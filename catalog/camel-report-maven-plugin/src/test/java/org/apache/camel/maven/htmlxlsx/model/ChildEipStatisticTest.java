...
public class ChildEipStatisticTest extends GetterAndSetterTest<ChildEipStatistic> {

    @Override
    protected ChildEipStatistic getInstance() {

        return TestUtil.childEipStatistic();
    }
