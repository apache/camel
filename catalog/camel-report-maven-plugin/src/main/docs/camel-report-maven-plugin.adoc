...
| generateHtmlReport | false | Whether to generate a coverage-report in HTML format. When enabled it will generate the file: `target/site/site/route-coverage/html/index.html`
|===
