...
| *adsuAddressType* (connection) | The common ASDU address size. <p> May be either SIZE_1 or SIZE_2. There are 2 enums and the value can be one of: SIZE_1, SIZE_2 |  | ASDUAddressType
| *causeOfTransmissionType* (connection) | The cause of transmission type. <p> May be either SIZE_1 or SIZE_2. There are 2 enums and the value can be one of: SIZE_1, SIZE_2 |  | CauseOfTransmissionType
| *informationObjectAddressType* (connection) | The information address size. <p> May be either SIZE_1, SIZE_2 or SIZE_3. There are 3 enums and the value can be one of: SIZE_1, SIZE_2, SIZE_3 |  | InformationObjectAddressType
...
| *timeZone* (data) | The timezone to use. <p> May be any Java time zone string | UTC | TimeZone
