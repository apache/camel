...
| *name* | *Required* Name of the Kamelet (templateId/routeId) to call. Options for the kamelet can be specified using uri syntax, eg myname?count=4&type=gold. |  | String
|===
// eip options: END
