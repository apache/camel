...
xref:components::quartz-component.adoc[Quartz], and xref:manual:ROOT:spring.adoc[Spring] based which
...
xref:components::quartz-component.adoc[Quartz], xref:manual:ROOT:spring.adoc[Spring] based scheduler.
...
in the xref:components::quartz-component.adoc[Quartz], and xref:manual:ROOT:spring.adoc[Spring]
components.
