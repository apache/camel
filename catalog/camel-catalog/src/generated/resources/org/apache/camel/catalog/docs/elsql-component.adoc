...
| *databaseVendor* (common) | To use a vendor specific com.opengamma.elsql.ElSqlConfig. There are 7 enums and the value can be one of: default, postgres, h-sql, my-sql, oracle, sql-server2008, veritca |  | ElSqlDatabaseVendor
