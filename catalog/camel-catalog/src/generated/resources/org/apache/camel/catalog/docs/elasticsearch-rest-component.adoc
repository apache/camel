...
| *operation* (producer) | What operation to perform. There are 12 enums and the value can be one of: index, update, bulk, bulk-index, get-by-id, multi-get, multi-search, delete, delete-index, search, exists, ping |  | ElasticsearchOperation
