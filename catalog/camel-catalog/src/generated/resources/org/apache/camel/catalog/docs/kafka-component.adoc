...
For this to work, you need to use `avro-maven-plugin` to generate the Java sources of your POJOs from your schema
files. Put your `.avsc` files in the `src/main/avro` directory of your project where the plugin looks for them
by default.