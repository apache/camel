...
| read | *edm* | *Optional*  Service Edm, read from calling <code>read(null, $metdata, null, responseHandler) | Edm
...
| uread | *edm* | *Optional*  Service Edm, read from calling <code>read(null, $metdata, null, responseHandler) | Edm
