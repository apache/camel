...
The content enricher (`enrich`) retrieves additional data from a _resource endpoint_
...
Here's an example for implementing an `AggregationStrategy`, which merges the two data
