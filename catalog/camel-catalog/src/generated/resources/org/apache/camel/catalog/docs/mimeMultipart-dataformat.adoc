...
a Camel message that has a MIME-Multipart message as message body (and no
attachments).
...
from MIME encoding descriptor to Java encoding descriptor)

|MIME-Version |String |The unmarshal operation will read this header and use it for parsing the
MIME multipart. The header is removed afterward
|=======================================================================
