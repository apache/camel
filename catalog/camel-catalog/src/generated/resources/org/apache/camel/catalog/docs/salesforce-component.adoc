...
Send HTTP requests to salesforce with full, raw control of all aspects of the call. Any serialization or deserialization of request and response
bodies must be performed in the route.
...
| rawQueryParameters | `String` | Query Comma separated list of headers to include as query parameters. Do not url-encode values as this will be done automatically. | |
| rawHttpHeaders | `String` | Query Comma separated list of headers to include as query parameters for Raw operation. | |
|===
...
| *rawHttpHeaders* (producer) | Query Comma separated list of headers to include as query parameters for Raw operation. |  | String
...
| *rawQueryParameters* (producer) | Query Comma separated list of headers to include as query parameters for Raw operation. Do not url-encode values as this will be done automatically. |  | String
