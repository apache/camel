...
By default, the Resequencer does not support duplicate messages. If a message arrives with the same message expression as
a message the Resequencer already holds, it keeps the message that arrived first and drops the later one.
