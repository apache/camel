...
:description: Expose ai-tool routes as MCP tools and ai-resource routes as MCP resources over streamable HTTP or stdio
:since: 4.22
...
>>>>>>> 156e1db07c7 (CAMEL-24352: Address review findings for MCP stdio transport)
