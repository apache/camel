...
| *operation* (producer) | *Required* The operation to perform. It can be listBrokers,createBroker,deleteBroker. There are 6 enums and the value can be one of: list-brokers, create-broker, delete-broker, reboot-broker, update-broker, describe-broker |  | MQOperations
