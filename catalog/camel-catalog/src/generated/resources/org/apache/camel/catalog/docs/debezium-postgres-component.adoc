...
| *signalDataCollection* (postgres) | The name of the data collection that is used to send signals/commands to Debezium. Signaling is disabled when not set. |  | String
...
include::spring-boot:partial$debezium-postgres-starter.adoc[]
