...
| *operation* (producer) | *Required* The operation to perform. There are 4 enums and the value can be one of: list-clusters, describe-cluster, create-cluster, delete-cluster |  | EKSOperations
