...
|===
| Name | Description | Default | Type
| *outputType* | *Required* The primary output format is PDF but other output formats are also supported. There are 10 enums and the value can be one of: pdf, ps, pcl, png, jpeg, svg, xml, mif, rtf, txt |  | FopOutputType
|===
...
include::{page-component-version}@camel-spring-boot::page$fop-starter.adoc[]
