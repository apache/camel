...
| *namesOnJoin* (common) | Sends <code>NAMES command to channel after joining it.<br> onReply has to be <code>true in order to process the result which will have the header value <code>irc.num = '353'. | false | boolean
