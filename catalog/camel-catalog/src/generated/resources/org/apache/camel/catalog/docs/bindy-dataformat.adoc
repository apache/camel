...
|Date |DateFormat |dd-MM-yyyy |https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html

|Decimal* |DecimalFormat |+##.###.###+ |https://docs.oracle.com/javase/8/docs/api/java/text/DecimalFormat.html
|===
...
| type |  | BindyType | Whether to use Csv, Fixed, or KeyValue. There are 3 enums and the value can be one of: Csv, Fixed, KeyValue
...
include::{page-component-version}@camel-spring-boot::page$bindy-starter.adoc[]
