...
IMPORTANT: If running in an OSGi container, please consult the <<Ignite-OsgiSupport,OSGi Support>> section below.
...
include::spring-boot:partial$ignite-starter.adoc[]
