...
| dataObjectType | org.w3c.dom.Node | String | What data type to unmarshal as, can either be org.w3c.dom.Node or java.lang.String. <p/> Is by default org.w3c.dom.Node
