...
| *httpLogLevel* (logging) | Set logging level for http calls, see java.util.logging.Level. The value can be one of: OFF, SEVERE, WARNING, INFO, CONFIG, FINE, FINER, FINEST, ALL |  | String
