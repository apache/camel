...
| *operation* (producer) | The operation to do in case the user don't want to send only a message. There are 4 enums and the value can be one of: sendBatchMessage, deleteMessage, listQueues, purgeQueue |  | Sqs2Operations
