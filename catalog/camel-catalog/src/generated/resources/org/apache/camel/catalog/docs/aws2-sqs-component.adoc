...
The AWS 2 Simple Queue Service (SQS) component supports 43 options, which are listed below.
...
include::{page-component-version}@camel-spring-boot::page$aws2-sqs-starter.adoc[]
