...
| *resultsFormat* (common) | What output result to use. There are 7 enums and the value can be one of: bytes, bytes-source, dom, dom-source, list, string, string-source | dom | ResultFormat
