...
| *language* (common) | Language of the response. There are 23 enums and the value can be one of: en, ru, it, es, sp, uk, ua, de, pt, ro, pl, fi, nl, fr, bg, sv, se, zh-tw, zh, zh-cn, tr, hr, ca | en | WeatherLanguage
