...
| *usernameSecurityPolicyUri* (security) | Set the UserTokenPolicy used when. There are 6 enums and the value can be one of: none, basic128-rsa15, basic256, basic256-sha256, aes128-sha256-rsa-oaep, aes256-sha256-rsa-pss |  | SecurityPolicy
|===
