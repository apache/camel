...
public class RoasterJavaDslTwoRoutesTest extends CamelTestSupport {
    ...
    void parseTree() throws Exception {
        JavaClassSource clazz = (JavaClassSource)
                Roaster.parse(new File("src/test/java/org/apache/camel/parser/java/TwoRoutesRouteBuilder.java"));

        List<CamelNodeDetails> list = RouteBuilderParser.parseRouteBuilderTree(
                clazz, "src/test/java/org/apache/camel/parser/java/TwoRoutesRouteBuilder.java", true);
