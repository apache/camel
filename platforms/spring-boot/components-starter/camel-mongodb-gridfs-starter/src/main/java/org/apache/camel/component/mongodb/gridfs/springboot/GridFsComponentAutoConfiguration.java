...
public class GridFsComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private GridFsComponentConfiguration componentConfiguration;
    ...
    public GridFsComponent configureGridFsComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<GridFsComponent> configurer : customizers) {
