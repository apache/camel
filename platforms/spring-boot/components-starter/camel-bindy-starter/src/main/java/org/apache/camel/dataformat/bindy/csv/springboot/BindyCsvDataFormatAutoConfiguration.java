...
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,
        BindyCsvDataFormatConfiguration.class})
public class BindyCsvDataFormatAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(BindyCsvDataFormatAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<DataFormatCustomizer<BindyCsvDataFormat>> customizers;
    @Autowired
    private DataFormatConfigurationProperties globalConfiguration;
    @Autowired
    private BindyCsvDataFormatConfiguration dataformatConfiguration;
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.dataformat", "camel.dataformat.bindy-csv");
        }
    }
        ...
        return new DataFormatFactory() {
            public DataFormat newInstance() {
                ...
                if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
                    for (DataFormatCustomizer<BindyCsvDataFormat> configurer : customizers) {
                        LOGGER.debug(
