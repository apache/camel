...
public class CouchbaseComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private CouchbaseComponentConfiguration componentConfiguration;
    ...
    public CouchbaseComponent configureCouchbaseComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<CouchbaseComponent> configurer : customizers) {
