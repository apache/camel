 ...
 */
package dataformat.springboot;

import java.util.HashMap;
import java.util.List;
import java.util.Map;
import javax.annotation.Generated;
import dataformat.ZipDataFormat;
...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        ZipDataFormatAutoConfiguration.GroupConditions.class})
@AutoConfigureAfter(name = "org.apache.camel.spring.boot.CamelAutoConfiguration")
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,
        ZipDataFormatConfiguration.class})
public class ZipDataFormatAutoConfiguration {
    ...
    static class GroupConditions extends GroupCondition {
        public GroupConditions() {
            super("camel.dataformat", "camel.dataformat.zip");
        }
    }

    @Bean(name = "zip-dataformat-factory")
    @ConditionalOnMissingBean(ZipDataFormat.class)
    public DataFormatFactory configureZipDataFormatFactory() throws Exception {
