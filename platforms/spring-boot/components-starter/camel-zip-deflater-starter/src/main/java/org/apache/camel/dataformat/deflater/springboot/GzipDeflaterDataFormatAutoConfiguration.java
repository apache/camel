...
import org.apache.camel.dataformat.deflater.GzipDeflaterDataFormat;
...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        GzipDeflaterDataFormatAutoConfiguration.GroupConditions.class})
@AutoConfigureAfter(name = "org.apache.camel.spring.boot.CamelAutoConfiguration")
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,
        GzipDeflaterDataFormatConfiguration.class})
public class GzipDeflaterDataFormatAutoConfiguration {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(GzipDeflaterDataFormatAutoConfiguration.class);
    @Autowired
    private ApplicationContext applicationContext;
    @Autowired
    private CamelContext camelContext;
    @Autowired
    private GzipDeflaterDataFormatConfiguration configuration;
    @Autowired(required = false)
    private List<DataFormatCustomizer<GzipDeflaterDataFormat>> customizers;

    static class GroupConditions extends GroupCondition {
        public GroupConditions() {
            super("camel.dataformat", "camel.dataformat.gzipdeflater");
        }
    }
