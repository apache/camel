...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        QueueServiceComponentConfiguration.class})
public class QueueServiceComponentAutoConfiguration extends AllNestedConditions {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.azure-queue");
        }
    }
    ...
    public QueueServiceComponent configureQueueServiceComponent()
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<QueueServiceComponent> configurer : customizers) {
