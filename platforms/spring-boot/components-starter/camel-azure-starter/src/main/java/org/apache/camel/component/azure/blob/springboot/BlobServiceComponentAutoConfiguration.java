...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        BlobServiceComponentConfiguration.class})
public class BlobServiceComponentAutoConfiguration extends AllNestedConditions {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.azure-blob");
        }
    }
    ...
    public BlobServiceComponent configureBlobServiceComponent()
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<BlobServiceComponent> customizer : customizers) {
