...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        RssComponentConfiguration.class})
public class RssComponentAutoConfiguration extends AllNestedConditions {
    ...
    private List<ComponentCustomizer<RssComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private RssComponentConfiguration componentConfiguration;

    public RssComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.rss");
        }
    }
    ...
    public RssComponent configureRssComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<RssComponent> customizer : customizers) {
