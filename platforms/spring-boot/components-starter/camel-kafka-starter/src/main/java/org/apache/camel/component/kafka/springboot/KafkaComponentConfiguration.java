...
public class KafkaComponentConfiguration
    ...
    public static class KafkaConfigurationNestedConfiguration {
         ...
         * <p/> If this option is enabled then an instance of {@link
         * KafkaManualCommit} is stored on the {@link Exchange} message header,
         * which allows end users to access this API and perform manual offset
         * commits via the Kafka consumer.
         */
        private Boolean allowManualCommit = false;
        /**
         ...
         * VIP pointing to a subset of brokers. <p/> This option is known as
         * <tt>bootstrap.servers</tt> in the Kafka documentation.
         */
        private String brokers;
        /**
         ...
         * Confluent schema registry and the
         * io.confluent.kafka.serializers.KafkaAvroDeserializer. This option is
         * only available in the Confluent Kafka product (not standard Apache
         * Kafka)
         */
         ...
         * have to be classes implementing {@link
         * org.apache.kafka.clients.producer.ProducerInterceptor} Consumer
         * interceptors have to be classes implementing {@link
