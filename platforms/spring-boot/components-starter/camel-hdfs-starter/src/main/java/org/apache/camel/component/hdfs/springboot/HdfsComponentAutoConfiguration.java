...
public class HdfsComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private HdfsComponentConfiguration componentConfiguration;

    public HdfsComponentAutoConfiguration() {
