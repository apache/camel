...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        MiloClientComponentConfiguration.class})
public class MiloClientComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(MiloClientComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<MiloClientComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private MiloClientComponentConfiguration componentConfiguration;

    public MiloClientComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.milo-client");
        }
    }
    ...
    public MiloClientComponent configureMiloClientComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<MiloClientComponent> customizer : customizers) {
