...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        MiloServerComponentConfiguration.class})
public class MiloServerComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(MiloServerComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<MiloServerComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private MiloServerComponentConfiguration componentConfiguration;

    public MiloServerComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.milo-server");
        }
    }
    ...
    public MiloServerComponent configureMiloServerComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<MiloServerComponent> configurer : customizers) {
