...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        CassandraComponentAutoConfiguration.GroupConditions.class})
...
public class CassandraComponentAutoConfiguration {
    ...
    public CassandraComponent configureCassandraComponent() throws Exception {
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<CassandraComponent> customizer : customizers) {
                boolean useCustomizer = (customizer instanceof HasId)
                        ? HierarchicalPropertiesEvaluator.evaluate(
                                applicationContext.getEnvironment(),
                                "camel.component.customizer",
                                "camel.component.cql.customizer",
