...
public class KubernetesComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private KubernetesComponentConfiguration componentConfiguration;

    public KubernetesComponentAutoConfiguration() {
    ...
    public KubernetesComponent configureKubernetesComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<KubernetesComponent> configurer : customizers) {
