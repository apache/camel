...
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,
        GsonDataFormatConfiguration.class})
public class GsonDataFormatAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(GsonDataFormatAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<DataFormatCustomizer<GsonDataFormat>> customizers;
    @Autowired
    private DataFormatConfigurationProperties globalConfiguration;
    @Autowired
    private GsonDataFormatConfiguration dataformatConfiguration;

    public GsonDataFormatAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.dataformat", "camel.dataformat.json-gson");
        }
    }
    ...
    public DataFormatFactory configureGsonDataFormatFactory() throws Exception {
        return new DataFormatFactory() {
            public DataFormat newInstance() {
                ...
                if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
                    for (DataFormatCustomizer<GsonDataFormat> customizer : customizers) {
                        LOGGER.debug(
