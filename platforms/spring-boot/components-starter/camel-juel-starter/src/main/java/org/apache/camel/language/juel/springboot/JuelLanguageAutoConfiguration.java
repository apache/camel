...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,
        JuelLanguageConfiguration.class})
public class JuelLanguageAutoConfiguration extends AllNestedConditions {
    ...
    public JuelLanguageAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.el");
        }
    }
    ...
    public JuelLanguage configureJuelLanguage() throws Exception {
