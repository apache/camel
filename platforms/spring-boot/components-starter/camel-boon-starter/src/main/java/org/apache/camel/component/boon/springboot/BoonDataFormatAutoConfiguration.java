...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        BoonDataFormatAutoConfiguration.GroupConditions.class})
...
public class BoonDataFormatAutoConfiguration {
    ...
    @Autowired
    private BoonDataFormatConfiguration configuration;
        ...
        return new DataFormatFactory() {
            ...
            public DataFormat newInstance() {
                ...
                if (ObjectHelper.isNotEmpty(customizers)) {
                    for (DataFormatCustomizer<BoonDataFormat> customizer : customizers) {
                        boolean useCustomizer = (customizer instanceof HasId)
                                ? HierarchicalPropertiesEvaluator.evaluate(
                                        applicationContext.getEnvironment(),
                                        "camel.dataformat.customizer",
                                        "camel.dataformat.boon.customizer",
