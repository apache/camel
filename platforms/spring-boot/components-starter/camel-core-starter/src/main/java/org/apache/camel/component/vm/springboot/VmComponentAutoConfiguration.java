...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        VmComponentConfiguration.class})
public class VmComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private VmComponentConfiguration componentConfiguration;

    public VmComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.vm");
        }
    }
