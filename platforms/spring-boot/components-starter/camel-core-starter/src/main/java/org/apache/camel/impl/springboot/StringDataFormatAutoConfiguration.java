...
public class StringDataFormatAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private StringDataFormatConfiguration dataformatConfiguration;

    public StringDataFormatAutoConfiguration() {
        ...
        return new DataFormatFactory() {
            public DataFormat newInstance() {
                ...
                if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
                    for (DataFormatCustomizer<StringDataFormat> configurer : customizers) {
                        LOGGER.debug(
