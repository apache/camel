...
public class RestComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private RestComponentConfiguration componentConfiguration;

    public RestComponentAutoConfiguration() {
