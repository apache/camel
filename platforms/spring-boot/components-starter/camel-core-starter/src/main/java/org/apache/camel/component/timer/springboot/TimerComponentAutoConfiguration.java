...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        TimerComponentConfiguration.class})
public class TimerComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private TimerComponentConfiguration componentConfiguration;

    public TimerComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.timer");
        }
    }
    ...
    public TimerComponent configureTimerComponent() throws Exception {
