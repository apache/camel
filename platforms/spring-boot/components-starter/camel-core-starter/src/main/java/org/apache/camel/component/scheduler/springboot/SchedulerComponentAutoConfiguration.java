...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        SchedulerComponentConfiguration.class})
public class SchedulerComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private SchedulerComponentConfiguration componentConfiguration;

    public SchedulerComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.scheduler");
        }
    }
    ...
    public SchedulerComponent configureSchedulerComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<SchedulerComponent> configurer : customizers) {
