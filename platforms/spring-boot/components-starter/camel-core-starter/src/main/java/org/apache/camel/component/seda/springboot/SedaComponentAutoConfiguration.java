...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        SedaComponentConfiguration.class})
public class SedaComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private SedaComponentConfiguration componentConfiguration;

    public SedaComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.seda");
        }
    }
    ...
    public SedaComponent configureSedaComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<SedaComponent> customizer : customizers) {
