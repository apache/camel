...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        RefComponentConfiguration.class})
public class RefComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private RefComponentConfiguration componentConfiguration;
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.ref");
        }
    }
    ...
    public RefComponent configureRefComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<RefComponent> customizer : customizers) {
