...
public class StubComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private StubComponentConfiguration componentConfiguration;

    public StubComponentAutoConfiguration() {
