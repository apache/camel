...
public class GzipDataFormatAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private GzipDataFormatConfiguration dataformatConfiguration;

    public GzipDataFormatAutoConfiguration() {
        ...
        return new DataFormatFactory() {
            public DataFormat newInstance() {
                ...
                if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
                    for (DataFormatCustomizer<GzipDataFormat> configurer : customizers) {
                        LOGGER.debug(
