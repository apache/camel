...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        ValidatorComponentConfiguration.class})
public class ValidatorComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private ValidatorComponentConfiguration componentConfiguration;

    public ValidatorComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.validator");
        }
    }
    ...
    public ValidatorComponent configureValidatorComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<ValidatorComponent> configurer : customizers) {
