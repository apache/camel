...
public class RestApiComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private RestApiComponentConfiguration componentConfiguration;
    ...
    public RestApiComponent configureRestApiComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<RestApiComponent> configurer : customizers) {
