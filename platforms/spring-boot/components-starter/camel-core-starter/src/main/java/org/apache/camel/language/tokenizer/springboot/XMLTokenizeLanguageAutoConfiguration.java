...
public class XMLTokenizeLanguageAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private XMLTokenizeLanguageConfiguration languageConfiguration;
    ...
    public XMLTokenizeLanguage configureXMLTokenizeLanguage() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (LanguageCustomizer<XMLTokenizeLanguage> configurer : customizers) {
