...
public class TestComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private TestComponentConfiguration componentConfiguration;

    public TestComponentAutoConfiguration() {
