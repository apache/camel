...
public class SerializationDataFormatAutoConfiguration
    ...
    @Autowired
    private SerializationDataFormatConfiguration dataformatConfiguration;

    public SerializationDataFormatAutoConfiguration() {
        ...
        return new DataFormatFactory() {
            public DataFormat newInstance() {
                ...
                if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
                    for (DataFormatCustomizer<SerializationDataFormat> configurer : customizers) {
                        LOGGER.debug(
