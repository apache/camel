...
public class ZipDataFormatAutoConfiguration extends AllNestedConditions {
    ...
    public ZipDataFormatAutoConfiguration() {
        ...
        return new DataFormatFactory() {
            public DataFormat newInstance() {
                ...
                if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
                    for (DataFormatCustomizer<ZipDataFormat> configurer : customizers) {
                        LOGGER.debug(
