...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,
        RefLanguageConfiguration.class})
public class RefLanguageAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(RefLanguageAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<LanguageCustomizer<RefLanguage>> customizers;
    @Autowired
    private LanguageConfigurationProperties globalConfiguration;
    @Autowired
    private RefLanguageConfiguration languageConfiguration;
