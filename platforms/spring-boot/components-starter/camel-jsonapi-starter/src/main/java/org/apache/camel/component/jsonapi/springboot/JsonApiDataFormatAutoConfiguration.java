...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        JsonApiDataFormatAutoConfiguration.GroupConditions.class})
@AutoConfigureAfter(name = "org.apache.camel.spring.boot.CamelAutoConfiguration")
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,
        JsonApiDataFormatConfiguration.class})
public class JsonApiDataFormatAutoConfiguration {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(JsonApiDataFormatAutoConfiguration.class);
    @Autowired
    ...
    private List<DataFormatCustomizer<JsonApiDataFormat>> customizers;

    static class GroupConditions extends GroupCondition {
        public GroupConditions() {
            super("camel.dataformat", "camel.dataformat.jsonapi");
        }
    }
