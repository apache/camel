...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        HazelcastAtomicnumberComponentAutoConfiguration.GroupConditions.class})
...
public class HazelcastAtomicnumberComponentAutoConfiguration {
    ...
    @Autowired
    private HazelcastAtomicnumberComponentConfiguration configuration;
    @Autowired(required = false)
    private List<ComponentCustomizer<HazelcastAtomicnumberComponent>> customizers;
    ...
    public HazelcastAtomicnumberComponent configureHazelcastAtomicnumberComponent()
            throws Exception {
        HazelcastAtomicnumberComponent component = new HazelcastAtomicnumberComponent();
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<HazelcastAtomicnumberComponent> customizer : customizers) {
