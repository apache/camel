...
@Configuration
@Conditional(HazelcastSetComponentAutoConfiguration.Condition.class)
@AutoConfigureAfter(CamelAutoConfiguration.class)
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        HazelcastSetComponentConfiguration.class})
public class HazelcastSetComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private HazelcastSetComponentConfiguration componentConfiguration;
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.hazelcast-set");
        }
    }
    ...
    @ConditionalOnMissingBean(HazelcastSetComponent.class)
    public HazelcastSetComponent configureHazelcastSetComponent()
            throws Exception {
        HazelcastSetComponent component = new HazelcastSetComponent();
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<HazelcastSetComponent> configurer : customizers) {
