...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        HazelcastQueueComponentAutoConfiguration.GroupConditions.class})
...
public class HazelcastQueueComponentAutoConfiguration {
    ...
    @Autowired
    private HazelcastQueueComponentConfiguration configuration;
    ...
    public HazelcastQueueComponent configureHazelcastQueueComponent()
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<HazelcastQueueComponent> customizer : customizers) {
                boolean useCustomizer = (customizer instanceof HasId)
                        ? HierarchicalPropertiesEvaluator.evaluate(
                                applicationContext.getEnvironment(),
                                "camel.component.customizer",
                                "camel.component.hazelcast-queue.customizer",
