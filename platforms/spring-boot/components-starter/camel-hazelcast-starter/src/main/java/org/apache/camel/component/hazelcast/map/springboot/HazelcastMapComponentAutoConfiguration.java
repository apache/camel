...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        HazelcastMapComponentAutoConfiguration.GroupConditions.class})
...
public class HazelcastMapComponentAutoConfiguration {
    ...
    @Autowired
    private HazelcastMapComponentConfiguration configuration;
    ...
    public HazelcastMapComponent configureHazelcastMapComponent()
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<HazelcastMapComponent> customizer : customizers) {
                boolean useCustomizer = (customizer instanceof HasId)
                        ? HierarchicalPropertiesEvaluator.evaluate(
                                applicationContext.getEnvironment(),
                                "camel.component.customizer",
                                "camel.component.hazelcast-map.customizer",
