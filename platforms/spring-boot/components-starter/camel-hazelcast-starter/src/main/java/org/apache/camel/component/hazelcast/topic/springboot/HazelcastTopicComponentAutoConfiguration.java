...
@Configuration
@Conditional(HazelcastTopicComponentAutoConfiguration.Condition.class)
...
public class HazelcastTopicComponentAutoConfiguration
    ...
    @Autowired
    private HazelcastTopicComponentConfiguration componentConfiguration;
    ...
    public HazelcastTopicComponent configureHazelcastTopicComponent()
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<HazelcastTopicComponent> configurer : customizers) {
