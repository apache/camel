...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        HazelcastRingbufferComponentAutoConfiguration.GroupConditions.class})
...
public class HazelcastRingbufferComponentAutoConfiguration {
    ...
    @Autowired
    private HazelcastRingbufferComponentConfiguration configuration;
    @Autowired(required = false)
    private List<ComponentCustomizer<HazelcastRingbufferComponent>> customizers;
    ...
    public HazelcastRingbufferComponent configureHazelcastRingbufferComponent()
            throws Exception {
        HazelcastRingbufferComponent component = new HazelcastRingbufferComponent();
