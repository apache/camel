...
public class RmiComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private RmiComponentConfiguration componentConfiguration;

    public RmiComponentAutoConfiguration() {
