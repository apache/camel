...
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,
        MimeMultipartDataFormatConfiguration.class})
public class MimeMultipartDataFormatAutoConfiguration
        extends
            AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(MimeMultipartDataFormatAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<DataFormatCustomizer<MimeMultipartDataFormat>> customizers;
    @Autowired
    private DataFormatConfigurationProperties globalConfiguration;
    @Autowired
    private MimeMultipartDataFormatConfiguration dataformatConfiguration;

    public MimeMultipartDataFormatAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.dataformat", "camel.dataformat.mime-multipart");
        }
    }
        ...
        return new DataFormatFactory() {
            public DataFormat newInstance() {
                ...
                if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
                    for (DataFormatCustomizer<MimeMultipartDataFormat> configurer : customizers) {
                        LOGGER.debug(
