...
public class MetricsComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private MetricsComponentConfiguration componentConfiguration;
    ...
    public MetricsComponent configureMetricsComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<MetricsComponent> configurer : customizers) {
