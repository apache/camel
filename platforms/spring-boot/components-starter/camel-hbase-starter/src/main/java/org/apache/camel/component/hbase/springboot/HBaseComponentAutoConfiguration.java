...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        HBaseComponentConfiguration.class})
public class HBaseComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private HBaseComponentConfiguration componentConfiguration;

    public HBaseComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.hbase");
        }
    }
    ...
    public HBaseComponent configureHBaseComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<HBaseComponent> customizer : customizers) {
