...
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,
        CsvDataFormatConfiguration.class})
public class CsvDataFormatAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(CsvDataFormatAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<DataFormatCustomizer<CsvDataFormat>> customizers;
    @Autowired
    private DataFormatConfigurationProperties globalConfiguration;
    @Autowired
    private CsvDataFormatConfiguration dataformatConfiguration;

    public CsvDataFormatAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.dataformat", "camel.dataformat.csv");
        }
    }
        ...
        return new DataFormatFactory() {
            public DataFormat newInstance() {
                ...
                if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
                    for (DataFormatCustomizer<CsvDataFormat> configurer : customizers) {
                        LOGGER.debug(
