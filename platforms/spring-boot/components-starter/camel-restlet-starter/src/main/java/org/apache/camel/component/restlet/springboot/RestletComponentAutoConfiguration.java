...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        RestletComponentConfiguration.class})
public class RestletComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(RestletComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<RestletComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private RestletComponentConfiguration componentConfiguration;

    public RestletComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.restlet");
        }
    }
    ...
    public RestletComponent configureRestletComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<RestletComponent> configurer : customizers) {
