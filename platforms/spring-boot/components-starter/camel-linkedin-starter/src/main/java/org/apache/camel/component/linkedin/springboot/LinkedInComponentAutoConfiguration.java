...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        LinkedInComponentConfiguration.class})
public class LinkedInComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(LinkedInComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<LinkedInComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private LinkedInComponentConfiguration componentConfiguration;

    public LinkedInComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.linkedin");
        }
    }
    ...
    public LinkedInComponent configureLinkedInComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<LinkedInComponent> customizer : customizers) {
