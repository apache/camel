...
public class GooglePubsubComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private GooglePubsubComponentConfiguration componentConfiguration;
    ...
    public GooglePubsubComponent configureGooglePubsubComponent()
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<GooglePubsubComponent> configurer : customizers) {
