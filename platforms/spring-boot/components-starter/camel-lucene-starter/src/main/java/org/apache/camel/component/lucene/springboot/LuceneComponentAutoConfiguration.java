...
public class LuceneComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private LuceneComponentConfiguration componentConfiguration;
    ...
    public LuceneComponent configureLuceneComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<LuceneComponent> configurer : customizers) {
