...
public class JXPathLanguageAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private JXPathLanguageConfiguration languageConfiguration;

    public JXPathLanguageAutoConfiguration() {
