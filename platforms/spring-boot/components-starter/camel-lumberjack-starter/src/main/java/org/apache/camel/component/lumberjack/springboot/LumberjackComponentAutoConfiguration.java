...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        LumberjackComponentConfiguration.class})
public class LumberjackComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(LumberjackComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<LumberjackComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private LumberjackComponentConfiguration componentConfiguration;
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.lumberjack");
        }
    }
    ...
    public LumberjackComponent configureLumberjackComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<LumberjackComponent> configurer : customizers) {
