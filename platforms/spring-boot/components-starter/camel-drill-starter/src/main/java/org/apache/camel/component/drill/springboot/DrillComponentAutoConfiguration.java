...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        DrillComponentConfiguration.class})
public class DrillComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(DrillComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<DrillComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private DrillComponentConfiguration componentConfiguration;

    public DrillComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.drill");
        }
    }
    ...
    public DrillComponent configureDrillComponent() throws Exception {
