...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        NetWeaverComponentConfiguration.class})
public class NetWeaverComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(NetWeaverComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<NetWeaverComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private NetWeaverComponentConfiguration componentConfiguration;

    public NetWeaverComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.sap-netweaver");
        }
    }
    ...
    public NetWeaverComponent configureNetWeaverComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<NetWeaverComponent> configurer : customizers) {
