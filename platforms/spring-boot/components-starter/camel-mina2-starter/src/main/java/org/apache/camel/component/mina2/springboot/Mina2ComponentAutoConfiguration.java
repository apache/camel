...
public class Mina2ComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private Mina2ComponentConfiguration componentConfiguration;

    public Mina2ComponentAutoConfiguration() {
    ...
    public Mina2Component configureMina2Component() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<Mina2Component> configurer : customizers) {
