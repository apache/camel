...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        BeanstalkComponentConfiguration.class})
public class BeanstalkComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(BeanstalkComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<BeanstalkComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private BeanstalkComponentConfiguration componentConfiguration;
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.beanstalk");
        }
    }
    ...
    public BeanstalkComponent configureBeanstalkComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<BeanstalkComponent> configurer : customizers) {
