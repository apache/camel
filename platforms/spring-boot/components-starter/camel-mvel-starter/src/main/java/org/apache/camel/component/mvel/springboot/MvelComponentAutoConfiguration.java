...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        MvelComponentConfiguration.class})
public class MvelComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private MvelComponentConfiguration componentConfiguration;

    public MvelComponentAutoConfiguration() {
    ...
    public MvelComponent configureMvelComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<MvelComponent> customizer : customizers) {
