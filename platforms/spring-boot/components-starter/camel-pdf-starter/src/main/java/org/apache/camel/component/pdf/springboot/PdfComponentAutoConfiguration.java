...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        PdfComponentConfiguration.class})
public class PdfComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(PdfComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<PdfComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private PdfComponentConfiguration componentConfiguration;

    public PdfComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.pdf");
        }
    }
    ...
    public PdfComponent configurePdfComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<PdfComponent> customizer : customizers) {
