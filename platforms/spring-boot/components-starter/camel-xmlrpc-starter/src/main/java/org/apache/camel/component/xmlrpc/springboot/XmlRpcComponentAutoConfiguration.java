...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        XmlRpcComponentAutoConfiguration.GroupConditions.class})
...
public class XmlRpcComponentAutoConfiguration {
    ...
    @Autowired
    private XmlRpcComponentConfiguration configuration;
    ...
    public XmlRpcComponent configureXmlRpcComponent() throws Exception {
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<XmlRpcComponent> customizer : customizers) {
                boolean useCustomizer = (customizer instanceof HasId)
                        ? HierarchicalPropertiesEvaluator.evaluate(
                                applicationContext.getEnvironment(),
                                "camel.component.customizer",
                                "camel.component.xmlrpc.customizer",
