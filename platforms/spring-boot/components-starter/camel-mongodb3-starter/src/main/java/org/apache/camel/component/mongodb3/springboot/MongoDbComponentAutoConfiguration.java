...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        MongoDbComponentConfiguration.class})
public class MongoDbComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private MongoDbComponentConfiguration componentConfiguration;
    ...
    public MongoDbComponent configureMongoDbComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<MongoDbComponent> customizer : customizers) {
