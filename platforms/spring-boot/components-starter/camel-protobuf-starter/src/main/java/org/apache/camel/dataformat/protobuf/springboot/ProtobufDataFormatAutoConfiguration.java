...
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,
        ProtobufDataFormatConfiguration.class})
public class ProtobufDataFormatAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(ProtobufDataFormatAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<DataFormatCustomizer<ProtobufDataFormat>> customizers;
    @Autowired
    private DataFormatConfigurationProperties globalConfiguration;
    @Autowired
    private ProtobufDataFormatConfiguration dataformatConfiguration;
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.dataformat", "camel.dataformat.protobuf");
        }
    }
        ...
        return new DataFormatFactory() {
            public DataFormat newInstance() {
                ...
                if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
                    for (DataFormatCustomizer<ProtobufDataFormat> configurer : customizers) {
                        LOGGER.debug(
