...
public class Jt400ComponentAutoConfiguration {
    ...
    @Autowired
    private Jt400ComponentConfiguration configuration;
    @Autowired(required = false)
    private List<ComponentCustomizer<Jt400Component>> customizers;
    ...
    public Jt400Component configureJt400Component() throws Exception {
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<Jt400Component> customizer : customizers) {
                boolean useCustomizer = (customizer instanceof HasId)
                        ? HierarchicalPropertiesEvaluator.evaluate(
                                applicationContext.getEnvironment(),
                                "camel.component.customizer",
                                "camel.component.jt400.customizer",
