...
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,
        PGPDataFormatConfiguration.class})
public class PGPDataFormatAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(PGPDataFormatAutoConfiguration.class);
    @Autowired
    ...
    @Autowired
    private PGPDataFormatConfiguration dataformatConfiguration;
        ...
        return new DataFormatFactory() {
            public DataFormat newInstance() {
                ...
                if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
                    for (DataFormatCustomizer<PGPDataFormat> configurer : customizers) {
                        LOGGER.debug(
