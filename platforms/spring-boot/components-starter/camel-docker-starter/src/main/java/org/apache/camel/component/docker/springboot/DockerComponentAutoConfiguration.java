...
public class DockerComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private DockerComponentConfiguration componentConfiguration;
    ...
    public DockerComponent configureDockerComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<DockerComponent> configurer : customizers) {
