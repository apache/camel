...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,
        JsonPathLanguageConfiguration.class})
public class JsonPathLanguageAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(JsonPathLanguageAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<LanguageCustomizer<JsonPathLanguage>> customizers;
    @Autowired
    private LanguageConfigurationProperties globalConfiguration;
    @Autowired
    private JsonPathLanguageConfiguration languageConfiguration;
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.jsonpath");
        }
    }
    ...
    public JsonPathLanguage configureJsonPathLanguage() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (LanguageCustomizer<JsonPathLanguage> configurer : customizers) {
