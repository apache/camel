...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        ScpComponentConfiguration.class})
public class ScpComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(ScpComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<ScpComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private ScpComponentConfiguration componentConfiguration;

    public ScpComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.scp");
        }
    }
    ...
    public ScpComponent configureScpComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<ScpComponent> customizer : customizers) {
