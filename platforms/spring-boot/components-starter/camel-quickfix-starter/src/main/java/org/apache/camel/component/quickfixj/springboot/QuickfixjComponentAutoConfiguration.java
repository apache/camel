...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        QuickfixjComponentConfiguration.class})
public class QuickfixjComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(QuickfixjComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<QuickfixjComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private QuickfixjComponentConfiguration componentConfiguration;

    public QuickfixjComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.quickfix");
        }
    }
    ...
    public QuickfixjComponent configureQuickfixjComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<QuickfixjComponent> configurer : customizers) {
