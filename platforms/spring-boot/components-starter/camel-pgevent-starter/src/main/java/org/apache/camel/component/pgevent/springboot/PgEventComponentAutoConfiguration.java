...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        PgEventComponentConfiguration.class})
public class PgEventComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(PgEventComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<PgEventComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private PgEventComponentConfiguration componentConfiguration;

    public PgEventComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.pgevent");
        }
    }
    ...
    public PgEventComponent configurePgEventComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<PgEventComponent> customizer : customizers) {
