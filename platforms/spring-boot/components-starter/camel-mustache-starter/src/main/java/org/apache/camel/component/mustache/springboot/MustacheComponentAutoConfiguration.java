...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        MustacheComponentConfiguration.class})
public class MustacheComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private MustacheComponentConfiguration componentConfiguration;

    public MustacheComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.mustache");
        }
    }
    ...
    public MustacheComponent configureMustacheComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<MustacheComponent> customizer : customizers) {
