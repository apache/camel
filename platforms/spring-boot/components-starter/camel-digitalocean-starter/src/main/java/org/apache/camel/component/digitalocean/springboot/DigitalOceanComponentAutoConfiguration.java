...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        DigitalOceanComponentConfiguration.class})
public class DigitalOceanComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(DigitalOceanComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<DigitalOceanComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private DigitalOceanComponentConfiguration componentConfiguration;

    public DigitalOceanComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.digitalocean");
        }
    }
    ...
    public DigitalOceanComponent configureDigitalOceanComponent()
            throws Exception {
        DigitalOceanComponent component = new DigitalOceanComponent();
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<DigitalOceanComponent> configurer : customizers) {
