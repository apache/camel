...
public class RestSwaggerComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private RestSwaggerComponentConfiguration componentConfiguration;
    ...
    public RestSwaggerComponent configureRestSwaggerComponent()
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<RestSwaggerComponent> configurer : customizers) {
