...
public class SqlLanguageAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private SqlLanguageConfiguration languageConfiguration;

    public SqlLanguageAutoConfiguration() {
