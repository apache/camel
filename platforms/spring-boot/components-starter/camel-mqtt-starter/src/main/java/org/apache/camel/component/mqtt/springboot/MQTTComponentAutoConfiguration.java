...
public class MQTTComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private MQTTComponentConfiguration componentConfiguration;

    public MQTTComponentAutoConfiguration() {
