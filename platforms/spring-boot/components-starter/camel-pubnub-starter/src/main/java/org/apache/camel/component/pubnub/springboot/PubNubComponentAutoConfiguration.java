...
public class PubNubComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private PubNubComponentConfiguration componentConfiguration;
    ...
    public PubNubComponent configurePubNubComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<PubNubComponent> configurer : customizers) {
