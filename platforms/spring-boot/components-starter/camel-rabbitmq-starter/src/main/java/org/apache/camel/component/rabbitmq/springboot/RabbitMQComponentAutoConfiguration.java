...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        RabbitMQComponentConfiguration.class})
public class RabbitMQComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(RabbitMQComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<RabbitMQComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private RabbitMQComponentConfiguration componentConfiguration;
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.rabbitmq");
        }
    }
    ...
    public RabbitMQComponent configureRabbitMQComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<RabbitMQComponent> customizer : customizers) {
