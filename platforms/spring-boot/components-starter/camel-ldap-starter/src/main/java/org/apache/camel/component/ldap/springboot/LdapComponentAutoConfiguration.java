...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        LdapComponentConfiguration.class})
public class LdapComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(LdapComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<LdapComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private LdapComponentConfiguration componentConfiguration;

    public LdapComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.ldap");
        }
    }
    ...
    public LdapComponent configureLdapComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<LdapComponent> customizer : customizers) {
