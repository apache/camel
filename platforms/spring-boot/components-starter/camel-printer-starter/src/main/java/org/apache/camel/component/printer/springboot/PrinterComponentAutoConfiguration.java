...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        PrinterComponentConfiguration.class})
public class PrinterComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(PrinterComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<PrinterComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private PrinterComponentConfiguration componentConfiguration;

    public PrinterComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.lpr");
        }
    }
    ...
    public PrinterComponent configurePrinterComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<PrinterComponent> customizer : customizers) {
