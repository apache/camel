...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        JmsComponentConfiguration.class})
public class JmsComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(JmsComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<JmsComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private JmsComponentConfiguration componentConfiguration;

    public JmsComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.jms");
        }
    }
    ...
    public JmsComponent configureJmsComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<JmsComponent> customizer : customizers) {
