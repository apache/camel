...
public class DisruptorComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private DisruptorComponentConfiguration componentConfiguration;
    ...
    public DisruptorComponent configureDisruptorComponent() throws Exception {
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<DisruptorComponent> configurer : customizers) {
