...
public class DisruptorVmComponentAutoConfiguration extends AllNestedConditions {
    ...
    @Autowired
    private DisruptorVmComponentConfiguration componentConfiguration;
    ...
    public DisruptorVmComponent configureDisruptorVmComponent()
        ...
        if (useConfigurers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<DisruptorVmComponent> configurer : customizers) {
