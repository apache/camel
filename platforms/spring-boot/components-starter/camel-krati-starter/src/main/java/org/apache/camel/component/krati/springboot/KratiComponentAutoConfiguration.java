...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        KratiComponentConfiguration.class})
public class KratiComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(KratiComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<KratiComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private KratiComponentConfiguration componentConfiguration;

    public KratiComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.krati");
        }
    }
    ...
    public KratiComponent configureKratiComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<KratiComponent> customizer : customizers) {
