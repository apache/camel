...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        DnsComponentConfiguration.class})
public class DnsComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(DnsComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<DnsComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private DnsComponentConfiguration componentConfiguration;

    public DnsComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.dns");
        }
    }
    ...
    public DnsComponent configureDnsComponent() throws Exception {
