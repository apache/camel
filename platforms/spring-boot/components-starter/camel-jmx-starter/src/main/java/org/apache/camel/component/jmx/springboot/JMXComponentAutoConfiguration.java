...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        JMXComponentConfiguration.class})
public class JMXComponentAutoConfiguration extends AllNestedConditions {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(JMXComponentAutoConfiguration.class);
    @Autowired
    private CamelContext camelContext;
    @Autowired(required = false)
    private List<ComponentCustomizer<JMXComponent>> customizers;
    @Autowired
    private ComponentConfigurationProperties globalConfiguration;
    @Autowired
    private JMXComponentConfiguration componentConfiguration;

    public JMXComponentAutoConfiguration() {
    ...
    public static class Condition extends GroupCondition {
        public Condition() {
            super("camel.component", "camel.component.jmx");
        }
    }
    ...
    public JMXComponent configureJMXComponent() throws Exception {
        ...
        if (useCustomizers && ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<JMXComponent> customizer : customizers) {
