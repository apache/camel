...
public class GoogleMailComponentAutoConfiguration {
    ...
    @Autowired
    private GoogleMailComponentConfiguration configuration;
    @Autowired(required = false)
    private List<ComponentCustomizer<GoogleMailComponent>> customizers;
    ...
    public GoogleMailComponent configureGoogleMailComponent() throws Exception {
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<GoogleMailComponent> customizer : customizers) {
