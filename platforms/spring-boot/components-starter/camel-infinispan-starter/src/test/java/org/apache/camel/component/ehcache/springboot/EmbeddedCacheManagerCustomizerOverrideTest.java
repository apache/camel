...
@SpringBootTest(
    classes = {
        EmbeddedCacheManagerCustomizerOverrideTest.TestConfiguration.class
    },
    properties = {
        "debug=false",
        ...
        "camel.component.infinispan.customizer.embedded-cache-manager.override=true",
        "camel.component.infinispan.customizer.remote-cache-manager.enabled=false"
    })
public class EmbeddedCacheManagerCustomizerOverrideTest {
