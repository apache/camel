...
@SpringBootTest(
    classes = {
        CacheManagerCustomizerSelectionForceEmbeddedTest.TestConfiguration.class
    },
    properties = {
        "debug=false",
...
public class CacheManagerCustomizerSelectionForceEmbeddedTest {
    @Autowired
    ...
    public void testComponentConfiguration() throws Exception {
        ...
        Assert.assertEquals(embeddedCacheManager, component.getCacheContainer());
    }
