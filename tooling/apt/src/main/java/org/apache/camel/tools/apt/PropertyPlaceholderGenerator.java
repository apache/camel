...
public final class PropertyPlaceholderGenerator {
    ...
    public static void generatePropertyPlaceholderProviderSource(String def, String fqnDef, String cn, Collection<? extends BaseOptionModel> options, Writer w) throws IOException {
    ...
    public static void generatePropertyPlaceholderDefinitionsHelper(Set<String> propertyPlaceholderDefinitions, Writer w) throws IOException {
