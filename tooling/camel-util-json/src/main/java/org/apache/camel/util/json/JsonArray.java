...
public class JsonArray extends ArrayList<Object> implements Jsonable {
     ...
     * collection of Ts.
     *
     * @param  <T>                represents the type that all of the elements of the JsonArray should be cast to and
     ...
     *
     * @param  <T>                       the kind of collection to expect at the index. Note unless manually added,
