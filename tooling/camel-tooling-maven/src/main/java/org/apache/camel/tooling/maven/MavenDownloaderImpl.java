...
public class MavenDownloaderImpl extends ServiceSupport implements MavenDownloader {
    ...
    protected void doBuild() {
        // Initialize repository resolver
    ...
    private void configureMIMA() {
        ...
        // Configure fresh mode (update policy) - in 2.4.39, this is done differently
        // The fresh mode will be handled by session configuration if needed
