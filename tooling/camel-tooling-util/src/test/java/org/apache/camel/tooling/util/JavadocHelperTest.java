...
public class JavadocHelperTest {
    ...
    public void testSanitizeJavaDoc() throws Exception {
        ...
        Assertions.assertEquals(
                "more memory. The total size is provided in the org.apache.camel.Exchange#SPLIT_SIZE header.", s2);
    ...
    public void testSanitizeJavaDocLink() throws Exception {
        ...
        Assertions.assertEquals(
                "Provides methods to interact with Transactions. E.g. sales, credits, refunds, searches, etc.", s3);
    }
}
