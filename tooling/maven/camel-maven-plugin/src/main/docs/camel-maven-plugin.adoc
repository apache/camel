...
| generateJacocoXmlReport | false | *Camel 2.24* Whether to generate a coverage-report in jacocoXml-format, when enabled it will generate a file: `target/site/jacoco/xmlJacoco.xml` 
|===
