...
public class HtmlToPdfMojo extends AbstractMojo {
    ...
    private void storeDummyFile() throws FileNotFoundException {
        ...
        out.println("<html>");
        out.println("<body>Generation of the offline PDF version of the manual failed, however you could try <a href=\"http://camel.apache.org/book-in-one-page.html\">the online HTML version</a>."
            + "</body>");
        out.println("</html>");
        out.close();
