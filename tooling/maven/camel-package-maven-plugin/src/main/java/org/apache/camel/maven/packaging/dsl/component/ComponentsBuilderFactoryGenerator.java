 ...
 * E.g: ComponentBuilderFactory.kafka().brokers("{{host:port}}").build()
 */
public final class ComponentsBuilderFactoryGenerator {
    ...
    private void setJavaDoc() {
        final String doc = "Component entry DSL builder. You can build a component like this: ComponentBuilderFactory.kafka().brokers(\"{{host:port}}\").build()" + "\n\n"
