...
| *camel.component.lucene.config.authority* | null |  | String
...
| *camel.component.lucene.config.max-hits* | An integer value that limits the result set of the search operation |  | int
...
| *camel.component.lucene.config.uri* | null |  | URI
