...
import org.apache.camel.component.schematron.util.ClassPathURIResolver;
...
public final class TemplatesFactory {
  ...
  private static final String[] PIPELINE = new String[] { "iso_dsdl_include.xsl", "iso_abstract_expand.xsl",
