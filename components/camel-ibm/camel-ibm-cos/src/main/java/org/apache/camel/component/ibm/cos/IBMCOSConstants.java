...
public interface IBMCOSConstants {
    ...
    @Metadata(description = "The bucket Name which this object will be stored or which will be used for the current operation",
              javaType = "String")
    ...
    @Metadata(description = "The *optional* Content-Encoding HTTP header specifying what content encodings have been applied to the object",
              javaType = "String")
    String CONTENT_ENCODING = "CamelIBMCOSContentEncoding";
    @Metadata(description = "The Content-Length HTTP header indicating the size of the associated object in bytes",
              javaType = "Long")
    String CONTENT_LENGTH = "CamelIBMCOSContentLength";
    @Metadata(description = "The base64 encoded 128-bit MD5 digest of the associated object",
              javaType = "String")
    String CONTENT_MD5 = "CamelIBMCOSContentMD5";
    @Metadata(description = "The Content-Type HTTP header, which indicates the type of content stored in the associated object",
              javaType = "String")
    String CONTENT_TYPE = "CamelIBMCOSContentType";
    @Metadata(description = "The ETag value for the object",
              javaType = "String")
    String E_TAG = "CamelIBMCOSETag";
    @Metadata(description = "The key under which this object is stored or will be stored",
              javaType = "String")
    ...
    @Metadata(description = "The value of the Last-Modified header, indicating the date and time at which IBM COS last recorded a modification to the object",
              javaType = "java.util.Date")
    String LAST_MODIFIED = "CamelIBMCOSLastModified";
    @Metadata(description = "The version ID of the associated IBM COS object if available",
              javaType = "String")
    ...
    @Metadata(description = "A map of metadata to be stored with the object in IBM COS",
              javaType = "java.util.Map<String, String>")
    String METADATA = "CamelIBMCOSMetadata";
    @Metadata(label = "producer", description = "The range start position for partial object retrieval",
              javaType = "Long")
    String RANGE_START = "CamelIBMCOSRangeStart";
    @Metadata(label = "producer", description = "The range end position for partial object retrieval",
              javaType = "Long")
    String RANGE_END = "CamelIBMCOSRangeEnd";
    @Metadata(label = "producer", description = "Whether the bucket exists or not",
              javaType = "Boolean")
