...
xref:ROOT:ibm-watsonx-ai-component.adoc[Back to IBM watsonx.ai Component]
...
NOTE: Requires the `camel-vertx-websocket` dependency. See the xref:ROOT:vertx-websocket-component.adoc[Vert.x WebSocket component documentation] for more details.
...
NOTE: This example requires the `camel-qdrant` dependency. See the xref:ROOT:qdrant-component.adoc[Qdrant component documentation] for more details.
