...
public class IBMSecretsManagerNoEnvPropertiesSourceTestIT extends CamelTestSupport {
    ...
    public void testFunction() throws Exception {
        ...
        context.getVaultConfiguration()
                .ibmSecretsManager()
                .setServiceUrl(System.getProperty("camel.ibm.sm.serviceurl"));
        context.addRoutes(new RouteBuilder() {
            @Override
            public void configure() {
                from("direct:start")
                        .setBody(simple("{{ibm:default:authsecdb#username}}"))
                        .to("mock:bar");
            }
        });
        context.start();
    ...
    public void testFunctionWithVersion() throws Exception {
        ...
        context.addRoutes(new RouteBuilder() {
            ...
            public void configure() {
                from("direct:start")
                        .setBody(simple("{{ibm:default:authsecdb#username@current}}"))
                        .to("mock:bar");
            }
        });
        context.start();
    ...
    public void testFunctionWithExistentVersion() throws Exception {
        ...
        context.addRoutes(new RouteBuilder() {
            ...
            public void configure() {
                from("direct:start")
                        .setBody(simple("{{ibm:default:authsecdb#username@00221dc6-1911-c29e-fd7a-c4c5d88ce13f}}"))
                        .to("mock:bar");
            }
        });
        context.start();
    ...
    public void testFunctionWithArbitrarySecret() throws Exception {
        ...
        context.addRoutes(new RouteBuilder() {
            @Override
            public void configure() {
                from("direct:start").setBody(simple("{{ibm:default:pippo}}")).to("mock:bar");
            }
        });
        context.start();
    ...
    public void testFunctionWithArbitrarySecretNonExistentAndDefault() throws Exception {
        ...
        context.addRoutes(new RouteBuilder() {
            ...
            public void configure() {
                from("direct:start")
                        .setBody(simple("{{ibm:default:secsecret:sese}}"))
                        .to("mock:bar");
            }
        });
        context.start();
