...
public final class DebeziumTestEndpoint extends DebeziumEndpoint<FileConnectorEmbeddedDebeziumConfiguration> {
    ...
    @Override
    public void setConfiguration(final FileConnectorEmbeddedDebeziumConfiguration configuration) {
        this.configuration = configuration;
    }
}
