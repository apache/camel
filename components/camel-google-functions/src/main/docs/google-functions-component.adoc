...
:description: Store and retrieve objects from Google Cloud Functions Service using the google-cloud-functions library.
:since: 3.9
...
the https://github.com/googleapis/java-functions[google java functions library].
