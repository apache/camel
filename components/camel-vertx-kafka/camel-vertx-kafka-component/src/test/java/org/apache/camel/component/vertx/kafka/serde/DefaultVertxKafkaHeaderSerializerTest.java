...
class DefaultVertxKafkaHeaderSerializerTest {

    @ParameterizedTest
    @MethodSource("primeNumbers")
    public void serialize(Object value, byte[] expectedResult) {
        byte[] result = Objects.requireNonNull(DefaultVertxKafkaHeaderSerializer.serialize(value)).getBytes();

        assertArrayEquals(expectedResult, result);

        assertNull(DefaultVertxKafkaHeaderSerializer.serialize(null));
        assertNull(DefaultVertxKafkaHeaderSerializer.serialize(new Object()));
    }
