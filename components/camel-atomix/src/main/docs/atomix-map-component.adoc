...
| *defaultAction* (common) | The default action. There are 12 enums and the value can be one of: put, put-if-absent, get, clear, size, contains-key, contains-value, is-empty, entry-set, remove, replace, values | put | Action
