...
public final class AtomixMultiMapComponent extends AbstractAtomixClientComponent<AtomixMultiMapConfiguration> {
    ...
    protected Endpoint createEndpoint(String uri, String remaining, Map<String, Object> parameters) throws Exception {
        AtomixMultiMapConfiguration configuration = this.configuration.copy();

        // Bind options to the configuration object
        setConfigurationProperties(configuration, parameters);

        AtomixMultiMapEndpoint endpoint = new AtomixMultiMapEndpoint(uri, this, remaining);
    ...
    @Override
    protected AtomixMultiMapConfiguration getComponentConfiguration() {
