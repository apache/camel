[[jackson-avro-dataformat]]
= Jackson Avro DataFormat
:docTitle: Jackson Avro
:artifactId: camel-jackson-avro
:description: Unmarshal Avro payloads to POJOs and back using Jackson.
:since: 3.10
:supportLevel: Stable
...
include::{page-component-version}@camel-spring-boot::page$jacksonxml-starter.adoc[]
