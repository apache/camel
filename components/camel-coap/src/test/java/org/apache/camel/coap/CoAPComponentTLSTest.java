...
public class CoAPComponentTLSTest extends CamelTestSupport {
    ...
    protected JndiRegistry createRegistry() throws Exception {
        ...
        registry.bind("selfSignedServiceSSLContextParameters", selfSignedServiceSSLContextParameters);
        registry.bind("clientAuthServiceSSLContextParameters", clientAuthServiceSSLContextParameters);
        registry.bind("clientSSLContextParameters", clientSSLContextParameters);
        registry.bind("clientSSLContextParameters2", clientSSLContextParameters2);
        registry.bind("clientAuthClientSSLContextParameters", clientAuthClientSSLContextParameters);
        registry.bind("clientAuthClientSSLContextParameters2", clientAuthClientSSLContextParameters2);
        registry.bind("selfSignedClientSSLContextParameters", selfSignedClientSSLContextParameters);
