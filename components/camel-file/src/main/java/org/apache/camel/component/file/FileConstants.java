...
public final class FileConstants {
    ...
    @Metadata(description = "Camel will by default move any processed file into a .camel subdirectory in the directory the file was consumed from", javaType = "String")
