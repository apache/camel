...
public abstract class GenericFileEndpoint<T> extends ScheduledPollEndpoint implements BrowsableEndpoint {
    ...
    @UriParam(
            label = "advanced",
            defaultValue = "true",
            description = "Automatically create missing directories in "
    ...
    @UriParam(
            label = "advanced",
            defaultValue = "" + FileUtil.BUFFER_SIZE,
            description = "Buffer size in bytes used "
                    + "for writing files (or in case of FTP for downloading and uploading files).")
    protected int bufferSize = FileUtil.BUFFER_SIZE;

    @UriParam(
            description = "This option is used to specify the encoding of the file. You can use this on the "
    ...
    @UriParam(
            ...
            description = "Use Expression such as File Language to dynamically set "
    ...
    @UriParam(
            description = "Producer: If provided, then Camel will write a 2nd done file when the original file has "
    ...
    @UriParam(
            label = "producer",
            description = "Flatten is used to flatten the file name path to strip any leading "
    ...
    @UriParam(
            ...
            description = "What to do if a file already exists with "
    ...
    @UriParam(
            label = "producer",
            description = "This option is used to write the file using a temporary name and "
    ...
    @UriParam(
            label = "producer",
            javaType = "java.lang.String",
            description = "The same as tempPrefix option but "
    ...
    @UriParam(
            ...
            defaultValue = "true",
            description =
                    "Whether or not to eagerly delete "
    ...
    @UriParam(
            label = "producer,advanced",
            description = "Will keep the last modified timestamp from the source file "
    ...
    @UriParam(
            label = "producer,advanced",
            description = "Used to specify if a null body is allowed during file "
    ...
    @UriParam(
            label = "producer",
            defaultValue = "true",
            description = "Used for jailing (restricting) writing files "
    ...
    @UriParam(
            label = "producer",
            description = "Used to append characters (text) after writing files. This can for "
    ...
    @UriParam(
            label = "consumer,advanced",
            description = "When consuming, a local work directory can be used to "
    ...
    @UriParam(
            label = "consumer",
            description = "If true, the file is not moved or deleted in any way. This option "
    ...
    @UriParam(
            ...
            description = "To define a maximum messages to gather per poll. By default "
    ...
    @UriParam(
            label = "consumer,filter",
            defaultValue = "true",
            description = "Allows for controlling whether the "
    ...
    @UriParam(
            label = "consumer,filter",
            description = "Is used to include files, if filename matches the regex "
    ...
    @UriParam(
            label = "consumer,filter",
            description = "Is used to exclude files, if filename matches the regex "
                    + "pattern (matching is case in-sensitive). <p/> Notice if you use symbols such as plus sign and others "
                    + "you would need to configure this using the RAW() syntax if configuring this as an endpoint uri. See "
                    + "more details at <a href=\"http://camel.apache.org/how-do-i-configure-endpoints.html\">configuring "
                    + "endpoint uris</a>")
    ...
    @UriParam(
            label = "consumer,filter",
            description =
                    "Is used to include files matching file extension name (case insensitive). For example to include txt files, then use includeExt=txt."
    ...
    @UriParam(
            label = "consumer,filter",
            description =
                    "Is used to exclude files matching file extension name (case insensitive). For example to exclude bak files, then use excludeExt=bak."
    ...
    @UriParam(
            label = "consumer,filter",
            javaType = "java.lang.String",
            description = "Expression (such as Simple "
    ...
    @UriParam(
            label = "consumer",
            javaType = "java.lang.String",
            description = "Sets the move failure expression "
    ...
    @UriParam(
            label = "consumer",
            javaType = "java.lang.String",
            description = "Expression (such as File Language) "
    ...
    @UriParam(
            label = "producer,advanced",
            description = "Strategy (Custom Strategy) used to move file with special "
    ...
    @UriParam(
            label = "consumer,filter",
            defaultValue = "false",
            description = "Option to use the Idempotent "
    ...
    @UriParam(
            ...
            defaultValue = "true",
            description =
                    "Sets whether to eagerly add the filename to the idempotent repository or wait until the exchange is complete.")
    private Boolean idempotentEager = Boolean.TRUE;

    @UriParam(
            label = "consumer,filter",
            javaType = "java.lang.String",
            description = "To use a custom idempotent "
    ...
    @UriParam(
            label = "consumer,filter",
            description = "A pluggable repository org.apache.camel.spi.IdempotentRepository "
    ...
    @UriParam(
            label = "consumer,filter",
            javaType = "java.lang.String",
            description = "Filters the directory based on "
    ...
    @UriParam(
            label = "consumer,filter",
            javaType = "java.lang.String",
            description = "Filters the file based on "
    ...
    @UriParam(
            label = "consumer,sort",
            javaType = "java.lang.String",
            description = "Built-in sort by using the "
    ...
    @UriParam(
            label = "consumer,lock",
            defaultValue = "1000",
            description = "Interval in millis for the read-lock, "
    ...
    @UriParam(
            label = "consumer,lock",
            defaultValue = "10000",
            description = "Optional timeout in millis for the "
    ...
    @UriParam(
            label = "consumer,lock",
            defaultValue = "true",
            description = "Whether to use marker file with the "
    ...
    @UriParam(
            label = "consumer,lock",
            defaultValue = "true",
            description = "Whether or not read lock with marker "
    ...
    @UriParam(
            label = "consumer,lock",
            defaultValue = "DEBUG",
            description = "Logging level used when a read lock "
    ...
    @UriParam(
            label = "consumer,lock",
            defaultValue = "1",
            description = "This option is applied only for "
    ...
    @UriParam(
            label = "consumer,lock",
            description = "Whether to delay the release task for a period of millis. <p/> "
    ...
    @UriParam(
            label = "consumer,lock",
            description = "Whether the delayed release task should be synchronous or "
    ...
    @UriParam(
            label = "consumer,lock",
            description = "The number of threads in the scheduled thread pool when using "
    ...
    @UriParam(
            label = "consumer,lock",
            description = "To use a custom and shared thread pool for asynchronous "
                        ...
                        if (!status) {
                            ...
                            if (gf != null) {
                                ...
                                try {
                                    ...
                                    LOG.debug(
                                            "Error trying to retrieve file: {} due to: {}. This exception is ignored.",
                                            name,
                                            e.getMessage(),
                                            e);
                                }
    ...
    protected Map<String, Object> getParamsAsMap() {
        ...
        if ("idempotent".equals(readLock)
                || "idempotent-changed".equals(readLock)
                || "idempotent-rename".equals(readLock)) {
    ...
    protected String createDoneFileName(String fileName) {
        ...
        if (org.apache.camel.util.ObjectHelper.isNotEmpty(path)
                && org.apache.camel.util.ObjectHelper.isNotEmpty(pattern)) {
    ...
    protected void doInit() throws Exception {
        ...
        if (!"none".equals(readLock) && !"off".equals(readLock)) {
            if (readLockTimeout > 0 && readLockTimeout <= readLockCheckInterval) {
                throw new IllegalArgumentException(
                        "The option readLockTimeout must be higher than readLockCheckInterval"
                                + ", was readLockTimeout="
                                + readLockTimeout
        ...
        if ("idempotent".equals(readLock) && idempotentRepository == null) {
            throw new IllegalArgumentException(
                    "IdempotentRepository must be configured when using readLock=idempotent");
        }
