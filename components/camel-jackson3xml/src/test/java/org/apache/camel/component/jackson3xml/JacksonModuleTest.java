...
public class JacksonModuleTest extends CamelTestSupport {
    ...
    public void testCustomModule() throws Exception {
        ...
        mock.message(0).body(String.class)
                .isEqualTo("<TestOtherPojo><my-country>Denmark</my-country><my-name>Camel</my-name></TestOtherPojo>");
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                format.setModuleClassNames("org.apache.camel.component.jackson3xml.MyModule");
