...
public class JacksonEmptyElementsAsNullTest extends CamelTestSupport {
    ...
    public void testEmptyAsNull() throws Exception {
        ...
        Assertions.assertEquals(null, mock.getReceivedExchanges().get(1).getMessage().getBody(TestPojo.class).getName());
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                format.enableFeature(XmlReadFeature.EMPTY_ELEMENT_AS_NULL);
