= OpenTelemetry Component (deprecated)
...
NOTE: this component is deprecated since version 4.19.0. Please, use xref:opentelemetry2.adoc[`camel-opentelemetry2`] component instead.
