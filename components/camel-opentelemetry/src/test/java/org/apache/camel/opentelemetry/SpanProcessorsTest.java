...
class SpanProcessorsTest extends CamelOpenTelemetryTestSupport {
    ...
    private static final SpanTestData[] TEST_DATA = {
        ...
        new SpanTestData()
                ...
                .setOperation("c")
                .setParentId(3)
                .addLogMessage("Exchange[ExchangePattern: InOut, BodyType: String, Body: Hello]"),
        new SpanTestData()
                .setLabel("seda:c server")
                .setUri("seda://c")
                .setOperation("c")
        ...
        new SpanTestData()
                ...
                .setOperation("a")
                .setParentId(5)
                .addLogMessage("routing at a")
                .addLogMessage("End of routing"),
        new SpanTestData()
                .setLabel("seda:a server")
                .setUri("seda://a")
                .setOperation("a")
