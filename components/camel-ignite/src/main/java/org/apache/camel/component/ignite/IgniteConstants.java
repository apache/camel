...
public final class IgniteConstants {
    ...
    @Metadata(
            description = "(producer) The old cache value to be replaced when invoking the REPLACE operation. \n"
    ...
    // Ignite Messaging.
    @Metadata(
            description = "(producer) Allows you to dynamically change the topic to send messages to. \n"
