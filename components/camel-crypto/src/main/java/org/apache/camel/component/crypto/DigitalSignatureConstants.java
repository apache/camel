...
public final class DigitalSignatureConstants {
    @Metadata(
            description = "The PrivateKey that should be used to sign the message",
            javaType = "java.security.PrivateKey")
    public static final String SIGNATURE_PRIVATE_KEY = "CamelSignaturePrivateKey";

    @Metadata(
            description = "The Certificate or PublicKey that should be used to verify the signature",
    ...
    @Metadata(
            description = "The alias used to query the KeyStore for keys and Certificates to be\n"
