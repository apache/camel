...
When using `alibaba-mns` with Spring Boot, add the following dependency:
...
<dependency>
    ...
    <version>x.x.x</version>
    <!-- use the same version as your Camel Spring Boot version -->
</dependency>
----

The component supports 0 options, which are listed below.

include::partial$starter-configure-options.adoc[]

== Spring Boot Auto-Configuration

When using Spring Boot, the component is auto-configured. Refer to the
xref:manual::spring-boot.adoc[Spring Boot documentation] for more details.
