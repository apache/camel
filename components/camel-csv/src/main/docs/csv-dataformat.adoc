...
| delimiter |  | String | Sets the delimiter to use. <p/> The default value is , (comma)
...
| recordConverterRef |  | String | Refers to a custom <tt>CsvRecordConverter to lookup from the registry to use.
|===
