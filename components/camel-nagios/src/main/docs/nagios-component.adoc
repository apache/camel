...
|===
| Name | Description | Default | Type
| *camel.component.nagios.configuration.connection-timeout* | Connection timeout in millis. | 5000 | int
| *camel.component.nagios.configuration.encryption* | To specify an encryption method. |  | Encryption
| *camel.component.nagios.configuration.encryption-method* | To specify an encryption method.
...
| *camel.component.nagios.configuration.nagios-settings.connect-timeout* | null |  | int
| *camel.component.nagios.configuration.nagios-settings.encryptor* | null |  | Encryptor
| *camel.component.nagios.configuration.nagios-settings.nagios-host* | null |  | String
| *camel.component.nagios.configuration.nagios-settings.password* | null |  | String
| *camel.component.nagios.configuration.nagios-settings.port* | null |  | int
| *camel.component.nagios.configuration.nagios-settings.timeout* | null |  | int
| *camel.component.nagios.configuration.password* | Password to be authenticated when sending checks to Nagios. |  | String
| *camel.component.nagios.configuration.port* | The port number of the host. |  | int
| *camel.component.nagios.configuration.timeout* | Sending timeout in millis. | 5000 | int
