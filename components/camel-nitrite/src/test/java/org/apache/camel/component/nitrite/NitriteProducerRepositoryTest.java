...
public class NitriteProducerRepositoryTest extends AbstractNitriteTest {
    ...
    public void findRepositoryOperation() {
        List<MyPersistentObject> result = template.requestBodyAndHeader(
                ...
                new FindRepositoryOperation(ObjectFilters.eq("key1", "c")),
                List.class);
    ...
    public void removeRepositoryOperation() {
        ...
        exchange.getMessage()
                .setHeader(NitriteConstants.OPERATION, new RemoveRepositoryOperation(ObjectFilters.eq("key2", "b")));
    ...
    public void updateRepositoryOperation() {
        Exchange exchange = new DefaultExchange(context);
        exchange.getMessage()
                .setHeader(NitriteConstants.OPERATION, new UpdateRepositoryOperation(ObjectFilters.eq("key2", "f")));
    ...
    public void insertOperation() {
        Exchange exchange = new DefaultExchange(context);
        exchange.getMessage()
                .setHeader(NitriteConstants.OPERATION, new InsertOperation(new MyPersistentObject(123, "", "", "")));
    ...
    public void updateOperation() {
        Exchange exchange = new DefaultExchange(context);
        exchange.getMessage()
                .setHeader(NitriteConstants.OPERATION, new UpdateOperation(new MyPersistentObject(1, "", "", "")));
    ...
    public void upsertOperation() {
        Exchange exchange = new DefaultExchange(context);
        exchange.getMessage()
                .setHeader(NitriteConstants.OPERATION, new UpsertOperation(new MyPersistentObject(1, "", "", "")));
