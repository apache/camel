...
public class DnsConstants {
    ...
    @Metadata(
            label = "dig",
            description = "The server in particular for the query. If none is given, the default\n"
    ...
    @Metadata(
            label = "lookup dig",
            description = "The type of the lookup. Should match the values of `org.xbill.dns.Type`.\n" + "Optional.",
            javaType = "String")
