 ...
 */
public abstract class CassandraQlAggregationRepository extends ServiceSupport implements AggregationRepository {
    /**
     * Logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(CassandraQlAggregationRepository.class);
    /**
     * Session holder
     */
    ...
    public CassandraQlAggregationRepository() {
    }

    public CassandraQlAggregationRepository(Session session) {
        this.sessionHolder = new CassandraSessionHolder(session);
    }
    public CassandraQlAggregationRepository(Cluster cluster, String keyspace) {
