 ...
 * <dl>
 */
public class CassandraQlProducer extends DefaultProducer {

    private static final Logger LOG = LoggerFactory.getLogger(CassandraQlProducer.class);
    private PreparedStatement preparedStatement;
    public CassandraQlProducer(CassandraQlEndpoint endpoint) {
        super(endpoint);
    }
    ...
    private ResultSet execute(Message message) {
        String messageCql = message.getHeader(CassandraQlConstants.CQL_QUERY, String.class);
