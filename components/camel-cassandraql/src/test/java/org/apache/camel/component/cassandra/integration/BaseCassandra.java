...
import org.apache.camel.test.infra.cassandra.services.CassandraTestService;
...
public abstract class BaseCassandra implements ConfigurableRoute, CamelTestSupportHelper {
    ...
    @Order(1)
    @RegisterExtension
    public static CassandraTestService service = CassandraServiceFactory.createLocalService("initScript.cql");
