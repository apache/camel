...
import org.apache.camel.utils.cassandraql.CassandraUtils;
import org.cassandraunit.CassandraCQLUnit;
/**
 * Unite test for {@link CassandraQlAggregationRepository}
 */
public class CassandraQlAggregationTest extends CamelTestSupport {
    private Cluster cluster;
    private CassandraQlAggregationRepository aggregationRepository;
    ...
    protected void doPreSetup() throws Exception {
        ...
        rootSession.close();
        aggregationRepository = new NamedCassandraQlAggregationRepository(cluster, CassandraUnitUtils.KEYSPACE, "ID");
