...
public class RestJettyNoContentTest extends BaseJettyTest {
    ...
    public void testJson200ConfigNoContentEnabled() {
        ...
        assertEquals(200, exchange.getMessage().getHeader(Exchange.HTTP_RESPONSE_CODE));
        assertEquals(
                "{\"iso\":\"EN\",\"country\":\"England\"}", MessageHelper.extractBodyAsString(exchange.getMessage()));
    }
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                from("direct:v1address")
                        .setHeader(
                                JaxbConstants.JAXB_PART_CLASS, simple("org.apache.camel.component.jetty.rest.Address"))
                        .setHeader(
