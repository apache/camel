...
public final class ZendeskEndpointConfiguration extends ZendeskConfiguration {
    ...
    @UriParam
    @ApiParam(optional = false, apiMethods = {@ApiMethod(methodName = "executeView")})
    ...
    @UriParam
    @ApiParam(optional = false, apiMethods = {@ApiMethod(methodName = "getOrganizationMembershipsForOrg"), @ApiMethod(methodName = "unassignOrganizationMembership")})
    ...
    @UriParam
    @ApiParam(optional = false, apiMethods = {@ApiMethod(methodName = "getContentTags"), @ApiMethod(methodName = "getTicketFromSearchWithExport")})
    ...
    @UriParam
    @ApiParam(optional = false, apiMethods = {@ApiMethod(methodName = "getArticleFromSearch"), @ApiMethod(methodName = "getTicketFromSearchWithExport"), @ApiMethod(methodName = "getTicketsFromSearch")})
    ...
    public void setClazz(Class<org.zendesk.client.v2.model.views.ViewRow> clazz) {
        this.clazz = clazz;
    }
