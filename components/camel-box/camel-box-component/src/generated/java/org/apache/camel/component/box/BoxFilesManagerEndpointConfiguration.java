...
public final class BoxFilesManagerEndpointConfiguration extends BoxConfiguration {
    ...
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "getFileInfo", description="The information fields to retrieve; if <code>null all information fields are retrieved.")})
    ...
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "downloadFile", description="A listener for monitoring the download's progress; if <code>null the download's progress will not be monitored."), @ApiMethod(methodName = "downloadPreviousFileVersion", description="A listener for monitoring the download's progress; if <code>null the download's progress will not be monitored."), @ApiMethod(methodName = "uploadFile", description="A listener for monitoring the upload's progress"), @ApiMethod(methodName = "uploadNewFileVersion", description="A listener for monitoring the upload's progress")})
    ...
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "copyFile", description="The new name for copied file; if <code>newName is <code>null, the copied file has same name as the original."), @ApiMethod(methodName = "moveFile", description="The new name of moved file; if <code>newName is <code>null, the moved file has same name as the original.")})
    ...
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "createFileSharedLink", description="The permissions of the created link; if <code>permissions is <code>null then the created shared link is create with default permissions.")})
    private com.box.sdk.BoxSharedLink.Permissions permissions;
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "downloadFile", description="The byte offset in file at which to stop the download; if <code>null the entire contents of file will be downloaded.")})
    private Long rangeEnd;
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "downloadFile", description="The byte offset in file at which to start the download; if <code>null the entire contents of file will be downloaded.")})
    ...
    private Long size;
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "createFileMetadata", description="The metadata template type name; if <code>null the global properties template type is used."), @ApiMethod(methodName = "getFileMetadata", description="The metadata template type name; if <code>null the global properties template type is used.")})
    private String typeName;
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "createFileSharedLink", description="The date and time at which time the created shared link will expire; if <code>unsharedDate is <code>null then a non-expiring link is created.")})
    private java.util.Date unshareDate;
    @UriParam
    @ApiParam(optional = false, apiMethods = {@ApiMethod(methodName = "deleteFileVersion", description="The version of file to delete; initial version of file has value of <code>0, second version of file is <code>1 and so on."), @ApiMethod(methodName = "downloadPreviousFileVersion", description="The version of file to download; initial version of file has value of <code>0, second version of file is <code>1 and so on."), @ApiMethod(methodName = "promoteFileVersion", description="The version of file to promote; initial version of file has value of <code>0, second version of file is <code>1 and so on.")})
