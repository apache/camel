...
public final class BoxFoldersManagerEndpointConfiguration extends BoxConfiguration {
    ...
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "getFolderInfo", description="The information fields to retrieve; if <code>null all information fields are retrieved."), @ApiMethod(methodName = "getFolderItems", description="The item fields to retrieve for each child item; if <code>null all item fields are retrieved.")})
    ...
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "getFolderItems", description="The maximum number of children to retrieve after the offset; if <code>null all child items are retrieved.")})
    private Long limit;
    @UriParam
    @ApiParam(optional = false, apiMethods = {@ApiMethod(methodName = "renameFolder", description="The new name of folder")})
    private String newFolderName;
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "copyFolder", description="The new name for copied folder; if <code>newName is <code>null, the copied folder has same name as the original."), @ApiMethod(methodName = "moveFolder", description="The new name of moved folder; if <code>newName is <code>null, the moved folder has same name as the original.")})
    private String newName;
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "getFolderItems", description="The index of first child item to retrieve; if <code>null all child items are retrieved.")})
    private Long offset;
    @UriParam
    ...
    private String[] path;
    @UriParam
    @ApiParam(optional = false, apiMethods = {@ApiMethod(methodName = "createFolderSharedLink", description="The permissions of the created link; if <code>permissions is <code>null then the created shared link is create with default permissions.")})
    private com.box.sdk.BoxSharedLink.Permissions permissions;
    @UriParam
    @ApiParam(optional = false, apiMethods = {@ApiMethod(methodName = "createFolderSharedLink", description="The date and time at which time the created shared link will expire; if <code>unsharedDate is <code>null then a non-expiring link is created.")})
