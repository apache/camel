...
public final class SpringIntegrationBinding {
    ...
    public static org.springframework.integration.Message<Object> createSpringIntegrationMessage(Exchange exchange) {
        return createSpringIntegrationMessage(exchange, exchange.getIn().getHeaders());
    }

    public static org.springframework.integration.Message<Object> createSpringIntegrationMessage(Exchange exchange, Map<String, Object> headers) {
