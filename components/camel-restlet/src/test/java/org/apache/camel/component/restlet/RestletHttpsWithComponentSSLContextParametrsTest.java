...
public class RestletHttpsWithComponentSSLContextParametrsTest extends RestletTestSupport {
	...
	protected RouteBuilder createRouteBuilder() {
		return new RouteBuilder() {
			...
			public void configure() throws Exception {
				...
				from("restlet-SSL:https://localhost:" + portNum + "/users/SSL?restletMethods=post")
				...
				from("restlet-withGlobalSSL:https://localhost:" + (portNum + 1) + "/users/globalSSL?restletMethods=post")
						.process(new Processor() {
							public void process(Exchange exchange) throws Exception {
								convertBody(exchange);
							}
	...
	public void testComponentGlobalSSLContextParametrs() throws Exception {
		//test that ssl context set for component has bigger priority than global context
