 ...
 * @version 
 */
public class RestRestletGetAutoDiscoverComponentTest extends RestletTestSupport {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                restConfiguration().port(portNum).endpointProperty("restletBinding", "#myBinding");
