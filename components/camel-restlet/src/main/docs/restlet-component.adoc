...
| *camel.component.restlet.controller-daemon* | Indicates if the controller thread should be a daemon (not blocking JVM
 exit). |  | boolean
| *camel.component.restlet.controller-sleep-time-ms* | Time for the controller thread to sleep between each control. |  | int
...
| *camel.component.restlet.inbound-buffer-size* | The size of the buffer when reading messages. |  | int
| *camel.component.restlet.low-threads* | Number of worker threads determining when the connector is considered
 overloaded. |  | int
| *camel.component.restlet.max-connections-per-host* | Maximum number of concurrent connections per host (IP address). |  | int
| *camel.component.restlet.max-queued* | Maximum number of calls that can be queued if there aren't any worker
 ...
 rejected. |  | int
| *camel.component.restlet.max-threads* | Maximum threads that will service requests. |  | int
| *camel.component.restlet.max-total-connections* | Maximum number of concurrent connections in total. |  | int
| *camel.component.restlet.min-threads* | Minimum threads waiting to service requests. |  | int
| *camel.component.restlet.outbound-buffer-size* | The size of the buffer when writing messages. |  | int
...
| *camel.component.restlet.port* | To configure the port number for the restlet consumer routes. This allows
 to configure this once to reuse the same port for these consumers. |  | int
...
| *camel.component.restlet.thread-max-idle-time-ms* | Time for an idle thread to wait for an operation before being collected. |  | int
