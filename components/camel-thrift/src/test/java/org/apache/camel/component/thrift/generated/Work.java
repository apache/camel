...
public class Work implements TBase<Work, Work._Fields>, Serializable, Cloneable, Comparable<Work> {
    ...
    private static final TField OP_FIELD_DESC
            = new TField("op", TType.I32, (short) 3);
    private static final TField COMMENT_FIELD_DESC
            = new TField("comment", TType.STRING, (short) 4);

    private static final SchemeFactory STANDARD_SCHEME_FACTORY = new WorkStandardSchemeFactory();
    private static final SchemeFactory TUPLE_SCHEME_FACTORY = new WorkTupleSchemeFactory();
     ...
     * @see Operation
     */
    public @Nullable Operation op; // required
    public @Nullable java.lang.String comment; // optional
    ...
    static {
        ...
        tmpMap.put(_Fields.OP,
                new FieldMetaData(
                        "op", TFieldRequirementType.DEFAULT,
                        new EnumMetaData(TType.ENUM, Operation.class)));
        tmpMap.put(_Fields.COMMENT,
                new FieldMetaData(
                        "comment", TFieldRequirementType.OPTIONAL,
     ...
     * @see Operation
     */
    public Work setOp(@Nullable Operation op) {
        this.op = op;
        return this;
    }
    ...
    public Work setComment(@Nullable java.lang.String comment) {
    ...
    private static class WorkStandardScheme extends StandardScheme<Work> {
        ...
        @Override
        public void read(TProtocol iprot, Work struct) throws TException {
            TField schemeField;
        ...
        @Override
        public void write(TProtocol oprot, Work struct) throws TException {
            struct.validate();
    ...
    private static class WorkTupleScheme extends TupleScheme<Work> {
        ...
        @Override
        public void write(TProtocol prot, Work struct) throws TException {
        ...
        @Override
        public void read(TProtocol prot, Work struct) throws TException {
