...
public final class ThriftUtils {
    ...
    @SuppressWarnings("rawtypes")
    public static Class getServerInterface(
            String packageName, String serviceName, boolean isSyncInterface, final CamelContext context) {
    ...
    /**
     * The function find onComplete method inside interface implementation and get fist parameter (but not Object.class)
     * as return type
     */
    @SuppressWarnings("rawtypes")
