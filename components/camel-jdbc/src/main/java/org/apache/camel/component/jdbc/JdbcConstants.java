...
public final class JdbcConstants {
    ...
    @Metadata(
            label = "producer",
            description = "If the query is an `UPDATE`, query the update count is returned in this\n" + "OUT header.",
            javaType = "int")
    public static final String JDBC_UPDATE_COUNT = "CamelJdbcUpdateCount";

    @Metadata(
            label = "producer",
            description = "If the query is a `SELECT`, query the row count is returned in this OUT\n" + "header.",
            javaType = "int")
    public static final String JDBC_ROW_COUNT = "CamelJdbcRowCount";

    @Metadata(
            label = "producer",
            description = "The column names from the ResultSet as a `java.util.Set`\n" + "type.",
            javaType = "Set<String>")
    public static final String JDBC_COLUMN_NAMES = "CamelJdbcColumnNames";

    @Metadata(
            label = "producer",
            description = "A `java.util.Map` which has the headers to be used if\n"
    ...
    @Metadata(
            label = "producer",
            description = "The number of rows in the header that contains generated\n" + "keys.",
            javaType = "int")
    ...
    @Metadata(
            label = "producer",
            description = "Rows that contains the generated keys.",
