...
The AWS Identity and Access Management (IAM) component supports 11 options, which are listed below.
...
include::{page-component-version}@camel-spring-boot::page$aws-iam-starter.adoc[]
