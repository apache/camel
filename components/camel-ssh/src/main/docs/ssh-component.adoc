...
| *certFilename* (security) | *Deprecated* Sets the resource path of the certificate to use for Authentication. Deprecation note: As of version 2.11, replaced by certResource. |  | String
