...
public class SipComponent extends UriEndpointComponent {
    ...
    /**
     * The logger for this class. It will log the parameters given when creating a sip endpoint.
     */
    ...
    /**
     * Constructs a SipEndpoint
     * @param uri the full URI of the endpoint
     * @param remaining the remaining part of the URI without the query
     *                parameters or component prefix
     * @param parameters the optional parameters passed in
     * @return a SipEndpoint
     * @throws Exception when setting up the properties of the SipEndpoint goes wrong
     */
    @Override
    protected Endpoint createEndpoint(String uri, String remaining, Map<String, Object> parameters) throws Exception {
        ...
        LOG.trace("Creating endpoint with uri: {} remaining: {} parameters: {}", uri, remaining, parametersString);
