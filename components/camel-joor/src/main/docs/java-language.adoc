...
Under the hood, Camel Java generates the following source code that is compiled once:
...
The Java language have special support for defining an `org.apache.camel.AggregationStrategy` as a lambda expression.
