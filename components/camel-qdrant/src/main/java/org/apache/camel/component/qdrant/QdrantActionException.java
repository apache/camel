...
public class QdrantActionException extends Exception {
    ...
    public QdrantActionException(QdrantAction action, String message) {
        super(message);
        this.action = action;
    }

    public QdrantActionException(QdrantAction action, String message, Throwable cause) {
        super(message, cause);
        this.action = action;
    }

    public QdrantActionException(QdrantAction action, Throwable cause) {
        super(cause);
        this.action = action;
    }
