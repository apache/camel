...
public class TagConsumer extends AbstractGitHub2Consumer {
    ...
    public TagConsumer(GitHub2Endpoint endpoint, Processor processor) {
    ...
    protected void doStart() throws Exception {
        ...
        for (GHTag tag : getRepository().listTags()) {
    ...
    protected int poll() throws Exception {
        ...
        ArrayDeque<GHTag> newTags = new ArrayDeque<>();
        for (GHTag tag : getRepository().listTags()) {
