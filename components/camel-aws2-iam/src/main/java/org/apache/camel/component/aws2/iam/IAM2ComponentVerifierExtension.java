...
public class IAM2ComponentVerifierExtension extends DefaultComponentVerifierExtension {

    public IAM2ComponentVerifierExtension() {
        this("aws2-iam");
    }

    public IAM2ComponentVerifierExtension(String scheme) {
        super(scheme);
    }
