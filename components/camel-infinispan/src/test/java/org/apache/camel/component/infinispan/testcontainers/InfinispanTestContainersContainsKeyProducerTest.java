...
public class InfinispanTestContainersContainsKeyProducerTest extends InfinispanTestContainerSupport {
    ...
    public void testUriCommandOption() throws Exception {
        ...
        Exchange exchange;
        exchange = template.send("direct:containsKey", new Processor() {
            @Override
            public void process(Exchange exchange) throws Exception {
                exchange.getIn().setHeader(InfinispanConstants.KEY, COMMAND_KEY);
            }
