...
@Component(InfinispanRemoteComponent.SCHEME)
public class InfinispanRemoteComponent extends InfinispanComponent {
    ...
    protected Endpoint createEndpoint(String uri, String remaining, Map<String, Object> parameters) throws Exception {
        InfinispanRemoteConfiguration conf = configuration.clone();
        InfinispanRemoteEndpoint endpoint = new InfinispanRemoteEndpoint(uri, remaining, this, conf);
