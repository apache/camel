...
| *camel.component.infinispan.configuration.cache-container* | null |  | BasicCacheContainer
...
| *camel.component.infinispan.configuration.clustered-listener* | null | false | boolean
...
| *camel.component.infinispan.configuration.configuration-uri* | null |  | String
| *camel.component.infinispan.configuration.custom-listener* | null |  | InfinispanCustomListener
...
| *camel.component.infinispan.configuration.flags* | null |  | Flag[]
| *camel.component.infinispan.configuration.hosts* | null |  | String
...
| *camel.component.infinispan.configuration.sync* | null | true | boolean
