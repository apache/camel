...
public class RaspberryConsumer extends DefaultConsumer implements GpioPinListenerDigital, GpioPinListenerAnalog {
    ...
    private final RaspberryEndpoint endpoint;
     ...
     * @param state
     */
    public RaspberryConsumer(RaspberryEndpoint endpoint, Processor processor, GpioPin pin, PinState state) {
    ...
    public void handleGpioPinAnalogValueChangeEvent(GpioPinAnalogValueChangeEvent event) {
        ...
        exchange.getIn().setHeader(RaspberryConstants.PI4J_PIN, event.getPin());
        exchange.getIn().setHeader(RaspberryConstants.PI4J_VALUE, event.getValue());
        exchange.getIn().setHeader(RaspberryConstants.PI4J_TYPE, event.getEventType());
    ...
    public void handleGpioPinDigitalStateChangeEvent(GpioPinDigitalStateChangeEvent event) {
        ...
        exchange.getIn().setHeader(RaspberryConstants.PI4J_PIN, event.getPin());
        exchange.getIn().setHeader(RaspberryConstants.PI4J_STATE, event.getState());
        exchange.getIn().setHeader(RaspberryConstants.PI4J_TYPE, event.getEventType());
