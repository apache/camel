...
public class MongoDbIndexTest extends AbstractMongoDbTest {
    ...
    public void testInsertDynamicityEnabledDBAndCollectionAndIndex() {
        ...
        assertFalse("The otherDB database should not exist",
                StreamSupport.stream(mongo.getDatabaseNames().spliterator(), false)
        ...
        Iterator<DBObject> iterator = indexInfos.iterator();
        iterator.next();
        ...
        DBObject b = dynamicCollection.findOne(new BasicDBObject("_id", "testInsertDynamicityEnabledDBAndCollection"));
        assertNotNull("No record with 'testInsertDynamicityEnabledDBAndCollection' _id", b);

        b = testCollection.findOne(new BasicDBObject("_id", "testInsertDynamicityEnabledDBOnly"));
    ...
    public void testInsertDynamicityEnabledCollectionAndIndex() {
        ...
        Iterator<DBObject> indexInfos = dynamicCollection.getIndexInfo().iterator();
        ...
        DBObject b = dynamicCollection.findOne(new BasicDBObject("_id", "testInsertDynamicityEnabledCollectionAndIndex"));
    ...
    public void testInsertDynamicityEnabledCollectionOnlyAndURIIndex() {
        ...
        DBObject b = dynamicCollection.findOne(new BasicDBObject("_id", "testInsertDynamicityEnabledCollectionOnlyAndURIIndex"));
        assertNotNull("No record with 'testInsertDynamicityEnabledCollectionOnlyAndURIIndex' _id", b);

        b = testCollection.findOne(new BasicDBObject("_id", "testInsertDynamicityEnabledCollectionOnlyAndURIIndex"));
    ...
    public void testInsertAutoCreateCollectionAndURIIndex() {
        ...
        Iterator<DBObject> indexInfos = collection.getIndexInfo().iterator();
        ...
        DBObject b = collection.findOne(new BasicDBObject("_id", "testInsertAutoCreateCollectionAndURIIndex"));
        assertNotNull("No record with 'testInsertAutoCreateCollectionAndURIIndex' _id", b);

        b = testCollection.findOne(new BasicDBObject("_id", "testInsertAutoCreateCollectionAndURIIndex"));
        ...
        return new RouteBuilder() {
            public void configure() {
                from("direct:dynamicityEnabled")
                        .to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=insert&dynamicity=true&writeConcern=SAFE");
                from("direct:dynamicityEnabledWithIndexUri")
                        .to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&collectionIndex={\"a\":1}&operation=insert&dynamicity=true&writeConcern=SAFE");
                from("direct:dynamicityDisabled")
                        .to("mongodb2:myDb?database={{mongodb.testDb}}&collection=otherCollection&collectionIndex={\"a\":1,\"b\":-1}&operation=insert&dynamicity=false&writeConcern=SAFE");
            }
        };
    }
}
