...
public class MongoDbConversionsTest extends AbstractMongoDbTest {
    ...
    public void testInsertMap() throws InterruptedException {
        ...
        DBObject b = testCollection.findOne(new BasicDBObject("_id", "testInsertMap"));
    ...
    public void testInsertPojo() {
        ...
        DBObject b = testCollection.findOne(new BasicDBObject("_id", "testInsertPojo"));
    ...
    public void testInsertJsonString() {
        ...
        DBObject b = testCollection.findOne(new BasicDBObject("_id", "testInsertJsonString"));
    ...
    public void testInsertBsonInputStream() {
        ...
        DBObject b = testCollection.findOne(new BasicDBObject("_id", "testInsertBsonString"));
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                ...
                from("direct:insertMap").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=insert");
                from("direct:insertPojo").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=insert");
                from("direct:insertJsonString").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=insert");
                from("direct:insertJsonStringWriteResultInString").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=insert").convertBodyTo(String.class);
