...
public class MongoDbReadPreferenceOptionTest extends AbstractMongoDbTest {
    ...
    public void testInvalidReadPreferenceOptionValue() throws Exception {
        try {
            createMongoDbEndpoint("mongodb2:myDb?database={{mongodb.testDb}}&readPreference=foo");
    ...
    public void testNoReadPreferenceOptionValue() throws Exception {
        endpoint = createMongoDbEndpoint("mongodb2:myDb?database={{mongodb.testDb}}");
    ...
    public void testPrimaryReadPreferenceOptionValue() throws Exception {
        endpoint = createMongoDbEndpoint("mongodb2:myDb?database={{mongodb.testDb}}&readPreference=primary");
    ...
    public void testPrimaryPreferredReadPreferenceOptionValue() throws Exception {
        endpoint = createMongoDbEndpoint("mongodb2:myDb?database={{mongodb.testDb}}&readPreference=primaryPreferred");
    ...
    public void testSecondaryReadPreferenceOptionValue() throws Exception {
        endpoint = createMongoDbEndpoint("mongodb2:myDb?database={{mongodb.testDb}}&readPreference=secondary");
    ...
    public void testSecondaryPreferredReadPreferenceOptionValue() throws Exception {
        endpoint = createMongoDbEndpoint("mongodb2:myDb?database={{mongodb.testDb}}&readPreference=secondaryPreferred");
    ...
    public void testNearestReadPreferenceOptionValue() throws Exception {
        endpoint = createMongoDbEndpoint("mongodb2:myDb?database={{mongodb.testDb}}&readPreference=nearest");
    ...
    private MongoDbEndpoint createMongoDbEndpoint(String uri) throws Exception {
        Endpoint endpoint = context().getComponent("mongodb2").createEndpoint(uri);
        endpoint.start();
