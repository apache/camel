...
public class MongoDbDynamicityTest extends AbstractMongoDbTest {
    ...
    public void testInsertDynamicityDisabled() {
        ...
        DBObject b = testCollection.findOne(new BasicDBObject("_id", "testInsertDynamicityDisabled"));
        ...
        b = testCollection.findOne(new BasicDBObject("_id", "testInsertDynamicityDisabledExplicitly"));
    ...
    public void testInsertDynamicityEnabledDBOnly() {
        ...
        DBObject b = dynamicCollection.findOne(new BasicDBObject("_id", "testInsertDynamicityEnabledDBOnly"));
    ...
    public void testInsertDynamicityEnabledCollectionOnly() {
        ...
        DBObject b = dynamicCollection.findOne(new BasicDBObject("_id", "testInsertDynamicityEnabledCollectionOnly"));
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                ...
                from("direct:noDynamicity").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=insert&writeConcern=SAFE");
                from("direct:noDynamicityExplicit").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=insert&dynamicity=false&writeConcern=SAFE");
                from("direct:dynamicityEnabled").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=insert&dynamicity=true&writeConcern=SAFE");
