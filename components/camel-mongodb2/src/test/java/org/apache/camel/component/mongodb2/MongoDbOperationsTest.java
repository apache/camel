...
public class MongoDbOperationsTest extends AbstractMongoDbTest {
    ...
    public void testCountOperation() throws Exception {
        ...
        testCollection.insert((BasicDBObject) JSON.parse("{a:60}"));
        ...
        // test dynamicity
        dynamicCollection.insert((BasicDBObject) JSON.parse("{a:60}"));
    ...
    public void testSave() throws Exception {
        ...
        DBObject record1 = testCollection.findOne(new BasicDBObject("_id", "testSave1"));
        ...
        record1 = testCollection.findOne(new BasicDBObject("_id", "testSave1"));
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                ...
                from("direct:testStoreOidOnInsert").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=insert&writeConcern=SAFE").
                    setBody().header(MongoDbConstants.OID);
                from("direct:save").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=save&writeConcern=SAFE");
                from("direct:testStoreOidOnSave").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=save&writeConcern=SAFE").
                    setBody().header(MongoDbConstants.OID);
                from("direct:update").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=update&writeConcern=SAFE");
                from("direct:remove").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=remove&writeConcern=SAFE");
                from("direct:aggregate").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=aggregate&writeConcern=SAFE");
                from("direct:getDbStats").to("mongodb2:myDb?database={{mongodb.testDb}}&operation=getDbStats");
                from("direct:getColStats").to("mongodb2:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=getColStats");
                from("direct:command").to("mongodb2:myDb?database={{mongodb.testDb}}&operation=command");
