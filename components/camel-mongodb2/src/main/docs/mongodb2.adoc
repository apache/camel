...
<dependency>
    ...
    <artifactId>camel-mongodb2</artifactId>
...
The MongoDB2 component has no options.
...
The MongoDB2 component supports 22 endpoint options which are listed below:
