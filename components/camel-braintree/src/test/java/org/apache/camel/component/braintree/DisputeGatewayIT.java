...
public class DisputeGatewayIT extends AbstractBraintreeTestSupport {
    ...
    private static final String PATH_PREFIX = BraintreeApiCollection.getCollection()
            .getApiName(DisputeGatewayApiMethod.class)
            .getName();
    private static final String TRANSACTION_PATH_PREFIX = BraintreeApiCollection.getCollection()
            .getApiName(TransactionGatewayApiMethod.class)
            .getName();
    private static final String DOCUMENT_UPLOAD_PATH_PREFIX = BraintreeApiCollection.getCollection()
    ...
    public void testRemoveEvidence() {
        ...
        final Result<DisputeEvidence> addTextEvidenceResult =
                requestBodyAndHeaders("direct://ADDTEXTEVIDENCE", null, addTextEvidenceHeaders);
        ...
        final Result removeTextEvidenceResult =
                requestBodyAndHeaders("direct://REMOVEEVIDENCE", null, removeTextEvidenceHeaders);
