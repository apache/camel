...
public final class TransactionGatewayEndpointConfiguration extends BraintreeConfiguration {
    ...
    @UriParam
    @ApiParam(optional = false, apiMethods = {@ApiMethod(methodName = "voidTransaction", description="The request. Request can be null. Request is used to support idempotency.")})
    ...
    public void setVoidRequest(com.braintreegateway.TransactionVoidRequest voidRequest) {
