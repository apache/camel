...
In addition to the parameters above, the address API can also use from the 13 endpoint query option
...
In addition to the parameters above, the clientToken API can also use from the 13 endpoint query option
which is listed in the _Query Parameters_ section.
...
In addition to the parameters above, the creditCardVerification API can also use from the 13 endpoint query option
which is listed in the _Query Parameters_ section.
...
In addition to the parameters above, the customer API can also use from the 13 endpoint query option
which is listed in the _Query Parameters_ section.
...
In addition to the parameters above, the dispute API can also use from the 13 endpoint query option
which is listed in the _Query Parameters_ section.
...
In addition to the parameters above, the documentUpload API can also use from the 13 endpoint query option
which is listed in the _Query Parameters_ section.
...
In addition to the parameters above, the merchantAccount API can also use from the 13 endpoint query option
which is listed in the _Query Parameters_ section.
...
In addition to the parameters above, the paymentMethod API can also use from the 13 endpoint query option
which is listed in the _Query Parameters_ section.
...
In addition to the parameters above, the paymentMethodNonce API can also use from the 13 endpoint query option
which is listed in the _Query Parameters_ section.
...
In addition to the parameters above, the report API can also use from the 13 endpoint query option
which is listed in the _Query Parameters_ section.
...
In addition to the parameters above, the settlementBatchSummary API can also use from the 13 endpoint query option
which is listed in the _Query Parameters_ section.
...
In addition to the parameters above, the subscription API can also use from the 13 endpoint query option
which is listed in the _Query Parameters_ section.
...
The transaction API has 14 method(s) which is represented by the following method signatures
(an API method may have multiple signatures due to overloading):
...
The 14 method(s) is listed in the table below.
(API methods can have a shorthand alias name which can be used in the syntax instead of the name)

[width="100%",cols="2,2,6",options="header"]
|===
| Method | Alias | Description
| *adjustAuthorization* |  | Submits the transaction with the given id to be adjusted for the given amount which must be less than or equal to the authorization amount
...
|===
| Method | Parameter | Description | Type
| adjustAuthorization | *amount* |  To be adjusted | BigDecimal
| adjustAuthorization | *id* |  Of the transaction to to be adjusted | String
| adjustAuthorization | *request* |  Is the TransactionRequest object with amount details | TransactionRequest
...
In addition to the parameters above, the transaction API can also use from the 13 endpoint query option
which is listed in the _Query Parameters_ section.
...
The webhookNotification API has 3 method(s) which is represented by the following method signatures
(an API method may have multiple signatures due to overloading):
...
| parseWithoutSignatureVerification | *payload* |   | String
| verify | *challenge* |   | String
|===

In addition to the parameters above, the webhookNotification API can also use from the 13 endpoint query option
which is listed in the _Query Parameters_ section.
