...
public class CamelSpringTestContextLoaderTestExecutionListener extends AbstractTestExecutionListener {
    ...
    /**
     * The default implementation returns {@link org.springframework.core.Ordered#LOWEST_PRECEDENCE}, thereby ensuring
     * that custom listeners are ordered after default listeners supplied by the framework. Can be overridden by
