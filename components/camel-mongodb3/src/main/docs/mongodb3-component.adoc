...
`Bson`. It can be a JSON String or a Hashmap. See xref:mongodb3-component.adoc[#Type conversions] for more info.
...
message body, i.e. it should be of type `Bson` or convertible to
`Bson`. It can be
a JSON String or a Hashmap. See xref:mongodb3-component.adoc[#Type conversions] for
more info.
