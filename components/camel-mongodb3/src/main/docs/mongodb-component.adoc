...
| outputType | common |  | MongoDbOutputType | Convert the output of the producer to the selected type : DocumentList Document or MongoIterable (cursor). DocumentList or Document applies to findAll. MongoIterable applies to all other operations.
