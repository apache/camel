...
public class KubernetesHPAConsumerClusterwideIT extends KubernetesConsumerTestSupport {
    @Test
    public void clusterWideTest() throws Exception {
        result.expectedBodiesReceivedInAnyOrder(
                "HorizontalPodAutoscaler hpa1 " + ns1 + " ADDED", "HorizontalPodAutoscaler hpa2 " + ns2 + " ADDED");

        createHPA(ns1, "hpa1", null);
        createHPA(ns2, "hpa2", null);
