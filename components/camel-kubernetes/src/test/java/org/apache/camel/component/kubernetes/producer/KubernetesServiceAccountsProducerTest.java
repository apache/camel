...
public class KubernetesServiceAccountsProducerTest extends KubernetesTestSupport {
    ...
    void listTest() {
        server.expect()
                .withPath("/api/v1/serviceaccounts")
                .andReturn(
                        200,
                        new ServiceAccountListBuilder()
                                .addNewItem()
                                .and()
                                .addNewItem()
                                .and()
    ...
    void listByLabelsTest() throws Exception {
        ...
        server.expect()
                .withPath("/api/v1/serviceaccounts?labelSelector=" + urlEncodedLabels)
                .andReturn(
                        200,
                        new ServiceAccountListBuilder()
                                .addNewItem()
                ...
                .once();
        server.expect()
                .withPath("/api/v1/namespaces/test/serviceaccounts?labelSelector=" + urlEncodedLabels)
                .andReturn(
                        200,
                        new ServiceAccountListBuilder()
                                .addNewItem()
        ...
        Exchange ex = template.request("direct:listByLabels", exchange -> exchange.getIn()
                .setHeader(KubernetesConstants.KUBERNETES_SERVICE_ACCOUNTS_LABELS, labels));
    ...
    void createServiceAccount() {
        ServiceAccount sa1 = new ServiceAccountBuilder()
                .withNewMetadata()
                .withName("sa1")
                .withNamespace("test")
                .and()
    ...
    void updateServiceAccount() {
        ...
        server.expect()
                .get()
                .withPath("/api/v1/namespaces/test/serviceaccounts/sa1")
                .andReturn(200, sa1)
                .once();
        server.expect()
                .put()
    ...
    public void getServiceAccount() {
        ...
        server.expect()
                .get()
                .withPath("/api/v1/namespaces/" + ns + "/serviceaccounts/" + name)
                .andReturn(200, sa)
                .once();
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:list")
                        .to(
                                "kubernetes-service-accounts:///?kubernetesClient=#kubernetesClient&operation=listServiceAccounts");
                ...
                from("direct:get")
                        .to(
                                "kubernetes-service-accounts:///?kubernetesClient=#kubernetesClient&operation=getServiceAccount");
            }
        };
    }
}
