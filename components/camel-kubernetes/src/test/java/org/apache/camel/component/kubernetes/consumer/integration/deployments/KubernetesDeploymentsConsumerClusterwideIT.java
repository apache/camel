...
public class KubernetesDeploymentsConsumerClusterwideIT extends KubernetesConsumerTestSupport {
    @Test
    public void clusterWideTest() {
        ...
        Awaitility.await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> {
            ...
            assertThat(list, allOf(hasItem(containsString("d1")), hasItem(containsString("d2"))));
        });
