...
public class KubernetesPersistentVolumesClaimsProducerTest extends KubernetesTestSupport {
    ...
    void listTest() {
        server.expect()
                .withPath("/api/v1/persistentvolumeclaims")
                .andReturn(
                        200,
                        new PersistentVolumeClaimListBuilder()
                                .addNewItem()
                                .and()
                                .addNewItem()
                                .and()
                ...
                .once();
        server.expect()
                .withPath("/api/v1/namespaces/test/persistentvolumeclaims")
                .andReturn(
                        200,
                        new PersistentVolumeClaimListBuilder()
                                .addNewItem()
    ...
    void listByLabelsTest() throws Exception {
        ...
        server.expect()
                .withPath("/api/v1/persistentvolumeclaims?labelSelector=" + urlEncodedLabels)
                .andReturn(
                        200,
                        new PersistentVolumeClaimListBuilder()
                                .addNewItem()
                ...
                .once();
        server.expect()
                .withPath("/api/v1/namespaces/test/persistentvolumeclaims?labelSelector=" + urlEncodedLabels)
                .andReturn(
                        200,
                        new PersistentVolumeClaimListBuilder()
                                .addNewItem()
    ...
    void createPersistentVolumeClaim() {
        ...
        PersistentVolumeClaimSpec spec = new PersistentVolumeClaimSpecBuilder()
                .withVolumeName("SomeVolumeName")
                .build();
        PersistentVolumeClaim vc1 = new PersistentVolumeClaimBuilder()
                .withNewMetadata()
                .withName("vc1")
                .withNamespace("test")
                .withLabels(labels)
    ...
    void updatePersistentVolumeClaim() {
        ...
        server.expect()
                .get()
                .withPath("/api/v1/namespaces/test/persistentvolumeclaims/vc1")
                .andReturn(
                        200,
    ...
    void deletePersistentVolumeClaim() {
        ...
        meta.setName("pvc1");
        server.expect()
                .withPath("/api/v1/namespaces/test/persistentvolumeclaims/pvc1")
                .andReturn(
                        200,
                        new PersistentVolumeClaimBuilder().withMetadata(meta).build())
                .once();
