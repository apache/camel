...
public class KubernetesConfigMapsConsumerClusterwideIT extends KubernetesConsumerTestSupport {
    @Test
    public void clusterWideTest() {
        ...
        Awaitility.await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> {
            ...
            assertThat(list, allOf(hasItem(containsString("cm1")), hasItem(containsString("cm2"))));
        });
    }
