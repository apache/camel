...
public class KubernetesConfigMapsConsumerNamespaceIT extends KubernetesConsumerTestSupport {
    @Test
    public void namespaceTest() {
        createConfigMap(ns1, "cm1", null);
        createConfigMap(ns2, "cm2", null);
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                fromF("kubernetes-config-maps://%s?oauthToken=%s&namespace=%s", host, authToken, ns2)
