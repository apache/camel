...
public class KubernetesReplicationControllersConsumerClusterwideIT extends KubernetesConsumerTestSupport {
    @Test
    public void clusterWideTest() {
        ...
        Awaitility.await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> {
            ...
            assertThat(list, allOf(hasItem(containsString("rc1")), hasItem(containsString("rc2"))));
        });
