...
public class KubernetesDeploymentsConsumerResourceNameIT extends KubernetesConsumerTestSupport {
    @Test
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                fromF("kubernetes-deployments://%s?oauthToken=%s&resourceName=%s&namespace=%s", host, authToken,
                        WATCH_RESOURCE_NAME,
                        ns2)
