...
public class SecretBinaryMountPropertiesFunctionTest extends KubernetesTestSupport {

    @Test
    @Order(1)
    public void secretMountPropertiesFunction() throws Exception {
        try (SecretBinaryPropertiesFunction cmf = new SecretBinaryPropertiesFunction()) {
