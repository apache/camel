...
public class KubernetesPodsConsumerClusterwideIT extends KubernetesConsumerTestSupport {
    @Test
    public void clusterWideTest() {
        ...
        Awaitility.await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> {
            ...
            assertThat(list, allOf(hasItem(containsString("pod1")), hasItem(containsString("pod2"))));
        });
    }
