...
public class KubernetesPodsConsumerLabelsIT extends KubernetesConsumerTestSupport {
    @Test
    public void labelsTest() {
        createPod(ns2, "pod1", null);
        createPod(ns2, "pod2", Map.of("otherKey", "otherValue"));
        createPod(ns1, "pod3", LABELS);
        createPod(ns2, "pod4", LABELS);
        ...
        Awaitility.await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> {
            ...
            assertThat(list, allOf(
                    ...
                    not(hasItem(containsString("pod2"))),
                    not(hasItem(containsString("pod3"))),
                    hasItem(containsString("pod4"))));
        });
    }
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                fromF("kubernetes-pods://%s?oauthToken=%s&namespace=%s&labelKey=%s&labelValue=%s",
