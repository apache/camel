...
public class KubernetesServicesConsumerClusterwideIT extends KubernetesConsumerTestSupport {
    @Test
    public void clusterWideTest() {
        ...
        Awaitility.await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> {
            ...
            assertThat(list, allOf(hasItem(containsString("svc1")), hasItem(containsString("svc2"))));
        });
    }
