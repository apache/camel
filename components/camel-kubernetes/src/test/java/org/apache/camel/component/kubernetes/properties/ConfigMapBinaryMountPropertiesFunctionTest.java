...
public class ConfigMapBinaryMountPropertiesFunctionTest extends KubernetesTestSupport {

    @Test
    @Order(1)
    public void configMapMountPropertiesFunction() throws Exception {
        try (ConfigMapBinaryPropertiesFunction cmf = new ConfigMapBinaryPropertiesFunction()) {
