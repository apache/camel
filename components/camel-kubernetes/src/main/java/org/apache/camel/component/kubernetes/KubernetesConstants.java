...
public final class KubernetesConstants {
    ...
    @Metadata(
            label = "producer",
            description =
                    "The event time in ISO-8601 extended offset date-time format, such as '2011-12-03T10:15:30+01:00'.",
            javaType = "String",
            defaultValue = "server time",
            applicableFor = SCHEME_EVENTS)
    ...
    @Metadata(
            label = "producer",
            description = "The event regarding",
    ...
    @Metadata(
            label = "producer",
            description = "The event reporting controller",
            javaType = "String",
            applicableFor = SCHEME_EVENTS)
    ...
    @Metadata(
            label = "producer",
            description = "The event reporting instance",
            javaType = "String",
            applicableFor = SCHEME_EVENTS)
    ...
    @Metadata(
            label = "producer",
            description = "The secret annotations",
            javaType = "Map<String, String>",
            applicableFor = SCHEME_SECRETS)
    ...
    @Metadata(
            ...
            applicableFor = SCHEME_DEPLOYMENT_CONFIGS)
    ...
    @Metadata(
            label = "producer",
            description = "The Cronjob labels.",
            javaType = "Map<String, String>",
    ...
    @Metadata(
            label = "producer",
            description = "The Cron Job annotations.",
            javaType = "Map<String, String>",
            applicableFor = SCHEME_CRON_JOB)
