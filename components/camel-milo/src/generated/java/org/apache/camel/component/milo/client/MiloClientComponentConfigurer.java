...
public class MiloClientComponentConfigurer extends PropertyConfigurerSupport implements GeneratedPropertyConfigurer, PropertyConfigurerGetter {
    ...
    public boolean configure(CamelContext camelContext, Object obj, String name, Object value, boolean ignoreCase) {
        ...
        case "allowedSecurityPolicies": getOrCreateConfiguration(target).setAllowedSecurityPolicies(property(camelContext, String.class, value)); return true;
        case "applicationname":
        case "applicationName": getOrCreateConfiguration(target).setApplicationName(property(camelContext, String.class, value)); return true;
        case "applicationuri":
        case "applicationUri": getOrCreateConfiguration(target).setApplicationUri(property(camelContext, String.class, value)); return true;
        case "autowiredenabled":
        case "autowiredEnabled": target.setAutowiredEnabled(property(camelContext, boolean.class, value)); return true;
        case "bridgeerrorhandler":
        case "bridgeErrorHandler": target.setBridgeErrorHandler(property(camelContext, boolean.class, value)); return true;
        case "channellifetime":
        case "channelLifetime": getOrCreateConfiguration(target).setChannelLifetime(property(camelContext, Long.class, value)); return true;
        case "clientid":
        case "clientId": getOrCreateConfiguration(target).setClientId(property(camelContext, String.class, value)); return true;
        case "configuration": target.setConfiguration(property(camelContext, MiloClientConfiguration.class, value)); return true;
        case "discoveryendpointsuffix":
        case "discoveryEndpointSuffix": getOrCreateConfiguration(target).setDiscoveryEndpointSuffix(property(camelContext, String.class, value)); return true;
        case "discoveryendpointuri":
        case "discoveryEndpointUri": getOrCreateConfiguration(target).setDiscoveryEndpointUri(property(camelContext, String.class, value)); return true;
        case "keyalias":
        case "keyAlias": getOrCreateConfiguration(target).setKeyAlias(property(camelContext, String.class, value)); return true;
        case "keypassword":
        case "keyPassword": getOrCreateConfiguration(target).setKeyPassword(property(camelContext, String.class, value)); return true;
        case "keystorepassword":
        case "keyStorePassword": getOrCreateConfiguration(target).setKeyStorePassword(property(camelContext, String.class, value)); return true;
        case "keystoretype":
        case "keyStoreType": getOrCreateConfiguration(target).setKeyStoreType(property(camelContext, String.class, value)); return true;
        case "keystoreurl":
        case "keyStoreUrl": getOrCreateConfiguration(target).setKeyStoreUrl(property(camelContext, String.class, value)); return true;
        case "lazystartproducer":
        case "lazyStartProducer": target.setLazyStartProducer(property(camelContext, boolean.class, value)); return true;
        case "maxpendingpublishrequests":
        case "maxPendingPublishRequests": getOrCreateConfiguration(target).setMaxPendingPublishRequests(property(camelContext, Long.class, value)); return true;
        case "maxresponsemessagesize":
        case "maxResponseMessageSize": getOrCreateConfiguration(target).setMaxResponseMessageSize(property(camelContext, Long.class, value)); return true;
        case "miloclientconnectionmanager":
        case "miloClientConnectionManager": target.setMiloClientConnectionManager(property(camelContext, MiloClientConnectionManager.class, value)); return true;
        case "overridehost":
        case "overrideHost": getOrCreateConfiguration(target).setOverrideHost(property(camelContext, boolean.class, value)); return true;
        case "producturi":
        case "productUri": getOrCreateConfiguration(target).setProductUri(property(camelContext, String.class, value)); return true;
        case "requesttimeout":
        ...
        case "requestedPublishingInterval": getOrCreateConfiguration(target).setRequestedPublishingInterval(property(camelContext, Double.class, value)); return true;
        case "sessionname":
        case "sessionName": getOrCreateConfiguration(target).setSessionName(property(camelContext, String.class, value)); return true;
        case "sessiontimeout":
        case "sessionTimeout": getOrCreateConfiguration(target).setSessionTimeout(property(camelContext, Long.class, value)); return true;
    ...
    public Class<?> getOptionType(String name, boolean ignoreCase) {
        ...
        case "miloclientconnectionmanager":
        case "miloClientConnectionManager": return MiloClientConnectionManager.class;
        case "overridehost":
