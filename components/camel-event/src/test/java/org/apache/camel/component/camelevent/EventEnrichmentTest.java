...
public class EventEnrichmentTest extends CamelTestSupport {
    ...
    void testExchangeEventHeaders() throws Exception {
        ...
        mock.getExchanges().forEach(e -> {
            assertNotNull(e.getIn().getHeader("CamelEventExchangeId", String.class),
                    "CamelEventExchangeId should be set");
            assertEquals("enrichmentSourceRoute",
                    e.getIn().getHeader("CamelEventRouteId", String.class),
                    "CamelEventRouteId should be the source route ID");
            assertNotNull(e.getIn().getHeader("CamelEventEndpointUri", String.class),
                    "CamelEventEndpointUri should be set");
            assertTrue(e.getIn().getHeader("CamelEventEndpointUri", String.class).contains("direct://enrichmentSource"),
    ...
    void testExchangeSentHeaders() throws Exception {
        // ExchangeSent events are generated by SendProcessor when using to().
        // Subscribe to both ExchangeSent and ExchangeCompleted to verify both enrichment types.
        ...
        mock.getExchanges().forEach(e -> {
            ...
            assertNotNull(e.getIn().getHeader("CamelEventDuration", Long.class),
        ...
        boolean foundFailedEvent = mock.getExchanges().stream()
                .anyMatch(e -> {
                    ...
                    if ("ExchangeFailed".equals(eventType)) {
                        String exceptionMsg = e.getIn().getHeader("CamelEventException", String.class);
    ...
    void testRouteEventHeaders() throws Exception {
        ...
        // Route events should have CamelEventRouteId but NOT CamelEventExchangeId
        mock.getExchanges().forEach(e -> {
            assertNotNull(e.getIn().getHeader("CamelEventRouteId", String.class),
