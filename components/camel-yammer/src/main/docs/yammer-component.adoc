...
|===
| Name | Description | Default | Type
| *function* | *Required* The function to use. There are 9 enums and the value can be one of: messages, my-feed, algo, following, sent, private, received, users, current |  | YammerFunctionType
|===
