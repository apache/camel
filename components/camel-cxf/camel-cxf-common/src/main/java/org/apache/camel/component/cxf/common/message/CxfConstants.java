...
public final class CxfConstants {
    ...
    @Metadata(
            description = "The CXF message",
            javaType = "org.apache.cxf.message.Message",
            applicableFor = SCHEME_CXF_RS)
    ...
    @Metadata(
            description =
                    "The stack of MethodInvocationInfo representing resources path when JAX-RS invocation looks for target.",
