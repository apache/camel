...
public interface CxfRsBinding {
    ...
    /**
     * Populate the camel exchange from the CxfRsRequest, the exchange will be consumed by the processor which the
     * CxfRsConsumer attached.
     *
    ...
    /**
     * Bind the camel in message body to a request body that gets passed to CXF RS
