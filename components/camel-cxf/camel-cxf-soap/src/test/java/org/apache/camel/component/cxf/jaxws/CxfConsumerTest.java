...
public class CxfConsumerTest extends CamelTestSupport {
    protected static final String SIMPLE_ENDPOINT_ADDRESS =
            "http://localhost:" + CXFTestSupport.getPort1() + "/CxfConsumerTest/test";
    ...
    public void testXmlDeclaration() throws Exception {
        String response = template.requestBodyAndHeader(
                SIMPLE_ENDPOINT_ADDRESS, ECHO_REQUEST, Exchange.CONTENT_TYPE, "text/xml; charset=UTF-8", String.class);
