...
public class CxfConsumer extends DefaultConsumer implements Suspendable {
    ...
    protected Server createServer() throws Exception {
        ...
        if (ObjectHelper.isNotEmpty(cxfEndpoint.getPublishedEndpointUrl())) {
            ret.getEndpoint()
                    .getEndpointInfo()
                    .setProperty("publishedEndpointUrl", cxfEndpoint.getPublishedEndpointUrl());
        }
    ...
    private class CxfConsumerInvoker implements Invoker {
        ...
        private Continuation getContinuation(Exchange cxfExchange) {
            ...
            if (continuation != null
                    && continuation
                            .getClass()
                            .getName()
                            .equals("org.apache.cxf.transport.jms.continuations.JMSContinuation")) {
                return null;
            } else {
                return continuation;
            }
        ...
        private void setResponseBack(Exchange cxfExchange, org.apache.camel.Exchange camelExchange) {
            ...
            ((DefaultCxfBinding) binding)
                    .populateCxfHeaderFromCamelExchangeBeforeCheckError(camelExchange, cxfExchange);
            ...
            binding.copyJaxWsContext(
                    cxfExchange, (Map<String, Object>) camelExchange.getProperty(CxfConstants.JAXWS_CONTEXT));
        }
