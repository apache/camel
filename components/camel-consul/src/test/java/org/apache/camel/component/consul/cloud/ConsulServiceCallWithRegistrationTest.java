    ...
    public void testServiceCallSuccess() throws Exception {
        ...
        context.addRoutes(new RouteBuilder() {
            ...
            public void configure() {
                ...
                from("direct:start").serviceCall().name(serviceName).component("undertow").defaultLoadBalancer()
                        .consulServiceDiscovery().url(consulUrl()).end().end()
                        .log("${body}");
    ...
    public void testServiceCallFailure() throws Exception {
        ...
        context.addRoutes(new RouteBuilder() {
            ...
            public void configure() {
                ...
                // by jetty
                from("direct:start").serviceCall().name(serviceName + "/bad/path").component("http").defaultLoadBalancer()
                        .consulServiceDiscovery().url(consulUrl()).end().end()
                        .log("${body}");
