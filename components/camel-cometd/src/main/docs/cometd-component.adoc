...
| *logLevel* (common) | Logging level. 0=none, 1=info, 2=debug. There are 3 enums and the value can be one of: 0, 1, 2 | 1 | int
...
include::{page-component-version}@camel-spring-boot::page$cometd-starter.adoc[]
