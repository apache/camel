...
public class CometdProducerConsumerInteractiveExtensionManualTest {
    ...
    public static void main(String[] args) throws Exception {
        CometdProducerConsumerInteractiveExtensionManualTest me =
                new CometdProducerConsumerInteractiveExtensionManualTest();
    ...
    private RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            public void configure() throws URISyntaxException {
                ...
                URI keyStoreUrl = CometdProducerConsumerInteractiveExtensionManualTest.class
