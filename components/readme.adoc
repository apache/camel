...
`twitter-directmessage:endpointId` | 2.10 | The Twitter Direct Message Component consumes/produces user's direct messages.

| link:camel-twitter/src/main/docs/twitter-search-component.adoc[Twitter Search] (camel-twitter) +
`twitter-search:endpointId` | 2.10 | The Twitter Search component consumes search results.
