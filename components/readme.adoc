...
`pg-replication-slot:host:port/database/slot` | 2.25 | The pg-replication-slot component allows for consuming PostgreSQL Streaming Replication change events.
