...
| link:camel-debezium/camel-debezium-component/src/main/docs/debezium-component.adoc[Debezium] (camel-debezium) +
...
`graphql:httpUri?options` | 3.0 | A Camel GraphQL Component
...
| link:camel-aws-xray/src/main/docs/aws-xray.adoc[AWS XRay] (camel-aws-xray) | 2.21 | Distributed tracing using AWS XRay
