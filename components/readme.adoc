...
| link:@@@ARTIFACTID@@@/src/main/docs/sql-component.adoc[SQL] (@@@ARTIFACTID@@@) +
`sql:query` | 1.4 | The sql component allows you to work with databases using JDBC SQL queries.

| link:@@@ARTIFACTID@@@/src/main/docs/sql-stored-component.adoc[SQL Stored Procedure] (@@@ARTIFACTID@@@) +
