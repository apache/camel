...
// components: START
Number of Components: 347 in 268 JAR artifacts (27 deprecated)
...
`aws2-eks:label` | 3.1 | The aws-eks is used for managing Amazon EKS

| link:camel-aws2-mq/src/main/docs/aws2-mq-component.adoc[AWS 2 MQ] (camel-aws2-mq) +
`aws2-mq:label` | 3.1 | The aws-mq is used for managing Amazon MQ instances.
...
`weka:cmd` | 3.1 | The camel-weka component provides Data Mining functionality through Weka.
...
`workday:uri` | 3.1.0-SNAPSHOT | Represents a camel-workday endpoint.
