...
// components: START
Number of Components: 250 in 192 JAR artifacts (22 deprecated)
...
// dataformats: START
Number of Data Formats: 42 in 36 JAR artifacts (3 deprecated)
...
// languages: START
Number of Languages: 13 in 10 JAR artifacts (7 deprecated)
