...
// components: START
Number of Components: 323 in 244 JAR artifacts (25 deprecated)
...
// dataformats: START
Number of Data Formats: 55 in 44 JAR artifacts (6 deprecated)
...
// others: START
Number of Miscellaneous Components: 49 in 49 JAR artifacts (13 deprecated)
