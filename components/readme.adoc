...
| link:camel-bindy/src/main/docs/bindy-csv-dataformat.adoc[Bindy CSV] (camel-bindy) | Camel Bindy data format support

| link:camel-bindy/src/main/docs/bindy-fixed-dataformat.adoc[Bindy Fixed Length] (camel-bindy) | Camel Bindy data format support

| link:camel-bindy/src/main/docs/bindy-kvp-dataformat.adoc[Bindy Key Value Pair] (camel-bindy) | Camel Bindy data format support
...
| link:camel-protobuf/src/main/docs/protobuf-dataformat.adoc[Protobuf] (camel-protobuf) | Camel Components
