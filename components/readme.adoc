...
`dataset-test:name` | 1.3 | The test component extends the mock component by on startup to pull messages from another endpoint to set the expected message bodies.
...
| link:@@@ARTIFACTID@@@/src/main/docs/spring-event-component.adoc[Spring Event] (@@@ARTIFACTID@@@) +
