...
| link:camel-fhir/src/main/docs/fhir-json-dataformat.adoc[FHIR JSON] (camel-fhir) | 2.21 | The FHIR JSON data format is used to marshall/unmarshall to/from FHIR objects to/from JSON.

| link:camel-fhir/src/main/docs/fhir-xml-dataformat.adoc[FHIR XML] (camel-fhir) | 2.21 | The FHIR XML data format is used to marshall/unmarshall from/to FHIR objects to/from XML.
