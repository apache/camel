...
// components: START
Number of Components: 295 in 202 JAR artifacts (20 deprecated)
...
| link:camel-web3j/src/main/docs/web3j-component.adoc[Web3j client for Ethereum blockchain] (camel-web3j) +
