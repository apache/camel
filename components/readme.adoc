...
`webhook:endpointUri` | 3.0 | A meta-endpoint that pushes webhook data into a delegate WebhookCapableEndpoint.
...
// dataformats: START
Number of Data Formats: 46 in 36 JAR artifacts (0 deprecated)
...
| link:camel-jsonapi/src/main/docs/jsonApi-dataformat.adoc[jsonApi] (camel-jsonapi) | 3.0 | 
