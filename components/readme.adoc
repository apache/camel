...
`hazelcast:command:cacheName` | 2.7 | The hazelcast component allows you to work with the Hazelcast distributed data grid / cache.
...
| link:camel-mail/src/main/docs/mail-component.adoc[IMAP] (camel-mail) +
...
`infinispan:host` | 2.13 | For reading/writing from/to Infinispan distributed key/value store and data grid.
...
`krati:path` | 2.9 | The krati allows the use krati datastores and datasets inside Camel.
...
| link:camel-scala/src/main/docs/scala-dsl.adoc[Scala DSL] (camel-scala) | 1.4 | *deprecated* Camel Scala DSL

| link:camel-scr/src/main/docs/camel-and-scr.adoc[SCR] (camel-scr) | 2.15 | *deprecated* Camel with OSGi SCR (Declarative Services)
...
| link:camel-shiro/src/main/docs/shiro-security.adoc[Shiro] (camel-shiro) | 2.5 | Security using Shiro
...
| link:camel-spring-javaconfig/src/main/docs/spring-java-config.adoc[Spring Java Configuration] (camel-spring-javaconfig) | 2.0 | Using Camel with Spring Java Configuration
...
| link:camel-test-cdi/src/main/docs/cdi-testing.adoc[Test CDI] (camel-test-cdi) | 2.17 | Camel unit testing with CDI
