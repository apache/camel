...
Please use the xref:github2-component.adoc[GitHub2] component instead, which uses the official https://github.com/hub4j/github-api[GitHub API for Java] library.
====
