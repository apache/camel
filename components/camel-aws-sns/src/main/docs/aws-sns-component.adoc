...
The AWS Simple Notification System (SNS) component supports 19 options, which are listed below.
...
include::{page-component-version}@camel-spring-boot::page$aws-sns-starter.adoc[]
