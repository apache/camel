...
console renders the running routes using the interactive `<camel-route-diagram>` web component,
fed by the `route-structure` console. Request `?format=png` to get the legacy inline PNG image
