...
| *camel.component.stomp.configuration.ssl-context-parameters.camel-context* | null |  | CamelContext
| *camel.component.stomp.configuration.ssl-context-parameters.cert-alias* | null |  | String
| *camel.component.stomp.configuration.ssl-context-parameters.cipher-suites* | null |  | CipherSuitesParameters
| *camel.component.stomp.configuration.ssl-context-parameters.cipher-suites-filter* | null |  | FilterParameters
| *camel.component.stomp.configuration.ssl-context-parameters.client-parameters* | null |  | SSLContextClientParameters
| *camel.component.stomp.configuration.ssl-context-parameters.key-managers* | null |  | KeyManagersParameters
| *camel.component.stomp.configuration.ssl-context-parameters.provider* | null |  | String
| *camel.component.stomp.configuration.ssl-context-parameters.secure-random* | null |  | SecureRandomParameters
| *camel.component.stomp.configuration.ssl-context-parameters.secure-socket-protocol* | null |  | String
| *camel.component.stomp.configuration.ssl-context-parameters.secure-socket-protocols* | null |  | SecureSocketProtocolsParameters
| *camel.component.stomp.configuration.ssl-context-parameters.secure-socket-protocols-filter* | null |  | FilterParameters
| *camel.component.stomp.configuration.ssl-context-parameters.server-parameters* | null |  | SSLContextServerParameters
| *camel.component.stomp.configuration.ssl-context-parameters.session-timeout* | null |  | String
| *camel.component.stomp.configuration.ssl-context-parameters.trust-managers* | null |  | TrustManagersParameters
| *camel.component.stomp.enabled* | Enable stomp component | true | boolean
| *camel.component.stomp.header-filter-strategy* | To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter
...
| *camel.component.stomp.resolve-property-placeholders* | Whether the component should resolve property placeholders on itself when
