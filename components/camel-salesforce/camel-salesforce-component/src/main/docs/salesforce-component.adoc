...
[IMPORTANT]
====
Starting with Camel 4.18.3, when these parameters are supplied as *message headers*, the header names
...
the value change. See the Camel 4.18 upgrade guide for the full list of renamed header names.
====
