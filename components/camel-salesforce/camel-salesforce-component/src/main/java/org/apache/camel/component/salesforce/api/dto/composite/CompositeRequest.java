...
final class CompositeRequest implements Serializable {
    ...
    CompositeRequest(final Method method, final String url, String referenceId) {
        this.method = method;
        this.url = url;
    ...
    CompositeRequest(final Method method, final String url, final Object body, String referenceId) {
        this.method = method;
        this.url = url;
        this.body = body;
        this.referenceId = referenceId;
