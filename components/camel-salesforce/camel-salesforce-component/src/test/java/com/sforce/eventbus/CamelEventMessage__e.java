...
public class CamelEventMessage__e extends org.apache.avro.specific.SpecificRecordBase {
    ...
    private static final BinaryMessageEncoder<CamelEventMessage__e> ENCODER =
            new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

    private static final BinaryMessageDecoder<CamelEventMessage__e> DECODER =
     ...
     */
    public static CamelEventMessage__e fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
        ...
        if (fieldOrder == null) {
            ...
            for (int i = 0; i < 3; i++) {
                switch (fieldOrder[i].pos()) {
                    ...
                    case 1:
                        this.CreatedById =
                                in.readString(this.CreatedById instanceof Utf8 ? (Utf8) this.CreatedById : null);
                        break;
                    ...
                    case 2:
                        if (in.readIndex() != 1) {
                            ...
                            this.Message__c =
                                    in.readString(this.Message__c instanceof Utf8 ? (Utf8) this.Message__c : null);
                        }
                        break;
