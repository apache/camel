...
/**
 * Integration tests for salesforce change data capture event. To receive
 * notifications for record changes, objects must be selected in salesforce
 * setup for change data capture.
 * 
 * @TODO: Select Account for Change Data Capture via mvn setup
 *        setup-salesforce-instance, add it to manual installation
 * @TODO: Complete units test with change data capture
 */
public class ChangeEventsConsumerIntegrationTest extends AbstractSalesforceTestBase {
    ...
    public void createAccountShouldTriggerCreateEvent() {
