...
public class SubscriptionHelperManualIT {
  ...
  static class MessageArgumentMatcher implements ArgumentMatcher<Message> {
    ...
    public boolean matches(final Message message) {
      ...
      @SuppressWarnings("unchecked") final Map<String, Object> event = (Map<String, Object>) data.get(
          "event");
      @SuppressWarnings("unchecked") final Map<String, Object> sobject = (Map<String, Object>) data.get(
          "sobject");
