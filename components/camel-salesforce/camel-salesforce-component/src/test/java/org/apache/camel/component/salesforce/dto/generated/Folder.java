...
public class Folder extends AbstractDescribedSObjectBase {
    ...
    private QueryRecordsFolder SubFolders;

    @JsonProperty("SubFolders")
    public QueryRecordsFolder getSubFolders() {
        return SubFolders;
    }

    @JsonProperty("SubFolders")
    public void setSubFolders(QueryRecordsFolder SubFolders) {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 =
                createField("Id", "Folder ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        fields1.add(sObjectField1);
        final SObjectField sObjectField2 = createField(
                "ParentId", "Folder ID", "reference", "tns:ID", 18, false, true, false, false, false, false, false);
        fields1.add(sObjectField2);
        final SObjectField sObjectField3 =
                createField("Name", "Name", "string", "xsd:string", 40, false, false, true, false, false, false, true);
        ...
        final SObjectField sObjectField7 = createField(
                "Type", "Type", "picklist", "xsd:string", 40, false, false, false, false, false, false, false);
        ...
        sObjectDescriptionUrls1.setDescribe("/services/data/v59.0/sobjects/Folder/describe");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v59.0/sobjects/Folder/{ID}");
        sObjectDescriptionUrls1.setSobject("/services/data/v59.0/sobjects/Folder");
