...
public class Kinesis2Configuration implements Cloneable {
    ...
    @UriParam(
            ...
            description =
                    "The region in which Kinesis Firehose client needs to work. When using this parameter, the configuration will expect the lowercase name of the "
    ...
    @UriParam(
            ...
            defaultValue = "ignore",
            description =
                    "Define what will be the behavior in case of shard closed. Possible value are ignore, silent and fail."
    ...
    @UriParam(
            label = "security",
            description =
                    "Set whether the Kinesis client should expect to load credentials through a default credentials provider or to expect"
    ...
    @UriParam(
            label = "security",
            description =
                    "Set whether the Kinesis client should expect to use Session Credentials. This is useful in situation in which the user"
