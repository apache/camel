...
public class Aws2StsBase extends CamelTestSupport {
    @RegisterExtension
    public static AWSTestService service = AWSServiceFactory.createSTSService();

    @Override
    protected CamelContext createCamelContext() throws Exception {
        CamelContext context = super.createCamelContext();
        STS2Component stsComponent = context.getComponent("aws2-sts", STS2Component.class);
        stsComponent.getConfiguration().setStsClient(AWSSDKClientUtils.newSTSClient());
        return context;
    }
}
