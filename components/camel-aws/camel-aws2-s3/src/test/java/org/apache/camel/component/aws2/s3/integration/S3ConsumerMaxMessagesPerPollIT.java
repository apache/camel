...
public class S3ConsumerMaxMessagesPerPollIT extends Aws2S3Base {
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                from("aws2-s3://" + name.get()
                                + "?maxMessagesPerPoll=2&moveAfterRead=true&destinationBucket=camel-kafka-connector&autoCreateBucket=true&destinationBucketPrefix=RAW(movedPrefix)&destinationBucketSuffix=RAW(movedSuffix)")
                        .routeId("s3consumer")
                        .startupOrder(2)
                        .log("${body}")
                        .process(e -> {
