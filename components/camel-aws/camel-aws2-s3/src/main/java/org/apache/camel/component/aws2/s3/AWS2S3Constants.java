...
public interface AWS2S3Constants {
    ...
    @Metadata(
            description =
                    "The bucket Name (can be dynamic using the simple language in the producer) which this object will be stored or which will be used for the current operation or in which this object is contained.",
            javaType = "String")
    ...
    @Metadata(description = "Whether the bucket exists when using the headBucket operation", javaType = "boolean")
    String BUCKET_EXISTS = "CamelAwsS3BucketExists";

    @Metadata(
            description = "The *optional* Cache-Control HTTP header which allows the user to\n"
                    + "specify caching behavior along the HTTP request/reply chain.",
            javaType = "String")
    String CACHE_CONTROL = "CamelAwsS3ContentControl";

    @Metadata(
            description = "The *optional* Content-Disposition HTTP header, which specifies\n"
    ...
    @Metadata(
            description = "The *optional* Content-Encoding HTTP header specifying what content\n"
    ...
    @Metadata(
            description = "The Content-Length HTTP header indicating the size of the associated\n" + "object in bytes.",
            javaType = "Long")
    String CONTENT_LENGTH = "CamelAwsS3ContentLength";

    @Metadata(
            description = "The base64 encoded 128-bit MD5 digest of the associated object (content\n"
    ...
    @Metadata(
            description = "The Content-Type HTTP header, which indicates the type of content stored\n"
    ...
    @Metadata(
            description =
                    "The key (can be dynamic using the simple language in the producer) under which this object is stored or will be stored or which will be used for the current operation",
            javaType = "String")
    String KEY = "CamelAwsS3Key";

    @Metadata(
            label = "producer",
            description = "The computed key that was used for retrieving this object",
            javaType = "String")
    ...
    @Metadata(
            description = "The value of the Last-Modified header, indicating the date and time at\n"
    ...
    @Metadata(
            description = "(producer) The *optional* version ID of the newly uploaded object.\n"
    ...
    @Metadata(
            description = "Sets the server-side encryption algorithm when encrypting\n"
    ...
    @Metadata(
            label = "producer",
            description =
                    "The request payload that is needed by the service (not needed when BrowserCompatible is true)",
            javaType = "String")
    String DOWNLOAD_LINK_SIGNED_PAYLOAD = "CamelAwsS3DownloadLinkSignedPayload";

    @Metadata(
            description = "A map of metadata to be stored or stored with the object in S3. More details about\n"
    ...
    @Metadata(
            description =
                    "The prefix which is used in the com.amazonaws.services.s3.model.ListObjectsRequest to only list objects we are interested in")
    String PREFIX = "CamelAwsS3Prefix";

    @Metadata(
            description =
                    "The delimiter which is used in the com.amazonaws.services.s3.model.ListObjectsRequest to only list objects we are interested in",
            javaType = "String")
    String DELIMITER = "CamelAwsS3Delimiter";

    @Metadata(
            description =
                    "Return/copy the object only if its entity tag (ETag) is the same as the one specified in this header.",
            javaType = "String")
    String IF_MATCH_CONDITION = "CamelAwsS3IfMatchCondition";

    @Metadata(
            description =
                    "Return/copy the object only if it has been modified since the specified time; otherwise, return a 304 Not Modified error.",
            javaType = "String")
    String IF_MODIFIED_SINCE_CONDITION = "CamelAwsS3IfModifiedSinceCondition";

    @Metadata(
            description =
                    "Return/copy the object only if its entity tag (ETag) is different from the one specified in this header.",
            javaType = "String")
    String IF_NONE_MATCH_CONDITION = "CamelAwsS3IfNoneMatchCondition";

    @Metadata(
            description = "Return/copy the object only if it has not been modified since the specified time.",
            javaType = "String")
    String IF_UNMODIFIED_SINCE_CONDITION = "CamelAwsS3IfUnmodifiedSinceCondition";

    @Metadata(
            description =
                    "The bucket Name to override (can be dynamic using the simple language in the producer) which this object will be stored or which will be used for the current operation or in which this object is contained.",
            javaType = "String")
    ...
    @Metadata(
            label = "producer",
            description =
                    "The number of days for which the restore request will remain active when using restoreObject operation",
            javaType = "Integer")
    ...
    @Metadata(
            label = "producer",
            description =
                    "The tier at which the restore will be processed when using restoreObject operation (e.g., Standard, Bulk, Expedited)",
            javaType = "String")
    String RESTORE_TIER = "CamelAwsS3RestoreTier";

    @Metadata(
            label = "producer",
            description = "The object tags to set when using putObjectTagging operation",
            javaType = "Map<String, String>")
    String OBJECT_TAGS = "CamelAwsS3ObjectTags";

    @Metadata(
            label = "producer",
            description = "The bucket tags to set when using putBucketTagging operation",
            javaType = "Map<String, String>")
    String BUCKET_TAGS = "CamelAwsS3BucketTags";

    @Metadata(
            label = "producer",
            description = "The bucket policy as JSON string when using putBucketPolicy operation",
            javaType = "String")
    ...
    @Metadata(
            label = "producer",
            description = "Whether to enable MFA delete when using putBucketVersioning operation",
            javaType = "String")
    String MFA_DELETE = "CamelAwsS3MfaDelete";

    @Metadata(
            label = "producer",
            description = "The expiration time of the upload link in milliseconds",
            javaType = "Long")
    ...
    @Metadata(
            label = "producer",
            description =
                    "The headers that are needed by the service for upload (not needed when BrowserCompatible is true)",
            javaType = "Map<String, List<String>>")
    ...
    @Metadata(
            label = "producer",
            description =
                    "The request payload that is needed by the service for upload (not needed when BrowserCompatible is true)",
            javaType = "String")
