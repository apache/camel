...
public class AWS2S3ClientSessionTokenImpl implements AWS2CamelS3InternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(AWS2S3ClientSessionTokenImpl.class);
    ...
    public S3Client getS3Client() {
        ...
        if (configuration.getAccessKey() != null && configuration.getSecretKey() != null && configuration.getSessionToken() != null) {
