 ...
 * credential set.
 */
public class AWS2S3ClientIAMProfileOptimizedImpl implements AWS2CamelS3InternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(AWS2S3ClientIAMProfileOptimizedImpl.class);
    private AWS2S3Configuration configuration;

    /**
     * Constructor that uses the config file.
     */
    public AWS2S3ClientIAMProfileOptimizedImpl(AWS2S3Configuration configuration) {
