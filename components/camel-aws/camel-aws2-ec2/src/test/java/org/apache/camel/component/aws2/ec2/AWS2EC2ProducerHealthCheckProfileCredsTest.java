        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:listClusters")
                        .to(
                                "aws2-ec2://TestDomain?operation=describeInstances&region=l&useDefaultCredentialsProvider=true");
            }
        };
    }
    ...
    public void testConnectivity() {
        ...
        await().atMost(20, TimeUnit.SECONDS).untilAsserted(() -> {
            ...
            boolean containsAws2AthenaHealthCheck =
                    res2.stream().anyMatch(result -> result.getCheck().getId().startsWith("producer:aws2-ec2"));
