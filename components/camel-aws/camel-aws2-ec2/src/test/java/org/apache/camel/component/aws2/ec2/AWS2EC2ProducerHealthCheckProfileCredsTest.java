...
public class AWS2EC2ProducerHealthCheckProfileCredsTest extends CamelTestSupport {
    ...
    protected CamelContext createCamelContext() throws Exception {
        ...
        context.getComponent("aws2-ec2", HealthCheckComponent.class).setHealthCheckProducerEnabled(true);
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:listClusters")
                        .to("aws2-ec2://TestDomain?operation=describeInstances&region=l&useDefaultCredentialsProvider=true");
            }
        };
    }
