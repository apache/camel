...
public class Lambda2ProducerHealthCheckProfileCredsTest extends CamelTestSupport {
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:listClusters")
                        .to("aws2-lambda://test?operation=listFunctions&region=l&useDefaultCredentialsProvider=true");
            }
        };
    }
    ...
    public void testConnectivity() {
        ...
        await().atMost(20, TimeUnit.SECONDS).untilAsserted(() -> {
            ...
            boolean containsAws2LambdaHealthCheck =
                    res2.stream().anyMatch(result -> result.getCheck().getId().startsWith("producer:aws2-lambda"));
