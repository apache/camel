...
public class Athena2Configuration implements Cloneable {
    ...
    @UriParam(defaultValue = "startQueryExecution", description = "The Athena API function to call.")
    ...
    @UriParam(label = "security", description = "For SSE-KMS and CSE-KMS, this is the KMS key ARN or ID.")
    ...
    @UriParam(
            label = "security",
            description =
                    "Set whether the Athena client should expect to load credentials through a default credentials provider"
