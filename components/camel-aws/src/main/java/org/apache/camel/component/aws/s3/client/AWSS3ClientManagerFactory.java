 ...
 */
public final class AWSS3ClientManagerFactory {
	...
	public static AWSS3Client getAWSS3Client(S3Configuration configuration, int maxConnections) {
		return configuration.isUseIAMCredentials() ? new StandardAWSS3ClientImpl(configuration, maxConnections)
				: new IAMOptimizedAWSS3ClientImpl(configuration, maxConnections);
	}
}
