 ...
 */
public class IAM2ClientProfileOptimizedImpl implements IAM2InternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(IAM2ClientProfileOptimizedImpl.class);
