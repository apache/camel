 ...
 * credential set.
 */
public class EKS2ClientSessionTokenImpl implements EKS2InternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(EKS2ClientSessionTokenImpl.class);
    private EKS2Configuration configuration;

    /**
     * Constructor that uses the config file.
     */
    public EKS2ClientSessionTokenImpl(EKS2Configuration configuration) {
        LOG.trace("Creating an AWS EKS manager using static credentials.");
