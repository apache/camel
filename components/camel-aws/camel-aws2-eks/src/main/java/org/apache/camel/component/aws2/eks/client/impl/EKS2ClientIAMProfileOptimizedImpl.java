 ...
 */
public class EKS2ClientIAMProfileOptimizedImpl implements EKS2InternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(EKS2ClientIAMProfileOptimizedImpl.class);
    private EKS2Configuration configuration;

    /**
     * Constructor that uses the config file.
     */
    public EKS2ClientIAMProfileOptimizedImpl(EKS2Configuration configuration) {
