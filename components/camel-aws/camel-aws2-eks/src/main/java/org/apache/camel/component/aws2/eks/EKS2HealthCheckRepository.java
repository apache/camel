...
/**
 * Repository for camel-eks2-athena {@link HealthCheck}s.
 */
@org.apache.camel.spi.annotations.HealthCheck("camel-aws2-eks-repository")
@DeferredContextBinding
public class EKS2HealthCheckRepository extends ServiceSupport
        implements CamelContextAware, HealthCheckRepository, StaticService, NonManagedService {

    public static final String REPOSITORY_ID = "camel-aws2-eks";
