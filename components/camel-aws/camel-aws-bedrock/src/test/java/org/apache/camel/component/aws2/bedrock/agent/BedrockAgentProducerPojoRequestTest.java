...
class BedrockAgentProducerPojoRequestTest {
    ...
    @ParameterizedTest
    @CsvSource({
            "startIngestionJob,startIngestionJob operation requires a StartIngestionJobRequest body when pojoRequest=true",
            "listIngestionJobs,listIngestionJobs operation requires a ListIngestionJobsRequest body when pojoRequest=true",
            "getIngestionJob,getIngestionJob operation requires a GetIngestionJobRequest body when pojoRequest=true",
    })
    void pojoRequestWithWrongBodyTypeThrows(String operation, String expectedMessage) throws Exception {
        BedrockAgentConfiguration configuration = new BedrockAgentConfiguration();
