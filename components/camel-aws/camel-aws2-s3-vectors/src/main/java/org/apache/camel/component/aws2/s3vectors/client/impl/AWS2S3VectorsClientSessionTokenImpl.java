...
/**
 * Manage an AWS S3 Vectors client using session credentials.
 */
public class AWS2S3VectorsClientSessionTokenImpl implements AWS2CamelS3VectorsInternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(AWS2S3VectorsClientSessionTokenImpl.class);
    private AWS2S3VectorsConfiguration configuration;

    /**
     * Constructor that uses the config file.
     */
    public AWS2S3VectorsClientSessionTokenImpl(AWS2S3VectorsConfiguration configuration) {
        LOG.trace("Creating an AWS S3 Vectors client using session credentials.");
