...
/**
 * Manage an AWS S3 Vectors client for all users to use. This implementation is for local instances to use a static and
 * solid credential set.
 */
public class AWS2S3VectorsClientStandardImpl implements AWS2CamelS3VectorsInternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(AWS2S3VectorsClientStandardImpl.class);
    private AWS2S3VectorsConfiguration configuration;

    /**
     * Constructor that uses the config file.
     */
    public AWS2S3VectorsClientStandardImpl(AWS2S3VectorsConfiguration configuration) {
        LOG.trace("Creating an AWS S3 Vectors client using static credentials.");
