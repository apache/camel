...
public class MSKComponentConfigurationTest extends CamelTestSupport {
    ...
    public void createEndpointWithComponentAndEndpointElements() throws Exception {
        ...
        MSK2Endpoint endpoint = (MSK2Endpoint)
                component.createEndpoint("aws2-msk://label?accessKey=xxxxxx&secretKey=yyyyy&region=US_EAST_1");
    ...
    public void createEndpointWithComponentEndpointElementsAndProxy() throws Exception {
        ...
        MSK2Endpoint endpoint = (MSK2Endpoint)
                component.createEndpoint(
                        "aws2-msk://label?accessKey=xxxxxx&secretKey=yyyyy&region=US_EAST_1&proxyHost=localhost&proxyPort=9000&proxyProtocol=HTTP");
