...
:page-source: components/camel-aws/camel-aws2-sns/src/main/docs/aws2-sns-component.adoc
...
include::{page-component-version}@camel-spring-boot::page$aws2-sns-starter.adoc[]
