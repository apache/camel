 ...
 */
public class Translate2ClientSessionTokenImpl implements Translate2InternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(Translate2ClientSessionTokenImpl.class);
    private Translate2Configuration configuration;

    /**
     * Constructor that uses the config file.
     */
    public Translate2ClientSessionTokenImpl(Translate2Configuration configuration) {
