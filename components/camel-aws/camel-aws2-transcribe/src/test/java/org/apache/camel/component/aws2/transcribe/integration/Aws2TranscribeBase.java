...
public class Aws2TranscribeBase extends CamelTestSupport {
    ...
    protected Supplier<String> name = () -> sharedNameGenerator.getClazz().toLowerCase(Locale.ROOT);

    @Override
    protected CamelContext createCamelContext() throws Exception {
        CamelContext context = super.createCamelContext();
        Transcribe2Component transcribe = context.getComponent("aws2-transcribe", Transcribe2Component.class);
        transcribe.getConfiguration().setTranscribeClient(AWSSDKClientUtils.newTranscribeClient());
        return context;
    }
}
