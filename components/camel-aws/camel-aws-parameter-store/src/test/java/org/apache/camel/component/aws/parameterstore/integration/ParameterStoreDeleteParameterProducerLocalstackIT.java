...
public class ParameterStoreDeleteParameterProducerLocalstackIT extends AwsParameterStoreBaseTest {
    ...
    public void deleteParameterTest() {
        ...
        Exchange exchange = template.request("direct:deleteParameter", new Processor() {
            @Override
            public void process(Exchange exchange) {
                exchange.getIn().setHeader(ParameterStoreConstants.PARAMETER_NAME, "/test/deleteparam");
            }
        });

        DeleteParameterResponse result = (DeleteParameterResponse) exchange.getIn().getBody();
