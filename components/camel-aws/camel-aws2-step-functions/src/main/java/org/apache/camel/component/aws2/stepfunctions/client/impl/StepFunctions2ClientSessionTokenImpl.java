 ...
 */
public class StepFunctions2ClientSessionTokenImpl implements StepFunctions2InternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(StepFunctions2ClientSessionTokenImpl.class);
    private StepFunctions2Configuration configuration;

    /**
     * Constructor that uses the config file.
     */
    public StepFunctions2ClientSessionTokenImpl(StepFunctions2Configuration configuration) {
