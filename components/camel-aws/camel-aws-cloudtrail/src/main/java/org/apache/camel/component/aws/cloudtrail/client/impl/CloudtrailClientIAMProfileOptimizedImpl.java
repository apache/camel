 ...
 */
public class CloudtrailClientIAMProfileOptimizedImpl implements CloudtrailInternalClient {
    ...
    public CloudtrailClientIAMProfileOptimizedImpl(CloudtrailConfiguration configuration) {
        LOG.trace(
                "Creating an AWS Cloudtrail client for an ec2 instance with IAM temporary credentials (normal for ec2s).");
