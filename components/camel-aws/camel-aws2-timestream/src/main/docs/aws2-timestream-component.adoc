...
The AWS2 Timestream component supports the following operations on
...
Based on the type of operation to be performed, the type of client (write/query) needs to be provided
