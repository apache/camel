...
public class SecretsManagerDeleteSecretProducerIntegrationTest extends CamelTestSupport {
    ...
    public void translateTextTest() throws Exception {
        ...
        DeleteSecretResponse resultGet = (DeleteSecretResponse) exchange.getIn().getBody();
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("direct:listSecrets")
                        .to("aws-secrets-manager://test?accessKey=RAW(xxxx)&secretKey=RAW(yyyy)&region=eu-west-1&operation=deleteSecret")
                        .to("mock:result");
            }
        };
    }
