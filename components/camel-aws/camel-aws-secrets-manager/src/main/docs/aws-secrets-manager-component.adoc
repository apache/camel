...
| *operation* (producer) | *Required* The operation to perform. There are 6 enums and the value can be one of: listSecrets, createSecret, getSecret, describeSecret, deleteSecret, rotateSecret |  | SecretsManagerOperations
