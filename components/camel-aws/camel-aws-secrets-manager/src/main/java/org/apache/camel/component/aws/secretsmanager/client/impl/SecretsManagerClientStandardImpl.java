...
public class SecretsManagerClientStandardImpl implements SecretsManagerInternalClient {
     ...
     */
    public SecretsManagerClientStandardImpl(SecretsManagerConfiguration configuration) {
        LOG.trace("Creating an AWS Secrets Manager manager using static credentials.");
