 ...
 */
public class SecretsManagerClientSessionTokenImpl implements SecretsManagerInternalClient {
     ...
     */
    public SecretsManagerClientSessionTokenImpl(SecretsManagerConfiguration configuration) {
