 ...
 */
public class SecretsManagerClientIAMOptimized implements SecretsManagerInternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(SecretsManagerClientIAMOptimized.class);
