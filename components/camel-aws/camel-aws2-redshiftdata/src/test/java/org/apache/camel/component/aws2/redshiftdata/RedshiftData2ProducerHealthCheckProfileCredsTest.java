...
public class RedshiftData2ProducerHealthCheckProfileCredsTest extends CamelTestSupport {
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:listDatabases")
                        .to("aws2-redshiftdata://test?operation=listDatabases&region=l&useDefaultCredentialsProvider=true");
            }
        };
    }
