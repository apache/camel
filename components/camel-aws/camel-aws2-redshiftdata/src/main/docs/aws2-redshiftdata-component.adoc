...
:shortname: aws2-redshiftdata
:artifactid: camel-aws2-redshiftdata
:description: Manage and invoke AWS Redshift Data.
:since: 4.1
...
:group: AWS
:camel-spring-boot-name: aws2-redshiftdata
...
-------------------------
aws2-redshiftdata://label[?options]
-------------------------
...
<dependency>
    ...
    <artifactId>camel-redshiftdata</artifactId>
