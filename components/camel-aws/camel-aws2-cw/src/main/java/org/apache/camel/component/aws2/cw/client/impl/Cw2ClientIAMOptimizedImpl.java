 ...
 */
public class Cw2ClientIAMOptimizedImpl implements Cw2InternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(Cw2ClientIAMOptimizedImpl.class);
