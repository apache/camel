...
public class Ddb2StreamConfiguration implements Cloneable {
    ...
    @UriParam(defaultValue = "false", description = "Set whether the DynamoDB Streams client should expect to load credentials through a default credentials provider or to expect " +
