 ...
 */
public class Ddb2StreamClientIAMProfileOptimizedImpl implements Ddb2StreamInternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(Ddb2StreamClientIAMProfileOptimizedImpl.class);
    private Ddb2StreamConfiguration configuration;

    /**
     * Constructor that uses the config file.
     */
    public Ddb2StreamClientIAMProfileOptimizedImpl(Ddb2StreamConfiguration configuration) {
        LOG.trace(
