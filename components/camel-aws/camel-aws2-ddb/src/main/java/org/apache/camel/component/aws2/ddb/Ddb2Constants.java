...
public interface Ddb2Constants {
    @Metadata(
            label = "DeleteItem GetItem PutItem UpdateItem",
    ...
    @Metadata(
            description = "If attribute names are not specified then all attributes will be\n" + "returned.",
    ...
    @Metadata(
            description = "This header specify the selection criteria for the\n"
    ...
    @Metadata(
            label = "DeleteTable DescribeTable",
    ...
    @Metadata(
            label = "UpdateTable DescribeTable",
            description = "ReadCapacityUnits property of this table.",
            javaType = "Long")
    String READ_CAPACITY = "CamelAwsDdbReadCapacity";

    @Metadata(
            description = "Use this parameter if you want to get the attribute name-value pairs\n"
    ...
    @Metadata(
            description = "Designates an attribute for a conditional modification.",
    ...
    @Metadata(label = "Query Scan", description = "The Filter Expression.", javaType = "String")
    String FILTER_EXPRESSION = "CamelAwsDdbFilterExpression";

    @Metadata(
            label = "Query Scan",
            description = "The Filter Expression Attribute Names.",
            javaType = "Map<String, String>")
    String FILTER_EXPRESSION_ATTRIBUTE_NAMES = "CamelAwsDdbFilterExpressionAttributeNames";

    @Metadata(
            label = "Query Scan",
            description = "The Filter Expression Attribute Values.",
            javaType = "Map<String, String>")
    String FILTER_EXPRESSION_ATTRIBUTE_VALUES = "CamelAwsDdbFilterExpressionAttributeValues";

    @Metadata(label = "Query Scan", description = "The Project Expression.", javaType = "String")
