 ...
 */
public class Ddb2ClientIAMProfileOptimizedImpl implements Ddb2InternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(Ddb2ClientIAMProfileOptimizedImpl.class);
    private Ddb2Configuration configuration;

    /**
     * Constructor that uses the config file.
     */
    public Ddb2ClientIAMProfileOptimizedImpl(Ddb2Configuration configuration) {
