...
public class AWS2QueryRuleIT extends Aws2DDBBase {
    ...
    public void queryItemsWithFilterExpression() {
        ...
        for (Map<String, AttributeValue> item : items) {
            ...
            assertEquals(AttributeValue.builder().s("ignore").build(), item.get("clave"));
        }
    }

    @Test
    public void queryItemsWithProjectExpression() {
        ...
        assertEquals(Set.of("uno", "dos", "tres", "Ignore me", "I should not be returned"), values);
        for (Map<String, AttributeValue> item : items) {
            assertTrue(item.containsKey("secondary_attribute"));
