...
public class Rekognition2Component extends HealthCheckComponent {
    ...
    @Metadata
    private Rekognition2Configuration configuration = new Rekognition2Configuration();

    public Rekognition2Component() {
        this(null);
    }

    public Rekognition2Component(CamelContext context) {
        super(context);
    }
    ...
    protected Endpoint createEndpoint(String uri, String remaining, Map<String, Object> parameters) throws Exception {
        ...
        if (Boolean.FALSE.equals(configuration.isUseDefaultCredentialsProvider())
                ...
                && configuration.getAwsRekognitionClient() == null
                && (configuration.getAccessKey() == null || configuration.getSecretKey() == null)) {
            throw new IllegalArgumentException(
                    "useDefaultCredentialsProvider is set to false, useProfileCredentialsProvider is set to false, useSessionCredentials is set to false, Amazon rekognition client or accessKey and secretKey must be specified");
        }
