...
public class Rekognition2ProducerHealthCheckStaticCredsTest extends CamelTestSupport {
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:listCollections")
                        .to("aws2-rekognition://test?operation=listCollections&region=l&secretKey=l&accessKey=k");
            }
        };
    }
