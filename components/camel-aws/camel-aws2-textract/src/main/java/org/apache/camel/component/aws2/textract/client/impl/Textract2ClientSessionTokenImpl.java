...
package org.apache.camel.component.aws2.textract.client.impl;
...
/**
 * Manage an AWS Textract client for all users to use. This implementation is for local instances to use a static and
 * solid credential set.
 */
public class Textract2ClientSessionTokenImpl implements Textract2InternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(Textract2ClientSessionTokenImpl.class);
    private Textract2Configuration configuration;

    /**
     * Constructor that uses the config file.
     */
    public Textract2ClientSessionTokenImpl(Textract2Configuration configuration) {
        LOG.trace("Creating an AWS Textract manager using static credentials.");
        this.configuration = configuration;
    }

    /**
     * Getting the Textract aws client that is used.
     *
     * @return Amazon Textract Client.
     */
    @Override
    public TextractClient getTextractClient() {
        TextractClient client = null;
        TextractClientBuilder clientBuilder = TextractClient.builder();
