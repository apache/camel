...
@UriParams
public class Textract2Configuration implements Cloneable, AwsCommonConfiguration {
    ...
    /**
     * The region in which Textract client needs to work. When using this parameter, the configuration will expect the
    ...
    /**
     * Set whether the Textract client should expect to load credentials through a default credentials provider or to
    ...
    /**
     * Set whether the Textract client should expect to load credentials through a profile credentials provider.
     */
    ...
    /**
     * Set whether the Textract client should expect to use Session Credentials. This is useful in situation in which
     * the user needs to assume a IAM role for doing operations in Textract.
     */
