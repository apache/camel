 ...
 */
public class Textract2ClientIAMProfileOptimized implements Textract2InternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(Textract2ClientIAMProfileOptimized.class);
    private Textract2Configuration configuration;

    /**
     * Constructor that uses the config file.
     */
    public Textract2ClientIAMProfileOptimized(Textract2Configuration configuration) {
