...
public class Textract2ComponentConfigurer extends PropertyConfigurerSupport implements GeneratedPropertyConfigurer, PropertyConfigurerGetter {

    private org.apache.camel.component.aws2.textract.Textract2Configuration getOrCreateConfiguration(Textract2Component target) {
        if (target.getConfiguration() == null) {
            target.setConfiguration(new org.apache.camel.component.aws2.textract.Textract2Configuration());
        }
    ...
    public boolean configure(CamelContext camelContext, Object obj, String name, Object value, boolean ignoreCase) {
        Textract2Component target = (Textract2Component) obj;
        switch (ignoreCase ? name.toLowerCase() : name) {
        case "accesskey":
        case "accessKey": getOrCreateConfiguration(target).setAccessKey(property(camelContext, java.lang.String.class, value)); return true;
        case "autowiredenabled":
        case "autowiredEnabled": target.setAutowiredEnabled(property(camelContext, boolean.class, value)); return true;
        case "configuration": target.setConfiguration(property(camelContext, org.apache.camel.component.aws2.textract.Textract2Configuration.class, value)); return true;
        ...
        case "operation": getOrCreateConfiguration(target).setOperation(property(camelContext, org.apache.camel.component.aws2.textract.Textract2Operations.class, value)); return true;
        ...
        case "s3object":
        case "s3Object": getOrCreateConfiguration(target).setS3Object(property(camelContext, java.lang.String.class, value)); return true;
        case "s3objectversion":
        case "s3ObjectVersion": getOrCreateConfiguration(target).setS3ObjectVersion(property(camelContext, java.lang.String.class, value)); return true;
        case "secretkey":
        ...
        case "textractclient":
        case "textractClient": getOrCreateConfiguration(target).setTextractClient(property(camelContext, software.amazon.awssdk.services.textract.TextractClient.class, value)); return true;
    ...
    public Class<?> getOptionType(String name, boolean ignoreCase) {
        ...
        case "configuration": return org.apache.camel.component.aws2.textract.Textract2Configuration.class;
        case "healthcheckconsumerenabled":
    ...
    public Object getOptionValue(Object obj, String name, boolean ignoreCase) {
        ...
        case "s3object":
        case "s3Object": return getOrCreateConfiguration(target).getS3Object();
        case "s3objectversion":
        case "s3ObjectVersion": return getOrCreateConfiguration(target).getS3ObjectVersion();
        case "secretkey":
        case "secretKey": return getOrCreateConfiguration(target).getSecretKey();
        case "sessiontoken":
        case "sessionToken": return getOrCreateConfiguration(target).getSessionToken();
        case "textractclient":
        case "textractClient": return getOrCreateConfiguration(target).getTextractClient();
        case "trustallcertificates":
