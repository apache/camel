 ...
 */
public class EventbridgeClientIAMProfileOptimizedImpl implements EventbridgeInternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(EventbridgeClientIAMProfileOptimizedImpl.class);
