 ...
 * credential set.
 */
public class EventbridgeClientSessionTokenImpl implements EventbridgeInternalClient {
    private static final Logger LOG = LoggerFactory.getLogger(EventbridgeClientSessionTokenImpl.class);
    private EventbridgeConfiguration configuration;

    /**
     * Constructor that uses the config file.
     */
    public EventbridgeClientSessionTokenImpl(EventbridgeConfiguration configuration) {
