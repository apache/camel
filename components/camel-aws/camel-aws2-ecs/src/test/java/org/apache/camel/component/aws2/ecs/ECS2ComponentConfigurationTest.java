...
public class ECS2ComponentConfigurationTest extends CamelTestSupport {
    ...
    public void createEndpointWithComponentAndEndpointElements() throws Exception {
        ...
        ECS2Endpoint endpoint = (ECS2Endpoint)
                component.createEndpoint("aws2-ecs://label?accessKey=xxxxxx&secretKey=yyyyy&region=US_EAST_1");
    ...
    public void createEndpointWithComponentEndpointElementsAndProxy() throws Exception {
        ...
        ECS2Endpoint endpoint = (ECS2Endpoint)
                component.createEndpoint(
                        "aws2-ecs://label?accessKey=xxxxxx&secretKey=yyyyy&region=US_EAST_1&proxyHost=localhost&proxyPort=9000&proxyProtocol=HTTP");
