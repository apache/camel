...
public class AWSConfigProducerHealthCheckStaticCredsTest extends CamelTestSupport {

    private static final Logger LOG = LoggerFactory.getLogger(AWSConfigProducerHealthCheckStaticCredsTest.class);
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:listClusters")
                        .to("aws-config://test?operation=putConfigRule&region=l&secretKey=l&accessKey=k");
            }
        };
    }
