...
public class AWSConfigProducerHealthCheckProfileCredsTest extends CamelTestSupport {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(AWSConfigProducerHealthCheckProfileCredsTest.class);
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:listClusters")
                        .to("aws-config://test?operation=putConfigRule&region=l&useDefaultCredentialsProvider=true");
            }
        };
    }
