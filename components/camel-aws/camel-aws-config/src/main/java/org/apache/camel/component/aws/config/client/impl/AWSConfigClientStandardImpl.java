...
/**
 * Manage an AWS Config client for all users to use. This implementation is for local instances to use a static and
 * solid credential set.
 */
public class AWSConfigClientStandardImpl implements AWSConfigInternalClient {
