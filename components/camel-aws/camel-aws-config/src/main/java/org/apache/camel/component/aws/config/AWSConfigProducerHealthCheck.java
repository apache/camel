...
public class AWSConfigProducerHealthCheck extends AbstractHealthCheck {
    ...
    protected void doCall(HealthCheckResultBuilder builder, Map<String, Object> options) {
        AWSConfigConfiguration configuration = configEndpoint.getConfiguration();
        if (ObjectHelper.isNotEmpty(configuration.getRegion())) {
            if (!ConfigClient.serviceMetadata().regions().contains(Region.of(configuration.getRegion()))) {
