...
| *operation* (producer) | The operation to do in case the user don't want to send only a message. There are 5 enums and the value can be one of: sendBatchMessage, deleteMessage, listQueues, purgeQueue, deleteQueue |  | Sqs2Operations
