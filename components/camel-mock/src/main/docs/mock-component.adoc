...
----
include::{examplesdir}/components/camel-test/camel-test-junit6/src/test/java/org/apache/camel/test/junit5/patterns/IsMockEndpointsJUnit5Test.java[tags=e1]
----
...
----
include::{examplesdir}/components/camel-test/camel-test-junit6/src/test/java/org/apache/camel/test/junit5/patterns/IsMockEndpointsAndSkipJUnit5Test.java[tags=e1]
----
