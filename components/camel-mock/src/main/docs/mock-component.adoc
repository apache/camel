...
----
include::{examplesdir}/components/camel-test/camel-test-junit6/src/test/java/org/apache/camel/test/junit6/patterns/IsMockEndpointsJUnit6Test.java[tags=e1]
----
...
----
include::{examplesdir}/components/camel-test/camel-test-junit6/src/test/java/org/apache/camel/test/junit6/patterns/IsMockEndpointsAndSkipJUnit6Test.java[tags=e1]
----
