...
public class MSK2ComponentVerifierExtension extends DefaultComponentVerifierExtension {
    ...
    public MSK2ComponentVerifierExtension(String scheme) {
        super(scheme);
    }
    ...
    protected Result verifyConnectivity(Map<String, Object> parameters) {
        ...
        try {
            ...
            KafkaClient client = clientBuilder.credentialsProvider(StaticCredentialsProvider.create(cred))
            ...
            ResultErrorBuilder errorBuilder
                    = ResultErrorBuilder.withCodeAndDescription(VerificationError.StandardCode.AUTHENTICATION, e.getMessage())
                            .detail("aws_mks_exception_message", e.getMessage())
