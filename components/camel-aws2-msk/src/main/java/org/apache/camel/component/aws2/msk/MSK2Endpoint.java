 ...
 */
@UriEndpoint(firstVersion = "3.1.0", scheme = "aws2-msk", title = "AWS 2 Managed Streaming for Apache Kafka (MSK)", syntax = "aws2-msk:label", producerOnly = true, category = {Category.CLOUD, Category.MANAGEMENT})
