...
public class ECS2ComponentVerifierExtension extends DefaultComponentVerifierExtension {
    ...
    protected Result verifyConnectivity(Map<String, Object> parameters) {
        ...
        try {
            ...
            EcsClient client = clientBuilder.credentialsProvider(StaticCredentialsProvider.create(cred))
            ...
            ResultErrorBuilder errorBuilder
                    = ResultErrorBuilder.withCodeAndDescription(VerificationError.StandardCode.AUTHENTICATION, e.getMessage())
                            .detail("aws_ecs_exception_message", e.getMessage())
