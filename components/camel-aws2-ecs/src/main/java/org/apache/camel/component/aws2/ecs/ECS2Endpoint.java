 ...
 */
@UriEndpoint(firstVersion = "3.1.0", scheme = "aws2-ecs", title = "AWS 2 Elastic Container Service (ECS)", syntax = "aws2-ecs:label", producerOnly = true, category = {Category.CLOUD, Category.MANAGEMENT})
