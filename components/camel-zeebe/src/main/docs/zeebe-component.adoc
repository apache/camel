...
Please use the xref:camunda-component.adoc[Camunda] component instead,
which uses the new Camunda Java Client (`io.camunda:camunda-client-java`).
====
