...
public class JobResponseTest {
    ...
    private final String MARSHAL_TEST_RESULT_1 = "{\"success\":true}";
    private final String MARSHAL_TEST_RESULT_2 = "{\"success\":false,\"error_message\":\"Test Error\",\"error_code\":\"TestCode\"}";
