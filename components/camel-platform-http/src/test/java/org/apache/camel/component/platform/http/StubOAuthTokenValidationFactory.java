...
public final class StubOAuthTokenValidationFactory implements OAuthTokenValidationFactory {
    ...
    @Override
    public OAuthTokenValidationResult validateToken(CamelContext context, String token) {
        lastToken = token;
        return validate(token);
    }
    ...
    public void validateConfiguration(CamelContext context, String profileName) {
        ...
        if ("invalid-profile".equals(profileName)) {
            throw new IllegalArgumentException("invalid OAuth profile");
        }
    }
