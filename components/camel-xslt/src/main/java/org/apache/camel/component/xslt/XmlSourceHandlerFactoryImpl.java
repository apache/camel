        ...
        if (source == null) {
            if (isFailOnNullBody()) {
                if (body == null) {
                    ...
                    throw new ExpectedBodyTypeException(
                            exchange, Source.class,
                            "the xslt step got no message body to transform: read the XML before the step with"
                                                    + " poll: file:..., pollEnrich or a from: consumer, or set it with setBody");
                }
