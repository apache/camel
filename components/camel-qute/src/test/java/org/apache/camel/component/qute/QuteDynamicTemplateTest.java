...
public class QuteDynamicTemplateTest extends CamelTestSupport {
    ...
    public static class MyBean {
        ...
        public void sendToNewTemplate(Exchange exchange) throws Exception {
            ...
            template.send("qute:" + getNewTemplate(), exchange);
            useLetter2 = !useLetter2;
        }

        private String getNewTemplate() {
            if (useLetter2) {
                return "org/apache/camel/component/qute/letter2.txt";
            } else {
                return "org/apache/camel/component/qute/letter.txt";
            }
        }
    }
}
