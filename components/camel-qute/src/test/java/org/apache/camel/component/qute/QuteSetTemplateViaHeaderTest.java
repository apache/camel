...
public class QuteSetTemplateViaHeaderTest extends CamelTestSupport {
    private Exchange createLetter(String template) {
        ...
        msg.setHeader(QuteConstants.QUTE_RESOURCE_URI, template);
    ...
    public void testLetter() throws Exception {
        ...
        template.send("direct:a", createLetter("org/apache/camel/component/qute/letter.txt"));
        ...
        template.send("direct:a", createLetter("org/apache/camel/component/qute/letter2.txt"));
