...
public final class MinaSftpProcessStrategyFactory implements GenericFileProcessStrategyFactory<SftpRemoteFile> {
    ...
    private static GenericFileExclusiveReadLockStrategy getExclusiveReadLockStrategy(Map<String, Object> params) {
        ...
        if (ObjectHelper.isNotEmpty(readLock)) {
            if ("none".equals(readLock) || "false".equals(readLock)) {
                ...
                MinaStrategyUtil.setup(readLockStrategy, params);

                return readLockStrategy;
            } else if ("changed".equals(readLock)) {
                MinaSftpChangedExclusiveReadLockStrategy readLockStrategy = new MinaSftpChangedExclusiveReadLockStrategy();
