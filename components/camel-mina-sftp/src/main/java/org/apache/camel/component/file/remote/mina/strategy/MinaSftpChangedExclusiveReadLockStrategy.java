 ...
 */
package org.apache.camel.component.file.remote.mina.strategy;
...
public class MinaSftpChangedExclusiveReadLockStrategy implements GenericFileExclusiveReadLockStrategy<SftpRemoteFile> {
    private static final Logger LOG = LoggerFactory.getLogger(MinaSftpChangedExclusiveReadLockStrategy.class);
    ...
    public void prepareOnStartup(
            GenericFileOperations<SftpRemoteFile> tGenericFileOperations,
            GenericFileEndpoint<SftpRemoteFile> tGenericFileEndpoint)
            throws Exception {
        // noop
    }
    ...
    public boolean acquireExclusiveReadLock(
            GenericFileOperations<SftpRemoteFile> operations, GenericFile<SftpRemoteFile> file, Exchange exchange)
            throws Exception {
