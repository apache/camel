...
/**
 * Default move existing file strategy for MINA SFTP.
 */
public class MinaSftpDefaultMoveExistingFileStrategy implements FileMoveExistingStrategy {

    private static final Logger LOG = LoggerFactory.getLogger(MinaSftpDefaultMoveExistingFileStrategy.class);
    ...
    public boolean moveExistingFile(GenericFileEndpoint<?> endpoint, GenericFileOperations<?> operations, String fileName)
        ...
        to = ((MinaSftpEndpoint) endpoint).getConfiguration().normalizePath(to);
