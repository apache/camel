...
public class SftpSimpleProduceIT extends SftpServerTestSupport {
    ...
    public void testSftpSimpleProduce() {
        template.sendBodyAndHeader(
                "mina-sftp://localhost:{{ftp.server.port}}/{{ftp.root.dir}}?username=admin&password=admin&knownHostsFile="
    ...
    public void testSftpSimpleSubPathProduce() {
        template.sendBodyAndHeader(
                "mina-sftp://localhost:{{ftp.server.port}}/{{ftp.root.dir}}/mysub?username=admin&password=admin&knownHostsFile="
                                   + service.getKnownHostsFile(),
