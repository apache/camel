...
public class SftpProduceTempFileIT extends SftpServerTestSupport {
    ...
    public void testSftpTempFile() {
        template.sendBodyAndHeader("mina-sftp://localhost:{{ftp.server.port}}/{{ftp.root.dir}}"
    ...
    public void testSftpTempFileNoStartingPath() {
        template.sendBodyAndHeader(
                "mina-sftp://localhost:{{ftp.server.port}}/?username=admin&password=admin&tempFileName=temp-${file:name}"
