...
public class SftpFromSedaDeleteFileIT extends SftpServerTestSupport {
    ...
    protected String getFtpUrl() {
        return "mina-sftp://localhost:{{ftp.server.port}}/{{ftp.root.dir}}?username=admin&knownHostsFile="
               + service.getKnownHostsFile()
               + "&privateKeyFile=./src/test/resources/sftp/id_rsa"
    ...
    private void createSampleFile() throws IOException {
        ...
        FileUtils.writeStringToFile(file, "Hello World this file will be deleted", StandardCharsets.UTF_8);
    }
