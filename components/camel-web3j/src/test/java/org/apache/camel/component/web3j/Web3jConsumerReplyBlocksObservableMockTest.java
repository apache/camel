...
public class Web3jConsumerReplyBlocksObservableMockTest extends Web3jMockTestSupport {
    ...
    public void successTest() throws Exception {
        ...
        Mockito.when(mockWeb3j.replayBlocksObservable(any(DefaultBlockParameter.class), any(DefaultBlockParameter.class),
                any(Boolean.class))).thenReturn(observable);
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            public void configure() {
                ...
                from(getUrl() + OPERATION.toLowerCase() + "=" + REPLAY_BLOCKS_OBSERVABLE
                     + "&fromBlock=5499965&toBlock=5499967&fullTransactionObjects=true")
                             .to("mock:result");
            }
        };
    }
