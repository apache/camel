    ...
    protected RoutesBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                fromF(
                                "jmx:platform?objectDomain=org.apache.camel&key.context=%s&key.type=routes&key.name=\"foo\"&observedAttribute=Tracing&stringToCompare=true&notifyDiffer=true",
                                id)
                        .routeId("jmxRoute")
                        .to("log:jmx")
                        .to("mock:result");
