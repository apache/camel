...
:description: Huawei Cloud component to integrate with FunctionGraph services
:since: 3.11.0-SNAPSHOT
:supportLevel: Stable
...
Huawei Cloud FunctionGraph component allows you to integrate with https://www.huaweicloud.com/en-us/product/functiongraph.html[FunctionGraph] services provided by Huawei Cloud.
...
------------------------------------------------------------
<dependency>
    <groupId>org.apache.camel</groupId>git
...
|===
| Name | Description | Default | Type
| *operation* | *Required* Name of the FunctionGraph operation to invoke. |  | String
|===
...
| *endpoint* (producer) | Fully qualified FunctionGraph service url. Carries higher precedence than region parameter based client initialization. Required if region is not given |  | String
| *functionName* (producer) | *Required* Name of the function to invoke the operation on |  | String
| *functionPackage* (producer) | Name of the function package |  | String
