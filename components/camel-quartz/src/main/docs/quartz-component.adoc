...
The Quartz Scheduler allows you to configure start date per trigger. You can provide the start date in the date format yyyy-MM-dd'T'HH:mm:ssz.
...
The Quartz Scheduler allows you to configure end date per trigger. You can provide the end date in the date format yyyy-MM-dd'T'HH:mm:ssz.
