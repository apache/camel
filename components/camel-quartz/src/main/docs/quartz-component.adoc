...
The Quartz Scheduler allows you to configure start date per trigger. You can provide the start date as TimeInMillis as follows:
...
The Quartz Scheduler allows you to configure end date per trigger. You can provide the end date as TimeInMillis as follows:
