...
public class AddIssueLinkProducer extends DefaultProducer {
    ...
    public void process(Exchange exchange) {
        ...
        LinkIssuesInput linkIssuesInput = new LinkIssuesInput(parentIssueKey, childIssueKey, linkType,
            comment);
