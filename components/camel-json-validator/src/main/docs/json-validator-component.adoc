...
| *schemaLoader* (advanced) | To use a custom schema loader allowing for adding custom format validation. See json-schema-validator documentation. The default implementation will create a JsonSchema with JsonSchemaFactory's default |  | JsonSchemaLoader
