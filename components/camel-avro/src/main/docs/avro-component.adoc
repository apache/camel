...
schema for your existing classes. You can use existing
...
You can specify message name right in the URI:
...
got only one parameter, you can use `singleParameter` URI
...
You can use following syntax to call constant messages:
...
You can set up two distinct routes to perform the same
task:
