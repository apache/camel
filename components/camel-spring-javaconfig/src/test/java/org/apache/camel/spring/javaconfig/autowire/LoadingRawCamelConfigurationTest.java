...
@CamelSpringTest
@ContextConfiguration(classes = { CamelConfiguration.class, AdditionalRouteConfiguration.class })
public class LoadingRawCamelConfigurationTest {
    ...
    public void shouldAutodetectRouteBuilders() throws InterruptedException {
        assertNotNull(moduleMockEndpoint);
    }

}

@Configuration
class AdditionalRouteConfiguration {
    ...
    public RouteBuilder routeBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("direct:rawConfigTest").to("mock:rawConfigTest");
            }
        };
    }
