...
public class BaggageInjectionTest extends MicrometerObservabilityTracerPropagationTestSupport {
    ...
    void testRouteSingleRequest() throws IOException {
        ...
        try (Scope rootScope = Context.root().makeCurrent()) {
            ...
            try (SpanInScope scope = tracer.withSpan(mySpan);
                 BaggageInScope baggageScope = tracer.createBaggageInScope("external.id", "1234")) {
                ...
                from("direct:start")
                        ...
                        .process(new Processor() {
                            ...
                            public void process(Exchange exchange) throws Exception {
                                ...
                                assertEquals("1234", tracer.getBaggage("external.id").get());
                            }
                        })
                        .to("log:info");
            }
