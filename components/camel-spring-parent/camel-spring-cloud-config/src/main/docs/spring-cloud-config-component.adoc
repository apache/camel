...
link:https://camel.apache.org/components/latest/others/properties.html[Camel Properties Component]
link:https://spring.io/projects/spring-cloud-config[Spring Cloud Config]
link:https://camel.apache.org/manual/latest/using-propertyplaceholder.html[Using Property Placeholders]
