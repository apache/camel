...
public class SpringTypeConvertersOverrideTest extends SpringTestSupport {

    @Override
    protected AbstractXmlApplicationContext createApplicationContext() {
        return new ClassPathXmlApplicationContext(
                "org/apache/camel/spring/impl/converter/SpringTypeConvertersOverrideTest.xml");
    }
    ...
    public void testConvertersShouldBeAddedAutomaticBySpring() throws Exception {
        ...
        assertEquals("en", country.getIso());
        assertEquals("Country:en", country.getName());
