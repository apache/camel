...
/**
 * A templated route bean created by a script has no type (class name): the Spring XSD must accept it, as the runtime
 * does.
 */
public class SpringTemplatedRouteScriptBeanNoTypeTest extends SpringTestSupport {
