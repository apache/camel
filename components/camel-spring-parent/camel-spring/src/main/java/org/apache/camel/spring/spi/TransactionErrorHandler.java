    ...
    protected void processInTransaction(final Exchange exchange) {
        ...
        if (onlyLast) {
            ...
            if (LOG.isDebugEnabled()) {
                ...
                if (cause != null) {
                    LOG.debug(
                            "Transaction rollback ({}) redelivered({}) for {} due exchange was marked for "
        ...
        transactionTemplate.execute(new TransactionCallbackWithoutResult() {
            protected void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                if (exchange.getException() != null || exchange.isRollbackOnly() || exchange.isRollbackOnlyLast()) {
                    ...
                    // throw runtime exception to force rollback (which works best to rollback with Spring transaction
                    // manager)
