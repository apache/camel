...
/**
 * Tests that timeout with fallback correctly sets RESPONSE_TIMED_OUT and makes the guard exception visible to the
 * fallback via EXCEPTION_CAUGHT.
 */
public class FaultToleranceTimeoutWithFallbackExchangePropertyTest extends CamelTestSupport {
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:start")
                        ...
                        .onFallback()
                        .process(e -> {
                            // guard exception must be visible to the fallback via EXCEPTION_CAUGHT
