...
Regardless of how the handler is registered *only one* handler is supported: if two or more beans of this type
are found in the registry, the default handler is used.
