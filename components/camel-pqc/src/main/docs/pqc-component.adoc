...
To use HashicorpVaultKeyLifecycleManager, configure Vault with appropriate policies:
...
[options="header"]
|===
|Feature |FileBasedKeyLifecycleManager |InMemoryKeyLifecycleManager |HashicorpVaultKeyLifecycleManager
