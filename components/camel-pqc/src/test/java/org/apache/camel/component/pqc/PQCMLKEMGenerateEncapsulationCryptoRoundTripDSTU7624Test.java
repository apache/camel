...
public class PQCMLKEMGenerateEncapsulationCryptoRoundTripDSTU7624Test extends CamelTestSupport {
    ...
    public PQCMLKEMGenerateEncapsulationCryptoRoundTripDSTU7624Test() throws NoSuchAlgorithmException {}
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:encapsulate")
                        .to(
                                "pqc:keyenc?operation=generateSecretKeyEncapsulation&symmetricKeyAlgorithm=DSTU7624&symmetricKeyLength=128")
                        .to("mock:encapsulate")
                        .to(
                                "pqc:keyenc?operation=extractSecretKeyEncapsulation&symmetricKeyAlgorithm=DSTU7624&symmetricKeyLength=128")
                        .to(
                                "pqc:keyenc?operation=extractSecretKeyFromEncapsulation&symmetricKeyAlgorithm=DSTU7624&symmetricKeyLength=128")
    ...
    void testSignAndVerify() throws Exception {
        ...
        assertEquals(
                PQCSymmetricAlgorithms.DSTU7624.getAlgorithm(),
                resultEncapsulate
                        .getExchanges()
                        .get(0)
                        .getMessage()
