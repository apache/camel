...
public class PQCKYBERGenerateEncapsulationAESNoAutowiredTest extends CamelTestSupport {
    ...
    public PQCKYBERGenerateEncapsulationAESNoAutowiredTest() throws NoSuchAlgorithmException {
    }
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:encapsulate").to(
                        "pqc:keyenc?operation=generateSecretKeyEncapsulation&symmetricKeyAlgorithm=AES&keyEncapsulationAlgorithm=KYBER")
                        .to("mock:encapsulate")
                        .to("pqc:keyenc?operation=extractSecretKeyEncapsulation&symmetricKeyAlgorithm=AES&keyEncapsulationAlgorithm=KYBER")
                        .to("mock:extract");
            }
        };
    }
