...
public class PQCMLKEMGenerateEncapsulationCryptoRoundTripDESedeTest extends CamelTestSupport {
    ...
    public PQCMLKEMGenerateEncapsulationCryptoRoundTripDESedeTest() throws NoSuchAlgorithmException {
    }
