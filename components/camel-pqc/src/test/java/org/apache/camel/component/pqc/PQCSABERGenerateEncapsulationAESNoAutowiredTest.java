...
public class PQCSABERGenerateEncapsulationAESNoAutowiredTest extends CamelTestSupport {
    ...
    public PQCSABERGenerateEncapsulationAESNoAutowiredTest() throws NoSuchAlgorithmException {
    }
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:encapsulate").to(
                        "pqc:keyenc?operation=generateSecretKeyEncapsulation&symmetricKeyAlgorithm=AES&keyEncapsulationAlgorithm=SABER")
                        .to("mock:encapsulate")
                        .to("pqc:keyenc?operation=extractSecretKeyEncapsulation&symmetricKeyAlgorithm=AES&keyEncapsulationAlgorithm=SABER")
                        .to("mock:extract");
            }
        };
    }
