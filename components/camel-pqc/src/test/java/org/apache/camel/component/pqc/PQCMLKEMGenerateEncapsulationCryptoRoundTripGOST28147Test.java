...
public class PQCMLKEMGenerateEncapsulationCryptoRoundTripGOST28147Test extends CamelTestSupport {
    ...
    public PQCMLKEMGenerateEncapsulationCryptoRoundTripGOST28147Test() throws NoSuchAlgorithmException {}

    @Override
    protected RouteBuilder createRouteBuilder() {
        CryptoDataFormat cryptoFormat = new CryptoDataFormat("GOST28147", null);
        return new RouteBuilder() {
            @Override
            public void configure() {
                from("direct:encapsulate")
                        .to(
                                "pqc:keyenc?operation=generateSecretKeyEncapsulation&symmetricKeyAlgorithm=GOST28147&symmetricKeyLength=256")
                        .to("mock:encapsulate")
                        .to(
                                "pqc:keyenc?operation=extractSecretKeyEncapsulation&symmetricKeyAlgorithm=GOST28147&symmetricKeyLength=256")
                        .to(
                                "pqc:keyenc?operation=extractSecretKeyFromEncapsulation&symmetricKeyAlgorithm=GOST28147&symmetricKeyLength=256")
    ...
    void testSignAndVerify() throws Exception {
        ...
        assertEquals(
                PQCSymmetricAlgorithms.GOST28147.getAlgorithm(),
                resultEncapsulate
                        .getExchanges()
                        .get(0)
                        .getMessage()
