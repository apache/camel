...
/**
 * Test for hybrid signature using Ed25519 + ML-DSA.
 */
public class PQCHybridSignatureEd25519MLDSATest extends CamelTestSupport {
    ...
    @Test
    void testHybridSignAndVerifyWithEd25519() throws Exception {
        resultSign.expectedMessageCount(1);
        resultVerify.expectedMessageCount(1);

        templateSign.sendBody("Hello, Ed25519 + ML-DSA hybrid!");
