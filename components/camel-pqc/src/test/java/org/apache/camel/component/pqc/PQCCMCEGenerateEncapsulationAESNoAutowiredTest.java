...
public class PQCCMCEGenerateEncapsulationAESNoAutowiredTest extends CamelTestSupport {
    ...
    public PQCCMCEGenerateEncapsulationAESNoAutowiredTest() throws NoSuchAlgorithmException {
    }
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:encapsulate").to(
                        "pqc:keyenc?operation=generateSecretKeyEncapsulation&symmetricKeyAlgorithm=AES&keyEncapsulationAlgorithm=CMCE")
                        .to("mock:encapsulate")
                        .to("pqc:keyenc?operation=extractSecretKeyEncapsulation&symmetricKeyAlgorithm=AES&keyEncapsulationAlgorithm=CMCE")
                        .to("mock:extract");
            }
        };
    }
