...
public class PQCMLKEMGenerateEncapsulationCryptoRoundTripCAST5Test extends CamelTestSupport {
    ...
    public PQCMLKEMGenerateEncapsulationCryptoRoundTripCAST5Test() throws NoSuchAlgorithmException {}
    ...
    void testSignAndVerify() throws Exception {
        ...
        assertEquals(
                PQCSymmetricAlgorithms.CAST5.getAlgorithm(),
                resultEncapsulate
                        .getExchanges()
                        .get(0)
                        .getMessage()
