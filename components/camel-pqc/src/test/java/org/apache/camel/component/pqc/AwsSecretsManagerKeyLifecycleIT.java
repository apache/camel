...
import org.apache.camel.component.pqc.lifecycle.AwsSecretsManagerKeyLifecycleManager;
 ...
 * rotation, and usage in Camel routes with a real AWS Secrets Manager instance via testcontainers (LocalStack).
 */
public class AwsSecretsManagerKeyLifecycleIT extends CamelTestSupport {
    ...
    protected CamelContext createCamelContext() throws Exception {
        ...
        // Create AwsSecretsManagerKeyLifecycleManager using AWS test infrastructure
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                // Signing route using PQC component with AWS Secrets Manager-stored key
                from("direct:sign")
