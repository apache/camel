...
public class PQCMLKEMGenerateEncapsulationCryptoRoundTripCAST6Test extends CamelTestSupport {
    ...
    public PQCMLKEMGenerateEncapsulationCryptoRoundTripCAST6Test() throws NoSuchAlgorithmException {}
    ...
    void testSignAndVerify() throws Exception {
        ...
        assertEquals(
                PQCSymmetricAlgorithms.CAST6.getAlgorithm(),
                resultEncapsulate
                        .getExchanges()
                        .get(0)
                        .getMessage()
