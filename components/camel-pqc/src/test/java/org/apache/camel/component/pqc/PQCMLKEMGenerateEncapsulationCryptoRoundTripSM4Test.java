...
public class PQCMLKEMGenerateEncapsulationCryptoRoundTripSM4Test extends CamelTestSupport {
    ...
    public PQCMLKEMGenerateEncapsulationCryptoRoundTripSM4Test() throws NoSuchAlgorithmException {}
    ...
    void testSignAndVerify() throws Exception {
        ...
        assertEquals(
                PQCSymmetricAlgorithms.SM4.getAlgorithm(),
                resultEncapsulate
                        .getExchanges()
                        .get(0)
                        .getMessage()
