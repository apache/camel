...
public class PQCMLKEMGenerateEncapsulationCryptoRoundTripRC2Test extends CamelTestSupport {
    ...
    public PQCMLKEMGenerateEncapsulationCryptoRoundTripRC2Test() throws NoSuchAlgorithmException {}
    ...
    void testSignAndVerify() throws Exception {
        ...
        assertEquals(
                PQCSymmetricAlgorithms.RC2.getAlgorithm(),
                resultEncapsulate
                        .getExchanges()
                        .get(0)
                        .getMessage()
