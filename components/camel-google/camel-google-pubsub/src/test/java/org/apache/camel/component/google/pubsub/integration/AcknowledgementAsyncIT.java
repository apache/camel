...
public class AcknowledgementAsyncIT extends PubsubTestSupport {
    private static final Logger LOG = LoggerFactory.getLogger(AcknowledgementAsyncIT.class);
    ...
    @EndpointInject("google-pubsub:{{project.id}}:" + SUBSCRIPTION_NAME + "?synchronousPull=false")
