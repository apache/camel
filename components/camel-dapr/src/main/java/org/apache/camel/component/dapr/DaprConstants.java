...
public class DaprConstants {
    ...
    @Metadata(
            label = "producer",
            description = "The query parameters for HTTP requests",
    ...
    @Metadata(
            label = "producer",
            description = "The HttpExtension object for service invocation. Takes precedence over verb",
    ...
    @Metadata(
            label = "producer",
            description = "List of transactions for execute transactions state operations",
    ...
    @Metadata(
            label = "consumer",
            description = "Gets the string indicating the type of cloud event",
            javaType = "String")
    public static final String TYPE = HEADER_PREFIX + "Type";

    @Metadata(
            label = "consumer",
            description = "Gets the version of the CloudEvents specification that the event conforms to",
            javaType = "String")
    ...
    @Metadata(
            label = "consumer",
            description = "Gets the raw binary data payload of the event, if present "
    ...
    @Metadata(
            label = "consumer",
            description = "Gets the timestamp of when the event occurred",
    ...
    @Metadata(
            label = "consumer",
            description =
                    "Gets tracing info for following the event across services " + "(includes trace ID and span ID)",
            javaType = "String")
    ...
    @Metadata(
            label = "common",
            description = "The raw configuration update response",
    ...
    @Metadata(
            label = "producer",
            description = "The FQCN of the class which implements io.dapr.workflows.Workflow",
            javaType = "String")
    ...
    @Metadata(
            label = "producer",
            description = "Gets the workflow instance's creation time in UTC",
            javaType = "Instant")
    public static final String WORKFLOW_CREATED_AT = HEADER_PREFIX + "WorkflowCreatedAt";

    @Metadata(
            label = "producer",
            description = "Gets the workflow instance's last updated time in UTC",
            javaType = "Instant")
    public static final String WORKFLOW_UPDATED_AT = HEADER_PREFIX + "WorkflowUpdatedAt";

    @Metadata(
            label = "producer",
            description = "Gets the workflow instance's serialized input, if any",
            javaType = "String")
    public static final String WORKFLOW_SERIALIZED_INPUT = HEADER_PREFIX + "WorkflowSerializedInput";

    @Metadata(
            label = "producer",
            description = "Gets the workflow instance's serialized output, if any",
            javaType = "String")
    ...
    @Metadata(
            label = "producer",
            description = "Set true if the workflow existed and was in a running state otherwise false",
            javaType = "boolean")
    public static final String IS_WORKFLOW_RUNNING = HEADER_PREFIX + "IsWorkflowRunning";

    @Metadata(
            label = "producer",
            description = "Set true if the workflow was in a terminal state; otherwise false",
            javaType = "boolean")
