...
public class FaceRecognitionInvalidParamsTest extends CamelTestSupport {
        ...
        return new RouteBuilder() {
            public void configure() {
                ...
                from("direct:face_verification_only_one_image_set")
                        .setProperty(FaceRecognitionProperties.FACE_IMAGE_FILE_PATH, constant(testConfiguration.getProperty("imageFilePath")))
                        .to("hwcloud-frs:faceVerification?"
                                + "accessKey=" + testConfiguration.getProperty("accessKey")
                                + "&secretKey=" + testConfiguration.getProperty("secretKey")
                                + "&projectId=" + testConfiguration.getProperty("projectId")
                ...
                from("direct:face_verification_image_sources_not_match")
                        .setProperty(FaceRecognitionProperties.FACE_IMAGE_BASE64, constant(testConfiguration.getProperty("imageBase64")))
                        .setProperty(FaceRecognitionProperties.ANOTHER_FACE_IMAGE_URL, constant(testConfiguration.getProperty("imageFilePath")))
                        .to("hwcloud-frs:faceVerification?"
                                + "accessKey=" + testConfiguration.getProperty("accessKey")
                                + "&secretKey=" + testConfiguration.getProperty("secretKey")
                                + "&projectId=" + testConfiguration.getProperty("projectId")
                ...
                from("direct:face_verification_image_file_not_found")
                        .setProperty(FaceRecognitionProperties.FACE_IMAGE_FILE_PATH, constant(testFilePath))
                        .setProperty(FaceRecognitionProperties.ANOTHER_FACE_IMAGE_FILE_PATH, constant(testConfiguration.getProperty("imageFilePath")))
                        .to("hwcloud-frs:faceVerification?"
                                + "accessKey=" + testConfiguration.getProperty("accessKey")
                                + "&secretKey=" + testConfiguration.getProperty("secretKey")
                                + "&projectId=" + testConfiguration.getProperty("projectId")
                ...
                from("direct:face_live_detection_actions_not_set")
                        .setProperty(FaceRecognitionProperties.FACE_VIDEO_FILE_PATH, constant(testConfiguration.getProperty("videoFilePath")))
                        .to("hwcloud-frs:faceLiveDetection?"
                                + "accessKey=" + testConfiguration.getProperty("accessKey")
                                + "&secretKey=" + testConfiguration.getProperty("secretKey")
                                + "&projectId=" + testConfiguration.getProperty("projectId")
    ...
    public void testAccessKeyNotSet() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:access_key_not_set", ""));
    ...
    public void testSecretKeyNotSet() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:secret_key_not_set", ""));
        assertTrue(exception.getCause() instanceof IllegalArgumentException);
    ...
    public void testProjectIdNotSet() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:project_id_not_set", ""));
        assertTrue(exception.getCause() instanceof IllegalArgumentException);
    ...
    public void testRegionIdNotSet() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:region_id_not_set", ""));
        assertTrue(exception.getCause() instanceof IllegalArgumentException);
    ...
    public void testOperationNotSet() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:operation_not_set", ""));
        assertTrue(exception.getCause() instanceof IllegalArgumentException);
    ...
    public void testOperationInvalid() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:operation_invalid", ""));
    ...
    public void testFaceDetectionImageNotSet() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:face_detection_image_not_set", ""));
        assertTrue(exception.getCause() instanceof IllegalArgumentException);
    ...
    public void testFaceDetectionImageFileInvalid() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:face_detection_image_file_not_found", ""));
        assertTrue(exception.getCause() instanceof IllegalArgumentException);
    ...
    public void testFaceVerificationImageNotSet() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:face_verification_image_not_set", ""));
        assertTrue(exception.getCause() instanceof IllegalArgumentException);
        String expectedMessage = "any one of image base64, url and filePath needs to be set";
        assertTrue(exception.getCause().getMessage().contains(expectedMessage));
    }
    ...
    public void testFaceVerificationImageSourcesNotMatch() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:face_verification_image_sources_not_match", ""));
        assertTrue(exception.getCause() instanceof IllegalArgumentException);
        String expectedMessage = "any one of image base64, url and filePath needs to be set";
        assertTrue(exception.getCause().getMessage().contains(expectedMessage));
    }
    ...
    public void testFaceVerificationImageFileInvalid() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:face_verification_image_file_not_found", ""));
        assertTrue(exception.getCause() instanceof IllegalArgumentException);
        String expectedMessage = String.format("File path is invalid: %s", testFilePath);
        assertTrue(exception.getCause().getMessage().contains(expectedMessage));
    }
    ...
    public void testFaceLiveDetectionVideoNotSet() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:face_live_detection_video_not_set", ""));
        assertTrue(exception.getCause() instanceof IllegalArgumentException);
    ...
    public void testFaceLiveDetectionVideoFileInvalid() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:face_live_detection_video_file_not_found", ""));
        assertTrue(exception.getCause() instanceof IllegalArgumentException);
        String expectedMessage = String.format("File path is invalid: %s", testFilePath);
        assertTrue(exception.getCause().getMessage().contains(expectedMessage));
    }
    ...
    public void testFaceLiveDetectionVideoActionsNotSet() {
        Exception exception = assertThrows(CamelExecutionException.class, () -> template.sendBody("direct:face_live_detection_actions_not_set", ""));
        assertTrue(exception.getCause() instanceof IllegalArgumentException);
