...
._Java-only: requires SDK UpdateUserOption builder_
...
<route>
  ...
  <setBody>
    <constant>{"name":"user","description":"employee","email":"user@email.com"}</constant>
  </setBody>
  <to uri="hwcloud-iam:updateUser?userId=********&amp;region=cn-north-4&amp;accessKey=********&amp;secretKey=********"/>
</route>
----
...
- route:
    from:
      ...
      steps:
        - setBody:
            constant: '{"name":"user","description":"employee","email":"user@email.com"}'
        - to:
            uri: hwcloud-iam:updateUser
            parameters:
              userId: "********"
              region: cn-north-4
              accessKey: "********"
...
._Java-only: requires SDK KeystoneUpdateGroupOption builder_
...
<route>
  <from uri="direct:triggerRoute"/>
  <setBody>
    <constant>{"name":"group","description":"employees","domain_id":"1234"}</constant>
  </setBody>
  <to uri="hwcloud-iam:updateUser?groupId=********&amp;region=cn-north-4&amp;accessKey=********&amp;secretKey=********"/>
</route>
----
...
- route:
    from:
      ...
      steps:
        - setBody:
            constant: '{"name":"group","description":"employees","domain_id":"1234"}'
        - to:
            uri: hwcloud-iam:updateUser
            parameters:
              groupId: "********"
...
----
from("direct:triggerRoute")
 .setProperty("CamelHwCloudIamOperation", constant("listUsers"))
 .setProperty("CamelHwCloudIamUserId", constant("your_user_id"))
 .setProperty("CamelHwCloudIamGroupId", constant("your_group_id"))
...
<route>
  <from uri="direct:triggerRoute"/>
  <setProperty name="CamelHwCloudIamOperation">
    <constant>listUsers</constant>
  </setProperty>
  <setProperty name="CamelHwCloudIamUserId">
    <constant>your_user_id</constant>
  </setProperty>
  <setProperty name="CamelHwCloudIamGroupId">
    <constant>your_group_id</constant>
  </setProperty>
  <to uri="hwcloud-iam:listUsers?region=cn-north-4&amp;serviceKeys=#myServiceKeyConfig"/>
</route>
----
...
- route:
    from:
      ...
      steps:
        - setProperty:
            name: CamelHwCloudIamOperation
            constant: listUsers
        - setProperty:
            name: CamelHwCloudIamUserId
            constant: your_user_id
        - setProperty:
            name: CamelHwCloudIamGroupId
            constant: your_group_id
        - to:
            uri: hwcloud-iam:listUsers
            parameters:
              region: cn-north-4
