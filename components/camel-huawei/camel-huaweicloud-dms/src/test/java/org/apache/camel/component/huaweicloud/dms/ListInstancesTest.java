...
public class ListInstancesTest extends CamelTestSupport {
            ...
            public void configure() {
                from("direct:operation")
                        .to("hwcloud-dms:listInstances?" + "accessKey="
                                ...
                                + testConfiguration.getProperty("region") + "&engine="
                                + testConfiguration.getProperty("engine") + "&ignoreSslVerification=true"
                                + "&dmsClient=#dmsClient")
    ...
    public void testOperation() throws Exception {
        ...
        ListInstancesResponse response =
                new ListInstancesResponse().withInstances(instances).withInstanceNum(2);
        Mockito.when(mockClient.listInstances(Mockito.any(ListInstancesRequest.class)))
                .thenReturn(response);
