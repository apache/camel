...
= Object Storage Service (OBS) Component
:docTitle: Object Storage Service (OBS)
...
The Object Storage Service (OBS) component supports 2 options, which are listed below.
...
The Object Storage Service (OBS) endpoint is configured using URI syntax:
