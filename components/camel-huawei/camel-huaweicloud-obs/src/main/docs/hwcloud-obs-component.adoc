...
= Huawei Cloud Object Storage Service (OBS) Component
:docTitle: Huawei Cloud Object Storage Service (OBS)
...
The Huawei Cloud Object Storage Service (OBS) component supports 2 options, which are listed below.
...
The Huawei Cloud Object Storage Service (OBS) endpoint is configured using URI syntax:
