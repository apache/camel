...
public class CreateBucketPojoTest extends CamelTestSupport {
    private static final Logger LOG = LoggerFactory.getLogger(CreateBucketPojoTest.class.getName());
    ...
    public void testCreateBucket() throws Exception {
        ...
        CreateBucketRequest newBucket = new CreateBucketRequest(
                testConfiguration.getProperty("bucketName"), testConfiguration.getProperty("bucketLocation"));
