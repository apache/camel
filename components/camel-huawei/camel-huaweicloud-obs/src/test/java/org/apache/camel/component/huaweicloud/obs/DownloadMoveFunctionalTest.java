...
/**
 * Test download objects with moveAfterRead = true and destination bucket does not already exist
 */
public class DownloadMoveFunctionalTest extends CamelTestSupport {
    ...
    private static final String DESTINATION_BUCKET = "replace_this_with_destination_bucket";
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("hwcloud-obs:?" + "serviceKeys=#serviceKeys"
                                ...
                                + DESTINATION_BUCKET + "&ignoreSslVerification=true"
                                + "&maxMessagesPerPoll=10"
                                + "&includeFolders="
                                + INCLUDE_FOLDERS + "&deleteAfterRead=false"
                                + "&moveAfterRead=true")
