...
public class CreateBucketJsonTest extends CamelTestSupport {
    private static final Logger LOG = LoggerFactory.getLogger(CreateBucketJsonTest.class.getName());
    ...
    public void testCreateBucket() throws Exception {
        ...
        String newBucket = "{\"bucketName\":\"" + testConfiguration.getProperty("bucketName") + "\",\"location\":\""
