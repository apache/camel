            ...
            public void configure() {
                from("direct:invoke_function")
                        ...
                        .to("hwcloud-functiongraph:invokeFunction?" + "accessKey="
                                ...
                                + testConfiguration.getProperty("projectId") + "&endpoint="
                                + testConfiguration.getProperty("endpoint") + "&functionName="
                                + testConfiguration.getProperty("functionName") + "&functionPackage="
                                + testConfiguration.getProperty("functionPackage") + "&ignoreSslVerification=true"
