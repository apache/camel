        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:invoke_function")
                        ...
                        .setProperty(
                                FunctionGraphProperties.FUNCTION_NAME,
                                constant(testConfiguration.getProperty("functionName")))
                        .setProperty(
                                FunctionGraphProperties.FUNCTION_PACKAGE,
                                constant(testConfiguration.getProperty("functionPackage")))
                        .to("hwcloud-functiongraph:dummy-operation?" + "accessKey="
                                + testConfiguration.getProperty("accessKey") + "&secretKey="
                                + testConfiguration.getProperty("secretKey") + "&projectId="
                                + testConfiguration.getProperty("projectId") + "&region=dummy-region"
                                + "&endpoint="
                                + testConfiguration.getProperty("endpoint") + "&functionName=dummy-function-name"
