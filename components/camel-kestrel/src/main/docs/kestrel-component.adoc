...
| *camel.component.kestrel.configuration.concurrent-consumers* | The number of concurrent consumers | 1 | int
| *camel.component.kestrel.configuration.wait-time-ms* | The wait time in milliseconds | 100 | int
