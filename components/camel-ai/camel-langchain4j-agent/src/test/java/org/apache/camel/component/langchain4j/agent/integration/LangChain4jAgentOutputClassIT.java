...
public class LangChain4jAgentOutputClassIT extends CamelTestSupport {
    ...
    void testOutputClassWithoutMemory() throws Exception {
        ...
        CarRentalRecommendation response = template.requestBody("direct:outputClass",
    ...
    void testOutputClassWithMemory() throws Exception {
        ...
        // First request
        CarRentalRecommendation response1 = template.requestBodyAndHeader("direct:outputClassWithMemory",
        ...
        CarRentalRecommendation response2 = template.requestBodyAndHeader("direct:outputClassWithMemory",
