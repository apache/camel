...
class LangChain4jChatObservabilityTest extends CamelTestSupport {
    ...
    protected void bindToRegistry(Registry registry) {
        registry.bind("chatModel", new StubChatModel());
    }
    ...
    void shouldEmitGenAiSpanAndModelHeadersFromProducer() throws Exception {
        ...
        assertThat(mock.getExchanges().get(0).getMessage().getHeader(LangChain4jChatHeaders.REQUEST_MODEL))
                .isEqualTo("gpt-4o");
        assertThat(mock.getExchanges().get(0).getMessage().getHeader(LangChain4jChatHeaders.RESPONSE_MODEL))
