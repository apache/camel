...
TIP: Not sure whether to use this component or xref:openai-component.adoc[OpenAI]? See the xref:ai-llm-integration-guide.adoc[LLM Integration Guide] decision matrix.
