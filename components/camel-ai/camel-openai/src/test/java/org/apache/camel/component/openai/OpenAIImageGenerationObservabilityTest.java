...
class OpenAIImageGenerationObservabilityTest extends CamelTestSupport {

    private static final byte[] IMAGE = "FAKE-PNG".getBytes(StandardCharsets.UTF_8);
    ...
    void shouldEmitGenerateContentGenAiSpan() {
        ...
        assertThat(result.getMessage().getBody(byte[].class)).isEqualTo(IMAGE);
        ...
        assertThat(tags.get(GenAiAttributes.REQUEST_MODEL)).isEqualTo("gpt-image-1");
