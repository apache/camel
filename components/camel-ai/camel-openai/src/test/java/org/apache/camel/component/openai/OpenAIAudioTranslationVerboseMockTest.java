...
public class OpenAIAudioTranslationVerboseMockTest extends CamelTestSupport {
    ...
    private static final String TRANSLATION_TEXT = "The stale smell of old beer lingers.";
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:translate-verbose")
                        .to("openai:audio-translation?audioModel=whisper-1&audioResponseFormat=verbose_json"
