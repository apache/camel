...
* `IllegalArgumentException`:
  ...
  ** When the audio model is missing (audio-transcription, audio-translation), the speech model is missing (audio-speech) or the moderation model is missing (moderation)
