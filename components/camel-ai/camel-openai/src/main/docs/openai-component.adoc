...
The LLM component provides integration with OpenAI and OpenAI-compatible APIs (Ollama, vLLM, LM Studio, OpenRouter, Azure OpenAI, and others) for chat completion, text embeddings, audio transcription, audio translation, and text-to-speech using the official openai-java SDK.
