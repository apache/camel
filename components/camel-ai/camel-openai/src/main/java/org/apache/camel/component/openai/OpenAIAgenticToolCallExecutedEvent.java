 ...
 * @since 4.23
 */
public final class OpenAIAgenticToolCallExecutedEvent extends AbstractOpenAIExchangeEvent {
    ...
    public OpenAIAgenticToolCallExecutedEvent(
                                              Exchange exchange, int iteration, String toolName, long durationMs,
                                              boolean success) {
        super(exchange);
