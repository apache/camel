...
public class LangChain4jEmbeddingStoreComponentWeaviateTargetIT extends CamelTestSupport {
    public static final long POINT_ID = 8;
    public static final String WEAVIATE_URI = "langchain4j-embeddingstore";
    ...
    protected CamelContext createCamelContext() throws Exception {
        ...
        EmbeddingStore<TextSegment> embeddingStore = WeaviateEmbeddingStore.builder()
                .scheme("http")
                .host(WEAVIATE.getWeaviateEndpointUrl())
                .objectClass("Test")
                .avoidDups(true)
