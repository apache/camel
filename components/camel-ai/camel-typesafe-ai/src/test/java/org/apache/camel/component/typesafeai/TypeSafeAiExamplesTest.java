...
/** Example routes run against the mock by default, or a configured System One API. */
class TypeSafeAiExamplesTest {
    @RegisterExtension
    ...
    void start() throws Exception {
        main = new Main();
        main.addProperty("camel.component.typesafe-ai.api-key", service.getApiKey());
        main.addProperty("camel.component.typesafe-ai.base-url", service.getBaseUrl());
        main.addProperty("camel.component.typesafe-ai.model", service.getModel());
