...
:description: Camel PyTorch TorchServe support
:since: 4.9
...
The TorchServe component provides support for invoking the https://pytorch.org/serve/rest_api.html[TorchServe REST API].
