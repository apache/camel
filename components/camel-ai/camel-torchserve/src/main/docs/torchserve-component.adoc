...
[NOTE]
====
This component is deprecated since Camel 4.14 and will be removed in a future release.
Please use the xref:langchain4j-chat-component.adoc[LangChain4j] component instead.
====
