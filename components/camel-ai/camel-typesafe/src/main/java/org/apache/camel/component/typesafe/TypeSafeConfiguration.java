...
@UriParams
public class TypeSafeConfiguration implements Cloneable {
    ...
    /** Default inclusive probability threshold for the TypeSafe language. Must be within [0,1]. */
    ...
    /** Default half-width of the inclusive uncertainty band for the TypeSafe language. Zero disables the band. */
    ...
    /** Default action for the TypeSafe language within the uncertainty band: NonMatch or Fail. */
    ...
    /**
     * The Simple expression selecting state for configured producer questions and the TypeSafe language. If not set,
    ...
    public TypeSafeConfiguration copy() {
        try {
            return (TypeSafeConfiguration) clone();
