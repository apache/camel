...
class TypeSafeTimeoutTest {
    ...
    void httpTimeoutsHaveTheSamePublicTypeAsTheOverallDeadline(boolean connecting) throws Exception {
        ...
        TypeSafeConfiguration configuration = new TypeSafeConfiguration();
        ...
        try (var factory = mockStatic(HttpClient.class)) {
            ...
            try (TypeSafeClient client = new TypeSafeClient(configuration)) {
                assertThatThrownBy(() -> client.evaluate(TypeSafeTestSupport.request("Refund")))
