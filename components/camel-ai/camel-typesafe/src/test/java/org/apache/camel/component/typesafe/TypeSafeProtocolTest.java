...
class TypeSafeProtocolTest extends TypeSafeTestSupport {
    @Test
    void preservesStructuredCriteriaNullChoiceDescriptionsAndAdditionalResponseFields() throws Exception {
        ...
        JsonObject actual = template.requestBody("typesafe:structured", input, JsonObject.class);
    ...
    void rejectsInvalidRequestsBeforeHttp(Map<String, Object> request) {
        Exchange exchange = template.request("typesafe:invalid", e -> e.getMessage().setBody(request));
    ...
    void rejectsInconsistentAnswersAndUsage(String path, String field, Object value) throws Exception {
        ...
        Exchange exchange = template.request("typesafe:invalid", e -> e.getMessage().setBody(mixedRequest("hello")));
    ...
    void preservesRoundedProbabilitiesAndIndependentlyRoundedScore() throws Exception {
        ...
        assertThat(template.requestBody("typesafe:rounded", mixedRequest("hello"), JsonObject.class))
    ...
    void preservesMissingAndNullTokenCounts(Map<String, Object> usage) throws Exception {
        ...
        JsonObject actual = template.requestBody("typesafe:usage", mixedRequest("hello"), JsonObject.class);
    ...
    void acceptsOptionalInstructionsNullNoulCriteriaAndSingleScoreLevel(String json) throws Exception {
        ...
        JsonObject actual = template.requestBody("typesafe:optional",
