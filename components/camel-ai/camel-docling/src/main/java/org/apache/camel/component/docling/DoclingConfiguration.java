...
public class DoclingConfiguration implements Cloneable {
    ...
    @Metadata(
            required = true,
            defaultValue = "CONVERT_TO_MARKDOWN",
    ...
    @Metadata(
            ...
            defaultValue = "en",
            enums =
                    "en,es,fr,de,it,pt,ru,zh,ja,ko,ar,hi,th,vi,tr,pl,nl,sv,da,no,fi,cs,hu,el,he,fa,ur,bn,ta,te,ml,kn,gu,pa,or,as,ne,si,my,lo,km,ka,hy,eu,mt,is,ga,cy,gd,br,oc,ca,gl,ast,an,lad,la,eo,ia,ie,vo,jbo,tlh")
    private String ocrLanguage = "en";

    @UriParam
    @Metadata(
            description = "Output format for document conversion",
    ...
    @UriParam
    @Metadata(
            description = "Include the content of the output file in the exchange body and delete the output file",
            defaultValue = "false")
    ...
    @UriParam(label = "advanced")
    @Metadata(
            description = "Maximum time to wait for async conversion completion in milliseconds",
            defaultValue = "300000")
    ...
    @UriParam(label = "advanced")
    @Metadata(
            description = "Connection request timeout in milliseconds (timeout when requesting connection from pool)",
            defaultValue = "30000")
    ...
    @UriParam(label = "batch")
    @Metadata(
            description = "Fail entire batch on first error (true) or continue processing remaining documents (false)",
            defaultValue = "true")
