...
For OpenAI-specific detail see xref:openai-component.adoc#_structured_error_exchange_properties[OpenAI structured error properties]. For LangChain4j chat see xref:langchain4j-chat-component.adoc#_structured_error_exchange_properties[LangChain4j Chat structured error properties].
