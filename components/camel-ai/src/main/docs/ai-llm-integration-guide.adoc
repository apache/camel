...
TIP: For a catalog of all AI components, start at xref:ai-summary.adoc[AI Components]. For coding-agent context about Camel itself, see https://camel.apache.org/llms.txt[llms.txt].
