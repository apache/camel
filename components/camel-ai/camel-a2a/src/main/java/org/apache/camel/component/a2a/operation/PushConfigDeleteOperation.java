...
/**
 * Implementation of the DeleteTaskPushNotificationConfig A2A operation. Infrastructure-only operation for removing a
 * push notification configuration.
 */
public class PushConfigDeleteOperation implements A2AOperation {

    @Override
    public A2AOperations getOperationType() {
        return A2AOperations.PUSH_CONFIG_DELETE;
    }
