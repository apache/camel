...
public interface TaskPredictor {
    ...
    /**
     * Sets the component configuration on the predictor.
     *
     * @param config The {@link HuggingFaceConfiguration} to be used.
     */
    void setConfig(HuggingFaceConfiguration config);
}
