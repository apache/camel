...
public class TextGenerationPredictor extends AbstractTaskPredictor {
    public TextGenerationPredictor(HuggingFaceConfiguration config) {
        super(config);
    }
        ...
        return """
                ...
                def handle(inputs: Input):
                    try:
                        ...
                        return outputs
                """
                .formatted(config.getModelId(), config.getRevision(), config.getDevice(), config.getMaxTokens(), doSample,
                        temperature);
    }
