...
import org.apache.camel.component.jev.JevConfiguration;
import org.apache.camel.component.jev.JevEndpoint;
import org.apache.camel.component.jev.JevUncertainResultException;
...
/** Evaluates a plain-text Noul question against selected exchange state through a managed Jev endpoint. */
@Language(value = "jev", modelName = "language")
@Metadata(title = "Jev", description = "Evaluate a Noul question with the TypeSafe AI Jev decision API",
...
public class JevLanguage extends LanguageSupport {
    ...
    private String endpoint = "jev:default";
    ...
    public boolean validateExpression(String expression) {
        if (expression == null || expression.isBlank()) {
            throw new IllegalArgumentException("Jev question must not be null or blank");
        }
        return true;
    }
    ...
    /** Managed endpoint URI. Defaults to jev:default, inheriting camel.component.jev settings. */
    ...
    private static final class Evaluation extends ExpressionAdapter {
        ...
        public void init(CamelContext context) {
            super.init(context);
            if (endpointUri == null || !endpointUri.startsWith("jev:")) {
                throw new IllegalArgumentException("Jev language endpoint must be a jev: URI");
            }
            ...
            JevConfiguration configuration = endpoint.getConfiguration();
            ...
            if (selection instanceof Expression expression) {
                ...
                throw new IllegalArgumentException("Jev state must be an Expression or a nonblank Simple string");
            }
            state.init(context);
        }
        ...
        public Object evaluate(Exchange exchange) {
            ...
            try {
                if (endpoint == null) {
                    throw new IllegalStateException("Jev expression must be initialized");
                }
        ...
        public String toString() {
            ...
            return "jev[endpoint=" + (endpointUri == null ? "" : endpointUri.split("\\?", 2)[0])
                   + ", threshold=" + threshold + "]";
        }
    }
}
