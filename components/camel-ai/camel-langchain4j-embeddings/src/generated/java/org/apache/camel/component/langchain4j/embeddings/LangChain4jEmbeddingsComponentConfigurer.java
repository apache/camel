...
public class LangChain4jEmbeddingsComponentConfigurer extends PropertyConfigurerSupport implements GeneratedPropertyConfigurer, PropertyConfigurerGetter {

    private org.apache.camel.component.langchain4j.embeddings.LangChain4jEmbeddingsConfiguration getOrCreateConfiguration(LangChain4jEmbeddingsComponent target) {
        if (target.getConfiguration() == null) {
            target.setConfiguration(new org.apache.camel.component.langchain4j.embeddings.LangChain4jEmbeddingsConfiguration());
        }
