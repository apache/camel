...
public class ZooTextClassificationPredictor extends AbstractNlpZooPredictor<Classifications> {

    public ZooTextClassificationPredictor(DJLEndpoint endpoint) throws ModelNotFoundException, MalformedModelException,
                                                                IOException {
        super(endpoint);
