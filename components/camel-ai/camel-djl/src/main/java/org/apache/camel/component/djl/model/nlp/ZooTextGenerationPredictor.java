...
public class ZooTextGenerationPredictor extends AbstractNlpZooPredictor<String> {

    public ZooTextGenerationPredictor(DJLEndpoint endpoint) throws ModelNotFoundException, MalformedModelException,
                                                            IOException {
        super(endpoint);
