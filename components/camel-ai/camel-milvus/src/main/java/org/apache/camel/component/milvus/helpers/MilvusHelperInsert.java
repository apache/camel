...
/**
 * A Camel {@link Processor} that builds a Milvus {@link io.milvus.param.dml.InsertParam} from the exchange body vector
 * and exchange variables mapped via {@link #setTextFieldMappings(String)}, then sets it as the exchange body together
 * with the {@link MilvusAction#INSERT} header.
 */
public class MilvusHelperInsert implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        for (Map.Entry<String, String> entry : mappings.entrySet()) {
            ...
            fields.add(new InsertParam.Field(entry.getKey(), Collections.singletonList(value)));
        }
