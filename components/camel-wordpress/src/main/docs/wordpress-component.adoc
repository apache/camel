...
|===
| Name | Description | Default | Type
| *camel.component.wordpress.configuration.api-version* | null | 2 | String
| *camel.component.wordpress.configuration.criteria-properties* | null |  | Map
| *camel.component.wordpress.configuration.force* | null | false | boolean
| *camel.component.wordpress.configuration.id* | null |  | int
| *camel.component.wordpress.configuration.password* | null |  | String
| *camel.component.wordpress.configuration.search-criteria.exclude* | null |  | List
| *camel.component.wordpress.configuration.search-criteria.include* | null |  | List
| *camel.component.wordpress.configuration.search-criteria.order* | null |  | Order
| *camel.component.wordpress.configuration.search-criteria.page* | null |  | int
| *camel.component.wordpress.configuration.search-criteria.per-page* | null |  | int
| *camel.component.wordpress.configuration.search-criteria.search* | null |  | String
| *camel.component.wordpress.configuration.url* | null |  | String
| *camel.component.wordpress.configuration.user* | null |  | String
| *camel.component.wordpress.enabled* | null |  | boolean
