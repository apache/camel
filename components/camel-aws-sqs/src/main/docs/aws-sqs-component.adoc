...
The AWS Simple Queue Service (SQS) component supports 38 options, which are listed below.
...
include::{page-component-version}@camel-spring-boot::page$aws-sqs-starter.adoc[]
