...
Use xref:servlet-component.adoc[Servlet] in Spring web applications for simplicity's sake. See
xref:ServletTomcatExample-ServletTomcatExample.adoc[Servlet Tomcat Example] for details.
...
See xref:ServletTomcatExample-ServletTomcatExample,.adoc[Servlet Tomcat Example].
