    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                restConfiguration().component("servlet").host("localhost").bindingMode(RestBindingMode.auto);
                ...
                rest("/v3/empty").get("/country").to("direct:v3country").enableNoContentResponse(true);
                ...
                from("direct:v1address")
                        .setHeader(
                                JaxbConstants.JAXB_PART_CLASS,
                                simple("org.apache.camel.component.servlet.rest.Address"))
                        .setHeader(
