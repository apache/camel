...
/**
 * This interface fuses the EventHandler and LifecycleAware interfaces. It also provides a handle to await the
 * termination of this EventHandler.
 */
interface LifecycleAwareExchangeEventHandler extends EventHandler<ExchangeEvent>, LifecycleAware {

    /**
     * Causes the current thread to wait until the event handler has been started, unless the thread is
     ...
     * @return                      {@code true} if the event hanlder is stopped and {@code false} if the waiting time
    ...
    /**
     * Causes the current thread to wait until the event handler has been shut down, unless the thread is
     * {@linkplain Thread#interrupt interrupted}.
     * <p/>
     * <p>
