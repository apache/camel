...
public class DisruptorReference {
    ...
    private final AtomicMarkableReference<Disruptor<ExchangeEvent>> disruptor
            = new AtomicMarkableReference<Disruptor<ExchangeEvent>>(null, false);
    ...
    private Disruptor<ExchangeEvent> createDisruptor() throws Exception {
        ...
        final ArrayList<LifecycleAwareExchangeEventHandler> eventHandlers
                = new ArrayList<LifecycleAwareExchangeEventHandler>();
