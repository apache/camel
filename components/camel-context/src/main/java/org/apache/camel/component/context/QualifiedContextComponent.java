...
/**
 * Supports the explicit and verbose URIs of the form <b>context:camelContextId:someEndpoint</b> to access
 * a local endpoint inside an external CamelContext.
 * <p/>
 * Typically there's no need to use this level of verbosity, you can just use <b>camelContextId:someEndpoint</b>
 */
