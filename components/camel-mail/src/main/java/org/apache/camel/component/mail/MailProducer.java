...
public class MailProducer extends DefaultAsyncProducer {
    ...
    protected JavaMailSender getSender(Exchange exchange) {
        ...
        // default because mail.smtp.* is a Camel-internal namespace that is not filtered by any
        // HeaderFilterStrategy, so an untrusted producer could otherwise weaken transport security or
