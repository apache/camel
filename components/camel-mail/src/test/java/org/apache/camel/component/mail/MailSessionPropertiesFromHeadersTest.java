...
/**
 * Verifies that dynamic JavaMail session properties provided as {@code mail.smtp.*} message headers only override the
 * endpoint configuration when explicitly opted-in via {@code useJavaMailSessionPropertiesFromHeaders=true}
 * (CAMEL-23522).
 */
