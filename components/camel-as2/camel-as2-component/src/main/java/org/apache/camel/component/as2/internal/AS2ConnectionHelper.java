...
public final class AS2ConnectionHelper {
    ...
    private static final Map<Integer, AS2AsyncMDNServerConnection> asyncMdnServerConnections =
    ...
    public static void closeAllServerConnections() {
        for (Map.Entry<Integer, AS2ServerConnection> entry : serverConnections.entrySet()) {
            try {
                ...
                // ignore
                LOG.debug(
                        "Error stopping and closing AS2ServerConnection due to {}. This exception is ignored",
                        e.getMessage(),
                        e);
            }
        }
    ...
    public static void closeAllAsyncMdnServerConnections() {
        for (Map.Entry<Integer, AS2AsyncMDNServerConnection> entry : asyncMdnServerConnections.entrySet()) {
            try {
                ...
                LOG.debug(
                        "Error stopping and closing AsyncMdnServerConnection due to {}. This exception is ignored",
                        e.getMessage(),
                        e);
            }
        }
