...
public class AS2DecryptionException extends AS2ErrorDispositionException {
    ...
    public AS2DecryptionException(String message) {
        super(message);
    }

    public AS2DecryptionException(String message, Exception exception) {
        super(message, exception);
    }

    @Override
    public AS2DispositionModifier getDispositionModifier() {
        return AS2DispositionModifier.ERROR_DECRYPTION_FAILED;
    }
}
