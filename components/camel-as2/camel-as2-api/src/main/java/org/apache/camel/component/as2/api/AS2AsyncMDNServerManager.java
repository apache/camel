...
public class AS2AsyncMDNServerManager {
    ...
    public AS2AsyncMDNServerManager(AS2AsyncMDNServerConnection as2ReceiptServerConnection) {
        this.as2ReceiptServerConnection = as2ReceiptServerConnection;
    }

    public void receive(String requestUriPattern, HttpRequestHandler handler) {
        as2ReceiptServerConnection.receive(requestUriPattern, handler);
    }
}
