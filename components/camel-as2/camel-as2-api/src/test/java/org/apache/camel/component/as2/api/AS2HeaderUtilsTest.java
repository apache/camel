...
public class AS2HeaderUtilsTest {
    ...
    public void parseNameValuePairTest() {
        ...
        assertArrayEquals("Unexpected value for parameter importance", SIGNED_RECEIPT_PROTOCOL_VALUES, parameter.getValues());
        ...
        assertArrayEquals("Unexpected value for parameter importance", SIGNED_RECEIPT_MICALG_VALUES, parameter.getValues());
    }
