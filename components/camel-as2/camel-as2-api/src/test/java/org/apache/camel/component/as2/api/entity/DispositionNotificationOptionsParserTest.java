...
public class DispositionNotificationOptionsParserTest {
    ...
    public void parseDispositionNotificationOptionsTest() throws ParseException {
        ...
        assertEquals(
                SIGNED_RECEIPT_MICALG_ATTRIBUTE,
                signedReceiptMicalg.getAttribute(),
                "Unexpected value for signed receipt micalg attribute");
        assertEquals(
                SIGNED_RECEIPT_MICALG_IMPORTANCE,
                signedReceiptMicalg.getImportance().getImportance(),
                "Unexpected value for signed receipt micalg importance");
        assertArrayEquals(
                SIGNED_RECEIPT_MICALG_VALUES,
                signedReceiptMicalg.getValues(),
