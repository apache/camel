...
| *configuration* (consumer) | Allow pre-configured Configurations to be set, you will need to extend MySqlConnectorEmbeddedDebeziumConfiguration in order to create the configuration for the component |  | MySqlConnectorEmbeddedDebeziumConfiguration
