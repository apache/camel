...
The list of supported protocols is growing in https://plc4x.apache.org[PLC4X]. There are good chance that they will work out of the box just by adding the driver dependency. You can check https://plc4x.apache.org/users/protocols/index.html[here].
