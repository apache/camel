...
:description: Read and write to Programmable Logic Controllers (PLC) devices. It supports various protocols by adding the driver dependencies: Allen Bradley ETH, Automation Device Specification (ADS), CANopen, EtherNet/IP, Firmata, KNXnet/IP, Modbus (TCP/UDP/Serial), Open Platform Communications Unified Architecture (OPC UA), Step7 (S7).
:since: 3.20
:supportlevel: Stable
:tabs-sync-option:
