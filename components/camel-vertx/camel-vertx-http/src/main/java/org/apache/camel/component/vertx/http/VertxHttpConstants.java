...
public final class VertxHttpConstants {
    ...
    @Metadata(
            description = "The HTTP content type. Is set on both the IN and OUT message to provide\n"
                    + "a content type, such as `text/html`.",
            javaType = "String")
    public static final String CONTENT_TYPE = Exchange.CONTENT_TYPE;

    @Metadata(
            description = "URI parameters. Will override existing URI parameters set directly on\n" + "the endpoint.",
            javaType = "String")
    public static final String HTTP_QUERY = Exchange.HTTP_QUERY;

    @Metadata(
            description = "URI to call. Will override the existing URI set directly on the endpoint.\n"
    ...
    @Metadata(
            description = "The HTTP content encoding. Is set to provide a content encoding, such as `gzip`.",
            javaType = "String")
