...
|===
| Name | Description | Default | Type
| *camel.component.iec60870-client.default-connection-options.cause-source-address* | null |  | byte
...
| *camel.component.iec60870-client.enabled* | null |  | boolean
...
| *camel.component.iec60870-server.default-connection-options.buffering-period* | A time period in "ms" the protocol layer will buffer change events in
 order to send out aggregated change messages |  | int
...
| *camel.component.iec60870-server.enabled* | null |  | boolean
