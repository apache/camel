...
class Python3ChoiceTest extends CamelTestSupport {

    @Test
    void testPython3Choice() throws Exception {
    ...
    protected RoutesBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:start")
                        .choice()
                        .when().python3("body == 'Hello'").to("mock:foo")
                        .when().python3("body == 'Bye'").to("mock:bar")
