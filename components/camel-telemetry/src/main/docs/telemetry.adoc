...
This module is a common interface and API for distributed tracing/telemetry. It is not intended to be used directly by end users. It will be eventually implemented by some concrete component.
