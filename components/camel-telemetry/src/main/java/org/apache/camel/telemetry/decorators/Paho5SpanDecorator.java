...
public class Paho5SpanDecorator extends AbstractMessagingSpanDecorator {
    ...
    protected String getDestination(Exchange exchange, Endpoint endpoint) {
        ...
        String destination = exchange.getMessage().getHeader("CamelPahoMqtt5OverrideTopic", String.class);
        if (destination == null) {
    ...
    public String getComponentClassName() {
        return "org.apache.camel.component.paho.mqtt5.PahoMqtt5Component";
    }
