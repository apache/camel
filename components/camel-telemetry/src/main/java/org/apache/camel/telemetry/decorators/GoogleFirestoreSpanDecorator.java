...
public class GoogleFirestoreSpanDecorator extends AbstractSpanDecorator {
    ...
    /**
     * Constants copied from {@link org.apache.camel.component.google.firestore.GoogleFirestoreConstants}
     */
    ...
    public String getComponentClassName() {
        return "org.apache.camel.component.google.firestore.GoogleFirestoreComponent";
    }
    ...
    public void beforeTracingEvent(Span span, Exchange exchange, Endpoint endpoint) {
        ...
        String collectionName = exchange.getIn().getHeader(COLLECTION_NAME, String.class);
        if (collectionName != null) {
            span.setTag(FIRESTORE_COLLECTION_NAME, collectionName);
        }

        String documentId = exchange.getIn().getHeader(DOCUMENT_ID, String.class);
        if (documentId != null) {
