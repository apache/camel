...
public class TarFileMultipleFilesSplitterTest extends TarSplitterRouteTest {
    ...
    public void testSplitter() throws InterruptedException {
        ...
        processTarEntry.expectedBodiesReceivedInAnyOrder("chau", "hi", "hola", "another_chiau", "another_hi");
            ...
            public Exchange aggregate(Exchange oldExchange, Exchange newExchange) {
                if (oldExchange != null) {
                    ...
                    if (processedFiles == null) {
                        processedFiles = oldExchange.getIn().getHeader("tarFileName", String.class);
                    }
                    processedFiles = processedFiles + "," + newExchange.getIn().getHeader("tarFileName", String.class);
