...
String
* Integration with the xref:mina2-component.adoc[Mina 2] component.
* Integration with the xref:netty-component.adoc[Netty] component.
* *Camel 2.14:* Encoder and decoder for
the xref:netty-component.adoc[Netty] component.
...
xref:mina2-component.adoc[Mina 2] component or xref:mina2-component.adoc[Mina 2]
...
existing xref:mina2-component.adoc[Mina 2] component
or xref:netty-component.adoc[Netty] where we just use
...
The same route using xref:mina2-component.adoc[Mina 2]
