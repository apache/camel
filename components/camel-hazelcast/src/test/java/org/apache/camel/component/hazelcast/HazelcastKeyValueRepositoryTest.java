...
class HazelcastKeyValueRepositoryTest {
    ...
    @RegisterExtension
    static HazelcastService hazelcastService = HazelcastServiceFactory.createSingletonService();
    ...
    void testReplaceWithTtl() {
        ...
        boolean replaced = repository.replace("key1", "value1", "value2", Duration.ofMillis(2000));
