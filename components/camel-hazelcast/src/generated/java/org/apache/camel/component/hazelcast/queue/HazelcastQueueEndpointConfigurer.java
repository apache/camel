...
public class HazelcastQueueEndpointConfigurer extends PropertyConfigurerSupport implements GeneratedPropertyConfigurer, PropertyConfigurerGetter {
    ...
    static {
        ...
        map.put("pollingTimeout", long.class);
        map.put("poolSize", int.class);
        map.put("queueConsumerMode", org.apache.camel.component.hazelcast.queue.HazelcastQueueConsumerMode.class);
        ...
        ALL_OPTIONS = map;
        ConfigurerStrategy.addBootstrapConfigurerClearer(HazelcastQueueEndpointConfigurer::clearBootstrapConfigurers);
    }
    ...
    public Class<?> getOptionType(String name, boolean ignoreCase) {
        ...
        case "pollingtimeout":
        case "pollingTimeout": return long.class;
        case "poolsize":
