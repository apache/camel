...
public final class HL723Converter {
    ...
    @Converter
    public static ADT_A46 toAdtA46(String body) {
    ...
    @Converter
    public static CRM_C02 toCrmC02(String body) {
        return toMessage(CRM_C02.class, body);
    }

    @Converter
    public static CRM_C02 toCrmC02(byte[] body, Exchange exchange) {
        return toMessage(CRM_C02.class, body, exchange);
    }

    @Converter
    public static CRM_C03 toCrmC03(String body) {
        return toMessage(CRM_C03.class, body);
    }

    @Converter
    public static CRM_C03 toCrmC03(byte[] body, Exchange exchange) {
        return toMessage(CRM_C03.class, body, exchange);
    }

    @Converter
    public static CRM_C04 toCrmC04(String body) {
        return toMessage(CRM_C04.class, body);
    }

    @Converter
    public static CRM_C04 toCrmC04(byte[] body, Exchange exchange) {
        return toMessage(CRM_C04.class, body, exchange);
    }

    @Converter
    public static CRM_C05 toCrmC05(String body) {
        return toMessage(CRM_C05.class, body);
    }

    @Converter
    public static CRM_C05 toCrmC05(byte[] body, Exchange exchange) {
        return toMessage(CRM_C05.class, body, exchange);
    }

    @Converter
    public static CRM_C06 toCrmC06(String body) {
        return toMessage(CRM_C06.class, body);
    }

    @Converter
    public static CRM_C06 toCrmC06(byte[] body, Exchange exchange) {
        return toMessage(CRM_C06.class, body, exchange);
    }

    @Converter
    public static CRM_C07 toCrmC07(String body) {
        return toMessage(CRM_C07.class, body);
    }

    @Converter
    public static CRM_C07 toCrmC07(byte[] body, Exchange exchange) {
        return toMessage(CRM_C07.class, body, exchange);
    }

    @Converter
    public static CRM_C08 toCrmC08(String body) {
        return toMessage(CRM_C08.class, body);
    }

    @Converter
    public static CRM_C08 toCrmC08(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static CSU_C10 toCsuC10(String body) {
        return toMessage(CSU_C10.class, body);
    }

    @Converter
    public static CSU_C10 toCsuC10(byte[] body, Exchange exchange) {
        return toMessage(CSU_C10.class, body, exchange);
    }

    @Converter
    public static CSU_C11 toCsuC11(String body) {
        return toMessage(CSU_C11.class, body);
    }

    @Converter
    public static CSU_C11 toCsuC11(byte[] body, Exchange exchange) {
        return toMessage(CSU_C11.class, body, exchange);
    }

    @Converter
    public static CSU_C12 toCsuC12(String body) {
        return toMessage(CSU_C12.class, body);
    }

    @Converter
    public static CSU_C12 toCsuC12(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static EDR_Q01 toEdrQ01(String body) {
        return toMessage(EDR_Q01.class, body);
    }

    @Converter
    public static EDR_Q01 toEdrQ01(byte[] body, Exchange exchange) {
        return toMessage(EDR_Q01.class, body, exchange);
    }

    @Converter
    public static EQQ_Q01 toEqqQ01(String body) {
        return toMessage(EQQ_Q01.class, body);
    }

    @Converter
    public static EQQ_Q01 toEqqQ01(byte[] body, Exchange exchange) {
        return toMessage(EQQ_Q01.class, body, exchange);
    }

    @Converter
    public static ERP_Q01 toErpQ01(String body) {
        return toMessage(ERP_Q01.class, body);
    }

    @Converter
    public static ERP_Q01 toErpQ01(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static MFK_M07 toMfkM07(String body) {
        return toMessage(MFK_M07.class, body);
    }

    @Converter
    public static MFK_M07 toMfkM07(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static MFN_M07 toMfnM07(String body) {
        return toMessage(MFN_M07.class, body);
    }

    @Converter
    public static MFN_M07 toMfnM07(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static ORF_R02 toOrfR02(String body) {
        return toMessage(ORF_R02.class, body);
    }

    @Converter
    public static ORF_R02 toOrfR02(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static PEX_P08 toPexP08(String body) {
        return toMessage(PEX_P08.class, body);
    }

    @Converter
    public static PEX_P08 toPexP08(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static PGL_PC7 toPglPc7(String body) {
        return toMessage(PGL_PC7.class, body);
    }

    @Converter
    public static PGL_PC7 toPglPc7(byte[] body, Exchange exchange) {
        return toMessage(PGL_PC7.class, body, exchange);
    }

    @Converter
    public static PGL_PC8 toPglPc8(String body) {
        return toMessage(PGL_PC8.class, body);
    }

    @Converter
    public static PGL_PC8 toPglPc8(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static PPG_PCH toPpgPch(String body) {
        return toMessage(PPG_PCH.class, body);
    }

    @Converter
    public static PPG_PCH toPpgPch(byte[] body, Exchange exchange) {
        return toMessage(PPG_PCH.class, body, exchange);
    }

    @Converter
    public static PPG_PCJ toPpgPcj(String body) {
        return toMessage(PPG_PCJ.class, body);
    }

    @Converter
    public static PPG_PCJ toPpgPcj(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static PPP_PCC toPppPcc(String body) {
        return toMessage(PPP_PCC.class, body);
    }

    @Converter
    public static PPP_PCC toPppPcc(byte[] body, Exchange exchange) {
        return toMessage(PPP_PCC.class, body, exchange);
    }

    @Converter
    public static PPP_PCD toPppPcd(String body) {
        return toMessage(PPP_PCD.class, body);
    }

    @Converter
    public static PPP_PCD toPppPcd(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static PPR_PC2 toPprPc2(String body) {
        return toMessage(PPR_PC2.class, body);
    }

    @Converter
    public static PPR_PC2 toPprPc2(byte[] body, Exchange exchange) {
        return toMessage(PPR_PC2.class, body, exchange);
    }

    @Converter
    public static PPR_PC3 toPprPc3(String body) {
        return toMessage(PPR_PC3.class, body);
    }

    @Converter
    public static PPR_PC3 toPprPc3(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static RAS_O02 toRasO02(String body) {
        return toMessage(RAS_O02.class, body);
    }

    @Converter
    public static RAS_O02 toRasO02(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static REF_I13 toRefI13(String body) {
        return toMessage(REF_I13.class, body);
    }

    @Converter
    public static REF_I13 toRefI13(byte[] body, Exchange exchange) {
        return toMessage(REF_I13.class, body, exchange);
    }

    @Converter
    public static REF_I14 toRefI14(String body) {
        return toMessage(REF_I14.class, body);
    }

    @Converter
    public static REF_I14 toRefI14(byte[] body, Exchange exchange) {
        return toMessage(REF_I14.class, body, exchange);
    }

    @Converter
    public static REF_I15 toRefI15(String body) {
        return toMessage(REF_I15.class, body);
    }

    @Converter
    public static REF_I15 toRefI15(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static ROR_ROR toRorRor(String body) {
        return toMessage(ROR_ROR.class, body);
    }

    @Converter
    public static ROR_ROR toRorRor(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static RPA_I09 toRpaI09(String body) {
        return toMessage(RPA_I09.class, body);
    }

    @Converter
    public static RPA_I09 toRpaI09(byte[] body, Exchange exchange) {
        return toMessage(RPA_I09.class, body, exchange);
    }

    @Converter
    public static RPA_I10 toRpaI10(String body) {
        return toMessage(RPA_I10.class, body);
    }

    @Converter
    public static RPA_I10 toRpaI10(byte[] body, Exchange exchange) {
        return toMessage(RPA_I10.class, body, exchange);
    }

    @Converter
    public static RPA_I11 toRpaI11(String body) {
        return toMessage(RPA_I11.class, body);
    }

    @Converter
    public static RPA_I11 toRpaI11(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static RQA_I09 toRqaI09(String body) {
        return toMessage(RQA_I09.class, body);
    }

    @Converter
    public static RQA_I09 toRqaI09(byte[] body, Exchange exchange) {
        return toMessage(RQA_I09.class, body, exchange);
    }

    @Converter
    public static RQA_I10 toRqaI10(String body) {
        return toMessage(RQA_I10.class, body);
    }

    @Converter
    public static RQA_I10 toRqaI10(byte[] body, Exchange exchange) {
        return toMessage(RQA_I10.class, body, exchange);
    }

    @Converter
    public static RQA_I11 toRqaI11(String body) {
        return toMessage(RQA_I11.class, body);
    }

    @Converter
    public static RQA_I11 toRqaI11(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static RQQ_Q01 toRqqQ01(String body) {
        return toMessage(RQQ_Q01.class, body);
    }

    @Converter
    public static RQQ_Q01 toRqqQ01(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static RRE_O01 toRreO01(String body) {
        return toMessage(RRE_O01.class, body);
    }

    @Converter
    public static RRE_O01 toRreO01(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static RRI_I13 toRriI13(String body) {
        return toMessage(RRI_I13.class, body);
    }

    @Converter
    public static RRI_I13 toRriI13(byte[] body, Exchange exchange) {
        return toMessage(RRI_I13.class, body, exchange);
    }

    @Converter
    public static RRI_I14 toRriI14(String body) {
        return toMessage(RRI_I14.class, body);
    }

    @Converter
    public static RRI_I14 toRriI14(byte[] body, Exchange exchange) {
        return toMessage(RRI_I14.class, body, exchange);
    }

    @Converter
    public static RRI_I15 toRriI15(String body) {
        return toMessage(RRI_I15.class, body);
    }

    @Converter
    public static RRI_I15 toRriI15(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static SIU_S13 toSiuS13(String body) {
        return toMessage(SIU_S13.class, body);
    }

    @Converter
    public static SIU_S13 toSiuS13(byte[] body, Exchange exchange) {
        return toMessage(SIU_S13.class, body, exchange);
    }

    @Converter
    public static SIU_S14 toSiuS14(String body) {
        return toMessage(SIU_S14.class, body);
    }

    @Converter
    public static SIU_S14 toSiuS14(byte[] body, Exchange exchange) {
        return toMessage(SIU_S14.class, body, exchange);
    }

    @Converter
    public static SIU_S15 toSiuS15(String body) {
        return toMessage(SIU_S15.class, body);
    }

    @Converter
    public static SIU_S15 toSiuS15(byte[] body, Exchange exchange) {
        return toMessage(SIU_S15.class, body, exchange);
    }

    @Converter
    public static SIU_S16 toSiuS16(String body) {
        return toMessage(SIU_S16.class, body);
    }

    @Converter
    public static SIU_S16 toSiuS16(byte[] body, Exchange exchange) {
        return toMessage(SIU_S16.class, body, exchange);
    }

    @Converter
    public static SIU_S17 toSiuS17(String body) {
        return toMessage(SIU_S17.class, body);
    }

    @Converter
    public static SIU_S17 toSiuS17(byte[] body, Exchange exchange) {
        return toMessage(SIU_S17.class, body, exchange);
    }

    @Converter
    public static SIU_S18 toSiuS18(String body) {
        return toMessage(SIU_S18.class, body);
    }

    @Converter
    public static SIU_S18 toSiuS18(byte[] body, Exchange exchange) {
        return toMessage(SIU_S18.class, body, exchange);
    }

    @Converter
    public static SIU_S19 toSiuS19(String body) {
        return toMessage(SIU_S19.class, body);
    }

    @Converter
    public static SIU_S19 toSiuS19(byte[] body, Exchange exchange) {
        return toMessage(SIU_S19.class, body, exchange);
    }

    @Converter
    public static SIU_S20 toSiuS20(String body) {
        return toMessage(SIU_S20.class, body);
    }

    @Converter
    public static SIU_S20 toSiuS20(byte[] body, Exchange exchange) {
        return toMessage(SIU_S20.class, body, exchange);
    }

    @Converter
    public static SIU_S21 toSiuS21(String body) {
        return toMessage(SIU_S21.class, body);
    }

    @Converter
    public static SIU_S21 toSiuS21(byte[] body, Exchange exchange) {
        return toMessage(SIU_S21.class, body, exchange);
    }

    @Converter
    public static SIU_S22 toSiuS22(String body) {
        return toMessage(SIU_S22.class, body);
    }

    @Converter
    public static SIU_S22 toSiuS22(byte[] body, Exchange exchange) {
        return toMessage(SIU_S22.class, body, exchange);
    }

    @Converter
    public static SIU_S23 toSiuS23(String body) {
        return toMessage(SIU_S23.class, body);
    }

    @Converter
    public static SIU_S23 toSiuS23(byte[] body, Exchange exchange) {
        return toMessage(SIU_S23.class, body, exchange);
    }

    @Converter
    public static SIU_S24 toSiuS24(String body) {
        return toMessage(SIU_S24.class, body);
    }

    @Converter
    public static SIU_S24 toSiuS24(byte[] body, Exchange exchange) {
        return toMessage(SIU_S24.class, body, exchange);
    }

    @Converter
    public static SIU_S26 toSiuS26(String body) {
        return toMessage(SIU_S26.class, body);
    }

    @Converter
    public static SIU_S26 toSiuS26(byte[] body, Exchange exchange) {
        return toMessage(SIU_S26.class, body, exchange);
    }

    @Converter
    public static SPQ_Q01 toSpqQ01(String body) {
        return toMessage(SPQ_Q01.class, body);
    }

    @Converter
    public static SPQ_Q01 toSpqQ01(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static SRM_S02 toSrmS02(String body) {
        return toMessage(SRM_S02.class, body);
    }

    @Converter
    public static SRM_S02 toSrmS02(byte[] body, Exchange exchange) {
        return toMessage(SRM_S02.class, body, exchange);
    }

    @Converter
    public static SRM_S03 toSrmS03(String body) {
        return toMessage(SRM_S03.class, body);
    }

    @Converter
    public static SRM_S03 toSrmS03(byte[] body, Exchange exchange) {
        return toMessage(SRM_S03.class, body, exchange);
    }

    @Converter
    public static SRM_S04 toSrmS04(String body) {
        return toMessage(SRM_S04.class, body);
    }

    @Converter
    public static SRM_S04 toSrmS04(byte[] body, Exchange exchange) {
        return toMessage(SRM_S04.class, body, exchange);
    }

    @Converter
    public static SRM_S05 toSrmS05(String body) {
        return toMessage(SRM_S05.class, body);
    }

    @Converter
    public static SRM_S05 toSrmS05(byte[] body, Exchange exchange) {
        return toMessage(SRM_S05.class, body, exchange);
    }

    @Converter
    public static SRM_S06 toSrmS06(String body) {
        return toMessage(SRM_S06.class, body);
    }

    @Converter
    public static SRM_S06 toSrmS06(byte[] body, Exchange exchange) {
        return toMessage(SRM_S06.class, body, exchange);
    }

    @Converter
    public static SRM_S07 toSrmS07(String body) {
        return toMessage(SRM_S07.class, body);
    }

    @Converter
    public static SRM_S07 toSrmS07(byte[] body, Exchange exchange) {
        return toMessage(SRM_S07.class, body, exchange);
    }

    @Converter
    public static SRM_S08 toSrmS08(String body) {
        return toMessage(SRM_S08.class, body);
    }

    @Converter
    public static SRM_S08 toSrmS08(byte[] body, Exchange exchange) {
        return toMessage(SRM_S08.class, body, exchange);
    }

    @Converter
    public static SRM_S09 toSrmS09(String body) {
        return toMessage(SRM_S09.class, body);
    }

    @Converter
    public static SRM_S09 toSrmS09(byte[] body, Exchange exchange) {
        return toMessage(SRM_S09.class, body, exchange);
    }

    @Converter
    public static SRM_S10 toSrmS10(String body) {
        return toMessage(SRM_S10.class, body);
    }

    @Converter
    public static SRM_S10 toSrmS10(byte[] body, Exchange exchange) {
        return toMessage(SRM_S10.class, body, exchange);
    }

    @Converter
    public static SRM_S11 toSrmS11(String body) {
        return toMessage(SRM_S11.class, body);
    }

    @Converter
    public static SRM_S11 toSrmS11(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static SRR_S02 toSrrS02(String body) {
        return toMessage(SRR_S02.class, body);
    }

    @Converter
    public static SRR_S02 toSrrS02(byte[] body, Exchange exchange) {
        return toMessage(SRR_S02.class, body, exchange);
    }

    @Converter
    public static SRR_S03 toSrrS03(String body) {
        return toMessage(SRR_S03.class, body);
    }

    @Converter
    public static SRR_S03 toSrrS03(byte[] body, Exchange exchange) {
        return toMessage(SRR_S03.class, body, exchange);
    }

    @Converter
    public static SRR_S04 toSrrS04(String body) {
        return toMessage(SRR_S04.class, body);
    }

    @Converter
    public static SRR_S04 toSrrS04(byte[] body, Exchange exchange) {
        return toMessage(SRR_S04.class, body, exchange);
    }

    @Converter
    public static SRR_S05 toSrrS05(String body) {
        return toMessage(SRR_S05.class, body);
    }

    @Converter
    public static SRR_S05 toSrrS05(byte[] body, Exchange exchange) {
        return toMessage(SRR_S05.class, body, exchange);
    }

    @Converter
    public static SRR_S06 toSrrS06(String body) {
        return toMessage(SRR_S06.class, body);
    }

    @Converter
    public static SRR_S06 toSrrS06(byte[] body, Exchange exchange) {
        return toMessage(SRR_S06.class, body, exchange);
    }

    @Converter
    public static SRR_S07 toSrrS07(String body) {
        return toMessage(SRR_S07.class, body);
    }

    @Converter
    public static SRR_S07 toSrrS07(byte[] body, Exchange exchange) {
        return toMessage(SRR_S07.class, body, exchange);
    }

    @Converter
    public static SRR_S08 toSrrS08(String body) {
        return toMessage(SRR_S08.class, body);
    }

    @Converter
    public static SRR_S08 toSrrS08(byte[] body, Exchange exchange) {
        return toMessage(SRR_S08.class, body, exchange);
    }

    @Converter
    public static SRR_S09 toSrrS09(String body) {
        return toMessage(SRR_S09.class, body);
    }

    @Converter
    public static SRR_S09 toSrrS09(byte[] body, Exchange exchange) {
        return toMessage(SRR_S09.class, body, exchange);
    }

    @Converter
    public static SRR_S10 toSrrS10(String body) {
        return toMessage(SRR_S10.class, body);
    }

    @Converter
    public static SRR_S10 toSrrS10(byte[] body, Exchange exchange) {
        return toMessage(SRR_S10.class, body, exchange);
    }

    @Converter
    public static SRR_S11 toSrrS11(String body) {
        return toMessage(SRR_S11.class, body);
    }

    @Converter
    public static SRR_S11 toSrrS11(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static TBR_Q01 toTbrQ01(String body) {
        return toMessage(TBR_Q01.class, body);
    }

    @Converter
    public static TBR_Q01 toTbrQ01(byte[] body, Exchange exchange) {
    ...
    @Converter
    public static VQQ_Q01 toVqqQ01(String body) {
        return toMessage(VQQ_Q01.class, body);
    }

    @Converter
    public static VQQ_Q01 toVqqQ01(byte[] body, Exchange exchange) {
