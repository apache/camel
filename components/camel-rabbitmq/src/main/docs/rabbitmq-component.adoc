...
| *camel.component.rabbitmq.channel-pool-max-size* | Get maximum number of opened channel in pool | 10 | int
...
| *camel.component.rabbitmq.connection-timeout* | Connection timeout | 60000 | int
...
| *camel.component.rabbitmq.port-number* | Port number for the host with the running rabbitmq instance or cluster. | 5672 | int
| *camel.component.rabbitmq.prefetch-count* | The maximum number of messages that the server will deliver, 0 if
 ...
 prefetchGlobal at the same time |  | int
...
| *camel.component.rabbitmq.prefetch-size* | The maximum amount of content (measured in octets) that the server will
 ...
 prefetchCount, prefetchGlobal at the same time |  | int
...
| *camel.component.rabbitmq.requested-channel-max* | Connection requested channel max (max number of channels offered) | 2047 | int
| *camel.component.rabbitmq.requested-frame-max* | Connection requested frame max (max size of frame offered) | 0 | int
| *camel.component.rabbitmq.requested-heartbeat* | Connection requested heartbeat (heart-beat in seconds offered) | 60 | int
...
| *camel.component.rabbitmq.thread-pool-size* | The consumer uses a Thread Pool Executor with a fixed number of threads.
 This setting allows you to set that number of threads. | 10 | int
