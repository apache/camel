...
public enum RabbitMQConstants {
    ...
    EXCHANGE_OVERRIDE_NAME("rabbitmq_EXCHANGE_OVERRIDE_NAME",
                           "Used for force sending the message to this exchange instead of the endpoint configured name on the producer"),
    EXCHANGE_NAME("rabbitmq_EXCHANGE_NAME", "The exchange the message was received from"),
    CONTENT_TYPE("rabbitmq_CONTENT_TYPE", "The contentType to set on the RabbitMQ message"),
    PRIORITY("rabbitmq_PRIORITY", "The priority header to set on the RabbitMQ message"),
    DELIVERY_TAG("rabbitmq_DELIVERY_TAG", "The rabbitmq delivery tag of the received message"),
    REDELIVERY_TAG("rabbitmq_REDELIVERY_TAG", "Whether the message is a redelivered"),
    CORRELATIONID("rabbitmq_CORRELATIONID", "The correlationId to set on the RabbitMQ message"),
    MESSAGE_ID("rabbitmq_MESSAGE_ID", "The message id to set on the RabbitMQ message"),
    DELIVERY_MODE("rabbitmq_DELIVERY_MODE", "If the message should be persistent or not"),
    USERID("rabbitmq_USERID", "The userId to set on the RabbitMQ message"),
    CLUSTERID("rabbitmq_CLUSTERID", "The clusterId to set on the RabbitMQ message"),
    REQUEST_TIMEOUT("rabbitmq_REQUEST_TIMEOUT", ""),
    REPLY_TO("rabbitmq_REPLY_TO", "The replyTo to set on the RabbitMQ message"),
    CONTENT_ENCODING("rabbitmq_CONTENT_ENCODING", "The contentEncoding to set on the RabbitMQ message"),
    TYPE("rabbitmq_TYPE", "The type to set on the RabbitMQ message"),
    EXPIRATION("rabbitmq_EXPIRATION", "The expiration to set on the RabbitMQ message"),
    TIMESTAMP("rabbitmq_TIMESTAMP", "The timestamp to set on the RabbitMQ message"),
    APP_ID("rabbitmq_APP_ID", "The appId to set on the RabbitMQ message"),
    REQUEUE("rabbitmq_REQUEUE",
    ...
    MANDATORY("rabbitmq_MANDATORY", "true if the 'mandatory' flag is to be set"),
    IMMEDIATE("rabbitmq_IMMEDIATE",
