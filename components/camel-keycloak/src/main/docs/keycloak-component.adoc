...
NOTE: Caffeine is marked as optional in the camel-keycloak component, so you must explicitly add it to your project to use the Caffeine cache implementation.
