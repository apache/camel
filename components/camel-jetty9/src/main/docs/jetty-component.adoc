...
xref:manual:faq:how-do-i-let-jetty-match-wildcards.adoc[How do I let Jetty match
wildcards].
...
xref:languages:simple-language.adoc[Simple] (such as xref:languages:el-language.adoc[EL] or
xref:languages:ognl-language.adoc[OGNL]) we could also test for the parameter value and do
