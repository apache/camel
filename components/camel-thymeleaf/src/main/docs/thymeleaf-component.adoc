...
from("activemq:My.Queue").
  to("thymeleaf:com/acme/MyResponse.txt");
----------------------------------------
...
`.txt` template never changes:

[source,java]
----------------------------------------------------------
from("activemq:My.Queue")
  .to("thymeleaf:com/acme/MyResponse.txt?contentCache=true")
  .to("activemq:Another.Queue");
----------------------------------------------------------
...
-----------------------------------------------------------------
from("activemq:My.Queue")
  .to("thymeleaf:file://myfolder/MyResponse.txt?contentCache=true")
  .to("activemq:Another.Queue");
-----------------------------------------------------------------
...
---------------------------------------------------------------------------
from("direct:in")
  .setHeader("CamelThymeleafResourceUri").constant("path/to/my/template.txt")
