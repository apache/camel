...
public class ThymeleafTest extends CamelTestSupport {
    ...
    @Test
    public void testThymeleafLetter() {
    ...
    @Test
    public void testThymeleafDataModel() {
    ...
    protected RouteBuilder createRouteBuilder() {
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                from("direct:a").to(
                        "thymeleaf:org/apache/camel/component/thymeleaf/example.txt?allowTemplateFromHeader=true&allowContextMapAll=true");
                // END SNIPPET: example
            }
        };
    }
