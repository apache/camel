...
public class ThymeleafValuesInPropertiesTest extends CamelTestSupport {
    ...
    public void testThymeleafLetter() throws Exception {
        ...
        template.send("direct:a", new Processor() {
            ...
            public void process(Exchange exchange) {
                ...
                exchange.getIn().setHeader(ThymeleafConstants.THYMELEAF_TEMPLATE,
    ...
    protected RouteBuilder createRouteBuilder() {
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                ThymeleafComponent fc = context.getComponent("thymeleaf", ThymeleafComponent.class);
