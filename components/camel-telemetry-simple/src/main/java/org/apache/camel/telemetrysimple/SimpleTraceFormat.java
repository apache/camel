 ...
 */
public interface SimpleTraceFormat {

    String format(SimpleTrace trace);
 ...
 */
class SimpleTraceFormatDefault implements SimpleTraceFormat {

    @Override
    public String format(SimpleTrace trace) {
 ...
 */
class SimpleTraceFormatJson implements SimpleTraceFormat {

    ObjectMapper mapper;

    SimpleTraceFormatJson() {
 ...
 */
class SimpleTraceFormatTree implements SimpleTraceFormat {
    ...
    public String format(SimpleTrace trace) {
        ...
        for (int j = 0; j < trace.getSpans().size(); j++) {
            SimpleSpanAdapter span = trace.getSpans().get(j);
    ...
    private String formatSpan(SimpleSpanAdapter span) {
    ...
    private String getMarker(HashMap<String, Integer> depths, SimpleSpanAdapter span, SimpleSpanAdapter next) {
        if (next == null) {
            return "└";
        }
