...
public class SpanPropagationTest extends TelemetrySimpleTracerTestSupport {
    ...
    private void checkTrace(SimpleTrace trace) {
        List<SimpleSpanAdapter> spans = trace.getSpans();
        assertEquals(3, spans.size());
        SimpleSpanAdapter testProducer = spans.get(0);
        SimpleSpanAdapter direct = spans.get(1);
        SimpleSpanAdapter log = spans.get(2);
