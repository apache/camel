 ...
 */
public class AsyncWiretapTest extends TelemetrySimpleTracerTestSupport {
    ...
    private void checkTrace(SimpleTrace trace, String expectedBody) {
        ...
        SimpleSpanAdapter wiretapDirectTo = TelemetrySimpleTracerTestSupport.getSpan(spans, "direct://tap", Op.EVENT_SENT);
        SimpleSpanAdapter wiretapDirectFrom
                = TelemetrySimpleTracerTestSupport.getSpan(spans, "direct://tap", Op.EVENT_RECEIVED);
        SimpleSpanAdapter log = TelemetrySimpleTracerTestSupport.getSpan(spans, "log://info", Op.EVENT_SENT);
        SimpleSpanAdapter wiretapLog = TelemetrySimpleTracerTestSupport.getSpan(spans, "log://tapped", Op.EVENT_SENT);
        SimpleSpanAdapter wiretapMock = TelemetrySimpleTracerTestSupport.getSpan(spans, "mock://end", Op.EVENT_SENT);
