...
public class AsyncDirectTest extends TelemetrySimpleTracerTestSupport {
    ...
    private void checkTrace(SimpleTrace trace, String expectedBody) {
        ...
        SimpleSpanAdapter newDirectTo = TelemetrySimpleTracerTestSupport.getSpan(spans, "direct://new", Op.EVENT_SENT);
        SimpleSpanAdapter log = TelemetrySimpleTracerTestSupport.getSpan(spans, "log://info", Op.EVENT_SENT);
        SimpleSpanAdapter newDirectFrom = TelemetrySimpleTracerTestSupport.getSpan(spans, "direct://new", Op.EVENT_RECEIVED);
        SimpleSpanAdapter newLog = TelemetrySimpleTracerTestSupport.getSpan(spans, "log://new", Op.EVENT_SENT);
        SimpleSpanAdapter newMock = TelemetrySimpleTracerTestSupport.getSpan(spans, "mock://end", Op.EVENT_SENT);
