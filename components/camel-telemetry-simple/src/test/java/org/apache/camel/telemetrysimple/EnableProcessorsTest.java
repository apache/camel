...
public class EnableProcessorsTest extends TelemetrySimpleTracerTestSupport {
    ...
    private void checkTrace(SimpleTrace trace) {
        ...
        SimpleSpanAdapter innerLog = spans.get(2);
        SimpleSpanAdapter innerProcessor = spans.get(3);
        SimpleSpanAdapter log = spans.get(4);
        SimpleSpanAdapter innerToLog = spans.get(5);
