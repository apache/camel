= Micrometer Observability Component (deprecated)
...
NOTE: this component is deprecated since version 4.19.0. Please, use xref:micrometer-observability.adoc[`camel-micrometer-observability`] component instead.
