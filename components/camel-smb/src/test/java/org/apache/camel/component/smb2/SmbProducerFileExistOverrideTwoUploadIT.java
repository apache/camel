...
public class SmbProducerFileExistOverrideTwoUploadIT extends SmbServerTestSupport {

    protected String getSmbUrl() {
        return String.format(
                "smb2:%s/%s?username=%s&password=%s&path=/existoverridetwo&delay=2000&noop=true&fileExist=Override",
