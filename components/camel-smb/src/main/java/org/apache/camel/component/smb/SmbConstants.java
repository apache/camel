...
public class SmbConstants {
    ...
    @Metadata(
            description = "(producer) Specifies the name of the file to write (relative to the endpoint"
    ...
    @Metadata(
            label = "consumer",
            description = "The file path. For relative files this is the starting directory."
    ...
    @Metadata(
            label = "producer",
            description = "The expected behavior if the file already exists.",
