...
public class SmbConfiguration extends GenericFileConfiguration {
    ...
    @UriParam(
            label = "consumer",
            description =
                    "The search pattern used to list the files (server side on SMB). This parameter can contain the name of a file (or multiple files, if wildcards are used) within this directory. When it is null all files are included."
    ...
    @UriParam(
            label = "consumer",
            description = "Sets the download method to use when not using a local working directory."
    ...
    @UriParam(
            ...
            description = "Whether the SMB consumer should download the file. If this "
    ...
    @UriParam(
            label = "common",
            description = "Whether or not to disconnect from remote SMB share right after use. "
    ...
    @UriParam(
            ...
            description = "Whether or not to disconnect from remote SMB share right "
    ...
    @UriParam(
            ...
            defaultValue = "false",
            description =
                    "Whether to fall back and do a copy and delete file, in case the file could not be renamed directly.")
