...
public class Smb2Consumer extends GenericFileConsumer<FileIdBothDirectoryInformation> {

    private static final Logger LOG = LoggerFactory.getLogger(Smb2Consumer.class);

    protected String endpointPath;
    private final Smb2Endpoint endpoint;
    private final Smb2Configuration configuration;

    public Smb2Consumer(Smb2Endpoint endpoint, Processor processor,
    ...
    private boolean handleDirectory(
        ...
        Smb2File smbFile = asGenericFile(fullFilePath, file, getEndpoint().getCharset());
    ...
    private Smb2File asGenericFile(String path, FileIdBothDirectoryInformation file, String charset) {
        Smb2File genericFile = new Smb2File(getOperations());
    ...
    private Smb2Operations getOperations() {
        return (Smb2Operations) operations;
    }
