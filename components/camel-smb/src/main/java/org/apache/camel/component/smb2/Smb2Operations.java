...
public class Smb2Operations implements Smb2FileOperations {
    ...
    private boolean retrieveFileToStreamInBody(String name, Exchange exchange) throws GenericFileOperationFailedException {
        Smb2File target = (Smb2File) exchange.getProperty(FileComponent.FILE_EXCHANGE_FILE);
    ...
    private boolean retrieveFileToFileInLocalWorkDirectory(String name, Exchange exchange)
        ...
        Smb2File file = (Smb2File) exchange.getProperty(FileComponent.FILE_EXCHANGE_FILE);
        ...
        try {
            ...
            exchange.getIn().setHeader(Smb2Constants.FILE_LOCAL_WORK_PATH, local.getPath());
        } catch (Exception e) {
    ...
    private boolean doStoreFile(String name, Exchange exchange) throws GenericFileOperationFailedException {
        ...
        GenericFileExist gfe = exchange.getIn().getHeader(Smb2Constants.SMB_FILE_EXISTS, GenericFileExist.class);
        if (gfe == null) {
