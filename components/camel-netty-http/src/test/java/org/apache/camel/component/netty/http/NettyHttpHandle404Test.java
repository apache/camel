    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                from("direct:start")
                        .enrich("direct:tohttp", (original, resource) -> {
                ...
                from("direct:tohttp")
                        ...
                        .process(exchange -> {
                            // copy the caused exception values to the exchange as we want the response in the regular
                            // exchange
                            // instead as an exception that will get thrown and thus the route breaks
                            NettyHttpOperationFailedException cause = exchange.getProperty(
                                    Exchange.EXCEPTION_CAUGHT, NettyHttpOperationFailedException.class);
                ...
                from("netty-http:http://localhost:{{port}}/myserver").process(exchange -> {
