...
public interface SecurityAuthenticator {
     ...
     * <p/>
     * By default if no explicit role class names has been configured, then this implementation will assume the
     * {@link Subject} {@link java.security.Principal}s is a role if the classname contains the word <tt>role</tt>
     * (lower cased).
     *
