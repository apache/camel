...
public final class NettyHttpConstants {
    ...
    @Metadata(
            description = "If the user was authenticated using HTTP Basic then this header is added\n"
    ...
    @Metadata(
            description = "Allows to set the HTTP Status code to use. By default 200 is used for\n"
    ...
    @Metadata(
            description = "The HTTP method used, such as GET, POST, TRACE etc.",
            javaType = "String",
            defaultValue = "GET")
    ...
    @Metadata(
            description = "Allows to provide URI context-path and query parameters as a `String`\n"
    ...
    @Metadata(
            description = "Any query parameters, such as `foo=bar&beer=yes`. Stored in the raw\n"
    ...
    @Metadata(
            description = "The URL including protocol, host and port, etc: \n" + "`\\http://0.0.0.0:8080/myapp`.",
            javaType = "String")
