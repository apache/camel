 ...
 * {@link org.apache.camel.component.netty.http.handlers.HttpServerChannelHandler} to handle an incoming
 * {@link io.netty.handler.codec.http.HttpRequest} when you use multiple routes on the same port.
 * <p/>
