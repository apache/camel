...
NOTE: this component and the related implementations are deprecated since version 4.19.0. Please, use xref:telemetry.adoc[`camel-telemetry`] components instead.
