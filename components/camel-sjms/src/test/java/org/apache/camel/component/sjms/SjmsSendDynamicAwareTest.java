...
public class SjmsSendDynamicAwareTest extends CamelTestSupport {
    ...
    public void testUriParsing() throws Exception {
        ...
        Processor processor = this.sjmsSendDynamicAware.createPreProcessor(
                TestSupport.createExchangeWithBody(this.context(), "Body"), entry);
        processor.process(exchange);
        assertEquals(
                "destination.SjmsSendDynamicAwareTest",
