        ...
        if (LOG.isTraceEnabled()) {
            ...
            configuration.setTracer(new Tracer() {
                ...
                public void debug(String message, Object...args) {
                    LOG.trace("tracer.debug() " + this + ": uri=" + urifinal + ", message=" + String.format(message, args));
                }
                ...
                public void onSend(MQTTFrame frame) {
                    ...
                    LOG.trace("tracer.onSend() " + this + ":  uri=" + urifinal + ", frame=" + decoded);
                }
                ...
                public void onReceive(MQTTFrame frame) {
                    ...
                    LOG.trace("tracer.onReceive() " + this + ":  uri=" + urifinal + ", frame=" + decoded);
                }
            });
        }
    }
