...
See also the xref:quartz2-component.adoc[Quartz] component that supports much more
advanced scheduling.
...
| *camel.component.timer.resolve-property-placeholders* | Whether the component should resolve property placeholders on itself when starting. Only properties which are of String type can use property placeholders. | true | Boolean
|===
...
* xref:quartz2-component.adoc[Quartz]
