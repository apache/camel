...
import org.apache.camel.component.fastjson.converter.FastJsonTypeConverters;
...
public final class FastJsonTypeConvertersLoader implements TypeConverterLoader, CamelContextAware {
    ...
    private volatile FastJsonTypeConverters fastJsonTypeConverters;
    private FastJsonTypeConverters getFastJsonTypeConverters() {
        if (fastJsonTypeConverters == null) {
            fastJsonTypeConverters = new FastJsonTypeConverters();
