...
public class JcloudsComponentConfigurer extends PropertyConfigurerSupport implements GeneratedPropertyConfigurer, PropertyConfigurerGetter {
    ...
    static {
        ...
        map.put("blobStores", java.util.List.class);
        map.put("computeServices", java.util.List.class);
        map.put("bridgeErrorHandler", boolean.class);
        map.put("lazyStartProducer", boolean.class);
        map.put("basicPropertyBinding", boolean.class);
        ALL_OPTIONS = map;
        ConfigurerStrategy.addBootstrapConfigurerClearer(JcloudsComponentConfigurer::clearBootstrapConfigurers);
    }
