...
/**
 * Header names are identical to {@code camel-hivemq}'s {@code HiveMQConstants} so that routes reading/writing them by
 * literal header name keep working unchanged when switching between the two components.
 */
public final class HiveMQ311Constants {
