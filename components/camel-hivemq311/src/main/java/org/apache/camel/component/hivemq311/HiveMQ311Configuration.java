...
@UriParams
public class HiveMQ311Configuration implements Cloneable {

    /**
     * Hostname or IP address of the HiveMQ MQTT broker.
     */
    @UriParam(defaultValue = HiveMQ311Constants.DEFAULT_HOST)
    private String host = HiveMQ311Constants.DEFAULT_HOST;

    /**
     * Port number of the HiveMQ MQTT broker.
     */
    @UriParam(defaultValue = "1883")
    private int port = HiveMQ311Constants.DEFAULT_PORT;
    ...
    public HiveMQ311Configuration copy() {
        try {
            return (HiveMQ311Configuration) super.clone();
