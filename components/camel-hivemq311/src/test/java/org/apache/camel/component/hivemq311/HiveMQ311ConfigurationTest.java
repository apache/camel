...
class HiveMQ311ConfigurationTest {

    @Test
    @DisplayName("Verify default configuration values")
    void testDefaults() {
        HiveMQ311Configuration config = new HiveMQ311Configuration();

        assertThat(config.getHost()).isEqualTo(HiveMQ311Constants.DEFAULT_HOST);
        assertThat(config.getPort()).isEqualTo(HiveMQ311Constants.DEFAULT_PORT);
    ...
    void testCopying() {
        HiveMQ311Configuration original = new HiveMQ311Configuration();
        ...
        HiveMQ311Configuration copy = original.copy();
