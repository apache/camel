...
public class HiveMQ311QosAndRetainIT extends CamelTestSupport {
    ...
    public void testQosAndRetainHeaders() throws Exception {
        ...
        mockQosResult.expectedHeaderReceived(HiveMQ311Constants.MQTT_QOS, MqttQos.EXACTLY_ONCE);
        mockQosResult.expectedHeaderReceived(HiveMQ311Constants.MQTT_RETAINED, true);

        Map<String, Object> headers = new HashMap<>();
        headers.put(HiveMQ311Constants.MQTT_QOS, MqttQos.EXACTLY_ONCE);
        headers.put(HiveMQ311Constants.MQTT_RETAINED, true);
        ...
        context.addRoutes(new RouteBuilder() {
            ...
            public void configure() {
                fromF("hivemq311:system/alerts?host=%s&port=%d&qos=EXACTLY_ONCE", host, port)
                        .to("mock:qosResult");
            }
        });
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                from("direct:startQos")
                        .toF("hivemq311:system/alerts?host=%s&port=%d", host, port);
            }
        };
    }
}
