...
public class HiveMQ311ComponentPubSubIT extends CamelTestSupport {
    ...
    public void testBasicPubSub() throws Exception {
        ...
        mockResult.expectedHeaderReceived(HiveMQ311Constants.MQTT_TOPIC, "test/basic");
        mockResult.expectedHeaderReceived(HiveMQ311Constants.MQTT_QOS, MqttQos.AT_LEAST_ONCE);

        template.sendBody("direct:startBasic", "Hello HiveMQ MQTT 3.1.1!");
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                from("direct:startBasic")
                        .toF("hivemq311:test/basic?host=%s&port=%d", host, port);

                fromF("hivemq311:test/basic?host=%s&port=%d", host, port)
                        .to("mock:result");
            }
        };
    }
