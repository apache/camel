...
public class HiveMQ311OverrideTopicIT extends CamelTestSupport {
    ...
    public void testTopicOverride() throws Exception {
        ...
        mockOverrideResult.expectedHeaderReceived(HiveMQ311Constants.MQTT_TOPIC, "orders/processed");

        template.sendBodyAndHeader("direct:startOverride", "Routed to custom topic",
                HiveMQ311Constants.OVERRIDE_TOPIC, "orders/processed");
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                from("direct:startOverride")
                        .toF("hivemq311:orders/default?host=%s&port=%d", host, port);

                fromF("hivemq311:orders/processed?host=%s&port=%d", host, port)
