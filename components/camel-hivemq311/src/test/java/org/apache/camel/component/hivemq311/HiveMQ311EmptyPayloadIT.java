...
public class HiveMQ311EmptyPayloadIT extends CamelTestSupport {
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                from("direct:startEmpty")
                        .toF("hivemq311:test/empty?host=%s&port=%d", host, port);

                fromF("hivemq311:test/empty?host=%s&port=%d", host, port)
                        .to("mock:emptyResult");
            }
        };
    }
