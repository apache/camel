...
class HiveMQ311ConsumerReleaseTest {

    private DefaultCamelContext camelContext;
    private HiveMQ311Component component;
    private HiveMQ311Endpoint endpoint;
    ...
    void setUp() {
        ...
        endpoint = new HiveMQ311Endpoint("hivemq311:test", component, new HiveMQ311Configuration(), "test");
    ...
    private static void invokeProcessExchange(HiveMQ311Consumer consumer, Exchange exchange) throws Exception {
        Method method = HiveMQ311Consumer.class.getDeclaredMethod("processExchange", Exchange.class);
        method.setAccessible(true);
        method.invoke(consumer, exchange);
    }

    private static final class CountingConsumer extends HiveMQ311Consumer {

        private final AtomicInteger releases = new AtomicInteger();

        CountingConsumer(HiveMQ311Endpoint endpoint, Processor processor) {
