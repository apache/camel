...
public class JCachePolicyProcessorTest extends JCachePolicyTestBase {
    ...
    public void testException() {
        ...
        // Send
        Exchange response = this.template()
                .request("direct:cached-exception", e -> e.getMessage().setBody(key));
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            public void configure() {
                ...
                from("direct:cached-simple").policy(jcachePolicy).to("mock:value");
                ...
                from("direct:cached-closed").policy(jcachePolicy).to("mock:value");
                ...
                from("direct:cached-byheader").policy(jcachePolicy).to("mock:value");
                ...
                from("direct:cached-bypass").policy(jcachePolicy).to("mock:value");
            }
        };
    }
}
