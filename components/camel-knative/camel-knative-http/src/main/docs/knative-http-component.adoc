...
._Java-only: binding custom Vertx instance and options to the Camel registry_
.Example
[source,java]
----
...
._Java-only: binding custom Vertx web client options to the Camel registry_
.Example
[source,java]
----
...
._Java-only: configuring SSL client options on the Knative Http producer factory_
.Example
[source,java]
----
...
._Java-only: using TrustAllOptions for test environments_
.TrustAllOptions
[source,java]
----
...
._Java-only: configuring OIDC client options on the Knative Http producer factory_
.Example
[source,java]
----
import org.apache.camel.component.knative.KnativeComponent;
