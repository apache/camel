...
public class KeyVaultConfigurationTest extends CamelTestSupport {
    ...
    public void createEndpointWithMinimalConfiguration() throws Exception {
        ...
        KeyVaultEndpoint endpoint =
                (KeyVaultEndpoint) component.createEndpoint("azure-key-valut://MyVault?secretClient=#secretClient");
    ...
    public void createEndpointWithMinimalIdentityConfiguration() throws Exception {
        KeyVaultComponent component = context.getComponent("azure-key-vault", KeyVaultComponent.class);
        KeyVaultEndpoint endpoint =
                (KeyVaultEndpoint) component.createEndpoint("azure-key-valut://MyVault?credentialType=AZURE_IDENTITY");
    ...
    public void createEndpointWithExplicitCredentials() throws Exception {
        ...
        KeyVaultComponent component = context.getComponent("azure-key-vault", KeyVaultComponent.class);
        KeyVaultEndpoint endpoint = (KeyVaultEndpoint)
                component.createEndpoint("azure-key-valut://MyVault?clientId=test&clientSecret=sec&tenantId=tenant");
    ...
    public void createEndpointFailure() throws Exception {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            KeyVaultComponent component = context.getComponent("azure-key-vault", KeyVaultComponent.class);
            KeyVaultEndpoint endpoint = (KeyVaultEndpoint) component.createEndpoint("azure-key-valut://MyVault");
        });
    }
}
