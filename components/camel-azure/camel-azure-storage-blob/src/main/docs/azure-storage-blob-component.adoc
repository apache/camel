...
The Azure Storage Blob Service component supports 30 options, which are listed below.
...
| *changeFeedContext* (producer) | h |  | Context
| *changeFeedEndTime* (producer) | h |  | OffsetDateTime
| *changeFeedStartTime* (producer) | h |  | OffsetDateTime
