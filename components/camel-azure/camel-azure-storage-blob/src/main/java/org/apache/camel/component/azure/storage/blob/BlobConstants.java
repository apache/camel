...
public final class BlobConstants {
    ...
    @Metadata(
            label = "producer",
            description =
                    "(uploadBlockBlob, commitBlobBlockList, createAppendBlob, createPageBlob) Additional parameters for a set of operations.",
    ...
    @Metadata(
            description =
                    "(producer) (Most operations related to upload blob) Most operations related to upload blob|An MD5 hash of the block content. "
    ...
    @Metadata(
            label = "producer",
            description =
                    "When uploading a blob with the uploadBlockBlob-operation this can be used to tell the client what the length of an InputStream is.",
            javaType = "long")
    public static final String BLOB_UPLOAD_SIZE = HEADER_PREFIX + "BlobUploadSize";

    @Metadata(
            description = "(producer) (createPageBlob) A user-controlled value that you can use to track requests. "
    ...
    @Metadata(
            label = "common",
            description =
                    "Specifies whether blob leasing is enabled for the operation. When set to true, the component will acquire "
    ...
    @Metadata(
            label = "common",
            description =
                    "Specifies the lease duration in seconds. Valid values are between 15 and 60 for fixed duration, or -1 for infinite duration.",
    ...
    @Metadata(
            description = "(producer) (uploadBlockBlob, commitBlobBlockList) Defines values for AccessTier.\n"
    ...
    @Metadata(
            description =
                    "(producer) (Operations related to container and blob) Operations related to container and blob| Metadata to associate with the container or blob.\n"
    ...
    @Metadata(
            label = "consumer",
            description = "The offset at which the block was committed to the block blob.",
            javaType = "String")
    public static final String APPEND_OFFSET = HEADER_PREFIX + "AppendOffset";

    @Metadata(
            label = "consumer",
            description = "Returns non-parsed httpHeaders that can be used by the user.",
            javaType = "HttpHeaders")
    public static final String RAW_HTTP_HEADERS = HEADER_PREFIX + "RawHttpHeaders";

    @Metadata(
            label = "consumer",
            description = "The downloaded filename from the operation `downloadBlobToFile`.",
            javaType = "String")
    public static final String FILE_NAME = HEADER_PREFIX + "FileName";

    @Metadata(
            label = "consumer",
            description = "The download link generated by `downloadLink` operation.",
            javaType = "String")
    ...
    @Metadata(
            label = "producer",
            description =
                    "(listBlobs) Defines options available to configure the behavior of a call to listBlobsFlatSegment on a `BlobContainerClient` object.",
            javaType = "ListBlobsOptions")
    public static final String LIST_BLOB_OPTIONS = HEADER_PREFIX + "ListBlobOptions";

    @Metadata(
            label = "producer",
            description = "(listBlobs) The details for listing specific blobs",
    ...
    @Metadata(
            label = "producer",
            description =
                    "(listBlobs,getBlob) Filters the results to return only blobs whose names begin with the specified prefix. May be null to return all blobs.",
            javaType = "String")
    ...
    @Metadata(
            label = "producer",
            description =
                    "(listBlobs,getBlob) Filters the results to return only blobs whose names match the specified regular expression. "
    ...
    @Metadata(
            label = "producer",
            description =
                    "(listBlobs) Specifies the maximum number of blobs to return, including all BlobPrefix elements. "
    ...
    @Metadata(
            label = "producer",
            description =
                    "(createContainer) Specifies how the data in this container is available to the public. Pass `null` for no public access.",
    ...
    @Metadata(
            label = "producer",
            description =
                    "(Operations related to container and blob) This contains values which will restrict the successful operation of a variety of requests to the conditions present. "
    ...
    @Metadata(
            label = "producer",
            description =
                    "(Operations related to page blob) A `PageRange` object. Given that pages must be aligned with 512-byte boundaries, "
    ...
    @Metadata(
            label = "producer",
            description =
                    "(createPageBlob, resizePageBlob) Specifies the maximum size for the page blob, up to 8 TB. The page blob size must be aligned to a 512-byte boundary.",
            javaType = "Long")
    ...
    @Metadata(
            label = "producer",
            description =
                    "(stageBlockBlobList) When is set to `true`, the staged blocks will not be committed directly.",
            javaType = "boolean")
    public static final String COMMIT_BLOCK_LIST_LATER = HEADER_PREFIX + "CommitBlobBlockListLater";

    @Metadata(
            label = "producer",
            description = "(getBlobBlockList) Specifies which type of blocks to return.",
    ...
    @Metadata(
            label = "producer",
            description =
                    "(commitAppendBlob) When is set to `true`, the append blocks will be created when committing append blocks.",
            javaType = "boolean")
    ...
    @Metadata(
            label = "producer",
            description =
                    "(uploadPageBlob) When is set to `true`, the page blob will be created when uploading page blob.",
            javaType = "boolean")
    ...
    @Metadata(
            label = "producer",
            description =
                    "(deleteBlob) Specifies the behavior for deleting the snapshots on this blob. `Include` will delete the base blob and all snapshots. "
    ...
    @Metadata(
            label = "producer",
            description =
                    "(listBlobContainers) A `ListBlobContainersOptions` which specifies what data should be returned by the service.",
    ...
    @Metadata(
            label = "producer",
            description =
                    "(downloadBlobToFile) `ParallelTransferOptions` to use to download to file. Number of parallel transfers parameter is ignored.",
    ...
    @Metadata(
            label = "producer",
            description = "(downloadLink) Override the default expiration (millis) of URL download link.",
            javaType = "Long")
    ...
    @Metadata(
            label = "producer",
            description =
                    "(copyBlob) The source blob account name to be used as source account name in a copy blob operation",
            javaType = "String")
    ...
    @Metadata(
            label = "producer",
            description =
                    "(copyBlob) The source blob container name to be used as source container name in a copy blob operation",
            javaType = "String")
    ...
    @Metadata(
            label = "producer",
            description =
                    "(getChangeFeed) It filters the results to return events approximately after the start time. "
    ...
    @Metadata(
            label = "producer",
            description =
                    "(getChangeFeed) It filters  the results to return events approximately before the end time. "
    ...
    @Metadata(
            label = "producer",
            description =
                    "(getChangeFeed) This gives additional context that is passed through the Http pipeline during the service call.",
            javaType = "Context")
