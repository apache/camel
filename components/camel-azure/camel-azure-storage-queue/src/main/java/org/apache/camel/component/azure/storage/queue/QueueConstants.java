...
public final class QueueConstants {
    ...
    @Metadata(
            label = "producer",
            description = "(createQueue) Metadata to associate with the queue",
    ...
    @Metadata(
            label = "producer",
            description =
                    "(deleteMessage, updateMessage) Unique identifier that must match for the message to be deleted or updated. "
    ...
    @Metadata(
            label = "producer",
            description = "(listQueues) Options for listing queues",
            javaType = "QueuesSegmentOptions")
    ...
    @Metadata(
            label = "producer",
            description =
                    "(receiveMessages, peekMessages) Maximum number of messages to get, if there are less messages exist in the queue than requested all the messages will be returned. "
    ...
    @Metadata(
            label = "producer",
            description =
                    "(sendMessage) How long the message will stay alive in the queue. "
