...
TODO investigate, below is a placeholder based on FTP adoc.

Consumer does not support concurrency.

The producer supports concurrency.
...
*WARNING* `.`-prefixed folders are not implicitly hidden from
recursive polling.
