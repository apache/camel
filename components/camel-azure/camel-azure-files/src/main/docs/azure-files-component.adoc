...
----
azure-files://account[.file.core.windows.net][:port]/share[/directoryname]
----
...
can contain nested folders, such as `/inbox/spam`.
...
files untouched on the remote files server. You have to configure it
