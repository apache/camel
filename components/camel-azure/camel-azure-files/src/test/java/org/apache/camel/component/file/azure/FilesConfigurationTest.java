...
public class FilesConfigurationTest extends CamelTestSupport {
    ...
    void accountForAccountHostURIShouldBeExtracted() {
        var remoteConf = context.getEndpoint("azure-files://account.file.core.windows.net/share", FilesEndpoint.class)
                .getConfiguration();
    ...
    void accountForAccountOnlyURIShouldBeExtracted() {
        var remoteConf = context.getEndpoint("azure-files://account/share", FilesEndpoint.class)
                .getConfiguration();
        assertEquals("share", remoteConf.getShare());
    ...
    void shareForValidURIShouldBeExtracted4() {
        var remoteConf = context.getEndpoint("azure-files://account/share/path", FilesEndpoint.class)
                .getConfiguration();
        assertEquals("share", remoteConf.getShare());
    }
    ...
    void endpointURIPathWithDoubleSlashShouldThrowRuntimeException() {
        ...
        assertThrows(
                RuntimeException.class, () -> context.getEndpoint("azure-files://account/share//?", FilesEndpoint.class)
                        .getConfiguration());
    }

    @Test
    void endpointURIPathWithSlashOnlyShouldThrowRuntimeException() {
        assertThrows(RuntimeException.class, () -> context.getEndpoint("azure-files://account/?", FilesEndpoint.class)
                .getConfiguration());
    }
    ...
    void dirForValidDirectoryNameURIShouldBeExtracted() {
        var remoteConf = context.getEndpoint("azure-files://account/share/dir", FilesEndpoint.class)
                .getConfiguration();
