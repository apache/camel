...
public class FilesOperationsTest extends CamelTestSupport {
    ...
    void testCreateClientAzureIdentity() {
        var endpoint = context
                .getEndpoint("azure-files://account.file.core.windows.net/share?credentialType=AZURE_IDENTITY", FilesEndpoint.class);
    ...
    void testCreateClientSharedAccountKey() {
        var endpoint = context
                .getEndpoint("azure-files://account.file.core.windows.net/share?credentialType=SHARED_ACCOUNT_KEY&sharedKey=sharedKey", FilesEndpoint.class);
    ...
    void testCreateClientAzureSAS() {
        var endpoint = context
                .getEndpoint("azure-files://account.file.core.windows.net/share?credentialType=AZURE_SAS&sv=2022-11-02&ss=f&srt=sco&sp=rwdlc&se=2023-06-18T22:29:13Z&st=2023-06-05T14:29:13Z&spr=https&sig=MPsMh8zci0v3To7IT9SKdaFGZV8ezno63m9C8s9bdVQ%3D", FilesEndpoint.class);
