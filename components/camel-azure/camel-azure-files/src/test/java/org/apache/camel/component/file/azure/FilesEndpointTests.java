...
public class FilesEndpointTests extends CamelTestSupport {
  ...
  void hostForValidURIShouldBeExtracted() {
    FilesEndpoint<?> endpoint = context.getEndpoint("azure-files://host/share", FilesEndpoint.class);
