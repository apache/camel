...
public class SbQueueComponentTest extends CamelTestSupport {
    ...
    public void sendMessage() throws Exception {
        String expectedBody = "This is my message text.";
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("direct:start")
                        .to("azure-sb://queue?queueName=MyQueue&ServiceBusContract=#MyServiceBusContract&timeout=2000&peekLock=true")
                        .to("mock:result");
            }
        };
    }
