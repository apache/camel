...
$reference/components/azure-blob.adoc[opts=optional]
...
| *operation* (producer) | Blob service operation hint to the producer. There are 14 enums and the value can be one of: getBlob, deleteBlob, listBlobs, updateBlockBlob, uploadBlobBlocks, commitBlobBlockList, getBlobBlockList, createAppendBlob, updateAppendBlob, createPageBlob, updatePageBlob, resizePageBlob, clearPageBlob, getPageBlobRanges | listBlobs | BlobServiceOperations
