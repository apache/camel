...
public final class DataLakeConstants {
    ...
    @Metadata(
            label = "producer",
            description =
                    "Name of the file system in azure data lake on which operation is to be performed. Please make sure that filesystem name is all lowercase.",
            javaType = "String")
    ...
    @Metadata(
            label = "producer",
            description = "Name of the file in azure data lake on which operation is to be performed.",
            javaType = "String")
