...
public interface UndertowSecurityProvider {
    ...
    /**
     * Hook into creation of undertow server. This place could be used for modification of httpHandlers.
     * Final undertow server has to be created in the same way as is created in default method.
     * Depending on the functionality, unregistrationHandler has to be implemented.
     *
     * @param builder Builder of undertow server.
     * @param handler Root http handler to be used in undertow server
     * @return Initialized undertow server
     */
