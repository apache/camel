...
| *camel.component.undertow.host-options.buffer-size* | The buffer size of the Undertow host. |  | int
...
| *camel.component.undertow.host-options.io-threads* | The number of io threads to use in a Undertow host. |  | int
| *camel.component.undertow.host-options.worker-threads* | The number of worker threads to use in a Undertow host. |  | int
