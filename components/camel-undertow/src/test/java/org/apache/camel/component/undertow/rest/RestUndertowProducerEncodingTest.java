...
public class RestUndertowProducerEncodingTest extends BaseUndertowTest {
    ...
    public void testSelect() {
        template.sendBody(
                "rest:get:bw-web-api/v1/objects/timesheets?companyId=RD&select=personId,personName", "Hello World");
    }
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                rest("/bw-web-api/v1/objects").get("{action}").to("direct:action");

                from("direct:action").process(exchange -> {
