...
public class AWS2EC2Producer extends DefaultProducer {
    ...
    private void createAndRunInstance(Ec2Client ec2Client, Exchange exchange) {
        ...
        try {
            ...
            LOG.trace("Run Instances command returned the error code {}", ase.getMessage());
            throw ase;
        }
    ...
    private void stopInstances(Ec2Client ec2Client, Exchange exchange) {
        ...
        try {
            ...
            LOG.trace("Stop Instances command returned the error code {}", ase.getMessage());
            throw ase;
        }
    ...
    private void terminateInstances(Ec2Client ec2Client, Exchange exchange) {
        ...
        try {
            ...
            LOG.trace("Terminate Instances command returned the error code {}", ase.getMessage());
            throw ase;
        }
    ...
    private void describeInstances(Ec2Client ec2Client, Exchange exchange) {
        ...
        try {
            ...
            LOG.trace("Describe Instances command returned the error code {}", ase.getMessage());
            throw ase;
        }
        Message message = getMessageForResponse(exchange);
        message.setBody(result);
    ...
    private void describeInstancesStatus(Ec2Client ec2Client, Exchange exchange) {
        ...
        try {
            ...
            LOG.trace("Describe Instances Status command returned the error code {}", ase.getMessage());
            throw ase;
        }
        Message message = getMessageForResponse(exchange);
        message.setBody(result);
    ...
    private void rebootInstances(Ec2Client ec2Client, Exchange exchange) {
        ...
        try {
            ...
            LOG.trace("Reboot Instances command returned the error code {}", ase.getMessage());
            throw ase;
        }
    }
    ...
    private void monitorInstances(Ec2Client ec2Client, Exchange exchange) {
        ...
        try {
            ...
            LOG.trace("Monitor Instances command returned the error code {}", ase.getMessage());
            throw ase;
        }
    ...
    private void unmonitorInstances(Ec2Client ec2Client, Exchange exchange) {
        ...
        try {
            ...
            LOG.trace("Unmonitor Instances command returned the error code {}", ase.getMessage());
            throw ase;
        }
    ...
    private void createTags(Ec2Client ec2Client, Exchange exchange) {
        ...
        try {
            ...
            LOG.trace("Create tags command returned the error code {}", ase.getMessage());
            throw ase;
        }
    ...
    private void deleteTags(Ec2Client ec2Client, Exchange exchange) {
        ...
        try {
            ...
            LOG.trace("Delete tags command returned the error code {}", ase.getMessage());
            throw ase;
        }
