...
The SlackComponent with XML must be configured as a Spring bean that contains the incoming webhook url or the app token for the integration as a
parameter.

[source,xml]
----
<bean id="slack" class="org.apache.camel.component.slack.SlackComponent">
    <property name="webhookUrl" value="https://hooks.slack.com/services/YOUR_TEAM_ID/YOUR_BOT_ID/YOUR_WEBHOOK_SECRET"/>
