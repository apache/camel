...
public class LevelDBAggregationRepositoryDefaultFilterTest {
    ...
    public void testDefaultFilterContainsGraphShapeLimits() {
        String filter = LevelDBAggregationRepository.DEFAULT_DESERIALIZATION_FILTER;
    ...
    public void testNewInstanceUsesDefaultFilter() {
        ...
        assertEquals(LevelDBAggregationRepository.DEFAULT_DESERIALIZATION_FILTER, repo.getDeserializationFilter());
    }
}
