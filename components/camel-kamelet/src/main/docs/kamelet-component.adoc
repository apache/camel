...
| *kameletResourceLoaderListener* (advanced) | To plugin a custom listener for when the Kamelet component is loading Kamelets from external resources. |  | KameletResourceLoaderListener
|===
