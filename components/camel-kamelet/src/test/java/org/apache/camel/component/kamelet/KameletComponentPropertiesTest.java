...
public class KameletComponentPropertiesTest {
    ...
    public void testComponentConfigurationAndConfigurationPrecedence() {
        ...
        try {
            ...
            assertThat(main.getCamelTemplate().requestBody("kamelet:setBody/test", "", String.class))
                    .isEqualTo("from-component-route");

            assertThat(main.getCamelTemplate().requestBody("kamelet:setBody", "", String.class))
                    .isEqualTo("from-component-template");
            // uri properties have precedence over component properties.
            assertThat(main.getCamelTemplate().requestBody("kamelet:setBody?bodyValue={{bodyValue}}", "", String.class))
                    .isEqualTo("from-uri");
        } catch (Exception e) {
            fail(e);
        } finally {
    ...
    protected Properties getTestProperties() {
        return asProperties(
                ...
                KAMELET_COMPONENT_PROPERTY_PREFIX + "templateProperties[setBody].bodyValue",
                "from-component-template",
                KAMELET_COMPONENT_PROPERTY_PREFIX + "routeProperties[test].bodyValue",
