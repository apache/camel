...
public class ShiroAuthorizationTest extends CamelTestSupport {
    ...
    public void testSuccessfulAuthorization() throws Exception {
        ...
        // Since the required permission incorporates zone1:readwrite:*, this request should successfully pass
        // authorization
    ...
    public void testSuccessfulAuthorizationAll() throws Exception {
        // The user george has role sec-level2 with permission set as zone1:*
        // Since the required permission incorporates all permissions, this request should successfully pass
        // authorization
        ShiroSecurityToken shiroSecurityToken = new ShiroSecurityToken("george", "harrison");
        TestShiroSecurityTokenInjector shiroSecurityTokenInjector =
                new TestShiroSecurityTokenInjector(shiroSecurityToken, passPhrase);
            ...
            new RouteBuilder() {
                public void configure() {
                    ...
                    final ShiroSecurityPolicy securityPolicy = new ShiroSecurityPolicy(
                            "src/test/resources/securityconfig.ini", passPhrase, true, permissionsList);
