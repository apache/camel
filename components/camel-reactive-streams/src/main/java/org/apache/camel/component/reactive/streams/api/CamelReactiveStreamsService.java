...
public interface CamelReactiveStreamsService extends Service, HasId, HasCamelContext {
    ...
    /**
     * Returns the publisher associated to the given stream name. A publisher can be used to push Camel exchanges to
     * reactive-streams subscribers.
     *
    ...
    /**
     * Returns the publisher associated to the given stream name. A publisher can be used to push Camel exchange to
     * external reactive-streams subscribers.
     *
    ...
    /**
     * Returns the subscriber associated to the given stream name. A subscriber can be used to push items coming from
     * external reactive-streams publishers to Camel routes.
     *
     * @param  name the stream name
    ...
    /**
     * Creates a new stream from the endpoint URI (used as Camel Consumer) and returns the associated {@code Publisher}.
     *
    ...
    /**
     * Creates a new route that pushes data to the endpoint URI and returns the associated {@code Subscriber}.
     *
     ...
     * {@code Publisher} that will eventually return the resulting exchange or an error.
     *
     ...
     * route and returns the {@code Publisher} that holds the resulting exchange or the error.
     *
     *
    ...
    /**
     * Creates a new route that uses the endpoint URI as producer, pushes the given data to the route and returns a
     * {@code Publisher} that will eventually return the exchange output or an error.
     *
     * @param  uri  the producer uri
     * @param  data the data to push
     * @param  type the type to which the output should be converted
    ...
    /**
     * Creates a new route that uses the endpoint URI as producer, and returns a function that pushes the data into the
     * route and returns the {@code Publisher} that holds the exchange output or an error.
     *
     ...
     * reactive processor.
     *
     * The processor receives a {@link Publisher} of exchanges and returns an object. If the output of the processor is
     * a {@link Publisher}, it will be unwrapped before delivering the result to the source route.
     *
     ...
     * reactive processor.
     *
     * The processor receives a {@link Publisher} of items of the given type and returns an object. If the output of the
     * processor is a {@link Publisher}, it will be unwrapped before delivering the result to the source route.
     *
     * @param uri       the uri where the processor should be attached
    ...
    /**
     * Used by Camel to associate the publisher of the stream with the given name to a specific Camel producer. This
     * method is used to bind a Camel route to a reactive stream.
     *
     * @param  name                  the stream name
    ...
    /**
     * Used by Camel to send the exchange to all active subscriptions on the given stream. The callback is used to
     * signal that the exchange has been delivered to the subscribers.
     *
     * @param name     the stream name
    ...
    /**
     * Used by Camel to associate the subscriber of the stream with the given name to a specific Camel consumer. This
     * method is used to bind a Camel route to a reactive stream.
     *
     * @param  name                  the stream name
