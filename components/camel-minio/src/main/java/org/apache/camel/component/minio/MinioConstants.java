...
public interface MinioConstants {
    ...
    @Metadata(description = """
            *Producer:* The content control of this object. *Consumer:* The *optional* Cache-Control HTTP header which allows the user to
            specify caching behavior along the HTTP request/reply chain.""",
              javaType = "String")
    String CACHE_CONTROL = "CamelMinioContentControl";
    @Metadata(description = """
            *Producer:* The content disposition of this object. *Consumer:* The *optional* Content-Disposition HTTP header, which specifies
            presentational information such as the recommended filename for the
            object to be saved as.""",
              javaType = "String")
    String CONTENT_DISPOSITION = "CamelMinioContentDisposition";
    @Metadata(description = """
            *Producer:* The content encoding of this object. *Consumer:* The *optional* Content-Encoding HTTP header specifying what content
    ...
    @Metadata(description = """
            *Producer:* The content length of this object. *Consumer:* The Content-Length HTTP header indicating the size of the associated
            object in bytes.""",
              javaType = "Long")
    String CONTENT_LENGTH = "CamelMinioContentLength";
    @Metadata(description = """
            *Producer:* The md5 checksum of this object. *Consumer:* The base64 encoded 128-bit MD5 digest of the associated object (content
    ...
    @Metadata(description = """
            *Producer:* The content type of this object. *Consumer:* The Content-Type HTTP header, which indicates the type of content stored
            in the associated object. The value of this header is a standard MIME
            type.""",
              javaType = "String")
    String CONTENT_TYPE = "CamelMinioContentType";
    @Metadata(description = """
            *Producer:* The ETag value for the newly uploaded object. *Consumer:* The hex encoded 128-bit MD5 digest of the associated object according to
    ...
    @Metadata(description = """
            *Producer:* The last modified timestamp of this object. *Consumer:* The value of the Last-Modified header, indicating the date and time at
    ...
    @Metadata(description = """
            *Producer:* The version Id of the object to be stored or returned from the current operation. *Consumer:* The version ID of the associated Minio object if available. Version
