...
public interface MinioConstants {
    ...
    @Metadata(
            description = "*Consumer:* The name of the bucket in which this object is contained.",
            javaType = "String")
    ...
    @Metadata(
            description = "*Producer:* The content control of this object. "
    ...
    @Metadata(
            description = "*Producer:* The content disposition of this object. "
    ...
    @Metadata(
            description = "*Producer:* The content encoding of this object. "
    ...
    @Metadata(
            description = "*Producer:* The content length of this object. "
    ...
    @Metadata(
            description = "*Producer:* The md5 checksum of this object. "
    ...
    @Metadata(
            description = "*Producer:* The content type of this object. "
    ...
    @Metadata(
            description =
                    "*Producer:* The key under which this object will be stored or which will be used for the current operation. "
    ...
    @Metadata(
            description = "*Producer:* The last modified timestamp of this object. "
    ...
    @Metadata(
            description =
                    "*Producer:* The version Id of the object to be stored or returned from the current operation. "
    ...
    @Metadata(
            description = "*Producer:* Sets the server-side encryption algorithm when encrypting\n"
    ...
    @Metadata(
            description =
                    "The bucket Name to override which this object will be stored or which will be used for the current operation or in which this object is contained.",
            javaType = "String")
