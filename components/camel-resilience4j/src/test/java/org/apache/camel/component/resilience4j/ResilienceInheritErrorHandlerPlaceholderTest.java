...
/**
 * The inheritErrorHandler option is a property placeholder that is resolved when the route starts (CAMEL-24696).
 */
public class ResilienceInheritErrorHandlerPlaceholderTest extends CamelTestSupport {
    ...
    public void testResiliencePlaceholder() throws Exception {
        // inheritErrorHandler resolved to true so Camel error handler does the 3 redeliveries before the dead letter
