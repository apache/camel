...
/**
 * The test class ensuring that an existing bean can be replaced with a bean defined as a field.
 */
@CamelMainTest
class ReplaceBeanFromFieldTest {
    ...
    void shouldReplaceTheBeanWithACustomBean() throws Exception {
        mock.expectedBodiesReceived("Hi Willy!");
