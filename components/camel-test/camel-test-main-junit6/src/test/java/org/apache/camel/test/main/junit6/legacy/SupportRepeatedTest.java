...
import org.apache.camel.test.main.junit6.common.MyMainClass;
 ...
 */
class SupportRepeatedTest extends CamelMainTestSupport {
    ...
    void shouldSupportMultipleCalls(RepetitionInfo repetitionInfo) throws Exception {
        ...
        int result = template.requestBody("direct:echo", repetitionInfo.getCurrentRepetition(), Integer.class);
