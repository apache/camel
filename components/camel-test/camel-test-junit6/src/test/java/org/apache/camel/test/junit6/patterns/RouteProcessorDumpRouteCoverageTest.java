...
public class RouteProcessorDumpRouteCoverageTest extends CamelTestSupport {
    ...
    @Test
    public void testProcessorJunit6() {
        String out = template.requestBody("direct:start", "Hello World", String.class);
        assertEquals("Bye World", out);
    }

    @Test
    public void testProcessorJunit6WithTestParameterInjection(TestInfo info, TestReporter testReporter) {
        assertNotNull(info);
    ...
    public static void checkDumpFilesCreatedAfterTests() {
        ...
        assertFileExists("target/camel-route-coverage/RouteProcessorDumpRouteCoverageTest-testProcessorJunit6.xml");
        assertFileExists(
                "target/camel-route-coverage/RouteProcessorDumpRouteCoverageTest-testProcessorJunit6WithTestParameterInjection.xml");
    }
