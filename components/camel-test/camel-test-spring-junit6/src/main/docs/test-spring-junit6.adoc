...
This approach provides feature parity with `org.apache.camel.test.junit6.CamelTestSupport`
from xref:components:others:test-junit6.adoc[camel-test-junit6] but does not support Spring annotations
...
* Migration steps from xref:components:others:test-junit6.adoc[camel-test-junit6] should have been applied first
