...
The name of the file can be provided in the header `CamelDropboxPutFileName`
or `CamelFileName` in that order of precedence. If no header has been provided then the message id (uuid) is
