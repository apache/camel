...
| *camel.component.twitter-directmessage.enabled* |  |  | Boolean
...
| *camel.component.twitter-search.enabled* |  |  | Boolean
...
| *camel.component.twitter-streaming.enabled* |  |  | Boolean
...
| *camel.component.twitter-timeline.enabled* |  |  | Boolean
