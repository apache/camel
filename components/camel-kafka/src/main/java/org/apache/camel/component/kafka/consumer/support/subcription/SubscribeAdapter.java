...
public interface SubscribeAdapter {
     ...
     * @param reBalanceListener a ConsumerRebalanceLister instance provided by Camel to use when subscribing TopicInfo:
     *                          Camel's own topic information (i.e., if it's a pattern or the list of topics, etc.)
     */
