...
public final class KafkaConstants {
    ...
    @Metadata(
            label = "consumer",
            description = "The partition where the message was stored",
            javaType = "Integer",
            important = true)
    ...
    @Metadata(
            description =
                    "Producer: The key of the message in order to ensure that all related message goes in the same partition. "
    ...
    @Metadata(
            label = "consumer",
            description = "The record headers",
            javaType = "org.apache.kafka.common.header.Headers")
    ...
    @Metadata(
            label = "consumer",
            description =
                    "Indicates the last record within the current poll request "
    ...
    @Metadata(
            label = "producer",
            description =
                    "The ProducerRecord also has an associated timestamp. "
    ...
    @Metadata(
            label = "consumer",
            description = "Can be used for forcing manual offset commit when using Kafka consumer.",
