...
public class JdbcAggregationRepositoryDefaultFilterTest {
    ...
    public void testDefaultFilterContainsGraphShapeLimits() {
        String filter = JdbcAggregationRepository.DEFAULT_DESERIALIZATION_FILTER;
    ...
    public void testNewInstanceUsesDefaultFilter() {
        ...
        assertEquals(JdbcAggregationRepository.DEFAULT_DESERIALIZATION_FILTER, repo.getDeserializationFilter());
    }
}
