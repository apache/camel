...
=== Clustering
In order to work in a clustered configuration correctly, recovery mechanism needs to be dealt separately by members of the cluster : a member may only recover exchanges that it completed itself.
