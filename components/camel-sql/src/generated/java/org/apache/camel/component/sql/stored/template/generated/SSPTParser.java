...
public class SSPTParser implements SSPTParserConstants {
  ...
  final public Template parse() throws ParseException {Token procedureName;
...
template.setProcedureName(procedureName.toString());
  ...
  final public Object Parameter() throws ParseException {Object param;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NUMBER:
    case PARAMETER_NAME:
    case IDENTIFIER:{
...
int sqlType = ParseHelper.parseSqlType(sqlTypeToken, classResolver);
  ...
  final public String ParameterName() throws ParseException {Token t = null;
    t = jj_consume_token(PARAMETER_NAME);
{if ("" != null) return ParseHelper.removeQuotes(t.toString()) ;}
    throw new Error("Missing return statement in function");
}

  final public Integer Scale() throws ParseException {Token t;
    t = jj_consume_token(SCALE);
{if ("" != null) return ParseHelper.parseScale(t);}
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return t;}
  ...
  final public String OutHeader() throws ParseException {Token token;
