...
| option |  | String | To configure additional options on JSONPath. Multiple values can be separated by comma.
...
include::{page-component-version}@camel-spring-boot::page$jsonpath-starter.adoc[]
