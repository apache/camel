...
public final class FhirOperationEndpointConfiguration extends FhirConfiguration {
    ...
    private String name;
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "onInstance", description="The type to use for the output parameters (this should be set to <code>Parameters.class drawn from the version of the FHIR structures you are using), may be NULL"), @ApiMethod(methodName = "onInstanceVersion", description="The type to use for the output parameters (this should be set to <code>Parameters.class drawn from the version of the FHIR structures you are using), may be NULL"), @ApiMethod(methodName = "onServer", description="The type to use for the output parameters (this should be set to <code>Parameters.class drawn from the version of the FHIR structures you are using), may be NULL"), @ApiMethod(methodName = "onType", description="The type to use for the output parameters (this should be set to <code>Parameters.class drawn from the version of the FHIR structures you are using), may be NULL")})
    private Class<org.hl7.fhir.instance.model.api.IBaseParameters> outputParameterType;
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "onInstance", description="The parameters to use as input. May also be <code>null if the operation does not require any input parameters."), @ApiMethod(methodName = "onInstanceVersion", description="The parameters to use as input. May also be <code>null if the operation does not require any input parameters."), @ApiMethod(methodName = "onServer", description="The parameters to use as input. May also be <code>null if the operation does not require any input parameters."), @ApiMethod(methodName = "onType", description="The parameters to use as input. May also be <code>null if the operation does not require any input parameters.")})
    ...
    @UriParam
    @ApiParam(optional = true, apiMethods = {@ApiMethod(methodName = "onInstance", description="If this operation returns a single resource body as its return type instead of a <code>Parameters resource, use this method to specify that resource type. This is useful for certain operations (e.g. <code>Patient/NNN/$everything) which return a bundle instead of a Parameters resource, may be NULL"), @ApiMethod(methodName = "onInstanceVersion", description="If this operation returns a single resource body as its return type instead of a <code>Parameters resource, use this method to specify that resource type. This is useful for certain operations (e.g. <code>Patient/NNN/$everything) which return a bundle instead of a Parameters resource, may be NULL"), @ApiMethod(methodName = "onServer", description="If this operation returns a single resource body as its return type instead of a <code>Parameters resource, use this method to specify that resource type. This is useful for certain operations (e.g. <code>Patient/NNN/$everything) which return a bundle instead of a Parameters resource, may be NULL"), @ApiMethod(methodName = "onType", description="If this operation returns a single resource body as its return type instead of a <code>Parameters resource, use this method to specify that resource type. This is useful for certain operations (e.g. <code>Patient/NNN/$everything) which return a bundle instead of a Parameters resource, may be NULL")})
