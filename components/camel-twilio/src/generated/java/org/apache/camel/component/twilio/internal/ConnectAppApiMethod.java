...
/**
 * Camel {@link ApiMethod} Enumeration for com.twilio.rest.api.v2010.account.ConnectApp
 */
...
public enum ConnectAppApiMethod implements ApiMethod {
    ...
    READER(
        com.twilio.rest.api.v2010.account.ConnectAppReader.class,
        "reader"),
    ...
    UPDATER(
        com.twilio.rest.api.v2010.account.ConnectAppUpdater.class,
        "updater",
        arg("pathSid", String.class)),
    ...
    ConnectAppApiMethod(Class<?> resultType, String name, ApiMethodArg... args) {
        this.apiMethod = new ApiMethodImpl(ConnectApp.class, resultType, name, args);
    }
