...
public class JmsPollingConsumerSpringIT extends SpringJMSBasic {
    ...
    @Produce("direct:JmsPollingConsumerSpringITStartConsumer")
    protected ProducerTemplate startDirectConsumer;

    @Produce("jms:JmsPollingConsumerSpringITQueue")
    protected ProducerTemplate queue;

    @EndpointInject("mock:JmsPollingConsumerSpringITResult")
    protected MockEndpoint result;

    @Override
    protected ClassPathXmlApplicationContext createApplicationContext() {
        return new ClassPathXmlApplicationContext(
                "/org/apache/camel/component/jms/integration/spring/polling/JmsPollingConsumerIT.xml");
    }
