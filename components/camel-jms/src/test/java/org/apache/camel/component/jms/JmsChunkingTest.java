 ...
 */
public class JmsChunkingTest extends CamelTestSupport {

    @Test
    public void testResultShouldBeInputStreamNotFit() throws Exception {
    ...
    @Test
    public void testResultShouldBeInputStreamFit() throws Exception {
        MockEndpoint mock = getMockEndpoint("mock:result");
        mock.expectedMessageCount(1);
        mock.message(0).body().isInstanceOf(InputStream.class);
        mock.message(0).body(String.class).isEqualTo("Hello World");
        ...
        template.sendBody("jms:queue:hello?maxChunkSize=1", body);
    ...
    public void testResultShouldBeByteArray() throws Exception {
        ...
        template.sendBody("jms:queue:hello?maxChunkSize=100", body);
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() throws Exception {
                from("jms:queue:hello?chunking=true").streamCaching().to("mock:result");
            }
        };
    }
}