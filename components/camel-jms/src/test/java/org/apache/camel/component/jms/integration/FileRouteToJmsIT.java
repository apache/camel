 ...
 */
public class FileRouteToJmsIT extends AbstractJMSTest {
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            public void configure() {
                from("file://target/routefromfile").to("activemq:queue:FileRouteToJmsIT");

                from("activemq:queue:FileRouteToJmsIT").to("mock:result");
            }
        };
    }
