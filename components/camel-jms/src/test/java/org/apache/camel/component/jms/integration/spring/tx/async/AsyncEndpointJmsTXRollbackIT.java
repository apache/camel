...
public class AsyncEndpointJmsTXRollbackIT extends AbstractSpringJMSITSupport {
    ...
    public void testAsyncEndpointRollback() throws Exception {
        ...
        template.sendBody("activemq:queue:inbox.AsyncEndpointJmsTXRollbackIT", "Hello Camel");
