...
public class JMXTXUseOriginalBodyWithDLCErrorHandlerIT extends JMXTXUseOriginalBodyIT {
    ...
    public static class TestRoutes extends RouteBuilder {
        ...
        public void configure() {
            ...
            from("activemq:JMXTXUseOriginalBodyWithDLCErrorHandlerIT.broken")
                    .transacted()
                    .to("mock:checkpoint1")
                    .setBody(method("foo"))
                    .to("mock:checkpoint2")
            ...
            from("activemq:JMXTXUseOriginalBodyWithDLCErrorHandlerIT.start")
                    .transacted()
                    .to("mock:checkpoint1")
            ...
            from("activemq:JMXTXUseOriginalBodyWithDLCErrorHandlerIT.ok")
                    .transacted()
                    .to("mock:checkpoint1")
                    .setBody(constant("oh no"))
                    .to("mock:checkpoint2")
