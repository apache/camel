...
public class JmsPassThroughJmsKeyFormatStrategyEndUserIssueTest extends AbstractJMSTest {
    ...
    private final String uri =
            "activemq:queue:JmsPassThroughJmsKeyFormatStrategyEndUserIssueTest?jmsKeyFormatStrategy=passthrough";
