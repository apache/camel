 ...
 */
public class JmsSplitterParallelChainedIT extends AbstractJMSTest {
    ...
    protected String getUri() {
        return "activemq:queue:fooJmsSplitterParallelChainedIT";
    }

    protected String getUri2() {
        return "activemq:queue:barJmsSplitterParallelChainedIT";
    }
