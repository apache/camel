...
public class AsyncEndpointJmsTXRoutingSlipIT extends AbstractSpringJMSITSupport {
    ...
    public void testAsyncEndpointOK() throws Exception {
        ...
        template.sendBody("activemq:queue:inbox.AsyncEndpointJmsTXRoutingSlipIT", "Hello Camel");
