...
public class AsyncEndpointJmsTXMulticastIT extends AbstractSpringJMSITSupport {
    ...
    public void testAsyncEndpointOK() throws Exception {
        ...
        template.sendBody("activemq:queue:inbox.AsyncEndpointJmsTXMulticastIT", "Hello Camel");
