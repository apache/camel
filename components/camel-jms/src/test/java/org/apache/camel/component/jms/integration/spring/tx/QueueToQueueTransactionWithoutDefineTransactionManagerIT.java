...
public class QueueToQueueTransactionWithoutDefineTransactionManagerIT extends AbstractTransactionIT {
    ...
    protected AbstractXmlApplicationContext createApplicationContext() {
        return new ClassPathXmlApplicationContext(
                "org/apache/camel/component/jms/integration/spring/tx/QueueToQueueTransactionWithoutDefineTransactionManagerIT.xml");
    }
    ...
    public void testNoTransactionRollbackUsingXmlQueueToQueue() throws Exception {
        ...
        template.sendBody("activemq:queue:QueueToQueueTransactionWithoutDefineTransactionManagerIT", "blah");
