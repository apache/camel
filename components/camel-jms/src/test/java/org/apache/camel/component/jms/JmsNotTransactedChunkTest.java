 ...
 */
public class JmsNotTransactedChunkTest extends CamelTestSupport {

    @Test
    public void testSplitNotTransacted() throws Exception {
        ...
        template.sendBody("jms:queue:hello?maxChunkSize=2", body);
