...
public class XMLQueueToProcessorTransactionIT extends AbstractTransactionIT {

    @Override
    protected AbstractXmlApplicationContext createApplicationContext() {
        return new ClassPathXmlApplicationContext(
                "org/apache/camel/component/jms/integration/spring/tx/XMLQueueToProcessorTransactionIT.xml");
    }
