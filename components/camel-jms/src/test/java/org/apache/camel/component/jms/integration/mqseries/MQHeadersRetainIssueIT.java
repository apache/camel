...
/**
 * Lets test that a number of headers MQSeries doesn't like to be sent and are excluded when forwarding a JMS message
 * from one destination to another
 */
public class MQHeadersRetainIssueIT extends AbstractJMSTest {
    @Order(2)
    @RegisterExtension
    ...
    public void testSendSomeMessages() throws Exception {
        ...
        template.sendBody("activemq:queue:MQHeadersRetainIssueIT.bar", body1);
        template.sendBody("activemq:queue:MQHeadersRetainIssueIT.bar", body2);
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            public void configure() {
                ...
                from("activemq:queue:MQHeadersRetainIssueIT.bar?cacheLevelName=CACHE_CONSUMER")
                        .process(myProcessor)
                        .to("mock:results");
            }
        };
