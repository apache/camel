...
public class JMXTXUseOriginalBodyWithTXErrorHandlerIT extends JMXTXUseOriginalBodyIT {
    ...
    public static class TestRoutes extends RouteBuilder {
        ...
        public void configure() {
            ...
            from("activemq:JMXTXUseOriginalBodyWithTXErrorHandlerIT.broken")
                    .transacted()
                    .to("mock:checkpoint1")
                    .setBody(method("foo"))
                    .to("mock:checkpoint2")
            ...
            from("activemq:JMXTXUseOriginalBodyWithTXErrorHandlerIT.start")
                    .transacted()
                    .to("mock:checkpoint1")
