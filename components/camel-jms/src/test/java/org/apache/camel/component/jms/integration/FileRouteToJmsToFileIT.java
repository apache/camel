 ...
 */
public class FileRouteToJmsToFileIT extends AbstractJMSTest {
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            public void configure() {
                from("file://target/file2file/in").to("activemq:queue:FileRouteToJmsToFileIT");

                from("activemq:queue:FileRouteToJmsToFileIT").to("file://target/file2file/out", "mock:result");
            }
        };
    }
