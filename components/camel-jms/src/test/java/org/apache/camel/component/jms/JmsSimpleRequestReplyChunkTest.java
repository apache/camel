 ...
 */
public class JmsSimpleRequestReplyChunkTest extends CamelTestSupport {
    ...
    public void testRequetReply() throws Exception {
        ...
        Exchange out = template.send("jms:queue:hello?maxChunkSize=1", ExchangePattern.InOut, new Processor() {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() throws Exception {
                from("jms:queue:hello?chunking=true").process(new Processor() {
                    public void process(Exchange exchange) throws Exception {
