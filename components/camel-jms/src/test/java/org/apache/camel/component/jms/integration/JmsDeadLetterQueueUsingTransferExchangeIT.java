 ...
 */
public class JmsDeadLetterQueueUsingTransferExchangeIT extends AbstractJMSTest {
    ...
    protected String getUri() {
        return "activemq:queue:JmsDeadLetterQueueUsingTransferExchangeIT?transferExchange=true";
    }
    ...
    public void testKaboom() throws Exception {
        MockEndpoint mock = getMockEndpoint("mock:JmsDeadLetterQueueUsingTransferExchangeIT.dead");
