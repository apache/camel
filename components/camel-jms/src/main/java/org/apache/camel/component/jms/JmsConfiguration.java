...
public class JmsConfiguration implements Cloneable {
    ...
    @UriParam(
            label = "advanced",
            description =
                    "A pluggable TemporaryQueueResolver that allows you to use your own resolver for creating temporary queues"
    ...
    @UriParam(
            ...
            defaultValue = "Default",
            description =
                    "The consumer type of the reply consumer (when doing request/reply), which can be one of: Simple, Default, or Custom."
                            + " The consumer type determines which Spring JMS listener to use. Default will use org.springframework.jms.listener.DefaultMessageListenerContainer,"
                            + " Simple will use org.springframework.jms.listener.SimpleMessageListenerContainer."
                            + " When Custom is specified, the MessageListenerContainerFactory defined by the messageListenerContainerFactory option"
                            + " will determine what org.springframework.jms.listener.AbstractMessageListenerContainer to use.")
    ...
    @UriParam(
            ...
            enums = "CACHE_AUTO,CACHE_CONNECTION,CACHE_CONSUMER,CACHE_NONE,CACHE_SESSION",
            label = "consumer",
            description =
    ...
    @UriParam(
            label = "advanced",
            description =
                    "Whether optimizing for Apache Artemis streaming mode. This can reduce memory overhead when using Artemis with JMS StreamMessage types."
                            + " This option must only be enabled if Apache Artemis is being used.")
    private boolean artemisStreamingEnabled;

    @UriParam(
            label = "consumer",
            description = "Consumer priorities allow you to ensure that high priority consumers"
    ...
    @UriParam(
            label = "consumer",
            description = "Set the name of a subscription to create. To be applied in case"
    ...
    @UriParam(
            label = "consumer",
            description = "Set whether to make the subscription durable. The durable subscription name"
    ...
    @UriParam(
            label = "consumer",
            description = "Set whether to make the subscription shared. The shared subscription name"
                    + " to be used can be specified through the subscriptionName property."
    ...
    @UriParam(
            defaultValue = "-1",
            label = "producer",
            description = "Sets delivery delay to use for send calls for JMS. "
    ...
    public static class CamelJmsTemplate extends JmsTemplate {
        ...
        public void send(
                final String destinationName, final MessageCreator messageCreator, final MessageSentCallback callback)
                throws JmsException {
            execute(
                    session -> {
        ...
        public void send(
                final Destination destination, final MessageCreator messageCreator, final MessageSentCallback callback)
                throws JmsException {
    ...
    private void configureDefaultMessageListenerContainer(
            JmsEndpoint endpoint, DefaultMessageListenerContainer container) {
