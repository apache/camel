...
| *camel.component.zookeeper.cluster.service.auth-info-list* | null |  | List
| *camel.component.zookeeper.cluster.service.base-path* | null |  | String
| *camel.component.zookeeper.cluster.service.connection-timeout* | null |  | long
| *camel.component.zookeeper.cluster.service.connection-timeout-unit* | null |  | TimeUnit
| *camel.component.zookeeper.cluster.service.curator-framework* | null |  | CuratorFramework
...
| *camel.component.zookeeper.cluster.service.max-close-wait* | null |  | long
| *camel.component.zookeeper.cluster.service.max-close-wait-unit* | null |  | TimeUnit
| *camel.component.zookeeper.cluster.service.namespace* | null |  | String
| *camel.component.zookeeper.cluster.service.nodes* | null |  | List
| *camel.component.zookeeper.cluster.service.order* | Service lookup order/priority. |  | int
| *camel.component.zookeeper.cluster.service.reconnect-base-sleep-time* | null |  | long
| *camel.component.zookeeper.cluster.service.reconnect-base-sleep-time-unit* | null |  | TimeUnit
| *camel.component.zookeeper.cluster.service.reconnect-max-retries* | null |  | int
| *camel.component.zookeeper.cluster.service.reconnect-max-sleep-time* | null |  | long
| *camel.component.zookeeper.cluster.service.reconnect-max-sleep-time-unit* | null |  | TimeUnit
| *camel.component.zookeeper.cluster.service.retry-policy* | null |  | RetryPolicy
| *camel.component.zookeeper.cluster.service.session-timeout* | null |  | long
| *camel.component.zookeeper.cluster.service.session-timeout-unit* | null |  | TimeUnit
| *camel.component.zookeeper.configuration.await-existence* | Not in use
 
 @deprecated The usage of this option has no effect at all. | true | boolean
...
| *camel.component.zookeeper.configuration.send-empty-message-on-delete* | Upon the delete of a znode, should an empty message be send to the
 consumer | true | boolean
| *camel.component.zookeeper.configuration.servers* | The zookeeper server hosts |  | List
| *camel.component.zookeeper.configuration.timeout* | The time interval to wait on connection before timing out. | 5000 | int
| *camel.component.zookeeper.enabled* | Enable zookeeper component | true | boolean
| *camel.component.zookeeper.resolve-property-placeholders* | Whether the component should resolve property placeholders on itself when
 starting. Only properties which are of String type can use property
 placeholders. | true | boolean
| *camel.component.zookeeper.service-registry.attributes* | Custom service attributes. |  | Map
| *camel.component.zookeeper.service-registry.auth-info-list* | null |  | List
| *camel.component.zookeeper.service-registry.base-path* | null |  | String
| *camel.component.zookeeper.service-registry.connection-timeout* | null |  | long
| *camel.component.zookeeper.service-registry.connection-timeout-unit* | null |  | TimeUnit
| *camel.component.zookeeper.service-registry.curator-framework* | null |  | CuratorFramework
| *camel.component.zookeeper.service-registry.deregister-services-on-stop* | null |  | boolean
...
| *camel.component.zookeeper.service-registry.max-close-wait* | null |  | long
| *camel.component.zookeeper.service-registry.max-close-wait-unit* | null |  | TimeUnit
| *camel.component.zookeeper.service-registry.namespace* | null |  | String
| *camel.component.zookeeper.service-registry.nodes* | null |  | List
| *camel.component.zookeeper.service-registry.order* | Service lookup order/priority. |  | int
| *camel.component.zookeeper.service-registry.override-service-host* | null |  | boolean
| *camel.component.zookeeper.service-registry.reconnect-base-sleep-time* | null |  | long
| *camel.component.zookeeper.service-registry.reconnect-base-sleep-time-unit* | null |  | TimeUnit
| *camel.component.zookeeper.service-registry.reconnect-max-retries* | null |  | int
| *camel.component.zookeeper.service-registry.reconnect-max-sleep-time* | null |  | long
| *camel.component.zookeeper.service-registry.reconnect-max-sleep-time-unit* | null |  | TimeUnit
| *camel.component.zookeeper.service-registry.retry-policy* | null |  | RetryPolicy
| *camel.component.zookeeper.service-registry.service-host* | null |  | String
| *camel.component.zookeeper.service-registry.session-timeout* | null |  | long
| *camel.component.zookeeper.service-registry.session-timeout-unit* | null |  | TimeUnit
|===
