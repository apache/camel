...
| *camel.component.smpp.configuration.http-proxy-port* | If you need to tunnel SMPP through a HTTP proxy, set this attribute
 to the port of your HTTP proxy. | 3128 | int
...
| *camel.component.smpp.configuration.max-reconnect* | null | 2147483647 | int
...
| *camel.component.smpp.configuration.password* | null |  | String
| *camel.component.smpp.configuration.port* | Port number for the SMSC server to use. | 2775 | int
...
| *camel.component.smpp.configuration.splitting-policy* | You can specify a policy for handling long messages:
 <ul>
