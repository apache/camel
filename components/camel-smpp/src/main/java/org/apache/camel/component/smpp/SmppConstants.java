...
public interface SmppConstants {
    ...
    @Metadata(
            description = "*Producer:* *only for SubmitSm, SubmitMulti, CancelSm and DataSm* Defines the\n"
    ...
    @Metadata(
            description = "*Producer:* *only for SubmitSm, SubmitMulti, CancelSm and DataSm* Defines the type\n"
    ...
    @Metadata(
            description = "*Producer:* *only for SubmitMultiSm* The errors which\n"
    ...
    @Metadata(
            description = "*Producer:* The id to identify the submitted short message(s) for later use.\n"
    ...
    @Metadata(
            description = "*Producer:* *only for SubmitSm, ReplaceSm, SubmitMulti and DataSm* Is used to\n"
    ...
    @Metadata(
            description = "*Producer:* only for SubmitSm, SubmitMulti and ReplaceSm* This parameter specifies\n"
    ...
    @Metadata(
            label = "producer",
            description =
                    "*only for SubmitSm and SubmitMultiSm* The total\n" + "number of messages which has been sent.",
            javaType = "Integer")
    ...
    @Metadata(
            description = "*Producer:* The service type parameter can be used to indicate the SMS Application\n"
    ...
    @Metadata(
            description = "*Producer:* Defines the numeric plan indicator (NPI) to be used in the SME\n"
    ...
    @Metadata(
            description = "*Producer:* Defines the type of number (TON) to be used in the SME originator\n"
                    + "address parameters. Use the `sourceAddrTon` URI option values defined\n"
                    + "above.\n"
    ...
    @Metadata(
            description = "*Producer:* *only for SubmitSm, SubmitMulti and ReplaceSm* The validity period\n"
    ...
    @Metadata(
            description = "*Producer:* *only for SubmitSm, SubmitMulti and\n"
