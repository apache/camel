...
| *operation* (producer) | What operation to perform. There are 10 enums and the value can be one of: batch-get-items, delete-item, delete-table, describe-table, get-item, put-item, query, scan, update-item, update-table | put-item | DdbOperations
