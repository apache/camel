...
public class MllpSocketBufferWriteTest extends SocketBufferTestSupport {
    ...
    public void testWriteByteArraySliceWithNegativeOffset() {
        ...
        try {
            ...
            assertEquals(
                    "write(byte[4], offset[-5], writeCount[4]) - offset is less than zero", expectedEx.getMessage());
        }
    }
    ...
    public void testWriteByteArraySliceWithOffsetGreaterThanLength() {
        ...
        try {
            ...
            assertEquals(
                    "write(byte[4], offset[5], writeCount[4]) - offset is greater than write count",
    ...
    public void testWriteByteArraySliceWithNegativeLength() {
        ...
        assertEquals(
                "write(byte[4], offset[0], writeCount[-5]) - write count is less than zero", exception.getMessage());
    }
    ...
    public void testWriteByteArraySliceWithLengthGreaterThanAvailable() {
        ...
        IndexOutOfBoundsException exception0 = assertThrows(
                IndexOutOfBoundsException.class,
                () -> instance.write(payload, 0, payload.length + 1),
                "Exception should have been thrown");

        assertEquals(
                "write(byte[4], offset[0], writeCount[5]) - write count is greater than length of the source byte[]",
    ...
    public void testEnsureCapacityWithOutOfRangeRequiredAvailability() {
        ...
        IllegalStateException expectedEx =
                assertThrows(IllegalStateException.class, () -> instance.ensureCapacity(MAX_BUFFER_SIZE));
        String expectedMessage =
    ...
    public void testEnsureCapacityWithAlreadyAllocateMaxBufferSize() {
        ...
        IllegalStateException expectedEx =
                assertThrows(IllegalStateException.class, () -> instance.ensureCapacity(MAX_BUFFER_SIZE + 1));
        String expectedMessage =
    ...
    public void testReadFrom() throws Exception {
        ...
        socketStub.inputStreamStub.addPacket("FOO".getBytes()).addPacket("BAR".getBytes());

        endpoint.setReceiveTimeout(500);
        endpoint.setReadTimeout(100);

        assertThrows(SocketTimeoutException.class, () -> instance.readFrom(socketStub));
    }
}
