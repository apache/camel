...
| *Instrumentation* | Camel routes only | Camel routes + JVM, HTTP clients, databases, messaging, and other libraries
| *Setup* | Built-in SDK | Downloads OTel Java Agent
| *Collector* | Not needed | Not needed (embedded OTLP receiver)
| *Use case* | Quick Camel route debugging | Full-stack observability during development
|=======================================================================
