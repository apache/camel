...
import org.apache.camel.opentelemetry2.CamelOpenTelemetryExtension;
import org.apache.camel.opentelemetry2.OpenTelemetryConstants;
import org.apache.camel.test.junit5.CamelTestSupport;
import org.junit.jupiter.api.Test;

import static org.apache.camel.opentelemetry2.OpenTelemetryConstants.HEADER_COUNTER_DECREMENT;
import static org.apache.camel.opentelemetry2.OpenTelemetryConstants.HEADER_COUNTER_INCREMENT;
    ...
    protected RoutesBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:in1")
                        .to("opentelemetry2:counter:A?increment=5")
                        .to("mock:result");

                from("direct:in2")
                        .to("opentelemetry2:counter:B?decrement=9")
                        .to("mock:result");
