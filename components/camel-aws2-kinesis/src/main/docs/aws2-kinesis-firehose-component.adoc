...
:description: Consume data from AWS Kinesis Firehose streams using AWS SDK version 2.x.
:since: 3.2
:supportLevel: Stable
...
The AWS2 Kinesis Firehose component supports sending messages to Amazon Kinesis Firehose service.
