...
public class WorkdayConfiguration {
    ...
    @UriParam(label = "security", security = "secret", description = "Workday client Id generated by API client for integrations.")
    @Metadata(required = true)
    ...
    @UriParam(label = "security", security = "secret", description = "Workday token Refresh generated for integrations system user.")
    @Metadata(required = true)
