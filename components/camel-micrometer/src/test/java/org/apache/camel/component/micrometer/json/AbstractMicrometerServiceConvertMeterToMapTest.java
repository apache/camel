    ...
    void shouldConvertGaugeWithNaNAndTags() {
        ...
        Meter.Id id = new Meter.Id(
                ...
                Tags.of(
                        ...
                        Tag.of("camel.runtime.version", "4.22.1-SNAPSHOT"),
                        Tag.of("camel.context", "camel-1"),
                        Tag.of("camel.version", "4.22.1-SNAPSHOT")),
                null,
                null,
                Meter.Type.GAUGE);
        ...
        assertEquals("4.22.1-SNAPSHOT", tags.get("camel.runtime.version"));
        assertEquals("camel-1", tags.get("camel.context"));
        assertEquals("4.22.1-SNAPSHOT", tags.get("camel.version"));
    }
