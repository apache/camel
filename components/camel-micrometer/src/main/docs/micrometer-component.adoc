...
By default the Camel Micrometer component creates a `SimpleMeterRegistry` instance.
This default registry, however, should be replaced with a custom one by providing
