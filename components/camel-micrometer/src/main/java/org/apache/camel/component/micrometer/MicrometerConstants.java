...
public final class MicrometerConstants {
    ...
    public static final String CAMEL_EXCHANGE_LAST_TIME_METER_NAME = "camel.exchanges.last.timestamp";
    ...
    public static final Predicate<Meter.Id> DISTRIBUTION_SUMMARIES =
            id -> id.getType() == Meter.Type.DISTRIBUTION_SUMMARY;
