...
public class MyInflightRepositoryTest extends CamelBlueprintTestSupport {

    @Override
    protected String getBlueprintDescriptor() {
        return "org/apache/camel/test/blueprint/MyInflightRepositoryTest.xml";
    }

    @Test
    public void testMyInflightRepository() throws Exception {
        InflightRepository inflightRepository = context().getInflightRepository();
        // send out the message into the camel route
