...
behaviour you need set property `partClass` on the `JaxbDataFormat`. Camel will pass this class
...
You can setup which encoding to use when you declare the `JaxbDataFormat`. You can also provide the encoding in the
