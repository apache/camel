...
public class AbstractOlingo4TestSupport extends CamelTestSupport {
    ...
    protected static final String TEST_PEOPLE = "People('russellwhyte')";
    private static final Logger LOG = LoggerFactory.getLogger(AbstractOlingo4TestSupport.class);
    ...
    public String getResolvedTestServiceBaseUrl() throws IOException {
        return getRealServiceUrl(ODATA_API_BASE_URL, Collections.emptyMap());
    }
    ...
    protected String getRealServiceUrl(String baseUrl, Map<String, String> headers) throws IOException {
        ...
        return modifyServiceUrl(currentHost.toURI(), currentReqUri);
    }

    protected String modifyServiceUrl(String hostUri, String reqUri) {
        return hostUri + reqUri;
    }
}
