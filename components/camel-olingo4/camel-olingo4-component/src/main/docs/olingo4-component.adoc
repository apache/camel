...
[NOTE]
====
This component is deprecated since Camel 4.18 and will be removed in a future release.
Apache Olingo project has been moved to the Apache Attic and is no longer maintained.
====
...
Since version 4.0, OData is an OASIS standard and a number of popular open source
