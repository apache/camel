...
public abstract class FtpsServerImplicitSSLWithClientAuthTestSupport extends FtpsServerTestSupport {
    @RegisterExtension
    static FtpsEmbeddedService service = FtpServiceFactory.createSecureEmbeddedService(
            new EmbeddedConfiguration.SecurityConfiguration(true, AUTH_VALUE_SSL, true));
