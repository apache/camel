...
public class FromFtpSimpleRelativeMoveToAbsoluteIT extends FtpServerTestSupport {
    ...
    public void testPollFileAndShouldBeMoved() throws Exception {
        ...
        mock.expectedFileExists(service.ftpFile("movefile/.done/hello.txt"));
        mock.expectedFileExists(service.ftpFile("movefile/.done/bye.txt"));
        mock.expectedFileExists(service.ftpFile("movefile/.done/goodday.txt"));
