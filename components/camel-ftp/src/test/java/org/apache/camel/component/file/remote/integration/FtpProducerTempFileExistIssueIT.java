...
public class FtpProducerTempFileExistIssueIT extends FtpServerTestSupport {
    ...
    public void testIllegalConfiguration() {
        ...
        assertEquals("You cannot set both fileExist=Append and tempPrefix/tempFileName options", ex.getMessage());
    }
    ...
    public void testWriteUsingTempPrefixButFileExistOverride() throws Exception {
        ...
        template.sendBodyAndHeader(
                getFtpUrl() + "&tempPrefix=foo&fileExist=Override", "Bye World", Exchange.FILE_NAME, "hello.txt");
    ...
    public void testWriteUsingTempPrefixButFileExistIgnore() throws Exception {
        ...
        template.sendBodyAndHeader(
                getFtpUrl() + "&tempPrefix=foo&fileExist=Ignore", "Bye World", Exchange.FILE_NAME, "hello.txt");
