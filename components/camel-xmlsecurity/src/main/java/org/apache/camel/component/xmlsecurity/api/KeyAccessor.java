...
/**
 * Returns the key selector and the optional KeyInfo instance for signing an XML document. There is a default
 * implementation {@link DefaultKeySelector}.
 * <p>
 * The XML signature generator will first call {@link #getKeySelector(Message)} and then
 * {@link KeyAccessor#getKeyInfo(Message, Node, KeyInfoFactory)}.
 */
