...
public class CookieHandlerTest extends CamelTestSupport {
    ...
    public static Stream<Arguments> data() {
        return Stream.of(
                Arguments.of(
                        new InstanceCookieHandler(),
                        CookiePolicy.ACCEPT_ORIGINAL_SERVER,
                        "http://www.example.com/acme/foo",
                        2,
                        "InstanceCookieHandler with ACCEPT_ORIGINAL_SERVER"),
                Arguments.of(
                        new InstanceCookieHandler(),
                        CookiePolicy.ACCEPT_ORIGINAL_SERVER,
                        "http://www.sub.example.com/acme/foo",
                        0,
                        "InstanceCookieHandler with ACCEPT_ORIGINAL_SERVER"),
                Arguments.of(
                        new InstanceCookieHandler(),
    ...
    public void setReceiveAndTestCookie(
            ...
            String uriStr,
            int expectedNumberOfCookieValues,
            String description)
        ...
        headerMap.put(
                ...
                Collections.singletonList(
                        "Customer=\"WILE_E_COYOTE\";Version=1;Path=\"/acme\";Domain=\".example.com\""));
