...
| *propertiesResolver* (common) | *Deprecated* To use a custom PropertiesResolver |  | PropertiesResolver
...
| *camel.component.properties.properties-resolver* | *Deprecated* To use a custom PropertiesResolver. The option is a org.apache.camel.component.properties.PropertiesResolver type. |  | String
|===
