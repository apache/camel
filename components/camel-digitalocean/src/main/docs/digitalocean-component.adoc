...
DigitalOcean REST API encapsulated by camel-digitalocean component is subjected to API Rate Limiting.
ou can find the per-method limits in the https://developers.digitalocean.com/documentation/v2/#rate-limit[API Rate Limits documentation].
