...
public class PublishTextMessageTest extends CamelTestSupport {
    ...
    public void testTextNotificationSend() throws Exception {
        ...
        if (isMockedServerTest) {
            ...
            Assert.assertEquals(
                    "eyJzdWJqZWN0IjoiRHVtbXkgU3ViamVjdCBMaW5lIiwibWVzc2FnZSI6Im1lc3NhZ2UgY29udGVudCIsInRpbWVfdG9fbGl2ZSI6IjYwIn0=",
                    loggedRequest.getBodyAsBase64());
            Assert.assertEquals("{\"subject\":\"Dummy Subject Line\",\"message\":\"message content\",\"time_to_live\":\"60\"}",
