...
public class PublishTemplatedMessageTest extends CamelTestSupport {
    ...
    private void initWireMock() throws Exception {
        ...
        wireMockServer.stubFor(post(urlPathMatching(
                "/v2/9071a38e7f6a4ba7b7bcbeb7d4ea6efc/notifications/topics/urn:smn:unit-test:9071a38e7f6a4ba7b7bcbeb7d4ea6efc:reji-test/publish"))
                        .willReturn(aResponse()
                                .withStatus(200)
                                .withHeader("Content-Type", "application/json")
                                .withBody(Files.readAllBytes(Paths.get("src/test/resources/templates/smn_response.json")))
                                .withStatus(200)));
