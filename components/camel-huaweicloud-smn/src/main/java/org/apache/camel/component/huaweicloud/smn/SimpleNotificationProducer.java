...
public class SimpleNotificationProducer extends DefaultProducer {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        /**
         * the produce method is invoked when a message arrives at producer endpoint
         * (lazy init of SmnClient on first message)
         */
    ...
    private void validateAndInitializeSmnClient(SimpleNotificationEndpoint simpleNotificationEndpoint) {
        ...
        if (ObjectHelper.isEmpty(simpleNotificationEndpoint.getSecretKey()) &&
            ...
            clientConfigurations.setSecretKey(simpleNotificationEndpoint.getSecretKey() != null ? simpleNotificationEndpoint.getSecretKey() :
        ...
        if (ObjectHelper.isEmpty(simpleNotificationEndpoint.getAuthKey()) &&
            ...
            clientConfigurations.setAuthenticationkey(simpleNotificationEndpoint.getAuthKey() != null ? simpleNotificationEndpoint.getAuthKey() :
    ...
    private ClientConfigurations validateServiceConfigurations(SimpleNotificationEndpoint simpleNotificationEndpoint, Exchange exchange) {
        ...
        if (ObjectHelper.isEmpty(exchange.getProperty("CamelHwCloudOperation")) && ObjectHelper.isEmpty(simpleNotificationEndpoint.getOperation())) {
            if (LOG.isErrorEnabled()) {
        ...
        if (ObjectHelper.isEmpty(exchange.getProperty("CamelHwCloudSmnTopic"))) {
            ...
            clientConfigurations.setTopicUrn(String.format(SmnConstants.TOPIC_URN_FORMAT,
                    simpleNotificationEndpoint.getRegion(), simpleNotificationEndpoint.getProjectId(), exchange.getProperty("CamelHwCloudSmnTopic")));
        }
