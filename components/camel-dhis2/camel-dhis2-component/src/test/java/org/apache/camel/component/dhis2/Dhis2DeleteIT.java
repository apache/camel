...
public class Dhis2DeleteIT extends AbstractDhis2TestSupport {
    ...
    private static final String PATH_PREFIX = Dhis2ApiCollection.getCollection()
            .getApiName(Dhis2DeleteApiMethod.class)
            .getName();

    @Test
    public void testResource() {
        String orgUnitId = Environment.DHIS2_CLIENT
                .post("organisationUnits")
                .withResource(new OrganisationUnit()
                        .withName("Acme")
                        .withShortName("Acme")
        ...
        RemoteDhis2ClientException remoteDhis2ClientException =
                assertThrows(RemoteDhis2ClientException.class, () -> Environment.DHIS2_CLIENT
