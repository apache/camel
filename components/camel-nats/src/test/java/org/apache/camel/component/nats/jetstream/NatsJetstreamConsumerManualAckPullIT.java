...
@Isolated
public class NatsJetstreamConsumerManualAckPullIT extends NatsITSupport {
    ...
    public void testManualAck() throws Exception {
        ...
        mockResultEndpoint.expectedHeaderReceived(NatsConstants.NATS_SUBJECT, "mytopic-manualack-pull");
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                String ackUri
                        = "nats:mytopic-manualack-pull?jetstreamEnabled=true&jetstreamName=mystream-manualack-pull&jetstreamAsync=false&durableName=camel-manualack-pull&pullSubscription=true&pullFetchTimeout=500&manualAck=true";
                String nakUri
                        = "nats:mytopic-manualack-pull-nak?jetstreamEnabled=true&jetstreamName=mystream-manualack-pull-nak&jetstreamAsync=false&durableName=camel-manualack-pull-nak&pullSubscription=true&pullFetchTimeout=500&manualAck=true&nackWait=10";
