...
Alternatively, configure the AMQP Component using the available options for SSL, authentication,
and AMQP Broker host/port.

*SSL configuration*

The component can be configured to connect to an AMQP broker using SSL, for example:
