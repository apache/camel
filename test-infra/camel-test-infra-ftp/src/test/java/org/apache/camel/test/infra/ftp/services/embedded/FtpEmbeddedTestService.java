...
public class FtpEmbeddedTestService extends FtpEmbeddedService implements FtpTestService {

    private ExtensionContext context;

    public FtpEmbeddedTestService() {
        super(EmbeddedConfigurationBuilder.defaultConfigurationTemplate());
    }

    protected FtpEmbeddedTestService(EmbeddedConfigurationBuilder embeddedConfigurationTemplate) {
