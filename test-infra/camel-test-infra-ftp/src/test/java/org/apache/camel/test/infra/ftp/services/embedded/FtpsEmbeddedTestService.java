...
public class FtpsEmbeddedTestService extends FtpEmbeddedTestService implements FtpTestService {
    public FtpsEmbeddedTestService(EmbeddedConfigurationBuilder embeddedConfigurationBuilder) {
        super(EmbeddedConfigurationBuilder.defaultFtpsConfigurationTemplate());
    }

    public FtpsEmbeddedTestService(EmbeddedConfiguration.SecurityConfiguration securityConfiguration) {
        super(EmbeddedConfigurationBuilder.defaultFtpsConfigurationTemplate().withSecurityConfiguration(securityConfiguration));
    }

    @Deprecated
    public FtpsEmbeddedTestService(boolean useImplicit, String authValue, boolean clientAuth) {
        super(EmbeddedConfigurationBuilder.defaultFtpsConfigurationTemplate());
