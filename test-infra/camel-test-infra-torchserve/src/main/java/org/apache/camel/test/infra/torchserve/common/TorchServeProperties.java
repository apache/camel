...
public class TorchServeProperties {
    public static final String TORCHSERVE_INFERENCE_PORT = "torchserve.inference.port";
    public static final String TORCHSERVE_MANAGEMENT_PORT = "torchserve.management.port";
