...
public class ArtemisVMTestService extends ArtemisVMService implements ArtemisTestService {
    public ArtemisVMTestService() {
    }

    protected ArtemisVMTestService(int port) {
        super(port);
    }
     ...
     */
    public static class ReusableArtemisVMService extends ArtemisVMTestService {
