...
public class WeaviateRemoteInfraService implements WeaviateInfraService {
    ...
    public String getWeaviateEndpointUrl() {
        return System.getProperty(WeaviateProperties.WEAVIATE_ENDPOINT_URL);
    }

    @Override
    public String getWeaviateHost() {
        return System.getProperty(WeaviateProperties.WEAVIATE_ENDPOINT_HOST);
    }
