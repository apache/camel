...
public class VictoriaLogsContainer extends GenericContainer<VictoriaLogsContainer> {
    ...
    public VictoriaLogsContainer() {
        super(LocalPropertyResolver.getProperty(
                ObservabilityLocalContainerInfraService.class, ObservabilityProperties.VICTORIA_LOGS_CONTAINER));
