 ...
 */
public class RemoteCassandraInfraService implements CassandraInfraService {
    private static final Logger LOG = LoggerFactory.getLogger(RemoteCassandraInfraService.class);
