...
mvn test-compile eu.maveniverse.maven.plugins:pilot-plugin:0.4.0:dependencies -Pdep-check -Dlicense.skip -Dquickly
...
[source,bash]
----
mvn test-compile eu.maveniverse.maven.plugins:pilot-plugin:0.4.0:dependencies -Pdep-check -Dpilot.action=check
----
