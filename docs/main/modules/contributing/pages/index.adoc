...
Contributors using AI coding assistants (such as https://github.com/anthropics/claude-code[Claude Code] or similar tools) can take advantage of the project rules in the `.oss-ai-helper-rules/` directory and the `CLAUDE.md` file at the repository root.
