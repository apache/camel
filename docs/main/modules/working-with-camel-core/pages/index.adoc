...
The xref:manual::camelcontext.adoc[Camel Context] is the heart of Apache Camel, which holds everything together.
...
You can find additional documentation in the xref:manual::architecture.adoc[architecture documentation] in the user manual.
