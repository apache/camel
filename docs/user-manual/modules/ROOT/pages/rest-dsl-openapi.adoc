...
2. use example inlined in the OpenAPI `response` section.
...
In the response section below, then for success response (200) then for the `application/json` content-type, we have
