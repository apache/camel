...
CAUTION: Exchange pooling is *deprecated* since Camel 4.23 and will be removed in a future release.
Please remove any `camel.main.exchange-factory=pooled` configuration from your application.
