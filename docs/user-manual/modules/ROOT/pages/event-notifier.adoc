...
This provides the same kind of structured metadata access as xref:components::others/backlog-tracer.adoc[Backlog Tracer] and the Error Registry backlog messages, but for live EventNotifier events.
...
The developer console event page also uses this structured JSON representation.
