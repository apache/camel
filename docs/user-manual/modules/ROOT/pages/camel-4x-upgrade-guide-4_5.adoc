...
The `BulkRequestAggregationStrategy` has been renamed to `OpensearchBulkRequestAggregationStrategy` and
`ElasticsearchBulkRequestAggregationStrategy` respectively.