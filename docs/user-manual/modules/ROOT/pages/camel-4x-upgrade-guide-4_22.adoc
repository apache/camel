...
Apache Tika 4 removes the `TikaConfig` class and XML configuration support; Camel 4.23 will provide
replacement options based on Tika's `TikaLoader` and JSON configuration. See the
