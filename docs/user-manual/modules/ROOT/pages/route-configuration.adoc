...
The builder is similar to xref:route-builder.adoc[RouteBuilder] so its usage is similar.
...
by the Spring Boot package scanning. This requires adding the `@Component` annotation to the class.

See more in this Spring Boot example https://github.com/apache/camel-spring-boot-examples/tree/main/routes-configuration[Routes Configuration Example].
...
route configurations in Java, and then use YAML DSL for the routes, and they would work together.
...
- https://github.com/apache/camel-examples/tree/main/routes-configuration[Standalone Routes Configuration Example]
- https://github.com/apache/camel-spring-boot-examples/tree/main/routes-configuration[Spring Boot Routes Configuration Example]
