...
image:../assets/images/images/async.data/camel_sync_request_reply.png[image]
...
image:../assets/images/images/async.data/camel_async_request_reply.png[image]
...
image:../assets/images/images/async.data/camel_sync_request_only.png[image]
...
image:../assets/images/images/async.data/camel_async_request_only.png[image]
