...
xref:components::cxf-component.adoc[CXF], xref:components::http4-component.adoc[HTTP], xref:components::jms-component.adoc[JMS],
...
|xref:components::http4-component.adoc[HTTP] |Each inbound
