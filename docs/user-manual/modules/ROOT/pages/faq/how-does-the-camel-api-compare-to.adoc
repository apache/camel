...
xref:cxf-component.adoc[CXF], xref:http-component.adoc[HTTP], xref:jms-component.adoc[JMS],
xref:mail-component.adoc[Mail], xref:xmpp-component.adoc[XMPP] and most other integration
