...
xref:components::http4-component.adoc[HTTP], xref:activemq.adoc[ActiveMQ], xref:jms-component.adoc[JMS],
JBI, SCA, xref:components::mina2-component.adoc[MINA] or xref:cxf-component.adoc[CXF], as
