...
image:../assets/images/images/building.data/camel-eclipse-m2e-import.png[image]
...
image:../assets/images/images/building.data/camel-eclipse-m2e-import-completed.png[image]
