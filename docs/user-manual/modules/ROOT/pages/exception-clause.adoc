...
Then the message has been enriched with a header named application after the original message was received in the JMS endpoint. And in case of an error then the `onException`
