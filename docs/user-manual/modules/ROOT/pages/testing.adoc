...
|xref:components:others:testcontainers-junit5.adoc[camel-testcontainers-junit5] | *JUnit 5*: Camel Testcontainers extends standard camel test support providing a way to create and interact with containerized applications.
|xref:components:others:testcontainers-spring-junit5.adoc[camel-testcontainers-spring-junit5] | *JUnit 5*: Camel Testcontainers extends standard camel Spring test support providing a way to create and interact with containerized applications.
