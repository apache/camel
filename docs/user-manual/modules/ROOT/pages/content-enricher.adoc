...
xref:simple-language.adoc[Simple] or xref:constant.html[Constant] or any other
...
a xref:components::http4-component.adoc[HTTP] endpoint where the header with key orderId is
