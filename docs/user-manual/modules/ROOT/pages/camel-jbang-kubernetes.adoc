...
By default, resources have the label `camel.apache.org/integration` set to the project name.
...
NOTE: If you used `--cluster-type` during export/run, you must specify it for delete as well.
