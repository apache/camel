...
The component stomp is deprecated. The protocol and the used implementation has not received updates in the last ten years and tests started to fail with Artemis 2.43.
