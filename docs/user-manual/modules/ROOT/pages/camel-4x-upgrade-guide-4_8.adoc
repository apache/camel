...
The tracer (`BacklogTracer`) has changed the `backlogSize` default value from `1000` to `100`. This reduces the amount of
data captured and stored and helps reduce the tracing overhead.
