...
Use *↑*/*↓* to move between rows, *Space* (or *←*/*→*) to cycle the theme and starting tab, type to
...
`camel.tui.defaultFolder`) in the Camel CLI configuration file. Each key is read from and
