...
The console can give you insights into your running Camel application, such as reporting the top
...
The https://hawt.io/[Hawtio] web console allows inspecting running Camel applications, such
...
You can uninstall the Jolokia JVM Agent in a running Camel application when no longer needed:
