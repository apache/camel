...
The `run-background` command runs Camel in background. Therefore, to understand what happens then you can use the management commands
such as `camel ps`, `camel get` and `camel log`.

[source,bash]
----
$ camel run-background chuck.yaml
