...
To show the services that are running, the flag --running can be used, this way, only the running processes are printed to the output
in order to make it easier to gather the running service name and stop it.
