...
The Camel JBang application can be packaged as a standalone _fat-jar_ without the need for JBang to run the application.

You simply do this by

[source,bash]
----
camel package fat-jar
----

Which will generate `target/camel-app.jar` as the output file.
