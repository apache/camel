...
NOTE: CyberArk Conjur requires secrets (variables) to be defined in a policy file before they can be set. See the xref:next@components::cyberark-vault-component.adoc[CyberArk Vault component documentation] for details on setting up policies.
