...
** xref:components::json-xstream-dataformat.adoc[JSon XStream]
...
=== Camel Jar Requirements

==== Camel 2.0 or lower requires:
...
* JAXB modules are required to be added as Maven dependencies because there are removed from Java 11.
