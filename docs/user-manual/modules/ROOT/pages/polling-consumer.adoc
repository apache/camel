...
also the xref:components::quartz2-component.adoc[Quartz Component] which provides scheduled
...
** xref:components::quartz2-component.adoc[Quartz]
...
xref:components::quartz2-component.adoc[Quartz2], and xref:spring.adoc[Spring] based which
...
to refer to use the xref:components::quartz2-component.adoc[Quartz2] scheduler; and use the
...
See xref:components::quartz2-component.adoc[Quartz2] page for an example.

|`scheduler.xxx` |`null` |*Camel 2.12:* To configure additional
properties when using a custom *`scheduler`* or any of the
xref:components::quartz2-component.adoc[Quartz2], xref:spring.adoc[Spring] based scheduler.
...
in the xref:components::quartz2-component.adoc[Quartz2], and xref:spring.adoc[Spring]
components.
