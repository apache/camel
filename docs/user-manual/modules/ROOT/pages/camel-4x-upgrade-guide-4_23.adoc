...
If you define the repository as a bean in XML, replace the single bean with two beans — a
`MemoryKeyValueRepository` backing store and the appropriate adapter:
