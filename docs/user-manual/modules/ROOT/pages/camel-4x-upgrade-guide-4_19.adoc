...
The deprecated component-specific enums have been removed. All internal usages now reference
`org.apache.camel.component.azure.common.CredentialType` directly. The `camel-azure-common` module is
