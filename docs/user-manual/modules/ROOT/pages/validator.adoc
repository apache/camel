...
NOTE: Currently, validators is only supported in Java DSL and the classic Spring XML.
...
If you have the following route definition, above validator will be applied when `direct:abc` endpoint
