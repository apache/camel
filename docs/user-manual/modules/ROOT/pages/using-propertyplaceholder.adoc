...
Another important point it is the following: you'll need to explicitly add the secretsManager dependency in your POM while using this feature.
...
Where the 'aws-java-sdk2-version' is the version used in the camel-parent of the Camel release you're using.
