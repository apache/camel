...
This processor will convert the current message body to a StreamCache. This allows the body to be re-read multiple times and can be placed at  any point in a Camel route.
