...
This happens with types that are streaming based, such as `java.util.InputStream`, etc.
...
TIP: You can run Camel CLI: `camel doc main --filter=stream` from CLI to see all the options.
