...
- https://github.com/apache/camel-examples/tree/main/examples/main-xml[camel-example-main-xml]
- https://github.com/apache/camel-examples/tree/main/examples/main-yaml[camel-example-main-yaml]
