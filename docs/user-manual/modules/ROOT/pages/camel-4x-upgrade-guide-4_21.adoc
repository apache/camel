...
Users who configure `DefaultHeaderFilterStrategy` directly and need these headers to pass through
must now explicitly opt out by calling `setInFilterStartsWith((String[]) null)` and/or
