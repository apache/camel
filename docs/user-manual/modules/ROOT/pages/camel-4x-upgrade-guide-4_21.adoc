...
selected consumer delegate, which is responsible for enforcing it. Verify that the selected delegate
supports `oauthProfile`; delegates that ignore the option can otherwise start without the expected
endpoint protection.
