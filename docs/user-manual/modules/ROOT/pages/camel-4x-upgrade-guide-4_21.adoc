...
Java object serialization is a recurring source of security issues and therefor these converters has been removed.
These converters are not used at all by Camel itself.

To restore compatability then end users can add these type converters back as custom converters in their own Camel applications.
