...
`readme.md` gained a _For AI coding assistants_ section linking to the Apache Camel LLM index
(`https://camel.apache.org/llms.txt`), and a new `AGENTS.md` file is generated at the project root. This applies to
