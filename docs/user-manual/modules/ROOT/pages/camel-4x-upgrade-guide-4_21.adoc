...
A new `camel validate normalize` command has been added to Camel JBang. It rewrites YAML routes from the
...
See xref:components:others:yaml-dsl.adoc#_extending_yaml_route_steps[Extending YAML route steps] for details.
