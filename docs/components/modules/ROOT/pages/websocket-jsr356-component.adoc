...
| *serverEndpointDeployment{zwsp}Strategy* (advanced) | To enable customization of how a WebSocket ServerEndpoint is configured and deployed. By default DefaultServerEndpointDeploymentStrategy is used. |  | ServerEndpointDeploymentStrategy
|===
