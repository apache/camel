...
| *transformDsl* (producer) | Specifies the Transform DSL of the endpoint resource. If none is specified <code>Chainr will be used. There are 5 enums and the value can be one of: Chainr, Shiftr, Defaultr, Removr, Sortr | Chainr | JoltTransformType
