...
:page-source: components/camel-xslt-saxon/src/main/docs/xslt-saxon-component.adoc
:docTitle: XSLT Saxon
...
include::{page-component-version}@camel-spring-boot::page$xslt-saxon-starter.adoc[]
