...
:page-source: components/camel-aws/camel-aws2-translate/src/main/docs/aws2-translate-component.adoc
...
The AWS 2 Translate component supports 19 options, which are listed below.
