...
| *outputType* (producer) | Determines the output the producer should use. There are 3 enums and the value can be one of: select-one, select-list, stream-list | select-list | JdbcOutputType
