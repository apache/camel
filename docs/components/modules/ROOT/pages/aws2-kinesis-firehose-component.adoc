...
:page-source: components/camel-aws/camel-aws2-kinesis/src/main/docs/aws2-kinesis-firehose-component.adoc
...
The AWS 2 Kinesis Firehose component supports 15 options, which are listed below.
