...
| *operation* (producer) | Queue service operation hint to the producer. There are 9 enums and the value can be one of: list-queues, create-queue, delete-queue, clear-queue, send-message, delete-message, receive-messages, peek-messages, update-message |  | QueueOperationDefinition
