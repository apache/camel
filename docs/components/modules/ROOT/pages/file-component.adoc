...
== Avoiding file auto-deletion and reuse of the same file
...
[source,java]
----
from("file://inbox?fileName=fileName.txt&noop=true").to("...");
----
...
In the above noope=true will avoid auto-deletion of the file 
