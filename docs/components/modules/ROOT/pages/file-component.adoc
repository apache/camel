...
This restricts the number of operations to be performed on the file to 1.

To enable reuse of this file you can disable this feature.
...
The above will avoid deleting the file and will also disable the idempotent feature.
