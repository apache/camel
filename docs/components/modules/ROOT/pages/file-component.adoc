...
xref:File2-Consumingfilesfromfolderswhereothersdropfilesdirectly.adoc[Consuming files from folders where others drop files directly].
====
...
(though if you use an expression such as xref:file-language,File Language>>, or <<simple-language.adoc[Simple] then the result of the expression
