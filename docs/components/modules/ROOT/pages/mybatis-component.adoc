...
| *configurationUri* (common) | Location of MyBatis xml configuration file. <p/> The default value is: SqlMapConfig.xml loaded from the classpath | SqlMapConfig.xml | String
