...
| *operation* (producer) | Queue service operation hint to the producer. There are 8 enums and the value can be one of: list-queues, create-queue, delete-queue, add-message, retrieve-message, peek-message, update-message, delete-message | list-queues | QueueServiceOperations
