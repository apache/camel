...
:docTitle: Identity and Access Management (IAM)
...
The Identity and Access Management (IAM) component supports 2 options, which are listed below.
...
The Identity and Access Management (IAM) endpoint is configured using URI syntax:
