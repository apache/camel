...
:description: Generate messages in specified intervals using <code>java.util.Timer.
:since: 1.0
:supportLevel: Stable
...
| *daemon* (advanced) | Specifies whether or not the thread associated with the timer endpoint runs as a daemon. <p/> The default value is true. | true | boolean
