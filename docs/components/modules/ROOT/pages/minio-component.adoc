...
| *serverSideEncryption* (common) | (Optional) Server-side encryption. |  | ServerSideEncryption
| *serverSideEncryptionCustomer Key* (common) | (Optional) Server-side encryption for source object while copy/move objects. |  | ServerSideEncryptionCustomerKey
...
|===
| Name | Description | Default | Type
| *bucketName* | *Required* Qualified url |  | String
|===
