...
The AWS Elastic Container Service (ECS) component supports 11 options, which are listed below.
...
include::{page-component-version}@camel-spring-boot::page$aws-ecs-starter.adoc[]
