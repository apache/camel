...
// components: START
Number of Components: 316 in 254 JAR artifacts (1 deprecated)
...
| xref:aws2-mq-component.adoc[AWS 2 MQ] (camel-aws2-mq) | 3.1 | The aws-mq is used for managing Amazon MQ instances.

| xref:aws2-msk-component.adoc[AWS 2 MSK] (camel-aws2-msk) | 3.1 | The aws-msk is used for managing Amazon MSK
