...
| xref:azure-storage-blob-component.adoc[Azure Storage Blob Service] (camel-azure-storage-blob) | 3.3 | The azure-storage-blob component is used for storing and retrieving blobs from Azure Storage Blob Service using SDK v12.
...
| xref:djl-component.adoc[Deep Java Library] (camel-djl) | 3.3 | The Deep Java Library component is used to infer deep learning models.
...
| xref:microprofile-fault-tolerance.adoc[Microprofile Fault Tolerance] (camel-microprofile-fault-tolerance) | 3.3 | Circuit Breaker EIP using Microprofile Fault Tolerance
