...
// components: START
Number of Components: 300 in 238 JAR artifacts (1 deprecated)

[width="100%",cols="4,1,5",options="header"]
|===
| Component | Since | Description

| xref:activemq-component.adoc[ActiveMQ] (camel-activemq) +
...
| xref:bean-component.adoc[Bean] (camel-bean) +
...
| xref:beanstalk-component.adoc[Beanstalk] (camel-beanstalk) +
...
| xref:caffeine-cache-component.adoc[Caffeine Cache] (camel-caffeine) +
...
| xref:cql-component.adoc[Cassandra CQL] (camel-cassandraql) +
...
| xref:consul-component.adoc[Consul] (camel-consul) +
...
| xref:controlbus-component.adoc[Control Bus] (camel-controlbus) +
...
| xref:corda-component.adoc[corda] (camel-corda) +
`corda:configuration` | 2.23 | The corda component uses the corda-rpc to interact with corda nodes.

| xref:couchbase-component.adoc[Couchbase] (camel-couchbase) +
...
| xref:crypto-cms-component.adoc[Crypto CMS] (camel-crypto-cms) +
...
| xref:elasticsearch-rest-component.adoc[Elastichsearch Rest] (camel-elasticsearch-rest) +
...
| xref:elsql-component.adoc[ElSQL] (camel-elsql) +
...
| xref:git-component.adoc[Git] (camel-git) +
`git:localPath` | 2.16 | The git component is used for working with git repositories.

| xref:github-component.adoc[GitHub] (camel-github) +
...
| xref:google-bigquery-sql-component.adoc[Google BigQuery Standard SQL] (camel-google-bigquery) +
...
| xref:grpc-component.adoc[gRPC] (camel-grpc) +
...
| xref:hazelcast-atomicvalue-component.adoc[Hazelcast Atomic Number] (camel-hazelcast) +
...
| xref:hazelcast-list-component.adoc[Hazelcast List] (camel-hazelcast) +
`hazelcast-list:cacheName` | 2.7 | The hazelcast-list component is used to access Hazelcast distributed list.

| xref:hazelcast-map-component.adoc[Hazelcast Map] (camel-hazelcast) +
...
| xref:hazelcast-queue-component.adoc[Hazelcast Queue] (camel-hazelcast) +
`hazelcast-queue:cacheName` | 2.7 | The hazelcast-queue component is used to access Hazelcast distributed queue.

| xref:hazelcast-replicatedmap-component.adoc[Hazelcast Replicated Map] (camel-hazelcast) +
`hazelcast-replicatedmap:cacheName` | 2.16 | The hazelcast-replicatedmap component is used to access Hazelcast replicated map.

| xref:hazelcast-ringbuffer-component.adoc[Hazelcast Ringbuffer] (camel-hazelcast) +
...
| xref:hazelcast-set-component.adoc[Hazelcast Set] (camel-hazelcast) +
...
| xref:ignite-cache-component.adoc[Ignite Cache] (camel-ignite) +
...
| xref:ignite-compute-component.adoc[Ignite Compute] (camel-ignite) +
...
| xref:ignite-events-component.adoc[Ignite Events] (camel-ignite) +
...
| xref:ignite-idgen-component.adoc[Ignite ID Generator] (camel-ignite) +
...
| xref:ignite-messaging-component.adoc[Ignite Messaging] (camel-ignite) +
...
| xref:ignite-queue-component.adoc[Ignite Queues] (camel-ignite) +
...
| xref:ignite-set-component.adoc[Ignite Sets] (camel-ignite) +
...
| xref:jmx-component.adoc[JMX] (camel-jmx) +
`jmx:serverURL` | 2.6 | The jmx component allows to receive JMX notifications.

| xref:jolt-component.adoc[JOLT] (camel-jolt) +
...
| xref:kafka-component.adoc[Kafka] (camel-kafka) +
`kafka:topic` | 2.13 | The kafka component allows messages to be sent to (or consumed from) Apache Kafka brokers.

| xref:kubernetes-config-maps-component.adoc[Kubernetes ConfigMap] (camel-kubernetes) +
...
| xref:kubernetes-deployments-component.adoc[Kubernetes Deployments] (camel-kubernetes) +
...
| xref:kubernetes-hpa-component.adoc[Kubernetes HPA] (camel-kubernetes) +
...
| xref:kubernetes-job-component.adoc[Kubernetes Job] (camel-kubernetes) +
`kubernetes-job:masterUrl` | 2.23 | The Kubernetes Jobs component provides a producer to execute kubernetes job operations

| xref:kubernetes-namespaces-component.adoc[Kubernetes Namespaces] (camel-kubernetes) +
...
| xref:kubernetes-persistent-volumes-component.adoc[Kubernetes Persistent Volume] (camel-kubernetes) +
...
| xref:kubernetes-persistent-volumes-claims-component.adoc[Kubernetes Persistent Volume Claim] (camel-kubernetes) +
...
| xref:kubernetes-replication-controllers-component.adoc[Kubernetes Replication Controller] (camel-kubernetes) +
...
| xref:kubernetes-resources-quota-component.adoc[Kubernetes Resources Quota] (camel-kubernetes) +
...
| xref:kubernetes-secrets-component.adoc[Kubernetes Secrets] (camel-kubernetes) +
...
| xref:kubernetes-service-accounts-component.adoc[Kubernetes Service Account] (camel-kubernetes) +
...
| xref:kubernetes-services-component.adoc[Kubernetes Services] (camel-kubernetes) +
...
| xref:language-component.adoc[Language] (camel-language) +
...
| xref:ldap-component.adoc[LDAP] (camel-ldap) +
...
| xref:metrics-component.adoc[Metrics] (camel-metrics) +
...
| xref:micrometer-component.adoc[Micrometer] (camel-micrometer) +
...
| xref:openstack-nova-component.adoc[OpenStack Nova] (camel-openstack) +
...
| xref:optaplanner-component.adoc[OptaPlanner] (camel-optaplanner) +
...
| xref:pg-replication-slot-component.adoc[PostgresSQL Replication Slot] (camel-pg-replication-slot) +
...
| xref:quickfix-component.adoc[QuickFix] (camel-quickfix) +
...
| xref:rest-api-component.adoc[REST API] (camel-rest) +
...
| xref:rest-swagger-component.adoc[REST Swagger] (camel-rest-swagger) +
`rest-swagger:specificationUri#operationId` | 2.19 | An awesome REST endpoint backed by Swagger specifications.

| xref:restlet-component.adoc[Restlet] (camel-restlet) +
`restlet:protocol:host:port/uriPattern` | 2.0 | *deprecated* Component for consuming and producing Restful resources using Restlet.
...
| xref:sjms-component.adoc[Simple JMS] (camel-sjms) +
...
| xref:sjms-batch-component.adoc[Simple JMS Batch] (camel-sjms) +
...
| xref:sjms2-component.adoc[Simple JMS2] (camel-sjms2) +
...
| xref:spring-redis-component.adoc[Spring Redis] (camel-spring-redis) +
`spring-redis:host:port` | 2.11 | The spring-redis component allows sending and receiving messages from Redis.

| xref:spring-ws-component.adoc[Spring WebService] (camel-spring-ws) +
...
| xref:stub-component.adoc[Stub] (camel-stub) +
...
| xref:telegram-component.adoc[Telegram] (camel-telegram) +
`telegram:type` | 2.18 | The telegram component provides access to the Telegram Bot API.

| xref:thrift-component.adoc[Thrift] (camel-thrift) +
...
| xref:tika-component.adoc[Tika] (camel-tika) +
...
| xref:twitter-directmessage-component.adoc[Twitter Direct Message] (camel-twitter) +
`twitter-directmessage:user` | 2.10 | The Twitter Direct Message Component consumes/produces user's direct messages.

| xref:twitter-search-component.adoc[Twitter Search] (camel-twitter) +
...
| xref:undertow-component.adoc[Undertow] (camel-undertow) +
...
| xref:webhook-component.adoc[Webhook] (camel-webhook) +
...
| xref:wordpress-component.adoc[Wordpress] (camel-wordpress) +
`wordpress:operation` | 2.21 | Integrates Camel with Wordpress.

| xref:xchange-component.adoc[XChange] (camel-xchange) +
...
| xref:reactive-executor-vertx.adoc[Reactive Executor Vertx] (camel-reactive-executor-vertx) | 3.0 | Reactive Executor for camel-core using Vert X
...
| xref:aws-xray.adoc[XRay] (camel-aws-xray) | 2.21 | Distributed tracing using AWS XRay
