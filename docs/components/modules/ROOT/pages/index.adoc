...
// components: START
Number of Components: 317 in 255 JAR artifacts (1 deprecated)
...
| xref:aws2-kms-component.adoc[AWS 2 KMS] (camel-aws2-kms) | 3.1 | The aws-kms is used for managing Amazon KMS
...
| xref:workday-component.adoc[Workday] (camel-workday) | 3.1.0-SNAPSHOT | Represents a camel-workday endpoint.
...
// others: START
Number of Miscellaneous Components: 44 in 44 JAR artifacts (0 deprecated)
...
| xref:aws2-kms.adoc[Aws2 Kms] (camel-aws2-kms) |  | A Camel Amazon KMS Web Service Component Version 2

| xref:aws2-mq.adoc[Aws2 Mq] (camel-aws2-mq) |  | A Camel Amazon MQ Web Service Component Version 2

| xref:aws2-msk.adoc[Aws2 Msk] (camel-aws2-msk) |  | A Camel Amazon MSK Web Service Component Version 2
...
| xref:fhir.adoc[Fhir] (camel-fhir) |  | Camel FHIR HL7 support
...
| xref:olingo2.adoc[Olingo2] (camel-olingo2) |  | Camel Olingo2 component

| xref:olingo4.adoc[Olingo4] (camel-olingo4) |  | Camel Olingo4 component
...
| xref:salesforce.adoc[Salesforce] (camel-salesforce) |  | Camel Salesforce support

| xref:servicenow.adoc[Servicenow] (camel-servicenow) |  | Camel ServiceNow support
