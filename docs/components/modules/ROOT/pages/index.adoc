...
| xref:aws2-kinesis-component.adoc[AWS 2 Kinesis] (camel-aws2-kinesis) | 3.2 | The aws-kinesis component is for consuming and producing records from Amazon Kinesis Streams.

| xref:aws2-kinesis-firehose-component.adoc[AWS 2 Kinesis Firehose] (camel-aws2-kinesis) | 3.2 | The aws-kinesis-firehose component is used for producing Amazon's Kinesis Firehose streams.
