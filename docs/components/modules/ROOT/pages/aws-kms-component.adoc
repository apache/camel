...
$reference/components/aws-kms.adoc[opts=optional]
//Manually maintained attributes
:group: AWS
:camel-spring-boot-name: aws-kms
...
| *operation* (producer) | *Required* The operation to perform. There are 6 enums and the value can be one of: listKeys, createKey, disableKey, scheduleKeyDeletion, describeKey, enableKey |  | KMSOperations
