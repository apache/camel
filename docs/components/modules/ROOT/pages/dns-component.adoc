...
|===
| Name | Description | Default | Type
| *dnsType* | *Required* The type of the lookup. There are 4 enums and the value can be one of: dig, ip, lookup, wikipedia |  | DnsType
|===
...
include::{page-component-version}@camel-spring-boot::page$dns-starter.adoc[]
