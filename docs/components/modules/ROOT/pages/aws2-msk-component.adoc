...
| *operation* (producer) | *Required* The operation to perform. There are 4 enums and the value can be one of: list-clusters, create-cluster, delete-cluster, describe-cluster |  | MSK2Operations
