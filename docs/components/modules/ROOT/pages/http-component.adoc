...
| *proxyAuthScheme* (proxy) | Proxy authentication scheme to use. There are 2 enums and the value can be one of: http, https |  | String
| *proxyAuthUsername* (proxy) | Proxy authentication username |  | String
...
| *authMethodPriority* (security) | Which authentication method to prioritize to use, either as Basic, Digest or NTLM. There are 3 enums and the value can be one of: Basic, Digest, NTLM |  | String
...
include::{page-component-version}@camel-spring-boot::page$http-starter.adoc[]
