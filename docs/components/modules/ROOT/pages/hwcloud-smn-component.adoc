...
= Simple Message Notification (SMN) Component
//THIS FILE IS COPIED: EDIT THE SOURCE FILE:
:page-source: componentscamel-huaweicamel-huaweicloud-smnsrcmaindocshwcloud-smn-component.adoc
:docTitle: Simple Message Notification (SMN)
...
The Simple Message Notification (SMN) component supports 2 options, which are listed below.
...
The Simple Message Notification (SMN) endpoint is configured using URI syntax:
