...
The Huawei Cloud Simple Message Notification (SMN) component supports 2 options, which are listed below.
...
The Huawei Cloud Simple Message Notification (SMN) endpoint is configured using URI syntax:
