...
:page-source: components/camel-huaweicloud-functiongraph/src/main/docs/hwcloud-functiongraph-component.adoc
...
| *functionPackage* (producer) | Functions that can be logically grouped together |  | String
