...
|===
| Name | Description | Default | Type
| *timelineType* | *Required* The timeline type to produce/consume. There are 7 enums and the value can be one of: PUBLIC, HOME, USER, MENTIONS, RETWEETSOFME, LIST, UNKNOWN |  | TimelineType
|===
...
include::spring-boot:partial$twitter-starter.adoc[]
