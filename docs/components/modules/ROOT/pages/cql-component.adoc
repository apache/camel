...
| *consistencyLevel* (common) | Consistency level to use. There are 11 enums and the value can be one of: any, one, two, three, quorum, all, local-one, local-quorum, each-quorum, serial, local-serial |  | DefaultConsistencyLevel
