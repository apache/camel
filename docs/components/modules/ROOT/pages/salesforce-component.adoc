...
| rawQueryParameters | `String` | Query Comma separated list of message headers to include as query parameters. Do not url-encode values as this will be done automatically. | |
| rawHttpHeaders | `String` | Query Comma separated list of message headers to include as HTTP headers for Raw operation. | |
|===
