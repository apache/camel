...
| *contentType* (common) | Bulk API content type, one of XML, CSV, ZIP_XML, ZIP_CSV. There are 6 enums and the value can be one of: xml, csv, json, zip-xml, zip-csv, zip-json |  | ContentType
