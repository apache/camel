...
:page-source: components/camel-aws-ddb/bin/src/main/docs/aws-ddbstream-component.adoc
...
| *proxyProtocol* (consumer) | To define a proxy protocol when instantiating the DDBStreams client | HTTPS | Protocol
