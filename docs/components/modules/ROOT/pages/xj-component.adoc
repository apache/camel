...
| Name | Description | Default | Type
<<<<<<< HEAD
| *transformDirection* (producer) | *Required* Sets the transform direction. The value can be one of: XML2JSON, JSON2XML |  | TransformDirection
=======
...
| *transformDirection* (producer) | *Required* Transform direction. Either XML2JSON or JSON2XML |  | TransformDirection
>>>>>>> 5c3b087412c... [CAMEL-14468] Move generated code into src/generated
