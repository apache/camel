...
//THIS FILE IS ORPHANED: the alleged source does not exist!
:page-source: components/camel-threadpoolfactory-vertx/src/main/docs/reactive-threadpoolfactory-vertx.adoc
