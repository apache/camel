[[spring-javaconfig-other]]
= Spring Java Configuration Component (deprecated)
//THIS FILE IS COPIED: EDIT THE SOURCE FILE:
:page-source: components/camel-spring-javaconfig/src/main/docs/spring-javaconfig.adoc
...
$reference/others/spring-javaconfig.adoc[opts=optional]
