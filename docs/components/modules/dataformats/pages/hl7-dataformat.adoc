...
* HL7 MLLP codec for xref:ROOT:mina2-component.adoc[Mina 2]
* HL7 MLLP codec for xref:ROOT:netty4-component.adoc[Netty4] from *Camel 2.15* onwards
* Type Converter from/to HAPI and String
* HL7 DataFormat using the HAPI library
* Even more ease-of-use as it's integrated well with the
xref:ROOT:mina2-component.adoc[Mina 2] component.
...
a HL7 listener service, the xref:ROOT:mina2-component.adoc[Mina 2] or
xref:ROOT:netty4-component.adoc[Netty4] component is used with the
