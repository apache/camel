...
| lineLength | 76 | Integer | To specific a maximum line length for the encoded data. <p/> By default 76 is used.
| lineSeparator |  | String | The line separators to use. <p/> Uses new line characters (CRLF) by default.
