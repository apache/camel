...
You have to add the dependency on *implementation* of jsonb specification.

If you want to add Johnzon imlementation and you are using maven, just add following to you pom.xml
