...
public class MllpSenderNegativeTest extends CamelTestSupport {
    MllpServerResource mllpServer = new MllpServerResource();

    String targetURI = "direct://mllp-sender";

    String encoderBeanName = "hl7encoder";
    String decoderBeanName = "hl7decoder";
...
//                .backOffMultiplier(2)
    ...
    public void testNoResponseOnFirstMessage() throws Exception {
        ...
        template.sendBody( TEST_MESSAGE );
