...
public class MllpInvalidAcknowledgementException extends MllpAcknowledgementException {
    ...
    public MllpInvalidAcknowledgementException(Throwable cause) {
        super(cause);
    }

    public MllpInvalidAcknowledgementException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
