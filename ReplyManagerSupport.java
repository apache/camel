 ...
 *
 * In this custom release om camel-jms we can configure paramters in the method waitForProvisionCorrelationToBeUpdated(String correlationID, Message message).
 * @version 
 */
public abstract class ReplyManagerSupport extends ServiceSupport implements ReplyManager {
     ...
     * 
     * Added Feature is that the waitForProvisionCorrelationToBeUpdateCounter and the waitForProvisionCorrelationToBeUpdatedThreadSleepingTime
