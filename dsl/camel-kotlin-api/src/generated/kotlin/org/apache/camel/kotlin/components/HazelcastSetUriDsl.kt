...
public fun UriDsl.`hazelcast-set`(i: HazelcastSetUriDsl.() -> Unit) {
  HazelcastSetUriDsl(this).apply(i)
}

@CamelDslMarker
public class HazelcastSetUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("hazelcast-set")
  }
