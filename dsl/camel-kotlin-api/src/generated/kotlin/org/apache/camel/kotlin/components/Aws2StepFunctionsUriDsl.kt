 ...
 */
public fun UriDsl.`aws2-step-functions`(i: Aws2StepFunctionsUriDsl.() -> Unit) {
  Aws2StepFunctionsUriDsl(this).apply(i)
}

@CamelDslMarker
public class Aws2StepFunctionsUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("aws2-step-functions")
  }
  ...
  /**
   * The region in which StepFunctions client needs to work. When using this parameter, the
  ...
  /**
   * Set whether the StepFunctions client should expect to load credentials through a default
  ...
  /**
   * Set whether the StepFunctions client should expect to load credentials through a profile
   ...
   */
  public fun awsSfnClient(awsSfnClient: String) {
    it.property("awsSfnClient", awsSfnClient)
  }
  ...
  /**
   * Set whether the Step Functions client should expect to use Session Credentials. This is useful
   * in a situation in which the user needs to assume an IAM role for doing operations in Step
   * Functions.
   */
