...
public fun UriDsl.`openstack-swift`(i: OpenstackSwiftUriDsl.() -> Unit) {
  OpenstackSwiftUriDsl(this).apply(i)
}

@CamelDslMarker
public class OpenstackSwiftUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("openstack-swift")
  }
