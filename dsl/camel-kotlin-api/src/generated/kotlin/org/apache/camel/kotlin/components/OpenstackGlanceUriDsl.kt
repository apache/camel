...
public fun UriDsl.`openstack-glance`(i: OpenstackGlanceUriDsl.() -> Unit) {
  OpenstackGlanceUriDsl(this).apply(i)
}

@CamelDslMarker
public class OpenstackGlanceUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("openstack-glance")
  }
