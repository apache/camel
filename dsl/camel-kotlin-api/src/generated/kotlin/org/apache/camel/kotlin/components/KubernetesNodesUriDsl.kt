...
public fun UriDsl.`kubernetes-nodes`(i: KubernetesNodesUriDsl.() -> Unit) {
  KubernetesNodesUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesNodesUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-nodes")
  }
