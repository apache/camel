...
public class AwsBedrockAgentRuntimeUriDsl(
  ...
  /**
   * The region in which Bedrock Agent Runtime client needs to work. When using this parameter, the
  ...
  /**
   * Set whether the Bedrock Agent Runtime client should expect to load credentials through a
  ...
  /**
   * Set whether the Bedrock Agent Runtime client should expect to use Session Credentials. This is
   * useful in a situation in which the user needs to assume an IAM role for doing operations in
   * Bedrock.
   */
