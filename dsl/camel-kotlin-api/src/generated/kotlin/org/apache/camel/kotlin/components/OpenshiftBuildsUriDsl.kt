...
public fun UriDsl.`openshift-builds`(i: OpenshiftBuildsUriDsl.() -> Unit) {
  OpenshiftBuildsUriDsl(this).apply(i)
}

@CamelDslMarker
public class OpenshiftBuildsUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("openshift-builds")
  }
