 ...
 */
public fun UriDsl.`hazelcast-multimap`(i: HazelcastMultimapUriDsl.() -> Unit) {
  HazelcastMultimapUriDsl(this).apply(i)
}

@CamelDslMarker
public class HazelcastMultimapUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("hazelcast-multimap")
  }
