...
public fun UriDsl.`kubernetes-pods`(i: KubernetesPodsUriDsl.() -> Unit) {
  KubernetesPodsUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesPodsUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-pods")
  }
