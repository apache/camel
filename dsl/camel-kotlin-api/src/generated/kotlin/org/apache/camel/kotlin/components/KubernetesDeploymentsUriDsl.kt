...
public fun UriDsl.`kubernetes-deployments`(i: KubernetesDeploymentsUriDsl.() -> Unit) {
  KubernetesDeploymentsUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesDeploymentsUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-deployments")
  }
