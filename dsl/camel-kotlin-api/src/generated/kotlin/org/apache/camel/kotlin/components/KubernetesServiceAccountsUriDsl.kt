...
public fun UriDsl.`kubernetes-service-accounts`(i: KubernetesServiceAccountsUriDsl.() -> Unit) {
  KubernetesServiceAccountsUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesServiceAccountsUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-service-accounts")
  }
