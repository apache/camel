...
public fun UriDsl.`kubernetes-secrets`(i: KubernetesSecretsUriDsl.() -> Unit) {
  KubernetesSecretsUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesSecretsUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-secrets")
  }
