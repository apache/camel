 ...
 */
public fun UriDsl.`kubernetes-config-maps`(i: KubernetesConfigMapsUriDsl.() -> Unit) {
  KubernetesConfigMapsUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesConfigMapsUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-config-maps")
  }
