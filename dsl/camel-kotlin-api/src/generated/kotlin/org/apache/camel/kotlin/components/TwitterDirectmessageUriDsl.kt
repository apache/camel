...
public fun UriDsl.`twitter-directmessage`(i: TwitterDirectmessageUriDsl.() -> Unit) {
  TwitterDirectmessageUriDsl(this).apply(i)
}

@CamelDslMarker
public class TwitterDirectmessageUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("twitter-directmessage")
  }
