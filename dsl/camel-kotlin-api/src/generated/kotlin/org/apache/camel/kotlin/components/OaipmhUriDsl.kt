 ...
 */
public fun UriDsl.oaipmh(i: OaipmhUriDsl.() -> Unit) {
  OaipmhUriDsl(this).apply(i)
}

@CamelDslMarker
public class OaipmhUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("oaipmh")
  }

  private var baseUrl: String = ""

  /**
   * Base URL of the repository to which the request is made through the OAI-PMH protocol
   */
  ...
  public fun identifier(identifier: String) {
    it.property("identifier", identifier)
  }

  /**
   * Specifies the metadataPrefix of the format that should be included in the metadata part of the
   * returned records.
   */
  public fun metadataPrefix(metadataPrefix: String) {
    it.property("metadataPrefix", metadataPrefix)
  }

  /**
   * Specifies membership as a criteria for set-based selective harvesting
   */
  public fun `set`(`set`: String) {
    it.property("set", set)
  }
   ...
   */
  public fun until(until: String) {
    it.property("until", until)
  }

  /**
   * Request name supported by OAI-PMh protocol
   */
  public fun verb(verb: String) {
    it.property("verb", verb)
  }
  ...
  /**
   * Returns the response of a single request. Otherwise it will make requests until there is no
   * more data to return.
   */
  public fun onlyFirst(onlyFirst: String) {
    it.property("onlyFirst", onlyFirst)
  }
   ...
   * more data to return.
   */
  public fun onlyFirst(onlyFirst: Boolean) {
    it.property("onlyFirst", onlyFirst.toString())
  }
   ...
   */
  public fun ignoreSSLWarnings(ignoreSSLWarnings: String) {
    it.property("ignoreSSLWarnings", ignoreSSLWarnings)
  }

  /**
   * Ignore SSL certificate warnings
   */
  public fun ignoreSSLWarnings(ignoreSSLWarnings: Boolean) {
    it.property("ignoreSSLWarnings", ignoreSSLWarnings.toString())
  }
