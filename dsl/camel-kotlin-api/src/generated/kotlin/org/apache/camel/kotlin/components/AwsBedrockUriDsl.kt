...
public class AwsBedrockUriDsl(
  ...
  /**
   * The region in which Bedrock client needs to work. When using this parameter, the configuration
  ...
  /**
   * Set whether the Bedrock client should expect to load credentials through a default credentials
  ...
  /**
   * Set whether the Bedrock client should expect to load credentials through a profile credentials
   * provider.
   */
  ...
  /**
   * Set whether the Bedrock client should expect to use Session Credentials. This is useful in a
