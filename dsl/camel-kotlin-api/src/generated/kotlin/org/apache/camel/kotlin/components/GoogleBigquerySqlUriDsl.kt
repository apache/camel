...
public fun UriDsl.`google-bigquery-sql`(i: GoogleBigquerySqlUriDsl.() -> Unit) {
  GoogleBigquerySqlUriDsl(this).apply(i)
}

@CamelDslMarker
public class GoogleBigquerySqlUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("google-bigquery-sql")
  }
