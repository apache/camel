...
public fun UriDsl.`hazelcast-topic`(i: HazelcastTopicUriDsl.() -> Unit) {
  HazelcastTopicUriDsl(this).apply(i)
}

@CamelDslMarker
public class HazelcastTopicUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("hazelcast-topic")
  }
  ...
  public fun reliable(reliable: String) {
    it.property("reliable", reliable)
  }

  public fun reliable(reliable: Boolean) {
    it.property("reliable", reliable.toString())
  }
