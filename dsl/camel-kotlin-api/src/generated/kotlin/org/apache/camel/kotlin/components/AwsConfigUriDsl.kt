 ...
 */
public fun UriDsl.`aws-config`(i: AwsConfigUriDsl.() -> Unit) {
  AwsConfigUriDsl(this).apply(i)
}

@CamelDslMarker
public class AwsConfigUriDsl(
  it: UriDsl,
) {
  ...
  /**
   * The region in which the Config client needs to work. When using this parameter, the
   ...
   */
  public fun configClient(configClient: String) {
    it.property("configClient", configClient)
  }
  ...
  /**
   * Set whether the Config client should expect to load credentials through a default credentials
  ...
  /**
   * Set whether the Config client should expect to load credentials through a profile credentials
   * provider.
   */
  ...
  /**
   * Set whether the Config client should expect to use Session Credentials. This is useful in a
   * situation in which the user needs to assume an IAM role for doing operations in Config.
   */
