...
/**
 * Perform operations on Kubernetes Persistent Volumes and get notified on Persistent Volume
 * changes.
 */
public fun UriDsl.`kubernetes-persistent-volumes`(i: KubernetesPersistentVolumesUriDsl.() -> Unit) {
  KubernetesPersistentVolumesUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesPersistentVolumesUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-persistent-volumes")
  }
