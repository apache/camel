...
public fun UriDsl.`hazelcast-replicatedmap`(i: HazelcastReplicatedmapUriDsl.() -> Unit) {
  HazelcastReplicatedmapUriDsl(this).apply(i)
}

@CamelDslMarker
public class HazelcastReplicatedmapUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("hazelcast-replicatedmap")
  }
