 ...
 */
public fun UriDsl.scheduler(i: SchedulerUriDsl.() -> Unit) {
  SchedulerUriDsl(this).apply(i)
}

@CamelDslMarker
public class SchedulerUriDsl(
  it: UriDsl,
) {
  ...
  /**
   * Number of core threads in the thread pool used by the scheduling thread pool. Is by default
