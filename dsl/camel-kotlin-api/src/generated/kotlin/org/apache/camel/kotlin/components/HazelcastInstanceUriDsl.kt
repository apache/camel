...
public fun UriDsl.`hazelcast-instance`(i: HazelcastInstanceUriDsl.() -> Unit) {
  HazelcastInstanceUriDsl(this).apply(i)
}

@CamelDslMarker
public class HazelcastInstanceUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("hazelcast-instance")
  }
