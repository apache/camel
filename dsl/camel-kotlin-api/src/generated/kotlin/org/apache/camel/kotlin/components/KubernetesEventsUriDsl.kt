...
public fun UriDsl.`kubernetes-events`(i: KubernetesEventsUriDsl.() -> Unit) {
  KubernetesEventsUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesEventsUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-events")
  }
