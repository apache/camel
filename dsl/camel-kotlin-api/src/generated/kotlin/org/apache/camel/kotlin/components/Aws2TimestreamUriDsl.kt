...
public class Aws2TimestreamUriDsl(
  ...
  /**
   * The region in which the Timestream client needs to work. When using this parameter, the
  ...
  /**
   * Set whether the Timestream client should expect to load credentials through a default
  ...
  /**
   * Set whether the Timestream client should expect to load credentials through a profile
