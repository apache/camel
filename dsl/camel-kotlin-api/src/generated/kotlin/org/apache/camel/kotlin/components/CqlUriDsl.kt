...
/**
 * Integrate with Cassandra 2.0 using the CQL3 API (not the Thrift API). Based on Cassandra Java
 * Driver provided by DataStax.
 */
public fun UriDsl.cql(i: CqlUriDsl.() -> Unit) {
  CqlUriDsl(this).apply(i)
}

@CamelDslMarker
public class CqlUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("cql")
  }

  private var beanRef: String = ""
   ...
   */
  public fun beanRef(beanRef: String) {
    this.beanRef = beanRef
    it.url("$beanRef:$hosts:$port/$keyspace")
  }
   ...
   * Keyspace to use
   */
  public fun keyspace(keyspace: String) {
  ...
  public fun clusterName(clusterName: String) {
    it.property("clusterName", clusterName)
  }
  ...
  public fun prepareStatements(prepareStatements: String) {
    it.property("prepareStatements", prepareStatements)
  }
