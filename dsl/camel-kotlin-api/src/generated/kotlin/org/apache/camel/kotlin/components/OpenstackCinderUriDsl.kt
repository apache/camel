...
public fun UriDsl.`openstack-cinder`(i: OpenstackCinderUriDsl.() -> Unit) {
  OpenstackCinderUriDsl(this).apply(i)
}

@CamelDslMarker
public class OpenstackCinderUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("openstack-cinder")
  }
