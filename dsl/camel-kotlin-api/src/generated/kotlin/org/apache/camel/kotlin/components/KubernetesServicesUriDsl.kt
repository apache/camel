...
public fun UriDsl.`kubernetes-services`(i: KubernetesServicesUriDsl.() -> Unit) {
  KubernetesServicesUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesServicesUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-services")
  }
