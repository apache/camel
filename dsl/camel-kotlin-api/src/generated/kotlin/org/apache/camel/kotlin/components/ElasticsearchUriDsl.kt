 ...
 */
public fun UriDsl.elasticsearch(i: ElasticsearchUriDsl.() -> Unit) {
  ElasticsearchUriDsl(this).apply(i)
}

@CamelDslMarker
public class ElasticsearchUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("elasticsearch")
  }
  ...
  /**
   * Indicates whether the body of the message contains only documents. By default, it is set to
