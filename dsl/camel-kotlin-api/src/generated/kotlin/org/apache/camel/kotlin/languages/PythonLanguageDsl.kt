...
public fun python(python: String, i: PythonLanguageDsl.() -> Unit = {}): PythonExpression {
  val def = PythonExpression(python)
  PythonLanguageDsl(def).apply(i)
  return def
}

@CamelDslMarker
public class PythonLanguageDsl(
  def: PythonExpression,
) {
  public val def: PythonExpression
