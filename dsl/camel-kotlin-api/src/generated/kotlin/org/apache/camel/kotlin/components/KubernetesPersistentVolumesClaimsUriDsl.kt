...
/**
 * Perform operations on Kubernetes Persistent Volumes Claims and get notified on Persistent Volumes
 * Claim changes.
 */
public
    fun UriDsl.`kubernetes-persistent-volumes-claims`(i: KubernetesPersistentVolumesClaimsUriDsl.() -> Unit) {
  KubernetesPersistentVolumesClaimsUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesPersistentVolumesClaimsUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-persistent-volumes-claims")
  }
