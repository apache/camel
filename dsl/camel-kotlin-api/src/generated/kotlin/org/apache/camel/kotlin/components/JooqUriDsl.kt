...
public fun UriDsl.jooq(i: JooqUriDsl.() -> Unit) {
  JooqUriDsl(this).apply(i)
}

@CamelDslMarker
public class JooqUriDsl(
  it: UriDsl,
) {
  ...
  public fun databaseConfiguration(databaseConfiguration: String) {
    it.property("databaseConfiguration", databaseConfiguration)
  }
