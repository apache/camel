...
public fun UriDsl.`hazelcast-list`(i: HazelcastListUriDsl.() -> Unit) {
  HazelcastListUriDsl(this).apply(i)
}

@CamelDslMarker
public class HazelcastListUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("hazelcast-list")
  }
