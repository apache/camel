 ...
 */
public fun UriDsl.`aws2-sts`(i: Aws2StsUriDsl.() -> Unit) {
  Aws2StsUriDsl(this).apply(i)
}

@CamelDslMarker
public class Aws2StsUriDsl(
  it: UriDsl,
) {
  ...
  /**
   * The region in which the STS client needs to work. When using this parameter, the configuration
   ...
   */
  public fun stsClient(stsClient: String) {
    it.property("stsClient", stsClient)
  }
  ...
  /**
   * Set whether the STS client should expect to load credentials through a default credentials
  ...
  /**
   * Set whether the STS client should expect to load credentials through a profile credentials
   * provider.
   */
