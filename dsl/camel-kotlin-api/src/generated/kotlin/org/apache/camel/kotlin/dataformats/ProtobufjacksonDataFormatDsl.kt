...
public fun DataFormatDsl.protobufJackson(i: ProtobufjacksonDataFormatDsl.() -> Unit) {
  def = ProtobufjacksonDataFormatDsl().apply(i).def
}

@CamelDslMarker
public class ProtobufjacksonDataFormatDsl {
