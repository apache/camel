...
/**
 * Perform operations on Kubernetes Horizontal Pod Autoscalers (HPA) and get notified on HPA
 * changes.
 */
public fun UriDsl.`kubernetes-hpa`(i: KubernetesHpaUriDsl.() -> Unit) {
  KubernetesHpaUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesHpaUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-hpa")
  }
