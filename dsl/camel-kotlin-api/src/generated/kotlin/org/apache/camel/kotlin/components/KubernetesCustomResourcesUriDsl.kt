...
public fun UriDsl.`kubernetes-custom-resources`(i: KubernetesCustomResourcesUriDsl.() -> Unit) {
  KubernetesCustomResourcesUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesCustomResourcesUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-custom-resources")
  }
