...
public fun UriDsl.`kubernetes-namespaces`(i: KubernetesNamespacesUriDsl.() -> Unit) {
  KubernetesNamespacesUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesNamespacesUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-namespaces")
  }
