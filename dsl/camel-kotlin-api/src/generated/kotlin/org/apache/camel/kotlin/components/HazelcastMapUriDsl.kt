...
public fun UriDsl.`hazelcast-map`(i: HazelcastMapUriDsl.() -> Unit) {
  HazelcastMapUriDsl(this).apply(i)
}

@CamelDslMarker
public class HazelcastMapUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("hazelcast-map")
  }
