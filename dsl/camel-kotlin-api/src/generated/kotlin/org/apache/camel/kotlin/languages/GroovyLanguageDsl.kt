...
public fun groovy(groovy: String, i: GroovyLanguageDsl.() -> Unit = {}): GroovyExpression {
  val def = GroovyExpression(groovy)
  GroovyLanguageDsl(def).apply(i)
  return def
}

@CamelDslMarker
public class GroovyLanguageDsl(
  def: GroovyExpression,
) {
  public val def: GroovyExpression
