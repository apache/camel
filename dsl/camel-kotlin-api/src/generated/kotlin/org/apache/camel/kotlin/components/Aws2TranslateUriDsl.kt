 ...
 */
public fun UriDsl.`aws2-translate`(i: Aws2TranslateUriDsl.() -> Unit) {
  Aws2TranslateUriDsl(this).apply(i)
}

@CamelDslMarker
public class Aws2TranslateUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("aws2-translate")
  }
   ...
   */
  public fun autodetectSourceLanguage(autodetectSourceLanguage: String) {
    it.property("autodetectSourceLanguage", autodetectSourceLanguage)
  }

  /**
   * Being able to autodetect the source language
   */
  public fun autodetectSourceLanguage(autodetectSourceLanguage: Boolean) {
    it.property("autodetectSourceLanguage", autodetectSourceLanguage.toString())
  }
  ...
  /**
   * The region in which the Translate client needs to work. When using this parameter, the
   ...
   */
  public fun sourceLanguage(sourceLanguage: String) {
    it.property("sourceLanguage", sourceLanguage)
  }

  /**
   * Target language to use
   */
  public fun targetLanguage(targetLanguage: String) {
    it.property("targetLanguage", targetLanguage)
  }
   ...
   */
  public fun translateClient(translateClient: String) {
    it.property("translateClient", translateClient)
  }
  ...
  /**
   * Set whether the Translate client should expect to load credentials through a profile
  ...
  /**
   * Set whether the Translate client should expect to use Session Credentials. This is useful in a
   * situation in which the user needs to assume an IAM role for doing operations in Translate.
   */
