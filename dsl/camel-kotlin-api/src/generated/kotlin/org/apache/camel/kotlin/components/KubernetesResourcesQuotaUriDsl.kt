...
public fun UriDsl.`kubernetes-resources-quota`(i: KubernetesResourcesQuotaUriDsl.() -> Unit) {
  KubernetesResourcesQuotaUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesResourcesQuotaUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-resources-quota")
  }
