...
/**
 * Marshal and unmarshal Java objects from and to CSV (Comma Separated Values) using UniVocity
 * Parsers.
 */
public fun DataFormatDsl.univocityCsv(i: UnivocityCsvDataFormatDsl.() -> Unit) {
  def = UnivocityCsvDataFormatDsl().apply(i).def
}

@CamelDslMarker
public class UnivocityCsvDataFormatDsl {
  public val def: UniVocityCsvDataFormat

  init {
    def = UniVocityCsvDataFormat()}
   ...
   */
  public fun quoteAllFields(quoteAllFields: Boolean) {
    def.quoteAllFields = quoteAllFields.toString()
  }

  /**
   * Whether or not all values must be quoted when writing them.
   */
  public fun quoteAllFields(quoteAllFields: String) {
    def.quoteAllFields = quoteAllFields
  }
   ...
   */
  public fun quoteEscape(quoteEscape: String) {
    def.quoteEscape = quoteEscape
  }
