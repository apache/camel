 ...
 */
public fun UriDsl.flatpack(i: FlatpackUriDsl.() -> Unit) {
  FlatpackUriDsl(this).apply(i)
}

@CamelDslMarker
public class FlatpackUriDsl(
  it: UriDsl,
) {
  ...
  public fun allowShortLines(allowShortLines: String) {
    it.property("allowShortLines", allowShortLines)
  }
  ...
  public fun allowShortLines(allowShortLines: Boolean) {
    it.property("allowShortLines", allowShortLines.toString())
  }
  ...
  public fun ignoreExtraColumns(ignoreExtraColumns: String) {
    it.property("ignoreExtraColumns", ignoreExtraColumns)
  }
  ...
  public fun ignoreExtraColumns(ignoreExtraColumns: Boolean) {
    it.property("ignoreExtraColumns", ignoreExtraColumns.toString())
  }
  ...
  public fun ignoreFirstRecord(ignoreFirstRecord: String) {
    it.property("ignoreFirstRecord", ignoreFirstRecord)
  }
  ...
  public fun ignoreFirstRecord(ignoreFirstRecord: Boolean) {
    it.property("ignoreFirstRecord", ignoreFirstRecord.toString())
  }

  /**
   * Sets the Component to send each row as a separate exchange once parsed
   */
  public fun splitRows(splitRows: String) {
    it.property("splitRows", splitRows)
  }

  /**
   * Sets the Component to send each row as a separate exchange once parsed
   */
  public fun splitRows(splitRows: Boolean) {
    it.property("splitRows", splitRows.toString())
  }
  ...
  public fun textQualifier(textQualifier: String) {
    it.property("textQualifier", textQualifier)
  }
