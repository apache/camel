...
public fun js(js: String, i: JsLanguageDsl.() -> Unit = {}): JavaScriptExpression {
  val def = JavaScriptExpression(js)
  JsLanguageDsl(def).apply(i)
  return def
}

@CamelDslMarker
public class JsLanguageDsl(
  def: JavaScriptExpression,
) {
  public val def: JavaScriptExpression
