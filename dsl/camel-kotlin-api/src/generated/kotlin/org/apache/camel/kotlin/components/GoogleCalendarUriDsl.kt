...
public fun UriDsl.`google-calendar`(i: GoogleCalendarUriDsl.() -> Unit) {
  GoogleCalendarUriDsl(this).apply(i)
}

@CamelDslMarker
public class GoogleCalendarUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("google-calendar")
  }
