...
public fun UriDsl.`kubernetes-job`(i: KubernetesJobUriDsl.() -> Unit) {
  KubernetesJobUriDsl(this).apply(i)
}

@CamelDslMarker
public class KubernetesJobUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("kubernetes-job")
  }
