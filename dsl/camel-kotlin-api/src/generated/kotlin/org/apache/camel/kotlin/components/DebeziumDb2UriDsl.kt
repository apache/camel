...
public class DebeziumDb2UriDsl(
   ...
   * uses the default JDBC fetch size. The default value is '10000'.
   */
  ...
  /**
   * The criteria for running a snapshot upon startup of the connector. Options include: 'initial'
   * (the default) to specify the connector should run a snapshot only when no offsets are available
   * for the logical server name; 'schema_only' to specify the connector should run a snapshot of the
