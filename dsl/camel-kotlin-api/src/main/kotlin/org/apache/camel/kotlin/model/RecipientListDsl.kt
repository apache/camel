...
class RecipientListDsl(
    ...
    fun ignoreInvalidEndpoints(ignoreInvalidEndpoints: Boolean) {
        def.ignoreInvalidEndpoints = ignoreInvalidEndpoints.toString()
    }

    fun ignoreInvalidEndpoints(ignoreInvalidEndpoints: String) {
        def.ignoreInvalidEndpoints = ignoreInvalidEndpoints
    }
