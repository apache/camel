...
@Command(
        name = "properties",
        description = "List configuration properties",
        sortOptions = false,
...
public class ListProperties extends ProcessWatchCommand {
    ...
    @CommandLine.Option(
            names = {"--startup"},
            description = "List only startup configuration")
    boolean startup;

    @CommandLine.Option(
            names = {"--verbose"},
            description = "Whether to include more details")
    boolean verbose;

    @CommandLine.Option(
            names = {"--internal"},
            description = "Whether to include internal configuration")
    boolean internal;

    @CommandLine.Option(
            names = {"--mask"},
            description =
                    "Whether to mask configuration values to avoid printing sensitive information such as password or access keys",
            defaultValue = "true")
    boolean mask = true;
