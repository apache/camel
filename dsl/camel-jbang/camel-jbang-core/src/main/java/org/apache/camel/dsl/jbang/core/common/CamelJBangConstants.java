...
public final class CamelJBangConstants {
    ...
    @Metadata(
            description = "Additional files to add to classpath (Use commas to separate multiple files).",
            javaType = "String")
    public static final String CLASSPATH_FILES = "camel.jbang.classpathFiles";

    @Metadata(description = "Local file directory for loading custom Kamelets", javaType = "String")
    public static final String LOCAL_KAMELET_DIR = "camel.jbang.localKameletDir";

    @Metadata(
            description =
                    "Additional groovy source files to export to src/main/resources/camel-groovy directory (Use commas to separate multiple files)",
            javaType = "String")
    public static final String GROOVY_FILES = "camel.jbang.groovyFiles";

    @Metadata(
            description = "Additional shell script files to export to src/main/scripts directory",
            javaType = "String")
    public static final String SCRIPT_FILES = "camel.jbang.scriptFiles";

    @Metadata(description = "Additional SSL/TLS files to export to src/main/tls directory", javaType = "String")
    public static final String TLS_FILES = "camel.jbang.tlsFiles";

    @Metadata(
            description =
                    "Resource YAML fragments for Kubernetes using Eclipse JKube tool (Use commas to separate multiple files).",
            javaType = "String",
            label = "kubernetes")
    public static final String JKUBE_FILES = "camel.jbang.jkubeFiles";

    @Metadata(
            description = "Which runtime to use (camel-main, spring-boot, quarkus)",
            javaType = "String",
            enums = "camel-main,spring-boot,quarkus")
    public static final String RUNTIME = "camel.jbang.runtime";

    @Metadata(description = "Maven coordinate (groupId:artifactId:version)", javaType = "String")
    public static final String GAV = "camel.jbang.gav";

    @Metadata(description = "Java version (17 or 21)", javaType = "String", enums = "17,21", defaultValue = "21")
    public static final String JAVA_VERSION = "camel.jbang.javaVersion";

    @Metadata(
            description = "Apache Camel Kamelets version. By default the Kamelets are the same version as Camel.",
            javaType = "String")
    public static final String KAMELETS_VERSION = "camel.jbang.kameletsVersion";

    @Metadata(description = "Quarkus Platform Maven groupId", javaType = "String", label = "quarkus")
    public static final String QUARKUS_GROUP_ID = "camel.jbang.quarkusGroupId";

    @Metadata(description = "Quarkus Platform Maven artifactId", javaType = "String", label = "quarkus")
    public static final String QUARKUS_ARTIFACT_ID = "camel.jbang.quarkusArtifactId";

    @Metadata(description = "Quarkus Platform version", javaType = "String", label = "quarkus")
    public static final String QUARKUS_VERSION = "camel.jbang.quarkusVersion";

    @Metadata(description = "Spring Boot version", javaType = "String", label = "spring-boot")
    public static final String SPRING_BOOT_VERSION = "camel.jbang.springBootVersion";

    @Metadata(
            description = "Include Maven Wrapper files in the exported project",
            javaType = "boolean",
            defaultValue = "true")
    public static final String MAVEN_WRAPPER = "camel.jbang.mavenWrapper";

    @Metadata(
            description = "Include Gradle Wrapper files in the exported project",
            javaType = "boolean",
            defaultValue = "true")
    public static final String GRADLE_WRAPPER = "camel.jbang.gradleWrapper";

    @Metadata(description = "Build tool to use (Maven or Gradle)", javaType = "String", defaultValue = "Maven")
    public static final String BUILD_TOOL = "camel.jbang.buildTool";

    @Metadata(description = "Directory where the project will be exported", javaType = "String", defaultValue = ".")
    public static final String EXPORT_DIR = "camel.jbang.exportDir";

    @Metadata(
            description =
                    "File name of open-api spec file (JSON or YAML) to generate routes from the swagger/openapi API spec file.",
            javaType = "String")
    ...
    @Metadata(
            description =
                    "Optional location of Maven settings-security.xml file to decrypt Maven Settings (settings.xml) file",
            javaType = "String",
            label = "maven")
    ...
    @Metadata(
            description = "Exclude files by name or pattern (Use commas to separate multiple files)",
            javaType = "String")
    public static final String EXCLUDES = "camel.jbang.excludes";

    @Metadata(
            description = "Additional dependencies (Use commas to separate multiple dependencies).",
            javaType = "String")
    ...
    @Metadata(
            description =
                    "Version to use for jkube-maven-plugin if exporting to camel-main and have Kubernetes enabled (jkube.xxx options)",
            javaType = "String",
            defaultValue = "1.18.1",
            label = "kubernetes")
    ...
    @Metadata(
            description =
                    "Stubs all the matching endpoint with the given component name or pattern. Multiple names can be separated by comma. (all = everything).",
            javaType = "String")
    ...
    @Metadata(
            ...
            javaType = "String",
            defaultValue = ".camel-jbang/compile",
            label = "advanced")
    public static final String COMPILE_WORK_DIR = "camel.jbang.compileWorkDir";

    @Deprecated
    @Metadata(
            description = "Health check at /observe/health on local HTTP server (port 8080 by default)",
            javaType = "boolean",
            defaultValue = ".camel-jbang/compile",
    ...
    @Metadata(
            description =
                    "Metrics (Micrometer and Prometheus) at /observe/metrics on local HTTP server (port 8080 by default) when running standalone Camel",
            javaType = "boolean",
            defaultValue = ".camel-jbang/compile",
            deprecationNote = "Deprecated: use observe instead")
    ...
    @Metadata(description = "The version of Apache Camel to use", javaType = "String")
    public static final String CAMEL_VERSION = "camel.jbang.camel-version";

    @Metadata(description = "Enables Java Flight Recorder saving recording to disk on exit", javaType = "boolean")
    ...
    @Metadata(
            description = "To use a custom Camel version when running or export to Spring Boot",
            javaType = "String",
            label = "spring-boot")
