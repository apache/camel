...
public class CamelJBangMain implements Callable<Integer> {
    ...
    public static void run(CamelJBangMain main, String... args) {
        ...
        commandLine = new CommandLine(main)
                ...
                .addSubcommand(
                        "transform",
                        new CommandLine(new TransformCommand(main))
                ...
                .addSubcommand(
                        "get",
                        new CommandLine(new CamelStatus(main))
                                ...
                                .addSubcommand(
                                        "startup-recorder", new CommandLine(new CamelStartupRecorderAction(main)))
                                .addSubcommand("vault", new CommandLine(new ListVault(main))))
                .addSubcommand(
                        "top",
                        new CommandLine(new CamelTop(main))
                ...
                .addSubcommand(
                        "cmd",
                        new CommandLine(new CamelAction(main))
                                ...
                                .addSubcommand(
                                        "enable-processor", new CommandLine(new CamelProcessorEnableAction(main)))
                                .addSubcommand(
                                        "disable-processor", new CommandLine(new CamelProcessorDisableAction(main)))
                ...
                .addSubcommand(
                        "dependency",
                        new CommandLine(new DependencyCommand(main))
                ...
                .addSubcommand(
                        "catalog",
                        new CommandLine(new CatalogCommand(main))
                ...
                .addSubcommand(
                        "plugin",
                        new CommandLine(new PluginCommand(main))
                ...
                .addSubcommand(
                        "version",
                        new CommandLine(new VersionCommand(main))
                ...
                .addSubcommand(
                        "infra",
                        new CommandLine(new InfraCommand(main))
                ...
                .addSubcommand(
                        "update",
                        new CommandLine(new UpdateCommand(main))
