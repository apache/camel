...
class CircuitBreakerTab extends AbstractTableTab {
    ...
    protected void renderContent(Frame frame, Rect area, IntegrationInfo info) {
        ...
        for (CircuitBreakerInfo cb : sorted) {
            ...
            String fallback = cb.fallbackCalls > 0 ? String.valueOf(cb.fallbackCalls) : "";
            String timeout = cb.timedOutCalls > 0 ? String.valueOf(cb.timedOutCalls) : "";
    ...
    private void renderChart(Frame frame, Rect area, CircuitBreakerInfo cb, String pid) {
        ...
        Line metricsLine1 = Line.from(
                ...
                Span.styled("bulkhead:", dim), Span.raw(cb.bulkheadRejectedCalls + " "),
    ...
    public String getHelpText() {
        return DocHelper.loadHelpText("circuit-breaker");
    }
