...
public class batch extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("timer:batch?period=5000")
                ...
                .log("Sending ${body.size()} items for batch processing...")
                .to("batch:orderJob?chunkSize=5&processorRef=direct:processOrder")
                .log("Batch result: ${body}");

        // Process each individual item
        from("direct:processOrder")
                .log("  Processing item ${header.CamelBatchIndex}/${header.CamelBatchSize}: ${body}")
                .delay(100);
    }
}
