...
/**
 * Thrown for any self-update failure that should be reported as a plain, non-stack-trace message and a non-zero exit
 * code -- mirrors {@code install.sh}'s {@code fail()} convention.
 */
