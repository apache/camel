...
```shell
jbang alias add -Dcamel.jbang.version=4.7.0-SNAPSHOT --name camel ./dsl/camel-jbang/camel-jbang-main/dist/CamelJBang.java

jbang camel version  
Camel JBang version: 4.7.0-SNAPSHOT
```
