...
```shell
jbang alias add --name camel -Dcamel.jbang.version=4.23.0-SNAPSHOT ./dsl/camel-jbang/camel-jbang-main/dist/CamelJBang.java

jbang camel version  
Camel CLI version: 4.23.0-SNAPSHOT
```
...
jbang run -Drepos=mavenLocal,central \
    ...
    --deps=org.apache.camel:camel-jbang-core:4.23.0-SNAPSHOT \
    org.apache.camel:camel-jbang-main:4.23.0-SNAPSHOT \
    version
```
