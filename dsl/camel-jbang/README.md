...
```shell
jbang alias add --name camel -Dcamel.jbang.version=4.8.6-SNAPSHOT ./dsl/camel-jbang/camel-jbang-main/dist/CamelJBang.java

jbang camel version  
Camel JBang version: 4.8.6-SNAPSHOT
```
