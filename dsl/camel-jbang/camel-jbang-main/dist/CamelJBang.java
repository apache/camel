...
//DEPS org.apache.camel:camel-bom:3.12.1-SNAPSHOT@pom
...
//DEPS org.apache.camel:camel-jbang-core:3.12.1-SNAPSHOT
...
class SearchComponents extends AbstractSearch implements Callable<Integer> {
    ...
    @Option(names = { "--branch" }, defaultValue = "camel-3.12.1-SNAPSHOT", hidden = true,
...
@Command(name = "CamelJBang", mixinStandardHelpOptions = true, version = "CamelJBang 3.12.1-SNAPSHOT",
