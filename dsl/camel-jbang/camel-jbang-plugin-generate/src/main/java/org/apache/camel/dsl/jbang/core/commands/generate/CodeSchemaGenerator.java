 ...
 *
 * This command downloads the specified Camel component dependencies and generates
...
public class CodeSchemaGenerator extends CamelCommand {
    ...
    private DependencyDownloaderClassLoader getDependencyDownloaderClassLoader(
        ...
        try {
            ...
            if (artifacts == null || artifacts.isEmpty()) {
                printer().printErr("Error: No artifacts found for component 'camel-" + camelComponent + "' version '" + version + "'");
    ...
    private Class<?> loadTargetClass(ClassLoader classLoader, String className) {
        try {
            ...
            printer().printErr("  - Browse the Maven artifact at: https://mvnrepository.com/artifact/org.apache.camel/camel-" + camelComponent);
