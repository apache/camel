...
public class KubernetesExportKnativeTest extends KubernetesExportBaseTest {
    ...
    public void shouldAddKnativeServiceSpec(RuntimeType rt) throws Exception {
        KubernetesExport command = createCommand(
                new String[] {"classpath:route-service.yaml"}, "--image-group=camel-test", "--runtime=" + rt.runtime());
        ...
        Assertions.assertEquals(
                "60", service.getMetadata().getAnnotations().get("serving.knative.dev/rolloutDuration"));
    ...
    public void shouldAddKnativeTrigger(RuntimeType rt) throws Exception {
        KubernetesExport command = createCommand(
                new String[] {"classpath:knative-event-source.yaml"},
                "--image-group=camel-test",
                "--runtime=" + rt.runtime());
        command.traits = new String[] {"knative.enabled=true", "knative.filters=source=my-source"};
        int exit = command.doCall();
        Assertions.assertEquals(0, exit);
        ...
        Assertions.assertEquals(
                "my-broker-knative-event-source-camel-event",
        ...
        Assertions.assertEquals(
                "camel-event", trigger.getSpec().getFilter().getAttributes().get("type"));
        Assertions.assertEquals(
                "my-source", trigger.getSpec().getFilter().getAttributes().get("source"));
        Assertions.assertEquals(
                "knative-event-source",
                trigger.getSpec().getSubscriber().getRef().getName());
        Assertions.assertEquals(
                "Service", trigger.getSpec().getSubscriber().getRef().getKind());
        Assertions.assertEquals("v1", trigger.getSpec().getSubscriber().getRef().getApiVersion());
        Assertions.assertEquals(
                "/events/camel-event", trigger.getSpec().getSubscriber().getUri());

        Properties applicationProperties = getApplicationProperties(workingDir);
        Assertions.assertEquals(
                "classpath:knative.json", applicationProperties.get("camel.component.knative.environmentPath"));
    ...
    public void shouldAddKnativeSubscription(RuntimeType rt) throws Exception {
        KubernetesExport command = createCommand(
                new String[] {"classpath:knative-channel-source.yaml"},
                "--image-group=camel-test",
                "--runtime=" + rt.runtime());
        command.traits = new String[] {"knative.enabled=true"};
        command.doCall();
        ...
        Assertions.assertEquals(
                "my-channel-knative-channel-source", subscription.getMetadata().getName());
        Assertions.assertEquals(
                "my-channel", subscription.getSpec().getChannel().getName());
        Assertions.assertEquals(
                "knative-channel-source",
                subscription.getSpec().getSubscriber().getRef().getName());
        Assertions.assertEquals(
                "Service", subscription.getSpec().getSubscriber().getRef().getKind());
        Assertions.assertEquals(
                "v1", subscription.getSpec().getSubscriber().getRef().getApiVersion());
        Assertions.assertEquals(
                "/channels/my-channel", subscription.getSpec().getSubscriber().getUri());
    ...
    public void shouldAddKnativeBrokerSinkBinding(RuntimeType rt) throws Exception {
        KubernetesExport command = createCommand(
                new String[] {"classpath:knative-event-sink.yaml"},
                "--image-group=camel-test",
                "--runtime=" + rt.runtime());
        ...
        Assertions.assertEquals(
                "my-broker", sinkBinding.getSpec().getSink().getRef().getName());
        Assertions.assertEquals(
                "Broker", sinkBinding.getSpec().getSink().getRef().getKind());
        Assertions.assertEquals(
                "eventing.knative.dev/v1",
                sinkBinding.getSpec().getSink().getRef().getApiVersion());
        Assertions.assertEquals(
                "knative-event-sink", sinkBinding.getSpec().getSubject().getName());
    ...
    public void shouldAddKnativeChannelSinkBinding(RuntimeType rt) throws Exception {
        KubernetesExport command = createCommand(
                new String[] {"classpath:knative-channel-sink.yaml"},
                "--image-group=camel-test",
                "--runtime=" + rt.runtime());
        ...
        Assertions.assertEquals(
                "knative-channel-sink", sinkBinding.getMetadata().getName());
        Assertions.assertEquals(
                "my-channel", sinkBinding.getSpec().getSink().getRef().getName());
        Assertions.assertEquals(
                "Channel", sinkBinding.getSpec().getSink().getRef().getKind());
        Assertions.assertEquals(
                "messaging.knative.dev/v1",
                sinkBinding.getSpec().getSink().getRef().getApiVersion());
        Assertions.assertEquals(
                "knative-channel-sink", sinkBinding.getSpec().getSubject().getName());
        Assertions.assertEquals("Deployment", sinkBinding.getSpec().getSubject().getKind());
        Assertions.assertEquals("apps/v1", sinkBinding.getSpec().getSubject().getApiVersion());
    ...
    public void shouldAddKnativeEndpointSinkBinding(RuntimeType rt) throws Exception {
        KubernetesExport command = createCommand(
                new String[] {"classpath:knative-endpoint-sink.yaml"},
                "--image-group=camel-test",
                "--runtime=" + rt.runtime());
        command.traits = new String[] {"knative.enabled=true"};
        command.doCall();
        ...
        Assertions.assertEquals(
                "knative-endpoint-sink", sinkBinding.getMetadata().getName());
        Assertions.assertEquals(
                "my-endpoint", sinkBinding.getSpec().getSink().getRef().getName());
        Assertions.assertEquals(
                "Service", sinkBinding.getSpec().getSink().getRef().getKind());
        Assertions.assertEquals(
                "serving.knative.dev/v1",
                sinkBinding.getSpec().getSink().getRef().getApiVersion());
        Assertions.assertEquals(
                "knative-endpoint-sink", sinkBinding.getSpec().getSubject().getName());
        Assertions.assertEquals("Deployment", sinkBinding.getSpec().getSubject().getKind());
        Assertions.assertEquals("apps/v1", sinkBinding.getSpec().getSubject().getApiVersion());
