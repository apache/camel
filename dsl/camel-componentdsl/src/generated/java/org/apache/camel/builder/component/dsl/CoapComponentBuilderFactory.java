...
public interface CoapComponentBuilderFactory {
    ...
    interface CoapComponentBuilder extends ComponentBuilder<CoAPComponent> {
         ...
         * @return the dsl builder
         */
        default CoapComponentBuilder configurationFile(java.lang.String configurationFile) {
         ...
         * @return the dsl builder
         */
        default CoapComponentBuilder client(org.eclipse.californium.core.CoapClient client) {
