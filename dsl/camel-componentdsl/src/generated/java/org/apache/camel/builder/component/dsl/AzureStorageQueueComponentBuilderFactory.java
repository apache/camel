...
public interface AzureStorageQueueComponentBuilderFactory {
     ...
     */
    interface AzureStorageQueueComponentBuilder extends ComponentBuilder<QueueComponent> {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder configuration(org.apache.camel.component.azure.storage.queue.QueueConfiguration configuration) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder serviceClient(com.azure.storage.queue.QueueServiceClient serviceClient) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder createQueue(boolean createQueue) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder operation(org.apache.camel.component.azure.storage.queue.QueueOperationDefinition operation) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder maxMessages(java.lang.Integer maxMessages) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder messageId(java.lang.String messageId) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder popReceipt(java.lang.String popReceipt) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder timeout(java.time.Duration timeout) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder timeToLive(java.time.Duration timeToLive) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder visibilityTimeout(java.time.Duration visibilityTimeout) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder accessKey(java.lang.String accessKey) {
         ...
         * @return the dsl builder
         */
        default AzureStorageQueueComponentBuilder credentials(com.azure.storage.common.StorageSharedKeyCredential credentials) {
    ...
    class AzureStorageQueueComponentBuilderImpl
        ...
        private org.apache.camel.component.azure.storage.queue.QueueConfiguration getOrCreateConfiguration(QueueComponent component) {
