...
public interface CaffeineCacheComponentBuilderFactory {
     ...
     */
    interface CaffeineCacheComponentBuilder extends ComponentBuilder<CaffeineCacheComponent> {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheComponentBuilder createCacheIfNotExist(boolean createCacheIfNotExist) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheComponentBuilder evictionType(org.apache.camel.component.caffeine.EvictionType evictionType) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheComponentBuilder expireAfterAccessTime(int expireAfterAccessTime) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheComponentBuilder expireAfterWriteTime(int expireAfterWriteTime) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheComponentBuilder initialCapacity(java.lang.Integer initialCapacity) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheComponentBuilder maximumSize(java.lang.Integer maximumSize) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheComponentBuilder cacheLoader(com.github.benmanes.caffeine.cache.CacheLoader cacheLoader) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheComponentBuilder configuration(org.apache.camel.component.caffeine.CaffeineConfiguration configuration) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheComponentBuilder removalListener(com.github.benmanes.caffeine.cache.RemovalListener removalListener) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheComponentBuilder statsCounter(com.github.benmanes.caffeine.cache.stats.StatsCounter statsCounter) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheComponentBuilder valueType(java.lang.String valueType) {
    ...
    class CaffeineCacheComponentBuilderImpl
        ...
        private org.apache.camel.component.caffeine.CaffeineConfiguration getOrCreateConfiguration(CaffeineCacheComponent component) {
