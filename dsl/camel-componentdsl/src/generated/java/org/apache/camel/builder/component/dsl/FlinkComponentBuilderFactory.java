...
public interface FlinkComponentBuilderFactory {
    ...
    interface FlinkComponentBuilder extends ComponentBuilder<FlinkComponent> {
         ...
         * @return the dsl builder
         */
        default FlinkComponentBuilder dataStream(org.apache.flink.streaming.api.datastream.DataStream dataStream) {
         ...
         * @return the dsl builder
         */
        default FlinkComponentBuilder dataStreamCallback(org.apache.camel.component.flink.DataStreamCallback dataStreamCallback) {
         ...
         * @return the dsl builder
         */
        default FlinkComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
    ...
    class FlinkComponentBuilderImpl
            extends AbstractComponentBuilder<FlinkComponent>
            implements FlinkComponentBuilder {
        @Override
