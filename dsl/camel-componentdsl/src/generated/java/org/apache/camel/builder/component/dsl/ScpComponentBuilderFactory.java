...
public interface ScpComponentBuilderFactory {
    ...
    interface ScpComponentBuilder extends ComponentBuilder<ScpComponent> {
         ...
         * @return the dsl builder
         */
        default ScpComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default ScpComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
    ...
    class ScpComponentBuilderImpl
            extends AbstractComponentBuilder<ScpComponent>
            implements ScpComponentBuilder {
        @Override
