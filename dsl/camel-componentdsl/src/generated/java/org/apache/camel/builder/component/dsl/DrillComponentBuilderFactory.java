...
public interface DrillComponentBuilderFactory {
    ...
    interface DrillComponentBuilder extends ComponentBuilder<DrillComponent> {
         ...
         * @return the dsl builder
         */
        default DrillComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
    ...
    class DrillComponentBuilderImpl
            extends AbstractComponentBuilder<DrillComponent>
            implements DrillComponentBuilder {
        @Override
