...
public interface VertxComponentBuilderFactory {
    ...
    interface VertxComponentBuilder extends ComponentBuilder<VertxComponent> {
         ...
         * @return the dsl builder
         */
        default VertxComponentBuilder vertxOptions(io.vertx.core.VertxOptions vertxOptions) {
         ...
         * @return the dsl builder
         */
        default VertxComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default VertxComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
