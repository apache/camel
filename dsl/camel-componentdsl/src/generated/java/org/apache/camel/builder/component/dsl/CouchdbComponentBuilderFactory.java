...
public interface CouchdbComponentBuilderFactory {
     ...
     */
    interface CouchdbComponentBuilder extends ComponentBuilder<CouchDbComponent> {
         ...
         * @return the dsl builder
         */
        default CouchdbComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default CouchdbComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default CouchdbComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class CouchdbComponentBuilderImpl
            extends AbstractComponentBuilder<CouchDbComponent>
            implements CouchdbComponentBuilder {
        @Override
