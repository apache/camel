...
public interface MicrometerComponentBuilderFactory {
     ...
     */
    interface MicrometerComponentBuilder extends ComponentBuilder<MicrometerComponent> {
         ...
         * @return the dsl builder
         */
        default MicrometerComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default MicrometerComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default MicrometerComponentBuilder metricsRegistry(io.micrometer.core.instrument.MeterRegistry metricsRegistry) {
    ...
    class MicrometerComponentBuilderImpl
            extends AbstractComponentBuilder<MicrometerComponent>
            implements MicrometerComponentBuilder {
        @Override
