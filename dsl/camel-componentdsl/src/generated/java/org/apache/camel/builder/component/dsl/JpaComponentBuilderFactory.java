...
public interface JpaComponentBuilderFactory {
    ...
    interface JpaComponentBuilder extends ComponentBuilder<JpaComponent> {
         ...
         * @return the dsl builder
         */
        default JpaComponentBuilder aliases(java.util.Map<java.lang.String, java.lang.Class<java.lang.Object>> aliases) {
         ...
         * @return the dsl builder
         */
        default JpaComponentBuilder entityManagerFactory(jakarta.persistence.EntityManagerFactory entityManagerFactory) {
         ...
         * @return the dsl builder
         */
        default JpaComponentBuilder sharedEntityManager(boolean sharedEntityManager) {
         ...
         * @return the dsl builder
         */
        default JpaComponentBuilder transactionStrategy(org.apache.camel.component.jpa.TransactionStrategy transactionStrategy) {
         ...
         * @return the dsl builder
         */
        default JpaComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default JpaComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default JpaComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
    ...
    class JpaComponentBuilderImpl
            extends AbstractComponentBuilder<JpaComponent>
            implements JpaComponentBuilder {
        @Override
