...
public interface ZookeeperComponentBuilderFactory {
     ...
     */
    interface ZookeeperComponentBuilder extends ComponentBuilder<ZooKeeperComponent> {
         ...
         * @return the dsl builder
         */
        default ZookeeperComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default ZookeeperComponentBuilder sendEmptyMessageOnDelete(boolean sendEmptyMessageOnDelete) {
         ...
         * @return the dsl builder
         */
        default ZookeeperComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default ZookeeperComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default ZookeeperComponentBuilder configuration(org.apache.camel.component.zookeeper.ZooKeeperConfiguration configuration) {
    ...
    class ZookeeperComponentBuilderImpl
        ...
        private org.apache.camel.component.zookeeper.ZooKeeperConfiguration getOrCreateConfiguration(ZooKeeperComponent component) {
