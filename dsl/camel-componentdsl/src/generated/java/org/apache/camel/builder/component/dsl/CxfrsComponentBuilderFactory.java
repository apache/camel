...
public interface CxfrsComponentBuilderFactory {
    ...
    interface CxfrsComponentBuilder extends ComponentBuilder<CxfRsComponent> {
         ...
         * @return the dsl builder
         */
        default CxfrsComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default CxfrsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default CxfrsComponentBuilder headerFilterStrategy(org.apache.camel.spi.HeaderFilterStrategy headerFilterStrategy) {
         ...
         * @return the dsl builder
         */
        default CxfrsComponentBuilder useGlobalSslContextParameters(boolean useGlobalSslContextParameters) {
    ...
    class CxfrsComponentBuilderImpl
            extends AbstractComponentBuilder<CxfRsComponent>
            implements CxfrsComponentBuilder {
        @Override
