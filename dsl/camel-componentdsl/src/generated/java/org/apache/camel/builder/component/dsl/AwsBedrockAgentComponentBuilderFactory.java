...
public interface AwsBedrockAgentComponentBuilderFactory {
     ...
     */
    interface AwsBedrockAgentComponentBuilder extends ComponentBuilder<BedrockAgentComponent> {
    ...
    class AwsBedrockAgentComponentBuilderImpl
            extends AbstractComponentBuilder<BedrockAgentComponent>
            implements AwsBedrockAgentComponentBuilder {
        @Override
        protected BedrockAgentComponent buildConcreteComponent() {
            return new BedrockAgentComponent();
        }
        private org.apache.camel.component.aws2.bedrock.agent.BedrockAgentConfiguration getOrCreateConfiguration(BedrockAgentComponent component) {
