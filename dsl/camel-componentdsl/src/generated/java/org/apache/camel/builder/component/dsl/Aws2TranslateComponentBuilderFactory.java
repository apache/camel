...
public interface Aws2TranslateComponentBuilderFactory {
    ...
    interface Aws2TranslateComponentBuilder
         ...
         * @return the dsl builder
         */
        default Aws2TranslateComponentBuilder profileCredentialsName(
         ...
         * @return the dsl builder
         */
        default Aws2TranslateComponentBuilder sessionToken(
         ...
         * @return the dsl builder
         */
        default Aws2TranslateComponentBuilder useProfileCredentialsProvider(
         ...
         * @return the dsl builder
         */
        default Aws2TranslateComponentBuilder useSessionCredentials(
