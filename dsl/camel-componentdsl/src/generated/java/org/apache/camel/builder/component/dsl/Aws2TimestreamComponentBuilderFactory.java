...
public interface Aws2TimestreamComponentBuilderFactory {
     ...
     */
    interface Aws2TimestreamComponentBuilder extends ComponentBuilder<Timestream2Component> {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder configuration(org.apache.camel.component.aws2.timestream.Timestream2Configuration configuration) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder operation(org.apache.camel.component.aws2.timestream.Timestream2Operations operation) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder overrideEndpoint(boolean overrideEndpoint) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder profileCredentialsName(java.lang.String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder uriEndpointOverride(java.lang.String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder awsTimestreamQueryClient(software.amazon.awssdk.services.timestreamquery.TimestreamQueryClient awsTimestreamQueryClient) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder awsTimestreamWriteClient(software.amazon.awssdk.services.timestreamwrite.TimestreamWriteClient awsTimestreamWriteClient) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder proxyHost(java.lang.String proxyHost) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder proxyPort(java.lang.Integer proxyPort) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder accessKey(java.lang.String accessKey) {
         ...
         * @return the dsl builder
         */
        default Aws2TimestreamComponentBuilder secretKey(java.lang.String secretKey) {
    ...
    class Aws2TimestreamComponentBuilderImpl
        ...
        private org.apache.camel.component.aws2.timestream.Timestream2Configuration getOrCreateConfiguration(Timestream2Component component) {
