...
public interface MybatisBeanComponentBuilderFactory {
     ...
     */
    interface MybatisBeanComponentBuilder extends ComponentBuilder<MyBatisBeanComponent> {
         ...
         * @return the dsl builder
         */
        default MybatisBeanComponentBuilder configurationUri(java.lang.String configurationUri) {
         ...
         * @return the dsl builder
         */
        default MybatisBeanComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default MybatisBeanComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default MybatisBeanComponentBuilder sqlSessionFactory(org.apache.ibatis.session.SqlSessionFactory sqlSessionFactory) {
         ...
         * @return the dsl builder
         */
        default MybatisBeanComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default MybatisBeanComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
    ...
    class MybatisBeanComponentBuilderImpl
            extends AbstractComponentBuilder<MyBatisBeanComponent>
            implements MybatisBeanComponentBuilder {
        @Override
