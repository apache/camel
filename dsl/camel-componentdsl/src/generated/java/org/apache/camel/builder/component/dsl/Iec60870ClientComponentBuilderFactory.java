...
public interface Iec60870ClientComponentBuilderFactory {
     ...
     */
    interface Iec60870ClientComponentBuilder extends ComponentBuilder<ClientComponent> {
         ...
         * @return the dsl builder
         */
        default Iec60870ClientComponentBuilder defaultConnectionOptions(org.apache.camel.component.iec60870.client.ClientOptions defaultConnectionOptions) {
         ...
         * @return the dsl builder
         */
        default Iec60870ClientComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default Iec60870ClientComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default Iec60870ClientComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class Iec60870ClientComponentBuilderImpl
            extends AbstractComponentBuilder<ClientComponent>
            implements Iec60870ClientComponentBuilder {
        @Override
