...
public interface JgroupsComponentBuilderFactory {
     ...
     */
    interface JgroupsComponentBuilder extends ComponentBuilder<JGroupsComponent> {
         ...
         * @return the dsl builder
         */
        default JgroupsComponentBuilder channelProperties(java.lang.String channelProperties) {
         ...
         * @return the dsl builder
         */
        default JgroupsComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default JgroupsComponentBuilder enableViewMessages(boolean enableViewMessages) {
         ...
         * @return the dsl builder
         */
        default JgroupsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default JgroupsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
