...
public interface KubernetesConfigMapsComponentBuilderFactory {
     ...
     */
    interface KubernetesConfigMapsComponentBuilder extends ComponentBuilder<KubernetesConfigMapsComponent> {
         ...
         * @return the dsl builder
         */
        default KubernetesConfigMapsComponentBuilder kubernetesClient(io.fabric8.kubernetes.client.KubernetesClient kubernetesClient) {
         ...
         * @return the dsl builder
         */
        default KubernetesConfigMapsComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default KubernetesConfigMapsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default KubernetesConfigMapsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class KubernetesConfigMapsComponentBuilderImpl
            extends AbstractComponentBuilder<KubernetesConfigMapsComponent>
            implements KubernetesConfigMapsComponentBuilder {
        @Override
