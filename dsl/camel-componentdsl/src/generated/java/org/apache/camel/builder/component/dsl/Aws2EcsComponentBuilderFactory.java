...
public interface Aws2EcsComponentBuilderFactory {
    ...
    interface Aws2EcsComponentBuilder extends ComponentBuilder<ECS2Component> {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder configuration(org.apache.camel.component.aws2.ecs.ECS2Configuration configuration) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder operation(org.apache.camel.component.aws2.ecs.ECS2Operations operation) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder overrideEndpoint(boolean overrideEndpoint) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder uriEndpointOverride(java.lang.String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder ecsClient(software.amazon.awssdk.services.ecs.EcsClient ecsClient) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder profileCredentialsName(java.lang.String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder sessionToken(java.lang.String sessionToken) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2EcsComponentBuilder useSessionCredentials(boolean useSessionCredentials) {
    ...
    class Aws2EcsComponentBuilderImpl
        ...
        private org.apache.camel.component.aws2.ecs.ECS2Configuration getOrCreateConfiguration(ECS2Component component) {
