...
public interface JsonataComponentBuilderFactory {
     ...
     */
    interface JsonataComponentBuilder extends ComponentBuilder<JsonataComponent> {
    ...
    class JsonataComponentBuilderImpl
            extends AbstractComponentBuilder<JsonataComponent>
            implements JsonataComponentBuilder {
        @Override
        ...
        protected boolean setPropertyOnComponent(
                ...
                Object value) {
            switch (name) {
            case "allowTemplateFromHeader": ((JsonataComponent) component).setAllowTemplateFromHeader((boolean) value); return true;
            case "contentCache": ((JsonataComponent) component).setContentCache((boolean) value); return true;
