...
public interface Aws2CwComponentBuilderFactory {
    ...
    interface Aws2CwComponentBuilder extends ComponentBuilder<Cw2Component> {
         ...
         * @return the dsl builder
         */
        default Aws2CwComponentBuilder configuration(org.apache.camel.component.aws2.cw.Cw2Configuration configuration) {
         ...
         * @return the dsl builder
         */
        default Aws2CwComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default Aws2CwComponentBuilder uriEndpointOverride(java.lang.String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default Aws2CwComponentBuilder amazonCwClient(software.amazon.awssdk.services.cloudwatch.CloudWatchClient amazonCwClient) {
         ...
         * @return the dsl builder
         */
        default Aws2CwComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2CwComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2CwComponentBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default Aws2CwComponentBuilder profileCredentialsName(java.lang.String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default Aws2CwComponentBuilder sessionToken(java.lang.String sessionToken) {
         ...
         * @return the dsl builder
         */
        default Aws2CwComponentBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default Aws2CwComponentBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2CwComponentBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2CwComponentBuilder useSessionCredentials(boolean useSessionCredentials) {
    ...
    class Aws2CwComponentBuilderImpl
        ...
        private org.apache.camel.component.aws2.cw.Cw2Configuration getOrCreateConfiguration(Cw2Component component) {
