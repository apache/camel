...
public interface GeocoderComponentBuilderFactory {
     ...
     */
    interface GeocoderComponentBuilder extends ComponentBuilder<GeoCoderComponent> {
         ...
         * @return the dsl builder
         */
        default GeocoderComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default GeocoderComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default GeocoderComponentBuilder geoApiContext(com.google.maps.GeoApiContext geoApiContext) {
