...
public interface ChatscriptComponentBuilderFactory {
     ...
     */
    interface ChatscriptComponentBuilder extends ComponentBuilder<ChatScriptComponent> {
         ...
         * @return the dsl builder
         */
        default ChatscriptComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default ChatscriptComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class ChatscriptComponentBuilderImpl
            extends AbstractComponentBuilder<ChatScriptComponent>
            implements ChatscriptComponentBuilder {
        @Override
