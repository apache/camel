...
public interface KubernetesHpaComponentBuilderFactory {
     ...
     */
    interface KubernetesHpaComponentBuilder extends ComponentBuilder<KubernetesHPAComponent> {
         ...
         * @return the dsl builder
         */
        default KubernetesHpaComponentBuilder kubernetesClient(io.fabric8.kubernetes.client.KubernetesClient kubernetesClient) {
         ...
         * @return the dsl builder
         */
        default KubernetesHpaComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default KubernetesHpaComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default KubernetesHpaComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class KubernetesHpaComponentBuilderImpl
            extends AbstractComponentBuilder<KubernetesHPAComponent>
            implements KubernetesHpaComponentBuilder {
        @Override
