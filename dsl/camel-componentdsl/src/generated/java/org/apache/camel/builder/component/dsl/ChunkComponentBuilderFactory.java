...
public interface ChunkComponentBuilderFactory {
    ...
    interface ChunkComponentBuilder extends ComponentBuilder<ChunkComponent> {
         ...
         * @return the dsl builder
         */
        default ChunkComponentBuilder allowContextMapAll(boolean allowContextMapAll) {
         ...
         * @return the dsl builder
         */
        default ChunkComponentBuilder allowTemplateFromHeader(boolean allowTemplateFromHeader) {
         ...
         * @return the dsl builder
         */
        default ChunkComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
    ...
    class ChunkComponentBuilderImpl
            extends AbstractComponentBuilder<ChunkComponent>
            implements ChunkComponentBuilder {
        @Override
        ...
        protected boolean setPropertyOnComponent(
            ...
            case "contentCache": ((ChunkComponent) component).setContentCache((boolean) value); return true;
