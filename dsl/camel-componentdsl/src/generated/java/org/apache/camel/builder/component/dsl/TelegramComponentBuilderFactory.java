...
public interface TelegramComponentBuilderFactory {
     ...
     */
    interface TelegramComponentBuilder extends ComponentBuilder<TelegramComponent> {
         ...
         * @return the dsl builder
         */
        default TelegramComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default TelegramComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default TelegramComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default TelegramComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default TelegramComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
         ...
         * @return the dsl builder
         */
        default TelegramComponentBuilder authorizationToken(java.lang.String authorizationToken) {
    ...
    class TelegramComponentBuilderImpl
            extends AbstractComponentBuilder<TelegramComponent>
            implements TelegramComponentBuilder {
        @Override
