...
public interface SpringJdbcComponentBuilderFactory {
     ...
     */
    interface SpringJdbcComponentBuilder extends ComponentBuilder<SpringJdbcComponent> {
         ...
         * @return the dsl builder
         */
        default SpringJdbcComponentBuilder dataSource(javax.sql.DataSource dataSource) {
         ...
         * @return the dsl builder
         */
        default SpringJdbcComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default SpringJdbcComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default SpringJdbcComponentBuilder connectionStrategy(org.apache.camel.component.jdbc.ConnectionStrategy connectionStrategy) {
