...
public interface DisruptorComponentBuilderFactory {
     ...
     */
    interface DisruptorComponentBuilder extends ComponentBuilder<DisruptorComponent> {
         ...
         * @return the dsl builder
         */
        default DisruptorComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default DisruptorComponentBuilder defaultConcurrentConsumers(int defaultConcurrentConsumers) {
         ...
         * @return the dsl builder
         */
        default DisruptorComponentBuilder defaultMultipleConsumers(boolean defaultMultipleConsumers) {
         ...
         * @return the dsl builder
         */
        default DisruptorComponentBuilder defaultWaitStrategy(org.apache.camel.component.disruptor.DisruptorWaitStrategy defaultWaitStrategy) {
         ...
         * @return the dsl builder
         */
        default DisruptorComponentBuilder defaultBlockWhenFull(boolean defaultBlockWhenFull) {
         ...
         * @return the dsl builder
         */
        default DisruptorComponentBuilder defaultProducerType(org.apache.camel.component.disruptor.DisruptorProducerType defaultProducerType) {
         ...
         * @return the dsl builder
         */
        default DisruptorComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default DisruptorComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class DisruptorComponentBuilderImpl
            extends AbstractComponentBuilder<DisruptorComponent>
            implements DisruptorComponentBuilder {
        @Override
