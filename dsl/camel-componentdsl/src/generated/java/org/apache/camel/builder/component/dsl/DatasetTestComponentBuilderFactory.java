...
public interface DatasetTestComponentBuilderFactory {
     ...
     */
    interface DatasetTestComponentBuilder extends ComponentBuilder<DataSetTestComponent> {
         ...
         * @return the dsl builder
         */
        default DatasetTestComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default DatasetTestComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default DatasetTestComponentBuilder exchangeFormatter(org.apache.camel.spi.ExchangeFormatter exchangeFormatter) {
