...
public interface SmbComponentBuilderFactory {
    ...
    interface SmbComponentBuilder extends ComponentBuilder<SmbComponent> {
         ...
         * @return the dsl builder
         */
        default SmbComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default SmbComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default SmbComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default SmbComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
    ...
    class SmbComponentBuilderImpl
            ...
            implements SmbComponentBuilder {
        @Override
