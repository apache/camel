...
public interface AzureKeyVaultComponentBuilderFactory {
     ...
     */
    interface AzureKeyVaultComponentBuilder extends ComponentBuilder<KeyVaultComponent> {
         ...
         * @return the dsl builder
         */
        default AzureKeyVaultComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AzureKeyVaultComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class AzureKeyVaultComponentBuilderImpl
            extends AbstractComponentBuilder<KeyVaultComponent>
            implements AzureKeyVaultComponentBuilder {
        @Override
