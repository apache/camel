...
public interface HazelcastAtomicvalueComponentBuilderFactory {
     ...
     */
    interface HazelcastAtomicvalueComponentBuilder extends ComponentBuilder<HazelcastAtomicnumberComponent> {
         ...
         * @return the dsl builder
         */
        default HazelcastAtomicvalueComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default HazelcastAtomicvalueComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default HazelcastAtomicvalueComponentBuilder hazelcastInstance(com.hazelcast.core.HazelcastInstance hazelcastInstance) {
         ...
         * @return the dsl builder
         */
        default HazelcastAtomicvalueComponentBuilder hazelcastMode(java.lang.String hazelcastMode) {
