...
public interface Aws2MqComponentBuilderFactory {
    ...
    interface Aws2MqComponentBuilder extends ComponentBuilder<MQ2Component> {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder configuration(org.apache.camel.component.aws2.mq.MQ2Configuration configuration) {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder operation(org.apache.camel.component.aws2.mq.MQ2Operations operation) {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder uriEndpointOverride(java.lang.String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder amazonMqClient(software.amazon.awssdk.services.mq.MqClient amazonMqClient) {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder profileCredentialsName(java.lang.String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder sessionToken(java.lang.String sessionToken) {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2MqComponentBuilder useSessionCredentials(boolean useSessionCredentials) {
    ...
    class Aws2MqComponentBuilderImpl
        ...
        private org.apache.camel.component.aws2.mq.MQ2Configuration getOrCreateConfiguration(MQ2Component component) {
        ...
        protected boolean setPropertyOnComponent(
            ...
            case "sessionToken": getOrCreateConfiguration((MQ2Component) component).setSessionToken((java.lang.String) value); return true;
            ...
            case "useSessionCredentials": getOrCreateConfiguration((MQ2Component) component).setUseSessionCredentials((boolean) value); return true;
