...
public interface ReactiveStreamsComponentBuilderFactory {
     ...
     */
    interface ReactiveStreamsComponentBuilder extends ComponentBuilder<ReactiveStreamsComponent> {
         ...
         * @return the dsl builder
         */
        default ReactiveStreamsComponentBuilder threadPoolMaxSize(int threadPoolMaxSize) {
         ...
         * @return the dsl builder
         */
        default ReactiveStreamsComponentBuilder threadPoolMinSize(int threadPoolMinSize) {
         ...
         * @return the dsl builder
         */
        default ReactiveStreamsComponentBuilder threadPoolName(java.lang.String threadPoolName) {
         ...
         * @return the dsl builder
         */
        default ReactiveStreamsComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default ReactiveStreamsComponentBuilder backpressureStrategy(org.apache.camel.component.reactive.streams.ReactiveStreamsBackpressureStrategy backpressureStrategy) {
         ...
         * @return the dsl builder
         */
        default ReactiveStreamsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default ReactiveStreamsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default ReactiveStreamsComponentBuilder reactiveStreamsEngineConfiguration(org.apache.camel.component.reactive.streams.engine.ReactiveStreamsEngineConfiguration reactiveStreamsEngineConfiguration) {
         ...
         * @return the dsl builder
         */
        default ReactiveStreamsComponentBuilder serviceType(java.lang.String serviceType) {
    ...
    class ReactiveStreamsComponentBuilderImpl
            extends AbstractComponentBuilder<ReactiveStreamsComponent>
            implements ReactiveStreamsComponentBuilder {
        @Override
