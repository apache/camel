...
public interface JsonPatchComponentBuilderFactory {
     ...
     */
    interface JsonPatchComponentBuilder extends ComponentBuilder<JsonPatchComponent> {
         ...
         * @return the dsl builder
         */
        default JsonPatchComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default JsonPatchComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
