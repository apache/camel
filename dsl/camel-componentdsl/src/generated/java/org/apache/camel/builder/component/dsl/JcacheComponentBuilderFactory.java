...
public interface JcacheComponentBuilderFactory {
     ...
     */
    interface JcacheComponentBuilder extends ComponentBuilder<JCacheComponent> {
         ...
         * @return the dsl builder
         */
        default JcacheComponentBuilder cacheConfiguration(javax.cache.configuration.Configuration cacheConfiguration) {
         ...
         * @return the dsl builder
         */
        default JcacheComponentBuilder cacheConfigurationProperties(java.util.Map cacheConfigurationProperties) {
         ...
         * @return the dsl builder
         */
        default JcacheComponentBuilder cacheConfigurationPropertiesRef(java.lang.String cacheConfigurationPropertiesRef) {
