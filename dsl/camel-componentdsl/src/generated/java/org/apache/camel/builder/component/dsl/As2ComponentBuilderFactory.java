...
public interface As2ComponentBuilderFactory {
    ...
    interface As2ComponentBuilder extends ComponentBuilder<AS2Component> {
         ...
         * @return the dsl builder
         */
        default As2ComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default As2ComponentBuilder configuration(org.apache.camel.component.as2.AS2Configuration configuration) {
    ...
    class As2ComponentBuilderImpl
            extends AbstractComponentBuilder<AS2Component>
            implements As2ComponentBuilder {
        @Override
