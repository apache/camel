...
public interface HwcloudIamComponentBuilderFactory {
     ...
     */
    interface HwcloudIamComponentBuilder extends ComponentBuilder<IAMComponent> {
         ...
         * @return the dsl builder
         */
        default HwcloudIamComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default HwcloudIamComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class HwcloudIamComponentBuilderImpl
            extends AbstractComponentBuilder<IAMComponent>
            implements HwcloudIamComponentBuilder {
        @Override
