...
public interface HwcloudDmsComponentBuilderFactory {
     ...
     */
    interface HwcloudDmsComponentBuilder extends ComponentBuilder<DMSComponent> {
         ...
         * @return the dsl builder
         */
        default HwcloudDmsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default HwcloudDmsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class HwcloudDmsComponentBuilderImpl
            extends AbstractComponentBuilder<DMSComponent>
            implements HwcloudDmsComponentBuilder {
        @Override
