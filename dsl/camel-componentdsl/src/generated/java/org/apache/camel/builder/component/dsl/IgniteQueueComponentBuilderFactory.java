...
public interface IgniteQueueComponentBuilderFactory {
     ...
     */
    interface IgniteQueueComponentBuilder extends ComponentBuilder<IgniteQueueComponent> {
         ...
         * @return the dsl builder
         */
        default IgniteQueueComponentBuilder configurationResource(java.lang.Object configurationResource) {
         ...
         * @return the dsl builder
         */
        default IgniteQueueComponentBuilder ignite(org.apache.ignite.Ignite ignite) {
         ...
         * @return the dsl builder
         */
        default IgniteQueueComponentBuilder igniteConfiguration(org.apache.ignite.configuration.IgniteConfiguration igniteConfiguration) {
         ...
         * @return the dsl builder
         */
        default IgniteQueueComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default IgniteQueueComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class IgniteQueueComponentBuilderImpl
            extends AbstractComponentBuilder<IgniteQueueComponent>
            implements IgniteQueueComponentBuilder {
        @Override
