...
public interface MetricsComponentBuilderFactory {
     ...
     */
    interface MetricsComponentBuilder extends ComponentBuilder<MetricsComponent> {
         ...
         * @return the dsl builder
         */
        default MetricsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default MetricsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default MetricsComponentBuilder metricRegistry(com.codahale.metrics.MetricRegistry metricRegistry) {
    ...
    class MetricsComponentBuilderImpl
            extends AbstractComponentBuilder<MetricsComponent>
            implements MetricsComponentBuilder {
        @Override
