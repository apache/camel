...
public interface ArangodbComponentBuilderFactory {
     ...
     */
    interface ArangodbComponentBuilder extends ComponentBuilder<ArangoDbComponent> {
         ...
         * @return the dsl builder
         */
        default ArangodbComponentBuilder configuration(org.apache.camel.component.arangodb.ArangoDbConfiguration configuration) {
         ...
         * @return the dsl builder
         */
        default ArangodbComponentBuilder documentCollection(java.lang.String documentCollection) {
         ...
         * @return the dsl builder
         */
        default ArangodbComponentBuilder edgeCollection(java.lang.String edgeCollection) {
         ...
         * @return the dsl builder
         */
        default ArangodbComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default ArangodbComponentBuilder operation(org.apache.camel.component.arangodb.ArangoDbOperation operation) {
         ...
         * @return the dsl builder
         */
        default ArangodbComponentBuilder vertexCollection(java.lang.String vertexCollection) {
         ...
         * @return the dsl builder
         */
        default ArangodbComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class ArangodbComponentBuilderImpl
            extends AbstractComponentBuilder<ArangoDbComponent>
            implements ArangodbComponentBuilder {
        @Override
        protected ArangoDbComponent buildConcreteComponent() {
            return new ArangoDbComponent();
        }
        private org.apache.camel.component.arangodb.ArangoDbConfiguration getOrCreateConfiguration(ArangoDbComponent component) {
