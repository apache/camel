...
public interface CometdComponentBuilderFactory {
     ...
     */
    interface CometdComponentBuilder extends ComponentBuilder<CometdComponent> {
         ...
         * @return the dsl builder
         */
        default CometdComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default CometdComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default CometdComponentBuilder extensions(java.util.List<org.cometd.bayeux.server.BayeuxServer.Extension> extensions) {
         ...
         * @return the dsl builder
         */
        default CometdComponentBuilder securityPolicy(org.cometd.bayeux.server.SecurityPolicy securityPolicy) {
         ...
         * @return the dsl builder
         */
        default CometdComponentBuilder sslContextParameters(org.apache.camel.support.jsse.SSLContextParameters sslContextParameters) {
         ...
         * @return the dsl builder
         */
        default CometdComponentBuilder sslKeyPassword(java.lang.String sslKeyPassword) {
         ...
         * @return the dsl builder
         */
        default CometdComponentBuilder useGlobalSslContextParameters(boolean useGlobalSslContextParameters) {
    ...
    class CometdComponentBuilderImpl
            ...
            implements CometdComponentBuilder {
        @Override
