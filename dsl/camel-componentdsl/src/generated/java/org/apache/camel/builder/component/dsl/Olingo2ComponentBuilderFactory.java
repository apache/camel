...
public interface Olingo2ComponentBuilderFactory {
     ...
     */
    interface Olingo2ComponentBuilder extends ComponentBuilder<Olingo2Component> {
         ...
         * @return the dsl builder
         */
        default Olingo2ComponentBuilder configuration(org.apache.camel.component.olingo2.Olingo2Configuration configuration) {
         ...
         * @return the dsl builder
         */
        default Olingo2ComponentBuilder entityProviderReadProperties(org.apache.olingo.odata2.api.ep.EntityProviderReadProperties entityProviderReadProperties) {
         ...
         * @return the dsl builder
         */
        default Olingo2ComponentBuilder entityProviderWriteProperties(org.apache.olingo.odata2.api.ep.EntityProviderWriteProperties entityProviderWriteProperties) {
         ...
         * @return the dsl builder
         */
        default Olingo2ComponentBuilder filterAlreadySeen(boolean filterAlreadySeen) {
         ...
         * @return the dsl builder
         */
        default Olingo2ComponentBuilder httpHeaders(java.util.Map<java.lang.String, java.lang.String> httpHeaders) {
         ...
         * @return the dsl builder
         */
        default Olingo2ComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default Olingo2ComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default Olingo2ComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default Olingo2ComponentBuilder httpAsyncClientBuilder(org.apache.http.impl.nio.client.HttpAsyncClientBuilder httpAsyncClientBuilder) {
         ...
         * @return the dsl builder
         */
        default Olingo2ComponentBuilder httpClientBuilder(org.apache.http.impl.client.HttpClientBuilder httpClientBuilder) {
         ...
         * @return the dsl builder
         */
        default Olingo2ComponentBuilder sslContextParameters(org.apache.camel.support.jsse.SSLContextParameters sslContextParameters) {
         ...
         * @return the dsl builder
         */
        default Olingo2ComponentBuilder useGlobalSslContextParameters(boolean useGlobalSslContextParameters) {
    ...
    class Olingo2ComponentBuilderImpl
        ...
        private org.apache.camel.component.olingo2.Olingo2Configuration getOrCreateConfiguration(Olingo2Component component) {
