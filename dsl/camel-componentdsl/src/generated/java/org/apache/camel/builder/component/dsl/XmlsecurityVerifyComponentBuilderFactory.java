...
public interface XmlsecurityVerifyComponentBuilderFactory {
     ...
     */
    interface XmlsecurityVerifyComponentBuilder extends ComponentBuilder<XmlVerifierComponent> {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder baseUri(java.lang.String baseUri) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder clearHeaders(java.lang.Boolean clearHeaders) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder cryptoContextProperties(java.util.Map<java.lang.String, java.lang.Object> cryptoContextProperties) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder disallowDoctypeDecl(java.lang.Boolean disallowDoctypeDecl) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder keySelector(javax.xml.crypto.KeySelector keySelector) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder omitXmlDeclaration(java.lang.Boolean omitXmlDeclaration) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder outputNodeSearch(java.lang.Object outputNodeSearch) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder outputNodeSearchType(java.lang.String outputNodeSearchType) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder outputXmlEncoding(java.lang.String outputXmlEncoding) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder removeSignatureElements(java.lang.Boolean removeSignatureElements) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder schemaResourceUri(java.lang.String schemaResourceUri) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder secureValidation(java.lang.Boolean secureValidation) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder validationFailedHandler(org.apache.camel.component.xmlsecurity.api.ValidationFailedHandler validationFailedHandler) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder xmlSignature2Message(org.apache.camel.component.xmlsecurity.api.XmlSignature2Message xmlSignature2Message) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder xmlSignatureChecker(org.apache.camel.component.xmlsecurity.api.XmlSignatureChecker xmlSignatureChecker) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder uriDereferencer(javax.xml.crypto.URIDereferencer uriDereferencer) {
         ...
         * @return the dsl builder
         */
        default XmlsecurityVerifyComponentBuilder verifierConfiguration(org.apache.camel.component.xmlsecurity.processor.XmlVerifierConfiguration verifierConfiguration) {
    ...
    class XmlsecurityVerifyComponentBuilderImpl
            extends AbstractComponentBuilder<XmlVerifierComponent>
            implements XmlsecurityVerifyComponentBuilder {
        @Override
        protected XmlVerifierComponent buildConcreteComponent() {
            return new XmlVerifierComponent();
        }
        private org.apache.camel.component.xmlsecurity.processor.XmlVerifierConfiguration getOrCreateConfiguration(XmlVerifierComponent component) {
