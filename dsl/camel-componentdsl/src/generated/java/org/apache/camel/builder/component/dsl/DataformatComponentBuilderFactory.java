...
public interface DataformatComponentBuilderFactory {
     ...
     */
    interface DataformatComponentBuilder extends ComponentBuilder<DataFormatComponent> {
         ...
         * @return the dsl builder
         */
        default DataformatComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default DataformatComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class DataformatComponentBuilderImpl
            extends AbstractComponentBuilder<DataFormatComponent>
            implements DataformatComponentBuilder {
        @Override
