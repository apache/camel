...
public interface GuavaEventbusComponentBuilderFactory {
     ...
     */
    interface GuavaEventbusComponentBuilder extends ComponentBuilder<GuavaEventBusComponent> {
         ...
         * @return the dsl builder
         */
        default GuavaEventbusComponentBuilder eventBus(com.google.common.eventbus.EventBus eventBus) {
         ...
         * @return the dsl builder
         */
        default GuavaEventbusComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default GuavaEventbusComponentBuilder listenerInterface(java.lang.Class<java.lang.Object> listenerInterface) {
         ...
         * @return the dsl builder
         */
        default GuavaEventbusComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default GuavaEventbusComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
