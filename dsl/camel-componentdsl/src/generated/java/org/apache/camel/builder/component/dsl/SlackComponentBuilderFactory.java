...
public interface SlackComponentBuilderFactory {
    ...
    interface SlackComponentBuilder extends ComponentBuilder<SlackComponent> {
         ...
         * @return the dsl builder
         */
        default SlackComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default SlackComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default SlackComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default SlackComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
    ...
    class SlackComponentBuilderImpl
            extends AbstractComponentBuilder<SlackComponent>
            implements SlackComponentBuilder {
        @Override
        ...
        protected boolean setPropertyOnComponent(
            ...
            case "healthCheckConsumerEnabled": ((SlackComponent) component).setHealthCheckConsumerEnabled((boolean) value); return true;
            case "healthCheckProducerEnabled": ((SlackComponent) component).setHealthCheckProducerEnabled((boolean) value); return true;
