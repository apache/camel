...
public interface StitchComponentBuilderFactory {
     ...
     */
    interface StitchComponentBuilder extends ComponentBuilder<StitchComponent> {
         ...
         * @return the dsl builder
         */
        default StitchComponentBuilder configuration(org.apache.camel.component.stitch.StitchConfiguration configuration) {
         ...
         * @return the dsl builder
         */
        default StitchComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default StitchComponentBuilder region(org.apache.camel.component.stitch.client.StitchRegion region) {
         ...
         * @return the dsl builder
         */
        default StitchComponentBuilder stitchSchema(org.apache.camel.component.stitch.client.models.StitchSchema stitchSchema) {
         ...
         * @return the dsl builder
         */
        default StitchComponentBuilder connectionProvider(reactor.netty.resources.ConnectionProvider connectionProvider) {
         ...
         * @return the dsl builder
         */
        default StitchComponentBuilder httpClient(reactor.netty.http.client.HttpClient httpClient) {
         ...
         * @return the dsl builder
         */
        default StitchComponentBuilder stitchClient(org.apache.camel.component.stitch.client.StitchClient stitchClient) {
    ...
    class StitchComponentBuilderImpl
        ...
        private org.apache.camel.component.stitch.StitchConfiguration getOrCreateConfiguration(StitchComponent component) {
