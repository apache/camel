...
public interface KubernetesSecretsComponentBuilderFactory {
     ...
     */
    interface KubernetesSecretsComponentBuilder extends ComponentBuilder<KubernetesSecretsComponent> {
         ...
         * @return the dsl builder
         */
        default KubernetesSecretsComponentBuilder kubernetesClient(io.fabric8.kubernetes.client.KubernetesClient kubernetesClient) {
         ...
         * @return the dsl builder
         */
        default KubernetesSecretsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default KubernetesSecretsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class KubernetesSecretsComponentBuilderImpl
            extends AbstractComponentBuilder<KubernetesSecretsComponent>
            implements KubernetesSecretsComponentBuilder {
        @Override
        protected KubernetesSecretsComponent buildConcreteComponent() {
            return new KubernetesSecretsComponent();
        }
        @Override
