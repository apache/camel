...
public interface KubernetesSecretsComponentBuilderFactory {
    ...
    interface KubernetesSecretsComponentBuilder
         ...
         * @return the dsl builder
         */
        default KubernetesSecretsComponentBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default KubernetesSecretsComponentBuilder autowiredEnabled(
    ...
    class KubernetesSecretsComponentBuilderImpl
            extends
                AbstractComponentBuilder<KubernetesSecretsComponent>
            implements
                KubernetesSecretsComponentBuilder {
        @Override
