...
public interface AzureFilesComponentBuilderFactory {
     ...
     */
    static AzureFilesComponentBuilder azureFiles() {
        return new AzureFilesComponentBuilderImpl();
    }

    /**
     * Builder for the Azure Files component.
     */
    interface AzureFilesComponentBuilder
            extends
         ...
         * @return the dsl builder
         */
        default AzureFilesComponentBuilder bridgeErrorHandler(
         ...
         * @return the dsl builder
         */
        default AzureFilesComponentBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default AzureFilesComponentBuilder autowiredEnabled(
         ...
         * @return the dsl builder
         */
        default AzureFilesComponentBuilder healthCheckConsumerEnabled(
         ...
         * @return the dsl builder
         */
        default AzureFilesComponentBuilder healthCheckEnabled(
         ...
         * @return the dsl builder
         */
        default AzureFilesComponentBuilder healthCheckProducerEnabled(
    ...
    class AzureFilesComponentBuilderImpl
            extends
                AbstractComponentBuilder<FilesComponent>
            implements
                AzureFilesComponentBuilder {
        @Override
        ...
        protected boolean setPropertyOnComponent(
            ...
            case "healthCheckEnabled": ((FilesComponent) component).setHealthCheckEnabled((boolean) value); return true;
