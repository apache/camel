...
public interface AzureFilesComponentBuilderFactory {
     ...
     */
    interface AzureFilesComponentBuilder extends ComponentBuilder<FilesComponent> {
         ...
         * @return the dsl builder
         */
        default AzureFilesComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default AzureFilesComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AzureFilesComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default AzureFilesComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default AzureFilesComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
