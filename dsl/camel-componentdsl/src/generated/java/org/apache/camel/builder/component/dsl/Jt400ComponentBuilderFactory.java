...
public interface Jt400ComponentBuilderFactory {
    ...
    interface Jt400ComponentBuilder extends ComponentBuilder<Jt400Component> {
         ...
         * @return the dsl builder
         */
        default Jt400ComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default Jt400ComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default Jt400ComponentBuilder connectionPool(com.ibm.as400.access.AS400ConnectionPool connectionPool) {
         ...
         * @return the dsl builder
         */
        default Jt400ComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default Jt400ComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
    ...
    class Jt400ComponentBuilderImpl
            extends AbstractComponentBuilder<Jt400Component>
            implements Jt400ComponentBuilder {
        @Override
