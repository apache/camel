...
public interface LogComponentBuilderFactory {
    ...
    /**
     * Builder for the Log Data component.
     */
    interface LogComponentBuilder extends ComponentBuilder<LogComponent> {
         ...
         * @return the dsl builder
         */
        default LogComponentBuilder sourceLocationLoggerName(boolean sourceLocationLoggerName) {
         ...
         * @return the dsl builder
         */
        default LogComponentBuilder exchangeFormatter(org.apache.camel.spi.ExchangeFormatter exchangeFormatter) {
