...
public interface ImapsComponentBuilderFactory {
    ...
    interface ImapsComponentBuilder extends ComponentBuilder<MailComponent> {
         ...
         * @return the dsl builder
         */
        default ImapsComponentBuilder healthCheckConsumerEnabled(
         ...
         * @return the dsl builder
         */
        default ImapsComponentBuilder healthCheckEnabled(
         ...
         * @return the dsl builder
         */
        default ImapsComponentBuilder healthCheckProducerEnabled(
