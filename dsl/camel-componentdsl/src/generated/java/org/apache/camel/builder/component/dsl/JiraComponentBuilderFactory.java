...
public interface JiraComponentBuilderFactory {
    ...
    interface JiraComponentBuilder extends ComponentBuilder<JiraComponent> {
         ...
         * @return the dsl builder
         */
        default JiraComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default JiraComponentBuilder configuration(org.apache.camel.component.jira.JiraConfiguration configuration) {
         ...
         * @return the dsl builder
         */
        default JiraComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default JiraComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
         ...
         * @return the dsl builder
         */
        default JiraComponentBuilder verificationCode(java.lang.String verificationCode) {
