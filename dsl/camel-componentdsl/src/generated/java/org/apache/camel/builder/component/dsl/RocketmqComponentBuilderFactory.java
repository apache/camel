...
public interface RocketmqComponentBuilderFactory {
     ...
     */
    interface RocketmqComponentBuilder extends ComponentBuilder<RocketMQComponent> {
         ...
         * @return the dsl builder
         */
        default RocketmqComponentBuilder namesrvAddr(java.lang.String namesrvAddr) {
         ...
         * @return the dsl builder
         */
        default RocketmqComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default RocketmqComponentBuilder subscribeTags(java.lang.String subscribeTags) {
         ...
         * @return the dsl builder
         */
        default RocketmqComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default RocketmqComponentBuilder producerGroup(java.lang.String producerGroup) {
         ...
         * @return the dsl builder
         */
        default RocketmqComponentBuilder replyToConsumerGroup(java.lang.String replyToConsumerGroup) {
         ...
         * @return the dsl builder
         */
        default RocketmqComponentBuilder replyToTopic(java.lang.String replyToTopic) {
         ...
         * @return the dsl builder
         */
        default RocketmqComponentBuilder waitForSendResult(boolean waitForSendResult) {
         ...
         * @return the dsl builder
         */
        default RocketmqComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default RocketmqComponentBuilder requestTimeoutCheckerIntervalMillis(long requestTimeoutCheckerIntervalMillis) {
         ...
         * @return the dsl builder
         */
        default RocketmqComponentBuilder requestTimeoutMillis(long requestTimeoutMillis) {
    ...
    class RocketmqComponentBuilderImpl
            extends AbstractComponentBuilder<RocketMQComponent>
            implements RocketmqComponentBuilder {
        @Override
