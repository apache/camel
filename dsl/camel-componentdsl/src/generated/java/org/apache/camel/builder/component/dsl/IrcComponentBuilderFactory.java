...
public interface IrcComponentBuilderFactory {
    ...
    interface IrcComponentBuilder extends ComponentBuilder<IrcComponent> {
         ...
         * @return the dsl builder
         */
        default IrcComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default IrcComponentBuilder useGlobalSslContextParameters(boolean useGlobalSslContextParameters) {
    ...
    class IrcComponentBuilderImpl
            extends AbstractComponentBuilder<IrcComponent>
            implements IrcComponentBuilder {
        @Override
