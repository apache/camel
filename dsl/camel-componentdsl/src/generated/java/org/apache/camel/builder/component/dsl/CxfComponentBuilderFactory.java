...
public interface CxfComponentBuilderFactory {
    ...
    interface CxfComponentBuilder extends ComponentBuilder<CxfComponent> {
         ...
         * @return the dsl builder
         */
        default CxfComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default CxfComponentBuilder allowStreaming(java.lang.Boolean allowStreaming) {
         ...
         * @return the dsl builder
         */
        default CxfComponentBuilder headerFilterStrategy(org.apache.camel.spi.HeaderFilterStrategy headerFilterStrategy) {
         ...
         * @return the dsl builder
         */
        default CxfComponentBuilder useGlobalSslContextParameters(boolean useGlobalSslContextParameters) {
