...
public interface KuduComponentBuilderFactory {
    ...
    interface KuduComponentBuilder extends ComponentBuilder<KuduComponent> {
         ...
         * @return the dsl builder
         */
        default KuduComponentBuilder kuduClient(org.apache.kudu.client.KuduClient kuduClient) {
    ...
    class KuduComponentBuilderImpl
            extends AbstractComponentBuilder<KuduComponent>
            implements KuduComponentBuilder {
        @Override
