...
public interface Iec60870ServerComponentBuilderFactory {
     ...
     */
    interface Iec60870ServerComponentBuilder extends ComponentBuilder<ServerComponent> {
         ...
         * @return the dsl builder
         */
        default Iec60870ServerComponentBuilder defaultConnectionOptions(org.apache.camel.component.iec60870.server.ServerOptions defaultConnectionOptions) {
         ...
         * @return the dsl builder
         */
        default Iec60870ServerComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default Iec60870ServerComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default Iec60870ServerComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class Iec60870ServerComponentBuilderImpl
            extends AbstractComponentBuilder<ServerComponent>
            implements Iec60870ServerComponentBuilder {
        @Override
