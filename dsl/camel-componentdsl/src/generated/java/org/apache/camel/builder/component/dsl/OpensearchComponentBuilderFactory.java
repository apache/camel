...
public interface OpensearchComponentBuilderFactory {
     ...
     */
    interface OpensearchComponentBuilder extends ComponentBuilder<OpensearchComponent> {
         ...
         * @return the dsl builder
         */
        default OpensearchComponentBuilder connectionTimeout(int connectionTimeout) {
         ...
         * @return the dsl builder
         */
        default OpensearchComponentBuilder hostAddresses(java.lang.String hostAddresses) {
         ...
         * @return the dsl builder
         */
        default OpensearchComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default OpensearchComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default OpensearchComponentBuilder client(org.opensearch.client.RestClient client) {
         ...
         * takes precedence over the RestClient-based client option.
         * 
         * The option is a:
         ...
         * @return the dsl builder
         */
        default OpensearchComponentBuilder sniffAfterFailureDelay(int sniffAfterFailureDelay) {
    ...
    class OpensearchComponentBuilderImpl
            extends AbstractComponentBuilder<OpensearchComponent>
            implements OpensearchComponentBuilder {
        @Override
