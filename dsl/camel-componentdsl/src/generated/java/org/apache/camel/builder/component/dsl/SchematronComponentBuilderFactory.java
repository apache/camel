...
public interface SchematronComponentBuilderFactory {
     ...
     */
    interface SchematronComponentBuilder extends ComponentBuilder<SchematronComponent> {
         ...
         * @return the dsl builder
         */
        default SchematronComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default SchematronComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
