...
public interface XmlsecuritySignComponentBuilderFactory {
     ...
     */
    interface XmlsecuritySignComponentBuilder extends ComponentBuilder<XmlSignerComponent> {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder keyAccessor(org.apache.camel.component.xmlsecurity.api.KeyAccessor keyAccessor) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder omitXmlDeclaration(java.lang.Boolean omitXmlDeclaration) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder outputXmlEncoding(java.lang.String outputXmlEncoding) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder parentLocalName(java.lang.String parentLocalName) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder parentNamespace(java.lang.String parentNamespace) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder parentXpath(javax.xml.crypto.dsig.spec.XPathFilterParameterSpec parentXpath) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder plainText(java.lang.Boolean plainText) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder plainTextEncoding(java.lang.String plainTextEncoding) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder prefixForXmlSignatureNamespace(java.lang.String prefixForXmlSignatureNamespace) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder properties(org.apache.camel.component.xmlsecurity.api.XmlSignatureProperties properties) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder schemaResourceUri(java.lang.String schemaResourceUri) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder signatureAlgorithm(java.lang.String signatureAlgorithm) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder signatureId(java.lang.String signatureId) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder transformMethods(java.util.List<javax.xml.crypto.AlgorithmMethod> transformMethods) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder xpathsToIdAttributes(java.util.List<javax.xml.crypto.dsig.spec.XPathFilterParameterSpec> xpathsToIdAttributes) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder signerConfiguration(org.apache.camel.component.xmlsecurity.processor.XmlSignerConfiguration signerConfiguration) {
         ...
         * @return the dsl builder
         */
        default XmlsecuritySignComponentBuilder uriDereferencer(javax.xml.crypto.URIDereferencer uriDereferencer) {
    ...
    class XmlsecuritySignComponentBuilderImpl
        ...
        private org.apache.camel.component.xmlsecurity.processor.XmlSignerConfiguration getOrCreateConfiguration(XmlSignerComponent component) {
