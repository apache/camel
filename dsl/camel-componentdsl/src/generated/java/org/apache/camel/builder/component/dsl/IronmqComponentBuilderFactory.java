...
public interface IronmqComponentBuilderFactory {
     ...
     */
    interface IronmqComponentBuilder extends ComponentBuilder<IronMQComponent> {
         ...
         * @return the dsl builder
         */
        default IronmqComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default IronmqComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default IronmqComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default IronmqComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
    ...
    class IronmqComponentBuilderImpl
            extends AbstractComponentBuilder<IronMQComponent>
            implements IronmqComponentBuilder {
        @Override
