...
public interface CqlComponentBuilderFactory {
     ...
     */
    static CqlComponentBuilder cql() {
        return new CqlComponentBuilderImpl();
    }

    /**
     * Builder for the Cassandra CQL component.
     */
    interface CqlComponentBuilder extends ComponentBuilder<CassandraComponent> {
         ...
         * @return the dsl builder
         */
        default CqlComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default CqlComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default CqlComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
            doSetProperty("autowiredEnabled", autowiredEnabled);
            return this;
        }
    }

    class CqlComponentBuilderImpl
            extends AbstractComponentBuilder<CassandraComponent>
            implements CqlComponentBuilder {
        @Override
        ...
        protected boolean setPropertyOnComponent(
            ...
            case "autowiredEnabled": ((CassandraComponent) component).setAutowiredEnabled((boolean) value); return true;
