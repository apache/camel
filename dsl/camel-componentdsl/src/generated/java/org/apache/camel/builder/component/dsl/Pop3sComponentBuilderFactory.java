...
public interface Pop3sComponentBuilderFactory {
    ...
    interface Pop3sComponentBuilder extends ComponentBuilder<MailComponent> {
         ...
         * @return the dsl builder
         */
        default Pop3sComponentBuilder healthCheckConsumerEnabled(
         ...
         * @return the dsl builder
         */
        default Pop3sComponentBuilder healthCheckEnabled(
         ...
         * @return the dsl builder
         */
        default Pop3sComponentBuilder healthCheckProducerEnabled(
