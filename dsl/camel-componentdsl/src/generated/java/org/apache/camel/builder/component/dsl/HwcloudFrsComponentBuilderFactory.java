...
public interface HwcloudFrsComponentBuilderFactory {
     ...
     */
    interface HwcloudFrsComponentBuilder extends ComponentBuilder<FaceRecognitionComponent> {
         ...
         * @return the dsl builder
         */
        default HwcloudFrsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default HwcloudFrsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class HwcloudFrsComponentBuilderImpl
            extends AbstractComponentBuilder<FaceRecognitionComponent>
            implements HwcloudFrsComponentBuilder {
        @Override
