...
public interface FileWatchComponentBuilderFactory {
     ...
     */
    interface FileWatchComponentBuilder extends ComponentBuilder<FileWatchComponent> {
         ...
         * @return the dsl builder
         */
        default FileWatchComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default FileWatchComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default FileWatchComponentBuilder concurrentConsumers(int concurrentConsumers) {
         ...
         * @return the dsl builder
         */
        default FileWatchComponentBuilder fileHasher(io.methvin.watcher.hashing.FileHasher fileHasher) {
    ...
    class FileWatchComponentBuilderImpl
            extends AbstractComponentBuilder<FileWatchComponent>
            implements FileWatchComponentBuilder {
        @Override
