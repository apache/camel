...
public interface StompComponentBuilderFactory {
    ...
    interface StompComponentBuilder extends ComponentBuilder<StompComponent> {
         ...
         * @return the dsl builder
         */
        default StompComponentBuilder customHeaders(java.util.Properties customHeaders) {
         ...
         * @return the dsl builder
         */
        default StompComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default StompComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default StompComponentBuilder configuration(org.apache.camel.component.stomp.StompConfiguration configuration) {
         ...
         * @return the dsl builder
         */
        default StompComponentBuilder headerFilterStrategy(org.apache.camel.spi.HeaderFilterStrategy headerFilterStrategy) {
         ...
         * @return the dsl builder
         */
        default StompComponentBuilder sslContextParameters(org.apache.camel.support.jsse.SSLContextParameters sslContextParameters) {
         ...
         * @return the dsl builder
         */
        default StompComponentBuilder useGlobalSslContextParameters(boolean useGlobalSslContextParameters) {
    ...
    class StompComponentBuilderImpl
        ...
        private org.apache.camel.component.stomp.StompConfiguration getOrCreateConfiguration(StompComponent component) {
