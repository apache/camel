...
public interface HazelcastMultimapComponentBuilderFactory {
     ...
     */
    interface HazelcastMultimapComponentBuilder extends ComponentBuilder<HazelcastMultimapComponent> {
         ...
         * @return the dsl builder
         */
        default HazelcastMultimapComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default HazelcastMultimapComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default HazelcastMultimapComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default HazelcastMultimapComponentBuilder hazelcastInstance(com.hazelcast.core.HazelcastInstance hazelcastInstance) {
         ...
         * @return the dsl builder
         */
        default HazelcastMultimapComponentBuilder hazelcastMode(java.lang.String hazelcastMode) {
    ...
    class HazelcastMultimapComponentBuilderImpl
            extends AbstractComponentBuilder<HazelcastMultimapComponent>
            implements HazelcastMultimapComponentBuilder {
        @Override
