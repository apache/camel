...
public interface Plc4xComponentBuilderFactory {
    ...
    interface Plc4xComponentBuilder extends ComponentBuilder<Plc4XComponent> {
         ...
         * @return the dsl builder
         */
        default Plc4xComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default Plc4xComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
    ...
    class Plc4xComponentBuilderImpl
            extends AbstractComponentBuilder<Plc4XComponent>
            implements Plc4xComponentBuilder {
        @Override
