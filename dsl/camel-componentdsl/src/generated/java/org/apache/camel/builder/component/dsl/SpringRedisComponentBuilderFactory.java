...
public interface SpringRedisComponentBuilderFactory {
     ...
     */
    interface SpringRedisComponentBuilder extends ComponentBuilder<RedisComponent> {
         ...
         * @return the dsl builder
         */
        default SpringRedisComponentBuilder redisTemplate(org.springframework.data.redis.core.RedisTemplate<java.lang.Object, java.lang.Object> redisTemplate) {
         ...
         * @return the dsl builder
         */
        default SpringRedisComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default SpringRedisComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default SpringRedisComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
