...
public interface PahoComponentBuilderFactory {
    ...
    interface PahoComponentBuilder extends ComponentBuilder<PahoComponent> {
         ...
         * @return the dsl builder
         */
        default PahoComponentBuilder automaticReconnect(boolean automaticReconnect) {
         ...
         * @return the dsl builder
         */
        default PahoComponentBuilder configuration(org.apache.camel.component.paho.PahoConfiguration configuration) {
         ...
         * @return the dsl builder
         */
        default PahoComponentBuilder filePersistenceDirectory(java.lang.String filePersistenceDirectory) {
         ...
         * @return the dsl builder
         */
        default PahoComponentBuilder persistence(org.apache.camel.component.paho.PahoPersistence persistence) {
         ...
         * @return the dsl builder
         */
        default PahoComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default PahoComponentBuilder client(org.eclipse.paho.client.mqttv3.MqttClient client) {
         ...
         * @return the dsl builder
         */
        default PahoComponentBuilder customWebSocketHeaders(java.util.Properties customWebSocketHeaders) {
         ...
         * @return the dsl builder
         */
        default PahoComponentBuilder executorServiceTimeout(int executorServiceTimeout) {
         ...
         * @return the dsl builder
         */
        default PahoComponentBuilder httpsHostnameVerificationEnabled(boolean httpsHostnameVerificationEnabled) {
         ...
         * @return the dsl builder
         */
        default PahoComponentBuilder socketFactory(javax.net.SocketFactory socketFactory) {
         ...
         * @return the dsl builder
         */
        default PahoComponentBuilder sslClientProps(java.util.Properties sslClientProps) {
         ...
         * @return the dsl builder
         */
        default PahoComponentBuilder sslHostnameVerifier(javax.net.ssl.HostnameVerifier sslHostnameVerifier) {
    ...
    class PahoComponentBuilderImpl
        ...
        private org.apache.camel.component.paho.PahoConfiguration getOrCreateConfiguration(PahoComponent component) {
