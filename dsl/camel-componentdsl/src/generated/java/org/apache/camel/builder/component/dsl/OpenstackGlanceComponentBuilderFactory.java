...
public interface OpenstackGlanceComponentBuilderFactory {
     ...
     */
    interface OpenstackGlanceComponentBuilder extends ComponentBuilder<GlanceComponent> {
         ...
         * @return the dsl builder
         */
        default OpenstackGlanceComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default OpenstackGlanceComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class OpenstackGlanceComponentBuilderImpl
            extends AbstractComponentBuilder<GlanceComponent>
            implements OpenstackGlanceComponentBuilder {
        @Override
