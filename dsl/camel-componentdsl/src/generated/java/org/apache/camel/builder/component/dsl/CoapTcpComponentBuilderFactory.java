...
public interface CoapTcpComponentBuilderFactory {
    ...
    interface CoapTcpComponentBuilder extends ComponentBuilder<CoAPComponent> {
         ...
         * @return the dsl builder
         */
        default CoapTcpComponentBuilder bridgeErrorHandler(
         ...
         * @return the dsl builder
         */
        default CoapTcpComponentBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default CoapTcpComponentBuilder autowiredEnabled(
