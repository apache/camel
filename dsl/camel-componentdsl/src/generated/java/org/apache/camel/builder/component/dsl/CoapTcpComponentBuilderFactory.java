...
public interface CoapTcpComponentBuilderFactory {
     ...
     */
    static CoapTcpComponentBuilder coapTcp() {
        return new CoapTcpComponentBuilderImpl();
    }
    ...
    interface CoapTcpComponentBuilder extends ComponentBuilder<CoAPComponent> {
         ...
         * @return the dsl builder
         */
        default CoapTcpComponentBuilder configurationFile(java.lang.String configurationFile) {
         ...
         * @return the dsl builder
         */
        default CoapTcpComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default CoapTcpComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default CoapTcpComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class CoapTcpComponentBuilderImpl
            extends AbstractComponentBuilder<CoAPComponent>
            implements CoapTcpComponentBuilder {
        @Override
