...
public interface KubernetesDeploymentsComponentBuilderFactory {
     ...
     */
    interface KubernetesDeploymentsComponentBuilder extends ComponentBuilder<KubernetesDeploymentsComponent> {
         ...
         * @return the dsl builder
         */
        default KubernetesDeploymentsComponentBuilder kubernetesClient(io.fabric8.kubernetes.client.KubernetesClient kubernetesClient) {
         ...
         * @return the dsl builder
         */
        default KubernetesDeploymentsComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default KubernetesDeploymentsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default KubernetesDeploymentsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class KubernetesDeploymentsComponentBuilderImpl
            extends AbstractComponentBuilder<KubernetesDeploymentsComponent>
            implements KubernetesDeploymentsComponentBuilder {
        @Override
