...
public interface MapstructComponentBuilderFactory {
     ...
     */
    interface MapstructComponentBuilder extends ComponentBuilder<MapstructComponent> {
         ...
         * @return the dsl builder
         */
        default MapstructComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default MapstructComponentBuilder mapperPackageName(java.lang.String mapperPackageName) {
         ...
         * @return the dsl builder
         */
        default MapstructComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default MapstructComponentBuilder mapStructConverter(org.apache.camel.component.mapstruct.MapStructMapperFinder mapStructConverter) {
    ...
    class MapstructComponentBuilderImpl
            extends AbstractComponentBuilder<MapstructComponent>
            implements MapstructComponentBuilder {
        @Override
