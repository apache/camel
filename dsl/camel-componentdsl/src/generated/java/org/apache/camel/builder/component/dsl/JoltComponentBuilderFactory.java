...
public interface JoltComponentBuilderFactory {
    ...
    interface JoltComponentBuilder extends ComponentBuilder<JoltComponent> {
         ...
         * @return the dsl builder
         */
        default JoltComponentBuilder allowTemplateFromHeader(boolean allowTemplateFromHeader) {
    ...
    class JoltComponentBuilderImpl
            extends AbstractComponentBuilder<JoltComponent>
            implements JoltComponentBuilder {
        @Override
