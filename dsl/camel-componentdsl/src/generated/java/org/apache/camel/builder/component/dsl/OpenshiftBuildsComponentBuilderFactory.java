...
public interface OpenshiftBuildsComponentBuilderFactory {
    ...
    interface OpenshiftBuildsComponentBuilder extends ComponentBuilder<OpenshiftBuildsComponent> {
         ...
         * @return the dsl builder
         */
        default OpenshiftBuildsComponentBuilder kubernetesClient(io.fabric8.kubernetes.client.KubernetesClient kubernetesClient) {
         ...
         * @return the dsl builder
         */
        default OpenshiftBuildsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default OpenshiftBuildsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
