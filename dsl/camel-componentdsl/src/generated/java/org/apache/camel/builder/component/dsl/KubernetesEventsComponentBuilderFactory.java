...
public interface KubernetesEventsComponentBuilderFactory {
     ...
     */
    interface KubernetesEventsComponentBuilder extends ComponentBuilder<KubernetesEventsComponent> {
         ...
         * @return the dsl builder
         */
        default KubernetesEventsComponentBuilder kubernetesClient(io.fabric8.kubernetes.client.KubernetesClient kubernetesClient) {
         ...
         * @return the dsl builder
         */
        default KubernetesEventsComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default KubernetesEventsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default KubernetesEventsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class KubernetesEventsComponentBuilderImpl
            extends AbstractComponentBuilder<KubernetesEventsComponent>
            implements KubernetesEventsComponentBuilder {
        @Override
