...
public interface OaipmhComponentBuilderFactory {
     ...
     */
    interface OaipmhComponentBuilder extends ComponentBuilder<OAIPMHComponent> {
         ...
         * @return the dsl builder
         */
        default OaipmhComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default OaipmhComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default OaipmhComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default OaipmhComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
    ...
    class OaipmhComponentBuilderImpl
            extends AbstractComponentBuilder<OAIPMHComponent>
            implements OaipmhComponentBuilder {
        @Override
