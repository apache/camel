...
public interface LlmComponentBuilderFactory {
     ...
     */
    static LlmComponentBuilder llm() {
        return new LlmComponentBuilderImpl();
    }

    /**
     * Builder for the LLM component.
     */
    interface LlmComponentBuilder extends ComponentBuilder<OpenAIComponent> {
         ...
         * @return the dsl builder
         */
        default LlmComponentBuilder apiKey(java.lang.String apiKey) {
         ...
         * @return the dsl builder
         */
        default LlmComponentBuilder audioModel(java.lang.String audioModel) {
         ...
         * @return the dsl builder
         */
        default LlmComponentBuilder baseUrl(java.lang.String baseUrl) {
         ...
         * @return the dsl builder
         */
        default LlmComponentBuilder embeddingModel(java.lang.String embeddingModel) {
         ...
         * @return the dsl builder
         */
        default LlmComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default LlmComponentBuilder model(java.lang.String model) {
         ...
         * @return the dsl builder
         */
        default LlmComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default LlmComponentBuilder useGlobalSslContextParameters(boolean useGlobalSslContextParameters) {
            doSetProperty("useGlobalSslContextParameters", useGlobalSslContextParameters);
            return this;
        }
    }

    class LlmComponentBuilderImpl
            extends AbstractComponentBuilder<OpenAIComponent>
            implements LlmComponentBuilder {
        @Override
