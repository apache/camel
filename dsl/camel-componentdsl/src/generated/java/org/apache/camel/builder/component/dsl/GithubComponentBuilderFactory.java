...
public interface GithubComponentBuilderFactory {
     ...
     */
    interface GithubComponentBuilder extends ComponentBuilder<GitHubComponent> {
         ...
         * @return the dsl builder
         */
        default GithubComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default GithubComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default GithubComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default GithubComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
    ...
    class GithubComponentBuilderImpl
            extends AbstractComponentBuilder<GitHubComponent>
            implements GithubComponentBuilder {
        @Override
