...
public interface OptaplannerComponentBuilderFactory {
     ...
     */
    interface OptaplannerComponentBuilder extends ComponentBuilder<OptaPlannerComponent> {
         ...
         * @return the dsl builder
         */
        default OptaplannerComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default OptaplannerComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default OptaplannerComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class OptaplannerComponentBuilderImpl
            extends AbstractComponentBuilder<OptaPlannerComponent>
            implements OptaplannerComponentBuilder {
        @Override
