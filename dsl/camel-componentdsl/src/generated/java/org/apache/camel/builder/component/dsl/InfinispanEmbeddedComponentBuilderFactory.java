...
public interface InfinispanEmbeddedComponentBuilderFactory {
     ...
     */
    interface InfinispanEmbeddedComponentBuilder extends ComponentBuilder<InfinispanEmbeddedComponent> {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder configuration(org.apache.camel.component.infinispan.embedded.InfinispanEmbeddedConfiguration configuration) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder queryBuilder(org.apache.camel.component.infinispan.InfinispanQueryBuilder queryBuilder) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder clusteredListener(boolean clusteredListener) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder customListener(org.apache.camel.component.infinispan.embedded.InfinispanEmbeddedCustomListener customListener) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder eventTypes(java.lang.String eventTypes) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder defaultValue(java.lang.Object defaultValue) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder oldValue(java.lang.Object oldValue) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder operation(org.apache.camel.component.infinispan.InfinispanOperation operation) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder cacheContainer(org.infinispan.manager.EmbeddedCacheManager cacheContainer) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder cacheContainerConfiguration(org.infinispan.configuration.cache.Configuration cacheContainerConfiguration) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder configurationUri(java.lang.String configurationUri) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder remappingFunction(java.util.function.BiFunction remappingFunction) {
         ...
         * @return the dsl builder
         */
        default InfinispanEmbeddedComponentBuilder resultHeader(java.lang.String resultHeader) {
    ...
    class InfinispanEmbeddedComponentBuilderImpl
            extends AbstractComponentBuilder<InfinispanEmbeddedComponent>
            implements InfinispanEmbeddedComponentBuilder {
        @Override
        protected InfinispanEmbeddedComponent buildConcreteComponent() {
            return new InfinispanEmbeddedComponent();
        }
        private org.apache.camel.component.infinispan.embedded.InfinispanEmbeddedConfiguration getOrCreateConfiguration(InfinispanEmbeddedComponent component) {
