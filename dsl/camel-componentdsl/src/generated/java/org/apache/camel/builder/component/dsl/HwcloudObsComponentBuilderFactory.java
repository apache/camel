...
public interface HwcloudObsComponentBuilderFactory {
     ...
     */
    interface HwcloudObsComponentBuilder extends ComponentBuilder<OBSComponent> {
         ...
         * @return the dsl builder
         */
        default HwcloudObsComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default HwcloudObsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default HwcloudObsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default HwcloudObsComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default HwcloudObsComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
