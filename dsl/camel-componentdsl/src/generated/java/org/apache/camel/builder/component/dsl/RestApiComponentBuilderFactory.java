...
public interface RestApiComponentBuilderFactory {
     ...
     */
    interface RestApiComponentBuilder extends ComponentBuilder<RestApiComponent> {
         ...
         * @return the dsl builder
         */
        default RestApiComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default RestApiComponentBuilder consumerComponentName(java.lang.String consumerComponentName) {
         ...
         * @return the dsl builder
         */
        default RestApiComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class RestApiComponentBuilderImpl
            extends AbstractComponentBuilder<RestApiComponent>
            implements RestApiComponentBuilder {
        @Override
