...
public interface MockComponentBuilderFactory {
    ...
    interface MockComponentBuilder extends ComponentBuilder<MockComponent> {
         ...
         * @return the dsl builder
         */
        default MockComponentBuilder exchangeFormatter(org.apache.camel.spi.ExchangeFormatter exchangeFormatter) {
    ...
    class MockComponentBuilderImpl
            extends AbstractComponentBuilder<MockComponent>
            implements MockComponentBuilder {
        @Override
