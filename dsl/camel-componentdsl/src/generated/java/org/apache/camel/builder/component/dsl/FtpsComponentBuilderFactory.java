...
public interface FtpsComponentBuilderFactory {
    ...
    interface FtpsComponentBuilder extends ComponentBuilder<FtpsComponent> {
         ...
         * @return the dsl builder
         */
        default FtpsComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default FtpsComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default FtpsComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
         ...
         * @return the dsl builder
         */
        default FtpsComponentBuilder useGlobalSslContextParameters(boolean useGlobalSslContextParameters) {
    ...
    class FtpsComponentBuilderImpl
            extends AbstractComponentBuilder<FtpsComponent>
            implements FtpsComponentBuilder {
        @Override
