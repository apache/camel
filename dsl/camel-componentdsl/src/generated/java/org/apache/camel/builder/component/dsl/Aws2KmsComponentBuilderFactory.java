...
public interface Aws2KmsComponentBuilderFactory {
    ...
    interface Aws2KmsComponentBuilder extends ComponentBuilder<KMS2Component> {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder configuration(org.apache.camel.component.aws2.kms.KMS2Configuration configuration) {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder operation(org.apache.camel.component.aws2.kms.KMS2Operations operation) {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder overrideEndpoint(boolean overrideEndpoint) {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder uriEndpointOverride(java.lang.String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder kmsClient(software.amazon.awssdk.services.kms.KmsClient kmsClient) {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder profileCredentialsName(java.lang.String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder sessionToken(java.lang.String sessionToken) {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2KmsComponentBuilder useSessionCredentials(boolean useSessionCredentials) {
