...
public interface KubernetesJobComponentBuilderFactory {
     ...
     */
    interface KubernetesJobComponentBuilder extends ComponentBuilder<KubernetesJobComponent> {
         ...
         * @return the dsl builder
         */
        default KubernetesJobComponentBuilder kubernetesClient(io.fabric8.kubernetes.client.KubernetesClient kubernetesClient) {
         ...
         * @return the dsl builder
         */
        default KubernetesJobComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default KubernetesJobComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class KubernetesJobComponentBuilderImpl
            extends AbstractComponentBuilder<KubernetesJobComponent>
            implements KubernetesJobComponentBuilder {
        @Override
