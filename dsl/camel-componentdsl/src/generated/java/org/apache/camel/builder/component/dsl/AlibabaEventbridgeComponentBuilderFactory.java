...
public interface AlibabaEventbridgeComponentBuilderFactory {
     ...
     */
    static AlibabaEventbridgeComponentBuilder alibabaEventbridge() {
        return new AlibabaEventbridgeComponentBuilderImpl();
    }
    ...
    interface AlibabaEventbridgeComponentBuilder extends ComponentBuilder<AlibabaEventBridgeComponent> {
         ...
         * @return the dsl builder
         */
        default AlibabaEventbridgeComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AlibabaEventbridgeComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default AlibabaEventbridgeComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default AlibabaEventbridgeComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
