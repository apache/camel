...
public interface JsonValidatorComponentBuilderFactory {
     ...
     */
    interface JsonValidatorComponentBuilder extends ComponentBuilder<JsonValidatorComponent> {
         ...
         * @return the dsl builder
         */
        default JsonValidatorComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default JsonValidatorComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class JsonValidatorComponentBuilderImpl
            extends AbstractComponentBuilder<JsonValidatorComponent>
            implements JsonValidatorComponentBuilder {
        @Override
        protected JsonValidatorComponent buildConcreteComponent() {
