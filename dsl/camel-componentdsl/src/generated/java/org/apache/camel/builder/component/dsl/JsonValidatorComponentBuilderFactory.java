...
public interface JsonValidatorComponentBuilderFactory {
     ...
     */
    interface JsonValidatorComponentBuilder
            extends
         ...
         * @return the dsl builder
         */
        default JsonValidatorComponentBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default JsonValidatorComponentBuilder autowiredEnabled(
    ...
    class JsonValidatorComponentBuilderImpl
            extends
                AbstractComponentBuilder<JsonValidatorComponent>
            implements
                JsonValidatorComponentBuilder {
        @Override
