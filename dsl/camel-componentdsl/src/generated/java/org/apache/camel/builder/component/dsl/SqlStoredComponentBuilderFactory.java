...
public interface SqlStoredComponentBuilderFactory {
     ...
     */
    interface SqlStoredComponentBuilder extends ComponentBuilder<SqlStoredComponent> {
         ...
         * @return the dsl builder
         */
        default SqlStoredComponentBuilder dataSource(javax.sql.DataSource dataSource) {
         ...
         * @return the dsl builder
         */
        default SqlStoredComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default SqlStoredComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class SqlStoredComponentBuilderImpl
            extends AbstractComponentBuilder<SqlStoredComponent>
            implements SqlStoredComponentBuilder {
        @Override
