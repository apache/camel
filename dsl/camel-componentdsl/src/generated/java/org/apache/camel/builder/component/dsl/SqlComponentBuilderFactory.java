...
public interface SqlComponentBuilderFactory {
    ...
    interface SqlComponentBuilder extends ComponentBuilder<SqlComponent> {
         ...
         * @return the dsl builder
         */
        default SqlComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default SqlComponentBuilder fetchSize(int fetchSize) {
         ...
         * @return the dsl builder
         */
        default SqlComponentBuilder rowMapperFactory(org.apache.camel.component.sql.RowMapperFactory rowMapperFactory) {
         ...
         * @return the dsl builder
         */
        default SqlComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default SqlComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
    ...
    class SqlComponentBuilderImpl
        ...
        protected boolean setPropertyOnComponent(
            ...
            case "fetchSize": ((SqlComponent) component).setFetchSize((int) value); return true;
