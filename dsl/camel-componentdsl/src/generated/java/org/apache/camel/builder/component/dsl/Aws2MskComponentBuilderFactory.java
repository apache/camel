...
public interface Aws2MskComponentBuilderFactory {
    ...
    interface Aws2MskComponentBuilder extends ComponentBuilder<MSK2Component> {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder configuration(org.apache.camel.component.aws2.msk.MSK2Configuration configuration) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder operation(org.apache.camel.component.aws2.msk.MSK2Operations operation) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder overrideEndpoint(boolean overrideEndpoint) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder uriEndpointOverride(java.lang.String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder mskClient(software.amazon.awssdk.services.kafka.KafkaClient mskClient) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder profileCredentialsName(java.lang.String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder sessionToken(java.lang.String sessionToken) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2MskComponentBuilder useSessionCredentials(boolean useSessionCredentials) {
    ...
    class Aws2MskComponentBuilderImpl
        ...
        private org.apache.camel.component.aws2.msk.MSK2Configuration getOrCreateConfiguration(MSK2Component component) {
