...
public interface CronComponentBuilderFactory {
    ...
    interface CronComponentBuilder extends ComponentBuilder<CronComponent> {
         ...
         * @return the dsl builder
         */
        default CronComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
    ...
    class CronComponentBuilderImpl
            extends AbstractComponentBuilder<CronComponent>
            implements CronComponentBuilder {
        @Override
