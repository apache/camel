...
public interface Aws2LambdaComponentBuilderFactory {
     ...
     */
    interface Aws2LambdaComponentBuilder extends ComponentBuilder<Lambda2Component> {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder configuration(org.apache.camel.component.aws2.lambda.Lambda2Configuration configuration) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder operation(org.apache.camel.component.aws2.lambda.Lambda2Operations operation) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder overrideEndpoint(boolean overrideEndpoint) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder uriEndpointOverride(java.lang.String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder awsLambdaClient(software.amazon.awssdk.services.lambda.LambdaClient awsLambdaClient) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder profileCredentialsName(java.lang.String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder sessionToken(java.lang.String sessionToken) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2LambdaComponentBuilder useSessionCredentials(boolean useSessionCredentials) {
    ...
    class Aws2LambdaComponentBuilderImpl
        ...
        private org.apache.camel.component.aws2.lambda.Lambda2Configuration getOrCreateConfiguration(Lambda2Component component) {
