...
public interface Aws2IamComponentBuilderFactory {
    ...
    interface Aws2IamComponentBuilder extends ComponentBuilder<IAM2Component> {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder configuration(org.apache.camel.component.aws2.iam.IAM2Configuration configuration) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder iamClient(software.amazon.awssdk.services.iam.IamClient iamClient) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder operation(org.apache.camel.component.aws2.iam.IAM2Operations operation) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder overrideEndpoint(boolean overrideEndpoint) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder uriEndpointOverride(java.lang.String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder profileCredentialsName(java.lang.String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder sessionToken(java.lang.String sessionToken) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Aws2IamComponentBuilder useSessionCredentials(boolean useSessionCredentials) {
    ...
    class Aws2IamComponentBuilderImpl
        ...
        private org.apache.camel.component.aws2.iam.IAM2Configuration getOrCreateConfiguration(IAM2Component component) {
