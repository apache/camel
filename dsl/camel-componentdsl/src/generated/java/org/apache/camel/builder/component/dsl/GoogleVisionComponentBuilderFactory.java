...
public interface GoogleVisionComponentBuilderFactory {
     ...
     */
    interface GoogleVisionComponentBuilder extends ComponentBuilder<GoogleCloudVisionComponent> {
         ...
         * @return the dsl builder
         */
        default GoogleVisionComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default GoogleVisionComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class GoogleVisionComponentBuilderImpl
        ...
        protected boolean setPropertyOnComponent(
                ...
                Object value) {
            switch (name) {
            case "lazyStartProducer": ((GoogleCloudVisionComponent) component).setLazyStartProducer((boolean) value); return true;
            case "autowiredEnabled": ((GoogleCloudVisionComponent) component).setAutowiredEnabled((boolean) value); return true;
