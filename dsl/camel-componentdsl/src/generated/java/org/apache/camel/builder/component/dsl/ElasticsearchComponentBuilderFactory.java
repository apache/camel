...
public interface ElasticsearchComponentBuilderFactory {
     ...
     */
    interface ElasticsearchComponentBuilder extends ComponentBuilder<ElasticsearchComponent> {
         ...
         * @return the dsl builder
         */
        default ElasticsearchComponentBuilder connectionTimeout(int connectionTimeout) {
         ...
         * @return the dsl builder
         */
        default ElasticsearchComponentBuilder enableDocumentOnlyMode(boolean enableDocumentOnlyMode) {
         ...
         * @return the dsl builder
         */
        default ElasticsearchComponentBuilder hostAddresses(java.lang.String hostAddresses) {
         ...
         * @return the dsl builder
         */
        default ElasticsearchComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default ElasticsearchComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default ElasticsearchComponentBuilder client(org.elasticsearch.client.RestClient client) {
         ...
         * @return the dsl builder
         */
        default ElasticsearchComponentBuilder enableSniffer(boolean enableSniffer) {
         ...
         * @return the dsl builder
         */
        default ElasticsearchComponentBuilder sniffAfterFailureDelay(int sniffAfterFailureDelay) {
         ...
         * @return the dsl builder
         */
        default ElasticsearchComponentBuilder snifferInterval(int snifferInterval) {
         ...
         * @return the dsl builder
         */
        default ElasticsearchComponentBuilder certificatePath(java.lang.String certificatePath) {
         ...
         * @return the dsl builder
         */
        default ElasticsearchComponentBuilder sslContextParameters(org.apache.camel.support.jsse.SSLContextParameters sslContextParameters) {
         ...
         * @return the dsl builder
         */
        default ElasticsearchComponentBuilder useGlobalSslContextParameters(boolean useGlobalSslContextParameters) {
    ...
    class ElasticsearchComponentBuilderImpl
            extends AbstractComponentBuilder<ElasticsearchComponent>
            implements ElasticsearchComponentBuilder {
        @Override
        ...
        protected boolean setPropertyOnComponent(
            ...
            case "sslContextParameters": ((ElasticsearchComponent) component).setSslContextParameters((org.apache.camel.support.jsse.SSLContextParameters) value); return true;
            case "useGlobalSslContextParameters": ((ElasticsearchComponent) component).setUseGlobalSslContextParameters((boolean) value); return true;
