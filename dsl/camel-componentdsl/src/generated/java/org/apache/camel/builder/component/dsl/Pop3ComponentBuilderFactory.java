...
public interface Pop3ComponentBuilderFactory {
    ...
    interface Pop3ComponentBuilder extends ComponentBuilder<MailComponent> {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder bridgeErrorHandler(
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder generateMissingAttachmentNames(
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder handleDuplicateAttachmentNames(
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder configuration(
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder headerFilterStrategy(
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder healthCheckConsumerEnabled(
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder healthCheckProducerEnabled(
