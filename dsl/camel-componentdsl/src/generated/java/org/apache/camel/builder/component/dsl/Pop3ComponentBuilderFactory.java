...
public interface Pop3ComponentBuilderFactory {
     ...
     */
    static Pop3ComponentBuilder pop3() {
        return new Pop3ComponentBuilderImpl();
    }
    ...
    interface Pop3ComponentBuilder extends ComponentBuilder<MailComponent> {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder handleFailedMessage(boolean handleFailedMessage) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder failOnDuplicateFileAttachment(boolean failOnDuplicateFileAttachment) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder generateMissingAttachmentNames(java.lang.String generateMissingAttachmentNames) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder handleDuplicateAttachmentNames(java.lang.String handleDuplicateAttachmentNames) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder useHeaderFrom(boolean useHeaderFrom) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder useHeaderRecipients(boolean useHeaderRecipients) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder useHeaderReplyTo(boolean useHeaderReplyTo) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder useHeaderSubject(boolean useHeaderSubject) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder javaMailSender(org.apache.camel.component.mail.JavaMailSender javaMailSender) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder additionalJavaMailProperties(java.util.Properties additionalJavaMailProperties) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder alternativeBodyHeader(java.lang.String alternativeBodyHeader) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder attachmentsContentTransferEncodingResolver(org.apache.camel.component.mail.AttachmentsContentTransferEncodingResolver attachmentsContentTransferEncodingResolver) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder authenticator(org.apache.camel.component.mail.MailAuthenticator authenticator) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder configuration(org.apache.camel.component.mail.MailConfiguration configuration) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder contentTypeResolver(org.apache.camel.component.mail.ContentTypeResolver contentTypeResolver) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder ignoreUnsupportedCharset(boolean ignoreUnsupportedCharset) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder javaMailProperties(java.util.Properties javaMailProperties) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder session(jakarta.mail.Session session) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder useInlineAttachments(boolean useInlineAttachments) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder headerFilterStrategy(org.apache.camel.spi.HeaderFilterStrategy headerFilterStrategy) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder sslContextParameters(org.apache.camel.support.jsse.SSLContextParameters sslContextParameters) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder useGlobalSslContextParameters(boolean useGlobalSslContextParameters) {
         ...
         * @return the dsl builder
         */
        default Pop3ComponentBuilder useJavaMailSessionPropertiesFromHeaders(boolean useJavaMailSessionPropertiesFromHeaders) {
    ...
    class Pop3ComponentBuilderImpl
            extends AbstractComponentBuilder<MailComponent>
            implements Pop3ComponentBuilder {
        @Override
