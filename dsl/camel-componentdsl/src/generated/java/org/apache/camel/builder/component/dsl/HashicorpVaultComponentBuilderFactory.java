...
public interface HashicorpVaultComponentBuilderFactory {
     ...
     */
    interface HashicorpVaultComponentBuilder extends ComponentBuilder<HashicorpVaultComponent> {
         ...
         * @return the dsl builder
         */
        default HashicorpVaultComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default HashicorpVaultComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class HashicorpVaultComponentBuilderImpl
            extends AbstractComponentBuilder<HashicorpVaultComponent>
            implements HashicorpVaultComponentBuilder {
        @Override
