...
public interface StringTemplateComponentBuilderFactory {
     ...
     */
    interface StringTemplateComponentBuilder extends ComponentBuilder<StringTemplateComponent> {
         ...
         * @return the dsl builder
         */
        default StringTemplateComponentBuilder allowContextMapAll(boolean allowContextMapAll) {
         ...
         * @return the dsl builder
         */
        default StringTemplateComponentBuilder allowTemplateFromHeader(boolean allowTemplateFromHeader) {
         ...
         * @return the dsl builder
         */
        default StringTemplateComponentBuilder contentCache(boolean contentCache) {
         ...
         * @return the dsl builder
         */
        default StringTemplateComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default StringTemplateComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class StringTemplateComponentBuilderImpl
            extends AbstractComponentBuilder<StringTemplateComponent>
            implements StringTemplateComponentBuilder {
        @Override
        ...
        protected boolean setPropertyOnComponent(
            ...
            case "contentCache": ((StringTemplateComponent) component).setContentCache((boolean) value); return true;
