...
public interface SpringLdapComponentBuilderFactory {
     ...
     */
    interface SpringLdapComponentBuilder extends ComponentBuilder<SpringLdapComponent> {
         ...
         * @return the dsl builder
         */
        default SpringLdapComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default SpringLdapComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
