...
public interface SolrcloudComponentBuilderFactory {
     ...
     */
    interface SolrcloudComponentBuilder extends ComponentBuilder<SolrComponent> {
         ...
         * @return the dsl builder
         */
        default SolrcloudComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default SolrcloudComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
