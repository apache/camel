...
public interface KubernetesNamespacesComponentBuilderFactory {
     ...
     */
    interface KubernetesNamespacesComponentBuilder extends ComponentBuilder<KubernetesNamespacesComponent> {
         ...
         * @return the dsl builder
         */
        default KubernetesNamespacesComponentBuilder kubernetesClient(io.fabric8.kubernetes.client.KubernetesClient kubernetesClient) {
         ...
         * @return the dsl builder
         */
        default KubernetesNamespacesComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default KubernetesNamespacesComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default KubernetesNamespacesComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
