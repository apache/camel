...
public interface OpenstackSwiftComponentBuilderFactory {
     ...
     */
    interface OpenstackSwiftComponentBuilder extends ComponentBuilder<SwiftComponent> {
         ...
         * @return the dsl builder
         */
        default OpenstackSwiftComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default OpenstackSwiftComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class OpenstackSwiftComponentBuilderImpl
            extends AbstractComponentBuilder<SwiftComponent>
            implements OpenstackSwiftComponentBuilder {
        @Override
