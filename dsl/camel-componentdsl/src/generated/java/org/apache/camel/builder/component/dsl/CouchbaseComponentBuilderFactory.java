...
public interface CouchbaseComponentBuilderFactory {
     ...
     */
    interface CouchbaseComponentBuilder extends ComponentBuilder<CouchbaseComponent> {
         ...
         * @return the dsl builder
         */
        default CouchbaseComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default CouchbaseComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default CouchbaseComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default CouchbaseComponentBuilder healthCheckConsumerEnabled(boolean healthCheckConsumerEnabled) {
         ...
         * @return the dsl builder
         */
        default CouchbaseComponentBuilder healthCheckProducerEnabled(boolean healthCheckProducerEnabled) {
