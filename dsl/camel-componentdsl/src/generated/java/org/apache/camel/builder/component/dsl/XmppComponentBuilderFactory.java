...
public interface XmppComponentBuilderFactory {
    ...
    interface XmppComponentBuilder extends ComponentBuilder<XmppComponent> {
         ...
         * @return the dsl builder
         */
        default XmppComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
    ...
    class XmppComponentBuilderImpl
            extends AbstractComponentBuilder<XmppComponent>
            implements XmppComponentBuilder {
        @Override
