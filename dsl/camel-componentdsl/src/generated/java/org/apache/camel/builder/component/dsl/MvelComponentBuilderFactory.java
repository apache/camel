...
public interface MvelComponentBuilderFactory {
    ...
    interface MvelComponentBuilder extends ComponentBuilder<MvelComponent> {
         ...
         * @return the dsl builder
         */
        default MvelComponentBuilder allowContextMapAll(boolean allowContextMapAll) {
         ...
         * @return the dsl builder
         */
        default MvelComponentBuilder allowTemplateFromHeader(boolean allowTemplateFromHeader) {
    ...
    class MvelComponentBuilderImpl
            extends AbstractComponentBuilder<MvelComponent>
            implements MvelComponentBuilder {
        @Override
