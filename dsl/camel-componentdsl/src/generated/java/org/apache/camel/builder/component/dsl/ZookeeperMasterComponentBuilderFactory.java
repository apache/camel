...
public interface ZookeeperMasterComponentBuilderFactory {
     ...
     */
    interface ZookeeperMasterComponentBuilder extends ComponentBuilder<MasterComponent> {
         ...
         * @return the dsl builder
         */
        default ZookeeperMasterComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default ZookeeperMasterComponentBuilder maximumConnectionTimeout(int maximumConnectionTimeout) {
         ...
         * @return the dsl builder
         */
        default ZookeeperMasterComponentBuilder zooKeeperUrl(java.lang.String zooKeeperUrl) {
         ...
         * @return the dsl builder
         */
        default ZookeeperMasterComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default ZookeeperMasterComponentBuilder containerIdFactory(org.apache.camel.component.zookeepermaster.ContainerIdFactory containerIdFactory) {
         ...
         * @return the dsl builder
         */
        default ZookeeperMasterComponentBuilder curator(org.apache.curator.framework.CuratorFramework curator) {
         ...
         * @return the dsl builder
         */
        default ZookeeperMasterComponentBuilder zooKeeperPassword(java.lang.String zooKeeperPassword) {
    ...
    class ZookeeperMasterComponentBuilderImpl
            extends AbstractComponentBuilder<MasterComponent>
            implements ZookeeperMasterComponentBuilder {
        @Override
