...
public interface ThriftComponentBuilderFactory {
     ...
     */
    interface ThriftComponentBuilder extends ComponentBuilder<ThriftComponent> {
         ...
         * @return the dsl builder
         */
        default ThriftComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default ThriftComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default ThriftComponentBuilder useGlobalSslContextParameters(boolean useGlobalSslContextParameters) {
    ...
    class ThriftComponentBuilderImpl
            extends AbstractComponentBuilder<ThriftComponent>
            implements ThriftComponentBuilder {
        @Override
