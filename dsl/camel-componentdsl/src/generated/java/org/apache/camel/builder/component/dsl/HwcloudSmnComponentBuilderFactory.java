...
public interface HwcloudSmnComponentBuilderFactory {
     ...
     */
    interface HwcloudSmnComponentBuilder extends ComponentBuilder<SimpleNotificationComponent> {
         ...
         * @return the dsl builder
         */
        default HwcloudSmnComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default HwcloudSmnComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class HwcloudSmnComponentBuilderImpl
            extends AbstractComponentBuilder<SimpleNotificationComponent>
            implements HwcloudSmnComponentBuilder {
        @Override
