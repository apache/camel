...
public interface ImapComponentBuilderFactory {
    ...
    interface ImapComponentBuilder extends ComponentBuilder<MailComponent> {
         ...
         * @return the dsl builder
         */
        default ImapComponentBuilder healthCheckConsumerEnabled(
         ...
         * @return the dsl builder
         */
        default ImapComponentBuilder healthCheckEnabled(
         ...
         * @return the dsl builder
         */
        default ImapComponentBuilder healthCheckProducerEnabled(
