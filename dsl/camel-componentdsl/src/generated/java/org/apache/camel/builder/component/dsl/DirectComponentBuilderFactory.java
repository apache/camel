...
public interface DirectComponentBuilderFactory {
     ...
     */
    interface DirectComponentBuilder extends ComponentBuilder<DirectComponent> {
         ...
         * @return the dsl builder
         */
        default DirectComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default DirectComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
    ...
    class DirectComponentBuilderImpl
            extends AbstractComponentBuilder<DirectComponent>
            implements DirectComponentBuilder {
        @Override
