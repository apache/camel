...
public interface MustacheComponentBuilderFactory {
     ...
     */
    interface MustacheComponentBuilder extends ComponentBuilder<MustacheComponent> {
         ...
         * @return the dsl builder
         */
        default MustacheComponentBuilder allowContextMapAll(boolean allowContextMapAll) {
         ...
         * @return the dsl builder
         */
        default MustacheComponentBuilder allowTemplateFromHeader(boolean allowTemplateFromHeader) {
         ...
         * @return the dsl builder
         */
        default MustacheComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default MustacheComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default MustacheComponentBuilder mustacheFactory(com.github.mustachejava.MustacheFactory mustacheFactory) {
    ...
    class MustacheComponentBuilderImpl
            extends AbstractComponentBuilder<MustacheComponent>
            implements MustacheComponentBuilder {
        @Override
