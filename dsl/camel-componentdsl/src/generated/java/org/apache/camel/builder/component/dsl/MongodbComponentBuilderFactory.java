...
public interface MongodbComponentBuilderFactory {
     ...
     */
    interface MongodbComponentBuilder extends ComponentBuilder<MongoDbComponent> {
         ...
         * @return the dsl builder
         */
        default MongodbComponentBuilder mongoConnection(com.mongodb.client.MongoClient mongoConnection) {
         ...
         * @return the dsl builder
         */
        default MongodbComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default MongodbComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default MongodbComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class MongodbComponentBuilderImpl
            extends AbstractComponentBuilder<MongoDbComponent>
            implements MongodbComponentBuilder {
        @Override
