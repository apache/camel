...
public interface XqueryComponentBuilderFactory {
     ...
     */
    interface XqueryComponentBuilder extends ComponentBuilder<XQueryComponent> {
         ...
         * @return the dsl builder
         */
        default XqueryComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default XqueryComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default XqueryComponentBuilder configuration(net.sf.saxon.Configuration configuration) {
         ...
         * @return the dsl builder
         */
        default XqueryComponentBuilder configurationProperties(java.util.Map<java.lang.String, java.lang.Object> configurationProperties) {
         ...
         * @return the dsl builder
         */
        default XqueryComponentBuilder moduleURIResolver(net.sf.saxon.lib.ModuleURIResolver moduleURIResolver) {
    ...
    class XqueryComponentBuilderImpl
            extends AbstractComponentBuilder<XQueryComponent>
            implements XqueryComponentBuilder {
        @Override
