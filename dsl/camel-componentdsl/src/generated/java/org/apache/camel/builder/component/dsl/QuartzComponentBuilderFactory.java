...
public interface QuartzComponentBuilderFactory {
     ...
     */
    interface QuartzComponentBuilder extends ComponentBuilder<QuartzComponent> {
         ...
         * @return the dsl builder
         */
        default QuartzComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default QuartzComponentBuilder prefixInstanceName(boolean prefixInstanceName) {
         ...
         * @return the dsl builder
         */
        default QuartzComponentBuilder prefixJobNameWithEndpointId(boolean prefixJobNameWithEndpointId) {
         ...
         * @return the dsl builder
         */
        default QuartzComponentBuilder propertiesFile(java.lang.String propertiesFile) {
         ...
         * @return the dsl builder
         */
        default QuartzComponentBuilder propertiesRef(java.lang.String propertiesRef) {
         ...
         * @return the dsl builder
         */
        default QuartzComponentBuilder schedulerFactory(org.quartz.SchedulerFactory schedulerFactory) {
         ...
         * @return the dsl builder
         */
        default QuartzComponentBuilder autoStartScheduler(boolean autoStartScheduler) {
         ...
         * @return the dsl builder
         */
        default QuartzComponentBuilder interruptJobsOnShutdown(boolean interruptJobsOnShutdown) {
    ...
    class QuartzComponentBuilderImpl
            extends AbstractComponentBuilder<QuartzComponent>
            implements QuartzComponentBuilder {
        @Override
