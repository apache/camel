...
public interface MasterComponentBuilderFactory {
     ...
     */
    interface MasterComponentBuilder extends ComponentBuilder<MasterComponent> {
         ...
         * @return the dsl builder
         */
        default MasterComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default MasterComponentBuilder service(org.apache.camel.cluster.CamelClusterService service) {
         ...
         * @return the dsl builder
         */
        default MasterComponentBuilder serviceSelector(org.apache.camel.cluster.CamelClusterService.Selector serviceSelector) {
    ...
    class MasterComponentBuilderImpl
            ...
            implements MasterComponentBuilder {
        @Override
