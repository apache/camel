...
public interface BeanValidatorComponentBuilderFactory {
     ...
     */
    interface BeanValidatorComponentBuilder extends ComponentBuilder<BeanValidatorComponent> {
         ...
         * @return the dsl builder
         */
        default BeanValidatorComponentBuilder ignoreXmlConfiguration(boolean ignoreXmlConfiguration) {
         ...
         * @return the dsl builder
         */
        default BeanValidatorComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default BeanValidatorComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default BeanValidatorComponentBuilder constraintValidatorFactory(jakarta.validation.ConstraintValidatorFactory constraintValidatorFactory) {
         ...
         * @return the dsl builder
         */
        default BeanValidatorComponentBuilder messageInterpolator(jakarta.validation.MessageInterpolator messageInterpolator) {
         ...
         * @return the dsl builder
         */
        default BeanValidatorComponentBuilder traversableResolver(jakarta.validation.TraversableResolver traversableResolver) {
         ...
         * @return the dsl builder
         */
        default BeanValidatorComponentBuilder validationProviderResolver(jakarta.validation.ValidationProviderResolver validationProviderResolver) {
         ...
         * @return the dsl builder
         */
        default BeanValidatorComponentBuilder validatorFactory(jakarta.validation.ValidatorFactory validatorFactory) {
    ...
    class BeanValidatorComponentBuilderImpl
            extends AbstractComponentBuilder<BeanValidatorComponent>
            implements BeanValidatorComponentBuilder {
        @Override
