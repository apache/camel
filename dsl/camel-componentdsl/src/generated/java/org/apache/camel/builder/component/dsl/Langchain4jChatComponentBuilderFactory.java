...
public interface Langchain4jChatComponentBuilderFactory {
     ...
     */
    interface Langchain4jChatComponentBuilder
            extends
                ComponentBuilder<LangChain4jChatComponent> {
        /**
         ...
         * @return the dsl builder
         */
        default Langchain4jChatComponentBuilder chatOperation(
         ...
         * @return the dsl builder
         */
        default Langchain4jChatComponentBuilder configuration(
                org.apache.camel.component.langchain4j.chat.LangChain4jChatConfiguration configuration) {
         ...
         * @return the dsl builder
         */
        default Langchain4jChatComponentBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default Langchain4jChatComponentBuilder autowiredEnabled(
         ...
         * @return the dsl builder
         */
        default Langchain4jChatComponentBuilder chatModel(
    ...
    class Langchain4jChatComponentBuilderImpl
            extends
                AbstractComponentBuilder<LangChain4jChatComponent>
            implements
                Langchain4jChatComponentBuilder {
        @Override
        protected LangChain4jChatComponent buildConcreteComponent() {
            return new LangChain4jChatComponent();
        }
        private org.apache.camel.component.langchain4j.chat.LangChain4jChatConfiguration getOrCreateConfiguration(
                org.apache.camel.component.langchain4j.chat.LangChain4jChatComponent component) {
