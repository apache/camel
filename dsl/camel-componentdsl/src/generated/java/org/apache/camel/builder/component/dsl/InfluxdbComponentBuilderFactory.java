...
public interface InfluxdbComponentBuilderFactory {
     ...
     */
    interface InfluxdbComponentBuilder extends ComponentBuilder<InfluxDbComponent> {
         ...
         * @return the dsl builder
         */
        default InfluxdbComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default InfluxdbComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class InfluxdbComponentBuilderImpl
            extends AbstractComponentBuilder<InfluxDbComponent>
            implements InfluxdbComponentBuilder {
        @Override
