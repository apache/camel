...
public interface VelocityComponentBuilderFactory {
     ...
     */
    interface VelocityComponentBuilder extends ComponentBuilder<VelocityComponent> {
         ...
         * @return the dsl builder
         */
        default VelocityComponentBuilder allowContextMapAll(boolean allowContextMapAll) {
         ...
         * @return the dsl builder
         */
        default VelocityComponentBuilder allowTemplateFromHeader(boolean allowTemplateFromHeader) {
         ...
         * @return the dsl builder
         */
        default VelocityComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default VelocityComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default VelocityComponentBuilder velocityEngine(org.apache.velocity.app.VelocityEngine velocityEngine) {
    ...
    class VelocityComponentBuilderImpl
            extends AbstractComponentBuilder<VelocityComponent>
            implements VelocityComponentBuilder {
        @Override
