...
public interface CryptoComponentBuilderFactory {
     ...
     */
    interface CryptoComponentBuilder extends ComponentBuilder<DigitalSignatureComponent> {
         ...
         * @return the dsl builder
         */
        default CryptoComponentBuilder certificateName(java.lang.String certificateName) {
         ...
         * @return the dsl builder
         */
        default CryptoComponentBuilder keystoreName(java.lang.String keystoreName) {
         ...
         * @return the dsl builder
         */
        default CryptoComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default CryptoComponentBuilder privateKey(java.security.PrivateKey privateKey) {
         ...
         * @return the dsl builder
         */
        default CryptoComponentBuilder privateKeyName(java.lang.String privateKeyName) {
         ...
         * @return the dsl builder
         */
        default CryptoComponentBuilder publicKeyName(java.lang.String publicKeyName) {
         ...
         * @return the dsl builder
         */
        default CryptoComponentBuilder secureRandomName(java.lang.String secureRandomName) {
         ...
         * @return the dsl builder
         */
        default CryptoComponentBuilder signatureHeaderName(java.lang.String signatureHeaderName) {
         ...
         * @return the dsl builder
         */
        default CryptoComponentBuilder certificate(java.security.cert.Certificate certificate) {
         ...
         * @return the dsl builder
         */
        default CryptoComponentBuilder configuration(org.apache.camel.component.crypto.DigitalSignatureConfiguration configuration) {
         ...
         * @return the dsl builder
         */
        default CryptoComponentBuilder keyStoreParameters(org.apache.camel.support.jsse.KeyStoreParameters keyStoreParameters) {
         ...
         * @return the dsl builder
         */
        default CryptoComponentBuilder publicKey(java.security.PublicKey publicKey) {
         ...
         * @return the dsl builder
         */
        default CryptoComponentBuilder secureRandom(java.security.SecureRandom secureRandom) {
    ...
    class CryptoComponentBuilderImpl
        ...
        private org.apache.camel.component.crypto.DigitalSignatureConfiguration getOrCreateConfiguration(DigitalSignatureComponent component) {
