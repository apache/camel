...
public interface BraintreeEndpointBuilderFactory {
    ...
    public interface BraintreeEndpointBuilder
         ...
         * @return the dsl builder
         */
        default BraintreeEndpointBuilder logHandlerEnabled(boolean logHandlerEnabled) {
         ...
         * @return the dsl builder
         */
        default BraintreeEndpointBuilder logHandlerEnabled(String logHandlerEnabled) {
            doSetProperty("logHandlerEnabled", logHandlerEnabled);
            return this;
        }
        /**
    ...
    public interface AdvancedBraintreeEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedBraintreeEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedBraintreeEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedBraintreeEndpointBuilder httpReadTimeout(Integer httpReadTimeout) {
         ...
         * @return the dsl builder
         */
        default AdvancedBraintreeEndpointBuilder httpReadTimeout(String httpReadTimeout) {
            doSetProperty("httpReadTimeout", httpReadTimeout);
            return this;
        }
    }
    ...
    public interface BraintreeBuilders {
         ...
         * @return the dsl builder
         */
        default BraintreeEndpointBuilder braintree(String componentName, String path) {
            return BraintreeEndpointBuilderFactory.endpointBuilder(componentName, path);
        }

    }
    static BraintreeEndpointBuilder endpointBuilder(String componentName, String path) {
