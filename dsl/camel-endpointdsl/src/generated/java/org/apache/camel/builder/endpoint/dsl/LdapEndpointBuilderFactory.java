...
public interface LdapEndpointBuilderFactory {
    ...
    public interface AdvancedLdapEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedLdapEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedLdapEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
