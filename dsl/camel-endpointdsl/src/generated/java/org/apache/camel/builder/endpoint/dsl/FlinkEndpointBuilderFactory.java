...
public interface FlinkEndpointBuilderFactory {
    ...
    public interface FlinkEndpointBuilder
         ...
         * @return the dsl builder
         */
        default FlinkEndpointBuilder dataSet(org.apache.flink.api.java.DataSet dataSet) {
         ...
         * @return the dsl builder
         */
        default FlinkEndpointBuilder dataSetCallback(org.apache.camel.component.flink.DataSetCallback dataSetCallback) {
         ...
         * @return the dsl builder
         */
        default FlinkEndpointBuilder dataStream(org.apache.flink.streaming.api.datastream.DataStream dataStream) {
         ...
         * @return the dsl builder
         */
        default FlinkEndpointBuilder dataStreamCallback(org.apache.camel.component.flink.DataStreamCallback dataStreamCallback) {
         ...
         * @return the dsl builder
         */
        default FlinkEndpointBuilder dataStreamCallback(String dataStreamCallback) {
            doSetProperty("dataStreamCallback", dataStreamCallback);
            return this;
        }
    }
    ...
    public interface AdvancedFlinkEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedFlinkEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
    ...
    public static class FlinkHeaderNameBuilder {
         ...
         */
        public static final FlinkHeaderNameBuilder INSTANCE = new FlinkHeaderNameBuilder();
    ...
    static FlinkEndpointBuilder endpointBuilder(String componentName, String path) {
