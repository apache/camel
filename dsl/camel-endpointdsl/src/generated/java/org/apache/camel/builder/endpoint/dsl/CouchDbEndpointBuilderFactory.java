...
public interface CouchDbEndpointBuilderFactory {
    ...
    public interface CouchDbEndpointConsumerBuilder
         ...
         */
        default CouchDbEndpointConsumerBuilder createDatabase(boolean createDatabase) {
         ...
         * @return the dsl builder
         */
        default CouchDbEndpointConsumerBuilder createDatabase(String createDatabase) {
            doSetProperty("createDatabase", createDatabase);
            return this;
        }
        /**
    ...
    public interface CouchDbEndpointProducerBuilder
         ...
         * @return the dsl builder
         */
        default CouchDbEndpointProducerBuilder createDatabase(boolean createDatabase) {
            doSetProperty("createDatabase", createDatabase);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default CouchDbEndpointProducerBuilder createDatabase(String createDatabase) {
            doSetProperty("createDatabase", createDatabase);
            return this;
        }
        /**
    ...
    public interface AdvancedCouchDbEndpointProducerBuilder extends EndpointProducerBuilder {
         ...
         * @return the dsl builder
         */
        default AdvancedCouchDbEndpointProducerBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedCouchDbEndpointProducerBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
