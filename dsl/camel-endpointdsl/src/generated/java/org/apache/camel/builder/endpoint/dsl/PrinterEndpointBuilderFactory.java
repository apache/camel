...
public interface PrinterEndpointBuilderFactory {
    ...
    public interface AdvancedPrinterEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedPrinterEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedPrinterEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
