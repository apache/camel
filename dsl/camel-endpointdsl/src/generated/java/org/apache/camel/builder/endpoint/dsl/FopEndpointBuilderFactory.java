...
public interface FopEndpointBuilderFactory {
    ...
    public interface AdvancedFopEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedFopEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedFopEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
