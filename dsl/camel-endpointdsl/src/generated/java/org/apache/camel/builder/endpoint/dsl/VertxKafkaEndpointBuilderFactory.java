...
public interface VertxKafkaEndpointBuilderFactory {
    ...
    public interface VertxKafkaEndpointConsumerBuilder
         ...
         * Note, that &lt;code&gt;max.poll.records does not impact the
         ...
         * are:&lt;ul&gt;&lt;li&gt;&lt;code&gt;org.apache.kafka.clients.consumer.RangeAssignor: The default assignor, which works on a per-topic basis.&lt;li&gt;&lt;code&gt;org.apache.kafka.clients.consumer.RoundRobinAssignor: Assigns partitions to consumers in a round-robin fashion.&lt;li&gt;&lt;code&gt;org.apache.kafka.clients.consumer.StickyAssignor: Guarantees an assignment that is maximally balanced while preserving as many existing partition assignments as possible.&lt;li&gt;&lt;code&gt;org.apache.kafka.clients.consumer.CooperativeStickyAssignor: Follows the same StickyAssignor logic, but allows for cooperative rebalancing.&lt;p&gt;Implementing the &lt;code&gt;org.apache.kafka.clients.consumer.ConsumerPartitionAssignor interface allows you to plug in a custom assignment strategy.
         * 
         * The option is a: &lt;code&gt;java.lang.String&lt;/code&gt; type.
         * 
    ...
    public interface VertxKafkaEndpointProducerBuilder
        ...
        /**
         * The configuration controls how long the &lt;code&gt;KafkaProducer's
         * &lt;code&gt;send(), &lt;code&gt;partitionsFor(),
         * &lt;code&gt;initTransactions(),
         * &lt;code&gt;sendOffsetsToTransaction(),
         * &lt;code&gt;commitTransaction() and &lt;code&gt;abortTransaction()
         * methods will block. For &lt;code&gt;send() this timeout bounds the
         ...
         * counted against this timeout). For &lt;code&gt;partitionsFor() this
         ...
         * request will fail with a &lt;code&gt;InvalidTxnTimeoutException
         * error.
         * 
         * The option is a: &lt;code&gt;int&lt;/code&gt; type.
         * 
