...
public interface StAXEndpointBuilderFactory {
    ...
    public interface AdvancedStAXEndpointBuilder
         ...
         */
        default AdvancedStAXEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedStAXEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
