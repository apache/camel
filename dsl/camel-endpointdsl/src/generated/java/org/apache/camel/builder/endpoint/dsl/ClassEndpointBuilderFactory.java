...
public interface ClassEndpointBuilderFactory {
    ...
    public interface AdvancedClassEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedClassEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedClassEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
