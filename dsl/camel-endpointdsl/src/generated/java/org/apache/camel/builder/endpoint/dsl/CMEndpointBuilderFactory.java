...
public interface CMEndpointBuilderFactory {
    ...
    public interface CMEndpointBuilder
         ...
         * @return the dsl builder
         */
        default CMEndpointBuilder defaultMaxNumberOfParts(int defaultMaxNumberOfParts) {
         ...
         * @return the dsl builder
         */
        default CMEndpointBuilder defaultMaxNumberOfParts(String defaultMaxNumberOfParts) {
            doSetProperty("defaultMaxNumberOfParts", defaultMaxNumberOfParts);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default CMEndpointBuilder testConnectionOnStartup(boolean testConnectionOnStartup) {
         ...
         * @return the dsl builder
         */
        default CMEndpointBuilder testConnectionOnStartup(String testConnectionOnStartup) {
            doSetProperty("testConnectionOnStartup", testConnectionOnStartup);
            return this;
        }
    }
    ...
    public interface AdvancedCMEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedCMEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedCMEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
