...
public interface LangChain4jChatEndpointBuilderFactory {
    ...
    public interface LangChain4jChatEndpointBuilder
         ...
         */
        default LangChain4jChatEndpointBuilder chatOperation(
                org.apache.camel.component.langchain4j.chat.LangChain4jChatOperations chatOperation) {
    ...
    public interface AdvancedLangChain4jChatEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedLangChain4jChatEndpointBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default AdvancedLangChain4jChatEndpointBuilder chatModel(
    ...
    public interface LangChain4jChatBuilders {
         ...
         * @return the dsl builder
         */
        default LangChain4jChatEndpointBuilder langchain4jChat(
    ...
    static LangChain4jChatEndpointBuilder endpointBuilder(
            String componentName,
            String path) {
