...
public interface GraphqlEndpointBuilderFactory {
     ...
     */
    public interface GraphqlEndpointBuilder
            extends
    ...
    public interface AdvancedGraphqlEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedGraphqlEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
    ...
    static GraphqlEndpointBuilder endpointBuilder(String componentName, String path) {
