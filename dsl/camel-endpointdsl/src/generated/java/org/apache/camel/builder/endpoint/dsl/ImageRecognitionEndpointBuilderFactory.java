...
public interface ImageRecognitionEndpointBuilderFactory {
    ...
    public interface ImageRecognitionEndpointBuilder
         ...
         * @return the dsl builder
         */
        default ImageRecognitionEndpointBuilder proxyPassword(String proxyPassword) {
         ...
         * @return the dsl builder
         */
        default ImageRecognitionEndpointBuilder serviceKeys(org.apache.camel.component.huaweicloud.common.models.ServiceKeys serviceKeys) {
         ...
         * @return the dsl builder
         */
        default ImageRecognitionEndpointBuilder ignoreSslVerification(boolean ignoreSslVerification) {
         ...
         * @return the dsl builder
         */
        default ImageRecognitionEndpointBuilder ignoreSslVerification(String ignoreSslVerification) {
            doSetProperty("ignoreSslVerification", ignoreSslVerification);
            return this;
        }
    }
    ...
    /**
     * Advanced builder for endpoint for the Huawei Cloud Image Recognition component.
     */
    public interface AdvancedImageRecognitionEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedImageRecognitionEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedImageRecognitionEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface ImageRecognitionBuilders {
         ...
         * @return the dsl builder
         */
        default ImageRecognitionEndpointBuilder hwcloudImagerecognition(String path) {
         ...
         * @return the dsl builder
         */
        default ImageRecognitionEndpointBuilder hwcloudImagerecognition(String componentName, String path) {
            return ImageRecognitionEndpointBuilderFactory.endpointBuilder(componentName, path);
        }

    }
    static ImageRecognitionEndpointBuilder endpointBuilder(String componentName, String path) {
