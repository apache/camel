...
public interface GoogleBigQueryEndpointBuilderFactory {
    ...
    public interface GoogleBigQueryEndpointBuilder
         ...
         */
        default GoogleBigQueryEndpointBuilder connectionFactory(org.apache.camel.component.google.bigquery.GoogleBigQueryConnectionFactory connectionFactory) {
         ...
         * @return the dsl builder
         */
        default GoogleBigQueryEndpointBuilder connectionFactory(String connectionFactory) {
            doSetProperty("connectionFactory", connectionFactory);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default GoogleBigQueryEndpointBuilder serviceAccountKey(String serviceAccountKey) {
    ...
    public interface AdvancedGoogleBigQueryEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedGoogleBigQueryEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedGoogleBigQueryEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    static GoogleBigQueryEndpointBuilder endpointBuilder(String componentName, String path) {
