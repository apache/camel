...
public interface GoogleCloudFunctionsEndpointBuilderFactory {
    ...
    public interface GoogleCloudFunctionsEndpointBuilder
         ...
         */
        default GoogleCloudFunctionsEndpointBuilder serviceAccountKey(String serviceAccountKey) {
         ...
         * @return the dsl builder
         */
        default GoogleCloudFunctionsEndpointBuilder operation(org.apache.camel.component.google.functions.GoogleCloudFunctionsOperations operation) {
         ...
         * @return the dsl builder
         */
        default GoogleCloudFunctionsEndpointBuilder pojoRequest(boolean pojoRequest) {
         ...
         * @return the dsl builder
         */
        default GoogleCloudFunctionsEndpointBuilder pojoRequest(String pojoRequest) {
            doSetProperty("pojoRequest", pojoRequest);
            return this;
        }
        /**
    ...
    public interface AdvancedGoogleCloudFunctionsEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedGoogleCloudFunctionsEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedGoogleCloudFunctionsEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedGoogleCloudFunctionsEndpointBuilder client(com.google.cloud.functions.v1.CloudFunctionsServiceClient client) {
