...
public interface ValidatorEndpointBuilderFactory {
    ...
    public interface ValidatorEndpointBuilder
         ...
         * @return the dsl builder
         */
        default ValidatorEndpointBuilder failOnNullHeader(boolean failOnNullHeader) {
         ...
         * @return the dsl builder
         */
        default ValidatorEndpointBuilder failOnNullHeader(String failOnNullHeader) {
            doSetProperty("failOnNullHeader", failOnNullHeader);
            return this;
        }
        /**
    ...
    public interface AdvancedValidatorEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedValidatorEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedValidatorEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedValidatorEndpointBuilder errorHandler(org.apache.camel.support.processor.validation.ValidatorErrorHandler errorHandler) {
         ...
         * @return the dsl builder
         */
        default AdvancedValidatorEndpointBuilder errorHandler(String errorHandler) {
            doSetProperty("errorHandler", errorHandler);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedValidatorEndpointBuilder resourceResolver(org.w3c.dom.ls.LSResourceResolver resourceResolver) {
         ...
         * @return the dsl builder
         */
        default AdvancedValidatorEndpointBuilder resourceResolver(String resourceResolver) {
            doSetProperty("resourceResolver", resourceResolver);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedValidatorEndpointBuilder resourceResolverFactory(String resourceResolverFactory) {
            doSetProperty("resourceResolverFactory", resourceResolverFactory);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedValidatorEndpointBuilder schemaFactory(javax.xml.validation.SchemaFactory schemaFactory) {
         ...
         * @return the dsl builder
         */
        default AdvancedValidatorEndpointBuilder schemaFactory(String schemaFactory) {
            doSetProperty("schemaFactory", schemaFactory);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedValidatorEndpointBuilder schemaLanguage(String schemaLanguage) {
         ...
         * @return the dsl builder
         */
        default AdvancedValidatorEndpointBuilder useSharedSchema(boolean useSharedSchema) {
         ...
         * @return the dsl builder
         */
        default AdvancedValidatorEndpointBuilder useSharedSchema(String useSharedSchema) {
            doSetProperty("useSharedSchema", useSharedSchema);
            return this;
        }
    }
    ...
    public interface ValidatorBuilders {
         ...
         * @return the dsl builder
         */
        default ValidatorEndpointBuilder validator(String componentName, String path) {
            return ValidatorEndpointBuilderFactory.endpointBuilder(componentName, path);
        }

    }
    static ValidatorEndpointBuilder endpointBuilder(String componentName, String path) {
