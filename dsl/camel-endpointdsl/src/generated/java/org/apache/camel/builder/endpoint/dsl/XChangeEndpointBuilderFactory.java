...
public interface XChangeEndpointBuilderFactory {
    ...
    public interface AdvancedXChangeEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedXChangeEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedXChangeEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public static class XChangeHeaderNameBuilder {
         ...
         */
        public static final XChangeHeaderNameBuilder INSTANCE = new XChangeHeaderNameBuilder();
    ...
    static XChangeEndpointBuilder endpointBuilder(String componentName, String path) {
