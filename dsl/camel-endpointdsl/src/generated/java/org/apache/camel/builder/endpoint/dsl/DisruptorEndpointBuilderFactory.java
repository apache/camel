...
public interface DisruptorEndpointBuilderFactory {
    ...
    public interface DisruptorEndpointConsumerBuilder
         ...
         * @return the dsl builder
         */
        default DisruptorEndpointConsumerBuilder concurrentConsumers(int concurrentConsumers) {
         ...
         * @return the dsl builder
         */
        default DisruptorEndpointConsumerBuilder concurrentConsumers(String concurrentConsumers) {
            doSetProperty("concurrentConsumers", concurrentConsumers);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default DisruptorEndpointConsumerBuilder multipleConsumers(boolean multipleConsumers) {
         ...
         * @return the dsl builder
         */
        default DisruptorEndpointConsumerBuilder multipleConsumers(String multipleConsumers) {
            doSetProperty("multipleConsumers", multipleConsumers);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default DisruptorEndpointConsumerBuilder waitStrategy(org.apache.camel.component.disruptor.DisruptorWaitStrategy waitStrategy) {
         ...
         * @return the dsl builder
         */
        default DisruptorEndpointConsumerBuilder waitStrategy(String waitStrategy) {
            doSetProperty("waitStrategy", waitStrategy);
            return this;
        }
    }
    ...
    public interface AdvancedDisruptorEndpointConsumerBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedDisruptorEndpointConsumerBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default AdvancedDisruptorEndpointConsumerBuilder bridgeErrorHandler(String bridgeErrorHandler) {
            doSetProperty("bridgeErrorHandler", bridgeErrorHandler);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedDisruptorEndpointConsumerBuilder exceptionHandler(org.apache.camel.spi.ExceptionHandler exceptionHandler) {
         ...
         * @return the dsl builder
         */
        default AdvancedDisruptorEndpointConsumerBuilder exceptionHandler(String exceptionHandler) {
            doSetProperty("exceptionHandler", exceptionHandler);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedDisruptorEndpointConsumerBuilder exchangePattern(org.apache.camel.ExchangePattern exchangePattern) {
         ...
         * @return the dsl builder
         */
        default AdvancedDisruptorEndpointConsumerBuilder exchangePattern(String exchangePattern) {
            doSetProperty("exchangePattern", exchangePattern);
            return this;
        }
    }
    ...
    public interface DisruptorEndpointProducerBuilder
         ...
         * @return the dsl builder
         */
        default DisruptorEndpointProducerBuilder blockWhenFull(boolean blockWhenFull) {
         ...
         * @return the dsl builder
         */
        default DisruptorEndpointProducerBuilder blockWhenFull(String blockWhenFull) {
            doSetProperty("blockWhenFull", blockWhenFull);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default DisruptorEndpointProducerBuilder producerType(org.apache.camel.component.disruptor.DisruptorProducerType producerType) {
         ...
         * @return the dsl builder
         */
        default DisruptorEndpointProducerBuilder producerType(String producerType) {
            doSetProperty("producerType", producerType);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default DisruptorEndpointProducerBuilder waitForTaskToComplete(org.apache.camel.WaitForTaskToComplete waitForTaskToComplete) {
         ...
         * @return the dsl builder
         */
        default DisruptorEndpointProducerBuilder waitForTaskToComplete(String waitForTaskToComplete) {
            doSetProperty("waitForTaskToComplete", waitForTaskToComplete);
            return this;
        }
    }
    ...
    public interface AdvancedDisruptorEndpointProducerBuilder extends EndpointProducerBuilder {
         ...
         * @return the dsl builder
         */
        default AdvancedDisruptorEndpointProducerBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedDisruptorEndpointProducerBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface DisruptorBuilders {
         ...
         * @return the dsl builder
         */
        default DisruptorEndpointBuilder disruptor(String componentName, String path) {
            return DisruptorEndpointBuilderFactory.endpointBuilder(componentName, path);
        }

    }
    static DisruptorEndpointBuilder endpointBuilder(String componentName, String path) {
