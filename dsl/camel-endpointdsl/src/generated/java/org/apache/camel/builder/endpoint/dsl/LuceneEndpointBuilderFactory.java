...
public interface LuceneEndpointBuilderFactory {
    ...
    public interface LuceneEndpointBuilder
         ...
         */
        default LuceneEndpointBuilder analyzer(org.apache.lucene.analysis.Analyzer analyzer) {
    ...
    public interface AdvancedLuceneEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedLuceneEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedLuceneEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
