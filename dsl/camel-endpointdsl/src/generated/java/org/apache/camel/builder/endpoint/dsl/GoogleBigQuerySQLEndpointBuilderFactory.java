...
public interface GoogleBigQuerySQLEndpointBuilderFactory {
    ...
    public interface GoogleBigQuerySQLEndpointBuilder
         ...
         */
        default GoogleBigQuerySQLEndpointBuilder connectionFactory(org.apache.camel.component.google.bigquery.GoogleBigQueryConnectionFactory connectionFactory) {
         ...
         * @return the dsl builder
         */
        default GoogleBigQuerySQLEndpointBuilder connectionFactory(String connectionFactory) {
            doSetProperty("connectionFactory", connectionFactory);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default GoogleBigQuerySQLEndpointBuilder serviceAccountKey(String serviceAccountKey) {
    ...
    /**
     * Advanced builder for endpoint for the Google BigQuery Standard SQL component.
     */
    ...
    public interface GoogleBigQuerySQLBuilders {
         ...
         * @return the dsl builder
         */
        default GoogleBigQuerySQLEndpointBuilder googleBigquerySql(String componentName, String path) {
            return GoogleBigQuerySQLEndpointBuilderFactory.endpointBuilder(componentName, path);
        }

    }
    /**
     * The builder of headers' name for the Google BigQuery Standard SQL component.
     */
    public static class GoogleBigQuerySQLHeaderNameBuilder {
         ...
         */
        public static final GoogleBigQuerySQLHeaderNameBuilder INSTANCE = new GoogleBigQuerySQLHeaderNameBuilder();
