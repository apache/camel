...
public interface JsonPatchEndpointBuilderFactory {
    ...
    public interface JsonPatchEndpointBuilder
         ...
         */
        default JsonPatchEndpointBuilder allowContextMapAll(boolean allowContextMapAll) {
         ...
         * @return the dsl builder
         */
        default JsonPatchEndpointBuilder allowContextMapAll(String allowContextMapAll) {
            doSetProperty("allowContextMapAll", allowContextMapAll);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default JsonPatchEndpointBuilder allowTemplateFromHeader(boolean allowTemplateFromHeader) {
         ...
         * @return the dsl builder
         */
        default JsonPatchEndpointBuilder allowTemplateFromHeader(String allowTemplateFromHeader) {
            doSetProperty("allowTemplateFromHeader", allowTemplateFromHeader);
            return this;
        }
        /**
    ...
    static JsonPatchEndpointBuilder endpointBuilder(String componentName, String path) {
