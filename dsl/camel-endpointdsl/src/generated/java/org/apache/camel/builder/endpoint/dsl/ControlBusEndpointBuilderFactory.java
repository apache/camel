...
public interface ControlBusEndpointBuilderFactory {
    ...
    public interface ControlBusEndpointBuilder
         ...
         * @return the dsl builder
         */
        default ControlBusEndpointBuilder loggingLevel(org.apache.camel.LoggingLevel loggingLevel) {
    ...
    public interface ControlBusBuilders {
         ...
         * @return the dsl builder
         */
        default ControlBusEndpointBuilder controlbus(String componentName, String path) {
            return ControlBusEndpointBuilderFactory.endpointBuilder(componentName, path);
        }

    }
    static ControlBusEndpointBuilder endpointBuilder(String componentName, String path) {
