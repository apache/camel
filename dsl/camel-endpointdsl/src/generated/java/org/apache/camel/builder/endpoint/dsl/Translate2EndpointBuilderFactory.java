...
public interface Translate2EndpointBuilderFactory {
    ...
    public interface Translate2EndpointBuilder
         ...
         */
        default Translate2EndpointBuilder autodetectSourceLanguage(boolean autodetectSourceLanguage) {
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder autodetectSourceLanguage(String autodetectSourceLanguage) {
            doSetProperty("autodetectSourceLanguage", autodetectSourceLanguage);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder operation(org.apache.camel.component.aws2.translate.Translate2Operations operation) {
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder overrideEndpoint(boolean overrideEndpoint) {
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder overrideEndpoint(String overrideEndpoint) {
            doSetProperty("overrideEndpoint", overrideEndpoint);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder uriEndpointOverride(String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder profileCredentialsName(String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder trustAllCertificates(String trustAllCertificates) {
            doSetProperty("trustAllCertificates", trustAllCertificates);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder useDefaultCredentialsProvider(String useDefaultCredentialsProvider) {
            doSetProperty("useDefaultCredentialsProvider", useDefaultCredentialsProvider);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder useProfileCredentialsProvider(String useProfileCredentialsProvider) {
            doSetProperty("useProfileCredentialsProvider", useProfileCredentialsProvider);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder useSessionCredentials(boolean useSessionCredentials) {
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder useSessionCredentials(String useSessionCredentials) {
            doSetProperty("useSessionCredentials", useSessionCredentials);
            return this;
        }
    }
    ...
    public interface AdvancedTranslate2EndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedTranslate2EndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedTranslate2EndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedTranslate2EndpointBuilder translateClient(software.amazon.awssdk.services.translate.TranslateClient translateClient) {
         ...
         * @return the dsl builder
         */
        default AdvancedTranslate2EndpointBuilder translateClient(String translateClient) {
            doSetProperty("translateClient", translateClient);
            return this;
        }
    }
    ...
    public interface Translate2Builders {
         ...
         * @return the dsl builder
         */
        default Translate2EndpointBuilder aws2Translate(String componentName, String path) {
