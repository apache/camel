...
public interface KubernetesJobEndpointBuilderFactory {
    ...
    public interface KubernetesJobEndpointBuilder
         ...
         * @return the dsl builder
         */
        default KubernetesJobEndpointBuilder kubernetesClient(io.fabric8.kubernetes.client.KubernetesClient kubernetesClient) {
         ...
         * @return the dsl builder
         */
        default KubernetesJobEndpointBuilder kubernetesClient(String kubernetesClient) {
            doSetProperty("kubernetesClient", kubernetesClient);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default KubernetesJobEndpointBuilder clientCertData(String clientCertData) {
         ...
         * @return the dsl builder
         */
        default KubernetesJobEndpointBuilder clientCertFile(String clientCertFile) {
         ...
         * @return the dsl builder
         */
        default KubernetesJobEndpointBuilder clientKeyPassphrase(String clientKeyPassphrase) {
    ...
    public interface AdvancedKubernetesJobEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedKubernetesJobEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedKubernetesJobEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedKubernetesJobEndpointBuilder connectionTimeout(Integer connectionTimeout) {
         ...
         * @return the dsl builder
         */
        default AdvancedKubernetesJobEndpointBuilder connectionTimeout(String connectionTimeout) {
            doSetProperty("connectionTimeout", connectionTimeout);
            return this;
        }
    }
    ...
    public interface KubernetesJobBuilders {
         ...
         * @return the dsl builder
         */
        default KubernetesJobEndpointBuilder kubernetesJob(String componentName, String path) {
    ...
    public static class KubernetesJobHeaderNameBuilder {
         ...
         */
        public static final KubernetesJobHeaderNameBuilder INSTANCE = new KubernetesJobHeaderNameBuilder();
