...
public interface IAMEndpointBuilderFactory {
    ...
    public interface IAMEndpointBuilder
         ...
         * @return the dsl builder
         */
        default IAMEndpointBuilder serviceKeys(org.apache.camel.component.huaweicloud.common.models.ServiceKeys serviceKeys) {
    ...
    /**
     * Advanced builder for endpoint for the Huawei Identity and Access Management (IAM) component.
     */
    public interface AdvancedIAMEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedIAMEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedIAMEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
