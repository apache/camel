...
public interface MetricsEndpointBuilderFactory {
    ...
    public interface MetricsEndpointBuilder
         ...
         */
        default MetricsEndpointBuilder action(org.apache.camel.component.metrics.MetricsTimerAction action) {
    ...
    public interface AdvancedMetricsEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedMetricsEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedMetricsEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    static MetricsEndpointBuilder endpointBuilder(String componentName, String path) {
