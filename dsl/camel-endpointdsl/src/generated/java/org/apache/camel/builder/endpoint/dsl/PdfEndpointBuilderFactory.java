...
public interface PdfEndpointBuilderFactory {
    ...
    public interface PdfEndpointBuilder
         ...
         * @return the dsl builder
         */
        default PdfEndpointBuilder textProcessingFactory(org.apache.camel.component.pdf.TextProcessingFactory textProcessingFactory) {
         ...
         * @return the dsl builder
         */
        default PdfEndpointBuilder textProcessingFactory(String textProcessingFactory) {
            doSetProperty("textProcessingFactory", textProcessingFactory);
            return this;
        }
    }
    ...
    public interface AdvancedPdfEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedPdfEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedPdfEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
