...
public interface LangChain4jEmbeddingsEndpointBuilderFactory {
    ...
    public interface LangChain4jEmbeddingsEndpointBuilder
         ...
         */
        default LangChain4jEmbeddingsEndpointBuilder embeddingModel(
    ...
    public interface AdvancedLangChain4jEmbeddingsEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedLangChain4jEmbeddingsEndpointBuilder lazyStartProducer(
    ...
    public interface LangChain4jEmbeddingsBuilders {
         ...
         * @return the dsl builder
         */
        default LangChain4jEmbeddingsEndpointBuilder langchain4jEmbeddings(
                String path) {
    ...
    static LangChain4jEmbeddingsEndpointBuilder endpointBuilder(
            String componentName,
            String path) {
