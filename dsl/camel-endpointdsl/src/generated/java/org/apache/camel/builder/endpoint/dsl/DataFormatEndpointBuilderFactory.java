...
public interface DataFormatEndpointBuilderFactory {
    ...
    public interface AdvancedDataFormatEndpointBuilder
         ...
         */
        default AdvancedDataFormatEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedDataFormatEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface DataFormatBuilders {
         ...
         * @return the dsl builder
         */
        default DataFormatEndpointBuilder dataformat(String componentName, String path) {
            return DataFormatEndpointBuilderFactory.endpointBuilder(componentName, path);
        }

    }
    static DataFormatEndpointBuilder endpointBuilder(String componentName, String path) {
