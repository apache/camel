...
public interface GlanceEndpointBuilderFactory {
    ...
    public interface GlanceEndpointBuilder
         ...
         * @return the dsl builder
         */
        default GlanceEndpointBuilder config(org.openstack4j.core.transport.Config config) {
    ...
    public interface AdvancedGlanceEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedGlanceEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedGlanceEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface GlanceBuilders {
         ...
         * @return the dsl builder
         */
        default GlanceEndpointBuilder openstackGlance(String componentName, String path) {
