...
public interface WorkdayEndpointBuilderFactory {
    ...
    public interface AdvancedWorkdayEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedWorkdayEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedWorkdayEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedWorkdayEndpointBuilder httpConnectionManager(org.apache.hc.client5.http.impl.io.PoolingHttpClientConnectionManager httpConnectionManager) {
         ...
         * @return the dsl builder
         */
        default AdvancedWorkdayEndpointBuilder httpConnectionManager(String httpConnectionManager) {
            doSetProperty("httpConnectionManager", httpConnectionManager);
            return this;
        }
    }
    ...
    static WorkdayEndpointBuilder endpointBuilder(String componentName, String path) {
