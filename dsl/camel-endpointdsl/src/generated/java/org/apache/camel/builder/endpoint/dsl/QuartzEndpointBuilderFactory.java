...
public interface QuartzEndpointBuilderFactory {
    ...
    public interface QuartzEndpointBuilder
         ...
         * @return the dsl builder
         */
        default QuartzEndpointBuilder autoStartScheduler(boolean autoStartScheduler) {
         ...
         * @return the dsl builder
         */
        default QuartzEndpointBuilder autoStartScheduler(String autoStartScheduler) {
            doSetProperty("autoStartScheduler", autoStartScheduler);
            return this;
        }
        /**
    ...
    static QuartzEndpointBuilder endpointBuilder(String componentName, String path) {
