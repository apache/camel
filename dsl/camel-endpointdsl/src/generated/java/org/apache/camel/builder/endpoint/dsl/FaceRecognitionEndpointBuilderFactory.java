...
public interface FaceRecognitionEndpointBuilderFactory {
    ...
    public interface FaceRecognitionEndpointBuilder
         ...
         * @return the dsl builder
         */
        default FaceRecognitionEndpointBuilder anotherImageBase64(String anotherImageBase64) {
         ...
         * @return the dsl builder
         */
        default FaceRecognitionEndpointBuilder anotherImageFilePath(String anotherImageFilePath) {
         ...
         * @return the dsl builder
         */
        default FaceRecognitionEndpointBuilder anotherImageUrl(String anotherImageUrl) {
         ...
         * @return the dsl builder
         */
        default FaceRecognitionEndpointBuilder imageFilePath(String imageFilePath) {
         ...
         * @return the dsl builder
         */
        default FaceRecognitionEndpointBuilder proxyPassword(String proxyPassword) {
         ...
         * @return the dsl builder
         */
        default FaceRecognitionEndpointBuilder serviceKeys(org.apache.camel.component.huaweicloud.common.models.ServiceKeys serviceKeys) {
         ...
         * @return the dsl builder
         */
        default FaceRecognitionEndpointBuilder videoFilePath(String videoFilePath) {
         ...
         * @return the dsl builder
         */
        default FaceRecognitionEndpointBuilder ignoreSslVerification(boolean ignoreSslVerification) {
         ...
         * @return the dsl builder
         */
        default FaceRecognitionEndpointBuilder ignoreSslVerification(String ignoreSslVerification) {
            doSetProperty("ignoreSslVerification", ignoreSslVerification);
            return this;
        }
    }
    ...
    /**
     * Advanced builder for endpoint for the Huawei Cloud Face Recognition Service (FRS) component.
     */
    public interface AdvancedFaceRecognitionEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedFaceRecognitionEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedFaceRecognitionEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface FaceRecognitionBuilders {
         ...
         * @return the dsl builder
         */
        default FaceRecognitionEndpointBuilder hwcloudFrs(String componentName, String path) {
            return FaceRecognitionEndpointBuilderFactory.endpointBuilder(componentName, path);
        }

    }
    static FaceRecognitionEndpointBuilder endpointBuilder(String componentName, String path) {
