...
public interface WasmEndpointBuilderFactory {
     ...
     */
    public interface WasmEndpointBuilder
            extends
    ...
    public interface AdvancedWasmEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedWasmEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedWasmEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
