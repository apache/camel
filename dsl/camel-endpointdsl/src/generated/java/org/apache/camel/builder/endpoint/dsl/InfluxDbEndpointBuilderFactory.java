...
public interface InfluxDbEndpointBuilderFactory {
    ...
    public interface InfluxDbEndpointBuilder
         ...
         */
        default InfluxDbEndpointBuilder autoCreateDatabase(boolean autoCreateDatabase) {
         ...
         * @return the dsl builder
         */
        default InfluxDbEndpointBuilder autoCreateDatabase(String autoCreateDatabase) {
            doSetProperty("autoCreateDatabase", autoCreateDatabase);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default InfluxDbEndpointBuilder checkDatabaseExistence(boolean checkDatabaseExistence) {
         ...
         * @return the dsl builder
         */
        default InfluxDbEndpointBuilder checkDatabaseExistence(String checkDatabaseExistence) {
            doSetProperty("checkDatabaseExistence", checkDatabaseExistence);
            return this;
        }
        /**
    ...
    public interface AdvancedInfluxDbEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedInfluxDbEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedInfluxDbEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface InfluxDbBuilders {
         ...
         * @return the dsl builder
         */
        default InfluxDbEndpointBuilder influxdb(String componentName, String path) {
    ...
    static InfluxDbEndpointBuilder endpointBuilder(String componentName, String path) {
