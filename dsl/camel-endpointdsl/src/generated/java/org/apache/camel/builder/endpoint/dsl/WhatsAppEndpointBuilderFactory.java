...
public interface WhatsAppEndpointBuilderFactory {
    ...
    public interface AdvancedWhatsAppEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedWhatsAppEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedWhatsAppEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedWhatsAppEndpointBuilder httpClient(java.net.http.HttpClient httpClient) {
         ...
         * @return the dsl builder
         */
        default AdvancedWhatsAppEndpointBuilder whatsappService(org.apache.camel.component.whatsapp.WhatsAppService whatsappService) {
         ...
         * @return the dsl builder
         */
        default AdvancedWhatsAppEndpointBuilder whatsappService(String whatsappService) {
            doSetProperty("whatsappService", whatsappService);
            return this;
        }
    }
    ...
    public interface WhatsAppBuilders {
         ...
         * @return the dsl builder
         */
        default WhatsAppEndpointBuilder whatsapp(String componentName, String path) {
