...
public interface DnsEndpointBuilderFactory {
    ...
    public interface AdvancedDnsEndpointBuilder
         ...
         */
        default AdvancedDnsEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedDnsEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
