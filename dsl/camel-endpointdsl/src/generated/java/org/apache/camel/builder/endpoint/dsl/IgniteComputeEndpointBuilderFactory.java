...
public interface IgniteComputeEndpointBuilderFactory {
    ...
    public interface IgniteComputeEndpointBuilder
         ...
         */
        default IgniteComputeEndpointBuilder clusterGroupExpression(org.apache.camel.component.ignite.ClusterGroupExpression clusterGroupExpression) {
         ...
         * @return the dsl builder
         */
        default IgniteComputeEndpointBuilder clusterGroupExpression(String clusterGroupExpression) {
            doSetProperty("clusterGroupExpression", clusterGroupExpression);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default IgniteComputeEndpointBuilder executionType(org.apache.camel.component.ignite.compute.IgniteComputeExecutionType executionType) {
         ...
         * @return the dsl builder
         */
        default IgniteComputeEndpointBuilder propagateIncomingBodyIfNoReturnValue(boolean propagateIncomingBodyIfNoReturnValue) {
         ...
         * @return the dsl builder
         */
        default IgniteComputeEndpointBuilder propagateIncomingBodyIfNoReturnValue(String propagateIncomingBodyIfNoReturnValue) {
            doSetProperty("propagateIncomingBodyIfNoReturnValue", propagateIncomingBodyIfNoReturnValue);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default IgniteComputeEndpointBuilder treatCollectionsAsCacheObjects(boolean treatCollectionsAsCacheObjects) {
         ...
         * @return the dsl builder
         */
        default IgniteComputeEndpointBuilder treatCollectionsAsCacheObjects(String treatCollectionsAsCacheObjects) {
            doSetProperty("treatCollectionsAsCacheObjects", treatCollectionsAsCacheObjects);
            return this;
        }
    }
    ...
    public interface AdvancedIgniteComputeEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedIgniteComputeEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedIgniteComputeEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    static IgniteComputeEndpointBuilder endpointBuilder(String componentName, String path) {
