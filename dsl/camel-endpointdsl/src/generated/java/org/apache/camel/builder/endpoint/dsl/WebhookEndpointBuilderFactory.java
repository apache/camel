...
public interface WebhookEndpointBuilderFactory {
    ...
    public interface WebhookEndpointBuilder
         ...
         */
        default WebhookEndpointBuilder webhookAutoRegister(boolean webhookAutoRegister) {
         ...
         * @return the dsl builder
         */
        default WebhookEndpointBuilder webhookAutoRegister(String webhookAutoRegister) {
            doSetProperty("webhookAutoRegister", webhookAutoRegister);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default WebhookEndpointBuilder webhookComponentName(String webhookComponentName) {
         ...
         * @return the dsl builder
         */
        default WebhookEndpointBuilder webhookExternalUrl(String webhookExternalUrl) {
    ...
    public interface AdvancedWebhookEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedWebhookEndpointBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default AdvancedWebhookEndpointBuilder bridgeErrorHandler(String bridgeErrorHandler) {
            doSetProperty("bridgeErrorHandler", bridgeErrorHandler);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedWebhookEndpointBuilder exceptionHandler(org.apache.camel.spi.ExceptionHandler exceptionHandler) {
         ...
         * @return the dsl builder
         */
        default AdvancedWebhookEndpointBuilder exceptionHandler(String exceptionHandler) {
            doSetProperty("exceptionHandler", exceptionHandler);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedWebhookEndpointBuilder exchangePattern(org.apache.camel.ExchangePattern exchangePattern) {
         ...
         * @return the dsl builder
         */
        default AdvancedWebhookEndpointBuilder exchangePattern(String exchangePattern) {
            doSetProperty("exchangePattern", exchangePattern);
            return this;
        }
    }
    ...
    static WebhookEndpointBuilder endpointBuilder(String componentName, String path) {
