...
public interface FreemarkerEndpointBuilderFactory {
    ...
    public interface FreemarkerEndpointBuilder
         ...
         */
        default FreemarkerEndpointBuilder allowContextMapAll(boolean allowContextMapAll) {
         ...
         * @return the dsl builder
         */
        default FreemarkerEndpointBuilder allowContextMapAll(String allowContextMapAll) {
            doSetProperty("allowContextMapAll", allowContextMapAll);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default FreemarkerEndpointBuilder allowTemplateFromHeader(boolean allowTemplateFromHeader) {
         ...
         * @return the dsl builder
         */
        default FreemarkerEndpointBuilder allowTemplateFromHeader(String allowTemplateFromHeader) {
            doSetProperty("allowTemplateFromHeader", allowTemplateFromHeader);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default FreemarkerEndpointBuilder configuration(freemarker.template.Configuration configuration) {
         ...
         * @return the dsl builder
         */
        default FreemarkerEndpointBuilder templateUpdateDelay(int templateUpdateDelay) {
         ...
         * @return the dsl builder
         */
        default FreemarkerEndpointBuilder templateUpdateDelay(String templateUpdateDelay) {
            doSetProperty("templateUpdateDelay", templateUpdateDelay);
            return this;
        }
    }
    ...
    public interface FreemarkerBuilders {
         ...
         * @return the dsl builder
         */
        default FreemarkerEndpointBuilder freemarker(String componentName, String path) {
