...
public interface SimpleNotificationEndpointBuilderFactory {
    ...
    public interface SimpleNotificationEndpointBuilder
         ...
         * @return the dsl builder
         */
        default SimpleNotificationEndpointBuilder proxyPassword(String proxyPassword) {
         ...
         * @return the dsl builder
         */
        default SimpleNotificationEndpointBuilder serviceKeys(org.apache.camel.component.huaweicloud.common.models.ServiceKeys serviceKeys) {
    ...
    /**
     * Advanced builder for endpoint for the Huawei Simple Message Notification (SMN) component.
     */
    public interface AdvancedSimpleNotificationEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedSimpleNotificationEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedSimpleNotificationEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface SimpleNotificationBuilders {
         ...
         * @return the dsl builder
         */
        default SimpleNotificationEndpointBuilder hwcloudSmn(String componentName, String path) {
            return SimpleNotificationEndpointBuilderFactory.endpointBuilder(componentName, path);
        }

    }
    static SimpleNotificationEndpointBuilder endpointBuilder(String componentName, String path) {
