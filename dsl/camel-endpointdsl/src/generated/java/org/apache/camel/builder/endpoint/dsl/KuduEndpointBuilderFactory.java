...
public interface KuduEndpointBuilderFactory {
    ...
    public interface KuduEndpointBuilder
         ...
         */
        default KuduEndpointBuilder operation(org.apache.camel.component.kudu.KuduOperations operation) {
    ...
    public interface AdvancedKuduEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedKuduEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedKuduEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
