...
public interface MSK2EndpointBuilderFactory {
     ...
     */
    public interface MSK2EndpointBuilder
            extends
         ...
         */
        default MSK2EndpointBuilder operation(org.apache.camel.component.aws2.msk.MSK2Operations operation) {
         ...
         * @return the dsl builder
         */
        default MSK2EndpointBuilder uriEndpointOverride(String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default MSK2EndpointBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default MSK2EndpointBuilder profileCredentialsName(String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default MSK2EndpointBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default MSK2EndpointBuilder trustAllCertificates(String trustAllCertificates) {
            doSetProperty("trustAllCertificates", trustAllCertificates);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default MSK2EndpointBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default MSK2EndpointBuilder useDefaultCredentialsProvider(String useDefaultCredentialsProvider) {
            doSetProperty("useDefaultCredentialsProvider", useDefaultCredentialsProvider);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default MSK2EndpointBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default MSK2EndpointBuilder useProfileCredentialsProvider(String useProfileCredentialsProvider) {
            doSetProperty("useProfileCredentialsProvider", useProfileCredentialsProvider);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default MSK2EndpointBuilder useSessionCredentials(boolean useSessionCredentials) {
         ...
         * @return the dsl builder
         */
        default MSK2EndpointBuilder useSessionCredentials(String useSessionCredentials) {
            doSetProperty("useSessionCredentials", useSessionCredentials);
            return this;
        }
    }
    ...
    /**
     * Advanced builder for endpoint for the AWS Managed Streaming for Apache Kafka (MSK) component.
     */
    public interface AdvancedMSK2EndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedMSK2EndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedMSK2EndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedMSK2EndpointBuilder mskClient(software.amazon.awssdk.services.kafka.KafkaClient mskClient) {
