...
public interface IAM2EndpointBuilderFactory {
     ...
     */
    public interface IAM2EndpointBuilder
            extends
    ...
    public interface AdvancedIAM2EndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedIAM2EndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedIAM2EndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
