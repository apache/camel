...
public interface HazelcastAtomicnumberEndpointBuilderFactory {
    ...
    public interface AdvancedHazelcastAtomicnumberEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedHazelcastAtomicnumberEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedHazelcastAtomicnumberEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    static HazelcastAtomicnumberEndpointBuilder endpointBuilder(String componentName, String path) {
