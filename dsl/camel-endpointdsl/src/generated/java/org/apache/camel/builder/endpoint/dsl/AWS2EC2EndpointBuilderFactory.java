...
public interface AWS2EC2EndpointBuilderFactory {
     ...
     */
    public interface AWS2EC2EndpointBuilder
            extends
         ...
         */
        default AWS2EC2EndpointBuilder amazonEc2Client(software.amazon.awssdk.services.ec2.Ec2Client amazonEc2Client) {
         ...
         * @return the dsl builder
         */
        default AWS2EC2EndpointBuilder operation(org.apache.camel.component.aws2.ec2.AWS2EC2Operations operation) {
         ...
         * @return the dsl builder
         */
        default AWS2EC2EndpointBuilder uriEndpointOverride(String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default AWS2EC2EndpointBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default AWS2EC2EndpointBuilder profileCredentialsName(String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default AWS2EC2EndpointBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default AWS2EC2EndpointBuilder trustAllCertificates(String trustAllCertificates) {
            doSetProperty("trustAllCertificates", trustAllCertificates);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AWS2EC2EndpointBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default AWS2EC2EndpointBuilder useDefaultCredentialsProvider(String useDefaultCredentialsProvider) {
            doSetProperty("useDefaultCredentialsProvider", useDefaultCredentialsProvider);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AWS2EC2EndpointBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default AWS2EC2EndpointBuilder useProfileCredentialsProvider(String useProfileCredentialsProvider) {
            doSetProperty("useProfileCredentialsProvider", useProfileCredentialsProvider);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AWS2EC2EndpointBuilder useSessionCredentials(boolean useSessionCredentials) {
         ...
         * @return the dsl builder
         */
        default AWS2EC2EndpointBuilder useSessionCredentials(String useSessionCredentials) {
            doSetProperty("useSessionCredentials", useSessionCredentials);
            return this;
        }
    }
    ...
    /**
     * Advanced builder for endpoint for the AWS Elastic Compute Cloud (EC2) component.
     */
    public interface AdvancedAWS2EC2EndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedAWS2EC2EndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedAWS2EC2EndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
