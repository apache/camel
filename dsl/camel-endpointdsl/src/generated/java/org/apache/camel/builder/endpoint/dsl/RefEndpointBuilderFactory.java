...
public interface RefEndpointBuilderFactory {
    ...
    public interface AdvancedRefEndpointProducerBuilder extends EndpointProducerBuilder {
         ...
         * @return the dsl builder
         */
        default AdvancedRefEndpointProducerBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedRefEndpointProducerBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
