...
public interface HyperledgerAriesEndpointBuilderFactory {
    ...
    public interface HyperledgerAriesEndpointBuilder
         ...
         * @return the dsl builder
         */
        default HyperledgerAriesEndpointBuilder lazyStartProducer(
    ...
    static HyperledgerAriesEndpointBuilder endpointBuilder(
            String componentName,
            String path) {
        class HyperledgerAriesEndpointBuilderImpl extends AbstractEndpointBuilder implements HyperledgerAriesEndpointBuilder {
