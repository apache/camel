...
public interface ECS2EndpointBuilderFactory {
    ...
    /**
     * Builder for endpoint for the AWS Elastic Container Service (ECS) component.
     */
    public interface ECS2EndpointBuilder
            extends
         ...
         */
        default ECS2EndpointBuilder operation(org.apache.camel.component.aws2.ecs.ECS2Operations operation) {
         ...
         * @return the dsl builder
         */
        default ECS2EndpointBuilder uriEndpointOverride(String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default ECS2EndpointBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default ECS2EndpointBuilder profileCredentialsName(String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default ECS2EndpointBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default ECS2EndpointBuilder trustAllCertificates(String trustAllCertificates) {
            doSetProperty("trustAllCertificates", trustAllCertificates);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default ECS2EndpointBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default ECS2EndpointBuilder useDefaultCredentialsProvider(String useDefaultCredentialsProvider) {
            doSetProperty("useDefaultCredentialsProvider", useDefaultCredentialsProvider);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default ECS2EndpointBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default ECS2EndpointBuilder useProfileCredentialsProvider(String useProfileCredentialsProvider) {
            doSetProperty("useProfileCredentialsProvider", useProfileCredentialsProvider);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default ECS2EndpointBuilder useSessionCredentials(boolean useSessionCredentials) {
         ...
         * @return the dsl builder
         */
        default ECS2EndpointBuilder useSessionCredentials(String useSessionCredentials) {
            doSetProperty("useSessionCredentials", useSessionCredentials);
            return this;
        }
    }
    ...
    /**
     * Advanced builder for endpoint for the AWS Elastic Container Service (ECS) component.
     */
    public interface AdvancedECS2EndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedECS2EndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedECS2EndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedECS2EndpointBuilder ecsClient(software.amazon.awssdk.services.ecs.EcsClient ecsClient) {
    ...
    public static class ECS2HeaderNameBuilder {
         ...
         */
        public static final ECS2HeaderNameBuilder INSTANCE = new ECS2HeaderNameBuilder();
