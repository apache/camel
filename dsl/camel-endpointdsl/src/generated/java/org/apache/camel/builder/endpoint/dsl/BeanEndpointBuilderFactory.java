...
public interface BeanEndpointBuilderFactory {
    ...
    public interface AdvancedBeanEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedBeanEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedBeanEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
