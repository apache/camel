...
public interface MyBatisBeanEndpointBuilderFactory {
    ...
    public interface AdvancedMyBatisBeanEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedMyBatisBeanEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedMyBatisBeanEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    static MyBatisBeanEndpointBuilder endpointBuilder(String componentName, String path) {
