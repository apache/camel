...
public interface IgniteIdGenEndpointBuilderFactory {
    ...
    public interface IgniteIdGenEndpointBuilder
         ...
         * @return the dsl builder
         */
        default IgniteIdGenEndpointBuilder operation(org.apache.camel.component.ignite.idgen.IgniteIdGenOperation operation) {
         ...
         * @return the dsl builder
         */
        default IgniteIdGenEndpointBuilder propagateIncomingBodyIfNoReturnValue(boolean propagateIncomingBodyIfNoReturnValue) {
         ...
         * @return the dsl builder
         */
        default IgniteIdGenEndpointBuilder propagateIncomingBodyIfNoReturnValue(String propagateIncomingBodyIfNoReturnValue) {
            doSetProperty("propagateIncomingBodyIfNoReturnValue", propagateIncomingBodyIfNoReturnValue);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default IgniteIdGenEndpointBuilder treatCollectionsAsCacheObjects(boolean treatCollectionsAsCacheObjects) {
         ...
         * @return the dsl builder
         */
        default IgniteIdGenEndpointBuilder treatCollectionsAsCacheObjects(String treatCollectionsAsCacheObjects) {
            doSetProperty("treatCollectionsAsCacheObjects", treatCollectionsAsCacheObjects);
            return this;
        }
    }
    ...
    public interface AdvancedIgniteIdGenEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedIgniteIdGenEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedIgniteIdGenEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    static IgniteIdGenEndpointBuilder endpointBuilder(String componentName, String path) {
