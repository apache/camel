...
public interface GridFsEndpointBuilderFactory {
    ...
    public interface GridFsEndpointConsumerBuilder
         ...
         * @return the dsl builder
         */
        default GridFsEndpointConsumerBuilder fileAttributeName(String fileAttributeName) {
         ...
         * @return the dsl builder
         */
        default GridFsEndpointConsumerBuilder persistentTSCollection(String persistentTSCollection) {
         ...
         * @return the dsl builder
         */
        default GridFsEndpointConsumerBuilder persistentTSObject(String persistentTSObject) {
         ...
         * @return the dsl builder
         */
        default GridFsEndpointConsumerBuilder queryStrategy(org.apache.camel.component.mongodb.gridfs.QueryStrategy queryStrategy) {
    ...
    public interface GridFsEndpointProducerBuilder
         ...
         * @return the dsl builder
         */
        default GridFsEndpointProducerBuilder readPreference(com.mongodb.ReadPreference readPreference) {
            doSetProperty("readPreference", readPreference);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default GridFsEndpointProducerBuilder readPreference(String readPreference) {
            doSetProperty("readPreference", readPreference);
            return this;
        }
        /**
    ...
    public interface AdvancedGridFsEndpointProducerBuilder extends EndpointProducerBuilder {
         ...
         * @return the dsl builder
         */
        default AdvancedGridFsEndpointProducerBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedGridFsEndpointProducerBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface GridFsEndpointBuilder
         ...
         * @return the dsl builder
         */
        default GridFsEndpointBuilder readPreference(com.mongodb.ReadPreference readPreference) {
            doSetProperty("readPreference", readPreference);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default GridFsEndpointBuilder writeConcern(com.mongodb.WriteConcern writeConcern) {
            doSetProperty("writeConcern", writeConcern);
            return this;
        }
        /**
    ...
    public interface GridFsBuilders {
         ...
         * @return the dsl builder
         */
        default GridFsEndpointBuilder mongodbGridfs(String componentName, String path) {
