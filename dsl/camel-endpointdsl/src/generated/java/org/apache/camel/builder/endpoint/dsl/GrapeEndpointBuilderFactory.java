...
public interface GrapeEndpointBuilderFactory {
    ...
    public interface AdvancedGrapeEndpointBuilder
         ...
         */
        default AdvancedGrapeEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedGrapeEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    static GrapeEndpointBuilder endpointBuilder(String componentName, String path) {
