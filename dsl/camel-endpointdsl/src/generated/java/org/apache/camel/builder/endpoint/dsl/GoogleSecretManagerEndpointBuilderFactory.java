...
public interface GoogleSecretManagerEndpointBuilderFactory {
    ...
    public interface GoogleSecretManagerEndpointBuilder
         ...
         */
        default GoogleSecretManagerEndpointBuilder serviceAccountKey(String serviceAccountKey) {
         ...
         * @return the dsl builder
         */
        default GoogleSecretManagerEndpointBuilder operation(org.apache.camel.component.google.secret.manager.GoogleSecretManagerOperations operation) {
         ...
         * @return the dsl builder
         */
        default GoogleSecretManagerEndpointBuilder pojoRequest(boolean pojoRequest) {
         ...
         * @return the dsl builder
         */
        default GoogleSecretManagerEndpointBuilder pojoRequest(String pojoRequest) {
            doSetProperty("pojoRequest", pojoRequest);
            return this;
        }
    }
    ...
    public interface AdvancedGoogleSecretManagerEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedGoogleSecretManagerEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedGoogleSecretManagerEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedGoogleSecretManagerEndpointBuilder client(com.google.cloud.secretmanager.v1.SecretManagerServiceClient client) {
    ...
    static GoogleSecretManagerEndpointBuilder endpointBuilder(String componentName, String path) {
