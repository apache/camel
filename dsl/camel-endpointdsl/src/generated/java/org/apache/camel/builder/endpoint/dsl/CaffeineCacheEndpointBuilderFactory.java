...
public interface CaffeineCacheEndpointBuilderFactory {
    ...
    public interface CaffeineCacheEndpointBuilder
         ...
         * @return the dsl builder
         */
        default CaffeineCacheEndpointBuilder createCacheIfNotExist(boolean createCacheIfNotExist) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheEndpointBuilder createCacheIfNotExist(String createCacheIfNotExist) {
            doSetProperty("createCacheIfNotExist", createCacheIfNotExist);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default CaffeineCacheEndpointBuilder evictionType(org.apache.camel.component.caffeine.EvictionType evictionType) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheEndpointBuilder expireAfterAccessTime(int expireAfterAccessTime) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheEndpointBuilder expireAfterAccessTime(String expireAfterAccessTime) {
            doSetProperty("expireAfterAccessTime", expireAfterAccessTime);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default CaffeineCacheEndpointBuilder expireAfterWriteTime(int expireAfterWriteTime) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheEndpointBuilder expireAfterWriteTime(String expireAfterWriteTime) {
            doSetProperty("expireAfterWriteTime", expireAfterWriteTime);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default CaffeineCacheEndpointBuilder initialCapacity(Integer initialCapacity) {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheEndpointBuilder initialCapacity(String initialCapacity) {
            doSetProperty("initialCapacity", initialCapacity);
            return this;
        }
        /**
    ...
    public interface AdvancedCaffeineCacheEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedCaffeineCacheEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedCaffeineCacheEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedCaffeineCacheEndpointBuilder cacheLoader(com.github.benmanes.caffeine.cache.CacheLoader cacheLoader) {
         ...
         * @return the dsl builder
         */
        default AdvancedCaffeineCacheEndpointBuilder cacheLoader(String cacheLoader) {
            doSetProperty("cacheLoader", cacheLoader);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedCaffeineCacheEndpointBuilder removalListener(com.github.benmanes.caffeine.cache.RemovalListener removalListener) {
         ...
         * @return the dsl builder
         */
        default AdvancedCaffeineCacheEndpointBuilder removalListener(String removalListener) {
            doSetProperty("removalListener", removalListener);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedCaffeineCacheEndpointBuilder statsCounter(com.github.benmanes.caffeine.cache.stats.StatsCounter statsCounter) {
         ...
         * @return the dsl builder
         */
        default AdvancedCaffeineCacheEndpointBuilder statsCounter(String statsCounter) {
            doSetProperty("statsCounter", statsCounter);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedCaffeineCacheEndpointBuilder statsEnabled(boolean statsEnabled) {
         ...
         * @return the dsl builder
         */
        default AdvancedCaffeineCacheEndpointBuilder statsEnabled(String statsEnabled) {
            doSetProperty("statsEnabled", statsEnabled);
            return this;
        }
        /**
    ...
    public interface CaffeineCacheBuilders {
         ...
         * @return the dsl builder
         */
        default CaffeineCacheEndpointBuilder caffeineCache(String componentName, String path) {
    ...
    public static class CaffeineCacheHeaderNameBuilder {
         ...
         */
        public static final CaffeineCacheHeaderNameBuilder INSTANCE = new CaffeineCacheHeaderNameBuilder();
    ...
    static CaffeineCacheEndpointBuilder endpointBuilder(String componentName, String path) {
