...
public interface YammerEndpointBuilderFactory {
    ...
    public interface AdvancedYammerEndpointConsumerBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedYammerEndpointConsumerBuilder requestor(
    ...
    public interface AdvancedYammerEndpointProducerBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedYammerEndpointProducerBuilder requestor(
                org.apache.camel.component.yammer.ApiRequestor requestor) {
            doSetProperty("requestor", requestor);
            return this;
        }
    ...
    public interface AdvancedYammerEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedYammerEndpointBuilder requestor(
                org.apache.camel.component.yammer.ApiRequestor requestor) {
            doSetProperty("requestor", requestor);
            return this;
        }
