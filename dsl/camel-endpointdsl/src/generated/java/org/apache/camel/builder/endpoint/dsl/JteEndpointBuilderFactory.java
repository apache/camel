...
public interface JteEndpointBuilderFactory {
     ...
     */
    public interface JteEndpointBuilder extends EndpointProducerBuilder {
         ...
         * @return the dsl builder
         */
        default JteEndpointBuilder allowTemplateFromHeader(
    ...
    public interface AdvancedJteEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedJteEndpointBuilder lazyStartProducer(
