...
public interface TikaEndpointBuilderFactory {
    ...
    public interface TikaEndpointBuilder
         ...
         */
        default TikaEndpointBuilder tikaParseOutputEncoding(String tikaParseOutputEncoding) {
         ...
         * @return the dsl builder
         */
        default TikaEndpointBuilder tikaParseOutputFormat(org.apache.camel.component.tika.TikaParseOutputFormat tikaParseOutputFormat) {
         ...
         * @return the dsl builder
         */
        default TikaEndpointBuilder tikaParseOutputFormat(String tikaParseOutputFormat) {
            doSetProperty("tikaParseOutputFormat", tikaParseOutputFormat);
            return this;
        }
    }
    ...
    public interface AdvancedTikaEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedTikaEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedTikaEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
