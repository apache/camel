...
public interface KeystoneEndpointBuilderFactory {
    ...
    public interface KeystoneEndpointBuilder
         ...
         */
        default KeystoneEndpointBuilder config(org.openstack4j.core.transport.Config config) {
    ...
    public interface AdvancedKeystoneEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedKeystoneEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedKeystoneEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface KeystoneBuilders {
         ...
         * @return the dsl builder
         */
        default KeystoneEndpointBuilder openstackKeystone(String componentName, String path) {
    ...
    public static class KeystoneHeaderNameBuilder {
         ...
         */
        public static final KeystoneHeaderNameBuilder INSTANCE = new KeystoneHeaderNameBuilder();
