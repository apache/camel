...
public interface JcrEndpointBuilderFactory {
    ...
    public interface JcrEndpointConsumerBuilder
        ...
        /**
         * When &lt;code&gt;isDeep is true, events whose associated parent node
         * is at &lt;code&gt;absPath or within its subgraph are received.
         * 
        ...
        /**
         * &lt;code&gt;eventTypes (a combination of one or more event types
         * encoded as a bit mask value such as
        ...
        /**
         * When a comma separated &lt;code&gt;nodeTypeName list string is set,
         * only events whose associated parent node has one of the node types
         * (or a subtype of one of the node types) in this list will be
         * received.
         * 
        ...
        /**
         * If &lt;code&gt;noLocal is &lt;code&gt;true, then events generated by
