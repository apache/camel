...
public interface ZooKeeperMasterEndpointBuilderFactory {
    ...
    public interface AdvancedZooKeeperMasterEndpointBuilder
         ...
         */
        default AdvancedZooKeeperMasterEndpointBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default AdvancedZooKeeperMasterEndpointBuilder bridgeErrorHandler(String bridgeErrorHandler) {
            doSetProperty("bridgeErrorHandler", bridgeErrorHandler);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedZooKeeperMasterEndpointBuilder exceptionHandler(org.apache.camel.spi.ExceptionHandler exceptionHandler) {
         ...
         * @return the dsl builder
         */
        default AdvancedZooKeeperMasterEndpointBuilder exceptionHandler(String exceptionHandler) {
            doSetProperty("exceptionHandler", exceptionHandler);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedZooKeeperMasterEndpointBuilder exchangePattern(org.apache.camel.ExchangePattern exchangePattern) {
         ...
         * @return the dsl builder
         */
        default AdvancedZooKeeperMasterEndpointBuilder exchangePattern(String exchangePattern) {
            doSetProperty("exchangePattern", exchangePattern);
            return this;
        }
    }
    ...
    public interface ZooKeeperMasterBuilders {
         ...
         * @return the dsl builder
         */
        default ZooKeeperMasterEndpointBuilder zookeeperMaster(String componentName, String path) {
            return ZooKeeperMasterEndpointBuilderFactory.endpointBuilder(componentName, path);
        }

    }
    static ZooKeeperMasterEndpointBuilder endpointBuilder(String componentName, String path) {
