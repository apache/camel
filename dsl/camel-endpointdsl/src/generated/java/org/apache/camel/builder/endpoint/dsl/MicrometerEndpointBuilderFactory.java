...
public interface MicrometerEndpointBuilderFactory {
    ...
    public interface MicrometerEndpointBuilder
         ...
         * @return the dsl builder
         */
        default MicrometerEndpointBuilder metricsDescription(String metricsDescription) {
    ...
    public interface AdvancedMicrometerEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedMicrometerEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedMicrometerEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface MicrometerBuilders {
         ...
         * @return the dsl builder
         */
        default MicrometerEndpointBuilder micrometer(String componentName, String path) {
