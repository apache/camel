...
public interface NovaEndpointBuilderFactory {
    ...
    public interface NovaEndpointBuilder
         ...
         * @return the dsl builder
         */
        default NovaEndpointBuilder config(org.openstack4j.core.transport.Config config) {
    ...
    public interface AdvancedNovaEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedNovaEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedNovaEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface NovaBuilders {
         ...
         * @return the dsl builder
         */
        default NovaEndpointBuilder openstackNova(String componentName, String path) {
