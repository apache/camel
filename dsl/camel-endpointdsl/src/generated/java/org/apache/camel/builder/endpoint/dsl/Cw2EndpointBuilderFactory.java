...
public interface Cw2EndpointBuilderFactory {
     ...
     */
    public interface Cw2EndpointBuilder
            extends
         ...
         * @return the dsl builder
         */
        default Cw2EndpointBuilder uriEndpointOverride(String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default Cw2EndpointBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default Cw2EndpointBuilder profileCredentialsName(String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default Cw2EndpointBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default Cw2EndpointBuilder trustAllCertificates(String trustAllCertificates) {
            doSetProperty("trustAllCertificates", trustAllCertificates);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default Cw2EndpointBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Cw2EndpointBuilder useDefaultCredentialsProvider(String useDefaultCredentialsProvider) {
            doSetProperty("useDefaultCredentialsProvider", useDefaultCredentialsProvider);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default Cw2EndpointBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default Cw2EndpointBuilder useProfileCredentialsProvider(String useProfileCredentialsProvider) {
            doSetProperty("useProfileCredentialsProvider", useProfileCredentialsProvider);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default Cw2EndpointBuilder useSessionCredentials(boolean useSessionCredentials) {
         ...
         * @return the dsl builder
         */
        default Cw2EndpointBuilder useSessionCredentials(String useSessionCredentials) {
            doSetProperty("useSessionCredentials", useSessionCredentials);
            return this;
        }
    }
    ...
    public interface AdvancedCw2EndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedCw2EndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedCw2EndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedCw2EndpointBuilder amazonCwClient(software.amazon.awssdk.services.cloudwatch.CloudWatchClient amazonCwClient) {
