...
public interface LanguageEndpointBuilderFactory {
    ...
    public interface LanguageEndpointBuilder
         ...
         */
        default LanguageEndpointBuilder allowContextMapAll(boolean allowContextMapAll) {
         ...
         * @return the dsl builder
         */
        default LanguageEndpointBuilder allowContextMapAll(String allowContextMapAll) {
            doSetProperty("allowContextMapAll", allowContextMapAll);
            return this;
        }
        /**
    ...
    public interface LanguageBuilders {
         ...
         * There are 28 enums and the value can be one of: bean, constant,
         * csimple, datasonnet, exchangeProperty, file, groovy, header,
         * hl7terser, java, joor, jq, js, jsonpath, mvel, ognl, python, python3,
         * quickjs, ref, simple, spel, tokenize, variable, wasm, xpath, xquery,
         * xtokenize
         * 
         ...
         * @return the dsl builder
         */
        default LanguageEndpointBuilder language(String componentName, String path) {
    ...
    static LanguageEndpointBuilder endpointBuilder(String componentName, String path) {
