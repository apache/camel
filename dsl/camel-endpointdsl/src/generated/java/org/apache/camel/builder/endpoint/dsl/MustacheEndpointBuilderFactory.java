...
public interface MustacheEndpointBuilderFactory {
    ...
    public interface MustacheEndpointBuilder
         ...
         */
        default MustacheEndpointBuilder allowContextMapAll(boolean allowContextMapAll) {
         ...
         * @return the dsl builder
         */
        default MustacheEndpointBuilder allowContextMapAll(String allowContextMapAll) {
            doSetProperty("allowContextMapAll", allowContextMapAll);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default MustacheEndpointBuilder allowTemplateFromHeader(boolean allowTemplateFromHeader) {
         ...
         * @return the dsl builder
         */
        default MustacheEndpointBuilder allowTemplateFromHeader(String allowTemplateFromHeader) {
            doSetProperty("allowTemplateFromHeader", allowTemplateFromHeader);
            return this;
        }
        /**
    ...
    public interface AdvancedMustacheEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedMustacheEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedMustacheEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface MustacheBuilders {
         ...
         * @return the dsl builder
         */
        default MustacheEndpointBuilder mustache(String componentName, String path) {
