...
public interface ExecEndpointBuilderFactory {
    ...
    public interface ExecEndpointBuilder
         ...
         * @return the dsl builder
         */
        default ExecEndpointBuilder commandLogLevel(org.apache.camel.LoggingLevel commandLogLevel) {
         ...
         * @return the dsl builder
         */
        default ExecEndpointBuilder useStderrOnEmptyStdout(boolean useStderrOnEmptyStdout) {
         ...
         * @return the dsl builder
         */
        default ExecEndpointBuilder useStderrOnEmptyStdout(String useStderrOnEmptyStdout) {
            doSetProperty("useStderrOnEmptyStdout", useStderrOnEmptyStdout);
            return this;
        }
        /**
    ...
    public interface AdvancedExecEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedExecEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
