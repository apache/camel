...
public interface CinderEndpointBuilderFactory {
    ...
    public interface AdvancedCinderEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedCinderEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedCinderEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface CinderBuilders {
         ...
         * @return the dsl builder
         */
        default CinderEndpointBuilder openstackCinder(String componentName, String path) {
