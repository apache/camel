...
public interface StitchEndpointBuilderFactory {
    ...
    public interface StitchEndpointBuilder
         ...
         * @return the dsl builder
         */
        default StitchEndpointBuilder region(org.apache.camel.component.stitch.client.StitchRegion region) {
         ...
         * @return the dsl builder
         */
        default StitchEndpointBuilder stitchSchema(org.apache.camel.component.stitch.client.models.StitchSchema stitchSchema) {
    ...
    public interface AdvancedStitchEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedStitchEndpointBuilder connectionProvider(reactor.netty.resources.ConnectionProvider connectionProvider) {
         ...
         * @return the dsl builder
         */
        default AdvancedStitchEndpointBuilder connectionProvider(String connectionProvider) {
            doSetProperty("connectionProvider", connectionProvider);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedStitchEndpointBuilder httpClient(reactor.netty.http.client.HttpClient httpClient) {
         ...
         * @return the dsl builder
         */
        default AdvancedStitchEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedStitchEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedStitchEndpointBuilder stitchClient(org.apache.camel.component.stitch.client.StitchClient stitchClient) {
    ...
    static StitchEndpointBuilder endpointBuilder(String componentName, String path) {
