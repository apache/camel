...
public interface BrowseEndpointBuilderFactory {
    ...
    public interface AdvancedBrowseEndpointProducerBuilder extends EndpointProducerBuilder {
         ...
         * @return the dsl builder
         */
        default AdvancedBrowseEndpointProducerBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedBrowseEndpointProducerBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
    ...
    static BrowseEndpointBuilder endpointBuilder(String componentName, String path) {
