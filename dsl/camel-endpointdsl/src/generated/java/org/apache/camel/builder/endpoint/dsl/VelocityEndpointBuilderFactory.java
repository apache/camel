...
public interface VelocityEndpointBuilderFactory {
    ...
    public interface VelocityEndpointBuilder
         ...
         */
        default VelocityEndpointBuilder allowContextMapAll(boolean allowContextMapAll) {
         ...
         * @return the dsl builder
         */
        default VelocityEndpointBuilder allowContextMapAll(String allowContextMapAll) {
            doSetProperty("allowContextMapAll", allowContextMapAll);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default VelocityEndpointBuilder allowTemplateFromHeader(boolean allowTemplateFromHeader) {
         ...
         * @return the dsl builder
         */
        default VelocityEndpointBuilder allowTemplateFromHeader(String allowTemplateFromHeader) {
            doSetProperty("allowTemplateFromHeader", allowTemplateFromHeader);
            return this;
        }
        /**
    ...
    public interface AdvancedVelocityEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedVelocityEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedVelocityEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface VelocityBuilders {
         ...
         * @return the dsl builder
         */
        default VelocityEndpointBuilder velocity(String componentName, String path) {
    ...
    static VelocityEndpointBuilder endpointBuilder(String componentName, String path) {
