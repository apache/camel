...
public interface LumberjackEndpointBuilderFactory {
    ...
    public interface LumberjackEndpointBuilder
         ...
         */
        default LumberjackEndpointBuilder sslContextParameters(org.apache.camel.support.jsse.SSLContextParameters sslContextParameters) {
         ...
         * @return the dsl builder
         */
        default LumberjackEndpointBuilder sslContextParameters(String sslContextParameters) {
            doSetProperty("sslContextParameters", sslContextParameters);
            return this;
        }
    }
    ...
    public interface AdvancedLumberjackEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedLumberjackEndpointBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default AdvancedLumberjackEndpointBuilder bridgeErrorHandler(String bridgeErrorHandler) {
            doSetProperty("bridgeErrorHandler", bridgeErrorHandler);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedLumberjackEndpointBuilder exceptionHandler(org.apache.camel.spi.ExceptionHandler exceptionHandler) {
         ...
         * @return the dsl builder
         */
        default AdvancedLumberjackEndpointBuilder exceptionHandler(String exceptionHandler) {
            doSetProperty("exceptionHandler", exceptionHandler);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedLumberjackEndpointBuilder exchangePattern(org.apache.camel.ExchangePattern exchangePattern) {
         ...
         * @return the dsl builder
         */
        default AdvancedLumberjackEndpointBuilder exchangePattern(String exchangePattern) {
            doSetProperty("exchangePattern", exchangePattern);
            return this;
        }
    }
    ...
    public interface LumberjackBuilders {
         ...
         * @return the dsl builder
         */
        default LumberjackEndpointBuilder lumberjack(String componentName, String path) {
            return LumberjackEndpointBuilderFactory.endpointBuilder(componentName, path);
        }

    }
    static LumberjackEndpointBuilder endpointBuilder(String componentName, String path) {
