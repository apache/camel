...
public interface AWSConfigEndpointBuilderFactory {
     ...
     */
    public interface AWSConfigEndpointBuilder
            extends
    ...
    public interface AdvancedAWSConfigEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedAWSConfigEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedAWSConfigEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * 
         * The option is a:
         * <code>software.amazon.awssdk.services.config.ConfigClient</code>
         * type.
         * 
         * Group: advanced
         * 
         ...
         * @return the dsl builder
         */
        default AdvancedAWSConfigEndpointBuilder configClient(software.amazon.awssdk.services.config.ConfigClient configClient) {
         ...
         * @return the dsl builder
         */
        default AdvancedAWSConfigEndpointBuilder configClient(String configClient) {
            doSetProperty("configClient", configClient);
            return this;
        }
    }
    ...
    public interface AWSConfigBuilders {
         ...
         * @return the dsl builder
         */
        default AWSConfigEndpointBuilder awsConfig(String componentName, String path) {
    ...
    static AWSConfigEndpointBuilder endpointBuilder(String componentName, String path) {
