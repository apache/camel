...
public interface KMS2EndpointBuilderFactory {
     ...
     */
    public interface KMS2EndpointBuilder
            extends
         ...
         */
        default KMS2EndpointBuilder operation(org.apache.camel.component.aws2.kms.KMS2Operations operation) {
         ...
         * @return the dsl builder
         */
        default KMS2EndpointBuilder uriEndpointOverride(String uriEndpointOverride) {
         ...
         * @return the dsl builder
         */
        default KMS2EndpointBuilder proxyProtocol(software.amazon.awssdk.core.Protocol proxyProtocol) {
         ...
         * @return the dsl builder
         */
        default KMS2EndpointBuilder profileCredentialsName(String profileCredentialsName) {
         ...
         * @return the dsl builder
         */
        default KMS2EndpointBuilder sessionToken(String sessionToken) {
         ...
         * @return the dsl builder
         */
        default KMS2EndpointBuilder trustAllCertificates(boolean trustAllCertificates) {
         ...
         * @return the dsl builder
         */
        default KMS2EndpointBuilder trustAllCertificates(String trustAllCertificates) {
            doSetProperty("trustAllCertificates", trustAllCertificates);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default KMS2EndpointBuilder useDefaultCredentialsProvider(boolean useDefaultCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default KMS2EndpointBuilder useDefaultCredentialsProvider(String useDefaultCredentialsProvider) {
            doSetProperty("useDefaultCredentialsProvider", useDefaultCredentialsProvider);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default KMS2EndpointBuilder useProfileCredentialsProvider(boolean useProfileCredentialsProvider) {
         ...
         * @return the dsl builder
         */
        default KMS2EndpointBuilder useProfileCredentialsProvider(String useProfileCredentialsProvider) {
            doSetProperty("useProfileCredentialsProvider", useProfileCredentialsProvider);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default KMS2EndpointBuilder useSessionCredentials(boolean useSessionCredentials) {
         ...
         * @return the dsl builder
         */
        default KMS2EndpointBuilder useSessionCredentials(String useSessionCredentials) {
            doSetProperty("useSessionCredentials", useSessionCredentials);
            return this;
        }
    }
    ...
    /**
     * Advanced builder for endpoint for the AWS Key Management Service (KMS) component.
     */
    public interface AdvancedKMS2EndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedKMS2EndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedKMS2EndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedKMS2EndpointBuilder kmsClient(software.amazon.awssdk.services.kms.KmsClient kmsClient) {
