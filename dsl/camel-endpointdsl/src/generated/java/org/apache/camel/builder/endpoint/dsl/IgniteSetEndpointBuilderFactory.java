...
public interface IgniteSetEndpointBuilderFactory {
    ...
    public interface IgniteSetEndpointBuilder
         ...
         */
        default IgniteSetEndpointBuilder configuration(org.apache.ignite.configuration.CollectionConfiguration configuration) {
         ...
         * @return the dsl builder
         */
        default IgniteSetEndpointBuilder operation(org.apache.camel.component.ignite.set.IgniteSetOperation operation) {
         ...
         * @return the dsl builder
         */
        default IgniteSetEndpointBuilder propagateIncomingBodyIfNoReturnValue(boolean propagateIncomingBodyIfNoReturnValue) {
         ...
         * @return the dsl builder
         */
        default IgniteSetEndpointBuilder propagateIncomingBodyIfNoReturnValue(String propagateIncomingBodyIfNoReturnValue) {
            doSetProperty("propagateIncomingBodyIfNoReturnValue", propagateIncomingBodyIfNoReturnValue);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default IgniteSetEndpointBuilder treatCollectionsAsCacheObjects(boolean treatCollectionsAsCacheObjects) {
         ...
         * @return the dsl builder
         */
        default IgniteSetEndpointBuilder treatCollectionsAsCacheObjects(String treatCollectionsAsCacheObjects) {
            doSetProperty("treatCollectionsAsCacheObjects", treatCollectionsAsCacheObjects);
            return this;
        }
    }
    ...
    public interface AdvancedIgniteSetEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedIgniteSetEndpointBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default AdvancedIgniteSetEndpointBuilder lazyStartProducer(String lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }
    ...
    public interface IgniteSetBuilders {
         ...
         * @return the dsl builder
         */
        default IgniteSetEndpointBuilder igniteSet(String componentName, String path) {
    ...
    public static class IgniteSetHeaderNameBuilder {
         ...
         */
        public static final IgniteSetHeaderNameBuilder INSTANCE = new IgniteSetHeaderNameBuilder();
    ...
    static IgniteSetEndpointBuilder endpointBuilder(String componentName, String path) {
