...
public interface StateStoreEndpointBuilderFactory {
    ...
    public interface AdvancedStateStoreEndpointBuilder
         ...
         * KeyValueRepository from the registry, or falls back to an in-memory
         * store.
         * 
         * The option is a: <code>org.apache.camel.spi.KeyValueRepository</code>
         * type.
         * 
         * Group: advanced
         * 
         ...
         * @return the dsl builder
         */
        default AdvancedStateStoreEndpointBuilder backend(org.apache.camel.spi.KeyValueRepository backend) {
         ...
         * 
         * The option will be converted to a
         * <code>org.apache.camel.spi.KeyValueRepository</code> type.
         * 
         * Group: advanced
         * 
         * @param backend the value to set
    ...
    public static class StateStoreHeaderNameBuilder {
         ...
         */
        public static final StateStoreHeaderNameBuilder INSTANCE = new StateStoreHeaderNameBuilder();
