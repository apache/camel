...
public class ClaimCheckTest extends YamlTestSupport {
    ...
    void claimCheckDefinition() throws Exception {
        ...
        assertEquals("Push", claimCheck.getOperation());
        assertEquals("foo", claimCheck.getKey());
        assertEquals("header:(foo|bar)", claimCheck.getFilter());
    }
}
