...
public final class ExpressionDeserializers extends YamlDeserializerSupport {
    ...
    public static ExpressionDefinition constructExpressionType(String id, Node node) {
        switch(id) {
            ...
            case "jactl": {
                return asType(node, org.apache.camel.model.language.JactlExpression.class);
            }
            case "java": {
                return asType(node, org.apache.camel.model.language.JavaExpression.class);
            }
            case "jev": {
                return asType(node, org.apache.camel.model.language.JevExpression.class);
            }
            case "jq": {
    ...
    @YamlType(
            ...
            properties = {
                    ...
                    @YamlProperty(name = "jev", type = "object:org.apache.camel.model.language.JevExpression", oneOf = "expression"),
