...
class RemoveVariableTest extends YamlTestSupport {
    ...
    void removeVariableDefinition(Resource resource) throws Exception {
        PluginHelper.getRoutesLoader(context).loadRoutes(resource);
        var rv = (RemoveVariableDefinition) context.getRouteDefinitions().get(0).getOutputs().get(0);
        assertThat(rv.getName()).isEqualTo("test");
    }
}
