...
class ToVariableDynamicTest extends YamlTestSupport {
    ...
    @Test
    void toDVariableSend() throws Exception {
        loadRoutes(ROUTES);
        ...
        withTemplate(t -> t.to("direct:send").withBody("World").withHeader("where", "foo").send());

        MockEndpoint.assertIsSatisfied(context);
    }

    @Test
    void toDVariableReceive() throws Exception {
        loadRoutes(ROUTES);
        ...
        withTemplate(t -> t.to("direct:receive").withBody("World").withHeader("where", "foo").send());

        MockEndpoint.assertIsSatisfied(context);
    }

    @Test
    void toDVariableSendAndReceive() throws Exception {
        loadRoutes(ROUTES);
        ...
        withTemplate(t -> t.to("direct:sendAndReceive").withBody("World").withHeader("where", "foo").send());
