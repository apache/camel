...
class ChoiceCamelExtTest extends YamlTestSupport {
    ...
    void choiceDefinition() throws Exception {
        ...
        assertThat(((WhenDefinition) choice.getWhenClauses().get(0)).getExpression().getLanguage()).isEqualTo("simple");
        assertThat(((WhenDefinition) choice.getWhenClauses().get(0)).getExpression().getExpression())
                .isEqualTo("${body.size()} == 1");
    }
