...
public final class CamelOpenMBeanTypes {
    ...
    public static TabularType listEndpointServicesTabularType() throws OpenDataException {
        ...
        return new TabularType(
                "listEndpointServices", "Lists all the endpoint services in the registry", ct, new String[] {
    ...
    public static CompositeType listEndpointServicesCompositeType() throws OpenDataException {
        return new CompositeType(
                "endpoints",
                "Endpoint Services",
                new String[] {"component", "dir", "protocol", "serviceUrl", "metadata", "endpointUri", "routeId", "hits"
                },
                new String[] {
    ...
    public static TabularType listRuntimeEndpointsTabularType() throws OpenDataException {
        ...
        return new TabularType(
                ...
                "Lists all the input and output endpoints gathered during runtime",
                ct,
                new String[] {"index"});
    }
    ...
    public static TabularType listAwaitThreadsTabularType() throws OpenDataException {
        ...
        return new TabularType(
                "listAwaitThreads", "Lists blocked threads by the routing engine", ct, new String[] {"id"});
    }
    ...
    public static CompositeType endpointsUtilizationCompositeType() throws OpenDataException {
        return new CompositeType(
                "endpoints", "Endpoints", new String[] {"url", "hits"}, new String[] {"Url", "Hits"}, new OpenType[] {
    ...
    public static TabularType listBackoffTaskTabularType() throws OpenDataException {
        ...
        return new TabularType("listBackoff", "Lists all the backoff tasks", ct, new String[] {"name"});
    }
    ...
    public static TabularType listInternalTaskTabularType() throws OpenDataException {
        ...
        return new TabularType("listTask", "Lists all the internal tasks", ct, new String[] {"name"});
    }
