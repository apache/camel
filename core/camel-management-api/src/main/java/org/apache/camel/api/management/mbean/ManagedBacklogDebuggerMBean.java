...
public interface ManagedBacklogDebuggerMBean {
    ...
    @ManagedOperation(
            description = "Remote the breakpoint from the given node id (will resume suspend breakpoint first)")
    ...
    @ManagedOperation(
            description = "Updates the message body (with a new type) on the suspended breakpoint at the given node id")
    ...
    @ManagedOperation(
            description = "Dumps the messages in JSon format from the suspended breakpoint at the given node.")
    ...
    @ManagedOperation(
            description = "Evaluates the expression at a given breakpoint node id and returns the result as String")
    String evaluateExpressionAtBreakpoint(String nodeId, String language, String expression);

    @ManagedOperation(
            description =
                    "Updates/adds the exchange property (uses same type as old exchange property value) on the suspended breakpoint at the given node id")
    void setExchangePropertyOnBreakpoint(String nodeId, String exchangePropertyName, Object value);

    @ManagedOperation(
            description =
                    "Updates/adds the exchange property (with a new type) on the suspended breakpoint at the given node id")
    ...
    @ManagedOperation(
            description =
                    "Updates/adds the exchange variable (uses same type as old variableName value) on the suspended breakpoint at the given node id")
    void setExchangeVariableOnBreakpoint(String nodeId, String variableName, Object value);

    @ManagedOperation(
            description =
                    "Updates/adds the exchange variable (with a new type) on the suspended breakpoint at the given node id")
