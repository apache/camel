...
public class DynamicRouterConvertBodyToIssueManualTest extends ContextTestSupport implements Processor {
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("direct:while_body")
                        .process(new DynamicRouterConvertBodyToIssueManualTest())
