...
public class ManagedRouteDumpStatsAsXmlAndResetWithCustomDomainTest extends ManagementTestSupport {
    ...
    public void testPerformanceCounterStats() throws Exception {
        ...
        int exchangeCompleted = Integer.parseInt(doc.getDocumentElement()
                .getElementsByTagName("processorStat")
                .item(0)
                .getAttributes()
                .getNamedItem("exchangesCompleted")
                .getNodeValue());
        ...
        assertNotNull(doc);
        exchangeCompleted = Integer.parseInt(doc.getDocumentElement()
                .getElementsByTagName("processorStat")
                .item(0)
                .getAttributes()
                .getNamedItem("exchangesCompleted")
