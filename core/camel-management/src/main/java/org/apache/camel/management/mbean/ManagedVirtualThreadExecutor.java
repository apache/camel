...
public class ManagedVirtualThreadExecutor implements ManagedVirtualThreadExecutorMBean {
    ...
    public ManagedVirtualThreadExecutor(CamelContext camelContext, ExecutorService executorService, String id,
