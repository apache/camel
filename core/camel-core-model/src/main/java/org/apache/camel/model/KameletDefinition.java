 ...
 * component, such as <code></code>to("kamelet:mykamelet")</code>. When a Kamelet is designed for a special use-case
 * such as aggregating messages, and returning a response message only when a group of aggregated messages is completed.
 * In other words, kamelet does not return a response message for every incoming message. In special situations like
 * these, then you must use this Kamelet EIP instead of using the kamelet component.
 */
