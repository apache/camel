...
/**
 * Marshal POJOs to Protobuf using Jackson and back.
 */
@Metadata(firstVersion = "3.10.0", label = "dataformat,transformation,json", title = "Protobuf Jackson")
@XmlRootElement(name = "protobuf-jackson")
@XmlAccessorType(XmlAccessType.FIELD)
public class ProtobufJacksonDataFormat extends DataFormatDefinition implements ContentTypeHeaderAware {
    @XmlAttribute
    ...
    public ProtobufJacksonDataFormat() {
        super("protobuf-jackson");
    }
    ...
    public ProtobufJacksonDataFormat objectMapper(String objectMapper) {
        this.objectMapper = objectMapper;
        return this;
    }

    public ProtobufJacksonDataFormat useDefaultObjectMapper(boolean useDefaultObjectMapper) {
        return useDefaultObjectMapper(Boolean.toString(useDefaultObjectMapper));
    }

    public ProtobufJacksonDataFormat useDefaultObjectMapper(String useDefaultObjectMapper) {
        this.useDefaultObjectMapper = useDefaultObjectMapper;
        return this;
    }

    public ProtobufJacksonDataFormat prettyPrint(boolean prettyPrint) {
        return prettyPrint(Boolean.toString(prettyPrint));
    }

    public ProtobufJacksonDataFormat prettyPrint(String prettyPrint) {
        this.prettyPrint = prettyPrint;
        return this;
    }

    public ProtobufJacksonDataFormat unmarshalType(String unmarshalType) {
        this.unmarshalTypeName = unmarshalType;
        return this;
    }

    public ProtobufJacksonDataFormat unmarshalType(Class<?> unmarshalType) {
        this.unmarshalType = unmarshalType;
        return this;
    }

    public ProtobufJacksonDataFormat jsonView(Class<?> jsonView) {
        this.jsonView = jsonView;
        return this;
    }

    public ProtobufJacksonDataFormat include(String include) {
        this.include = include;
        return this;
    }

    public ProtobufJacksonDataFormat allowJmsType(boolean allowJmsType) {
        return allowJmsType(Boolean.toString(allowJmsType));
    }

    public ProtobufJacksonDataFormat allowJmsType(String allowJmsType) {
        this.allowJmsType = allowJmsType;
        return this;
    }

    public ProtobufJacksonDataFormat collectionType(String collectionType) {
        this.collectionTypeName = collectionType;
        return this;
    }

    public ProtobufJacksonDataFormat collectionType(Class<?> collectionType) {
        this.collectionType = collectionType;
        return this;
    }

    public ProtobufJacksonDataFormat useList(boolean useList) {
        return useList(Boolean.toString(useList));
    }

    public ProtobufJacksonDataFormat useList(String useList) {
        this.useList = useList;
        return this;
    }

    public ProtobufJacksonDataFormat moduleClassNames(String moduleClassNames) {
        this.moduleClassNames = moduleClassNames;
        return this;
    }

    public ProtobufJacksonDataFormat moduleRefs(String moduleRefs) {
        this.moduleRefs = moduleRefs;
        return this;
    }

    public ProtobufJacksonDataFormat enableFeatures(String enableFeatures) {
        this.enableFeatures = enableFeatures;
        return this;
    }

    public ProtobufJacksonDataFormat disableFeatures(String disableFeatures) {
        this.disableFeatures = disableFeatures;
        return this;
    }

    public ProtobufJacksonDataFormat allowUnmarshallType(boolean allowUnmarshallType) {
        return allowUnmarshallType(Boolean.toString(allowUnmarshallType));
    }

    public ProtobufJacksonDataFormat allowUnmarshallType(String allowUnmarshallType) {
        this.allowUnmarshallType = allowUnmarshallType;
        return this;
    }

    public ProtobufJacksonDataFormat timezone(String timezone) {
        this.timezone = timezone;
        return this;
    }

    public ProtobufJacksonDataFormat autoDiscoverObjectMapper(boolean autoDiscoverObjectMapper) {
        return autoDiscoverObjectMapper(Boolean.toString(autoDiscoverObjectMapper));
    }

    public ProtobufJacksonDataFormat autoDiscoverObjectMapper(String autoDiscoverObjectMapper) {
        this.autoDiscoverObjectMapper = autoDiscoverObjectMapper;
        return this;
    }
