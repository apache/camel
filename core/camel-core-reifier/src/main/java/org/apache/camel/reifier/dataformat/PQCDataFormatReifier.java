...
public class PQCDataFormatReifier extends DataFormatReifier<PQCDataFormat> {

    public PQCDataFormatReifier(CamelContext camelContext, DataFormatDefinition definition) {
        super(camelContext, (PQCDataFormat) definition);
    }

    @Override
    protected void prepareDataFormatConfig(Map<String, Object> properties) {
        properties.put("keyEncapsulationAlgorithm", definition.getKeyEncapsulationAlgorithm());
