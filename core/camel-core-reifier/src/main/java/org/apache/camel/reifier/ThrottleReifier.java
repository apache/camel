...
public class ThrottleReifier extends ExpressionReifier<ThrottleDefinition> {
    ...
    public Processor createProcessor() throws Exception {
        ...
        if (definition.getThrottlerConfig() instanceof ConcurrentRequestsThrottlerConfig config) {
            ...
            if (definition.getThrottlerConfig() instanceof TotalRequestsThrottlerConfig config) {
                long period = parseDuration(config.getTimePeriodMillis(), 1000L);
                ...
                throw new IllegalArgumentException("Unsupported throttler type");
            }
        }
