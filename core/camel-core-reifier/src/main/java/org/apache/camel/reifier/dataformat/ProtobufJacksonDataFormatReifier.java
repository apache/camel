...
public class ProtobufJacksonDataFormatReifier extends DataFormatReifier<ProtobufJacksonDataFormat> {

    public ProtobufJacksonDataFormatReifier(CamelContext camelContext, DataFormatDefinition definition) {
        super(camelContext, (ProtobufJacksonDataFormat) definition);
    }
