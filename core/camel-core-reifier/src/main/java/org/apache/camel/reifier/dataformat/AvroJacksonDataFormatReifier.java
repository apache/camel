...
public class AvroJacksonDataFormatReifier extends DataFormatReifier<AvroJacksonDataFormat> {

    public AvroJacksonDataFormatReifier(CamelContext camelContext, DataFormatDefinition definition) {
        super(camelContext, (AvroJacksonDataFormat) definition);
    }
