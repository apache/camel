...
public class JacksonXML3DataFormatReifier extends DataFormatReifier<JacksonXML3DataFormat> {

    public JacksonXML3DataFormatReifier(CamelContext camelContext, DataFormatDefinition definition) {
        super(camelContext, (JacksonXML3DataFormat) definition);
    }
