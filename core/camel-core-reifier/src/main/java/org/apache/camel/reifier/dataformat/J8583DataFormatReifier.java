...
public class J8583DataFormatReifier extends DataFormatReifier<J8583DataFormat> {

    public J8583DataFormatReifier(CamelContext camelContext, DataFormatDefinition definition) {
        super(camelContext, (J8583DataFormat) definition);
    }
