...
public class OcsfDataFormatReifier extends DataFormatReifier<OcsfDataFormat> {

    public OcsfDataFormatReifier(CamelContext camelContext, DataFormatDefinition definition) {
        super(camelContext, (OcsfDataFormat) definition);
    }
