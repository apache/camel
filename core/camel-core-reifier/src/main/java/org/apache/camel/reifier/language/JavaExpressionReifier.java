...
public class JavaExpressionReifier extends TypedExpressionReifier<JavaExpression> {

    public JavaExpressionReifier(CamelContext camelContext, ExpressionDefinition definition) {
