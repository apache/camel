...
/**
 * Tests that bridgeErrorHandler with continued(true) properly executes the onException route and allows processing to
 * continue.
 * <p>
 * This is a regression test for CAMEL-22907.
 */
public class DefaultConsumerBridgeErrorHandlerContinuedTest extends ContextTestSupport {

    @Test
    public void testDefaultConsumerBridgeErrorHandlerContinued() throws Exception {
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                // The onException route should execute and processing should continue
                ...
                from("direct:subroute").to("mock:subroute")
                        .log("Subroute executed with continued: ${exception.message}");
            }
        };
    }
