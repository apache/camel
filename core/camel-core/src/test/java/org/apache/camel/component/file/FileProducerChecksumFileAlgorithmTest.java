...
public class FileProducerChecksumFileAlgorithmTest extends ContextTestSupport {
    ...
    public void testProducerChecksumFileMd5() throws Exception {
        template.sendBodyAndHeader(
                fileUri("?checksumFileAlgorithm=md5"), "Hello World", Exchange.FILE_NAME, "hello.txt");
    ...
    public void testProducerChecksumFileSha256() throws Exception {
        template.sendBodyAndHeader(
                fileUri("?checksumFileAlgorithm=sha256"), "Hello World", Exchange.FILE_NAME, "hello.txt");

        assertFileExists(testFile("hello.txt"));
        assertFileExists(
                testFile("hello.txt.sha256"), "a591a6d40bf420404a011733cfb7b190d62c65bf0bcda32b57b277d9ad9f146e");
    }
