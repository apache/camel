...
public class BeanOverloadedMethodFQNTest extends ContextTestSupport {
    ...
    public void testOrderNoFQNUnknown() throws Exception {
        ...
        NoTypeConversionAvailableException cause = assertIsInstanceOf(
    ...
    public void testOrderNoFQNBoolean() throws Exception {
        context.addRoutes(new RouteBuilder() {
            ...
            public void configure() {
                from("direct:start")
                        .bean(MyBean.class, "order(MyOrder.class,Boolean.class)")
                        .to("mock:result");
            }
        });
        context.start();
        ...
        context.addRoutes(new RouteBuilder() {
            ...
            public void configure() {
                from("direct:start")
                        .bean(
                                MyBean.class,
                                "order(org.apache.camel.component.bean.BeanOverloadedMethodFQNTest$MyOrder.class)")
                        .to("mock:result");
            }
        });
        context.start();
        ...
        context.addRoutes(new RouteBuilder() {
            ...
            public void configure() {
                from("direct:start")
                        .bean(
                                MyBean.class,
                                "order(org.apache.camel.component.bean.BeanOverloadedMethodFQNTest$Unknown.class)")
                        .to("mock:result");
            }
        });
        context.start();
