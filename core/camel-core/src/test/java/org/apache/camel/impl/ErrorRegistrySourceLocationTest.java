...
public class ErrorRegistrySourceLocationTest extends ContextTestSupport {
    ...
    @Test
    public void testLocationIsLeftOutWhenSourceLocationIsOff() throws Exception {
        ...
        assertTrue(entry.getMessageHistory()[0].contains("bodyType="), entry.getMessageHistory()[0]);
    }
