...
/**
 * Adds a compiled class that is an {@link EventNotifier} to the {@link ManagementStrategy}. As the class may be
 * compiled again (live reload) the previous notifier of the same name is removed first.
 */
