 ...
 *
 * @deprecated since 4.23.0. Use {@link org.apache.camel.support.KeyValueIdempotentRepository} instead. The no-arg
 *             constructor defaults to an in-memory store: {@code new KeyValueIdempotentRepository()}
 */
