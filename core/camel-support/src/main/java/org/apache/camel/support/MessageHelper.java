...
public final class MessageHelper {
    ...
    public static String dumpAsXml(Message message, boolean includeBody, int indent) {
        return dumpAsXml(message, includeBody, indent, false, true, 131072); // 131072 = 128 * 1024
    }
    ...
    public static String dumpAsJSon(Message message, boolean includeBody, int indent) {
        return dumpAsJSon(message, includeBody, indent, false, true, 131072, true); // 131072 = 128 * 1024
    }
