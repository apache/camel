 ...
 * executes a script by any of the supported Languages in Camel. By having a
 * component to execute language scripts, it allows more dynamic routing
 * capabilities. For example by using the Routing Slip or Dynamic Router EIPs
 * you can send messages to language endpoints where the script is dynamic
 * defined as well.
 * 
...
public interface LanguageEndpointBuilderFactory {
    ...
    public interface LanguageBuilders {
         ...
         * dynamic routing capabilities. For example by using the Routing Slip
         * or Dynamic Router EIPs you can send messages to language endpoints
     ...
     * executes a script by any of the supported Languages in Camel. By having a
     * component to execute language scripts, it allows more dynamic routing
     * capabilities. For example by using the Routing Slip or Dynamic Router
