 ...
 * fires. This component is similar to the scheduler component, but has much
 * less functionality.
 * 
...
public interface TimerEndpointBuilderFactory {
    ...
    public interface TimerBuilders {
         ...
         * timer fires. This component is similar to the scheduler component,
         * but has much less functionality.
         * 
