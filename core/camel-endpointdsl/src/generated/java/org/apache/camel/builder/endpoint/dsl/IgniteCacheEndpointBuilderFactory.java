 ...
 * to interact with an Ignite Cache. This offers both a Producer (to invoke
 * cache operations on an Ignite cache) and a Consumer (to consume changes from
 * a continuous query).
 * 
...
public interface IgniteCacheEndpointBuilderFactory {
    ...
    public interface IgniteCacheBuilders {
         ...
         * allows you to interact with an Ignite Cache. This offers both a
         * Producer (to invoke cache operations on an Ignite cache) and a
     ...
     * you to interact with an Ignite Cache. This offers both a Producer (to
     * invoke cache operations on an Ignite cache) and a Consumer (to consume
