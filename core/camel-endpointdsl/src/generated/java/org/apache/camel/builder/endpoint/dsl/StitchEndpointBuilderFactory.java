 ...
 * and replicates data from more than 90 applications and databases. It
 * integrates various data sources into a central data warehouse. Stitch has
 * integrations for many enterprise software data sources, and can receive data
 * via WebHooks and an API (Stitch Import API) which Camel Stitch Component uses
 * to produce the data to Stitch ETL.
 * 
...
public interface StitchEndpointBuilderFactory {
    ...
    public interface AdvancedStitchEndpointConsumerBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedStitchEndpointConsumerBuilder synchronous(
                boolean synchronous) {
    ...
    public interface AdvancedStitchEndpointProducerBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedStitchEndpointProducerBuilder synchronous(
                boolean synchronous) {
            doSetProperty("synchronous", synchronous);
            return this;
        }
    ...
    public interface AdvancedStitchEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedStitchEndpointBuilder synchronous(boolean synchronous) {
            doSetProperty("synchronous", synchronous);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedStitchEndpointBuilder synchronous(String synchronous) {
            doSetProperty("synchronous", synchronous);
            return this;
        }
    }
    ...
    public interface StitchBuilders {
         ...
         * moving and replicates data from more than 90 applications and
         * databases. It integrates various data sources into a central data
         * warehouse. Stitch has integrations for many enterprise software data
         * sources, and can receive data via WebHooks and an API (Stitch Import
         * API) which Camel Stitch Component uses to produce the data to Stitch
         * ETL.
         * 
