 ...
 * to interact with Ignite Queue data structures. This endpoint only supports
 * producers.
 * 
...
public interface IgniteQueueEndpointBuilderFactory {
    ...
    public interface IgniteQueueBuilders {
         ...
         * allows you to interact with Ignite Queue data structures. This
     ...
     * you to interact with Ignite Queue data structures. This endpoint only
     * supports producers.
     * 
     * Category: nosql,cache
     * Since: 2.17
