...
/**
 * The jmx component allows to receive JMX notifications. Endpoint that
 * describes a connection to an mbean. The component can connect to the local
 * platform mbean server with the following URI: jmx://platformoptions A remote
 * mbean server url can be provided following the initial JMX scheme like so:
 * jmx:service:jmx:rmi:///jndi/rmi://localhost:1099/jmxrmioptions You can append
...
public interface JMXEndpointBuilderFactory {
    ...
    public interface JMXBuilders {
         ...
         * JMX (camel-jmx)
         * The jmx component allows to receive JMX notifications. Endpoint that
         * describes a connection to an mbean. The component can connect to the
         * local platform mbean server with the following URI:
         * jmx://platformoptions A remote mbean server url can be provided
         * following the initial JMX scheme like so:
         * jmx:service:jmx:rmi:///jndi/rmi://localhost:1099/jmxrmioptions You
     ...
     * The jmx component allows to receive JMX notifications. Endpoint that
     * describes a connection to an mbean. The component can connect to the
     * local platform mbean server with the following URI: jmx://platformoptions
     * A remote mbean server url can be provided following the initial JMX
     * scheme like so:
     * jmx:service:jmx:rmi:///jndi/rmi://localhost:1099/jmxrmioptions You can
