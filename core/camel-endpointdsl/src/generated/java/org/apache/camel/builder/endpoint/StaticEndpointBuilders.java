...
public class StaticEndpointBuilders {
    ...
    /**
     * ActiveMQ (camel-activemq) Send messages to (or consume from) Apache
     * ActiveMQ. This component extends the Camel JMS component. Category:
     * messaging Since: 1.0 Maven coordinates: org.apache.camel:camel-activemq
     * Syntax: <code>activemq:destinationType:destinationName</code> Path
     * parameter: destinationType The kind of destination to use Default value:
     * queue The value can be one of: queue, topic, temp-queue, temp-topic Path
     * parameter: destinationName (required) Name of the queue or topic to use
     * as destination
    ...
    /**
     * AHC (camel-ahc) Call external HTTP services using Async Http Client.
     * Category: http Since: 2.8 Maven coordinates: org.apache.camel:camel-ahc
     * Syntax: <code>ahc:httpUri</code> Path parameter: httpUri (required) The
     * URI to use such as http://hostname:port/path
     * @param path httpUri
     */
    ...
    /**
     * AHC Websocket (camel-ahc-ws) Exchange data with external Websocket
     * servers using Async Http Client. Category: websocket Since: 2.14 Maven
     * coordinates: org.apache.camel:camel-ahc-ws Syntax:
     * <code>ahc-ws:httpUri</code> Path parameter: httpUri (required) The URI to
     * use such as http://hostname:port/path
     * @param path httpUri
     */
    ...
    /**
     * AHC Secure Websocket (Secure) (camel-ahc-ws) Exchange data with external
     * Websocket servers using Async Http Client. Category: websocket Since:
     * 2.14 Maven coordinates: org.apache.camel:camel-ahc-ws Syntax:
     * <code>ahc-wss:httpUri</code> Path parameter: httpUri (required) The URI
     * to use such as http://hostname:port/path
     * @param path httpUri
     */
    static org.apache.camel.builder.endpoint.dsl.WsEndpointBuilderFactory.WsEndpointBuilder ahcWss(
            java.lang.String path) {
     ...
     * Category: messaging Since: 1.2 Maven coordinates:
     * org.apache.camel:camel-amqp Syntax:
     * <code>amqp:destinationType:destinationName</code> Path parameter:
     * destinationType The kind of destination to use Default value: queue The
     * value can be one of: queue, topic, temp-queue, temp-topic Path parameter:
    ...
    /**
     * APNS (camel-apns) Send notifications to Apple iOS devices. Category:
     * eventbus,mobile Since: 2.8 Maven coordinates: org.apache.camel:camel-apns
     * Syntax: <code>apns:name</code> Path parameter: name Name of the endpoint
     * @param path name
     */
    ...
    /**
     * AS2 (camel-as2) Transfer data securely and reliably using the AS2
     * protocol (RFC4130). Category: file Since: 2.22 Maven coordinates:
     * org.apache.camel:camel-as2 Syntax: <code>as2:apiName/methodName</code>
     * Path parameter: apiName (required) What kind of operation to perform The
     * value can be one of: CLIENT, SERVER Path parameter: methodName (required)
    ...
    /**
     * Asterisk (camel-asterisk) Interact with Asterisk PBX Server. Category:
     * voip Since: 2.18 Maven coordinates: org.apache.camel:camel-asterisk
     * Syntax: <code>asterisk:name</code> Path parameter: name (required) Name
     * of component
     * @param path name
     */
    ...
    /**
     * Atmos (camel-atmos) Integract with EMC's ViPR object data services using
     * the Atmos Client. Category: file,cloud Since: 2.15 Maven coordinates:
     * org.apache.camel:camel-atmos Syntax: <code>atmos:name/operation</code>
     * Path parameter: name Atmos name Path parameter: operation (required)
     * Operation to perform The value can be one of: put, del, search, get, move
    ...
    /**
     * Atmosphere Websocket (camel-atmosphere-websocket) Expose WebSocket
     * endpoints using the Atmosphere framework. Category: websocket Since: 2.14
     * Maven coordinates: org.apache.camel:camel-atmosphere-websocket Syntax:
     * <code>atmosphere-websocket:servicePath</code> Path parameter: servicePath
    ...
    /**
     * Atom (camel-atom) Poll Atom RSS feeds. Category: rss Since: 1.2 Maven
     * coordinates: org.apache.camel:camel-atom Syntax:
     * <code>atom:feedUri</code> Path parameter: feedUri (required) The URI to
     * the feed to poll.
     * @param path feedUri
     */
    ...
    /**
     * Atomix Map (camel-atomix) Access Atomix's distributed map. Category:
     * clustering Since: 2.20 Maven coordinates: org.apache.camel:camel-atomix
     * Syntax: <code>atomix-map:resourceName</code> Path parameter: resourceName
    ...
    /**
     * Atomix Messaging (camel-atomix) Access Atomix's group messaging.
     * Category: clustering Since: 2.20 Maven coordinates:
     * org.apache.camel:camel-atomix Syntax:
     * <code>atomix-messaging:resourceName</code> Path parameter: resourceName
     * (required) The distributed resource name
     * @param path resourceName
     */
    ...
    /**
     * Atomix MultiMap (camel-atomix) Access Atomix's distributed multi map.
     * Category: clustering Since: 2.20 Maven coordinates:
     * org.apache.camel:camel-atomix Syntax:
     * <code>atomix-multimap:resourceName</code> Path parameter: resourceName
     * (required) The distributed resource name
     * @param path resourceName
     */
    ...
    /**
     * Atomix Queue (camel-atomix) Access Atomix's distributed queue. Category:
     * clustering Since: 2.20 Maven coordinates: org.apache.camel:camel-atomix
     * Syntax: <code>atomix-queue:resourceName</code> Path parameter:
     * resourceName (required) The distributed resource name
     * @param path resourceName
     */
    ...
    /**
     * Atomix Set (camel-atomix) Access Atomix's distributed set. Category:
     * clustering Since: 2.20 Maven coordinates: org.apache.camel:camel-atomix
     * Syntax: <code>atomix-set:resourceName</code> Path parameter: resourceName
     * (required) The distributed resource name
     * @param path resourceName
     */
    ...
    /**
     * Atomix Value (camel-atomix) Access Atomix's distributed value. Category:
     * clustering Since: 2.20 Maven coordinates: org.apache.camel:camel-atomix
     * Syntax: <code>atomix-value:resourceName</code> Path parameter:
     * resourceName (required) The distributed resource name
     * @param path resourceName
     */
    ...
    /**
     * Avro (camel-avro-rpc) Produce or consume Apache Avro RPC services.
     * Category: messaging,transformation Since: 2.10 Maven coordinates:
     * org.apache.camel:camel-avro-rpc Syntax:
     * <code>avro:transport:host:port/messageName</code> Path parameter:
     * transport (required) Transport to use, can be either http or netty The
     * value can be one of: http, netty Path parameter: port (required) Port
     * number to use Path parameter: host (required) Hostname to use Path
     * parameter: messageName The name of the message to send.
    ...
    /**
     * AWS 2 CloudWatch (camel-aws2-cw) Sending metrics to AWS CloudWatch using
     * AWS SDK version 2.x. Category: cloud,monitoring Since: 3.1 Maven
     * coordinates: org.apache.camel:camel-aws2-cw Syntax:
     * <code>aws2-cw:namespace</code> Path parameter: namespace (required) The
     * metric namespace
    ...
    /**
     * AWS 2 DynamoDB (camel-aws2-ddb) Store and retrieve data from AWS DynamoDB
     * service using AWS SDK version 2.x. Category: cloud,database,nosql Since:
     * 3.1 Maven coordinates: org.apache.camel:camel-aws2-ddb Syntax:
     * <code>aws2-ddb:tableName</code> Path parameter: tableName (required) The
     * name of the table currently worked with.
    ...
    /**
     * AWS 2 DynamoDB Streams (camel-aws2-ddb) Receive messages from AWS
     * DynamoDB Stream service using AWS SDK version 2.x. Category:
     * cloud,messaging,streams Since: 3.1 Maven coordinates:
     * org.apache.camel:camel-aws2-ddb Syntax:
     * <code>aws2-ddbstream:tableName</code> Path parameter: tableName
    ...
    /**
     * AWS 2 EC2 (camel-aws2-ec2) Manage AWS EC2 instances using AWS SDK version
     * 2.x. Category: cloud,management Since: 3.1 Maven coordinates:
     * org.apache.camel:camel-aws2-ec2 Syntax: <code>aws2-ec2:label</code> Path
     * parameter: label (required) Logical name
     * @param path label
     */
    ...
    /**
     * AWS 2 ECS (camel-aws2-ecs) Manage AWS ECS cluster instances using AWS SDK
     * version 2.x. Category: cloud,management Since: 3.1 Maven coordinates:
     * org.apache.camel:camel-aws2-ecs Syntax: <code>aws2-ecs:label</code> Path
     * parameter: label (required) Logical name
     * @param path label
     */
    ...
    /**
     * AWS 2 EKS (camel-aws2-eks) Manage AWS EKS cluster instances using AWS SDK
     * version 2.x. Category: cloud,management Since: 3.1 Maven coordinates:
     * org.apache.camel:camel-aws2-eks Syntax: <code>aws2-eks:label</code> Path
     * parameter: label (required) Logical name
     * @param path label
     */
    ...
    /**
     * AWS 2 IAM (camel-aws2-iam) Manage AWS IAM instances using AWS SDK version
     * 2.x. Category: cloud,management Since: 3.1 Maven coordinates:
     * org.apache.camel:camel-aws2-iam Syntax: <code>aws2-iam:label</code> Path
     * parameter: label (required) Logical name
     * @param path label
     */
    ...
    /**
     * AWS 2 Kinesis (camel-aws2-kinesis) Consume and produce records from AWS
     * Kinesis Streams using AWS SDK version 2.x. Category: cloud,messaging
     * Since: 3.2 Maven coordinates: org.apache.camel:camel-aws2-kinesis Syntax:
     * <code>aws2-kinesis:streamName</code> Path parameter: streamName
    ...
    /**
     * AWS 2 Kinesis Firehose (camel-aws2-kinesis) Consume data from AWS Kinesis
     * Firehose streams using AWS SDK version 2.x. Category: cloud,messaging
     * Since: 3.2 Maven coordinates: org.apache.camel:camel-aws2-kinesis Syntax:
     * <code>aws2-kinesis-firehose:streamName</code> Path parameter: streamName
     * (required) Name of the stream
     * @param path streamName
     */
    ...
    /**
     * AWS 2 KMS (camel-aws2-kms) Manage keys stored in AWS KMS instances using
     * AWS SDK version 2.x. Category: cloud,management Since: 3.1 Maven
     * coordinates: org.apache.camel:camel-aws2-kms Syntax:
     * <code>aws2-kms:label</code> Path parameter: label (required) Logical name
     * @param path label
     */
    ...
    /**
     * AWS Lambda (camel-aws2-lambda) Manage and invoke AWS Lambda functions
     * using AWS SDK version 2.x. Category: cloud,computing,serverless Since:
     * 3.2 Maven coordinates: org.apache.camel:camel-aws2-lambda Syntax:
     * <code>aws2-lambda:function</code> Path parameter: function (required)
    ...
    /**
     * AWS 2 MQ (camel-aws2-mq) Manage AWS MQ instances using AWS SDK version
     * 2.x. Category: cloud,management Since: 3.1 Maven coordinates:
     * org.apache.camel:camel-aws2-mq Syntax: <code>aws2-mq:label</code> Path
     * parameter: label (required) Logical name
     * @param path label
     */
    ...
    /**
     * AWS 2 MSK (camel-aws2-msk) Manage AWS MSK instances using AWS SDK version
     * 2.x. Category: cloud,management Since: 3.1 Maven coordinates:
     * org.apache.camel:camel-aws2-msk Syntax: <code>aws2-msk:label</code> Path
     * parameter: label (required) Logical name
     * @param path label
     */
    ...
    /**
     * AWS 2 S3 Storage Service (camel-aws2-s3) Store and retrie objects from
     * AWS S3 Storage Service using AWS SDK version 2.x. Category: cloud,file
     * Since: 3.2 Maven coordinates: org.apache.camel:camel-aws2-s3 Syntax:
     * <code>aws2-s3://bucketNameOrArn</code> Path parameter: bucketNameOrArn
    ...
    /**
     * AWS 2 Simple Email Service (camel-aws2-ses) Send e-mails through AWS SES
     * service using AWS SDK version 2.x. Category: cloud,mail Since: 3.1 Maven
     * coordinates: org.apache.camel:camel-aws2-ses Syntax:
     * <code>aws2-ses:from</code> Path parameter: from (required) The sender's
     * email address.
     * @param path from
     */
    ...
    /**
     * AWS 2 Simple Notification System (camel-aws2-sns) Send messages to an AWS
     * Simple Notification Topic using AWS SDK version 2.x. Category:
     * cloud,mobile,messaging Since: 3.1 Maven coordinates:
     * org.apache.camel:camel-aws2-sns Syntax:
     * <code>aws2-sns:topicNameOrArn</code> Path parameter: topicNameOrArn
    ...
    /**
     * AWS 2 Simple Queue Service (camel-aws2-sqs) Sending and receive messages
     * to/from AWS SQS service using AWS SDK version 2.x. Category:
     * cloud,messaging Since: 3.1 Maven coordinates:
     * org.apache.camel:camel-aws2-sqs Syntax:
     * <code>aws2-sqs:queueNameOrArn</code> Path parameter: queueNameOrArn
    ...
    /**
     * AWS CloudWatch (camel-aws-cw) Send metrics to AWS CloudWatch. Category:
     * cloud,monitoring Since: 2.11 Maven coordinates:
     * org.apache.camel:camel-aws-cw Syntax: <code>aws-cw:namespace</code> Path
     * parameter: namespace (required) The metric namespace
     * @param path namespace
     */
    ...
    /**
     * AWS DynamoDB (camel-aws-ddb) Store and retrieve data from AWS DynamoDB
     * service. Category: cloud,database,nosql Since: 2.10 Maven coordinates:
     * org.apache.camel:camel-aws-ddb Syntax: <code>aws-ddb:tableName</code>
     * Path parameter: tableName (required) The name of the table currently
     * worked with.
     * @param path tableName
     */
    ...
    /**
     * AWS DynamoDB Streams (camel-aws-ddb) Receive messages from AWS DynamoDB
     * Stream service. Category: cloud,messaging,streams Since: 2.17 Maven
     * coordinates: org.apache.camel:camel-aws-ddb Syntax:
     * <code>aws-ddbstream:tableName</code> Path parameter: tableName (required)
    ...
    /**
     * AWS EC2 (camel-aws-ec2) Manage AWS EC2 instances. Category:
     * cloud,management Since: 2.16 Maven coordinates:
     * org.apache.camel:camel-aws-ec2 Syntax: <code>aws-ec2:label</code> Path
     * parameter: label (required) Logical name
     * @param path label
     */
    ...
    /**
     * AWS ECS (camel-aws-ecs) Manage AWS ECS cluster instances. Category:
     * cloud,management Since: 3.0 Maven coordinates:
     * org.apache.camel:camel-aws-ecs Syntax: <code>aws-ecs:label</code> Path
     * parameter: label (required) Logical name
     * @param path label
     */
    ...
    /**
     * AWS EKS (camel-aws-eks) Manage AWS EKS cluster instances. Category:
     * cloud,management Since: 3.0 Maven coordinates:
     * org.apache.camel:camel-aws-eks Syntax: <code>aws-eks:label</code> Path
     * parameter: label (required) Logical name
     * @param path label
     */
    ...
    /**
     * AWS IAM (camel-aws-iam) Manage AWS IAM instances. Category:
     * cloud,management Since: 2.23 Maven coordinates:
     * org.apache.camel:camel-aws-iam Syntax: <code>aws-iam:label</code> Path
     * parameter: label (required) Logical name
     * @param path label
     */
    ...
    /**
     * AWS Kinesis (camel-aws-kinesis) Consume and produce records from AWS
     * Kinesis Streams. Category: cloud,messaging Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-aws-kinesis Syntax:
     * <code>aws-kinesis:streamName</code> Path parameter: streamName (required)
     * Name of the stream
     * @param path streamName
     */
    ...
    /**
     * AWS Kinesis Firehose (camel-aws-kinesis) Consume data from AWS Kinesis
     * Firehose streams. Category: cloud,messaging Since: 2.19 Maven
     * coordinates: org.apache.camel:camel-aws-kinesis Syntax:
     * <code>aws-kinesis-firehose:streamName</code> Path parameter: streamName
     * (required) Name of the stream
     * @param path streamName
     */
    ...
    /**
     * AWS KMS (camel-aws-kms) Manage keys stored in AWS KMS instances.
     * Category: cloud,management Since: 2.21 Maven coordinates:
     * org.apache.camel:camel-aws-kms Syntax: <code>aws-kms:label</code> Path
     * parameter: label (required) Logical name
     * @param path label
     */
     ...
     * Category: cloud,computing,serverless Since: 2.20 Maven coordinates:
     * org.apache.camel:camel-aws-lambda Syntax:
     * <code>aws-lambda:function</code> Path parameter: function (required) Name
    ...
    /**
     * AWS MQ (camel-aws-mq) Manage AWS MQ instances. Category: cloud,management
     * Since: 2.21 Maven coordinates: org.apache.camel:camel-aws-mq Syntax:
     * <code>aws-mq:label</code> Path parameter: label (required) Logical name
     * @param path label
     */
    ...
    /**
     * AWS MSK (camel-aws-msk) Manage AWS MSK instances. Category:
     * cloud,management Since: 3.0 Maven coordinates:
     * org.apache.camel:camel-aws-msk Syntax: <code>aws-msk:label</code> Path
     * parameter: label (required) Logical name
     * @param path label
     */
    ...
    /**
     * AWS S3 Storage Service (camel-aws-s3) Store and retrie objects from AWS
     * S3 Storage Service. Category: cloud,file Since: 2.8 Maven coordinates:
     * org.apache.camel:camel-aws-s3 Syntax:
     * <code>aws-s3://bucketNameOrArn</code> Path parameter: bucketNameOrArn
     * (required) Bucket name or ARN
     * @param path //bucketNameOrArn
     */
    ...
    /**
     * AWS SimpleDB (camel-aws-sdb) Store and Retrieve data from/to AWS SDB
     * service. Category: cloud,database,nosql Since: 2.9 Maven coordinates:
     * org.apache.camel:camel-aws-sdb Syntax: <code>aws-sdb:domainName</code>
     * Path parameter: domainName (required) The name of the domain currently
     * worked with.
    ...
    /**
     * AWS Simple Email Service (camel-aws-ses) Send e-mails through AWS SES
     * service. Category: cloud,mail Since: 2.9 Maven coordinates:
     * org.apache.camel:camel-aws-ses Syntax: <code>aws-ses:from</code> Path
     * parameter: from (required) The sender's email address.
     * @param path from
     */
    ...
    /**
     * AWS Simple Notification System (camel-aws-sns) Send messages to an AWS
     * Simple Notification Topic. Category: cloud,mobile,messaging Since: 2.8
     * Maven coordinates: org.apache.camel:camel-aws-sns Syntax:
     * <code>aws-sns:topicNameOrArn</code> Path parameter: topicNameOrArn
     * (required) Topic name or ARN
     * @param path topicNameOrArn
     */
    ...
    /**
     * AWS Simple Queue Service (camel-aws-sqs) Sending and receive messages
     * to/from AWS SQS service. Category: cloud,messaging Since: 2.6 Maven
     * coordinates: org.apache.camel:camel-aws-sqs Syntax:
     * <code>aws-sqs:queueNameOrArn</code> Path parameter: queueNameOrArn
     * (required) Queue name or ARN
     * @param path queueNameOrArn
     */
    ...
    /**
     * AWS Simple Workflow (camel-aws-swf) Manage workflows in the AWS Simple
     * Workflow service. Category: cloud,workflow Since: 2.13 Maven coordinates:
     * org.apache.camel:camel-aws-swf Syntax: <code>aws-swf:type</code> Path
     * parameter: type (required) Activity or workflow The value can be one of:
     * activity, workflow
     * @param path type
     */
     ...
     * Category: cloud,management Since: 3.0 Maven coordinates:
     * org.apache.camel:camel-aws-translate Syntax:
     * <code>aws-translate:label</code> Path parameter: label (required) Logical
     * name
     * @param path label
     */
    ...
    /**
     * Azure Storage Blob Service (Legacy) (camel-azure) Store and retrieve
     * blobs from Azure Storage Blob Service. Category: cloud,database,nosql
     * Since: 2.19 Maven coordinates: org.apache.camel:camel-azure Syntax:
     * <code>azure-blob:containerOrBlobUri</code> Path parameter:
     * containerOrBlobUri (required) Container or Blob compact Uri
    ...
    /**
     * Azure Storage Queue Service (Legacy) (camel-azure) Store and retrieve
     * messages from Azure Storage Queue Service. Category: cloud,queue,azure
     * Since: 2.19 Maven coordinates: org.apache.camel:camel-azure Syntax:
     * <code>azure-queue:containerAndQueueUri</code> Path parameter:
     * containerAndQueueUri (required) Container Queue compact Uri
    ...
    /**
     * Azure Storage Blob Service (camel-azure-storage-blob) Store and retrieve
     * blobs from Azure Storage Blob Service using SDK v12. Category: cloud,file
     * Since: 3.3 Maven coordinates: org.apache.camel:camel-azure-storage-blob
     * Syntax: <code>azure-storage-blob:containerName</code> Path parameter:
     * accountName Azure account name to be used for authentication with azure
     * blob services Path parameter: containerName The blob container name
    ...
    /**
     * Azure Storage Queue Service (camel-azure-storage-queue) The
     * azure-storage-queue component is used for storing and retrieving the
     * messages to/from Azure Storage Queue using Azure SDK v12. Category:
     * cloud,messaging Since: 3.3 Maven coordinates:
     * org.apache.camel:camel-azure-storage-queue Syntax:
     * <code>azure-storage-queue:queueName</code> Path parameter: accountName
     * Azure account name to be used for authentication with azure queue
     * services Path parameter: queueName The queue resource name
     ...
     * Category: core,java Since: 1.0 Maven coordinates:
     * org.apache.camel:camel-bean Syntax: <code>bean:beanName</code> Path
     * parameter: beanName (required) Sets the name of the bean to invoke
     * @param path beanName
     */
    ...
    /**
     * Beanstalk (camel-beanstalk) Retrieve and post-process Beanstalk jobs.
     * Category: messaging Since: 2.15 Maven coordinates:
     * org.apache.camel:camel-beanstalk Syntax:
     * <code>beanstalk:connectionSettings</code> Path parameter:
     * connectionSettings Connection settings host:port/tube
    ...
    /**
     * Bean Validator (camel-bean-validator) Validate the message body using the
     * Java Bean Validation API. Category: validation Since: 2.3 Maven
     * coordinates: org.apache.camel:camel-bean-validator Syntax:
     * <code>bean-validator:label</code> Path parameter: label (required) Where
     * label is an arbitrary text value describing the endpoint
     * @param path label
     */
    ...
    /**
     * Bonita (camel-bonita) Communicate with a remote Bonita BPM process
     * engine. Category: process Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-bonita Syntax: <code>bonita:operation</code> Path
     * parameter: operation (required) Operation to use The value can be one of:
     * startCase
    ...
    /**
     * Box (camel-box) Upload, download and manage files, folders, groups,
     * collaborations, etc. on box.com. Category: api,file,cloud Since: 2.14
     * Maven coordinates: org.apache.camel:camel-box Syntax:
     * <code>box:apiName/methodName</code> Path parameter: apiName (required)
     * What kind of operation to perform The value can be one of:
     * COLLABORATIONS, COMMENTS, EVENT_LOGS, FILES, FOLDERS, GROUPS, EVENTS,
     * SEARCH, TASKS, USERS Path parameter: methodName (required) What sub
     * operation to use for the selected operation
     * @param path apiName/methodName
     */
     ...
     * Category: api,cloud,payment Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-braintree Syntax:
     * <code>braintree:apiName/methodName</code> Path parameter: apiName
     * (required) What kind of operation to perform The value can be one of:
     * ADDON, ADDRESS, CLIENTTOKEN, CREDITCARDVERIFICATION, CUSTOMER, DISCOUNT,
     * DISPUTE, DOCUMENTUPLOAD, MERCHANTACCOUNT, PAYMENTMETHOD,
     * PAYMENTMETHODNONCE, PLAN, REPORT, SETTLEMENTBATCHSUMMARY, SUBSCRIPTION,
     * TRANSACTION, WEBHOOKNOTIFICATION Path parameter: methodName What sub
     * operation to use for the selected operation
     * @param path apiName/methodName
     */
    ...
    /**
     * Browse (camel-browse) Inspect the messages received on endpoints
     * supporting BrowsableEndpoint. Category: core,monitoring Since: 1.3 Maven
     * coordinates: org.apache.camel:camel-browse Syntax:
     * <code>browse:name</code> Path parameter: name (required) A name which can
     * be any string to uniquely identify the endpoint
     * @param path name
     */
    ...
    /**
     * Caffeine Cache (camel-caffeine) Perform caching operations using Caffeine
     * Cache. Category: cache,datagrid,clustering Since: 2.20 Maven coordinates:
     * org.apache.camel:camel-caffeine Syntax:
     * <code>caffeine-cache:cacheName</code> Path parameter: cacheName
    ...
    /**
     * Caffeine LoadCache (camel-caffeine) Perform caching operations using
     * Caffeine Cache with an attached CacheLoader. Category:
     * cache,datagrid,clustering Since: 2.20 Maven coordinates:
     * org.apache.camel:camel-caffeine Syntax:
     * <code>caffeine-loadcache:cacheName</code> Path parameter: cacheName
     * (required) the cache name
     * @param path cacheName
     */
    ...
    /**
     * ChatScript (camel-chatscript) Chat with a ChatScript Server. Category:
     * ai,chatscript Since: 3.0 Maven coordinates:
     * org.apache.camel:camel-chatscript Syntax:
     * <code>chatscript:host:port/botName</code> Path parameter: host (required)
     * Hostname or IP of the server on which CS server is running Path
     * parameter: port Port on which ChatScript is listening to Default value:
     * 1024 Path parameter: botName (required) Name of the Bot in CS to converse
     * with
    ...
    /**
     * Chunk (camel-chunk) Transform messages using Chunk templating engine.
     * Category: transformation Since: 2.15 Maven coordinates:
     * org.apache.camel:camel-chunk Syntax: <code>chunk:resourceUri</code> Path
     * parameter: resourceUri (required) Path to the resource. You can prefix
     * with: classpath, file, http, ref, or bean. classpath, file and http loads
     * the resource using these protocols (classpath is default). ref will
     * lookup the resource in the registry. bean will call a method on a bean to
     * be used as the resource. For bean you can specify the method name after
     * dot, eg bean:myBean.myMethod.
    ...
    /**
     * Class (camel-bean) Invoke methods of Java beans specified by class name.
     * Category: core,java Since: 2.4 Maven coordinates:
     * org.apache.camel:camel-bean Syntax: <code>class:beanName</code> Path
     * parameter: beanName (required) Sets the name of the bean to invoke
     * @param path beanName
     */
    ...
    /**
     * CMIS (camel-cmis) Read and write data from to/from a CMIS compliant
     * content repositories. Category: cms,database Since: 2.11 Maven
     * coordinates: org.apache.camel:camel-cmis Syntax: <code>cmis:cmsUrl</code>
     * Path parameter: cmsUrl (required) URL to the cmis repository
     * @param path cmsUrl
     */
     ...
     * Category: mobile Since: 2.18 Maven coordinates:
     * org.apache.camel:camel-cm-sms Syntax: <code>cm-sms:host</code> Path
     * parameter: host (required) SMS Provider HOST with scheme
     * @param path host
     */
    ...
    /**
     * CoAP (camel-coap) Send and receive messages to/from COAP capable devices.
     * Category: iot Since: 2.16 Maven coordinates: org.apache.camel:camel-coap
     * Syntax: <code>coap:uri</code> Path parameter: uri The URI for the CoAP
     * endpoint
     * @param path uri
     */
    ...
    /**
     * CoAP (Secure) (camel-coap) Send and receive messages to/from COAP capable
     * devices. Category: iot Since: 2.16 Maven coordinates:
     * org.apache.camel:camel-coap Syntax: <code>coaps:uri</code> Path
     * parameter: uri The URI for the CoAP endpoint
     * @param path uri
     */
    static org.apache.camel.builder.endpoint.dsl.CoAPEndpointBuilderFactory.CoAPEndpointBuilder coaps(
            java.lang.String path) {
     ...
     * CoAP (camel-coap) Send and receive messages to/from COAP capable devices.
     * Category: iot Since: 2.16 Maven coordinates: org.apache.camel:camel-coap
     * Syntax: <code>coaps+tcp:uri</code> Path parameter: uri The URI for the
     * CoAP endpoint
     * @param path uri
     */
    static org.apache.camel.builder.endpoint.dsl.CoAPEndpointBuilderFactory.CoAPEndpointBuilder coapsTcp(
            java.lang.String path) {
     ...
     * CoAP (camel-coap) Send and receive messages to/from COAP capable devices.
     * Category: iot Since: 2.16 Maven coordinates: org.apache.camel:camel-coap
     * Syntax: <code>coap+tcp:uri</code> Path parameter: uri The URI for the
     * CoAP endpoint
     * @param path uri
     */
    static org.apache.camel.builder.endpoint.dsl.CoAPEndpointBuilderFactory.CoAPEndpointBuilder coapTcp(
            java.lang.String path) {
    ...
    /**
     * CometD (camel-cometd) Offers publish/subscribe, peer-to-peer (via a
     * server), and RPC style messaging using the CometD/Bayeux protocol.
     * Category: websocket Since: 2.0 Maven coordinates:
     * org.apache.camel:camel-cometd Syntax:
     * <code>cometd:host:port/channelName</code> Path parameter: host (required)
     * Hostname Path parameter: port (required) Host port number Path parameter:
    ...
    /**
     * CometD (Secure) (camel-cometd) Offers publish/subscribe, peer-to-peer
     * (via a server), and RPC style messaging using the CometD/Bayeux protocol.
     * Category: websocket Since: 2.0 Maven coordinates:
     * org.apache.camel:camel-cometd Syntax:
     * <code>cometds:host:port/channelName</code> Path parameter: host
     * (required) Hostname Path parameter: port (required) Host port number Path
     * parameter: channelName (required) The channelName represents a topic that
     * can be subscribed to by the Camel endpoints.
     * @param path host:port/channelName
     */
    static org.apache.camel.builder.endpoint.dsl.CometdEndpointBuilderFactory.CometdEndpointBuilder cometds(
            java.lang.String path) {
    ...
    /**
     * Consul (camel-consul) Integrate with Consul service discovery and
     * configuration store. Category: api,cloud Since: 2.18 Maven coordinates:
     * org.apache.camel:camel-consul Syntax: <code>consul:apiEndpoint</code>
     * Path parameter: apiEndpoint (required) The API endpoint
    ...
    /**
     * Control Bus (camel-controlbus) Manage and monitor Camel routes. Category:
     * core,monitoring Since: 2.11 Maven coordinates:
     * org.apache.camel:camel-controlbus Syntax:
     * <code>controlbus:command:language</code> Path parameter: command
     * (required) Command can be either route or language The value can be one
     * of: route, language Path parameter: language Allows you to specify the
     * name of a Language to use for evaluating the message body. If there is
     * any result from the evaluation, then the result is put in the message
     * body. The value can be one of: bean, constant, el, exchangeProperty,
     * file, groovy, header, jsonpath, mvel, ognl, ref, simple, spel, sql,
    ...
    /**
     * Corda (camel-corda) Perform operations against Corda blockchain platform
     * using corda-rpc library. Category: corda,blockchain Since: 2.23 Maven
     * coordinates: org.apache.camel:camel-corda Syntax: <code>corda:node</code>
     * Path parameter: node (required) The url for the corda node
     * @param path node
     */
    ...
    /**
     * Couchbase (camel-couchbase) Query Couchbase Views with a poll strategy
     * and/or perform various operations against Couchbase databases. Category:
     * database,nosql Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-couchbase Syntax:
     * <code>couchbase:protocol:hostname:port</code> Path parameter: protocol
     * (required) The protocol to use Path parameter: hostname (required) The
     * hostname to use Path parameter: port The port number to use Default
     * value: 8091
    ...
    /**
     * CouchDB (camel-couchdb) Consume changesets for inserts, updates and
     * deletes in a CouchDB database, as well as get, save, update and delete
     * documents from a CouchDB database. Category: database,nosql Since: 2.11
     * Maven coordinates: org.apache.camel:camel-couchdb Syntax:
     * <code>couchdb:protocol:hostname:port/database</code> Path parameter:
     * protocol (required) The protocol to use for communicating with the
     * database. The value can be one of: http, https Path parameter: hostname
     * (required) Hostname of the running couchdb instance Path parameter: port
     * Port number for the running couchdb instance Default value: 5984 Path
    ...
    /**
     * Cassandra CQL (camel-cassandraql) Integrate with Cassandra 2.0 using the
     * CQL3 API (not the Thrift API). Category: database,nosql Since: 2.15 Maven
     * coordinates: org.apache.camel:camel-cassandraql Syntax:
     * <code>cql:beanRef:hosts:port/keyspace</code> Path parameter: beanRef
     * beanRef is defined using bean:id Path parameter: hosts Hostname(s)
     * cassansdra server(s). Multiple hosts can be separated by comma. Path
     * parameter: port Port number of cassansdra server(s) Path parameter:
    ...
    /**
     * Cron (camel-cron) A generic interface for triggering events at times
     * specified through the Unix cron syntax. Category: scheduling Since: 3.1
     * Maven coordinates: org.apache.camel:camel-cron Syntax:
     * <code>cron:name</code> Path parameter: name (required) The name of the
     * cron trigger
     * @param path name
     */
    ...
    /**
     * Crypto (JCE) (camel-crypto) Sign and verify exchanges using the Signature
     * Service of the Java Cryptographic Extension (JCE). Category:
     * security,transformation Since: 2.3 Maven coordinates:
     * org.apache.camel:camel-crypto Syntax:
     * <code>crypto:cryptoOperation:name</code> Path parameter: cryptoOperation
     * (required) Set the Crypto operation from that supplied after the crypto
     * scheme in the endpoint uri e.g. crypto:sign sets sign as the operation.
     * The value can be one of: sign, verify Path parameter: name (required) The
     * logical name of this operation.
    ...
    /**
     * Crypto CMS (camel-crypto-cms) Encrypt, decrypt, sign and verify data in
     * CMS Enveloped Data format. Category: security,transformation Since: 2.20
     * Maven coordinates: org.apache.camel:camel-crypto-cms Syntax:
     * <code>crypto-cms:cryptoOperation:name</code> Path parameter:
     * cryptoOperation (required) Set the Crypto operation from that supplied
     * after the crypto scheme in the endpoint uri e.g. crypto-cms:sign sets
     * sign as the operation. Possible values: sign, verify, encrypt, or
     * decrypt. The value can be one of: sign, verify, encrypt, decrypt Path
     * parameter: name (required) The name part in the URI can be chosen by the
     * user to distinguish between different signer/verifier/encryptor/decryptor
    ...
    /**
     * CXF (camel-cxf) Expose SOAP WebServices using Apache CXF or connect to
     * external WebServices using CXF WS client. Category: soap,webservice
     * Since: 1.0 Maven coordinates: org.apache.camel:camel-cxf Syntax:
     * <code>cxf:beanId:address</code> Path parameter: beanId To lookup an
     * existing configured CxfEndpoint. Must used bean: as prefix. Path
     * parameter: address The service publish address.
    ...
    /**
     * CXF-RS (camel-cxf) Expose JAX-RS REST services using Apache CXF or
     * connect to external REST services using CXF REST client. Category: rest
     * Since: 2.0 Maven coordinates: org.apache.camel:camel-cxf Syntax:
     * <code>cxfrs:beanId:address</code> Path parameter: beanId To lookup an
     * existing configured CxfRsEndpoint. Must used bean: as prefix. Path
     * parameter: address The service publish address.
     * @param path beanId:address
     */
    ...
    /**
     * Data Format (camel-dataformat) Use a Camel Data Format as a regular Camel
     * Component. Category: core,transformation Since: 2.12 Maven coordinates:
     * org.apache.camel:camel-dataformat Syntax:
     * <code>dataformat:name:operation</code> Path parameter: name (required)
     * Name of data format Path parameter: operation (required) Operation to use
     * either marshal or unmarshal The value can be one of: marshal, unmarshal
     * @param path name:operation
     */
    ...
    /**
     * Dataset (camel-dataset) Provide data for load & soak testing of your
     * Camel application. Category: core,testing Since: 1.3 Maven coordinates:
     * org.apache.camel:camel-dataset Syntax: <code>dataset:name</code> Path
     * parameter: name (required) Name of DataSet to lookup in the registry
     * @param path name
     */
    ...
    /**
     * DataSet Test (camel-dataset) Extends the mock component by pulling
     * messages from another endpoint on startup to set the expected message
     * bodies. Category: core,testing Since: 1.3 Maven coordinates:
     * org.apache.camel:camel-dataset Syntax: <code>dataset-test:name</code>
     * Path parameter: name (required) Name of endpoint to lookup in the
    ...
    /**
     * Debezium MongoDB Connector (camel-debezium-mongodb) Capture changes from
     * a MongoDB database. Category: database,nosql,mongodb Since: 3.0 Maven
     * coordinates: org.apache.camel:camel-debezium-mongodb Syntax:
     * <code>debezium-mongodb:name</code> Path parameter: name (required) Unique
     * name for the connector. Attempting to register again with the same name
     * will fail.
     * @param path name
     */
    ...
    /**
     * Debezium MySQL Connector (camel-debezium-mysql) Capture changes from a
     * MySQL database. Category: database,sql,mysql Since: 3.0 Maven
     * coordinates: org.apache.camel:camel-debezium-mysql Syntax:
     * <code>debezium-mysql:name</code> Path parameter: name (required) Unique
     * name for the connector. Attempting to register again with the same name
     * will fail.
     * @param path name
     */
    ...
    /**
     * Debezium PostgresSQL Connector (camel-debezium-postgres) Capture changes
     * from a PostgresSQL database. Category: database,sql,postgres Since: 3.0
     * Maven coordinates: org.apache.camel:camel-debezium-postgres Syntax:
     * <code>debezium-postgres:name</code> Path parameter: name (required)
    ...
    /**
     * Debezium SQL Server Connector (camel-debezium-sqlserver) Capture changes
     * from an SQL Server database. Category: database,sql,sqlserver Since: 3.0
     * Maven coordinates: org.apache.camel:camel-debezium-sqlserver Syntax:
     * <code>debezium-sqlserver:name</code> Path parameter: name (required)
     * Unique name for the connector. Attempting to register again with the same
     * name will fail.
     * @param path name
     */
    ...
    /**
     * DigitalOcean (camel-digitalocean) Manage Droplets and resources within
     * the DigitalOcean cloud. Category: cloud,management Since: 2.19 Maven
     * coordinates: org.apache.camel:camel-digitalocean Syntax:
     * <code>digitalocean:operation</code> Path parameter: operation The
     * operation to perform to the given resource. The value can be one of:
     * create, update, delete, list, ownList, get, listBackups, listActions,
     * listNeighbors, listSnapshots, listKernels, listAllNeighbors,
     * enableBackups, disableBackups, reboot, powerCycle, shutdown, powerOn,
     * powerOff, restore, resetPassword, resize, rebuild, rename, changeKernel,
    ...
    /**
     * Direct (camel-direct) Call another endpoint from the same Camel Context
     * synchronously. Category: core,endpoint Since: 1.0 Maven coordinates:
     * org.apache.camel:camel-direct Syntax: <code>direct:name</code> Path
     * parameter: name (required) Name of direct endpoint
     * @param path name
     */
    ...
    /**
     * Direct VM (camel-directvm) Call another endpoint from any Camel Context
     * in the same JVM synchronously. Category: core,endpoint Since: 2.10 Maven
     * coordinates: org.apache.camel:camel-directvm Syntax:
     * <code>direct-vm:name</code> Path parameter: name (required) Name of
     * direct-vm endpoint
     * @param path name
     */
    ...
    /**
     * Disruptor (camel-disruptor) Provides asynchronous SEDA behavior using
     * LMAX Disruptor. Category: endpoint Since: 2.12 Maven coordinates:
     * org.apache.camel:camel-disruptor Syntax: <code>disruptor:name</code> Path
     * parameter: name (required) Name of queue
     * @param path name
     */
    ...
    /**
     * Disruptor VM (camel-disruptor) Provides asynchronous SEDA behavior using
     * LMAX Disruptor. Category: endpoint Since: 2.12 Maven coordinates:
     * org.apache.camel:camel-disruptor Syntax: <code>disruptor-vm:name</code>
     * Path parameter: name (required) Name of queue
     * @param path name
     */
    ...
    /**
     * Deep Java Library (camel-djl) Infer Deep Learning models from message
     * exchanges data using Deep Java Library (DJL). Category: ai,deeplearning
     * Since: 3.3 Maven coordinates: org.apache.camel:camel-djl Syntax:
     * <code>djl:application</code> Path parameter: application (required)
     * Application name
    ...
    /**
     * DNS (camel-dns) Perform DNS queries using DNSJava. Category: networking
     * Since: 2.7 Maven coordinates: org.apache.camel:camel-dns Syntax:
     * <code>dns:dnsType</code> Path parameter: dnsType (required) The type of
     * the lookup. The value can be one of: dig, ip, lookup, wikipedia
     * @param path dnsType
     */
    ...
    /**
     * Docker (camel-docker) Manage Docker containers. Category:
     * container,cloud,paas Since: 2.15 Maven coordinates:
     * org.apache.camel:camel-docker Syntax: <code>docker:operation</code> Path
     * parameter: operation (required) Which operation to use The value can be
     * one of: events, stats, auth, info, ping, version, imagebuild,
     * imagecreate, imageinspect, imagelist, imagepull, imagepushimageremove,
     ...
     * containerrestart, containerremove, containerstartcontainerstop,
     * containertop, containerunpause, containerwait, execcreate, execstart
     * @param path operation
     */
    ...
    /**
     * Dozer (camel-dozer) Map between Java beans using the Dozer mapping
     * library. Category: transformation Since: 2.15 Maven coordinates:
     * org.apache.camel:camel-dozer Syntax: <code>dozer:name</code> Path
     * parameter: name (required) A human readable name of the mapping.
     * @param path name
     */
    ...
    /**
     * Drill (camel-drill) Perform queries against an Apache Drill cluster.
     * Category: database,sql Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-drill Syntax: <code>drill:host</code> Path
     * parameter: host (required) Host name or IP address
     * @param path host
     */
    ...
    /**
     * Dropbox (camel-dropbox) Upload, download and manage files, folders,
     * groups, collaborations, etc on Dropbox. Category: api,file Since: 2.14
     * Maven coordinates: org.apache.camel:camel-dropbox Syntax:
     * <code>dropbox:operation</code> Path parameter: operation (required) The
     * specific action (typically is a CRUD action) to perform on Dropbox remote
     * folder. The value can be one of: put, del, search, get, move
     * @param path operation
     */
     ...
     * Category: cache,datagrid,clustering Since: 2.18 Maven coordinates:
     * org.apache.camel:camel-ehcache Syntax: <code>ehcache:cacheName</code>
     * Path parameter: cacheName (required) the cache name
     * @param path cacheName
     */
    ...
    /**
     * Elasticsearch Rest (camel-elasticsearch-rest) Send requests to with an
     * ElasticSearch via REST API. Category: monitoring,search Since: 2.21 Maven
     * coordinates: org.apache.camel:camel-elasticsearch-rest Syntax:
     * <code>elasticsearch-rest:clusterName</code> Path parameter: clusterName
    ...
    /**
     * ElSQL (camel-elsql) Use ElSql to define SQL queries. Extends the SQL
     * Component. Category: database,sql Since: 2.16 Maven coordinates:
     * org.apache.camel:camel-elsql Syntax:
     * <code>elsql:elsqlName:resourceUri</code> Path parameter: elsqlName
     * (required) The name of the elsql to use (is NAMED in the elsql file) Path
     * parameter: resourceUri The resource file which contains the elsql SQL
     * statements to use. You can specify multiple resources separated by comma.
     * The resources are loaded on the classpath by default, you can prefix with
    ...
    /**
     * Etcd Keys (camel-etcd) Get, set or delete keys in etcd key-value store.
     * Category: clustering,database Since: 2.18 Maven coordinates:
     * org.apache.camel:camel-etcd Syntax: <code>etcd-keys:path</code> Path
     * parameter: path The path the endpoint refers to
     * @param path path
     */
    ...
    /**
     * Etcd Stats (camel-etcd) Access etcd cluster statistcs. Category:
     * clustering,database Since: 2.18 Maven coordinates:
     * org.apache.camel:camel-etcd Syntax: <code>etcd-stats:path</code> Path
     * parameter: path The path the endpoint refers to
     * @param path path
     */
    ...
    /**
     * Etcd Watch (camel-etcd) Watch specific etcd keys or directories for
     * changes. Category: clustering,database Since: 2.18 Maven coordinates:
     * org.apache.camel:camel-etcd Syntax: <code>etcd-watch:path</code> Path
     * parameter: path The path the endpoint refers to
     * @param path path
     */
     ...
     * Category: system Since: 2.3 Maven coordinates:
     * org.apache.camel:camel-exec Syntax: <code>exec:executable</code> Path
     * parameter: executable (required) Sets the executable to be executed. The
    ...
    /**
     * Facebook (camel-facebook) Send requests to Facebook APIs supported by
     * Facebook4J. Category: social Since: 2.14 Maven coordinates:
     * org.apache.camel:camel-facebook Syntax: <code>facebook:methodName</code>
     * Path parameter: methodName (required) What operation to perform
    ...
    /**
     * FHIR (camel-fhir) Exchange information in the healthcare domain using the
     * FHIR (Fast Healthcare Interoperability Resources) standard. Category:
     * hl7,api Since: 2.23 Maven coordinates: org.apache.camel:camel-fhir
     * Syntax: <code>fhir:apiName/methodName</code> Path parameter: apiName
     * (required) What kind of operation to perform The value can be one of:
     * capabilities, create, delete, history, load-page, meta, patch, read,
     * search, transaction, update, validate Path parameter: methodName
    ...
    /**
     * File (camel-file) Read and write files. Category: core,file Since: 1.0
     * Maven coordinates: org.apache.camel:camel-file Syntax:
     * <code>file:directoryName</code> Path parameter: directoryName (required)
    ...
    /**
     * File Watch (camel-file-watch) Get notified about file events in a
     * directory using java.nio.file.WatchService. Category: file Since: 3.0
     * Maven coordinates: org.apache.camel:camel-file-watch Syntax:
     * <code>file-watch:path</code> Path parameter: path (required) Path of
     * directory to consume events from.
     * @param path path
     */
    ...
    /**
     * Flatpack (camel-flatpack) Parse fixed width and delimited files using the
     * FlatPack library. Category: transformation Since: 1.4 Maven coordinates:
     * org.apache.camel:camel-flatpack Syntax:
     * <code>flatpack:type:resourceUri</code> Path parameter: type Whether to
     * use fixed or delimiter Default value: delim The value can be one of:
     * fixed, delim Path parameter: resourceUri (required) URL for loading the
     * flatpack mapping file from classpath or file system
    ...
    /**
     * Flink (camel-flink) Send DataSet jobs to an Apache Flink cluster.
     * Category: hadoop Since: 2.18 Maven coordinates:
     * org.apache.camel:camel-flink Syntax: <code>flink:endpointType</code> Path
     * parameter: endpointType (required) Type of the endpoint (dataset,
     * datastream). The value can be one of: dataset, datastream
    ...
    /**
     * FOP (camel-fop) Render messages into PDF and other output formats
     * supported by Apache FOP. Category: transformation Since: 2.10 Maven
     * coordinates: org.apache.camel:camel-fop Syntax:
     * <code>fop:outputType</code> Path parameter: outputType (required) The
    ...
    /**
     * Freemarker (camel-freemarker) Transform messages using FreeMarker
     * templates. Category: transformation Since: 2.10 Maven coordinates:
     * org.apache.camel:camel-freemarker Syntax:
     * <code>freemarker:resourceUri</code> Path parameter: resourceUri
     * (required) Path to the resource. You can prefix with: classpath, file,
     * http, ref, or bean. classpath, file and http loads the resource using
     * these protocols (classpath is default). ref will lookup the resource in
     * the registry. bean will call a method on a bean to be used as the
    ...
    /**
     * FTP (camel-ftp) Upload and download files to/from FTP servers. Category:
     * file Since: 1.1 Maven coordinates: org.apache.camel:camel-ftp Syntax:
     * <code>ftp:host:port/directoryName</code> Path parameter: host (required)
     * Hostname of the FTP server Path parameter: port Port of the FTP server
     * Path parameter: directoryName The starting directory
    ...
    /**
     * FTPS (camel-ftp) Upload and download files to/from FTP servers supporting
     * the FTPS protocol. Category: file Since: 2.2 Maven coordinates:
     * org.apache.camel:camel-ftp Syntax:
     * <code>ftps:host:port/directoryName</code> Path parameter: host (required)
     * Hostname of the FTP server Path parameter: port Port of the FTP server
     * Path parameter: directoryName The starting directory
     * @param path host:port/directoryName
     */
    ...
    /**
     * Ganglia (camel-ganglia) Send metrics to Ganglia monitoring system.
     * Category: monitoring Since: 2.15 Maven coordinates:
     * org.apache.camel:camel-ganglia Syntax: <code>ganglia:host:port</code>
     * Path parameter: host Host name for Ganglia server Default value:
     * 239.2.11.71 Path parameter: port Port for Ganglia server Default value:
     * 8649
    ...
    /**
     * Geocoder (camel-geocoder) Find geocodes (latitude and longitude) for a
     * given address or the other way round. Category: api,location Since: 2.12
     * Maven coordinates: org.apache.camel:camel-geocoder Syntax:
     * <code>geocoder:address:latlng</code> Path parameter: address The geo
     * address which should be prefixed with address: Path parameter: latlng The
     * geo latitude and longitude which should be prefixed with latlng:
    ...
    /**
     * Git (camel-git) Perform operations on git repositories. Category: file
     * Since: 2.16 Maven coordinates: org.apache.camel:camel-git Syntax:
     * <code>git:localPath</code> Path parameter: localPath (required) Local
     * repository path
    ...
    /**
     * GitHub (camel-github) Interact with the GitHub API. Category: api,file
     * Since: 2.15 Maven coordinates: org.apache.camel:camel-github Syntax:
     * <code>github:type/branchName</code> Path parameter: type (required) What
     * git operation to execute The value can be one of: CLOSEPULLREQUEST,
     * PULLREQUESTCOMMENT, COMMIT, PULLREQUEST, TAG, PULLREQUESTSTATE,
     * PULLREQUESTFILES, GETCOMMITFILE, CREATEISSUE Path parameter: branchName
     * Name of branch
    ...
    /**
     * Google BigQuery (camel-google-bigquery) Google BigQuery data warehouse
     * for analytics. Category: cloud,messaging Since: 2.20 Maven coordinates:
     * org.apache.camel:camel-google-bigquery Syntax:
     * <code>google-bigquery:projectId:datasetId:tableId</code> Path parameter:
     * projectId (required) Google Cloud Project Id Path parameter: datasetId
     * (required) BigQuery Dataset Id Path parameter: tableId BigQuery table id
    ...
    /**
     * Google BigQuery Standard SQL (camel-google-bigquery) Access Google Cloud
     * BigQuery service using SQL queries. Category: cloud,messaging Since: 2.23
     * Maven coordinates: org.apache.camel:camel-google-bigquery Syntax:
     * <code>google-bigquery-sql:projectId:query</code> Path parameter: query
     * (required) BigQuery standard SQL query Path parameter: projectId
    ...
    /**
     * Google Calendar (camel-google-calendar) Perform various operations on a
     * Google Calendar. Category: api,cloud Since: 2.15 Maven coordinates:
     * org.apache.camel:camel-google-calendar Syntax:
     * <code>google-calendar:apiName/methodName</code> Path parameter: apiName
     * (required) What kind of operation to perform The value can be one of:
     * ACL, LIST, CALENDARS, CHANNELS, COLORS, FREEBUSY, EVENTS, SETTINGS Path
     * parameter: methodName (required) What sub operation to use for the
     * selected operation The value can be one of: calendarImport, clear,
    ...
    /**
     * Google Calendar Stream (camel-google-calendar) Poll for changes in a
     * Google Calendar. Category: api,cloud Since: 2.23 Maven coordinates:
     * org.apache.camel:camel-google-calendar Syntax:
     * <code>google-calendar-stream:index</code> Path parameter: index Specifies
     * an index for the endpoint
     * @param path index
     */
    ...
    /**
     * Google Drive (camel-google-drive) Manage files in Google Drive. Category:
     * api,cloud,file Since: 2.14 Maven coordinates:
     * org.apache.camel:camel-google-drive Syntax:
     * <code>google-drive:apiName/methodName</code> Path parameter: apiName
     * (required) What kind of operation to perform The value can be one of:
     * drive-about, drive-apps, drive-changes, drive-channels, drive-children,
     * drive-comments, drive-files, drive-parents, drive-permissions,
     * drive-properties, drive-realtime, drive-replies, drive-revisions Path
     * parameter: methodName (required) What sub operation to use for the
     * selected operation The value can be one of: copy, delete, get,
    ...
    /**
     * Google Mail (camel-google-mail) Manage messages in Google Mail. Category:
     * api,cloud,mail Since: 2.15 Maven coordinates:
     * org.apache.camel:camel-google-mail Syntax:
     * <code>google-mail:apiName/methodName</code> Path parameter: apiName
     * (required) What kind of operation to perform The value can be one of:
     * THREADS, MESSAGES, ATTACHMENTS, LABELS, HISTORY, DRAFTS, USERS Path
     * parameter: methodName (required) What sub operation to use for the
     * selected operation The value can be one of: attachments, create, delete,
     * get, getProfile, gmailImport, insert, list, modify, patch, send, stop,
    ...
    /**
     * Google Mail Stream (camel-google-mail) Poll for incoming messages in
     * Google Mail. Category: api,cloud,mail Since: 2.22 Maven coordinates:
     * org.apache.camel:camel-google-mail Syntax:
     * <code>google-mail-stream:index</code> Path parameter: index Specifies an
    ...
    /**
     * Google Pubsub (camel-google-pubsub) Send and receive messages to/from
     * Google Cloud Platform PubSub Service. Category: messaging Since: 2.19
     * Maven coordinates: org.apache.camel:camel-google-pubsub Syntax:
     * <code>google-pubsub:projectId:destinationName</code> Path parameter:
     * projectId (required) Project Id Path parameter: destinationName
    ...
    /**
     * Google Sheets (camel-google-sheets) Manage spreadsheets in Google Sheets.
     * Category: api,cloud,sheets Since: 2.23 Maven coordinates:
     * org.apache.camel:camel-google-sheets Syntax:
     * <code>google-sheets:apiName/methodName</code> Path parameter: apiName
     * (required) What kind of operation to perform The value can be one of:
     * SPREADSHEETS, DATA Path parameter: methodName (required) What sub
     * operation to use for the selected operation The value can be one of:
     * create, get, update, append, batchUpdate, clear
     * @param path apiName/methodName
     */
    ...
    /**
     * Google Sheets Stream (camel-google-sheets) Poll for changes in Google
     * Sheets. Category: api,cloud,sheets Since: 2.23 Maven coordinates:
     * org.apache.camel:camel-google-sheets Syntax:
     * <code>google-sheets-stream:apiName</code> Path parameter: apiName Sets
     * the apiName.
     * @param path apiName
     */
    ...
    /**
     * Gora (camel-gora) Access NoSQL databases using the Apache Gora framework.
     * Category: database,hadoop,nosql Since: 2.14 Maven coordinates:
     * org.apache.camel:camel-gora Syntax: <code>gora:name</code> Path
     * parameter: name (required) Instance name
     * @param path name
     */
    ...
    /**
     * Grape (camel-grape) Fetch, load and manage additional jars dynamically
     * after Camel Context was started. Category: management,deployment Since:
     * 2.16 Maven coordinates: org.apache.camel:camel-grape Syntax:
     * <code>grape:defaultCoordinates</code> Path parameter: defaultCoordinates
     * (required) Maven coordinates to use as default to grab if the message
     * body is empty.
    ...
    /**
     * GraphQL (camel-graphql) Send GraphQL queries and mutations to external
     * systems. Category: api Since: 3.0 Maven coordinates:
     * org.apache.camel:camel-graphql Syntax: <code>graphql:httpUri</code> Path
     * parameter: httpUri (required) The GraphQL server URI.
     * @param path httpUri
     */
    ...
    /**
     * gRPC (camel-grpc) Expose gRPC endpoints and access external gRPC
     * endpoints. Category: rpc Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-grpc Syntax: <code>grpc:host:port/service</code>
     * Path parameter: host (required) The gRPC server host name. This is
     * localhost or 0.0.0.0 when being a consumer or remote server host name
     * when using producer. Path parameter: port (required) The gRPC local or
     * remote server port Path parameter: service (required) Fully qualified
     * service name from the protocol buffer descriptor file (package dot
    ...
    /**
     * Guava EventBus (camel-guava-eventbus) Send and receive messages to/from
     * Guava EventBus. Category: eventbus Since: 2.10 Maven coordinates:
     * org.apache.camel:camel-guava-eventbus Syntax:
     * <code>guava-eventbus:eventBusRef</code> Path parameter: eventBusRef To
     * lookup the Guava EventBus from the registry with the given name
    ...
    /**
     * Hazelcast Atomic Number (camel-hazelcast) Increment, decrement, set, etc.
     * Hazelcast atomic number (a grid wide number). Category: cache,datagrid
     * Since: 2.7 Maven coordinates: org.apache.camel:camel-hazelcast Syntax:
     * <code>hazelcast-atomicvalue:cacheName</code> Path parameter: cacheName
    ...
    /**
     * Hazelcast Instance (camel-hazelcast) Consume join/leave events of a cache
     * instance in a Hazelcast cluster. Category: cache,datagrid Since: 2.7
     * Maven coordinates: org.apache.camel:camel-hazelcast Syntax:
     * <code>hazelcast-instance:cacheName</code> Path parameter: cacheName
     * (required) The name of the cache
     * @param path cacheName
     */
    ...
    /**
     * Hazelcast List (camel-hazelcast) Perform operations on Hazelcast
     * distributed list. Category: cache,datagrid Since: 2.7 Maven coordinates:
     * org.apache.camel:camel-hazelcast Syntax:
     * <code>hazelcast-list:cacheName</code> Path parameter: cacheName
     * (required) The name of the cache
     * @param path cacheName
     */
    ...
    /**
     * Hazelcast Map (camel-hazelcast) Perform operations on Hazelcast
     * distributed map. Category: cache,datagrid Since: 2.7 Maven coordinates:
     * org.apache.camel:camel-hazelcast Syntax:
     * <code>hazelcast-map:cacheName</code> Path parameter: cacheName (required)
    ...
    /**
     * Hazelcast Multimap (camel-hazelcast) Perform operations on Hazelcast
     * distributed multimap. Category: cache,datagrid Since: 2.7 Maven
     * coordinates: org.apache.camel:camel-hazelcast Syntax:
     * <code>hazelcast-multimap:cacheName</code> Path parameter: cacheName
     * (required) The name of the cache
     * @param path cacheName
     */
    ...
    /**
     * Hazelcast Queue (camel-hazelcast) Perform operations on Hazelcast
     * distributed queue. Category: cache,datagrid Since: 2.7 Maven coordinates:
     * org.apache.camel:camel-hazelcast Syntax:
     * <code>hazelcast-queue:cacheName</code> Path parameter: cacheName
     * (required) The name of the cache
     * @param path cacheName
     */
    ...
    /**
     * Hazelcast Replicated Map (camel-hazelcast) Perform operations on
     * Hazelcast replicated map. Category: cache,datagrid Since: 2.16 Maven
     * coordinates: org.apache.camel:camel-hazelcast Syntax:
     * <code>hazelcast-replicatedmap:cacheName</code> Path parameter: cacheName
     * (required) The name of the cache
     * @param path cacheName
     */
    ...
    /**
     * Hazelcast Ringbuffer (camel-hazelcast) Perform operations on Hazelcast
     * distributed ringbuffer. Category: cache,datagrid Since: 2.16 Maven
     * coordinates: org.apache.camel:camel-hazelcast Syntax:
     * <code>hazelcast-ringbuffer:cacheName</code> Path parameter: cacheName
     * (required) The name of the cache
     * @param path cacheName
     */
    ...
    /**
     * Hazelcast SEDA (camel-hazelcast) Asynchronously send/receive Exchanges
     * between Camel routes running on potentially distinct JVMs/hosts backed by
     * Hazelcast BlockingQueue. Category: cache,datagrid Since: 2.7 Maven
     * coordinates: org.apache.camel:camel-hazelcast Syntax:
     * <code>hazelcast-seda:cacheName</code> Path parameter: cacheName
     * (required) The name of the cache
     * @param path cacheName
     */
    ...
    /**
     * Hazelcast Set (camel-hazelcast) Perform operations on Hazelcast
     * distributed set. Category: cache,datagrid Since: 2.7 Maven coordinates:
     * org.apache.camel:camel-hazelcast Syntax:
     * <code>hazelcast-set:cacheName</code> Path parameter: cacheName (required)
     * The name of the cache
     * @param path cacheName
     */
    ...
    /**
     * Hazelcast Topic (camel-hazelcast) Send and receive messages to/from
     * Hazelcast distributed topic. Category: cache,datagrid Since: 2.15 Maven
     * coordinates: org.apache.camel:camel-hazelcast Syntax:
     * <code>hazelcast-topic:cacheName</code> Path parameter: cacheName
     * (required) The name of the cache
     * @param path cacheName
     */
    ...
    /**
     * HBase (camel-hbase) Reading and write from/to an HBase store (Hadoop
     * database). Category: hadoop Since: 2.10 Maven coordinates:
     * org.apache.camel:camel-hbase Syntax: <code>hbase:tableName</code> Path
     * parameter: tableName (required) The name of the table
     * @param path tableName
     */
    ...
    /**
     * HDFS (camel-hdfs) Read and write from/to an HDFS filesystem using Hadoop
     * 2.x. Category: hadoop,file Since: 2.14 Maven coordinates:
     * org.apache.camel:camel-hdfs Syntax: <code>hdfs:hostName:port/path</code>
     * Path parameter: hostName (required) HDFS host to use Path parameter: port
     * HDFS port to use Default value: 8020 Path parameter: path (required) The
    ...
    /**
     * Hipchat (camel-hipchat) Send and receive messages to/from Hipchat
     * service. Category: api,cloud Since: 2.15 Maven coordinates:
     * org.apache.camel:camel-hipchat Syntax:
     * <code>hipchat:protocol:host:port</code> Path parameter: protocol
     * (required) The protocol for the hipchat server, such as http. Path
     * parameter: host (required) The host for the hipchat server, such as
     * api.hipchat.com Path parameter: port The port for the hipchat server. Is
     * by default 80. Default value: 80
    ...
    /**
     * HTTP (camel-http) Send requests to external HTTP servers using Apache
     * HTTP Client 4.x. Category: http Since: 2.3 Maven coordinates:
     * org.apache.camel:camel-http Syntax: <code>http:httpUri</code> Path
     * parameter: httpUri (required) The url of the HTTP endpoint to call.
     * @param path httpUri
     */
    ...
    /**
     * HTTPS (Secure) (camel-http) Send requests to external HTTP servers using
     * Apache HTTP Client 4.x. Category: http Since: 2.3 Maven coordinates:
     * org.apache.camel:camel-http Syntax: <code>https:httpUri</code> Path
     * parameter: httpUri (required) The url of the HTTP endpoint to call.
     * @param path httpUri
     */
    static org.apache.camel.builder.endpoint.dsl.HttpEndpointBuilderFactory.HttpEndpointBuilder https(
            java.lang.String path) {
    ...
    /**
     * IEC 60870 Client (camel-iec60870) IEC 60870 supervisory control and data
     * acquisition (SCADA) client using NeoSCADA implementation. Category: iot
     * Since: 2.20 Maven coordinates: org.apache.camel:camel-iec60870 Syntax:
     * <code>iec60870-client:uriPath</code> Path parameter: uriPath (required)
    ...
    /**
     * IEC 60870 Server (camel-iec60870) IEC 60870 supervisory control and data
     * acquisition (SCADA) server using NeoSCADA implementation. Category: iot
     * Since: 2.20 Maven coordinates: org.apache.camel:camel-iec60870 Syntax:
     * <code>iec60870-server:uriPath</code> Path parameter: uriPath (required)
     * The object information address
     * @param path uriPath
     */
    ...
    /**
     * Ignite Cache (camel-ignite) Perform cache operations on an Ignite cache
     * or consume changes from a continuous query. Category: nosql,cache,compute
     * Since: 2.17 Maven coordinates: org.apache.camel:camel-ignite Syntax:
     * <code>ignite-cache:cacheName</code> Path parameter: cacheName (required)
     * The cache name.
     * @param path cacheName
     */
    ...
    /**
     * Ignite Compute (camel-ignite) Run compute operations on an Ignite
     * cluster. Category: nosql,cache,compute Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-ignite Syntax:
     * <code>ignite-compute:endpointId</code> Path parameter: endpointId
    ...
    /**
     * Ignite Events (camel-ignite) Receive events from an Ignite cluster by
     * creating a local event listener. Category:
     * nosql,cache,compute,messaging,data Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-ignite Syntax:
     * <code>ignite-events:endpointId</code> Path parameter: endpointId The
     * endpoint ID (not used).
     * @param path endpointId
     */
    ...
    /**
     * Ignite ID Generator (camel-ignite) Interact with Ignite Atomic Sequences
     * and ID Generators . Category: nosql,cache,compute Since: 2.17 Maven
     * coordinates: org.apache.camel:camel-ignite Syntax:
     * <code>ignite-idgen:name</code> Path parameter: name (required) The
     * sequence name.
     * @param path name
     */
    ...
    /**
     * Ignite Messaging (camel-ignite) Send and receive messages from an Ignite
     * topic. Category: nosql,cache,messaging Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-ignite Syntax: <code>ignite-messaging:topic</code>
     * Path parameter: topic (required) The topic name.
     * @param path topic
     */
    ...
    /**
     * Ignite Queues (camel-ignite) Interact with Ignite Queue data structures.
     * Category: nosql,cache Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-ignite Syntax: <code>ignite-queue:name</code> Path
     * parameter: name (required) The queue name.
     * @param path name
     */
    ...
    /**
     * Ignite Sets (camel-ignite) Interact with Ignite Set data structures.
     * Category: nosql,cache Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-ignite Syntax: <code>ignite-set:name</code> Path
     * parameter: name (required) The set name.
     * @param path name
     */
    ...
    /**
     * IMAP (camel-mail) Send and receive emails using imap, pop3 and smtp
     * protocols. Category: mail Since: 1.0 Maven coordinates:
     * org.apache.camel:camel-mail Syntax: <code>imap:host:port</code> Path
     * parameter: host (required) The mail server host name Path parameter: port
    ...
    /**
     * IMAPS (Secure) (camel-mail) Send and receive emails using imap, pop3 and
     * smtp protocols. Category: mail Since: 1.0 Maven coordinates:
     * org.apache.camel:camel-mail Syntax: <code>imaps:host:port</code> Path
     * parameter: host (required) The mail server host name Path parameter: port
     * The port number of the mail server
     * @param path host:port
     */
    static org.apache.camel.builder.endpoint.dsl.MailEndpointBuilderFactory.MailEndpointBuilder imaps(
            java.lang.String path) {
    ...
    /**
     * Infinispan (camel-infinispan) Read and write from/to Infinispan
     * distributed key/value store and data grid. Category:
     * cache,datagrid,clustering Since: 2.13 Maven coordinates:
     * org.apache.camel:camel-infinispan Syntax:
     * <code>infinispan:cacheName</code> Path parameter: cacheName (required)
    ...
    /**
     * InfluxDB (camel-influxdb) Interact with InfluxDB, a time series database.
     * Category: database Since: 2.18 Maven coordinates:
     * org.apache.camel:camel-influxdb Syntax:
     * <code>influxdb:connectionBean</code> Path parameter: connectionBean
    ...
    /**
     * IOTA (camel-iota) Manage financial transactions using IOTA distributed
     * ledger. Category: ledger Since: 2.23 Maven coordinates:
     * org.apache.camel:camel-iota Syntax: <code>iota:name</code> Path
     * parameter: name (required) Component name
     * @param path name
     */
    ...
    /**
     * IPFS (camel-ipfs) Access the Interplanetary File System (IPFS). Category:
     * file,ipfs Since: 2.23 Maven coordinates: org.apache.camel:camel-ipfs
     * Syntax: <code>ipfs:ipfsCmd</code> Path parameter: ipfsCmd (required) The
     * ipfs command The value can be one of: add, cat, get, version
     * @param path ipfsCmd
     */
    ...
    /**
     * IRC (camel-irc) Send and receive messages to/from and IRC chat. Category:
     * chat Since: 1.1 Maven coordinates: org.apache.camel:camel-irc Syntax:
     * <code>irc:hostname:port</code> Path parameter: hostname (required)
     * Hostname for the IRC chat server Path parameter: port Port number for the
     * IRC chat server. If no port is configured then a default port of either
    ...
    /**
     * IronMQ (camel-ironmq) Send and receive messages to/from IronMQ an elastic
     * and durable hosted message queue as a service. Category: cloud,messaging
     * Since: 2.17 Maven coordinates: org.apache.camel:camel-ironmq Syntax:
     * <code>ironmq:queueName</code> Path parameter: queueName (required) The
     * name of the IronMQ queue
     * @param path queueName
     */
    ...
    /**
     * JBPM (camel-jbpm) Interact with jBPM workflow engine over REST. Category:
     * process Since: 2.6 Maven coordinates: org.apache.camel:camel-jbpm Syntax:
     * <code>jbpm:connectionURL</code> Path parameter: connectionURL (required)
     * The URL to the jBPM server. Path parameter: eventListenerType Sets the
     ...
     * Category: cache,datagrid,clustering Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-jcache Syntax: <code>jcache:cacheName</code> Path
     * parameter: cacheName (required) The name of the cache
     * @param path cacheName
     */
    ...
    /**
     * JClouds (camel-jclouds) Interact with jclouds compute & blobstore
     * service. Category: api,cloud Since: 2.9 Maven coordinates:
     * org.apache.camel:camel-jclouds Syntax:
     * <code>jclouds:command:providerId</code> Path parameter: command
     * (required) What command to execute such as blobstore or compute. The
     * value can be one of: blobstore, compute Path parameter: providerId
     * (required) The name of the cloud provider that provides the target
     * service (e.g. aws-s3 or aws_ec2).
    ...
    /**
     * JCR (camel-jcr) Read and write nodes to/from a JCR compliant content
     * repository. Category: cms,database Since: 1.3 Maven coordinates:
     * org.apache.camel:camel-jcr Syntax: <code>jcr:host/base</code> Path
     * parameter: host (required) Name of the javax.jcr.Repository to lookup
     * from the Camel registry to be used. Path parameter: base Get the base
     * node when accessing the repository
    ...
    /**
     * JDBC (camel-jdbc) Access databases through SQL and JDBC. Category:
     * database,sql Since: 1.2 Maven coordinates: org.apache.camel:camel-jdbc
     * Syntax: <code>jdbc:dataSourceName</code> Path parameter: dataSourceName
     * (required) Name of DataSource to lookup in the Registry. If the name is
     * dataSource or default, then Camel will attempt to lookup a default
     * DataSource from the registry, meaning if there is a only one instance of
     * DataSource found, then this DataSource will be used.
    ...
    /**
     * Jetty (camel-jetty) Expose HTTP endpoints using Jetty 9. Category: http
     * Since: 1.2 Maven coordinates: org.apache.camel:camel-jetty Syntax:
     * <code>jetty:httpUri</code> Path parameter: httpUri (required) The url of
    ...
    /**
     * JGroups (camel-jgroups) Exchange messages with JGroups clusters.
     * Category: clustering,messaging Since: 2.13 Maven coordinates:
     * org.apache.camel:camel-jgroups Syntax: <code>jgroups:clusterName</code>
     * Path parameter: clusterName (required) The name of the JGroups cluster
    ...
    /**
     * JGroups raft (camel-jgroups-raft) Exchange messages with JGroups-raft
     * clusters. Category: clustering,messaging Since: 2.24 Maven coordinates:
     * org.apache.camel:camel-jgroups-raft Syntax:
     * <code>jgroups-raft:clusterName</code> Path parameter: clusterName
     * (required) The name of the JGroupsraft cluster the component should
     * connect to.
     * @param path clusterName
     */
    ...
    /**
     * Jing (camel-jing) Validate XML against a RelaxNG schema (XML Syntax or
     * Compact Syntax) using Jing library. Category: validation Since: 1.1 Maven
     * coordinates: org.apache.camel:camel-jing Syntax:
     * <code>jing:resourceUri</code> Path parameter: resourceUri (required) URL
     * to a local resource on the classpath or a full URL to a remote resource
     * or resource on the file system which contains the schema to validate
     * against.
     * @param path resourceUri
     */
    ...
    /**
     * Jira (camel-jira) Interact with JIRA issue tracker. Category:
     * api,reporting Since: 3.0 Maven coordinates: org.apache.camel:camel-jira
     * Syntax: <code>jira:type</code> Path parameter: type (required) Operation
     * to perform. Consumers: NewIssues, NewComments. Producers: AddIssue,
     * AttachFile, DeleteIssue, TransitionIssue, UpdateIssue, Watchers. See this
     * class javadoc description for more information. The value can be one of:
     * ADDCOMMENT, ADDISSUE, ATTACH, DELETEISSUE, NEWISSUES, NEWCOMMENTS,
    ...
    /**
     * JMS (camel-jms) Sent and receive messages to/from a JMS Queue or Topic.
     * Category: messaging Since: 1.0 Maven coordinates:
     * org.apache.camel:camel-jms Syntax:
     * <code>jms:destinationType:destinationName</code> Path parameter:
     * destinationType The kind of destination to use Default value: queue The
     * value can be one of: queue, topic, temp-queue, temp-topic Path parameter:
     * destinationName (required) Name of the queue or topic to use as
     * destination
    ...
    /**
     * JMX (camel-jmx) Receive JMX notifications. Category: monitoring Since:
     * 2.6 Maven coordinates: org.apache.camel:camel-jmx Syntax:
     * <code>jmx:serverURL</code> Path parameter: serverURL Server url comes
     * from the remaining endpoint. Use platform to connect to local JVM.
    ...
    /**
     * JOLT (camel-jolt) JSON to JSON transformation using JOLT. Category:
     * transformation Since: 2.16 Maven coordinates: org.apache.camel:camel-jolt
     * Syntax: <code>jolt:resourceUri</code> Path parameter: resourceUri
     * (required) Path to the resource. You can prefix with: classpath, file,
     * http, ref, or bean. classpath, file and http loads the resource using
     * these protocols (classpath is default). ref will lookup the resource in
     * the registry. bean will call a method on a bean to be used as the
    ...
    /**
     * JOOQ (camel-jooq) Store and retrieve Java objects from an SQL database
     * using JOOQ. Category: database Since: 3.0 Maven coordinates:
     * org.apache.camel:camel-jooq Syntax: <code>jooq:entityType</code> Path
     * parameter: entityType JOOQ entity class
    ...
    /**
     * JPA (camel-jpa) Store and retrieve Java objects from databases using Java
     * Persistence API (JPA). Category: database,sql Since: 1.0 Maven
     * coordinates: org.apache.camel:camel-jpa Syntax:
     * <code>jpa:entityType</code> Path parameter: entityType (required) Entity
     * class name
     * @param path entityType
     */
    ...
    /**
     * JSLT (camel-jslt) Query or transform JSON payloads using an JSLT.
     * Category: transformation Since: 3.1 Maven coordinates:
     * org.apache.camel:camel-jslt Syntax: <code>jslt:resourceUri</code> Path
     * parameter: resourceUri (required) Path to the resource. You can prefix
     * with: classpath, file, http, ref, or bean. classpath, file and http loads
     * the resource using these protocols (classpath is default). ref will
     * lookup the resource in the registry. bean will call a method on a bean to
    ...
    /**
     * JSON Schema Validator (camel-json-validator) Validate JSON payloads using
     * NetworkNT JSON Schema. Category: validation Since: 2.20 Maven
     * coordinates: org.apache.camel:camel-json-validator Syntax:
     * <code>json-validator:resourceUri</code> Path parameter: resourceUri
     * (required) Path to the resource. You can prefix with: classpath, file,
     * http, ref, or bean. classpath, file and http loads the resource using
     * these protocols (classpath is default). ref will lookup the resource in
     * the registry. bean will call a method on a bean to be used as the
    ...
    /**
     * JT400 (camel-jt400) Exchanges messages with an AS/400 system using data
     * queues or program call. Category: messaging Since: 1.5 Maven coordinates:
     * org.apache.camel:camel-jt400 Syntax:
     * <code>jt400:userID:password/systemName/objectPath.type</code> Path
     * parameter: userID (required) Returns the ID of the AS/400 user. Path
     * parameter: password (required) Returns the password of the AS/400 user.
     * Path parameter: systemName (required) Returns the name of the AS/400
     * system. Path parameter: objectPath (required) Returns the fully qualified
     * integrated file system path name of the target object of this endpoint.
     * Path parameter: type (required) Whether to work with data queues or
     * remote program call The value can be one of: DTAQ, PGM, SRVPGM
    ...
    /**
     * Kafka (camel-kafka) Sent and receive messages to/from an Apache Kafka
     * broker. Category: messaging Since: 2.13 Maven coordinates:
     * org.apache.camel:camel-kafka Syntax: <code>kafka:topic</code> Path
     * parameter: topic (required) Name of the topic to use. On the consumer you
     * can use comma to separate multiple topics. A producer can only send a
    ...
    /**
     * Kubernetes ConfigMap (camel-kubernetes) Perform operations on Kubernetes
     * ConfigMaps and get notified on ConfigMaps changes. Category:
     * container,cloud,paas Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-config-maps:masterUrl</code> Path parameter: masterUrl
    ...
    /**
     * Kubernetes Deployments (camel-kubernetes) Perform operations on
     * Kubernetes Deployments and get notified on Deployment changes. Category:
     * container,cloud,paas Since: 2.20 Maven coordinates:
     * org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-deployments:masterUrl</code> Path parameter: masterUrl
     * (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Kubernetes HPA (camel-kubernetes) Perform operations on Kubernetes
     * Horizontal Pod Autoscalers (HPA) and get notified on HPA changes.
     * Category: container,cloud,paas Since: 2.23 Maven coordinates:
     * org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-hpa:masterUrl</code> Path parameter: masterUrl
     * (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Kubernetes Job (camel-kubernetes) Perform operations on Kubernetes Jobs.
     * Category: container,cloud,paas Since: 2.23 Maven coordinates:
     * org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-job:masterUrl</code> Path parameter: masterUrl
     * (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Kubernetes Namespaces (camel-kubernetes) Perform operations on Kubernetes
     * Namespaces and get notified on Namespace changes. Category:
     * container,cloud,paas Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-namespaces:masterUrl</code> Path parameter: masterUrl
     * (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Kubernetes Nodes (camel-kubernetes) Perform operations on Kubernetes
     * Nodes and get notified on Node changes. Category: container,cloud,paas
     * Since: 2.17 Maven coordinates: org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-nodes:masterUrl</code> Path parameter: masterUrl
     * (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Kubernetes Persistent Volume (camel-kubernetes) Perform operations on
     * Kubernetes Persistent Volumes and get notified on Persistent Volume
     * changes. Category: container,cloud,paas Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-persistent-volumes:masterUrl</code> Path parameter:
     * masterUrl (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Kubernetes Persistent Volume Claim (camel-kubernetes) Perform operations
     * on Kubernetes Persistent Volumes Claims and get notified on Persistent
     * Volumes Claim changes. Category: container,cloud,paas Since: 2.17 Maven
     * coordinates: org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-persistent-volumes-claims:masterUrl</code> Path
     * parameter: masterUrl (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Kubernetes Pods (camel-kubernetes) Perform operations on Kubernetes Pods
     * and get notified on Pod changes. Category: container,cloud,paas Since:
     * 2.17 Maven coordinates: org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-pods:masterUrl</code> Path parameter: masterUrl
     * (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Kubernetes Replication Controller (camel-kubernetes) Perform operations
     * on Kubernetes Replication Controllers and get notified on Replication
     * Controllers changes. Category: container,cloud,paas Since: 2.17 Maven
     * coordinates: org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-replication-controllers:masterUrl</code> Path parameter:
     * masterUrl (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Kubernetes Resources Quota (camel-kubernetes) Perform operations on
     * Kubernetes Resources Quotas. Category: container,cloud,paas Since: 2.17
     * Maven coordinates: org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-resources-quota:masterUrl</code> Path parameter:
     * masterUrl (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Kubernetes Secrets (camel-kubernetes) Perform operations on Kubernetes
     * Secrets. Category: container,cloud,paas Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-secrets:masterUrl</code> Path parameter: masterUrl
     * (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Kubernetes Service Account (camel-kubernetes) Perform operations on
     * Kubernetes Service Accounts. Category: container,cloud,paas Since: 2.17
     * Maven coordinates: org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-service-accounts:masterUrl</code> Path parameter:
     * masterUrl (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Kubernetes Services (camel-kubernetes) Perform operations on Kubernetes
     * Services and get notified on Service changes. Category:
     * container,cloud,paas Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-kubernetes Syntax:
     * <code>kubernetes-services:masterUrl</code> Path parameter: masterUrl
     * (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Kudu (camel-kudu) Interact with Apache Kudu, a free and open source
     * column-oriented data store of the Apache Hadoop ecosystem. Category:
     * cloud,database,iot Since: 3.0 Maven coordinates:
     * org.apache.camel:camel-kudu Syntax: <code>kudu:host:port/tableName</code>
     * Path parameter: host Host of the server to connect to Path parameter:
     * port Port of the server to connect to Path parameter: tableName Table to
     * connect to
    ...
    /**
     * Language (camel-language) Execute scripts in any of the languages
     * supported by Camel. Category: core,script Since: 2.5 Maven coordinates:
     * org.apache.camel:camel-language Syntax:
     * <code>language:languageName:resourceUri</code> Path parameter:
     * languageName (required) Sets the name of the language to use The value
     * can be one of: bean, constant, exchangeProperty, file, groovy, header,
     * javascript, jsonpath, mvel, ognl, , ref, simple, spel, sql, terser,
     * tokenize, xpath, xquery, xtokenize Path parameter: resourceUri Path to
     * the resource, or a reference to lookup a bean in the Registry to use as
     * the resource
    ...
    /**
     * LDAP (camel-ldap) Perform searches on LDAP servers. Category: ldap Since:
     * 1.5 Maven coordinates: org.apache.camel:camel-ldap Syntax:
     * <code>ldap:dirContextName</code> Path parameter: dirContextName
     * (required) Name of either a javax.naming.directory.DirContext, or
    ...
    /**
     * LDIF (camel-ldif) Perform updates on an LDAP server from an LDIF body
     * content. Category: ldap Since: 2.20 Maven coordinates:
     * org.apache.camel:camel-ldif Syntax: <code>ldif:ldapConnectionName</code>
     * Path parameter: ldapConnectionName (required) The name of the
     * LdapConnection bean to pull from the registry. Note that this must be of
     * scope prototype to avoid it being shared among threads or using a
     ...
     * Category: core,monitoring Since: 1.1 Maven coordinates:
     * org.apache.camel:camel-log Syntax: <code>log:loggerName</code> Path
     * parameter: loggerName (required) Name of the logging category to use
    ...
    /**
     * Printer (camel-printer) Send print jobs to printers. Category: printing
     * Since: 2.1 Maven coordinates: org.apache.camel:camel-printer Syntax:
     * <code>lpr:hostname:port/printername</code> Path parameter: hostname
     * (required) Hostname of the printer Path parameter: port Port number of
     * the printer Path parameter: printername Name of the printer
    ...
    /**
     * Lucene (camel-lucene) Perform inserts or queries against Apache Lucene
     * databases. Category: database,search Since: 2.2 Maven coordinates:
     * org.apache.camel:camel-lucene Syntax: <code>lucene:host:operation</code>
     * Path parameter: host (required) The URL to the lucene server Path
     * parameter: operation (required) Operation to do such as insert or query.
    ...
    /**
     * Lumberjack (camel-lumberjack) Receive logs messages using the Lumberjack
     * protocol. Category: log Since: 2.18 Maven coordinates:
     * org.apache.camel:camel-lumberjack Syntax:
     * <code>lumberjack:host:port</code> Path parameter: host (required) Network
     * interface on which to listen for Lumberjack Path parameter: port Network
     * port on which to listen for Lumberjack Default value: 5044
     * @param path host:port
     */
    ...
    /**
     * Master (camel-master) Have only a single consumer in a cluster consuming
     * from a given endpoint; with automatic failover if the JVM dies. Category:
     * clustering Since: 2.20 Maven coordinates: org.apache.camel:camel-master
     * Syntax: <code>master:namespace:delegateUri</code> Path parameter:
     * namespace (required) The name of the cluster namespace to use Path
     * parameter: delegateUri (required) The endpoint uri to use in master/slave
     * mode
    ...
    /**
     * Metrics (camel-metrics) Collect various metrics directly from Camel
     * routes using the DropWizard metrics library. Category: monitoring Since:
     * 2.14 Maven coordinates: org.apache.camel:camel-metrics Syntax:
     * <code>metrics:metricsType:metricsName</code> Path parameter: metricsType
     * (required) Type of metrics The value can be one of: gauge, counter,
     * histogram, meter, timer Path parameter: metricsName (required) Name of
     * metrics
     ...
     * routes using the Micrometer library. Category: monitoring Since: 2.22
     * Maven coordinates: org.apache.camel:camel-micrometer Syntax:
     * <code>micrometer:metricsType:metricsName</code> Path parameter:
     * metricsType (required) Type of metrics The value can be one of: COUNTER,
     * GAUGE, LONG_TASK_TIMER, TIMER, DISTRIBUTION_SUMMARY, OTHER Path
     * parameter: metricsName (required) Name of metrics Path parameter: tags
     * Tags of metrics
     * @param path metricsType:metricsName
     */
    ...
    /**
     * MicroProfile Metrics (camel-microprofile-metrics) Expose metrics from
     * Camel routes. Category: monitoring Since: 3.0 Maven coordinates:
     * org.apache.camel:camel-microprofile-metrics Syntax:
     * <code>microprofile-metrics:metricType:metricName</code> Path parameter:
     ...
     * Path parameter: metricName (required) Metric name
    ...
    /**
     * OPC UA Client (camel-milo) Connect to OPC UA servers using the binary
     * protocol for acquiring telemetry data. Category: iot Since: 2.19 Maven
     * coordinates: org.apache.camel:camel-milo Syntax:
     * <code>milo-client:endpointUri</code> Path parameter: endpointUri
    ...
    /**
     * OPC UA Server (camel-milo) Make telemetry data available as an OPC UA
     * server. Category: iot Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-milo Syntax: <code>milo-server:itemId</code> Path
     * parameter: itemId (required) ID of the item
     * @param path itemId
     */
     ...
     * Mina 2.x. Category: networking,tcp,udp Since: 2.10 Maven coordinates:
     * org.apache.camel:camel-mina Syntax: <code>mina:protocol:host:port</code>
     * Path parameter: protocol (required) Protocol to use Path parameter: host
     * (required) Hostname to use. Use localhost or 0.0.0.0 for local server as
     * consumer. For producer use the hostname or ip address of the remote
     * server. Path parameter: port (required) Port number
     * @param path protocol:host:port
     */
    ...
    /**
     * MLLP (camel-mllp) Communicate with external systems using the MLLP
     * protocol. Category: mllp Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-mllp Syntax: <code>mllp:hostname:port</code> Path
     * parameter: hostname (required) Hostname or IP for connection for the TCP
     * connection. The default value is null, which means any local IP address
     * Path parameter: port (required) Port number for the TCP connection
     * @param path hostname:port
     */
    ...
    /**
     * Mock (camel-mock) Test routes and mediation rules using mocks. Category:
     * core,testing Since: 1.0 Maven coordinates: org.apache.camel:camel-mock
     * Syntax: <code>mock:name</code> Path parameter: name (required) Name of
     * mock endpoint
     * @param path name
     */
    ...
    /**
     * MongoDB (camel-mongodb) Perform operations on MongoDB documents and
     * collections. Category: database,nosql Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-mongodb Syntax:
     * <code>mongodb:connectionBean</code> Path parameter: connectionBean
     * (required) Sets the connection bean reference used to lookup a client for
    ...
    /**
     * MongoDB GridFS (camel-mongodb-gridfs) Interact with MongoDB GridFS.
     * Category: database,nosql Since: 2.18 Maven coordinates:
     * org.apache.camel:camel-mongodb-gridfs Syntax:
     * <code>mongodb-gridfs:connectionBean</code> Path parameter: connectionBean
    ...
    /**
     * MSV (camel-msv) Validate XML payloads using Multi-Schema Validator (MSV).
     * Category: validation Since: 1.1 Maven coordinates:
     * org.apache.camel:camel-msv Syntax: <code>msv:resourceUri</code> Path
     * parameter: resourceUri (required) URL to a local resource on the
     * classpath, or a reference to lookup a bean in the Registry, or a full URL
     * to a remote resource or resource on the file system which contains the
     ...
     * Category: transformation Since: 2.12 Maven coordinates:
     * org.apache.camel:camel-mustache Syntax: <code>mustache:resourceUri</code>
     * Path parameter: resourceUri (required) Path to the resource. You can
     * prefix with: classpath, file, http, ref, or bean. classpath, file and
     * http loads the resource using these protocols (classpath is default). ref
     * will lookup the resource in the registry. bean will call a method on a
     * bean to be used as the resource. For bean you can specify the method name
     * after dot, eg bean:myBean.myMethod.
     * @param path resourceUri
     */
    ...
    /**
     * MVEL (camel-mvel) Transform messages using an MVEL template. Category:
     * transformation,script Since: 2.12 Maven coordinates:
     * org.apache.camel:camel-mvel Syntax: <code>mvel:resourceUri</code> Path
     * parameter: resourceUri (required) Path to the resource. You can prefix
     * with: classpath, file, http, ref, or bean. classpath, file and http loads
     * the resource using these protocols (classpath is default). ref will
     * lookup the resource in the registry. bean will call a method on a bean to
    ...
    /**
     * MyBatis (camel-mybatis) Performs a query, poll, insert, update or delete
     * in a relational database using MyBatis. Category: database,sql Since: 2.7
     * Maven coordinates: org.apache.camel:camel-mybatis Syntax:
     * <code>mybatis:statement</code> Path parameter: statement (required) The
     * statement name in the MyBatis XML mapping file which maps to the query,
    ...
    /**
     * MyBatis Bean (camel-mybatis) Perform queries, inserts, updates or deletes
     * in a relational database using MyBatis. Category: database,sql Since:
     * 2.22 Maven coordinates: org.apache.camel:camel-mybatis Syntax:
     * <code>mybatis-bean:beanName:methodName</code> Path parameter: beanName
     * (required) Name of the bean with the MyBatis annotations. This can either
     * by a type alias or a FQN class name. Path parameter: methodName
     * (required) Name of the method on the bean that has the SQL query to be
     * executed.
    ...
    /**
     * Nagios (camel-nagios) Send passive checks to Nagios using JSendNSCA.
     * Category: monitoring Since: 2.3 Maven coordinates:
     * org.apache.camel:camel-nagios Syntax: <code>nagios:host:port</code> Path
     * parameter: host (required) This is the address of the Nagios host where
     * checks should be send. Path parameter: port (required) The port number of
     * the host.
     * @param path host:port
     */
    ...
    /**
     * Nats (camel-nats) Send and receive messages from NATS messaging system.
     * Category: messaging Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-nats Syntax: <code>nats:topic</code> Path
     * parameter: topic (required) The name of topic we want to use
     * @param path topic
     */
    ...
    /**
     * Netty (camel-netty) Socket level networking using TCP or UDP with the
     * Netty 4.x. Category: networking,tcp,udp Since: 2.14 Maven coordinates:
     * org.apache.camel:camel-netty Syntax:
     * <code>netty:protocol:host:port</code> Path parameter: protocol (required)
     * The protocol to use which can be tcp or udp. The value can be one of:
     * tcp, udp Path parameter: host (required) The hostname. For the consumer
     * the hostname is localhost or 0.0.0.0. For the producer the hostname is
     * the remote host to connect to Path parameter: port (required) The host
     * port number
     * @param path protocol:host:port
     */
    ...
    /**
     * Netty HTTP (camel-netty-http) Netty HTTP server and client using the
     * Netty 4.x. Category: http Since: 2.14 Maven coordinates:
     * org.apache.camel:camel-netty-http Syntax:
     * <code>netty-http:protocol:host:port/path</code> Path parameter: protocol
     * (required) The protocol to use which is either http, https or proxy - a
     * consumer only option. The value can be one of: http, https Path
     * parameter: host (required) The local hostname such as localhost, or
     * 0.0.0.0 when being a consumer. The remote HTTP server hostname when using
     * producer. Path parameter: port The host port number Path parameter: path
     * Resource path
    ...
    /**
     * Nitrite (camel-nitrite) Access Nitrite databases. Category:
     * database,nosql Since: 3.0 Maven coordinates:
     * org.apache.camel:camel-nitrite Syntax: <code>nitrite:database</code> Path
     * parameter: database (required) Path to database file. Will be created if
     * not exists.
     * @param path database
     */
    ...
    /**
     * NSQ (camel-nsq) Send and receive messages from NSQ realtime distributed
     * messaging platform. Category: messaging Since: 2.23 Maven coordinates:
     * org.apache.camel:camel-nsq Syntax: <code>nsq:topic</code> Path parameter:
     * topic (required) The NSQ topic
     * @param path topic
     */
    ...
    /**
     * Olingo2 (camel-olingo2) Communicate with OData 2.0 services using Apache
     * Olingo. Category: cloud Since: 2.14 Maven coordinates:
     * org.apache.camel:camel-olingo2 Syntax:
     * <code>olingo2:apiName/methodName</code> Path parameter: apiName
     * (required) What kind of operation to perform The value can be one of:
     * DEFAULT Path parameter: methodName (required) What sub operation to use
    ...
    /**
     * Olingo4 (camel-olingo4) Communicate with OData 4.0 services using Apache
     * Olingo OData API. Category: cloud Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-olingo4 Syntax:
     * <code>olingo4:apiName/methodName</code> Path parameter: apiName
     * (required) What kind of operation to perform The value can be one of:
     * DEFAULT Path parameter: methodName (required) What sub operation to use
     * for the selected operation
     * @param path apiName/methodName
    ...
    /**
     * Openshift Build Config (camel-kubernetes) Perform operations on OpenShift
     * Build Configs. Category: container,cloud,paas Since: 2.17 Maven
     * coordinates: org.apache.camel:camel-kubernetes Syntax:
     * <code>openshift-build-configs:masterUrl</code> Path parameter: masterUrl
     * (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * Openshift Builds (camel-kubernetes) Perform operations on OpenShift
     * Builds. Category: container,cloud,paas Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-kubernetes Syntax:
     * <code>openshift-builds:masterUrl</code> Path parameter: masterUrl
     * (required) Kubernetes Master url
     * @param path masterUrl
     */
    ...
    /**
     * OpenStack Cinder (camel-openstack) Access data in OpenStack Cinder block
     * storage. Category: cloud,paas Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-openstack Syntax:
     * <code>openstack-cinder:host</code> Path parameter: host (required)
     * OpenStack host url
     * @param path host
     */
    ...
    /**
     * OpenStack Glance (camel-openstack) Manage VM images and metadata
     * definitions in OpenStack Glance. Category: cloud,paas Since: 2.19 Maven
     * coordinates: org.apache.camel:camel-openstack Syntax:
     * <code>openstack-glance:host</code> Path parameter: host (required)
     * OpenStack host url
     * @param path host
     */
    ...
    /**
     * OpenStack Keystone (camel-openstack) Access OpenStack Keystone for API
     * client authentication, service discovery and distributed multi-tenant
     * authorization. Category: cloud,paas Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-openstack Syntax:
     * <code>openstack-keystone:host</code> Path parameter: host (required)
     * OpenStack host url
     * @param path host
     */
    ...
    /**
     * OpenStack Neutron (camel-openstack) Access OpenStack Neutron for network
     * services. Category: cloud,paas Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-openstack Syntax:
     * <code>openstack-neutron:host</code> Path parameter: host (required)
     * OpenStack host url
     * @param path host
     */
    ...
    /**
     * OpenStack Nova (camel-openstack) Access OpenStack to manage compute
     * resources. Category: cloud,paas Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-openstack Syntax: <code>openstack-nova:host</code>
    ...
    /**
     * OpenStack Swift (camel-openstack) Access OpenStack Swift object/blob
     * store. Category: cloud,paas Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-openstack Syntax:
     * <code>openstack-swift:host</code> Path parameter: host (required)
     * OpenStack host url
     * @param path host
     */
    ...
    /**
     * OptaPlanner (camel-optaplanner) Solve planning problems with OptaPlanner.
     * Category: engine,planning Since: 2.13 Maven coordinates:
     * org.apache.camel:camel-optaplanner Syntax:
     * <code>optaplanner:configFile</code> Path parameter: configFile (required)
    ...
    /**
     * Paho (camel-paho) Communicate with MQTT message brokers using Eclipse
     * Paho MQTT Client. Category: messaging,iot Since: 2.16 Maven coordinates:
     * org.apache.camel:camel-paho Syntax: <code>paho:topic</code> Path
     * parameter: topic (required) Name of the topic
     * @param path topic
     */
     ...
     * Category: document,transformation,printing Since: 2.16 Maven coordinates:
     * org.apache.camel:camel-pdf Syntax: <code>pdf:operation</code> Path
     * parameter: operation (required) Operation type The value can be one of:
    ...
    /**
     * PostgresSQL Event (camel-pgevent) Send and receive PostgreSQL events via
     * LISTEN and NOTIFY commands. Category: database,sql Since: 2.15 Maven
     * coordinates: org.apache.camel:camel-pgevent Syntax:
     * <code>pgevent:host:port/database/channel</code> Path parameter: host To
     * connect using hostname and port to the database. Default value: localhost
     * Path parameter: port To connect using hostname and port to the database.
     * Default value: 5432 Path parameter: database (required) The database name
     * Path parameter: channel (required) The channel name
    ...
    /**
     * PostgresSQL Replication Slot (camel-pg-replication-slot) Poll for
     * PostgreSQL Write-Ahead Log (WAL) records using Streaming Replication
     * Slots. Category: database,sql Since: 3.0 Maven coordinates:
     * org.apache.camel:camel-pg-replication-slot Syntax:
     * <code>pg-replication-slot:host:port/database/slot:outputPlugin</code>
     * Path parameter: slot (required) Replication Slot name Path parameter:
     * host Postgres host Default value: localhost Path parameter: port Postgres
     * port Default value: 5432 Path parameter: database (required) Postgres
     * database name Path parameter: outputPlugin (required) Output plugin name
    ...
    /**
     * Platform HTTP (camel-platform-http) Expose HTTP endpoints using the HTTP
     * server available in the current platform. Category: http Since: 3.0 Maven
     * coordinates: org.apache.camel:camel-platform-http Syntax:
     * <code>platform-http:path</code> Path parameter: path (required) The path
     * under which this endpoint serves the HTTP requests
     * @param path path
     */
    ...
    /**
     * POP3 (camel-mail) Send and receive emails using imap, pop3 and smtp
     * protocols. Category: mail Since: 1.0 Maven coordinates:
     * org.apache.camel:camel-mail Syntax: <code>pop3:host:port</code> Path
     * parameter: host (required) The mail server host name Path parameter: port
     * The port number of the mail server
     * @param path host:port
     */
    static org.apache.camel.builder.endpoint.dsl.MailEndpointBuilderFactory.MailEndpointBuilder pop3(
            java.lang.String path) {
    ...
    /**
     * POP3S (camel-mail) Send and receive emails using imap, pop3 and smtp
     * protocols. Category: mail Since: 1.0 Maven coordinates:
     * org.apache.camel:camel-mail Syntax: <code>pop3s:host:port</code> Path
     * parameter: host (required) The mail server host name Path parameter: port
     * The port number of the mail server
     * @param path host:port
     */
    static org.apache.camel.builder.endpoint.dsl.MailEndpointBuilderFactory.MailEndpointBuilder pop3s(
            java.lang.String path) {
    ...
    /**
     * PubNub (camel-pubnub) Send and receive messages to/from PubNub data
     * stream network for connected devices. Category: cloud,iot,messaging
     * Since: 2.19 Maven coordinates: org.apache.camel:camel-pubnub Syntax:
     * <code>pubnub:channel</code> Path parameter: channel (required) The
     * channel used for subscribing/publishing events
     * @param path channel
     */
    ...
    /**
     * Pulsar (camel-pulsar) Send and receive messages from/to Apache Pulsar
     * messaging system. Category: messaging Since: 2.24 Maven coordinates:
     * org.apache.camel:camel-pulsar Syntax:
     * <code>pulsar:persistence://tenant/namespace/topic</code> Path parameter:
     * persistence (required) Whether the topic is persistent or non-persistent
     * The value can be one of: persistent, non-persistent Path parameter:
     * tenant (required) The tenant Path parameter: namespace (required) The
     * namespace Path parameter: topic (required) The topic
    ...
    /**
     * Quartz (camel-quartz) Schedule sending of messages using the Quartz 2.x
     * scheduler. Category: scheduling Since: 2.12 Maven coordinates:
     * org.apache.camel:camel-quartz Syntax:
     * <code>quartz:groupName/triggerName</code> Path parameter: groupName The
     * quartz group name to use. The combination of group name and timer name
     * should be unique. Default value: Camel Path parameter: triggerName
     * (required) The quartz timer name to use. The combination of group name
     * and timer name should be unique.
    ...
    /**
     * QuickFix (camel-quickfix) Open a Financial Interchange (FIX) session
     * using an embedded QuickFix/J engine. Category: messaging Since: 2.1 Maven
     * coordinates: org.apache.camel:camel-quickfix Syntax:
     * <code>quickfix:configurationName</code> Path parameter: configurationName
     * (required) The configFile is the name of the QuickFIX/J configuration to
     * use for the FIX engine (located as a resource found in your classpath).
    ...
    /**
     * RabbitMQ (camel-rabbitmq) Send and receive messages from RabbitMQ
     * instances. Category: messaging Since: 2.12 Maven coordinates:
     * org.apache.camel:camel-rabbitmq Syntax:
     * <code>rabbitmq:exchangeName</code> Path parameter: exchangeName
     * (required) The exchange name determines which exchange produced messages
     * will sent to. In the case of consumers, the exchange name determines
    ...
    /**
     * Reactive Streams (camel-reactive-streams) Exchange messages with reactive
     * stream processing libraries compatible with the reactive streams
     * standard. Category: reactive,streams Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-reactive-streams Syntax:
     * <code>reactive-streams:stream</code> Path parameter: stream Name of the
     * stream channel used by the endpoint to exchange messages.
     * @param path stream
     */
    ...
    /**
     * Ref (camel-ref) Route messages to an endpoint looked up dynamically by
     * name in the Camel Registry. Category: core,endpoint Since: 1.2 Maven
     * coordinates: org.apache.camel:camel-ref Syntax: <code>ref:name</code>
     * Path parameter: name (required) Name of endpoint to lookup in the
     * registry.
     * @param path name
     */
    ...
    /**
     * REST API (camel-rest) Expose OpenAPI Specification of the REST services
     * defined using Camel REST DSL. Category: core,rest Since: 2.16 Maven
     * coordinates: org.apache.camel:camel-rest Syntax:
     * <code>rest-api:path/contextIdPattern</code> Path parameter: path
     * (required) The base path Path parameter: contextIdPattern Optional
    ...
    /**
     * REST (camel-rest) Expose REST services or call external REST services.
     * Category: core,rest Since: 2.14 Maven coordinates:
     * org.apache.camel:camel-rest Syntax:
     * <code>rest:method:path:uriTemplate</code> Path parameter: method
     * (required) HTTP method to use. The value can be one of: get, post, put,
     * delete, patch, head, trace, connect, options Path parameter: path
     * (required) The base path Path parameter: uriTemplate The uri template
    ...
    /**
     * REST OpenApi (camel-rest-openapi) Configure REST producers based on an
     * OpenAPI specification document delegating to a component implementing the
     * RestProducerFactory interface. Category: rest,openapi,http Since: 3.1
     * Maven coordinates: org.apache.camel:camel-rest-openapi Syntax:
     * <code>rest-openapi:specificationUri#operationId</code> Path parameter:
     * specificationUri Path to the OpenApi specification file. The scheme, host
     * base path are taken from this specification, but these can be overridden
     * with properties on the component or endpoint level. If not given the
     * component tries to load openapi.json resource from the classpath. Note
     * that the host defined on the component and endpoint of this Component
     * should contain the scheme, hostname and optionally the port in the URI
     * syntax (i.e. http://api.example.com:8080). Overrides component
     * configuration. The OpenApi specification can be loaded from different
     * sources by prefixing with file: classpath: http: https:. Support for
     * https is limited to using the JDK installed UrlHandler, and as such it
     * can be cumbersome to setup TLS/SSL certificates for https (such as
     * setting a number of javax.net.ssl JVM system properties). How to do that
     * consult the JDK documentation for UrlHandler. Default value notice: By
     * default loads openapi.json file Default value: openapi.json Path
     * parameter: operationId (required) ID of the operation from the OpenApi
     * specification.
    ...
    /**
     * REST Swagger (camel-rest-swagger) Configure REST producers based on a
     * Swagger (OpenAPI) specification document delegating to a component
     * implementing the RestProducerFactory interface. Category:
     * rest,swagger,http Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-rest-swagger Syntax:
     * <code>rest-swagger:specificationUri#operationId</code> Path parameter:
     * specificationUri Path to the Swagger specification file. The scheme, host
     * base path are taken from this specification, but these can be overridden
     * with properties on the component or endpoint level. If not given the
     * component tries to load swagger.json resource from the classpath. Note
     * that the host defined on the component and endpoint of this Component
     * should contain the scheme, hostname and optionally the port in the URI
     * syntax (i.e. http://api.example.com:8080). Overrides component
     * configuration. The Swagger specification can be loaded from different
     * sources by prefixing with file: classpath: http: https:. Support for
     * https is limited to using the JDK installed UrlHandler, and as such it
     * can be cumbersome to setup TLS/SSL certificates for https (such as
     * setting a number of javax.net.ssl JVM system properties). How to do that
     * consult the JDK documentation for UrlHandler. Default value notice: By
     * default loads swagger.json file Default value: swagger.json Path
     * parameter: operationId (required) ID of the operation from the Swagger
     * specification.
     * @param path specificationUri#operationId
     */
    ...
    /**
     * Robot Framework (camel-robotframework) Pass camel exchanges to acceptence
     * test written in Robot DSL. Category: testing Since: 3.0 Maven
     * coordinates: org.apache.camel:camel-robotframework Syntax:
     * <code>robotframework:resourceUri</code> Path parameter: resourceUri
     * (required) Path to the resource. You can prefix with: classpath, file,
     * http, ref, or bean. classpath, file and http loads the resource using
     * these protocols (classpath is default). ref will lookup the resource in
     * the registry. bean will call a method on a bean to be used as the
    ...
    /**
     * RSS (camel-rss) Poll RSS feeds. Category: rss Since: 2.0 Maven
     * coordinates: org.apache.camel:camel-rss Syntax: <code>rss:feedUri</code>
     * Path parameter: feedUri (required) The URI to the feed to poll.
     * @param path feedUri
     */
    ...
    /**
     * Saga (camel-saga) Execute custom actions within a route using the Saga
     * EIP. Category: core,endpoint Since: 2.21 Maven coordinates:
     * org.apache.camel:camel-saga Syntax: <code>saga:action</code> Path
     * parameter: action (required) Action to execute (complete or compensate)
    ...
    /**
     * Salesforce (camel-salesforce) Communicate with Salesforce using Java
     * DTOs. Category: api,cloud,crm Since: 2.12 Maven coordinates:
     * org.apache.camel:camel-salesforce Syntax:
     * <code>salesforce:operationName:topicName</code> Path parameter:
     * operationName The operation to use The value can be one of: getVersions,
     ...
     * composite-tree, composite-batch, composite Path parameter: topicName The
     * name of the topic/channel to use
    ...
    /**
     * SAP NetWeaver (camel-sap-netweaver) Send requests to SAP NetWeaver
     * Gateway using HTTP. Category: sap Since: 2.12 Maven coordinates:
     * org.apache.camel:camel-sap-netweaver Syntax:
     * <code>sap-netweaver:url</code> Path parameter: url (required) Url to the
     * SAP net-weaver gateway server.
     * @param path url
     */
    ...
    /**
     * Scheduler (camel-scheduler) Generate messages in specified intervals
     * using java.util.concurrent.ScheduledExecutorService. Category:
     * core,scheduling Since: 2.15 Maven coordinates:
     * org.apache.camel:camel-scheduler Syntax: <code>scheduler:name</code> Path
     * parameter: name (required) The name of the scheduler
     * @param path name
     */
    ...
    /**
     * Schematron (camel-schematron) Validate XML payload using the Schematron
     * Library. Category: validation Since: 2.15 Maven coordinates:
     * org.apache.camel:camel-schematron Syntax: <code>schematron:path</code>
     * Path parameter: path (required) The path to the schematron rules file.
     * Can either be in class path or location in the file system.
     * @param path path
     */
    ...
    /**
     * SCP (camel-jsch) Copy files to/from remote hosts using the secure copy
     * protocol (SCP). Category: file Since: 2.10 Maven coordinates:
     * org.apache.camel:camel-jsch Syntax:
     * <code>scp:host:port/directoryName</code> Path parameter: host (required)
     * Hostname of the FTP server Path parameter: port Port of the FTP server
     * Path parameter: directoryName The starting directory
     * @param path host:port/directoryName
     */
    ...
    /**
     * SEDA (camel-seda) Asynchronously call another endpoint from any Camel
     * Context in the same JVM. Category: core,endpoint Since: 1.1 Maven
     * coordinates: org.apache.camel:camel-seda Syntax: <code>seda:name</code>
     * Path parameter: name (required) Name of queue
     * @param path name
     */
    ...
    /**
     * Service (camel-service) Register a Camel endpoint to a Service Registry
     * (such as Consul, Etcd) and delegate to it. Category: cloud Since: 2.22
     * Maven coordinates: org.apache.camel:camel-service Syntax:
     * <code>service:delegateUri</code> Path parameter: delegateUri (required)
    ...
    /**
     * ServiceNow (camel-servicenow) Interact with ServiceNow via its REST API.
     * Category: api,cloud,management Since: 2.18 Maven coordinates:
     * org.apache.camel:camel-servicenow Syntax:
     * <code>servicenow:instanceName</code> Path parameter: instanceName
    ...
    /**
     * Servlet (camel-servlet) Serve HTTP requests by a Servlet. Category: http
     * Since: 2.0 Maven coordinates: org.apache.camel:camel-servlet Syntax:
     * <code>servlet:contextPath</code> Path parameter: contextPath (required)
     ...
     * Category: file Since: 1.1 Maven coordinates: org.apache.camel:camel-ftp
     * Syntax: <code>sftp:host:port/directoryName</code> Path parameter: host
     * (required) Hostname of the FTP server Path parameter: port Port of the
     * FTP server Path parameter: directoryName The starting directory
     * @param path host:port/directoryName
     */
    ...
    /**
     * SIP (camel-sip) Send and receive messages using the SIP protocol (used in
     * telecommunications). Category: mobile Since: 2.5 Maven coordinates:
     * org.apache.camel:camel-sip Syntax: <code>sip:uri</code> Path parameter:
     * uri (required) URI of the SIP server to connect to (the username and
     * password can be included such as: john:secretmyserver:9999)
     * @param path uri
     */
    ...
    /**
     * SIP (Secure) (camel-sip) Send and receive messages using the SIP protocol
     * (used in telecommunications). Category: mobile Since: 2.5 Maven
     * coordinates: org.apache.camel:camel-sip Syntax: <code>sips:uri</code>
     * Path parameter: uri (required) URI of the SIP server to connect to (the
     * username and password can be included such as: john:secretmyserver:9999)
     * @param path uri
     */
    static org.apache.camel.builder.endpoint.dsl.SipEndpointBuilderFactory.SipEndpointBuilder sips(
            java.lang.String path) {
        return org.apache.camel.builder.endpoint.dsl.SipEndpointBuilderFactory.endpointBuilder("sips",path);
    }
    /**
     * SIP (Secure) (camel-sip) Send and receive messages using the SIP protocol
     * (used in telecommunications). Category: mobile Since: 2.5 Maven
    ...
    /**
     * Simple JMS (camel-sjms) Send and receive messages to/from a JMS Queue or
     * Topic using plain JMS 1.x API. Category: messaging Since: 2.11 Maven
     * coordinates: org.apache.camel:camel-sjms Syntax:
     * <code>sjms:destinationType:destinationName</code> Path parameter:
     * destinationType The kind of destination to use Default value: queue The
     * value can be one of: queue, topic Path parameter: destinationName
     * (required) DestinationName is a JMS queue or topic name. By default, the
    ...
    /**
     * Simple JMS2 (camel-sjms2) Send and receive messages to/from a JMS Queue
     * or Topic using plain JMS 2.x API. Category: messaging Since: 2.19 Maven
     * coordinates: org.apache.camel:camel-sjms2 Syntax:
     * <code>sjms2:destinationType:destinationName</code> Path parameter:
     * destinationType The kind of destination to use Default value: queue The
     * value can be one of: queue, topic Path parameter: destinationName
     * (required) DestinationName is a JMS queue or topic name. By default, the
     * destinationName is interpreted as a queue name.
    ...
    /**
     * Simple JMS Batch (camel-sjms) Highly performant and transactional batch
     * consumption of messages from a JMS queue. Category: messaging Since: 2.16
     * Maven coordinates: org.apache.camel:camel-sjms Syntax:
     * <code>sjms-batch:destinationName</code> Path parameter: destinationName
     * (required) The destination name. Only queues are supported, names may be
     * prefixed by 'queue:'.
    ...
    /**
     * Slack (camel-slack) Send and receive messages to/from Slack. Category:
     * social Since: 2.16 Maven coordinates: org.apache.camel:camel-slack
     * Syntax: <code>slack:channel</code> Path parameter: channel (required) The
     * channel name (syntax #name) or slackuser (syntax userName) to send a
    ...
    /**
     * SMPP (camel-smpp) Send and receive SMS messages using a SMSC (Short
     * Message Service Center). Category: mobile Since: 2.2 Maven coordinates:
     * org.apache.camel:camel-smpp Syntax: <code>smpp:host:port</code> Path
     * parameter: host Hostname for the SMSC server to use. Default value:
     * localhost Path parameter: port Port number for the SMSC server to use.
     * Default value: 2775
     * @param path host:port
     */
    ...
    /**
     * SMPP (Secure) (camel-smpp) Send and receive SMS messages using a SMSC
     * (Short Message Service Center). Category: mobile Since: 2.2 Maven
     * coordinates: org.apache.camel:camel-smpp Syntax:
     * <code>smpps:host:port</code> Path parameter: host Hostname for the SMSC
     * server to use. Default value: localhost Path parameter: port Port number
     * for the SMSC server to use. Default value: 2775
     * @param path host:port
     */
    static org.apache.camel.builder.endpoint.dsl.SmppEndpointBuilderFactory.SmppEndpointBuilder smpps(
            java.lang.String path) {
    ...
    /**
     * SMTP (camel-mail) Send and receive emails using imap, pop3 and smtp
     * protocols. Category: mail Since: 1.0 Maven coordinates:
     * org.apache.camel:camel-mail Syntax: <code>smtp:host:port</code> Path
     * parameter: host (required) The mail server host name Path parameter: port
     * The port number of the mail server
     * @param path host:port
     */
    static org.apache.camel.builder.endpoint.dsl.MailEndpointBuilderFactory.MailEndpointBuilder smtp(
            java.lang.String path) {
    ...
    /**
     * SMTPS (camel-mail) Send and receive emails using imap, pop3 and smtp
     * protocols. Category: mail Since: 1.0 Maven coordinates:
     * org.apache.camel:camel-mail Syntax: <code>smtps:host:port</code> Path
     * parameter: host (required) The mail server host name Path parameter: port
     * The port number of the mail server
     * @param path host:port
     */
    static org.apache.camel.builder.endpoint.dsl.MailEndpointBuilderFactory.MailEndpointBuilder smtps(
            java.lang.String path) {
     ...
     * Protocol) capable devices. Category: monitoring Since: 2.1 Maven
     * coordinates: org.apache.camel:camel-snmp Syntax:
     * <code>snmp:host:port</code> Path parameter: host (required) Hostname of
     * the SNMP enabled device Path parameter: port (required) Port number of
     * the SNMP enabled device
     * @param path host:port
     */
     ...
     * Category: monitoring,search Since: 2.9 Maven coordinates:
     * org.apache.camel:camel-solr Syntax: <code>solr:url</code> Path parameter:
     * url (required) Hostname and port for the solr server
     * @param path url
     */
     ...
     * Solr (camel-solr) Perform operations against Apache Lucene Solr.
     * Category: monitoring,search Since: 2.9 Maven coordinates:
     * org.apache.camel:camel-solr Syntax: <code>solrCloud:url</code> Path
     * parameter: url (required) Hostname and port for the solr server
     * @param path url
     */
    static org.apache.camel.builder.endpoint.dsl.SolrEndpointBuilderFactory.SolrEndpointBuilder solrCloud(
            java.lang.String path) {
        return org.apache.camel.builder.endpoint.dsl.SolrEndpointBuilderFactory.endpointBuilder("solrCloud",path);
    }
    /**
     * Solr (camel-solr) Perform operations against Apache Lucene Solr.
     * Category: monitoring,search Since: 2.9 Maven coordinates:
     ...
     * Category: monitoring,search Since: 2.9 Maven coordinates:
     * org.apache.camel:camel-solr Syntax: <code>solrs:url</code> Path
     * parameter: url (required) Hostname and port for the solr server
     * @param path url
     */
    static org.apache.camel.builder.endpoint.dsl.SolrEndpointBuilderFactory.SolrEndpointBuilder solrs(
            java.lang.String path) {
        return org.apache.camel.builder.endpoint.dsl.SolrEndpointBuilderFactory.endpointBuilder("solrs",path);
    }
    /**
     * Solr (Secure) (camel-solr) Perform operations against Apache Lucene Solr.
     * Category: monitoring,search Since: 2.9 Maven coordinates:
     ...
     * Category: chat Since: 3.0 Maven coordinates:
     * org.apache.camel:camel-soroush Syntax: <code>soroush:action</code> Path
     * parameter: action (required) The action to do. The value can be one of:
    ...
    /**
     * Spark (camel-spark) Send RDD or DataFrame jobs to Apache Spark clusters.
     * Category: bigdata,iot Since: 2.17 Maven coordinates:
     * org.apache.camel:camel-spark Syntax: <code>spark:endpointType</code> Path
     * parameter: endpointType (required) Type of the endpoint (rdd, dataframe,
     * hive). The value can be one of: rdd, dataframe, hive
     * @param path endpointType
     */
    ...
    /**
     * Splunk (camel-splunk) Publish or search for events in Splunk. Category:
     * log,monitoring Since: 2.13 Maven coordinates:
     * org.apache.camel:camel-splunk Syntax: <code>splunk:name</code> Path
     * parameter: name (required) Name has no purpose
     * @param path name
     */
    ...
    /**
     * Splunk HEC (camel-splunk-hec) The splunk component allows to publish
     * events in Splunk using the HTTP Event Collector. Category: log,monitoring
     * Since: 3.3 Maven coordinates: org.apache.camel:camel-splunk-hec Syntax:
     * <code>splunk-hec:splunkURL/token</code> Path parameter: splunkURL
     * (required) Splunk Host URL Path parameter: token (required) Splunk
     * authorization token
    ...
    /**
     * Spring Batch (camel-spring-batch) Send messages to Spring Batch for
     * further processing. Category: spring,batch,scheduling Since: 2.10 Maven
     * coordinates: org.apache.camel:camel-spring-batch Syntax:
     * <code>spring-batch:jobName</code> Path parameter: jobName (required) The
     * name of the Spring Batch job located in the registry.
     * @param path jobName
     */
     ...
     * Category: spring,eventbus Since: 1.4 Maven coordinates:
     * org.apache.camel:camel-spring Syntax: <code>spring-event:name</code> Path
     * parameter: name Name of endpoint
     * @param path name
     */
    ...
    /**
     * Spring Integration (camel-spring-integration) Bridge Camel with Spring
     * Integration. Category: spring,eventbus Since: 1.4 Maven coordinates:
     * org.apache.camel:camel-spring-integration Syntax:
     * <code>spring-integration:defaultChannel</code> Path parameter:
     * defaultChannel (required) The default channel name which is used by the
     * Spring Integration Spring context. It will equal to the inputChannel name
     * for the Spring Integration consumer and the outputChannel name for the
    ...
    /**
     * Spring LDAP (camel-spring-ldap) Perform searches in LDAP servers using
     * filters as the message payload. Category: spring,ldap Since: 2.11 Maven
     * coordinates: org.apache.camel:camel-spring-ldap Syntax:
     * <code>spring-ldap:templateName</code> Path parameter: templateName
    ...
    /**
     * Spring Redis (camel-spring-redis) Send and receive messages from Redis.
     * Category: spring,nosql Since: 2.11 Maven coordinates:
     * org.apache.camel:camel-spring-redis Syntax:
     * <code>spring-redis:host:port</code> Path parameter: host (required) The
     * host where Redis server is running. Path parameter: port (required) Redis
     * server port number
     * @param path host:port
     */
    ...
    /**
     * Spring WebService (camel-spring-ws) Access external web services as a
     * client or expose your own web services. Category: spring,soap,webservice
     * Since: 2.6 Maven coordinates: org.apache.camel:camel-spring-ws Syntax:
     * <code>spring-ws:type:lookupKey:webServiceEndpointUri</code> Path
     * parameter: type Endpoint mapping type if endpoint mapping is used.
     * rootqname - Offers the option to map web service requests based on the
     * qualified name of the root element contained in the message. soapaction -
     * Used to map web service requests based on the SOAP action specified in
     * the header of the message. uri - In order to map web service requests
     * that target a specific URI. xpathresult - Used to map web service
     * requests based on the evaluation of an XPath expression against the
     * incoming message. The result of the evaluation should match the XPath
     * result specified in the endpoint URI. beanname - Allows you to reference
     * an org.apache.camel.component.spring.ws.bean.CamelEndpointDispatcher
     * object in order to integrate with existing (legacy) endpoint mappings
     * like PayloadRootQNameEndpointMapping, SoapActionEndpointMapping, etc The
     * value can be one of: ROOT_QNAME, ACTION, TO, SOAP_ACTION, XPATHRESULT,
     * URI, URI_PATH, BEANNAME Path parameter: lookupKey Endpoint mapping key if
     * endpoint mapping is used Path parameter: webServiceEndpointUri The
     * default Web Service endpoint uri to use for the producer. Path parameter:
     * expression The XPath expression to use when option type=xpathresult. Then
     * this option is required to be configured.
    ...
    /**
     * SQL (camel-sql) Perform SQL queries using Spring JDBC. Category:
     * database,sql Since: 1.4 Maven coordinates: org.apache.camel:camel-sql
     * Syntax: <code>sql:query</code> Path parameter: query (required) Sets the
    ...
    /**
     * SQL Stored Procedure (camel-sql) Perform SQL queries as a JDBC Stored
     * Procedures using Spring JDBC. Category: database,sql Since: 2.17 Maven
     * coordinates: org.apache.camel:camel-sql Syntax:
     * <code>sql-stored:template</code> Path parameter: template (required) Sets
     * the StoredProcedure template to perform
     * @param path template
     */
    ...
    /**
     * SSH (camel-ssh) Execute commands on remote hosts using SSH. Category:
     * file Since: 2.10 Maven coordinates: org.apache.camel:camel-ssh Syntax:
     * <code>ssh:host:port</code> Path parameter: host (required) Sets the
     * hostname of the remote SSH server. Path parameter: port Sets the port
     * number for the remote SSH server. Default value: 22
     * @param path host:port
     */
    ...
    /**
     * StAX (camel-stax) Process XML payloads by a SAX ContentHandler. Category:
     * transformation Since: 2.9 Maven coordinates: org.apache.camel:camel-stax
     * Syntax: <code>stax:contentHandlerClass</code> Path parameter:
     * contentHandlerClass (required) The FQN class name for the ContentHandler
    ...
    /**
     * Stomp (camel-stomp) Send and rececive messages to/from STOMP (Simple Text
     * Oriented Messaging Protocol) compliant message brokers. Category:
     * messaging Since: 2.12 Maven coordinates: org.apache.camel:camel-stomp
     * Syntax: <code>stomp:destination</code> Path parameter: destination
    ...
    /**
     * Stream (camel-stream) Read from system-in and write to system-out and
     * system-err streams. Category: file,system Since: 1.3 Maven coordinates:
     * org.apache.camel:camel-stream Syntax: <code>stream:kind</code> Path
     * parameter: kind (required) Kind of stream to use such as System.in or
    ...
    /**
     * String Template (camel-stringtemplate) Transform messages using
     * StringTemplate engine. Category: transformation Since: 1.2 Maven
     * coordinates: org.apache.camel:camel-stringtemplate Syntax:
     * <code>string-template:resourceUri</code> Path parameter: resourceUri
     * (required) Path to the resource. You can prefix with: classpath, file,
     * http, ref, or bean. classpath, file and http loads the resource using
     * these protocols (classpath is default). ref will lookup the resource in
     * the registry. bean will call a method on a bean to be used as the
    ...
    /**
     * Stub (camel-stub) Stub out any physical endpoints while in development or
     * testing. Category: core,testing Since: 2.10 Maven coordinates:
     * org.apache.camel:camel-stub Syntax: <code>stub:name</code> Path
     * parameter: name (required) Name of queue
     * @param path name
     */
    ...
    /**
     * Telegram (camel-telegram) Send and receive messages acting as a Telegram
     * Bot Telegram Bot API. Category: chat Since: 2.18 Maven coordinates:
     * org.apache.camel:camel-telegram Syntax: <code>telegram:type</code> Path
     * parameter: type (required) The endpoint type. Currently, only the 'bots'
     * type is supported. The value can be one of: bots
     * @param path type
     */
    ...
    /**
     * Thrift (camel-thrift) Call and expose remote procedures (RPC) with Apache
     * Thrift data format and serialization mechanism. Category: rpc Since: 2.20
     * Maven coordinates: org.apache.camel:camel-thrift Syntax:
     * <code>thrift:host:port/service</code> Path parameter: host The Thrift
     * server host name. This is localhost or 0.0.0.0 (if not defined) when
     * being a consumer or remote server host name when using producer. Path
     * parameter: port (required) The Thrift server port Path parameter: service
     * (required) Fully qualified service name from the thrift descriptor file
    ...
    /**
     * Tika (camel-tika) Parse documents and extract metadata and text using
     * Apache Tika. Category: document,transformation Since: 2.19 Maven
     * coordinates: org.apache.camel:camel-tika Syntax:
     * <code>tika:operation</code> Path parameter: operation (required)
     * Operation type The value can be one of: parse, detect
     * @param path operation
     */
    ...
    /**
     * Timer (camel-timer) Generate messages in specified intervals using
     * java.util.Timer. Category: core,scheduling Since: 1.0 Maven coordinates:
     * org.apache.camel:camel-timer Syntax: <code>timer:timerName</code> Path
     * parameter: timerName (required) The name of the timer
    ...
    /**
     * Twilio (camel-twilio) Interact with Twilio REST APIs using Twilio Java
     * SDK. Category: api,messaging,cloud Since: 2.20 Maven coordinates:
     * org.apache.camel:camel-twilio Syntax:
     * <code>twilio:apiName/methodName</code> Path parameter: apiName (required)
     * What kind of operation to perform The value can be one of: ACCOUNT,
     * ADDRESS, APPLICATION, AVAILABLE_PHONE_NUMBER_COUNTRY, CALL, CONFERENCE,
     ...
     * USAGE_RECORD_YEARLY, USAGE_RECORD_YESTERDAY Path parameter: methodName
     * (required) What sub operation to use for the selected operation The value
     * can be one of: create, delete, fetch, read, update
     * @param path apiName/methodName
     */
    ...
    /**
     * Twitter Direct Message (camel-twitter) Send and receive Twitter direct
     * messages. Category: api,social Since: 2.10 Maven coordinates:
     * org.apache.camel:camel-twitter Syntax:
     * <code>twitter-directmessage:user</code> Path parameter: user (required)
    ...
    /**
     * Twitter Search (camel-twitter) Access Twitter Search. Category:
     * api,social Since: 2.10 Maven coordinates: org.apache.camel:camel-twitter
     * Syntax: <code>twitter-search:keywords</code> Path parameter: keywords
     * (required) The search query, use the keywords AND, OR, - and () to narrow
     * the search results.
     * @param path keywords
     */
    ...
    /**
     * Twitter Timeline (camel-twitter) Send tweets and receive tweets from
     * user's timeline. Category: api,social Since: 2.10 Maven coordinates:
     * org.apache.camel:camel-twitter Syntax:
     * <code>twitter-timeline:timelineType</code> Path parameter: timelineType
     * (required) The timeline type to produce/consume. The value can be one of:
    ...
    /**
     * Undertow (camel-undertow) Expose HTTP and WebSocket endpoints and access
     * external HTTP/WebSocket servers. Category: http,websocket Since: 2.16
     * Maven coordinates: org.apache.camel:camel-undertow Syntax:
     * <code>undertow:httpURI</code> Path parameter: httpURI (required) The url
     * of the HTTP endpoint to use.
     * @param path httpURI
     */
    ...
    /**
     * Validator (camel-validator) Validate the payload using XML Schema and
     * JAXP Validation. Category: core,validation Since: 1.1 Maven coordinates:
     * org.apache.camel:camel-validator Syntax:
     * <code>validator:resourceUri</code> Path parameter: resourceUri (required)
    ...
    /**
     * Velocity (camel-velocity) Transform messages using a Velocity template.
     * Category: transformation Since: 1.2 Maven coordinates:
     * org.apache.camel:camel-velocity Syntax: <code>velocity:resourceUri</code>
     * Path parameter: resourceUri (required) Path to the resource. You can
     * prefix with: classpath, file, http, ref, or bean. classpath, file and
     * http loads the resource using these protocols (classpath is default). ref
     * will lookup the resource in the registry. bean will call a method on a
     ...
     * Category: eventbus,reactive Since: 2.12 Maven coordinates:
     * org.apache.camel:camel-vertx Syntax: <code>vertx:address</code> Path
     * parameter: address (required) Sets the event bus address used to
     * communicate
     * @param path address
     */
    ...
    /**
     * VM (camel-vm) Call another endpoint in the same CamelContext
     * asynchronously. Category: core,endpoint Since: 1.1 Maven coordinates:
     * org.apache.camel:camel-vm Syntax: <code>vm:name</code> Path parameter:
     * name (required) Name of queue
     * @param path name
     */
    ...
    /**
     * Weather (camel-weather) Poll the weather information from Open Weather
     * Map. Category: api Since: 2.12 Maven coordinates:
     * org.apache.camel:camel-weather Syntax: <code>weather:name</code> Path
     * parameter: name (required) The name value is not used.
     * @param path name
     */
    ...
    /**
     * Web3j Ethereum Blockchain (camel-web3j) Interact with Ethereum nodes
     * using web3j client API. Category: bitcoin,blockchain Since: 2.22 Maven
     * coordinates: org.apache.camel:camel-web3j Syntax:
     * <code>web3j:nodeAddress</code> Path parameter: nodeAddress (required)
    ...
    /**
     * Webhook (camel-webhook) Expose webhook endpoints to receive push
     * notifications for other Camel components. Category: cloud Since: 3.0
     * Maven coordinates: org.apache.camel:camel-webhook Syntax:
     * <code>webhook:endpointUri</code> Path parameter: endpointUri (required)
     ...
     * Category: websocket Since: 2.10 Maven coordinates:
     * org.apache.camel:camel-websocket Syntax:
     * <code>websocket:host:port/resourceUri</code> Path parameter: host The
     * hostname. The default value is 0.0.0.0. Setting this option on the
     * component will use the component configured value as default. Default
     * value: 0.0.0.0 Path parameter: port The port number. The default value is
     * 9292. Setting this option on the component will use the component
     * configured value as default. Default value: 9292 Path parameter:
     * resourceUri (required) Name of the websocket channel to use
    ...
    /**
     * Javax Websocket (camel-websocket-jsr356) Expose websocket endpoints using
     * JSR356. Category: http Since: 2.23 Maven coordinates:
     * org.apache.camel:camel-websocket-jsr356 Syntax:
     * <code>websocket-jsr356:uri</code> Path parameter: uri If a schemeless URI
     * path is provided, a ServerEndpoint is deployed under that path. Else if
     * the URI is prefixed with the 'ws://' scheme, then a connection is
    ...
    /**
     * Weka (camel-weka) Perform machine learning tasks using Weka. Category:
     * Datamining Since: 3.1 Maven coordinates: org.apache.camel:camel-weka
     * Syntax: <code>weka:command</code> Path parameter: command (required) The
     * command to use. The value can be one of: filter, model, read, write,
     * push, pop, version
     * @param path command
     */
    ...
    /**
     * Wordpress (camel-wordpress) Manage posts and users using Wordpress API.
     * Category: cms Since: 2.21 Maven coordinates:
     * org.apache.camel:camel-wordpress Syntax: <code>wordpress:operation</code>
     * Path parameter: operation (required) The endpoint operation. The value
     * can be one of: post, user Path parameter: operationDetail The second part
     * of an endpoint operation. Needed only when endpoint semantic is not
     * enough, like wordpress:post:delete The value can be one of: delete
     * @param path operation
     */
    ...
    /**
     * Workday (camel-workday) Detect and parse documents using Workday.
     * Category: hcm Since: 3.1 Maven coordinates:
     * org.apache.camel:camel-workday Syntax: <code>workday:entity:path</code>
     * Path parameter: entity (required) The entity to be requested or
     * subscribed via API. The value can be one of: report Path parameter: path
    ...
    /**
     * XChange (camel-xchange) Access market data and trade on Bitcoin and
     * Altcoin exchanges. Category: bitcoin,blockchain Since: 2.21 Maven
     * coordinates: org.apache.camel:camel-xchange Syntax:
     * <code>xchange:name</code> Path parameter: name (required) The exchange to
     * connect to
     * @param path name
     */
    ...
    /**
     * XJ (camel-xj) Transform JSON and XML message using a XSLT. Category:
     * transformation Since: 3.0 Maven coordinates: org.apache.camel:camel-xj
     * Syntax: <code>xj:resourceUri</code> Path parameter: resourceUri
     * (required) Path to the template. The following is supported by the
     * default URIResolver. You can prefix with: classpath, file, http, ref, or
    ...
    /**
     * XML Security Sign (camel-xmlsecurity) Sign XML payloads using the XML
     * signature specification. Category: security,transformation Since: 2.12
     * Maven coordinates: org.apache.camel:camel-xmlsecurity Syntax:
     * <code>xmlsecurity-sign:name</code> Path parameter: name (required) The
     * name part in the URI can be chosen by the user to distinguish between
    ...
    /**
     * XML Security Verify (camel-xmlsecurity) Verify XML payloads using the XML
     * signature specification. Category: security,transformation Since: 2.12
     * Maven coordinates: org.apache.camel:camel-xmlsecurity Syntax:
     * <code>xmlsecurity-verify:name</code> Path parameter: name (required) The
     * name part in the URI can be chosen by the user to distinguish between
     ...
     * Category: chat,messaging Since: 1.0 Maven coordinates:
     * org.apache.camel:camel-xmpp Syntax:
     * <code>xmpp:host:port/participant</code> Path parameter: host (required)
     * Hostname for the chat server Path parameter: port (required) Port number
     * for the chat server Path parameter: participant JID (Jabber ID) of person
     * to receive messages. room parameter has precedence over participant.
    ...
    /**
     * XQuery (camel-saxon) Query and/or transform XML payloads using XQuery and
     * Saxon. Category: transformation Since: 1.0 Maven coordinates:
     * org.apache.camel:camel-saxon Syntax: <code>xquery:resourceUri</code> Path
     * parameter: resourceUri (required) The name of the template to load from
     ...
     * Category: core,transformation Since: 1.3 Maven coordinates:
     * org.apache.camel:camel-xslt Syntax: <code>xslt:resourceUri</code> Path
     * parameter: resourceUri (required) Path to the template. The following is
     * supported by the default URIResolver. You can prefix with: classpath,
     * file, http, ref, or bean. classpath, file and http loads the resource
     * using these protocols (classpath is default). ref will lookup the
     * resource in the registry. bean will call a method on a bean to be used as
     * the resource. For bean you can specify the method name after dot, eg
     * bean:myBean.myMethod
     * @param path resourceUri
     */
    ...
    /**
     * XSLT Saxon (camel-xslt-saxon) Transform XML payloads using an XSLT
     * template using Saxon. Category: core,transformation Since: 3.0 Maven
     * coordinates: org.apache.camel:camel-xslt-saxon Syntax:
     * <code>xslt-saxon:resourceUri</code> Path parameter: resourceUri
     * (required) Path to the template. The following is supported by the
     * default URIResolver. You can prefix with: classpath, file, http, ref, or
     * bean. classpath, file and http loads the resource using these protocols
     * (classpath is default). ref will lookup the resource in the registry.
    ...
    /**
     * Yammer (camel-yammer) Interact with the Yammer enterprise social network.
     * Category: social Since: 2.12 Maven coordinates:
     * org.apache.camel:camel-yammer Syntax: <code>yammer:function</code> Path
     * parameter: function (required) The function to use The value can be one
     * of: MESSAGES, MY_FEED, ALGO, FOLLOWING, SENT, PRIVATE, RECEIVED, USERS,
     * CURRENT
     * @param path function
     */
    ...
    /**
     * Zendesk (camel-zendesk) Manage Zendesk tickets, users, organizations,
     * etc. Category: api,support,cloud Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-zendesk Syntax: <code>zendesk:methodName</code>
     * Path parameter: methodName (required) What operation to use
     * @param path methodName
     */
    ...
    /**
     * ZooKeeper Master (camel-zookeeper-master) Have only a single consumer in
     * a cluster consuming from a given endpoint; with automatic failover if the
     * JVM dies. Category: clustering Since: 2.19 Maven coordinates:
     * org.apache.camel:camel-zookeeper-master Syntax:
     * <code>zookeeper-master:groupName:consumerEndpointUri</code> Path
     * parameter: groupName (required) The name of the cluster group to use Path
     * parameter: consumerEndpointUri (required) The consumer endpoint to use in
     * master/slave mode
