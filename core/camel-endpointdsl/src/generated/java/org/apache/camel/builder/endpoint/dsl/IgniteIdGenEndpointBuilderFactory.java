 ...
 * allows you to interact with Ignite Atomic Sequences and ID Generators. This
 * endpoint only supports producers.
 * 
...
public interface IgniteIdGenEndpointBuilderFactory {
    ...
    public interface IgniteIdGenBuilders {
         ...
         * Generators. This endpoint only supports producers.
         * 
