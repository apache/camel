 ...
 * from) a JMS Queue or Topic (uses JMS 1.x API). This component uses plain JMS
 * API where as the jms component uses Spring JMS.
 * 
...
public interface SjmsEndpointBuilderFactory {
    ...
    public interface SjmsBuilders {
         ...
         * consumed from) a JMS Queue or Topic (uses JMS 1.x API). This
         * component uses plain JMS API where as the jms component uses Spring
         * JMS.
         * 
         * Category: messaging
         * Since: 2.11
     ...
     * Simple JMS (camel-sjms)
     * The sjms component (simple jms) allows messages to be sent to (or
     * consumed from) a JMS Queue or Topic (uses JMS 1.x API). This component
     * uses plain JMS API where as the jms component uses Spring JMS.
     * 
     * Category: messaging
     * Since: 2.11
     * Maven coordinates: org.apache.camel:camel-sjms
