 ...
 * communicating with clients using websocket. This component uses Jetty as the
...
public interface WebsocketEndpointBuilderFactory {
    ...
    public interface WebsocketBuilders {
         ...
         * The websocket component provides websocket endpoints with Jetty for
         * communicating with clients using websocket. This component uses Jetty
     ...
     * Jetty Websocket (camel-websocket)
     * The websocket component provides websocket endpoints with Jetty for
     * communicating with clients using websocket. This component uses Jetty as
