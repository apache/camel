 ...
 * scheduler fires. This component is similar to the timer component, but it
 * offers more functionality in terms of scheduling. Also this component uses
...
public interface SchedulerEndpointBuilderFactory {
    ...
    public interface SchedulerBuilders {
         ...
         * a scheduler fires. This component is similar to the timer component,
         * but it offers more functionality in terms of scheduling. Also this
         * component uses JDK ScheduledExecutorService. Where as the timer uses
         * a JDK Timer.
         * 
     ...
     * The scheduler component is used for generating message exchanges when a
     * scheduler fires. This component is similar to the timer component, but it
     * offers more functionality in terms of scheduling. Also this component
     * uses JDK ScheduledExecutorService. Where as the timer uses a JDK Timer.
     * 
     * Category: core,scheduling
     * Since: 2.15
     * Maven coordinates: org.apache.camel:camel-scheduler
