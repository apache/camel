...
public interface KinesisEndpointBuilderFactory {
    ...
    public interface KinesisEndpointConsumerBuilder
         ...
         * Group: common
         */
        default KinesisEndpointConsumerBuilder autoDiscoverClient(
         ...
         * Group: scheduler
         */
        default KinesisEndpointConsumerBuilder schedulerProperties(Map values) {
    ...
    public interface KinesisEndpointProducerBuilder
         ...
         * Group: common
         */
        default KinesisEndpointProducerBuilder autoDiscoverClient(
                boolean autoDiscoverClient) {
            doSetProperty("autoDiscoverClient", autoDiscoverClient);
            return this;
        }
    ...
    public interface KinesisEndpointBuilder
         ...
         * Group: common
         */
        default KinesisEndpointBuilder autoDiscoverClient(
                boolean autoDiscoverClient) {
            doSetProperty("autoDiscoverClient", autoDiscoverClient);
            return this;
        }
