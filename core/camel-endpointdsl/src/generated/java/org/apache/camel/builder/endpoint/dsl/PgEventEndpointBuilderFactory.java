 ...
 * related to the listen/notify commands. This requires using PostgreSQL 8.3 or
 * newer.
 * 
...
public interface PgEventEndpointBuilderFactory {
    ...
    public interface PgEventBuilders {
         ...
         * events related to the listen/notify commands. This requires using
     ...
     * PostgresSQL Event (camel-pgevent)
     * The pgevent component allows for producing/consuming PostgreSQL events
     * related to the listen/notify commands. This requires using PostgreSQL 8.3
     * or newer.
     * 
     * Category: database,sql
     * Since: 2.15
