...
public interface KMS2EndpointBuilderFactory {
    ...
    public interface KMS2EndpointBuilder extends EndpointProducerBuilder {
         ...
         * Group: common
         */
        default KMS2EndpointBuilder autoDiscoverClient(
         ...
         * Group: common
         */
        default KMS2EndpointBuilder autoDiscoverClient(String autoDiscoverClient) {
            doSetProperty("autoDiscoverClient", autoDiscoverClient);
            return this;
        }
        /**
    ...
    /**
     * Advanced builder for endpoint for the AWS 2 Key Management Service (KMS)
     * component.
     */
