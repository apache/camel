 ...
 * you to send and consume messages from an Ignite topic. This endpoint supports
 * producers (to send messages) and consumers (to receive messages).
 * 
...
public interface IgniteMessagingEndpointBuilderFactory {
    ...
    public interface IgniteMessagingBuilders {
         ...
         * allows you to send and consume messages from an Ignite topic. This
         * endpoint supports producers (to send messages) and consumers (to
         * receive messages).
         * 
     ...
     * The Ignite Messaging endpoint is one of camel-ignite endpoints which
     * allows you to send and consume messages from an Ignite topic. This
     * endpoint supports producers (to send messages) and consumers (to receive
     * messages).
     * 
     * Category: nosql,cache,messaging
     * Since: 2.17
