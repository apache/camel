...
public interface MinioEndpointBuilderFactory {
    ...
    public interface MinioEndpointConsumerBuilder
         ...
         * Group: common
         */
        default MinioEndpointConsumerBuilder pojoRequest(boolean pojoRequest) {
         ...
         * Group: common
         */
        default MinioEndpointConsumerBuilder pojoRequest(String pojoRequest) {
            doSetProperty("pojoRequest", pojoRequest);
            return this;
        }
        /**
    ...
    public interface MinioEndpointProducerBuilder
         ...
         * Group: common
         */
        default MinioEndpointProducerBuilder bypassGovernanceMode(
                boolean bypassGovernanceMode) {
            doSetProperty("bypassGovernanceMode", bypassGovernanceMode);
            return this;
        }
    ...
    public interface MinioEndpointBuilder
         ...
         * Group: common
         */
        default MinioEndpointBuilder bypassGovernanceMode(
                boolean bypassGovernanceMode) {
            doSetProperty("bypassGovernanceMode", bypassGovernanceMode);
            return this;
        }
         ...
         * Group: common
         */
        default MinioEndpointBuilder pojoRequest(boolean pojoRequest) {
            doSetProperty("pojoRequest", pojoRequest);
            return this;
        }
        /**
         ...
         * Group: common
         */
        default MinioEndpointBuilder pojoRequest(String pojoRequest) {
            doSetProperty("pojoRequest", pojoRequest);
            return this;
        }
        /**
