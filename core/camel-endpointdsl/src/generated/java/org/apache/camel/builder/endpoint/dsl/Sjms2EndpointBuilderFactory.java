 ...
 * from) a JMS Queue or Topic (uses JMS 2.x API). This component uses plain JMS
 * 2.x API where as the jms component uses Spring JMS.
 * 
...
public interface Sjms2EndpointBuilderFactory {
    ...
    public interface Sjms2Builders {
         ...
         * consumed from) a JMS Queue or Topic (uses JMS 2.x API). This
         * component uses plain JMS 2.x API where as the jms component uses
         * Spring JMS.
         * 
         * Category: messaging
         * Since: 2.19
     ...
     * Simple JMS2 (camel-sjms2)
     * The sjms2 component (simple jms) allows messages to be sent to (or
     * consumed from) a JMS Queue or Topic (uses JMS 2.x API). This component
     * uses plain JMS 2.x API where as the jms component uses Spring JMS.
     * 
     * Category: messaging
     * Since: 2.19
     * Maven coordinates: org.apache.camel:camel-sjms2
