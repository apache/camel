...
public interface EndpointBuilderFactory {
    ...
    default org.apache.camel.Expression endpoints(org.apache.camel.builder.EndpointProducerBuilder... endpoints) {
        return new org.apache.camel.support.ExpressionAdapter() {
            ...
            List<org.apache.camel.Expression> expressions = Stream.of(endpoints).map(org.apache.camel.builder.EndpointProducerBuilder::expr).collect(Collectors.toList());
     ...
     * The url of the HTTP endpoint to call.
     */
    default org.apache.camel.builder.endpoint.dsl.JettyHttpEndpointBuilderFactory.JettyHttpEndpointBuilder jetty(String path) {
