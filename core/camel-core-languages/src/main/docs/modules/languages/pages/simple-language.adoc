...
:page-source: core/camel-core-languages/src/main/docs/modules/languages/pages/simple-language.adoc
:docTitle: Simple
...
The simple langauge is designed with intend to cover almost all of the common use cases
