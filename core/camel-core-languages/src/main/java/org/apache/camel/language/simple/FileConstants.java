...
public final class FileConstants {
    ...
    @Metadata(
            description = "The file name (relative from starting directory) without extension",
            javaType = "String",
            label = "function")
    ...
    @Metadata(
            description =
                    "The file name (relative from starting directory) without extension. If the file name has multiple dots, then this expression strips and only returns the last part.",
            javaType = "String",
            label = "function")
    ...
    @Metadata(
            description =
                    "The file extension. If the file extension has multiple dots, then this expression strips and only returns the last part.",
            javaType = "String",
            label = "function")
    ...
    @Metadata(
            description = "†he file name (without any leading paths) without extension",
            javaType = "String",
            label = "function")
    ...
    @Metadata(
            description =
                    "†he file name (without any leading paths) without extension. If the file name has multiple dots, then this expression strips and only returns the last part.",
            javaType = "String",
            label = "function")
    public static final String FILE_ONLY_NAME_NO_EXT_SINGLE = "file:onlyname.noext.single";

    @Metadata(
            description = "The file parent directory (null if no parent directory)",
            javaType = "String",
            label = "function")
    ...
    @Metadata(
            description = "Whether the file is regarded as absolute or relative",
            javaType = "boolean",
            label = "function")
