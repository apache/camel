...
public final class SimpleConstants {
    ...
    @Metadata(description = "Base64 decodes the message body (or expression)", javaType = "byte[]", label = "function")
    public static final String BASE64_DECODE = "base64Decode(exp)";

    @Metadata(description = "Base64 encodes the message body (or expression)", javaType = "String", label = "function")
    ...
    @Metadata(description = "Capitalizes the message body/expression as a String value (upper case every words)",
              javaType = "String", label = "function", displayName = "Capitalize String Values")
    ...
    @Metadata(description = "Converts the message body (or expression) to the specified type.", label = "function,ognl",
    ...
    @Metadata(description = "The list function creates an ArrayList with the given set of values.", label = "function",
    ...
    @Metadata(description = "The map function creates a LinkedHashMap with the given set of pairs.", label = "function",
    ...
    @Metadata(description = "Splits the message body/expression as a String value using the separator into a String array",
              label = "function", javaType = "String[]", displayName = "Split String Values")
