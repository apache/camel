...
public final class SimpleConstants {
    ...
    @Metadata(
            description = "The message timestamp (millis since epoc) that this message originates from."
    ...
    @Metadata(
            description =
                    "The exception object on the exchange (also from caught exceptions), is null if no exception present.",
    ...
    @Metadata(
            description =
                    "Converts the message body to the given type (classname). If the body is null then the function will fail with an exception",
            label = "function,ognl",
            javaType = "Object")
    ...
    @Metadata(
            description =
                    "Evaluates to a java.util.Date object." + " Supported commands are: `now` for current timestamp,"
    ...
    @Metadata(
            description = "Formats the date to a String using the given date pattern, and with support for timezone."
    ...
    @Metadata(
            description =
                    "To refer to a type or field by its classname. To refer to a field, you can append .FIELD_NAME. For example, you can refer to the"
    ...
    @Metadata(
            description =
                    "Replace all the string values in the message body/expression."
    ...
    @Metadata(
            description = "Returns a substring of the message body/expression."
    ...
    @Metadata(
            description =
                    "The skip function iterates the message body and skips the first number of items."
                            + " This can be used with the Splitter EIP to split a message body and skip the first N number of items.",
            label = "function",
            javaType = "java.util.Iterator",
            displayName = "Skip First Items from the Message Body")
    public static final String SKIP = "skip(num)";

    @Metadata(
            description =
                    "The collate function iterates the message body and groups the data into sub lists of specified size."
    ...
    @Metadata(
            description =
                    "The join function iterates the message body/expression and joins the data into a string."
    ...
    @Metadata(
            description =
                    "The message history of the current exchange (how it has been routed). This is similar to the route stack-trace message history"
    ...
    @Metadata(
            description = "Returns a UUID using the Camel `UuidGenerator`."
    ...
    @Metadata(
            description =
                    "Returns a hashed value (string in hex decimal) of the message body/expression using JDK MessageDigest. The algorithm can be SHA-256 (default) or SHA3-256.",
            label = "function",
            javaType = "String",
    ...
    @Metadata(
            description =
                    "Creates a new empty object (decided by type). Use `string` to create an empty String. Use `list` to create an empty `java.util.ArrayList`. Use `map` to create an empty `java.util.LinkedHashMap`.",
            label = "function",
            javaType = "Object",
    ...
    @Metadata(
            description =
                    "Evaluates the predicate and returns the value of trueExp or falseExp. This function is similar to the ternary operator in Java.",
            label = "function",
            javaType = "Object",
    ...
    @Metadata(
            ...
            label = "function",
            javaType = "java.util.LinkedHashMap",
