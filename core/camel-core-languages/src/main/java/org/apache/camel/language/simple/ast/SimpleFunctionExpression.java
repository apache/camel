...
public class SimpleFunctionExpression extends LiteralExpression {
    ...
    public SimpleFunctionExpression(
            SimpleToken token, Map<String, Expression> cacheExpression, boolean skipFileFunctions) {
        super(token);
    ...
    private Expression createSimpleExpression(CamelContext camelContext, String function, boolean strict) {
        ...
        if (remainder != null) {
            ...
            if (invalid) {
                throw new SimpleParserException(
                        "Valid syntax: ${camelContext.OGNL} was: " + function, token.getIndex());
            }
        ...
        if (remainder != null) {
            ...
            if (invalid) {
                throw new SimpleParserException(
                        "Valid syntax: ${exchangeProperty.OGNL} was: " + function, token.getIndex());
            }
        ...
        if (remainder != null) {
            ...
            if (parts.length < 3) {
                throw new SimpleParserException(
                        "Valid syntax: ${date-with-timezone:command:timezone:pattern} was: " + function,
                        token.getIndex());
            }
        ...
        if (remainder != null) {
            ...
            if (remainder.contains("?method=") || remainder.contains("?scope=")) {
                ...
                if (doubleColonIndex > 0
                        && (!remainder.contains("(") || doubleColonIndex < beginOfParameterDeclaration)) {
        ...
        if (remainder != null) {
            ...
            if (parts.length > 2) {
                throw new SimpleParserException(
                        "Valid syntax: ${propertiesExist:key} was: " + function, token.getIndex());
            }
            String key = parts[0];
        ...
        if (remainder != null) {
            ...
            if (parts.length > 2) {
                throw new SimpleParserException(
                        "Valid syntax: ${properties:key[:default]} was: " + function, token.getIndex());
            }
    ...
    private Expression createSimpleExpressionMessage(CamelContext camelContext, String function, boolean strict) {
        ...
        if (remainder != null) {
            ...
            if (ObjectHelper.isNotEmpty(remainder)) {
                ...
                if (invalid) {
                    throw new SimpleParserException(
                            "Valid syntax: ${messageAs(type).OGNL} was: " + function, token.getIndex());
                }
    ...
    private Expression createSimpleExpressionBodyOrHeader(String function, boolean strict) {
        ...
        if (remainder != null) {
            ...
            if (ObjectHelper.isNotEmpty(remainder)) {
                ...
                if (invalid) {
                    throw new SimpleParserException(
                            "Valid syntax: ${bodyAs(type).OGNL} was: " + function, token.getIndex());
                }
        ...
        if (remainder != null) {
            ...
            if (type == null) {
                throw new SimpleParserException(
                        "Valid syntax: ${mandatoryBodyAs(type)} was: " + function, token.getIndex());
            }
            type = StringHelper.removeQuotes(type);
            remainder = StringHelper.after(remainder, ")");
            if (ObjectHelper.isNotEmpty(remainder)) {
        ...
        if (remainder != null) {
            ...
            if (keyAndType == null) {
                throw new SimpleParserException(
                        "Valid syntax: ${headerAs(key, type)} was: " + function, token.getIndex());
            }
    ...
    private Expression createSimpleExpressionMisc(String function) {
        ...
        if (remainder != null) {
            ...
            if (values.contains(",")) {
                ...
                if (tokens.length > 2) {
                    throw new SimpleParserException(
                            "Valid syntax: ${hash(value,algorithm)} or ${hash(value)} was: " + function,
                            token.getIndex());
                }
        ...
        if (remainder != null) {
            ...
            if (values == null || ObjectHelper.isEmpty(values)) {
                throw new SimpleParserException(
                        "Valid syntax: ${iif(predicate,trueExpression,falseExpression)} was: " + function,
                        token.getIndex());
            }
    ...
    private String doCreateCode(CamelContext camelContext, String expression) throws SimpleParserException {
        ...
        if (remainder != null) {
            ...
            if (type.isEmpty() || invalid) {
                throw new SimpleParserException(
                        "Valid syntax: ${exceptionAs(type).OGNL} was: " + function, token.getIndex());
            }
    ...
    private String createCodeBody(final String function) {
        ...
        if (remainder != null) {
            ...
            if (ObjectHelper.isNotEmpty(remainder)) {
                ...
                if (invalid) {
                    throw new SimpleParserException(
                            "Valid syntax: ${mandatoryBodyAsIndex(type, index).OGNL} was: " + function,
                            token.getIndex());
                }
    ...
    private String createCodeHeader(final String function) {
        ...
        if (remainder != null) {
            ...
            if (index) {
                ...
                throw new SimpleParserException(
                        "Valid syntax: ${headerAs(key, type).OGNL} was: " + function, token.getIndex());
            } else {
                // regular header
    ...
    private String createCodeExchangeProperty(final String function) {
        ...
        if (remainder != null) {
            ...
            if (keyTypeAndIndex == null) {
                throw new SimpleParserException(
                        "Valid syntax: ${exchangePropertyAsIndex(key, type, index)} was: " + function,
                        token.getIndex());
            }
            String[] parts = keyTypeAndIndex.split(",");
            if (parts.length != 3) {
    ...
    private String createCodeExpressionMisc(String function) {
        ...
        if (remainder != null) {
            ...
            if (values == null || ObjectHelper.isEmpty(values)) {
                throw new SimpleParserException(
                        "Valid syntax: ${substring(num)}, ${substring(num,num)} was: " + function, token.getIndex());
            }
        ...
        if (remainder != null) {
            String values = StringHelper.before(remainder, ")");
            if (values == null || ObjectHelper.isEmpty(values)) {
                throw new SimpleParserException("Valid syntax: ${replace(from,to)} was: " + function, token.getIndex());
            }
