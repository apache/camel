...
public interface BulkTypeConverters extends Ordered, TypeConverter {
     ...
     */
    <T> @Nullable T convertTo(Class<?> from, Class<T> to, @Nullable Exchange exchange, Object value)
     ...
     */
    default <T> @Nullable T tryConvertTo(Class<?> from, Class<T> to, @Nullable Exchange exchange, Object value)
            throws TypeConversionException {
        try {
