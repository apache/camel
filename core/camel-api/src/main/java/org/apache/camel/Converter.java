 ...
 * which are then auto-discovered using the <a href="http://camel.apache.org/type-converter.html">Type Conversion
 * Support</a>
 */
...
public @interface Converter {
     ...
     *
     * <b>Important</b>: Fallback type converters is not recommended being used by Camel end users,
     * but are used by Camel internally and for some special Camel components.
     *
     * The difference between a regular converter and a fallback-converter is that the fallback is resolved at last if
     * no regular converter could be found. The method signature is scoped to be generic to allow handling a
