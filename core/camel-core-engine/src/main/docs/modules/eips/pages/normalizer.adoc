...
In this case we're using a Java xref:components::bean-component.adoc[Bean] as the normalizer.
...
that computes a xref:components::bean-component.adoc[Bean] endpoint, to be called that acts as
