...
[source,xml]
----
include::{examplesdir}/components/camel-spring-xml/src/test/resources/org/apache/camel/spring/SpringConsumerTemplateTest-context.xml[tags=e1]
----
...
[source,java]
----
include::{examplesdir}/components/camel-spring-xml/src/test/java/org/apache/camel/spring/SpringConsumerTemplateTest.java[tags=e1]
----
...
xref:ROOT:quartz-component.adoc[Quartz], and xref:latest@manual:ROOT:spring.adoc[Spring] based which
...
xref:ROOT:quartz-component.adoc[Quartz], xref:latest@manual:ROOT:spring.adoc[Spring] based scheduler.
...
in the xref:ROOT:quartz-component.adoc[Quartz], and xref:latest@manual:ROOT:spring.adoc[Spring]
components.
