...
| xref:sticky-eip.adoc[Sticky Load Balancer] | Sticky load balancing using an xref:manual:ROOT:expression.adoc[Expression] to calculate a correlation key to perform the sticky load balancing.
