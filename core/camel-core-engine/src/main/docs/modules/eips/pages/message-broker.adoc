...
Camel supports integration with existing message broker systems such as xref:components::activemq-component.adoc[ActiveMQ],
xref:components::kafka-component.adoc[Kafka], xref:components::spring-rabbitmq-component.adoc[RabbitMQ],
and cloud queue systems such as xref:components::aws2-s3-component.adoc[AWS SQS], and others.
