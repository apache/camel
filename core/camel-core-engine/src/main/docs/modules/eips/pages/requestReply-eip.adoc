...
Camel supports Request Reply by the xref:latest@manual:ROOT:exchange-pattern.adoc[Exchange Pattern]
...
* continue routing when the reply is received and populated on the xref:latest@manual:ROOT:exchange.adoc[Exchange]
