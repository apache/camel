...
- _default mode_ - The message is split into sub messages, which allows to know the total split size. However this causes all sub messages to be kept temporarily in-memory.
