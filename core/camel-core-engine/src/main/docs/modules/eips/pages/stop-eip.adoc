...
:doctitle: Stop
:shortname: stop
:description: Stops processing of the current message and marks the exchange as completed without sending it to any further steps
:since: 
:supportlevel: Stable
:tabs-sync-option:
...
You can also mark an `Exchange` to stop being routed using the `setRouteStop(true)` method
using Java code:
