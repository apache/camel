...
java.lang.IllegalArgumentException: The number is too low
	...
	at org.apache.camel.builder.RouteBuilder.checkInitialized(RouteBuilder.java:607) ~[camel-core-model-3.20.1-SNAPSHOT.jar:3.20.1-SNAPSHOT]
	at org.apache.camel.builder.RouteBuilder.configureRoutes(RouteBuilder.java:553) ~[camel-core-model-3.20.1-SNAPSHOT.jar:3.20.1-SNAPSHOT]
----
