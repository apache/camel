...
This is useful for xref:others:a2a-component.adoc[A2A] consumer routes where you want to report scoped progress updates
...
* xref:others:a2a-component.adoc[A2A Component]
