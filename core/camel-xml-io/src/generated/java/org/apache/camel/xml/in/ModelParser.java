...
public class ModelParser extends BaseParser {
    ...
    protected DataFormatDefinition doParseJacksonXMLDataFormatUnified() throws IOException, XmlPullParserException {
        // Detect which Jackson implementation is available
        // Try Jackson 3.x first (tools.jackson.databind.ObjectMapper)
        try {
            Class.forName("tools.jackson.databind.ObjectMapper");
            return doParseJacksonXML3DataFormat();
        } catch (ClassNotFoundException e) {
            // Fall back to Jackson 2.x
    ...
    protected DataFormatDefinition doParseDataFormatDefinitionRef(String key) throws IOException, XmlPullParserException {
        switch (key) {
                        ...
                        case "jacksonXml": return doParseJacksonXMLDataFormatUnified();
