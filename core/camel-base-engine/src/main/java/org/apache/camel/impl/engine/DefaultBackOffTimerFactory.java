...
public class DefaultBackOffTimerFactory implements BackOffTimerFactory {
    ...
    public BackOffTimer newBackOffTimer(String name) {
        var scheduler = camelContext.getExecutorServiceManager().newSingleThreadScheduledExecutor(this, "BackOffTimer");
        return newBackOffTimer(name, scheduler);
    }

    @Override
    public BackOffTimer newBackOffTimer(String name, ScheduledExecutorService scheduler) {
