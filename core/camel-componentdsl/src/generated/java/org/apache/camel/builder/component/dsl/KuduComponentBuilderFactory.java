...
public interface KuduComponentBuilderFactory {
     ...
     */
    interface KuduComponentBuilder extends ComponentBuilder<KuduComponent> {
        /**
    ...
    class KuduComponentBuilderImpl
            extends
                AbstractComponentBuilder<KuduComponent>
            implements
                KuduComponentBuilder {
        @Override
        protected KuduComponent buildConcreteComponent() {
            return new KuduComponent();
        }
        @Override
