...
public interface OaipmhComponentBuilderFactory {
     ...
     */
    static OaipmhComponentBuilder oaipmh() {
        return new OaipmhComponentBuilderImpl();
    }

    /**
     * Builder for the OAIPMH component.
     */
    interface OaipmhComponentBuilder
            extends
         ...
         * Group: consumer
         */
        default OaipmhComponentBuilder bridgeErrorHandler(
         ...
         * Group: producer
         */
        default OaipmhComponentBuilder lazyStartProducer(
    ...
    class OaipmhComponentBuilderImpl
            extends
                AbstractComponentBuilder<OAIPMHComponent>
            implements
                OaipmhComponentBuilder {
        @Override
        protected OAIPMHComponent buildConcreteComponent() {
            return new OAIPMHComponent();
        }
        @Override
        protected boolean setPropertyOnComponent(
            ...
            case "basicPropertyBinding": ((OAIPMHComponent) component).setBasicPropertyBinding((boolean) value); return true;
