...
public interface AhcComponentBuilderFactory {
    ...
    interface AhcComponentBuilder extends ComponentBuilder<AhcComponent> {
         ...
         * context-type=application/x-java-serialized-object &lt;p/&gt; This is
         * by default turned off. If you enable this then be aware that Java
         * will deserialize the incoming data from the request to Java and that
