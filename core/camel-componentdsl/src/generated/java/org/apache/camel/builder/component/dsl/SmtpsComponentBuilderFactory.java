...
public interface SmtpsComponentBuilderFactory {
    ...
    interface SmtpsComponentBuilder extends ComponentBuilder<MailComponent> {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder bridgeErrorHandler(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder closeFolder(boolean closeFolder) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder copyTo(java.lang.String copyTo) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder delete(boolean delete) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder disconnect(boolean disconnect) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder handleFailedMessage(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder mimeDecodeHeaders(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder moveTo(java.lang.String moveTo) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder peek(boolean peek) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder skipFailedMessage(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder unseen(boolean unseen) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder fetchSize(int fetchSize) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder folderName(java.lang.String folderName) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder mapMailMessage(boolean mapMailMessage) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder bcc(java.lang.String bcc) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder cc(java.lang.String cc) {
            doSetProperty("cc", cc);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder from(java.lang.String from) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder replyTo(java.lang.String replyTo) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder subject(java.lang.String subject) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder to(java.lang.String to) {
            doSetProperty("to", to);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder javaMailSender(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder additionalJavaMailProperties(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder alternativeBodyHeader(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder attachmentsContentTransferEncodingResolver(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder configuration(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder connectionTimeout(int connectionTimeout) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder contentType(java.lang.String contentType) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder contentTypeResolver(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder debugMode(boolean debugMode) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder ignoreUnsupportedCharset(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder ignoreUriScheme(boolean ignoreUriScheme) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder javaMailProperties(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder session(javax.mail.Session session) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder useInlineAttachments(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder headerFilterStrategy(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder password(java.lang.String password) {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder sslContextParameters(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder useGlobalSslContextParameters(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder username(java.lang.String username) {
            doSetProperty("username", username);
            return this;
        }
    }

    class SmtpsComponentBuilderImpl
            extends
                AbstractComponentBuilder<MailComponent>
            implements
                SmtpsComponentBuilder {
        @Override
