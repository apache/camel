...
public interface KameletReifyComponentBuilderFactory {
    ...
    class KameletReifyComponentBuilderImpl
        ...
        protected boolean setPropertyOnComponent(
                ...
                Object value) {
            switch (name) {
            case "bridgeErrorHandler": ((KameletReifyComponent) component).setBridgeErrorHandler((boolean) value); return true;
            case "lazyStartProducer": ((KameletReifyComponent) component).setLazyStartProducer((boolean) value); return true;
            case "autowiredEnabled": ((KameletReifyComponent) component).setAutowiredEnabled((boolean) value); return true;
