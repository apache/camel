...
public interface PrinterComponentBuilderFactory {
     ...
     */
    static PrinterComponentBuilder lpr() {
        return new PrinterComponentBuilderImpl();
    }

    /**
     * Builder for the Printer component.
     */
    interface PrinterComponentBuilder
            extends
                ComponentBuilder<PrinterComponent> {
        /**
    ...
    class PrinterComponentBuilderImpl
            extends
                AbstractComponentBuilder<PrinterComponent>
            implements
                PrinterComponentBuilder {
        @Override
