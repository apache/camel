...
public interface SmppsSmppComponentBuilderFactory {
     ...
     */
    static SmppsSmppComponentBuilder smpps() {
        return new SmppsSmppComponentBuilderImpl();
    }

    /**
     * Builder for the SMPP (Secure) component.
     */
    interface SmppsSmppComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default SmppsSmppComponentBuilder configuration(
         ...
         * Group: advanced
         */
        default SmppsSmppComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default SmppsSmppComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default SmppsSmppComponentBuilder bridgeErrorHandler(
    ...
    class SmppsSmppComponentBuilderImpl
            extends
                AbstractComponentBuilder<SmppComponent>
            implements
                SmppsSmppComponentBuilder {
        @Override
