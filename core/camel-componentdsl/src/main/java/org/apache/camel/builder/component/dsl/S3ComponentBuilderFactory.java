...
public interface S3ComponentBuilderFactory {
     ...
     */
    static S3ComponentBuilder awsS3() {
        return new S3ComponentBuilderImpl();
    }

    /**
     * Builder for the AWS S3 Storage Service component.
     */
    interface S3ComponentBuilder extends ComponentBuilder<S3Component> {
        /**
