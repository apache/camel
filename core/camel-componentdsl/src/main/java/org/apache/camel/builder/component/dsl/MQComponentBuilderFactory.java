...
public interface MQComponentBuilderFactory {
     ...
     */
    static MQComponentBuilder awsMq() {
        return new MQComponentBuilderImpl();
    }

    /**
     * Builder for the AWS MQ component.
     */
    interface MQComponentBuilder extends ComponentBuilder<MQComponent> {
        /**
