...
public interface BlobServiceComponentBuilderFactory {
     ...
     */
    static BlobServiceComponentBuilder azureBlob() {
        return new BlobServiceComponentBuilderImpl();
    }

    /**
     * Builder for the Azure Storage Blob Service component.
     */
    interface BlobServiceComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default BlobServiceComponentBuilder setConfiguration(
         ...
         * Group: advanced
         */
        default BlobServiceComponentBuilder setBasicPropertyBinding(
         ...
         * Group: producer
         */
        default BlobServiceComponentBuilder setLazyStartProducer(
         ...
         * Group: consumer
         */
        default BlobServiceComponentBuilder setBridgeErrorHandler(
    ...
    class BlobServiceComponentBuilderImpl
            extends
                AbstractComponentBuilder<BlobServiceComponent>
            implements
                BlobServiceComponentBuilder {
        @Override
