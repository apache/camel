...
public interface GlanceComponentBuilderFactory {
     ...
     */
    static GlanceComponentBuilder openstackGlance() {
        return new GlanceComponentBuilderImpl();
    }

    /**
     * Builder for the OpenStack Glance component.
     */
    interface GlanceComponentBuilder
            extends
    ...
    class GlanceComponentBuilderImpl
            extends
                AbstractComponentBuilder<GlanceComponent>
            implements
                GlanceComponentBuilder {
        @Override
