...
public interface GoogleCalendarStreamComponentBuilderFactory {
    ...
    interface GoogleCalendarStreamComponentBuilder
         ...
         * Group: advanced
         */
        default GoogleCalendarStreamComponentBuilder setConfiguration(
         ...
         * Group: advanced
         */
        default GoogleCalendarStreamComponentBuilder setClientFactory(
         ...
         * Group: advanced
         */
        default GoogleCalendarStreamComponentBuilder setBasicPropertyBinding(
         ...
         * Group: consumer
         */
        default GoogleCalendarStreamComponentBuilder setBridgeErrorHandler(
