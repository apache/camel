...
public interface DdbComponentBuilderFactory {
     ...
     */
    static DdbComponentBuilder awsDdb() {
        return new DdbComponentBuilderImpl();
    }

    /**
     * Builder for the AWS DynamoDB component.
     */
    interface DdbComponentBuilder extends ComponentBuilder<DdbComponent> {
        /**
