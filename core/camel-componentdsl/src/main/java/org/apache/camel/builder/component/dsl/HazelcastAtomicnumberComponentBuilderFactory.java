...
public interface HazelcastAtomicnumberComponentBuilderFactory {
     ...
     */
    static HazelcastAtomicnumberComponentBuilder hazelcastAtomicvalue() {
        return new HazelcastAtomicnumberComponentBuilderImpl();
    }

    /**
     * Builder for the Hazelcast Atomic Number component.
     */
    interface HazelcastAtomicnumberComponentBuilder
            extends
    ...
    class HazelcastAtomicnumberComponentBuilderImpl
            extends
                AbstractComponentBuilder<HazelcastAtomicnumberComponent>
            implements
                HazelcastAtomicnumberComponentBuilder {
        @Override
