...
public interface SolrSolrComponentBuilderFactory {
     ...
     */
    static SolrSolrComponentBuilder solr() {
        return new SolrSolrComponentBuilderImpl();
    }

    /**
     * Builder for the Solr component.
     */
    interface SolrSolrComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default SolrSolrComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default SolrSolrComponentBuilder lazyStartProducer(
    ...
    class SolrSolrComponentBuilderImpl
            extends
                AbstractComponentBuilder<SolrComponent>
            implements
                SolrSolrComponentBuilder {
        @Override
