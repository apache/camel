...
public interface RestSwaggerComponentBuilderFactory {
    ...
    interface RestSwaggerComponentBuilder
         ...
         * Group: producer
         */
        default RestSwaggerComponentBuilder setBasePath(
         ...
         * Group: producer
         */
        default RestSwaggerComponentBuilder setComponentName(
         ...
         * Group: producer
         */
        default RestSwaggerComponentBuilder setConsumes(
         ...
         * Group: producer
         */
        default RestSwaggerComponentBuilder setHost(java.lang.String host) {
         ...
         * Group: producer
         */
        default RestSwaggerComponentBuilder setProduces(
         ...
         * Group: producer
         */
        default RestSwaggerComponentBuilder setSpecificationUri(
         ...
         * Group: security
         */
        default RestSwaggerComponentBuilder setSslContextParameters(
         ...
         * Group: security
         */
        default RestSwaggerComponentBuilder setUseGlobalSslContextParameters(
         ...
         * Group: advanced
         */
        default RestSwaggerComponentBuilder setBasicPropertyBinding(
         ...
         * Group: producer
         */
        default RestSwaggerComponentBuilder setLazyStartProducer(
