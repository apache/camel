...
public interface SolrcloudSolrComponentBuilderFactory {
     ...
     */
    static SolrcloudSolrComponentBuilder solrcloud() {
        return new SolrcloudSolrComponentBuilderImpl();
    }

    /**
     * Builder for the Solr component.
     */
    interface SolrcloudSolrComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default SolrcloudSolrComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default SolrcloudSolrComponentBuilder lazyStartProducer(
    ...
    class SolrcloudSolrComponentBuilderImpl
            extends
                AbstractComponentBuilder<SolrComponent>
            implements
                SolrcloudSolrComponentBuilder {
        @Override
