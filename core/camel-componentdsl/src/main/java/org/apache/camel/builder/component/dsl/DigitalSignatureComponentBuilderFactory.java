...
public interface DigitalSignatureComponentBuilderFactory {
     ...
     */
    static DigitalSignatureComponentBuilder crypto() {
        return new DigitalSignatureComponentBuilderImpl();
    }

    /**
     * Builder for the Crypto (JCE) component.
     */
    interface DigitalSignatureComponentBuilder
            extends
    ...
    class DigitalSignatureComponentBuilderImpl
            extends
                AbstractComponentBuilder<DigitalSignatureComponent>
            implements
                DigitalSignatureComponentBuilder {
        @Override
