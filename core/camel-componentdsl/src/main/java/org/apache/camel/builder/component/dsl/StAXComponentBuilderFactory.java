...
public interface StAXComponentBuilderFactory {
     ...
     */
    static StAXComponentBuilder stax() {
        return new StAXComponentBuilderImpl();
    }
    ...
    interface StAXComponentBuilder extends ComponentBuilder<StAXComponent> {
         ...
         * Group: advanced
         */
        default StAXComponentBuilder setBasicPropertyBinding(
         ...
         * Group: producer
         */
        default StAXComponentBuilder setLazyStartProducer(
    ...
    class StAXComponentBuilderImpl
            extends
                AbstractComponentBuilder<StAXComponent>
            implements
                StAXComponentBuilder {
        @Override
        protected StAXComponent buildConcreteComponent() {
            return new StAXComponent();
        }
    }
}