...
public interface SolrsSolrComponentBuilderFactory {
     ...
     */
    static SolrsSolrComponentBuilder solrs() {
        return new SolrsSolrComponentBuilderImpl();
    }

    /**
     * Builder for the Solr (Secure) component.
     */
    interface SolrsSolrComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default SolrsSolrComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default SolrsSolrComponentBuilder lazyStartProducer(
    ...
    class SolrsSolrComponentBuilderImpl
            extends
                AbstractComponentBuilder<SolrComponent>
            implements
                SolrsSolrComponentBuilder {
        @Override
