...
public interface KubernetesPersistentVolumesComponentBuilderFactory {
     ...
     */
    static KubernetesPersistentVolumesComponentBuilder kubernetesPersistentVolumes() {
        return new KubernetesPersistentVolumesComponentBuilderImpl();
    }
    ...
    class KubernetesPersistentVolumesComponentBuilderImpl
            extends
                AbstractComponentBuilder<KubernetesPersistentVolumesComponent>
            implements
                KubernetesPersistentVolumesComponentBuilder {
        @Override
