...
public interface MSK2ComponentBuilderFactory {
     ...
     */
    static MSK2ComponentBuilder aws2Msk() {
        return new MSK2ComponentBuilderImpl();
    }

    /**
     * Builder for the AWS 2 MSK component.
     */
    interface MSK2ComponentBuilder extends ComponentBuilder<MSK2Component> {
        /**
         ...
         * Group: advanced
         */
        default MSK2ComponentBuilder configuration(
         ...
         * Group: producer
         */
        default MSK2ComponentBuilder accessKey(java.lang.String accessKey) {
         ...
         * Group: producer
         */
        default MSK2ComponentBuilder secretKey(java.lang.String secretKey) {
         ...
         * Group: producer
         */
        default MSK2ComponentBuilder region(java.lang.String region) {
         ...
         * Group: advanced
         */
        default MSK2ComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default MSK2ComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }

    class MSK2ComponentBuilderImpl
            extends
                AbstractComponentBuilder<MSK2Component>
            implements
                MSK2ComponentBuilder {
        @Override
