...
public interface SmppSmppComponentBuilderFactory {
     ...
     */
    static SmppSmppComponentBuilder smpp() {
        return new SmppSmppComponentBuilderImpl();
    }

    /**
     * Builder for the SMPP component.
     */
    interface SmppSmppComponentBuilder
            extends
                ComponentBuilder<SmppComponent> {
        /**
         ...
         * Group: advanced
         */
        default SmppSmppComponentBuilder configuration(
         ...
         * Group: advanced
         */
        default SmppSmppComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default SmppSmppComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default SmppSmppComponentBuilder bridgeErrorHandler(
    ...
    class SmppSmppComponentBuilderImpl
            extends
                AbstractComponentBuilder<SmppComponent>
            implements
                SmppSmppComponentBuilder {
        @Override
