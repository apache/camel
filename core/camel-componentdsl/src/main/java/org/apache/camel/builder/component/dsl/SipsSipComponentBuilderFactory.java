...
public interface SipsSipComponentBuilderFactory {
     ...
     */
    static SipsSipComponentBuilder sips() {
        return new SipsSipComponentBuilderImpl();
    }

    /**
     * Builder for the SIP (Secure) component.
     */
    interface SipsSipComponentBuilder extends ComponentBuilder<SipComponent> {
        /**
         ...
         * Group: advanced
         */
        default SipsSipComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default SipsSipComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default SipsSipComponentBuilder bridgeErrorHandler(
    ...
    class SipsSipComponentBuilderImpl
            extends
                AbstractComponentBuilder<SipComponent>
            implements
                SipsSipComponentBuilder {
        @Override
