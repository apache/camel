...
public interface QueueServiceComponentBuilderFactory {
     ...
     */
    static QueueServiceComponentBuilder azureQueue() {
        return new QueueServiceComponentBuilderImpl();
    }

    /**
     * Builder for the Azure Storage Queue Service component.
     */
    interface QueueServiceComponentBuilder
            extends
    ...
    class QueueServiceComponentBuilderImpl
            extends
                AbstractComponentBuilder<QueueServiceComponent>
            implements
                QueueServiceComponentBuilder {
        @Override
