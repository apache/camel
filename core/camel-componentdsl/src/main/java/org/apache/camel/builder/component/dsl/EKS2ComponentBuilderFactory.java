...
public interface EKS2ComponentBuilderFactory {
     ...
     */
    static EKS2ComponentBuilder aws2Eks() {
        return new EKS2ComponentBuilderImpl();
    }

    /**
     * Builder for the AWS 2 EKS component.
     */
    interface EKS2ComponentBuilder extends ComponentBuilder<EKS2Component> {
        /**
         ...
         * Group: advanced
         */
        default EKS2ComponentBuilder configuration(
         ...
         * Group: producer
         */
        default EKS2ComponentBuilder accessKey(java.lang.String accessKey) {
         ...
         * Group: producer
         */
        default EKS2ComponentBuilder secretKey(java.lang.String secretKey) {
         ...
         * Group: producer
         */
        default EKS2ComponentBuilder region(java.lang.String region) {
         ...
         * Group: advanced
         */
        default EKS2ComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default EKS2ComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }

    class EKS2ComponentBuilderImpl
            extends
                AbstractComponentBuilder<EKS2Component>
            implements
                EKS2ComponentBuilder {
        @Override
