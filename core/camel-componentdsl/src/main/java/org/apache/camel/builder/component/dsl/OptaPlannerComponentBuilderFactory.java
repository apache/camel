...
public interface OptaPlannerComponentBuilderFactory {
    ...
    interface OptaPlannerComponentBuilder
         ...
         * Group: advanced
         */
        default OptaPlannerComponentBuilder setBasicPropertyBinding(
         ...
         * Group: producer
         */
        default OptaPlannerComponentBuilder setLazyStartProducer(
         ...
         * Group: consumer
         */
        default OptaPlannerComponentBuilder setBridgeErrorHandler(
