...
public interface GraphqlComponentBuilderFactory {
     ...
     */
    interface GraphqlComponentBuilder
            extends
                ComponentBuilder<GraphqlComponent> {
        /**
         ...
         * Group: advanced
         */
        default GraphqlComponentBuilder setBasicPropertyBinding(
         ...
         * Group: producer
         */
        default GraphqlComponentBuilder setLazyStartProducer(
    ...
    class GraphqlComponentBuilderImpl
            extends
                AbstractComponentBuilder<GraphqlComponent>
            implements
                GraphqlComponentBuilder {
        @Override
