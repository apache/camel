...
public interface SpringIntegrationComponentBuilderFactory {
    ...
    interface SpringIntegrationComponentBuilder
         ...
         * Group: advanced
         */
        default SpringIntegrationComponentBuilder setBasicPropertyBinding(
         ...
         * Group: producer
         */
        default SpringIntegrationComponentBuilder setLazyStartProducer(
         ...
         * Group: consumer
         */
        default SpringIntegrationComponentBuilder setBridgeErrorHandler(
