...
public interface SWFComponentBuilderFactory {
     ...
     */
    static SWFComponentBuilder awsSwf() {
        return new SWFComponentBuilderImpl();
    }

    /**
     * Builder for the AWS Simple Workflow component.
     */
    interface SWFComponentBuilder extends ComponentBuilder<SWFComponent> {
        /**
