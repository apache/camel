...
public interface ControlBusComponentBuilderFactory {
     ...
     */
    static ControlBusComponentBuilder controlbus() {
        return new ControlBusComponentBuilderImpl();
    }

    /**
     * Builder for the Control Bus component.
     */
    interface ControlBusComponentBuilder
            extends
                ComponentBuilder<ControlBusComponent> {
        /**
    ...
    class ControlBusComponentBuilderImpl
            extends
                AbstractComponentBuilder<ControlBusComponent>
            implements
