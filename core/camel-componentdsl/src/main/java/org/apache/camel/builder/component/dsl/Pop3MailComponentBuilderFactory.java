...
public interface Pop3MailComponentBuilderFactory {
     ...
     */
    static Pop3MailComponentBuilder pop3() {
        return new Pop3MailComponentBuilderImpl();
    }

    /**
     * Builder for the POP3 component.
     */
    interface Pop3MailComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default Pop3MailComponentBuilder configuration(
         ...
         * Group: advanced
         */
        default Pop3MailComponentBuilder contentTypeResolver(
         ...
         * Group: security
         */
        default Pop3MailComponentBuilder useGlobalSslContextParameters(
         ...
         * Group: filter
         */
        default Pop3MailComponentBuilder headerFilterStrategy(
         ...
         * Group: advanced
         */
        default Pop3MailComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default Pop3MailComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default Pop3MailComponentBuilder bridgeErrorHandler(
    ...
    class Pop3MailComponentBuilderImpl
            extends
                AbstractComponentBuilder<MailComponent>
            implements
                Pop3MailComponentBuilder {
        @Override
