...
public interface SmtpMailComponentBuilderFactory {
     ...
     */
    static SmtpMailComponentBuilder smtp() {
        return new SmtpMailComponentBuilderImpl();
    }

    /**
     * Builder for the SMTP component.
     */
    interface SmtpMailComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default SmtpMailComponentBuilder configuration(
         ...
         * Group: advanced
         */
        default SmtpMailComponentBuilder contentTypeResolver(
         ...
         * Group: security
         */
        default SmtpMailComponentBuilder useGlobalSslContextParameters(
         ...
         * Group: filter
         */
        default SmtpMailComponentBuilder headerFilterStrategy(
         ...
         * Group: advanced
         */
        default SmtpMailComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default SmtpMailComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default SmtpMailComponentBuilder bridgeErrorHandler(
    ...
    class SmtpMailComponentBuilderImpl
            extends
