...
public interface SmtpsMailComponentBuilderFactory {
     ...
     */
    static SmtpsMailComponentBuilder smtps() {
        return new SmtpsMailComponentBuilderImpl();
    }

    /**
     * Builder for the SMTPS component.
     */
    interface SmtpsMailComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default SmtpsMailComponentBuilder configuration(
         ...
         * Group: advanced
         */
        default SmtpsMailComponentBuilder contentTypeResolver(
         ...
         * Group: security
         */
        default SmtpsMailComponentBuilder useGlobalSslContextParameters(
         ...
         * Group: filter
         */
        default SmtpsMailComponentBuilder headerFilterStrategy(
         ...
         * Group: advanced
         */
        default SmtpsMailComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default SmtpsMailComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default SmtpsMailComponentBuilder bridgeErrorHandler(
    ...
    class SmtpsMailComponentBuilderImpl
            extends
                AbstractComponentBuilder<MailComponent>
            implements
                SmtpsMailComponentBuilder {
        @Override
