...
public interface CometdCometdComponentBuilderFactory {
     ...
     */
    static CometdCometdComponentBuilder cometd() {
        return new CometdCometdComponentBuilderImpl();
    }

    /**
     * Builder for the CometD component.
     */
    interface CometdCometdComponentBuilder
            extends
         ...
         * Group: security
         */
        default CometdCometdComponentBuilder sslKeyPassword(
         ...
         * Group: security
         */
        default CometdCometdComponentBuilder sslPassword(
         ...
         * Group: security
         */
        default CometdCometdComponentBuilder sslKeystore(
         ...
         * Group: security
         */
        default CometdCometdComponentBuilder securityPolicy(
         ...
         * Group: common
         */
        default CometdCometdComponentBuilder extensions(
         ...
         * Group: security
         */
        default CometdCometdComponentBuilder sslContextParameters(
         ...
         * Group: security
         */
        default CometdCometdComponentBuilder useGlobalSslContextParameters(
         ...
         * Group: advanced
         */
        default CometdCometdComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default CometdCometdComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default CometdCometdComponentBuilder bridgeErrorHandler(
    ...
    class CometdCometdComponentBuilderImpl
            extends
                AbstractComponentBuilder<CometdComponent>
            implements
                CometdCometdComponentBuilder {
        @Override
