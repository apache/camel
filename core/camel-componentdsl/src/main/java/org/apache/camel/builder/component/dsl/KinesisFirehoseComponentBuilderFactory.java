...
public interface KinesisFirehoseComponentBuilderFactory {
    ...
    interface KinesisFirehoseComponentBuilder
         ...
         * Group: advanced
         */
        default KinesisFirehoseComponentBuilder configuration(
         ...
         * Group: producer
         */
        default KinesisFirehoseComponentBuilder accessKey(
         ...
         * Group: producer
         */
        default KinesisFirehoseComponentBuilder secretKey(
         ...
         * Group: producer
         */
        default KinesisFirehoseComponentBuilder region(java.lang.String region) {
         ...
         * Group: advanced
         */
        default KinesisFirehoseComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default KinesisFirehoseComponentBuilder lazyStartProducer(
