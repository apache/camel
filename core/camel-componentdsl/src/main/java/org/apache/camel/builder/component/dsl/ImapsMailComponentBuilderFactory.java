...
public interface ImapsMailComponentBuilderFactory {
     ...
     */
    static ImapsMailComponentBuilder imaps() {
        return new ImapsMailComponentBuilderImpl();
    }

    /**
     * Builder for the IMAPS (Secure) component.
     */
    interface ImapsMailComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default ImapsMailComponentBuilder configuration(
         ...
         * Group: advanced
         */
        default ImapsMailComponentBuilder contentTypeResolver(
         ...
         * Group: security
         */
        default ImapsMailComponentBuilder useGlobalSslContextParameters(
         ...
         * Group: filter
         */
        default ImapsMailComponentBuilder headerFilterStrategy(
         ...
         * Group: advanced
         */
        default ImapsMailComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default ImapsMailComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default ImapsMailComponentBuilder bridgeErrorHandler(
    ...
    class ImapsMailComponentBuilderImpl
            extends
                AbstractComponentBuilder<MailComponent>
            implements
                ImapsMailComponentBuilder {
        @Override
