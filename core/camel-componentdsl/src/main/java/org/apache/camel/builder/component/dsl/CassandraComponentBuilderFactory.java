...
public interface CassandraComponentBuilderFactory {
     ...
     */
    static CassandraComponentBuilder cql() {
        return new CassandraComponentBuilderImpl();
    }

    /**
     * Builder for the Cassandra CQL component.
     */
    interface CassandraComponentBuilder
            extends
    ...
    class CassandraComponentBuilderImpl
            extends
                AbstractComponentBuilder<CassandraComponent>
            implements
                CassandraComponentBuilder {
        @Override
