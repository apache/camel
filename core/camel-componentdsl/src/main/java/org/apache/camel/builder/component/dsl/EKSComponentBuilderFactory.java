...
public interface EKSComponentBuilderFactory {
     ...
     */
    static EKSComponentBuilder awsEks() {
        return new EKSComponentBuilderImpl();
    }

    /**
     * Builder for the AWS EKS component.
     */
    interface EKSComponentBuilder extends ComponentBuilder<EKSComponent> {
        /**
