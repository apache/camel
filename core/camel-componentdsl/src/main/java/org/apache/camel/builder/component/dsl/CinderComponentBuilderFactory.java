...
public interface CinderComponentBuilderFactory {
     ...
     */
    static CinderComponentBuilder openstackCinder() {
        return new CinderComponentBuilderImpl();
    }

    /**
     * Builder for the OpenStack Cinder component.
     */
    interface CinderComponentBuilder
            extends
    ...
    class CinderComponentBuilderImpl
            extends
                AbstractComponentBuilder<CinderComponent>
            implements
                CinderComponentBuilder {
        @Override
