...
public interface CoapsCoAPComponentBuilderFactory {
     ...
     */
    static CoapsCoAPComponentBuilder coaps() {
        return new CoapsCoAPComponentBuilderImpl();
    }

    /**
     * Builder for the CoAP (Secure) component.
     */
    interface CoapsCoAPComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default CoapsCoAPComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default CoapsCoAPComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default CoapsCoAPComponentBuilder bridgeErrorHandler(
    ...
    class CoapsCoAPComponentBuilderImpl
            extends
                AbstractComponentBuilder<CoAPComponent>
            implements
                CoapsCoAPComponentBuilder {
        @Override
