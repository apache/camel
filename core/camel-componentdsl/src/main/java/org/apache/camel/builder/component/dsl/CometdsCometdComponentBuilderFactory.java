...
public interface CometdsCometdComponentBuilderFactory {
     ...
     */
    static CometdsCometdComponentBuilder cometds() {
        return new CometdsCometdComponentBuilderImpl();
    }

    /**
     * Builder for the CometD (Secure) component.
     */
    interface CometdsCometdComponentBuilder
            extends
         ...
         * Group: security
         */
        default CometdsCometdComponentBuilder sslKeyPassword(
         ...
         * Group: security
         */
        default CometdsCometdComponentBuilder sslPassword(
         ...
         * Group: security
         */
        default CometdsCometdComponentBuilder sslKeystore(
         ...
         * Group: security
         */
        default CometdsCometdComponentBuilder securityPolicy(
         ...
         * Group: common
         */
        default CometdsCometdComponentBuilder extensions(
         ...
         * Group: security
         */
        default CometdsCometdComponentBuilder sslContextParameters(
         ...
         * Group: security
         */
        default CometdsCometdComponentBuilder useGlobalSslContextParameters(
         ...
         * Group: advanced
         */
        default CometdsCometdComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default CometdsCometdComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default CometdsCometdComponentBuilder bridgeErrorHandler(
    ...
    class CometdsCometdComponentBuilderImpl
            extends
                AbstractComponentBuilder<CometdComponent>
            implements
                CometdsCometdComponentBuilder {
        @Override
