...
public interface KinesisComponentBuilderFactory {
     ...
     */
    static KinesisComponentBuilder awsKinesis() {
        return new KinesisComponentBuilderImpl();
    }

    /**
     * Builder for the AWS Kinesis component.
     */
    interface KinesisComponentBuilder
            extends
    ...
    class KinesisComponentBuilderImpl
            extends
                AbstractComponentBuilder<KinesisComponent>
            implements
                KinesisComponentBuilder {
        @Override
