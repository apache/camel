...
public interface CwComponentBuilderFactory {
     ...
     */
    static CwComponentBuilder awsCw() {
        return new CwComponentBuilderImpl();
    }

    /**
     * Builder for the AWS CloudWatch component.
     */
    interface CwComponentBuilder extends ComponentBuilder<CwComponent> {
        /**
