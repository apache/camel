...
public interface SlackComponentBuilderFactory {
     ...
     */
    static SlackComponentBuilder slack() {
        return new SlackComponentBuilderImpl();
    }
    ...
    class SlackComponentBuilderImpl
            extends
                AbstractComponentBuilder<SlackComponent>
            implements
                SlackComponentBuilder {
        @Override
