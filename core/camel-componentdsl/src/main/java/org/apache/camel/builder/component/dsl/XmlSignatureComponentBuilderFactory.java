...
public interface XmlSignatureComponentBuilderFactory {
     ...
     */
    static XmlSignatureComponentBuilder xmlsecurity() {
        return new XmlSignatureComponentBuilderImpl();
    }

    /**
     * Builder for the XML Security component.
     */
    interface XmlSignatureComponentBuilder
            extends
    ...
    class XmlSignatureComponentBuilderImpl
            extends
                AbstractComponentBuilder<XmlSignatureComponent>
            implements
                XmlSignatureComponentBuilder {
        @Override
