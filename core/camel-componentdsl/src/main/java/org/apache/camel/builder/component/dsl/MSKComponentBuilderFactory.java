...
public interface MSKComponentBuilderFactory {
     ...
     */
    static MSKComponentBuilder awsMsk() {
        return new MSKComponentBuilderImpl();
    }

    /**
     * Builder for the AWS MSK component.
     */
    interface MSKComponentBuilder extends ComponentBuilder<MSKComponent> {
        /**
