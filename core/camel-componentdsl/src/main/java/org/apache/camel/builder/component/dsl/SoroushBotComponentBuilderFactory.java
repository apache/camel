...
public interface SoroushBotComponentBuilderFactory {
     ...
     */
    static SoroushBotComponentBuilder soroush() {
        return new SoroushBotComponentBuilderImpl();
    }

    /**
     * Builder for the Soroush component.
     */
    interface SoroushBotComponentBuilder
            extends
    ...
    class SoroushBotComponentBuilderImpl
            extends
                AbstractComponentBuilder<SoroushBotComponent>
            implements
                SoroushBotComponentBuilder {
        @Override
