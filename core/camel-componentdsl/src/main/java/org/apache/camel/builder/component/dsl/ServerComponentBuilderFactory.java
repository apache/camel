...
public interface ServerComponentBuilderFactory {
     ...
     */
    static ServerComponentBuilder iec60870Server() {
        return new ServerComponentBuilderImpl();
    }

    /**
     * Builder for the IEC 60870 Server component.
     */
    interface ServerComponentBuilder
            extends
    ...
    class ServerComponentBuilderImpl
            extends
