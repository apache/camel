...
public interface RestComponentBuilderFactory {
     ...
     */
    static RestComponentBuilder restEndpoint() {
        return new RestComponentBuilderImpl();
    }

    /**
     * Builder for the REST component.
     */
    interface RestComponentBuilder extends ComponentBuilder<RestComponent> {
        /**
    ...
    class RestComponentBuilderImpl
            extends
                AbstractComponentBuilder<RestComponent>
            implements
                RestComponentBuilder {
        @Override
