...
public interface NovaComponentBuilderFactory {
     ...
     */
    static NovaComponentBuilder openstackNova() {
        return new NovaComponentBuilderImpl();
    }

    /**
     * Builder for the OpenStack Nova component.
     */
    interface NovaComponentBuilder extends ComponentBuilder<NovaComponent> {
        /**
    ...
    class NovaComponentBuilderImpl
            extends
                AbstractComponentBuilder<NovaComponent>
            implements
                NovaComponentBuilder {
        @Override
