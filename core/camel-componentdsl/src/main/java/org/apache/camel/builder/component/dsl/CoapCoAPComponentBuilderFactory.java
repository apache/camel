...
public interface CoapCoAPComponentBuilderFactory {
     ...
     */
    static CoapCoAPComponentBuilder coap() {
        return new CoapCoAPComponentBuilderImpl();
    }

    /**
     * Builder for the CoAP component.
     */
    interface CoapCoAPComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default CoapCoAPComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default CoapCoAPComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default CoapCoAPComponentBuilder bridgeErrorHandler(
    ...
    class CoapCoAPComponentBuilderImpl
            extends
                AbstractComponentBuilder<CoAPComponent>
            implements
                CoapCoAPComponentBuilder {
        @Override
