...
public interface MailComponentBuilderFactory {
     ...
     */
    static MailComponentBuilder imap() {
        return new MailComponentBuilderImpl();
    }

    /**
     * Builder for the IMAP component.
     */
    interface MailComponentBuilder extends ComponentBuilder<MailComponent> {
        /**
    ...
    class MailComponentBuilderImpl
            extends
                AbstractComponentBuilder<MailComponent>
            implements
                MailComponentBuilder {
        @Override
