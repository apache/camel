...
public interface RedisComponentBuilderFactory {
     ...
     */
    static RedisComponentBuilder springRedis() {
        return new RedisComponentBuilderImpl();
    }

    /**
     * Builder for the Spring Redis component.
     */
    interface RedisComponentBuilder extends ComponentBuilder<RedisComponent> {
        /**
    ...
    class RedisComponentBuilderImpl
            extends
                AbstractComponentBuilder<RedisComponent>
            implements
                RedisComponentBuilder {
        @Override
