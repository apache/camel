...
public interface TranslateComponentBuilderFactory {
     ...
     */
    static TranslateComponentBuilder awsTranslate() {
        return new TranslateComponentBuilderImpl();
    }

    /**
     * Builder for the AWS Translate component.
     */
    interface TranslateComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default TranslateComponentBuilder configuration(
         ...
         * Group: producer
         */
        default TranslateComponentBuilder accessKey(java.lang.String accessKey) {
         ...
         * Group: producer
         */
        default TranslateComponentBuilder secretKey(java.lang.String secretKey) {
         ...
         * Group: producer
         */
        default TranslateComponentBuilder region(java.lang.String region) {
         ...
         * Group: advanced
         */
        default TranslateComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default TranslateComponentBuilder lazyStartProducer(
    ...
    class TranslateComponentBuilderImpl
            extends
                AbstractComponentBuilder<TranslateComponent>
            implements
                TranslateComponentBuilder {
        @Override
