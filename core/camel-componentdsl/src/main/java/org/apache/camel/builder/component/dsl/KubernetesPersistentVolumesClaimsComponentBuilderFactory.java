...
public interface KubernetesPersistentVolumesClaimsComponentBuilderFactory {
    ...
    interface KubernetesPersistentVolumesClaimsComponentBuilder
         ...
         * Group: advanced
         */
        default KubernetesPersistentVolumesClaimsComponentBuilder setBasicPropertyBinding(
         ...
         * Group: producer
         */
        default KubernetesPersistentVolumesClaimsComponentBuilder setLazyStartProducer(
