...
public interface KubernetesPersistentVolumesClaimsComponentBuilderFactory {
    ...
    interface KubernetesPersistentVolumesClaimsComponentBuilder
         ...
         * Group: advanced
         */
        default KubernetesPersistentVolumesClaimsComponentBuilder basicPropertyBinding(
    ...
    class KubernetesPersistentVolumesClaimsComponentBuilderImpl
            extends
                AbstractComponentBuilder<KubernetesPersistentVolumesClaimsComponent>
            implements
                KubernetesPersistentVolumesClaimsComponentBuilder {
        @Override
        protected KubernetesPersistentVolumesClaimsComponent buildConcreteComponent() {
            return new KubernetesPersistentVolumesClaimsComponent();
        }
        @Override
        protected boolean setPropertyOnComponent(
                ...
                Object value) {
            switch (name) {
            case "basicPropertyBinding": ((KubernetesPersistentVolumesClaimsComponent) component).setBasicPropertyBinding((boolean) value); return true;
