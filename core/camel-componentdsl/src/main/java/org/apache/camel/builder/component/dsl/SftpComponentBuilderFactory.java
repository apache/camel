...
public interface SftpComponentBuilderFactory {
    ...
    interface SftpComponentBuilder extends ComponentBuilder<SftpComponent> {
         ...
         * Group: advanced
         */
        default SftpComponentBuilder setBasicPropertyBinding(
         ...
         * Group: producer
         */
        default SftpComponentBuilder setLazyStartProducer(
         ...
         * Group: consumer
         */
        default SftpComponentBuilder setBridgeErrorHandler(
    ...
    class SftpComponentBuilderImpl
            extends
                AbstractComponentBuilder<SftpComponent>
            implements
