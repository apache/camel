...
public interface SnmpComponentBuilderFactory {
    ...
    interface SnmpComponentBuilder extends ComponentBuilder<SnmpComponent> {
         ...
         * Group: advanced
         */
        default SnmpComponentBuilder setBasicPropertyBinding(
         ...
         * Group: producer
         */
        default SnmpComponentBuilder setLazyStartProducer(
         ...
         * Group: consumer
         */
        default SnmpComponentBuilder setBridgeErrorHandler(
