...
public interface KMS2ComponentBuilderFactory {
     ...
     */
    static KMS2ComponentBuilder aws2Kms() {
        return new KMS2ComponentBuilderImpl();
    }

    /**
     * Builder for the AWS 2 KMS component.
     */
    interface KMS2ComponentBuilder extends ComponentBuilder<KMS2Component> {
        /**
         ...
         * Group: advanced
         */
        default KMS2ComponentBuilder configuration(
         ...
         * Group: producer
         */
        default KMS2ComponentBuilder accessKey(java.lang.String accessKey) {
         ...
         * Group: producer
         */
        default KMS2ComponentBuilder secretKey(java.lang.String secretKey) {
         ...
         * Group: producer
         */
        default KMS2ComponentBuilder region(java.lang.String region) {
         ...
         * Group: advanced
         */
        default KMS2ComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default KMS2ComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
            doSetProperty("lazyStartProducer", lazyStartProducer);
            return this;
        }
    }

    class KMS2ComponentBuilderImpl
            extends
                AbstractComponentBuilder<KMS2Component>
            implements
                KMS2ComponentBuilder {
        @Override
