...
public interface ClientComponentBuilderFactory {
    ...
    interface ClientComponentBuilder
         ...
         * Group: common
         */
        default ClientComponentBuilder defaultConnectionOptions(
         ...
         * Group: advanced
         */
        default ClientComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default ClientComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default ClientComponentBuilder bridgeErrorHandler(
