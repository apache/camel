...
public interface ImapMailComponentBuilderFactory {
     ...
     */
    static ImapMailComponentBuilder imap() {
        return new ImapMailComponentBuilderImpl();
    }

    /**
     * Builder for the IMAP component.
     */
    interface ImapMailComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default ImapMailComponentBuilder configuration(
         ...
         * Group: advanced
         */
        default ImapMailComponentBuilder contentTypeResolver(
         ...
         * Group: security
         */
        default ImapMailComponentBuilder useGlobalSslContextParameters(
         ...
         * Group: filter
         */
        default ImapMailComponentBuilder headerFilterStrategy(
         ...
         * Group: advanced
         */
        default ImapMailComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default ImapMailComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default ImapMailComponentBuilder bridgeErrorHandler(
    ...
    class ImapMailComponentBuilderImpl
            extends
                AbstractComponentBuilder<MailComponent>
            implements
                ImapMailComponentBuilder {
        @Override
