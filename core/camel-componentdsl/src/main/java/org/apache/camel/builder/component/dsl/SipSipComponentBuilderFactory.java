...
public interface SipSipComponentBuilderFactory {
     ...
     */
    static SipSipComponentBuilder sip() {
        return new SipSipComponentBuilderImpl();
    }

    /**
     * Builder for the SIP component.
     */
    interface SipSipComponentBuilder extends ComponentBuilder<SipComponent> {
        /**
         ...
         * Group: advanced
         */
        default SipSipComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default SipSipComponentBuilder lazyStartProducer(
         ...
         * Group: consumer
         */
        default SipSipComponentBuilder bridgeErrorHandler(
    ...
    class SipSipComponentBuilderImpl
            extends
                AbstractComponentBuilder<SipComponent>
            implements
                SipSipComponentBuilder {
        @Override
