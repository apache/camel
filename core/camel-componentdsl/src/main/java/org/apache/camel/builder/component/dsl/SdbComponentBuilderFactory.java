...
public interface SdbComponentBuilderFactory {
     ...
     */
    static SdbComponentBuilder awsSdb() {
        return new SdbComponentBuilderImpl();
    }

    /**
     * Builder for the AWS SimpleDB component.
     */
    interface SdbComponentBuilder extends ComponentBuilder<SdbComponent> {
        /**
    ...
    class SdbComponentBuilderImpl
            extends
                AbstractComponentBuilder<SdbComponent>
            implements
                SdbComponentBuilder {
        @Override
