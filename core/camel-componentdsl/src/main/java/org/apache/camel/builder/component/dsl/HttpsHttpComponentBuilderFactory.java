...
public interface HttpsHttpComponentBuilderFactory {
     ...
     */
    static HttpsHttpComponentBuilder https() {
        return new HttpsHttpComponentBuilderImpl();
    }

    /**
     * Builder for the HTTPS (Secure) component.
     */
    interface HttpsHttpComponentBuilder
            extends
         ...
         * Group: advanced
         */
        default HttpsHttpComponentBuilder httpClientConfigurer(
         ...
         * Group: advanced
         */
        default HttpsHttpComponentBuilder clientConnectionManager(
         ...
         * Group: advanced
         */
        default HttpsHttpComponentBuilder httpContext(
         ...
         * Group: security
         */
        default HttpsHttpComponentBuilder sslContextParameters(
         ...
         * Group: security
         */
        default HttpsHttpComponentBuilder useGlobalSslContextParameters(
         ...
         * Group: security
         */
        default HttpsHttpComponentBuilder x509HostnameVerifier(
         ...
         * Group: advanced
         */
        default HttpsHttpComponentBuilder maxTotalConnections(
         ...
         * Group: advanced
         */
        default HttpsHttpComponentBuilder connectionsPerRoute(
         ...
         * Group: advanced
         */
        default HttpsHttpComponentBuilder connectionTimeToLive(
         ...
         * Group: producer
         */
        default HttpsHttpComponentBuilder cookieStore(
         ...
         * Group: timeout
         */
        default HttpsHttpComponentBuilder connectionRequestTimeout(
         ...
         * Group: timeout
         */
        default HttpsHttpComponentBuilder connectTimeout(int connectTimeout) {
         ...
         * Group: timeout
         */
        default HttpsHttpComponentBuilder socketTimeout(int socketTimeout) {
         ...
         * Group: advanced
         */
        default HttpsHttpComponentBuilder httpBinding(
         ...
         * Group: advanced
         */
        default HttpsHttpComponentBuilder httpConfiguration(
         ...
         * Group: advanced
         */
        default HttpsHttpComponentBuilder allowJavaSerializedObject(
         ...
         * Group: filter
         */
        default HttpsHttpComponentBuilder headerFilterStrategy(
         ...
         * Group: advanced
         */
        default HttpsHttpComponentBuilder basicPropertyBinding(
         ...
         * Group: producer
         */
        default HttpsHttpComponentBuilder lazyStartProducer(
    ...
    class HttpsHttpComponentBuilderImpl
            extends
                AbstractComponentBuilder<HttpComponent>
            implements
                HttpsHttpComponentBuilder {
        @Override
