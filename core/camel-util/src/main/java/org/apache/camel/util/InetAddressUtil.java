...
public final class InetAddressUtil {
     ...
     * lookup nor an <tt>/etc/hosts</tt> entry exists for a given host, the following exception will be thrown:
     * <p/>
     * <code>
     ...
     * exception, only then is the <tt>UnknownHostException</tt> thrown.
     *
     * @return                      the hostname
