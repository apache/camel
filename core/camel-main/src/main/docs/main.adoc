...
|===
| Name | Description | Default | Type
| *camel.mdc.customHeaders* | Provide the headers you would like to use in the logging. Use value to include all available headers |  | String
| *camel.mdc.customProperties* | Provide the properties you would like to use in the logging. Use value to include all available properties |  | String
