...
The camel.cluster.kubernetes supports 14 options, which are listed below.
...
The camel.cluster.zookeeper supports 11 options, which are listed below.
...
The camel.cluster.consul supports 16 options, which are listed below.
...
The camel.cluster.jgroups-raft supports 4 options, which are listed below.
...
The camel.cluster.infinispan supports 14 options, which are listed below.
