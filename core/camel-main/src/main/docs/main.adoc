...
| *camel.main.sslClient{zwsp}Authentication* | Sets the configuration options for server-side client-authentication requirements | NONE | String
| *camel.main.sslEnabled* | Enable SSL in your Camel application. | false | boolean
| *camel.main.sslKeyStore* | Sets the SSL Keystore resource. |  | String
| *camel.main.sslKeystorePassword* | Sets the SSL Keystore password. | changeit | String
| *camel.main.sslTrustStore* | Sets the SSL Truststore resource. |  | String
| *camel.main.sslTrustStore{zwsp}Password* | Sets the SSL Truststore password. | changeit | String
