...
| *camel.rest.enableNoContent{zwsp}Response* | Whether to return the HTTP 204 (no Content) success status response code for a response that has an empty body. The default value is false. | false | boolean
