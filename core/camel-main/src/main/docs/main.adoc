...
| *camel.trace.traceAsJSon* | Whether to support tracing messages and outputting as JSon. | true | boolean
| *camel.trace.traceAsXml* | Whether to support tracing messages and outputting as XML. | true | boolean
