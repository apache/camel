...
| *camel.main.enabled* | To enable TelemetrySimple | false | boolean
...
| *camel.main.excludePatterns* | Adds an exclude pattern that will disable tracing for Camel messages that matches the pattern. Multiple patterns can be separated by comma. |  | String
...
| *camel.main.traceFormat* | The output format for traces. |  | String
| *camel.main.traceProcessors* | Setting this to true will create new TelemetrySimple Spans for each Camel Processors. Use the excludePattern property to filter out Processors. | false | boolean
