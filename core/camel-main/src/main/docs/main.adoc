...
| *camel.server.jolokiaPath* | The path endpoint used to expose the jolokia data. | /q/jolokia | String
...
| *camel.vault.ibm.refreshPeriod* | The period (millis) between checking AWS for updated secrets. | 30000 | long
