...
| *camel.main.ssl.client{zwsp}Authentication* | Sets the configuration for server-side client-authentication requirements | NONE | String
| *camel.main.ssl.enabled* | Enables SSL in your Camel application. | false | boolean
| *camel.main.ssl.keyStore* | Sets the SSL Keystore resource. |  | String
| *camel.main.ssl.keystore{zwsp}Password* | Sets the SSL Keystore password. |  | String
| *camel.main.ssl.trustStore* | Sets the SSL Truststore resource. |  | String
| *camel.main.ssl.trustStore{zwsp}Password* | Sets the SSL Truststore password. |  | String
...
=== Camel Main SSL configurations
The camel.main.ssl supports 6 options, which are listed below.
