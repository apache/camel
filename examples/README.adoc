...
| link:camel-example-spring-boot-pojo/readme.md[Spring Boot Pojo] (camel-example-spring-boot-pojo) | Beginner | An example showing how to work with Camel POJO routing with Spring Boot
