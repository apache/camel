...
// examples: START
Number of Examples: 92 (9 deprecated)
...
| link:camel-example-spring-boot-activemq/readme.adoc[Spring Boot Activemq] (camel-example-spring-boot-activemq) | Beginner | An example showing how to work with Camel, ActiveMQ and Spring Boot
