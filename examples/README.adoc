...
| link:camel-example-kubernetes-fabric8-maven-plugin/ReadMe.md[Kubernetes Fabric8 Maven Plugin] (camel-example-kubernetes-fabric8-maven-plugin) |  | Kubernetes Kubernetes Fabric8 Maven Plugin example
