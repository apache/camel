...
// examples: START
Number of Examples: 103 (0 deprecated)
...
| link:camel-example-as2/README.md[AS2] (camel-example-as2) | Messaging | Demonstrates sending and receiving AS2 messages using AS2 enpoints.
