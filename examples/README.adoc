...
| link:camel-example-opentracing/README.md[Opentracing] (camel-example-opentracing) |  | An example showing how to trace incoming and outgoing messages from Camel with OpenTracing
