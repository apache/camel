...
dh.languages.sql={case_insensitive:true,defaultMode:{lexems:[_3.IDENT_RE],contains:["string","number","comment"],keywords:{"keyword":_1,"aggregate":{"count":1,"sum":1,"min":1,"max":1,"avg":1}}},modes:[_3.C_NUMBER_MODE,_3.C_BLOCK_COMMENT_MODE,{className:"comment",begin:"--",end:"$"},{className:"string",begin:"'",end:"'",contains:["escape","squote"],relevance:0},{className:"squote",begin:"''",end:"^"},{className:"string",begin:"\"",end:"\"",contains:["escape","dquote"],relevance:0},{className:"dquote",begin:"\"\"",end:"^"},{className:"string",begin:"`",end:"`",contains:["escape"]},_3.BACKSLASH_ESCAPE]};
})();
}
