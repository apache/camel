...
public class CamelBlueprint7Test extends OSGiBlueprintTestSupport {
    ...
    public static Option[] configure() throws Exception {
        ...
        Option[] options = combine(
                ...
                bundle(newBundle()
                        .add("OSGI-INF/blueprint/test.xml", OSGiBlueprintTestSupport.class.getResource("blueprint-25.xml"))
                        .set(Constants.BUNDLE_SYMBOLICNAME, "CamelBlueprintTestBundle25")
