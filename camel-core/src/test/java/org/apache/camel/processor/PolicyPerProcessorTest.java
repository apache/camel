...
public class PolicyPerProcessorTest extends ContextTestSupport {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                Policy foo = context.getRegistry().lookup("foo", Policy.class);
                Policy bar = context.getRegistry().lookup("bar", Policy.class);
    ...
    public static class MyPolicy implements Policy {
        ...
        public Processor wrap(final Processor processor) {
