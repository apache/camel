 ...
 *
 */
public class XsltFromHeaderTest extends ContextTestSupport {
    ...
    public void testSendMessageAndHaveItTransformed() throws Exception {
        ...
        template.sendBodyAndHeader("direct:start",
                ...
                XsltConstants.XSLT_RESOURCE_URI, "org/apache/camel/component/xslt/transform.xsl");        
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("direct:start")
                    .to("xslt:dummy") // real xsl should come from header
                    .multicast()
                        .beanRef("testBean")
                        .to("mock:result");
            }
