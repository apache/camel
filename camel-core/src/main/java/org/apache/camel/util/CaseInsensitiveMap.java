 ...
 * <p/>
 * The map is based on {@link GenericCaseInsensitiveMap}, which is copied from com.cedarsoftware:java-util:1.26.0.
 * It uses {@link HashMap} under the hood and provides better performance than {@link TreeMap}.
 * <p/>
 ...
 */
public class CaseInsensitiveMap extends GenericCaseInsensitiveMap<String, Object> {
